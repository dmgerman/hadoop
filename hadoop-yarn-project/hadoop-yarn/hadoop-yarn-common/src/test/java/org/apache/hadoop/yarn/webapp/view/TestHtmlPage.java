...
argument_list|)
decl_stmt|;
comment|// Verify the HTML page has correct meta tags in the header
name|verify
argument_list|(
name|out
argument_list|)
...
name|print
argument_list|(
literal|" http-equiv=\"X-UA-Compatible\""
argument_list|)
expr_stmt|;
name|verify
argument_list|(
