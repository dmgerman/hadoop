...
annotation|@
name|Test
DECL|method|testFinishTimesAheadOfStartTimes ()
specifier|public
name|void
name|testFinishTimesAheadOfStartTimes
parameter_list|()
block|{
name|long
name|elapsed
...
argument_list|)
expr_stmt|;
comment|// use Long.MAX_VALUE to ensure started time is after the current one
name|elapsed
operator|=
name|Times
operator|.
