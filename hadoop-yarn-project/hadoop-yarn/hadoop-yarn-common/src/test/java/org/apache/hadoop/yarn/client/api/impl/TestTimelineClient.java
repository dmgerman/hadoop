...
annotation|@
name|Test
DECL|method|testPostEntitiesTimelineServiceNotEnabled ()
specifier|public
name|void
name|testPostEntitiesTimelineServiceNotEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"putEntities should already return before throwing the exception"
argument_list|)
expr_stmt|;
block|}
block|}
annotation|@
name|Test
DECL|method|testPostEntitiesTimelineServiceDefaultNotEnabled ()
specifier|public
name|void
name|testPostEntitiesTimelineServiceDefaultNotEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Unset the timeline service's enabled properties.
comment|// Make sure default value is pickup up
name|conf
operator|.
name|unset
argument_list|(
