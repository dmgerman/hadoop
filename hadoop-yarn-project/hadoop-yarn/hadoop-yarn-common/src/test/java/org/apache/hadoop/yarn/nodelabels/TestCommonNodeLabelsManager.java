...
literal|5000
argument_list|)
DECL|method|testUpdateNodeLabels ()
specifier|public
name|void
name|testUpdateNodeLabels
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|false
decl_stmt|;
comment|// should fail: label isn't exist
try|try
block|{
name|mgr
operator|.
...
name|assertTrue
argument_list|(
literal|"Should fail since the node label doesn't exist"
argument_list|,
name|failed
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Check exclusive for p1/p2
name|Assert
operator|.
name|assertFalse
argument_list|(
