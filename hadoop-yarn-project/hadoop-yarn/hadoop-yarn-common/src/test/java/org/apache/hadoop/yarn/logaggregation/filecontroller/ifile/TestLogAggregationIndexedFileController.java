...
begin_comment
comment|/**  * Function test for {@link LogAggregationIndexedFileController}.  *  */
end_comment

begin_class
DECL|class|TestLogAggregationIndexedFileController
specifier|public
class|class
name|TestLogAggregationIndexedFileController
extends|extends
name|Configured
block|{
...
expr_stmt|;
block|}
name|assertZeroFileIsContained
argument_list|(
name|sysOutStream
operator|.
name|toString
...
expr_stmt|;
block|}
DECL|method|assertZeroFileIsContained (String outStream)
specifier|private
name|void
name|assertZeroFileIsContained
parameter_list|(
...
literal|"\n"
operator|+
literal|"End of LogType:zero"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|createZeroLocalLogFile (Path localLogDir)
specifier|private
name|File
name|createZeroLocalLogFile
parameter_list|(
...
return|;
block|}
DECL|method|createAndWriteLocalLogFile (Path localLogDir, String logType, String message)
specifier|private
name|File
name|createAndWriteLocalLogFile
parameter_list|(
...
annotation|@
name|Test
DECL|method|testGetRollOverLogMaxSize ()
specifier|public
name|void
name|testGetRollOverLogMaxSize
parameter_list|()
block|{
name|String
name|fileControllerName
init|=
literal|"testController"
decl_stmt|;
name|String
name|remoteDirConf
init|=
...
argument_list|)
expr_stmt|;
comment|// test file system supporting append
name|conf
operator|.
name|set
argument_list|(
name|remoteDirConf
argument_list|,
literal|"webhdfs://localhost/path"
argument_list|)
expr_stmt|;
name|fileFormat
operator|.
...
argument_list|)
expr_stmt|;
comment|// test file system not supporting append
name|conf
operator|.
name|set
argument_list|(
