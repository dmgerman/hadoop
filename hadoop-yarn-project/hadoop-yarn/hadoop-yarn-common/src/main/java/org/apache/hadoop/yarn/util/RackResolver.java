...
return|;
block|}
comment|/**    * Utility method for getting a list of hostname resolved to a list of node    *  in the network topology. This method initializes the class with the    * right resolver implementation.    * @param conf    * @param hostNames    * @return nodes {@link Node} after resolving the hostnames    */
DECL|method|resolve ( Configuration conf, List<String> hostNames)
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
comment|/**    * Utility method for getting a list of hostname resolved to a list of node    *  in the network topology. This method doesn't initialize the class.    * Call {@link #init(Configuration)} explicitly.    * @param hostNames    * @return nodes {@link Node} after resolving the hostnames    */
DECL|method|resolve (List<String> hostNames)
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
DECL|method|coreResolve (List<String> hostNames)
specifier|private
specifier|static
name|List
argument_list|<
...
name|info
argument_list|(
literal|"Got an error when resolve hostNames. Falling back to "
operator|+
name|NetworkTopology
operator|.
name|DEFAULT_RACK
...
condition|)
block|{
comment|// fallback to use default rack
name|nodes
operator|.
name|add
argument_list|(
