...
name|diff
operator|=
name|calculateSharesForTwoMandatoryResources
argument_list|(
name|clusterRes
argument_list|,
name|lhs
...
DECL|method|calculateSharesForTwoMandatoryResources ( ResourceInformation[] clusterRes, Resource first, Resource second, double[] firstShares, double[] secondShares)
specifier|private
name|int
name|calculateSharesForTwoMandatoryResources
parameter_list|(
...
return|;
block|}
DECL|method|isAllInvalidDivisor (Resource r)
specifier|public
name|boolean
name|isAllInvalidDivisor
parameter_list|(
