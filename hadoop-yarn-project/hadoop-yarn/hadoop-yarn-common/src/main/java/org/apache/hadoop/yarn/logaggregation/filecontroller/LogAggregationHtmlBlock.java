...
name|__
argument_list|(
literal|"Invalid log start time value: "
operator|+
name|$
argument_list|(
literal|"start.time"
...
name|__
argument_list|(
literal|"Invalid log end time value: "
operator|+
name|$
argument_list|(
literal|"end.time"
argument_list|)
operator|+
literal|". It should be larger than start time value:"
operator|+
name|startTime
argument_list|)
operator|.
...
return|;
block|}
DECL|method|checkParseRange (Block html, long startIndex, long endIndex, long startTime, long endTime, long logLength, String logType)
specifier|protected
name|long
index|[]
...
return|;
block|}
DECL|method|processContainerLog (Block html, long[] range, InputStream in, int bufferSize, byte[] cbuf)
specifier|protected
name|void
