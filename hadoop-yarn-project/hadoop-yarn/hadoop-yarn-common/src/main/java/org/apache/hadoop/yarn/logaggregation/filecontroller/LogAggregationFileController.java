...
name|controllerName
expr_stmt|;
name|extractRemoteRootLogDir
argument_list|()
expr_stmt|;
name|extractRemoteRootLogDirSuffix
argument_list|()
expr_stmt|;
name|initInternal
argument_list|(
...
name|IOException
function_decl|;
comment|/**    * Sets the remoteRootLogDirSuffix class variable extracting    * {@link YarnConfiguration#LOG_AGGREGATION_REMOTE_APP_LOG_DIR_SUFFIX_FMT}    * from the configuration, or    * {@link YarnConfiguration#NM_REMOTE_APP_LOG_DIR_SUFFIX} appended by the    * FileController's name, if the former is not set.    */
DECL|method|extractRemoteRootLogDirSuffix ()
specifier|private
name|void
name|extractRemoteRootLogDirSuffix
parameter_list|()
...
block|}
block|}
comment|/**    * Sets the remoteRootLogDir class variable extracting    * {@link YarnConfiguration#LOG_AGGREGATION_REMOTE_APP_LOG_DIR_FMT}    * from the configuration or {@link YarnConfiguration#NM_REMOTE_APP_LOG_DIR},    * if the former is not set.    */
DECL|method|extractRemoteRootLogDir ()
specifier|private
name|void
name|extractRemoteRootLogDir
parameter_list|()
...
return|;
block|}
comment|/**    * Get the older remote application directory for log aggregation.    * @param appId the Application ID    * @param appOwner the Application Owner    * @return the older remote application directory    * @throws IOException if can not find the remote application directory    */
DECL|method|getOlderRemoteAppLogDir (ApplicationId appId, String appOwner)
specifier|public
name|Path
