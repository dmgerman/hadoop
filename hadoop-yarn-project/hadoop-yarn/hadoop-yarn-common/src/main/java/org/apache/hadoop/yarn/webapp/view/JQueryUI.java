...
name|root_url
argument_list|(
literal|"static/dt-1.10.18/css/jquery.dataTables.css"
argument_list|)
argument_list|)
operator|.
name|link
...
name|root_url
argument_list|(
literal|"static/dt-1.10.18/css/jui-dt.css"
argument_list|)
argument_list|)
operator|.
name|link
...
name|root_url
argument_list|(
literal|"static/dt-1.10.18/css/custom_datatable.css"
argument_list|)
argument_list|)
operator|.
name|script
...
name|root_url
argument_list|(
literal|"static/jquery/jquery-3.4.1.min.js"
argument_list|)
argument_list|)
operator|.
name|script
...
name|root_url
argument_list|(
literal|"static/dt-1.10.18/js/jquery.dataTables.min.js"
argument_list|)
argument_list|)
operator|.
name|script
