...
return|;
block|}
comment|/**      * Enable the CSRF filter.      * @param csrfConfigPrefix The config prefix that identifies the      *                         CSRF parameters applicable for this filter      *                         instance.      * @return the Builder instance      */
DECL|method|withCSRFProtection (String csrfConfigPrefix)
specifier|public
name|Builder
argument_list|<
name|T
...
return|;
block|}
DECL|method|getCsrfConfigParameters ()
specifier|private
name|Map
argument_list|<
name|String
...
condition|)
block|{
comment|// need to obtain parameters for CSRF filter
name|params
operator|=
name|RestCsrfPreventionFilter
operator|.
