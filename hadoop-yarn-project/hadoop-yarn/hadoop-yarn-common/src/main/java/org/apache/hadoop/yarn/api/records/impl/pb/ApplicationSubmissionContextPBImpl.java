...
literal|null
decl_stmt|;
DECL|field|schedulingProperties
specifier|private
name|Map
argument_list|<
name|String
...
name|builder
operator|.
name|addAllAmContainerResourceRequest
argument_list|(
name|convertToProtoFormat
argument_list|(
name|this
...
condition|)
block|{
name|addApplicationSchedulingProperties
argument_list|()
expr_stmt|;
block|}
block|}
...
return|;
block|}
DECL|method|convertFromProtoFormat ( List<ResourceRequestProto> ps)
specifier|private
name|List
argument_list|<
name|ResourceRequest
...
return|;
block|}
DECL|method|convertToProtoFormat ( List<ResourceRequest> ts)
specifier|private
name|List
argument_list|<
name|ResourceRequestProto
...
name|p
operator|.
name|getAmContainerResourceRequestCount
argument_list|()
operator|==
literal|0
condition|)
...
name|p
operator|.
name|getAmContainerResourceRequestList
argument_list|()
argument_list|)
expr_stmt|;
return|return
...
expr_stmt|;
block|}
DECL|method|addApplicationSchedulingProperties ()
specifier|private
name|void
name|addApplicationSchedulingProperties
parameter_list|()
...
name|builder
operator|.
name|clearApplicationSchedulingProperties
argument_list|()
expr_stmt|;
if|if
condition|(
...
name|builder
operator|.
name|addAllApplicationSchedulingProperties
argument_list|(
name|values
argument_list|)
expr_stmt|;
block|}
DECL|method|initApplicationSchedulingProperties ()
specifier|private
name|void
name|initApplicationSchedulingProperties
parameter_list|()
block|{
if|if
condition|(
...
name|p
operator|.
name|getApplicationSchedulingPropertiesList
argument_list|()
decl_stmt|;
name|this
operator|.
