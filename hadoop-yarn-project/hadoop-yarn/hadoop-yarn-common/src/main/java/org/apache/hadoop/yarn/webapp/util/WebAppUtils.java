...
block|}
block|}
DECL|method|getLogUrl (String nodeHttpAddress, String allocatedNode, ContainerId containerId, String user)
specifier|public
specifier|static
name|String
name|getLogUrl
...
return|;
block|}
comment|/**    * Choose which scheme (HTTP or HTTPS) to use when generating a URL based on    * the configuration.    *     * @return the schmeme (HTTP / HTTPS)    */
