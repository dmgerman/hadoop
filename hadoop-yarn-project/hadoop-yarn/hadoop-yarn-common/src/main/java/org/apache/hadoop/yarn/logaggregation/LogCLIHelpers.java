...
return|;
block|}
DECL|method|guessOwnerWithFileFormat ( LogAggregationFileController fileFormat, ApplicationId appId, String bestGuess, Configuration conf)
specifier|public
specifier|static
name|String
name|guessOwnerWithFileFormat
parameter_list|(
name|LogAggregationFileController
name|fileFormat
parameter_list|,
...
condition|)
block|{
comment|//fetch user from new path /app-logs/user[/suffix]/bucket/app_id
name|Path
name|parent
init|=
name|matching
...
parameter_list|)
block|{
comment|// Ignore IOException thrown from wrong file format
block|}
if|if
condition|(
name|scanOldPath
...
condition|)
block|{
comment|//fetch user from old path /app-logs/user[/suffix]/app_id
name|Path
name|parent
init|=
name|matching
