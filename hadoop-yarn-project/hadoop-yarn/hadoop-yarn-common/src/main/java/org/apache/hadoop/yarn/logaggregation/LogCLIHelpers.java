...
condition|)
block|{
comment|//fetch the user from the old path /app-logs/user[/suffix]/app_id
name|Path
name|parent
init|=
name|matching
...
parameter_list|)
block|{
comment|// Ignore IOException from accessing older app log dir
block|}
block|}
return|return
literal|null
return|;
block|}
comment|//fetch the user from the full path /app-logs/user[/suffix]/bucket/app_id
name|Path
name|parent
init|=
name|matching
