...
annotation|@
name|VisibleForTesting
DECL|method|dumpAContainersLogsForALogType (String appId, String containerId, String nodeId, String jobOwner, List<String> logType, boolean outputFailure)
specifier|public
name|int
name|dumpAContainersLogsForALogType
parameter_list|(
...
annotation|@
name|Private
DECL|method|dumpAContainersLogsForALogTypeWithoutNodeId (String appId, String containerId, String jobOwner, List<String> logType)
specifier|public
name|int
