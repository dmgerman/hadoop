...
literal|0
decl_stmt|;
DECL|field|lastEventDetailsQueueSizeLogged
specifier|private
specifier|volatile
name|int
name|lastEventDetailsQueueSizeLogged
init|=
literal|0
decl_stmt|;
DECL|field|stopped
...
literal|false
decl_stmt|;
comment|//Configuration for control the details queue event printing.
DECL|field|detailsInterval
specifier|private
name|int
name|detailsInterval
decl_stmt|;
DECL|field|printTrigger
specifier|private
name|boolean
name|printTrigger
init|=
...
condition|)
block|{
comment|//Log the latest dispatch event type
comment|// may cause the too many events queued
name|LOG
operator|.
name|info
argument_list|(
literal|"Latest dispatch event type: "
operator|+
name|event
operator|.
name|getType
...
argument_list|>
block|{
DECL|method|printEventQueueDetails (BlockingQueue<Event> queue)
specifier|private
name|void
name|printEventQueueDetails
parameter_list|(
name|BlockingQueue
argument_list|<
name|Event
