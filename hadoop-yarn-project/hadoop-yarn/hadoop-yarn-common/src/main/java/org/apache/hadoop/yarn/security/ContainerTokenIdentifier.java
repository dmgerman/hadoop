...
expr_stmt|;
block|}
comment|/**    * Create a Container Token Identifier.    *    * @param containerID containerID    * @param containerVersion containerVersion    * @param hostName hostName    * @param appSubmitter appSubmitter    * @param r resource    * @param expiryTimeStamp expiryTimeStamp    * @param masterKeyId masterKeyId    * @param rmIdentifier rmIdentifier    * @param priority priority    * @param creationTime creationTime    * @param logAggregationContext logAggregationContext    * @param nodeLabelExpression nodeLabelExpression    * @param containerType containerType    * @param executionType executionType    * @param allocationRequestId allocationRequestId    * @param allocationTags Set of allocation Tags.    */
...
parameter_list|)
block|{
comment|// In the old format, there was no versioning or proper handling of new
comment|// fields.  Depending on how old, the log aggregation size and data, may
comment|// or may not exist.  To handle that, we try to read it and ignore the
comment|// EOFException that's thrown if it's not there.
block|}
if|if
condition|(
name|logAggregationSize
