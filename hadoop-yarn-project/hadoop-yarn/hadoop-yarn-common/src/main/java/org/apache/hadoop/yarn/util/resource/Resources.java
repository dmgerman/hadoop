...
return|;
block|}
comment|/**    * Multiply {@code lhs} by {@code by}, and set the result rounded down into a    * cloned version of {@code lhs} Resource object.    * @param lhs Resource object    * @param by Multiply values by this value    * @return A cloned version of {@code lhs} with updated values    */
...
return|;
block|}
comment|/**    * Multiply {@code lhs} by {@code by}, and set the result rounded up into a    * cloned version of {@code lhs} Resource object.    * @param lhs Resource object    * @param by Multiply values by this value    * @return A cloned version of {@code lhs} with updated values    */
...
return|;
block|}
comment|/**    * Multiply {@code lhs} by {@code by}, and set the result according to    * the rounding direction to {@code lhs}    * without creating any new {@link Resource} object.    * @param lhs Resource object    * @param by Multiply values by this value    * @return Returns {@code lhs} itself (without cloning) with updated values    */
DECL|method|multiplyAndRound (Resource lhs, double by, RoundingDirection roundingDirection)
specifier|private
specifier|static
name|Resource
name|multiplyAndRound
