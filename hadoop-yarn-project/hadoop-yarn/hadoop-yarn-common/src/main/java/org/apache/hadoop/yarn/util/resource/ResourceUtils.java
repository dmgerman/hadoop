...
name|YarnRuntimeException
argument_list|(
literal|"Attempt to re-define mandatory resource 'memory-mb'. It can only"
operator|+
literal|" be of type 'COUNTABLE' and have units 'Mi'."
argument_list|)
throw|;
block|}
block|}
...
name|YarnRuntimeException
argument_list|(
literal|"Attempt to re-define mandatory resource 'vcores'. It can only be"
operator|+
literal|" of type 'COUNTABLE' and have units ''(no units)."
argument_list|)
throw|;
block|}
block|}
