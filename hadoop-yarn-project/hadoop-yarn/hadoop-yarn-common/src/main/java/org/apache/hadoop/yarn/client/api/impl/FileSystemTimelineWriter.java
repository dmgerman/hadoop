...
name|YarnConfiguration
operator|.
name|TIMELINE_SERVICE_ENTITYGROUP_FS_STORE_RETRY_POLICY_SPEC
argument_list|,
name|YarnConfiguration
operator|.
name|DEFAULT_TIMELINE_SERVICE_ENTITYGROUP_FS_STORE_RETRY_POLICY_SPEC
argument_list|)
decl_stmt|;
name|fsConf
operator|.
...
decl_stmt|;
DECL|field|cleanInActiveFDsTask
specifier|private
...
literal|false
decl_stmt|;
DECL|method|LogFDsCache (long flushIntervalSecs, long cleanIntervalSecs, long ttl)
specifier|public
name|LogFDsCache
parameter_list|(
name|long
