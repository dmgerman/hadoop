...
decl_stmt|;
comment|/**    * Formats the header of an aggregated log file.    */
DECL|method|formatContainerLogHeader (String containerId, String nodeId, ContainerLogAggregationType logType, String fileName, String lastModifiedTime, long fileLength)
specifier|private
specifier|static
name|byte
index|[]
name|formatContainerLogHeader
parameter_list|(
name|String
name|containerId
parameter_list|,
