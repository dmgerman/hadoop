...
case|:
name|StoreUpdateNodeLabelsEvent
name|storeSetNodeLabelsEventEvent
init|=
operator|(
name|StoreUpdateNodeLabelsEvent
operator|)
...
block|}
block|}
DECL|method|checkUpdateNodeLabels ( List<NodeLabel> updatedNodeLabels)
specifier|private
name|void
name|checkUpdateNodeLabels
parameter_list|(
name|List
argument_list|<
name|NodeLabel
...
name|format
argument_list|(
literal|"Trying to update a non-existing node-label=%s"
argument_list|,
name|label
operator|.
name|getNodeLabel
