...
expr_stmt|;
block|}
comment|/**    *    * @param envString String containing env variable definitions    * @param classPathSeparator String that separates the definitions    * @return ArrayList of environment variable names    */
DECL|method|getEnvVarsFromInputString (String envString, String classPathSeparator)
specifier|public
specifier|static
name|ArrayList
argument_list|<
