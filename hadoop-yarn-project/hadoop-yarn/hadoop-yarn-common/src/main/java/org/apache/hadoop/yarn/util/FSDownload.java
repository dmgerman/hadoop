...
DECL|method|isPublic (FileSystem fs, Path current)
specifier|private
specifier|static
name|boolean
name|isPublic
...
return|;
block|}
DECL|method|checkPublicPermsForAll (FileSystem fs, Path current, FsAction dir, FsAction file)
specifier|private
specifier|static
name|boolean
name|checkPublicPermsForAll
...
return|;
block|}
DECL|method|unpack (File localrsrc, File dst, Pattern pattern)
specifier|private
name|long
name|unpack
parameter_list|(
