...
block|}
block|}
comment|/**    * Visits a {@link PlacementConstraint} tree and, whenever possible,    * substitutes each {@link SingleConstraint} with a {@link TargetConstraint}    * or a {@link CardinalityConstraint}. When such a substitution is not    * possible, we keep the original {@link SingleConstraint}.    */
...
name|constraint
decl_stmt|;
comment|// Check if it is a cardinality constraint.
if|if
condition|(
name|constraint
operator|.
