...
begin_comment
comment|/**  * Utils to convert enum protos to corresponding java enums and vice versa.  */
end_comment
...
name|ProtoUtils
block|{
DECL|field|BYTE_STRING_INTERNER
specifier|public
specifier|static
specifier|final
name|Interner
...
return|;
block|}
DECL|method|convertStringStringMapProtoListToMap ( List<StringStringMapProto> pList)
specifier|public
specifier|static
name|Map
argument_list|<
...
return|;
block|}
DECL|method|convertToProtoFormat ( Map<String, String> stringMap)
specifier|public
specifier|static
name|List
argument_list|<
...
DECL|field|LOCALIZATION_STATE_PREFIX
specifier|private
specifier|final
specifier|static
name|String
name|LOCALIZATION_STATE_PREFIX
init|=
literal|"L_"
decl_stmt|;
