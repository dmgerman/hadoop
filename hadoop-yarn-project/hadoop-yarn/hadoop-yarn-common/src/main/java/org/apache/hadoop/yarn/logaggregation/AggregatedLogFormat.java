...
expr_stmt|;
block|}
DECL|method|LogValue (List<String> rootLogDirs, ContainerId containerId, String user, LogAggregationContext logAggregationContext, Set<String> alreadyUploadedLogFiles, boolean appFinished)
specifier|public
name|LogValue
parameter_list|(
name|List
