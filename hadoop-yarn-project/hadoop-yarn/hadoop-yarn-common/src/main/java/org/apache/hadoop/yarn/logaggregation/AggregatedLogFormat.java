...
expr_stmt|;
block|}
DECL|method|LogValue (List<String> rootLogDirs, ContainerId containerId, String user, LogAggregationContext logAggregationContext, Set<String> alreadyUploadedLogFiles, LogRetentionContext retentionContext, boolean appFinished)
specifier|public
name|LogValue
parameter_list|(
name|List
...
expr_stmt|;
block|}
DECL|method|readContainerLogs (DataInputStream valueStream, PrintStream out, long logUploadedTime)
specifier|private
specifier|static
name|void
name|readContainerLogs
