...
expr_stmt|;
block|}
DECL|method|LogValue (List<String> rootLogDirs, ContainerId containerId, String user, LogAggregationContext logAggregationContext, Set<String> alreadyUploadedLogFiles)
specifier|public
name|LogValue
parameter_list|(
name|List
...
argument_list|)
expr_stmt|;
comment|// Write the uploaded TimeStamp
name|out
operator|.
name|writeLong
argument_list|(
...
literal|null
decl_stmt|;
DECL|field|currentLogUpLoadTime
specifier|private
name|long
name|currentLogUpLoadTime
init|=
literal|0
decl_stmt|;
...
return|;
block|}
DECL|method|getCurrentLogUpLoadTime ()
specifier|public
name|long
