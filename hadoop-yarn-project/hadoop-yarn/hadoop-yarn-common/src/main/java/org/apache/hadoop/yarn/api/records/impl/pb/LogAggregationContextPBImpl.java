...
name|p
operator|.
name|hasLogAggregationPolicyClassName
argument_list|()
condition|)
block|{
return|return
...
name|builder
operator|.
name|clearLogAggregationPolicyClassName
argument_list|()
expr_stmt|;
return|return;
block|}
...
name|p
operator|.
name|hasLogAggregationPolicyParameters
argument_list|()
condition|)
block|{
return|return
...
annotation|@
name|Override
DECL|method|setLogAggregationPolicyParameters ( String config)
specifier|public
name|void
...
name|builder
operator|.
name|clearLogAggregationPolicyParameters
argument_list|()
expr_stmt|;
return|return;
block|}
