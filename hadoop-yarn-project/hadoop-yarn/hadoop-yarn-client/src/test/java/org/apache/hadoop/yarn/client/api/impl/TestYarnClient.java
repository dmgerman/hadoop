...
begin_comment
comment|/**  * This class is to test class {@link YarnClient).  */
end_comment
...
name|ParameterizedSchedulerTestBase
block|{
DECL|method|TestYarnClient (SchedulerType type)
specifier|public
name|TestYarnClient
parameter_list|(
name|SchedulerType
...
literal|10000
argument_list|)
DECL|method|testGetContainersOnAHSFail ()
specifier|public
name|void
name|testGetContainersOnAHSFail
parameter_list|()
throws|throws
name|YarnException
throws|,
...
argument_list|)
expr_stmt|;
comment|//Only 2 running containers from RM are present when AHS throws exception
name|Assert
operator|.
name|assertEquals
argument_list|(
...
name|ContainerReport
argument_list|>
DECL|method|getContainersOnAHSFail (ApplicationAttemptId appAttemptId)
name|getContainersOnAHSFail
parameter_list|(
name|ApplicationAttemptId
name|appAttemptId
...
argument_list|()
operator|+
literal|" does not exist in the timeline store"
argument_list|)
argument_list|)
expr_stmt|;
return|return
