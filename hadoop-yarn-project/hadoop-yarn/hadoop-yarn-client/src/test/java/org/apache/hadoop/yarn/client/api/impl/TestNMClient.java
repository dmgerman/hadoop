...
literal|null
decl_stmt|;
comment|/**    * Container State transition listener to track the number of times    * a container has transitioned into a state.    */
DECL|class|DebugSumContainerStateListener
specifier|public
specifier|static
class|class
name|DebugSumContainerStateListener
...
block|}
block|}
comment|/**      * Get the current number of state transitions.      * This is useful to check, if an event has occurred in unit tests.      * @param id Container id to check      * @param state Return the overall number of transitions to this state      * @return Number of transitions to the state specified      */
DECL|method|getTransitionCounter (ContainerId id, org.apache.hadoop.yarn.server.nodemanager .containermanager.container .ContainerState state)
specifier|static
name|long
name|getTransitionCounter
parameter_list|(
name|ContainerId
name|id
parameter_list|,
...
argument_list|()
expr_stmt|;
comment|// Turn on state tracking
name|conf
operator|.
name|set
argument_list|(
...
return|;
block|}
DECL|method|testContainerManagement (NMClientImpl client, Set<Container> containers)
specifier|private
name|void
name|testContainerManagement
parameter_list|(
...
block|}
block|}
DECL|method|testContainer (NMClientImpl client, int i, Container container, ContainerLaunchContext clc, List<Integer> exitCode)
specifier|private
name|void
name|testContainer
parameter_list|(
...
argument_list|)
expr_stmt|;
name|waitForContainerTransitionCount
argument_list|(
name|container
argument_list|,
name|org
...
block|}
block|}
comment|/**    * Wait until the container reaches a state N times.    * @param container container to watch    * @param state state to test    * @param transitions the number N above    * @throws YarnException This happens if the test times out while waiting    */
DECL|method|waitForContainerTransitionCount ( Container container, org.apache.hadoop.yarn.server.nodemanager. containermanager.container.ContainerState state, long transitions)
specifier|private
name|void
name|waitForContainerTransitionCount
parameter_list|(
...
name|YarnException
argument_list|(
literal|"Timeout at transition count:"
operator|+
name|transitionCount
argument_list|,
name|e
