...
annotation|@
name|Test
DECL|method|testUseWithResourceName ()
specifier|public
name|void
name|testUseWithResourceName
parameter_list|()
throws|throws
name|Exception
block|{
...
name|URI
argument_list|(
literal|"viewfs://test/path#linkName"
argument_list|)
decl_stmt|;
name|Path
name|usePath
...
annotation|@
name|Test
DECL|method|testUseWithSameResourceName ()
specifier|public
name|void
name|testUseWithSameResourceName
parameter_list|()
throws|throws
name|Exception
block|{
