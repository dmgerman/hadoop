...
name|println
argument_list|(
literal|" -appStates<States>        Works with -list to filter applications based"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                            on input comma-separated list of application"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                            states. The valid application state can be one"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|"                            ALL,NEW,NEW_SAVING,SUBMITTED,ACCEPTED,RUNNING,"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                            FINISHED,FAILED,KILLED"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|" -appTypes<Types>          Works with -list to filter applications based"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|" -list                      List applications from the RM. Supports"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                            optional use of -appTypes to filter"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                            applications based on application type, and"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                            -appStates to filter applications based on"
argument_list|)
expr_stmt|;
name|pw
operator|.
