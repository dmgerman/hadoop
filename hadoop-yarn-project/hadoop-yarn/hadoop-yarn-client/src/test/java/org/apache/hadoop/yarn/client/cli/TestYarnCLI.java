...
name|println
argument_list|(
literal|"\tExposedPorts : {\"192.168.0.1\":[{\"abc\":\"123\"}]}"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
annotation|@
name|Test
DECL|method|testGetQueueInfoOverrideIntraQueuePreemption ()
specifier|public
name|void
name|testGetQueueInfoOverrideIntraQueuePreemption
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Turn on cluster-wide intra-queue preemption
name|conf
operator|.
name|setBoolean
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Disable intra-queue preemption for all queues
name|conf
operator|.
name|setBoolean
argument_list|(
...
name|PREFIX
operator|+
literal|"root.intra-queue-preemption.disable_preemption"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
comment|// Enable intra-queue preemption for the a1 queue
name|conf
operator|.
name|setBoolean
argument_list|(
...
name|PREFIX
operator|+
literal|"root.a.a1.intra-queue-preemption.disable_preemption"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|MiniYARNCluster
argument_list|(
literal|"testGetQueueInfoOverrideIntraQueuePreemption"
argument_list|,
literal|2
argument_list|,
literal|1
...
argument_list|()
expr_stmt|;
comment|// Get status for the root.a queue
name|int
name|result
init|=
name|cli
...
argument_list|)
expr_stmt|;
comment|// In-queue preemption is disabled at the "root.a" queue level
name|Assert
operator|.
name|assertTrue
argument_list|(
...
name|contains
argument_list|(
literal|"Intra-queue Preemption : disabled"
argument_list|)
argument_list|)
expr_stmt|;
name|cli
...
argument_list|()
expr_stmt|;
comment|// Get status for the root.a.a1 queue
name|result
operator|=
name|cli
operator|.
...
argument_list|)
expr_stmt|;
comment|// In-queue preemption is enabled at the "root.a.a1" queue level
name|Assert
operator|.
name|assertTrue
argument_list|(
...
name|MiniYARNCluster
argument_list|(
literal|"testGetQueueInfoPreemptionEnabled"
argument_list|,
literal|2
argument_list|,
literal|1
...
return|;
block|}
DECL|method|createAndGetQueueCLI (YarnClient client)
specifier|private
name|QueueCLI
name|createAndGetQueueCLI
parameter_list|(
...
return|;
block|}
DECL|method|createAndGetNodeCLI ()
specifier|private
name|NodeCLI
name|createAndGetNodeCLI
parameter_list|()
...
name|println
argument_list|(
literal|" -clusterId<Cluster ID>                  ClusterId. By default, it will"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                                          take default cluster id from the"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|"                                          Multiple components should be"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|" -decommission<Application Name>         Decommissions component"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                                          instances for an application /"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                                          long-running service. Requires"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                                          -instances option. Supports"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|"                                          application. Also works with"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                                          -decommission option to"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                                          decommission specified component"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|"                                          should be separated by commas."
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|" -clusterId<Cluster ID>            ClusterId. By default, it will take"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                                    default cluster id from the RM"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|" -clusterId<Cluster ID>          ClusterId. By default, it will take default cluster id from the RM "
argument_list|)
expr_stmt|;
name|pw
operator|.
