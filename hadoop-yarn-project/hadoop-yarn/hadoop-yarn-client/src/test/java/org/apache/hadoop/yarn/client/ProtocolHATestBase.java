...
return|;
block|}
DECL|method|startHACluster (int numOfNMs, boolean overrideClientRMService, boolean overrideRTS)
specifier|protected
name|void
name|startHACluster
parameter_list|(
...
argument_list|)
decl_stmt|;
DECL|method|MiniYARNClusterForHATesting (String testName, int numResourceManagers, int numNodeManagers, int numLocalDirs, int numLogDirs, boolean enableAHS, boolean overrideClientRMService, boolean overrideRTS)
specifier|public
name|MiniYARNClusterForHATesting
parameter_list|(
name|String
