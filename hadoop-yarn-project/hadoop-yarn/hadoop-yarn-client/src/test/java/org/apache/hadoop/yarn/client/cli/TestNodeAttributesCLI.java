...
operator|+
literal|"attribute1[=value],attribute2  node2:attribute2[=value],attribute3\">"
operator|+
literal|" :"
argument_list|)
expr_stmt|;
...
name|assertOutputContains
argument_list|(
literal|"Can be used optionally along with other options. When"
operator|+
literal|" its set, it will fail if specified nodes are unknown."
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|assertFailureMessageContains
argument_list|(
literal|"Attributes cannot be null or empty for Operation REMOVE on the node x"
argument_list|)
expr_stmt|;
comment|// --------------------------------
comment|// success scenarios
...
expr_stmt|;
block|}
DECL|method|assertOutputContains (String... messages)
specifier|private
name|void
name|assertOutputContains
parameter_list|(
