...
throw|;
block|}
comment|// sleep to let NM's heartbeat to RM to confirm container launch
name|sleep
argument_list|(
literal|200
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// After first allocate request check change size
name|Assert
operator|.
name|assertEquals
argument_list|(
...
break|break;
block|}
comment|// increase request is served after next NM heart beat is received
comment|// Sleeping and retrying allocate
name|sleep
argument_list|(
literal|20
argument_list|)
