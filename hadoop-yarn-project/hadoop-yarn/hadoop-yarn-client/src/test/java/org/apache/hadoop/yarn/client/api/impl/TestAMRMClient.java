...
literal|60000
argument_list|)
DECL|method|testNoUpdateTrackingUrl ()
specifier|public
name|void
name|testNoUpdateTrackingUrl
parameter_list|()
block|{
try|try
block|{
...
name|mockRM
expr_stmt|;
comment|// Do allocate without updated tracking url
name|amClient
operator|.
name|allocate
argument_list|(
...
name|AssertionError
argument_list|(
literal|"testNoUpdateTrackingUrl unexpectedly threw exception: "
operator|+
name|e
argument_list|)
throw|;
...
name|mockRM
expr_stmt|;
comment|// Do allocate with updated tracking url
name|amClient
operator|.
...
name|AssertionError
argument_list|(
literal|"testUpdateTrackingUrl unexpectedly threw exception: "
operator|+
name|e
argument_list|)
throw|;
