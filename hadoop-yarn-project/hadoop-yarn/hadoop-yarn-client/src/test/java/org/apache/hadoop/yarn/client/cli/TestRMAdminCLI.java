...
annotation|@
name|Test
DECL|method|testNoUnsupportedHACommandsInHelp ()
specifier|public
name|void
name|testNoUnsupportedHACommandsInHelp
parameter_list|()
throws|throws
name|Exception
block|{
...
name|contains
argument_list|(
literal|"transitionToObserver: Unknown command"
argument_list|)
argument_list|)
expr_stmt|;
name|dataErr
...
name|contains
argument_list|(
literal|"failover: Unknown command"
argument_list|)
argument_list|)
expr_stmt|;
name|dataErr
