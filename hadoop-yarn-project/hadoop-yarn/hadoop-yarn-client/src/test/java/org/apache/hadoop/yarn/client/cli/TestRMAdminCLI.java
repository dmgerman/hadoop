...
annotation|@
name|Test
DECL|method|testReplaceLabelsOnNodeWithPort ()
specifier|public
name|void
name|testReplaceLabelsOnNodeWithPort
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"-replaceLabelsOnNode"
block|,
literal|"node1:8000,x,y node2:8000,y"
block|,
literal|"-directlyAccessNodeLabelStore"
block|}
decl_stmt|;
...
name|Exception
block|{
comment|// Successfully get labels
name|String
index|[]
name|args
init|=
...
annotation|@
name|Test
DECL|method|testGetNodeToLabels ()
specifier|public
name|void
name|testGetNodeToLabels
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Successfully get node-to-labels
name|String
index|[]
name|args
init|=
