...
literal|60000
argument_list|)
DECL|method|testAMRMClientWithPlacementConstraints ()
specifier|public
name|void
name|testAMRMClientWithPlacementConstraints
parameter_list|()
throws|throws
name|Exception
block|{
...
return|;
block|}
DECL|method|schedulingRequest (int numAllocations, int priority, long allocReqId, int cores, int mem, ExecutionType execType, String... tags)
specifier|private
specifier|static
name|SchedulingRequest
name|schedulingRequest
