...
name|println
argument_list|(
literal|"                                 exact matched log files. Use \"ALL\" or"
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|"                                 container. Specific -regex for using java"
argument_list|)
expr_stmt|;
name|pw
operator|.
name|println
argument_list|(
literal|"                                 regex to find matched log files."
argument_list|)
expr_stmt|;
name|pw
operator|.
...
name|println
argument_list|(
literal|" -regex                          Work with -log_files to find matched"
argument_list|)
expr_stmt|;
name|pw
operator|.
