...
argument_list|()
operator|+
literal|"/bucket-logs-tfile/0001/application_0_0001"
argument_list|)
decl_stmt|;
if|if
condition|(
...
argument_list|()
expr_stmt|;
comment|// specify how many bytes we should get from an empty log
name|exitCode
operator|=
name|cli
operator|.
...
argument_list|)
expr_stmt|;
comment|// create the remote app dir for app but for a different user testUser
name|Path
name|path
init|=
operator|new
...
name|testUser
operator|+
literal|"/bucket-logs-tfile/0001/"
operator|+
name|appId
argument_list|)
decl_stmt|;
...
argument_list|()
expr_stmt|;
comment|// Verify appOwner guessed correctly with older log dir dtructure
name|path
operator|=
operator|new
name|Path
...
name|priorityUser
operator|+
literal|"/bucket-logs-tfile/1000/"
operator|+
name|appTest
argument_list|)
decl_stmt|;
...
literal|5000
argument_list|)
DECL|method|testGuessAppOwnerWithCustomSuffix ()
specifier|public
name|void
name|testGuessAppOwnerWithCustomSuffix
parameter_list|()
throws|throws
name|Exception
block|{
...
try|try
block|{
comment|// Test New App Log Dir Struture (after YARN-6929) with Custom Suffix
name|ApplicationId
name|appId1
init|=
name|ApplicationId
...
argument_list|)
expr_stmt|;
comment|// Test Old App Log Dir Struture (before YARN-6929) with Custom Suffix
name|ApplicationId
name|appId2
init|=
name|ApplicationId
...
literal|5000
argument_list|)
DECL|method|testGuessAppOwnerWithCustomAppLogDir ()
specifier|public
name|void
name|testGuessAppOwnerWithCustomAppLogDir
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
name|String
name|remoteLogRootDir1
init|=
literal|"target/logs1/"
decl_stmt|;
name|String
name|jobUser
init|=
...
try|try
block|{
comment|// Test Custom App Log Dir Structure
name|ApplicationId
name|appId1
init|=
name|ApplicationId
...
name|jobUser
operator|+
literal|"/bucket-logs-indexed/0003/"
operator|+
name|appId1
argument_list|)
decl_stmt|;
...
argument_list|()
operator|+
literal|"/bucket-logs-tfile/0001/application_1440536969523_0001"
argument_list|)
decl_stmt|;
if|if
condition|(
...
block|}
block|}
DECL|method|createContainerLogInLocalDir (Path appLogsDir, ContainerId containerId, FileSystem fs, List<String> logTypes, List<String> emptyLogTypes)
specifier|private
specifier|static
name|void
name|createContainerLogInLocalDir
...
return|;
block|}
DECL|method|createEmptyLog (String logType)
specifier|private
specifier|static
name|String
name|createEmptyLog
