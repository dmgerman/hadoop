...
operator|+
literal|"Specify comma-separated value to get logs for related AM Container. "
operator|+
literal|"For example, If we specify -am 1,2, we will get the logs for "
operator|+
literal|"the first AM Container as well as the second AM Container. "
operator|+
literal|"To get logs for all AM Containers, use -am ALL. "
operator|+
...
name|println
argument_list|(
literal|"Can not get AMContainers logs for the application:"
operator|+
name|appId
argument_list|)
expr_stmt|;
...
operator|+
literal|"and we can not get Container report for the container: "
operator|+
name|containerIdStr
operator|+
literal|". Please try later or after the application "
operator|+
literal|"finishes."
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|printContainerLogsFromRunningApplication (Configuration conf, String appId, String containerIdStr, String nodeHttpAddress, String nodeId, String[] logFiles, LogCLIHelpers logCliHelper, String appOwner)
specifier|private
name|void
name|printContainerLogsFromRunningApplication
parameter_list|(
