...
literal|""
argument_list|,
literal|"Get node to label mappings"
argument_list|)
argument_list|)
decl|.
name|put
argument_list|(
literal|"-getClusterNodeLabels"
argument_list|,
operator|new
name|UsageInfo
argument_list|(
literal|""
argument_list|,
literal|"Get node labels in the cluster"
argument_list|)
argument_list|)
decl|.
name|put
...
operator|+
literal|" yarn.node-labels.fs-store.uri to a local directory"
operator|+
...
return|;
block|}
DECL|method|addToClusterNodeLabels (Set<String> labels)
specifier|private
name|int
name|addToClusterNodeLabels
parameter_list|(
...
return|;
block|}
DECL|method|sortNodeIdSet (Set<NodeId> nodes)
specifier|private
name|List
argument_list|<
name|NodeId
...
return|;
block|}
DECL|method|sortStrSet (Set<String> labels)
specifier|private
name|List
argument_list|<
name|String
