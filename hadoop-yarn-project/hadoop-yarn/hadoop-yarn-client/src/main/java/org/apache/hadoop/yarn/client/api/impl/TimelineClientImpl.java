...
specifier|private
name|TimelineAuthenticatedURLConnectionFactory
name|urlFactory
decl_stmt|;
...
return|;
block|}
DECL|class|TimelineAuthenticatedURLConnectionFactory
specifier|private
specifier|static
class|class
name|TimelineAuthenticatedURLConnectionFactory
...
name|service
decl_stmt|;
DECL|method|TimelineAuthenticatedURLConnectionFactory ()
specifier|public
name|TimelineAuthenticatedURLConnectionFactory
parameter_list|()
block|{
