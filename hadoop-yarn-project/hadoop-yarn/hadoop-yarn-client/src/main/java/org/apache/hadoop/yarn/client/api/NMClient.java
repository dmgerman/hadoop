...
return|;
block|}
comment|/**    * Localize resources for a container.    * @param containerId     the ID of the container    * @param nodeId          node Id of the container    * @param localResources  resources to localize    */
annotation|@
name|InterfaceStability
operator|.
name|Unstable
DECL|method|localize (ContainerId containerId, NodeId nodeId, Map<String, LocalResource> localResources)
specifier|public
name|void
name|localize
parameter_list|(
...
comment|// do nothing.
block|}
comment|/**    * Get the localization statuses of a container.    *    * @param containerId   the Id of the container    * @param nodeId        node Id of the container    *    * @return the status of a container.    *    * @throws YarnException YarnException.    * @throws IOException IOException.    */
annotation|@
name|InterfaceStability
operator|.
name|Unstable
DECL|method|getLocalizationStatuses ( ContainerId containerId, NodeId nodeId)
specifier|public
name|List
argument_list|<
name|LocalizationStatus
