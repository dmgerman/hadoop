...
name|IOException
function_decl|;
comment|/**    *<p>    * The interface used by client to get Attributes to nodes mapping    * for specified node attributes in existing cluster.    *</p>    *    * @param attributes Attributes for which Attributes to nodes mapping has to    *                   be retrieved.If empty or null is set then will return    *                   all attributes to node mapping in cluster.    * @return Attributes to nodes mappings for specific Attributes.    * @throws YarnException    * @throws IOException    */
annotation|@
name|Public
annotation|@
name|Unstable
