...
name|IOException
function_decl|;
comment|/**    *<p>    * The interface used by client to get node attributes in the cluster.    *</p>    *    * @return cluster node attributes collection    * @throws YarnException when there is a failure in    *                       {@link ApplicationClientProtocol}    * @throws IOException   when there is a failure in    *                       {@link ApplicationClientProtocol}    */
annotation|@
name|Public
annotation|@
name|Unstable
DECL|method|getClusterAttributes ()
specifier|public
specifier|abstract
name|Set
argument_list|<
...
name|IOException
function_decl|;
comment|/**    *<p>    * The interface used by client to get a shell to a container.    *</p>    *    * @param containerId Container ID    * @param command Shell type    * @throws IOException if connection fails.    */
annotation|@
name|Public
annotation|@
name|Unstable
DECL|method|shellToContainer (ContainerId containerId, ShellContainerCommand command)
specifier|public
specifier|abstract
name|void
