...
block|}
block|}
DECL|method|removePendingChangeRequests ( List<Container> changedContainers)
specifier|protected
name|void
name|removePendingChangeRequests
parameter_list|(
...
block|}
block|}
DECL|method|validateContainerResourceChangeRequest ( ContainerId containerId, Resource original, Resource target)
specifier|private
name|void
name|validateContainerResourceChangeRequest
parameter_list|(
...
comment|// previously then sending 0 ought to be a no-op on RM
if|if
condition|(
name|resourceRequestInfo
operator|!=
