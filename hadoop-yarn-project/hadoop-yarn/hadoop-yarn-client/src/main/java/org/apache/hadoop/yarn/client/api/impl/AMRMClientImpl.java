...
argument_list|()
decl_stmt|;
DECL|field|batchedSchedulingRequests
specifier|private
name|Queue
argument_list|<
name|Collection
...
argument_list|>
argument_list|>
name|batchedSchedulingRequests
init|=
operator|new
name|LinkedList
argument_list|<>
...
decl_stmt|;
DECL|method|ResourceRequestInfo (Long allocationRequestId, Priority priority, String resourceName, Resource capability, boolean relaxLocality, String resourceProfile)
name|ResourceRequestInfo
parameter_list|(
name|Long
...
DECL|class|ProfileCapabilityComparator
specifier|static
class|class
...
name|resourceProfilesMap
decl_stmt|;
DECL|method|ProfileCapabilityComparator ( HashMap<String, Resource> resourceProfileMap)
specifier|public
name|ProfileCapabilityComparator
parameter_list|(
name|HashMap
...
expr_stmt|;
block|}
DECL|method|compare (T arg0, T arg1)
specifier|public
name|int
name|compare
parameter_list|(
...
block|}
block|}
DECL|method|canFit (ProfileCapability arg0, ProfileCapability arg1)
name|boolean
name|canFit
parameter_list|(
name|ProfileCapability
...
argument_list|)
expr_stmt|;
name|recreateSchedulingRequestBatch
argument_list|()
expr_stmt|;
block|}
return|return
...
argument_list|()
expr_stmt|;
name|populateSchedulingRequests
argument_list|(
name|allocateRequest
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|populateSchedulingRequests (AllocateRequest allocateRequest)
specifier|private
name|void
name|populateSchedulingRequests
parameter_list|(
...
block|}
block|}
DECL|method|recreateSchedulingRequestBatch ()
specifier|private
name|void
name|recreateSchedulingRequestBatch
parameter_list|()
...
block|}
block|}
DECL|method|addToOutstandingSchedulingRequests ( Collection<SchedulingRequest> requests)
specifier|private
name|void
name|addToOutstandingSchedulingRequests
parameter_list|(
...
block|}
block|}
DECL|method|isMatching (SchedulingRequest schedReq1, SchedulingRequest schedReq2)
specifier|private
name|boolean
name|isMatching
parameter_list|(
...
return|;
block|}
DECL|method|removeFromOutstandingSchedulingRequests ( Collection<Container> containers)
specifier|private
name|void
name|removeFromOutstandingSchedulingRequests
parameter_list|(
...
block|}
block|}
DECL|method|checkResourceProfile (String profile)
specifier|private
name|void
name|checkResourceProfile
parameter_list|(
...
name|InvalidContainerRequestException
argument_list|(
literal|"Invalid profile name, valid profile names are "
operator|+
name|resourceProfilesMap
operator|.
name|keySet
...
expr_stmt|;
block|}
DECL|method|addResourceRequest (Priority priority, String resourceName, ExecutionTypeRequest execTypeReq, ProfileCapability capability, T req, boolean relaxLocality, String labelExpression)
specifier|private
name|void
name|addResourceRequest
parameter_list|(
