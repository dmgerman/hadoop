...
expr_stmt|;
block|}
comment|/**    * Lists the applications matching the given application Types    * present in the Resource Manager    *     * @param appTypes    * @throws YarnException    * @throws IOException    */
DECL|method|listApplications (Set<String> appTypes)
specifier|private
name|void
name|listApplications
parameter_list|(
