...
literal|true
argument_list|,
literal|"Launches application from "
operator|+
literal|"specification file (saves specification and starts application). "
operator|+
literal|"Options -updateLifetime and -changeQueue can be specified to alter"
operator|+
literal|" the values provided in the file. Supports -appTypes option to "
operator|+
literal|"specify which client implementation to use."
argument_list|)
expr_stmt|;
name|opts
operator|.
...
operator|+
literal|" the appType will be looked up. Supports -appTypes option to "
operator|+
literal|"specify which client implementation to use."
argument_list|)
expr_stmt|;
...
literal|true
argument_list|,
literal|"Starts a previously saved "
operator|+
literal|"application. Supports -appTypes option to specify which client "
operator|+
...
literal|true
argument_list|,
literal|"Saves specification file for "
operator|+
literal|"an application. Options -updateLifetime and -changeQueue can be "
operator|+
...
literal|true
argument_list|,
literal|"Changes number of "
operator|+
literal|"running containers for a component of an application / "
operator|+
literal|"long-running service. Requires -component option. If name is "
operator|+
literal|"provided, appType must be provided unless it is the default "
operator|+
literal|"yarn-service. If ID is provided, the appType will be looked up. "
operator|+
literal|"Supports -appTypes option to specify which client implementation "
operator|+
literal|"to use."
...
literal|true
argument_list|,
literal|"Decommissions component "
operator|+
literal|"instances for an application / long-running service. Requires "
operator|+
literal|"-instances option. Supports -appTypes option to specify which "
operator|+
literal|"client implementation to use."
argument_list|)
expr_stmt|;
name|opts
operator|.
...
literal|true
argument_list|,
literal|"Works with -flex option to change "
operator|+
literal|"the number of components/containers running for an application / "
operator|+
...
literal|true
argument_list|,
literal|"Upgrades an application/long-"
operator|+
literal|"running service. It requires either -initiate, -instances, or "
operator|+
...
literal|"Works with -upgrade option to "
operator|+
literal|"trigger the upgrade of specified components of the application. "
operator|+
literal|"Multiple components should be separated by commas."
argument_list|)
expr_stmt|;
name|opts
operator|.
...
literal|"ClusterId. "
operator|+
literal|"By default, it will take default cluster id from the RM"
argument_list|)
expr_stmt|;
name|opts
operator|.
...
literal|true
argument_list|,
literal|"List containers for application attempt when application "
operator|+
literal|"attempt ID is provided. When application name is provided, "
operator|+
literal|"then it finds the instances of the application based on app's "
operator|+
literal|"own implementation, and -appTypes option must be specified "
operator|+
literal|"unless it is the default yarn-service type. With app name, it "
operator|+
literal|"supports optional use of -version to filter instances based on "
operator|+
literal|"app version, -components to filter instances based on component "
operator|+
literal|"names, -states to filter instances based on instance state."
argument_list|)
expr_stmt|;
name|opts
operator|.
...
literal|"Works with -list to "
operator|+
literal|"specify the app type when application name is provided."
argument_list|)
expr_stmt|;
name|opts
operator|.
...
literal|"Works with -list "
operator|+
literal|"to filter instances based on input application version."
argument_list|)
expr_stmt|;
name|opts
operator|.
...
literal|"Works with -list to "
operator|+
literal|"filter instances based on input comma-separated list of "
operator|+
