...
argument_list|)
decl_stmt|;
comment|/**    * Buld the user path -switches to the system path if the user is "".    * It also cross-converts the username to ascii via punycode    * @param shortname username or ""    * @return the path to the user    */
DECL|method|homePathForUser (String shortname)
specifier|public
specifier|static
name|String
