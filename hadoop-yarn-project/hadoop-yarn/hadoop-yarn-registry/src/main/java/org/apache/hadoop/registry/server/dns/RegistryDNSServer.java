...
decl_stmt|;
comment|/**    * Creates the DNS server.    * @param name the server name.    * @param registryDNS the registry DNS instance.    */
DECL|method|RegistryDNSServer (String name, final RegistryDNS registryDNS)
specifier|public
name|RegistryDNSServer
parameter_list|(
name|String
...
expr_stmt|;
block|}
comment|/**    * Launch the server.    * @param conf configuration    * @param rdns registry dns instance    * @return    */
DECL|method|launchDNSServer (Configuration conf, RegistryDNS rdns)
specifier|static
name|RegistryDNSServer
...
return|;
block|}
comment|/**    * Lanches the server instance.    * @param args the command line args.    * @throws IOException if command line options can't be parsed    */
