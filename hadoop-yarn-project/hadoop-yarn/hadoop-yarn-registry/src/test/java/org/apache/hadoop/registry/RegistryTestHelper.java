...
name|API_WEBHDFS
init|=
literal|"org_apache_hadoop_namenode_webhdfs"
decl_stmt|;
DECL|field|API_HDFS
specifier|public
specifier|static
...
name|API_HDFS
init|=
literal|"org_apache_hadoop_namenode_dfs"
decl_stmt|;
DECL|field|USERPATH
specifier|public
specifier|static
...
return|;
block|}
comment|/**    * Exec the native<code>ktutil</code> to list the keys    * (primarily to verify that the generated keytabs are compatible).    * This operation is not executed on windows. On other platforms    * it requires<code>ktutil</code> to be installed and on the path    *<pre>    *   ktutil --keytab=target/kdc/zookeeper.keytab list --keys    *</pre>    * @param keytab keytab to list    * @throws IOException on any execution problem, including the executable    * being missing    */
DECL|method|ktList (File keytab)
specifier|public
specifier|static
name|String
name|ktList
...
return|;
block|}
comment|/**    * Perform a robust<code>ktutils -l</code> ... catches and ignores    * exceptions, otherwise the output is logged.    * @param keytab keytab to list    * @return the result of the operation, or "" on any problem    */
DECL|method|ktListRobust (File keytab)
specifier|public
specifier|static
name|String
name|ktListRobust
...
parameter_list|)
block|{
comment|// probably not on the path
return|return
literal|""
return|;
block|}
