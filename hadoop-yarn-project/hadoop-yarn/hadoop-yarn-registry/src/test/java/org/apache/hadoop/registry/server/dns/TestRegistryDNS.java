...
return|;
block|}
DECL|method|assertDNSQueryNotNull (String lookup, int type, int answerCount)
name|Record
index|[]
name|assertDNSQueryNotNull
parameter_list|(
name|String
name|lookup
parameter_list|,
...
annotation|@
name|Test
DECL|method|testExternalCNAMERecord ()
specifier|public
name|void
name|testExternalCNAMERecord
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|5000
argument_list|)
DECL|method|testUpstreamFault ()
specifier|public
name|void
name|testUpstreamFault
parameter_list|()
throws|throws
name|Exception
block|{
