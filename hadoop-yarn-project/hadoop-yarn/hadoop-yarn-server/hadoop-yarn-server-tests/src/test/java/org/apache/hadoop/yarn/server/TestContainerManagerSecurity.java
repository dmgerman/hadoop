...
literal|1000000
argument_list|)
DECL|method|testContainerManagerWithSecurityEnabled ()
specifier|public
name|void
name|testContainerManagerWithSecurityEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|1000000
argument_list|)
DECL|method|testContainerManagerWithSecurityDisabled ()
specifier|public
name|void
name|testContainerManagerWithSecurityDisabled
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Testing for authenticated user
name|testAuthenticatedUser
argument_list|()
expr_stmt|;
comment|// Testing for malicious user
name|testMaliceUser
argument_list|()
expr_stmt|;
comment|// Testing for usage of expired tokens
name|testExpiredTokens
argument_list|()
expr_stmt|;
block|}
finally|finally
...
argument_list|)
decl_stmt|;
name|makeTamperedStartContainerCall
argument_list|(
name|yarnRPC
argument_list|,
name|allocatedContainer
...
argument_list|)
expr_stmt|;
comment|// Malice user modifies the container-Id
name|ContainerId
name|newContainerId
init|=
name|BuilderUtils
...
argument_list|)
expr_stmt|;
comment|// Similarly messing with anything else will fail.
name|KillApplicationRequest
name|request
init|=
name|Records
...
expr_stmt|;
block|}
DECL|method|makeTamperedStartContainerCall (final YarnRPC yarnRPC, final Container allocatedContainer, final ContainerTokenIdentifier modifiedIdentifier, Token<ContainerTokenIdentifier> modifiedToken)
specifier|private
name|void
name|makeTamperedStartContainerCall
parameter_list|(
