...
argument_list|()
expr_stmt|;
comment|// Testing for unauthorized user
...
return|;
block|}
DECL|method|callWithIllegalContainerID (ContainerManager client, ContainerTokenIdentifier tokenId, Container container)
name|void
name|callWithIllegalContainerID
parameter_list|(
name|ContainerManager
...
block|}
block|}
DECL|method|callWithIllegalResource (ContainerManager client, ContainerTokenIdentifier tokenId, Container container)
name|void
name|callWithIllegalResource
parameter_list|(
name|ContainerManager
...
expr_stmt|;
block|}
DECL|method|callWithIllegalUserName (ContainerManager client, ContainerTokenIdentifier tokenId, Container container)
name|void
name|callWithIllegalUserName
parameter_list|(
name|ContainerManager
