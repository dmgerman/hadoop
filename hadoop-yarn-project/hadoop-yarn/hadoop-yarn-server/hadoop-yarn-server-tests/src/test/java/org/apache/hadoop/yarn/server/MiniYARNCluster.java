...
return|;
block|}
comment|/**    * In a HA cluster, go through all the RMs and find the Active RM. If none    * of them are active, wait upto 5 seconds for them to transition to Active.    *    * In an non-HA cluster, return the index of the only RM.    *    * @return index of the active RM    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
