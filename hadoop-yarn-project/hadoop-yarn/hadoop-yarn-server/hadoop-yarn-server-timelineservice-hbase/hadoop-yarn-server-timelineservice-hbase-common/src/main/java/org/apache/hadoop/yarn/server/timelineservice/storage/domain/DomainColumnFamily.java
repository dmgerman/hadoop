...
begin_comment
comment|/**  * Represents the domain table column families.  */
end_comment

begin_enum
DECL|enum|DomainColumnFamily
specifier|public
enum|enum
...
argument_list|>
block|{
comment|/**    * Info column family houses known columns such as created_time, owners,    * readers.    */
...
DECL|method|DomainColumnFamily (String value)
name|DomainColumnFamily
parameter_list|(
name|String
name|value
