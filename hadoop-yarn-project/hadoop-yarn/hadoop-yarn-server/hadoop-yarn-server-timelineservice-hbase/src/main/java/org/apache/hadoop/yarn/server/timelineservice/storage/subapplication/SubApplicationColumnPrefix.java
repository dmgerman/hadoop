...
begin_comment
comment|/**  * Identifies partially qualified columns for the sub app table.  */
end_comment

begin_enum
DECL|enum|SubApplicationColumnPrefix
specifier|public
enum|enum
...
DECL|method|SubApplicationColumnPrefix (ColumnFamily<SubApplicationTable> columnFamily, String columnPrefix)
name|SubApplicationColumnPrefix
parameter_list|(
name|ColumnFamily
argument_list|<
...
expr_stmt|;
block|}
DECL|method|SubApplicationColumnPrefix (ColumnFamily<SubApplicationTable> columnFamily, String columnPrefix, boolean compondColQual)
name|SubApplicationColumnPrefix
parameter_list|(
name|ColumnFamily
argument_list|<
...
expr_stmt|;
block|}
DECL|method|SubApplicationColumnPrefix (ColumnFamily<SubApplicationTable> columnFamily, String columnPrefix, ValueConverter converter)
name|SubApplicationColumnPrefix
parameter_list|(
name|ColumnFamily
argument_list|<
...
DECL|method|SubApplicationColumnPrefix (ColumnFamily<SubApplicationTable> columnFamily, String columnPrefix, boolean compondColQual, ValueConverter converter)
name|SubApplicationColumnPrefix
parameter_list|(
name|ColumnFamily
argument_list|<
...
DECL|method|store (byte[] rowKey, TypedBufferedMutator<SubApplicationTable> tableMutator, String qualifier, Long timestamp, Object inputValue, Attribute... attributes)
specifier|public
name|void
name|store
parameter_list|(
...
DECL|method|store (byte[] rowKey, TypedBufferedMutator<SubApplicationTable> tableMutator, byte[] qualifier, Long timestamp, Object inputValue, Attribute... attributes)
specifier|public
name|void
name|store
parameter_list|(
