...
begin_comment
comment|/**  * Represents a partial rowkey without the entityId or without entityType and  * entityId for the entity table.  *  */
end_comment

begin_class
DECL|class|EntityRowKeyPrefix
specifier|public
class|class
...
expr_stmt|;
block|}
comment|/**    * Creates a prefix which generates the following rowKeyPrefixes for the    * entity table:    * {@code userName!clusterId!flowName!flowRunId!AppId!entityType!entityId}.    *    * @param clusterId identifying the cluster    * @param userId identifying the user    * @param flowName identifying the flow    * @param flowRunId identifying the individual run of this flow    * @param appId identifying the application    */
DECL|method|EntityRowKeyPrefix (String clusterId, String userId, String flowName, Long flowRunId, String appId)
specifier|public
name|EntityRowKeyPrefix
parameter_list|(
name|String
