...
return|;
block|}
comment|/**    * Creates a HBase {@link SingleColumnValueFilter} with specified column.    * @param<T> Describes the type of column prefix.    * @param column Column which value to be filtered.    * @param value Value to be filtered.    * @param op Compare operator    * @return a SingleColumnValue Filter    * @throws IOException if any exception.    */
DECL|method|createHBaseSingleColValueFilter (Column<T> column, Object value, CompareOp op)
specifier|public
specifier|static
parameter_list|<
name|T
