...
begin_class
DECL|class|SubApplicationEntityReader
class|class
name|SubApplicationEntityReader
extends|extends
name|GenericEntityReader
block|{
DECL|field|SUB_APPLICATION_TABLE
specifier|private
specifier|static
specifier|final
name|SubApplicationTable
name|SUB_APPLICATION_TABLE
init|=
operator|new
name|SubApplicationTable
argument_list|()
decl_stmt|;
DECL|method|SubApplicationEntityReader (TimelineReaderContext ctxt, TimelineEntityFilters entityFilters, TimelineDataToRetrieve toRetrieve)
name|SubApplicationEntityReader
parameter_list|(
name|TimelineReaderContext
name|ctxt
...
expr_stmt|;
block|}
DECL|method|SubApplicationEntityReader (TimelineReaderContext ctxt, TimelineDataToRetrieve toRetrieve)
name|SubApplicationEntityReader
parameter_list|(
name|TimelineReaderContext
name|ctxt
...
expr_stmt|;
block|}
comment|/**    * Uses the {@link SubApplicationTable}.    */
...
argument_list|()
argument_list|,
literal|"DoAsUser shouldn't be null"
argument_list|)
expr_stmt|;
name|Preconditions
operator|.
...
expr_stmt|;
block|}
DECL|method|setMetricsTimeRange (Query query)
specifier|private
name|void
...
parameter_list|)
block|{
comment|// Set time range for metric values.
name|HBaseTimelineStorageUtils
operator|.
name|setMetricsTimeRange
argument_list|(
...
name|BadRequestException
argument_list|(
literal|"Invalid filter fromid is provided."
argument_list|)
throw|;
block|}
if|if
...
name|BadRequestException
argument_list|(
literal|"fromid doesn't belong to clusterId="
operator|+
name|context
operator|.
name|getClusterId
