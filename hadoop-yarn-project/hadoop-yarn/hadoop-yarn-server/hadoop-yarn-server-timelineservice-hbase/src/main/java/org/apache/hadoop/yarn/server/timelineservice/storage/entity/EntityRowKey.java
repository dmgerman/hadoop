...
return|;
block|}
comment|/**    * Constructs a row key for the entity table as follows:    *<p>    * {@code userName!clusterId!flowName!flowRunId!AppId!    * entityType!entityIdPrefix!entityId}.    *</p>    * @return String representation of row key.    */
...
return|;
block|}
comment|/**    * Given the encoded row key as string, returns the row key as an object.    * @param encodedRowKey String representation of row key.    * @return A<cite>EntityRowKey</cite> object.    */
...
annotation|@
name|Override
DECL|method|encodeAsString (EntityRowKey key)
specifier|public
name|String
name|encodeAsString
parameter_list|(
