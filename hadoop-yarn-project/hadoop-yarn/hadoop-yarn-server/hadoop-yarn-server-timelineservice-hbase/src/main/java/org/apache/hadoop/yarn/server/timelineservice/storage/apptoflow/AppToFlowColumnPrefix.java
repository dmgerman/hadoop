...
annotation|@
name|Override
DECL|method|store (byte[] rowKey, TypedBufferedMutator<AppToFlowTable> tableMutator, byte[] qualifier, Long timestamp, Object inputValue, Attribute... attributes)
specifier|public
name|void
name|store
parameter_list|(
...
annotation|@
name|Override
DECL|method|store (byte[] rowKey, TypedBufferedMutator<AppToFlowTable> tableMutator, String qualifier, Long timestamp, Object inputValue, Attribute... attributes)
specifier|public
name|void
name|store
parameter_list|(
...
return|;
block|}
comment|/**    * Retrieve an {@link AppToFlowColumnPrefix} given a name, or null if there    * is no match. The following holds true: {@code columnFor(x) == columnFor(y)}    * if and only if {@code x.equals(y)} or {@code (x == y == null)}    *    * @param columnPrefix Name of the column to retrieve    * @return the corresponding {@link AppToFlowColumnPrefix} or null    */
