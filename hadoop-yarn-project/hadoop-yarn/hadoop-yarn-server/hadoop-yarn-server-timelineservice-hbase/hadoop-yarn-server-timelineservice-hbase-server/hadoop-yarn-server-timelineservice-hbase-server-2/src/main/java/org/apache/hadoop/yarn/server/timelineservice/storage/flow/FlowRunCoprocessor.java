...
block|}
block|}
comment|/*    * (non-Javadoc)    *    * Ensures that max versions are set for the Scan so that metrics can be    * correctly aggregated and min/max can be correctly determined.    *    * @see    * org.apache.hadoop.hbase.coprocessor.BaseRegionObserver#preScannerOpen(org    * .apache.hadoop.hbase.coprocessor.ObserverContext,    * org.apache.hadoop.hbase.client.Scan)    */
annotation|@
name|Override
DECL|method|preScannerOpen ( ObserverContext<RegionCoprocessorEnvironment> e, Scan scan)
specifier|public
name|void
name|preScannerOpen
parameter_list|(
...
annotation|@
name|Override
DECL|method|preFlush ( ObserverContext<RegionCoprocessorEnvironment> c, Store store, InternalScanner scanner, FlushLifeCycleTracker cycleTracker)
specifier|public
name|InternalScanner
name|preFlush
parameter_list|(
...
annotation|@
name|Override
DECL|method|postFlush (ObserverContext<RegionCoprocessorEnvironment> c, Store store, StoreFile resultFile, FlushLifeCycleTracker tracker)
specifier|public
name|void
name|postFlush
parameter_list|(
...
annotation|@
name|Override
DECL|method|preCompact ( ObserverContext<RegionCoprocessorEnvironment> e, Store store, InternalScanner scanner, ScanType scanType, CompactionLifeCycleTracker tracker, CompactionRequest request)
specifier|public
name|InternalScanner
name|preCompact
parameter_list|(
