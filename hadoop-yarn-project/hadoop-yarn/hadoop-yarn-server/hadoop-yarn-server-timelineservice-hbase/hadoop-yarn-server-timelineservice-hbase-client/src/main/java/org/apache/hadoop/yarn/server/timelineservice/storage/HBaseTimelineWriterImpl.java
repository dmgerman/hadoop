...
name|subapplication
operator|.
name|SubApplicationColumnPrefix
import|;
end_import
...
name|flowRunTable
decl_stmt|;
DECL|field|subApplicationTable
specifier|private
name|TypedBufferedMutator
argument_list|<
name|SubApplicationTable
...
name|Tables
block|{
DECL|enumConstant|APPLICATION_TABLE
DECL|enumConstant|ENTITY_TABLE
DECL|enumConstant|SUBAPPLICATION_TABLE
name|APPLICATION_TABLE
block|,
name|ENTITY_TABLE
block|,
name|SUBAPPLICATION_TABLE
block|}
empty_stmt|;
...
name|warn
argument_list|(
literal|"Found null for clusterId. Not proceeding with writing to hbase"
argument_list|)
expr_stmt|;
return|return
name|putStatus
...
DECL|method|store (byte[] rowKey, TimelineEntity te, String flowVersion, Tables table)
specifier|private
name|void
name|store
parameter_list|(
...
name|info
argument_list|(
literal|"Invalid table name provided."
argument_list|)
expr_stmt|;
break|break;
block|}
block|}
comment|/**    * stores the info information from {@linkplain TimelineEntity}.    */
DECL|method|storeInfo (byte[] rowKey, Map<String, Object> info, String flowVersion, ColumnPrefix<T> columnPrefix, TypedBufferedMutator<T > table)
specifier|private
parameter_list|<
name|T
extends|extends
...
DECL|method|storeConfig ( byte[] rowKey, Map<String, String> config, ColumnPrefix<T> columnPrefix, TypedBufferedMutator<T> table)
specifier|private
parameter_list|<
name|T
extends|extends
...
DECL|method|storeMetrics ( byte[] rowKey, Set<TimelineMetric> metrics, ColumnPrefix<T> columnPrefix, TypedBufferedMutator<T> table)
specifier|private
parameter_list|<
name|T
extends|extends
...
DECL|method|storeEvents ( byte[] rowKey, Set<TimelineEvent> events, ColumnPrefix<T> columnPrefix, TypedBufferedMutator<T> table)
specifier|private
parameter_list|<
name|T
extends|extends
...
name|warn
argument_list|(
literal|"Failed to close the timeline tables as Hbase is down"
argument_list|,
name|e
argument_list|)
expr_stmt|;
