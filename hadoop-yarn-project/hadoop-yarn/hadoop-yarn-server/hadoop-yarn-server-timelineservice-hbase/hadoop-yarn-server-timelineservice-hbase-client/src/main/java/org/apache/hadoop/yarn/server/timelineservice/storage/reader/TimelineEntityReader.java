...
argument_list|)
decl_stmt|;
name|extractColumnFamiliesFromFiltersBasedOnFilters
argument_list|(
name|listBasedOnFilters
argument_list|,
name|cfsInListBasedOnFilters
argument_list|)
expr_stmt|;
comment|// must exclude cfs that are already covered in fields-based filters
comment|// otherwise we will return the whole cf
name|cfsInListBasedOnFilters
operator|.
name|removeAll
argument_list|(
...
return|;
block|}
DECL|method|extractColumnFamiliesFromFiltersBasedOnFilters ( Filter hbaseFilterBasedOnTLSFilter, Set<String> columnFamilies)
specifier|private
specifier|static
name|void
name|extractColumnFamiliesFromFiltersBasedOnFilters
parameter_list|(
name|Filter
name|hbaseFilterBasedOnTLSFilter
parameter_list|,
name|Set
argument_list|<
name|String
...
return|;
block|}
DECL|method|setTable (BaseTableRW<?> baseTable)
specifier|protected
name|void
name|setTable
parameter_list|(
