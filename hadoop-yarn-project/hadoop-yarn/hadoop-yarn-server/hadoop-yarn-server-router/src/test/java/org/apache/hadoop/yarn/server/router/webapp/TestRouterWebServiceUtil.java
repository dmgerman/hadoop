...
argument_list|)
expr_stmt|;
comment|// ensure that we don't reuse the same seed when setting up metricsResponse
comment|// or it might mask bugs
name|seed
operator|+=
literal|1000000000
expr_stmt|;
...
return|;
block|}
DECL|method|setUpClusterMetrics (ClusterMetricsInfo metrics, long seed)
specifier|private
name|void
name|setUpClusterMetrics
parameter_list|(
