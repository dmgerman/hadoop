...
annotation|@
name|Test
DECL|method|testGetClusterMetricsRequest ()
specifier|public
name|void
name|testGetClusterMetricsRequest
parameter_list|()
throws|throws
name|YarnException
throws|,
...
name|info
argument_list|(
literal|"Test FederationClientInterceptor : Get Cluster Metrics request"
argument_list|)
expr_stmt|;
comment|// null request
name|GetClusterMetricsResponse
name|response
init|=
name|interceptor
