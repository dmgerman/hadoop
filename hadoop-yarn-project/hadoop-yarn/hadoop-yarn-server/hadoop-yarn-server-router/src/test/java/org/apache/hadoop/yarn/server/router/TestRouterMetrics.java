...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of the metric: Retrieved Multiple Apps    * successfully.    */
annotation|@
name|Test
DECL|method|testSucceededMultipleAppsReport ()
specifier|public
name|void
name|testSucceededMultipleAppsReport
parameter_list|()
block|{
name|long
name|totalGoodBefore
...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of the metric: Failed to retrieve    * Multiple Apps.    */
annotation|@
name|Test
DECL|method|testMulipleAppsReportFailed ()
specifier|public
name|void
name|testMulipleAppsReportFailed
parameter_list|()
block|{
name|long
name|totalBadbefore
...
expr_stmt|;
block|}
DECL|method|getApplicationsReport ()
specifier|public
name|void
name|getApplicationsReport
parameter_list|()
...
name|info
argument_list|(
literal|"Mocked: failed getApplicationsReport call"
argument_list|)
expr_stmt|;
name|metrics
operator|.
...
expr_stmt|;
block|}
DECL|method|getApplicationsReport (long duration)
specifier|public
name|void
name|getApplicationsReport
parameter_list|(
...
name|info
argument_list|(
literal|"Mocked: successful getApplicationsReport call with duration {}"
argument_list|,
name|duration
argument_list|)
expr_stmt|;
