...
block|{
comment|/** The number of concurrent submissions for multi-thread test. */
DECL|field|NUM_THREADS_TESTS
specifier|private
specifier|static
specifier|final
name|int
name|NUM_THREADS_TESTS
init|=
literal|100
decl_stmt|;
DECL|field|userName
...
DECL|method|waitWebAppRunning ( final String address, final String path)
specifier|private
specifier|static
name|void
...
name|add
argument_list|(
literal|"../hadoop-yarn-server-timelineservice/target/classes"
argument_list|)
expr_stmt|;
name|rm
operator|=
...
DECL|method|performGetCalls (final String path, final Class<T> returnType, final String queryName, final String queryValue)
specifier|private
specifier|static
parameter_list|<
name|T
...
DECL|method|performCall (final String webAddress, final String queryKey, final String queryValue, final Object context, final HTTPMethods method)
specifier|private
specifier|static
name|ClientResponse
name|performCall
...
literal|2000
argument_list|)
DECL|method|testNodesEmptyXML ()
specifier|public
name|void
name|testNodesEmptyXML
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of    * {@link RMWebServiceProtocol#updateNodeResources()} inside Router.    */
annotation|@
name|Test
...
name|Exception
block|{
comment|// wait until a node shows up and check the resources
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// update memory to 4096MB and 5 cores
name|Resource
name|resource
init|=
name|Resource
...
argument_list|)
expr_stmt|;
comment|// Test with a bad request
name|AppTimeoutInfo
name|appTimeoutInfo
init|=
operator|new
...
literal|2000
argument_list|)
DECL|method|testGetLabelsMappingEmptyXML ()
specifier|public
name|void
name|testGetLabelsMappingEmptyXML
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|60000
argument_list|)
DECL|method|testGetAppsMultiThread ()
specifier|public
name|void
name|testGetAppsMultiThread
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// This submits an application
name|testGetContainersXML
argument_list|()
expr_stmt|;
comment|// This submits an application
...
argument_list|()
expr_stmt|;
comment|// Wait at most 10 seconds until we see all the applications
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
...
try|try
block|{
comment|// Check if we have the 2 apps we submitted
return|return
name|getNumApps
argument_list|()
operator|==
...
try|try
block|{
comment|// Submit a bunch of operations concurrently
for|for
control|(
name|int
name|i
...
expr_stmt|;
block|}
comment|/**    * Get the number of applications in the system.    * @return Number of applications in the system    * @throws Exception If we cannot get the applications.    */
DECL|method|getNumApps ()
specifier|private
name|int
name|getNumApps
parameter_list|()
