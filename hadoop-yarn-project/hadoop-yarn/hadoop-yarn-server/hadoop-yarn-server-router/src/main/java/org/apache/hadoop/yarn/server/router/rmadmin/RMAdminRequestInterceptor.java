...
begin_comment
comment|/**  * Defines the contract to be implemented by the request intercepter classes,  * that can be used to intercept and inspect messages sent from the client to  * the resource manager.  */
end_comment

begin_interface
DECL|interface|RMAdminRequestInterceptor
specifier|public
interface|interface
