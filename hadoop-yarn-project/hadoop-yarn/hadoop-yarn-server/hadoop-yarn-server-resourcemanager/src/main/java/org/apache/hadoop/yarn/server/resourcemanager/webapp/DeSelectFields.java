...
argument_list|)
block|,
comment|/**      *<code>APP_TIMEOUTS, APP_NODE_LABEL_EXPRESSION, AM_NODE_LABEL_EXPRESSION,      * RESOURCE_INFO</code> are additionally supported parameters added in      * YARN-6871.      */
DECL|enumConstant|TIMEOUTS
name|TIMEOUTS
argument_list|(
literal|"timeouts"
argument_list|)
block|,
DECL|enumConstant|APP_NODE_LABEL_EXPRESSION
name|APP_NODE_LABEL_EXPRESSION
argument_list|(
literal|"appNodeLabelExpression"
argument_list|)
block|,
DECL|enumConstant|AM_NODE_LABEL_EXPRESSION
name|AM_NODE_LABEL_EXPRESSION
argument_list|(
literal|"amNodeLabelExpression"
argument_list|)
block|,
DECL|enumConstant|RESOURCE_INFO
name|RESOURCE_INFO
argument_list|(
