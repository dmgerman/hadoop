...
expr_stmt|;
block|}
comment|//Return a string describing one resource as a percentage of another
DECL|method|getPercentage (ResourceInfo numerator, ResourceInfo denominator)
specifier|private
name|String
name|getPercentage
parameter_list|(
...
name|append
argument_list|(
literal|" (<span title='of used resources in this queue'>"
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|"&gt;<br style='display:block'>"
argument_list|)
expr_stmt|;
