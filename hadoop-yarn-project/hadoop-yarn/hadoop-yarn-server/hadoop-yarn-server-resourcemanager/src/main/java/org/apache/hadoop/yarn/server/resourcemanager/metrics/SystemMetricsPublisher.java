...
argument_list|)
decl_stmt|;
DECL|field|MAX_GET_TIMELINE_DELEGATION_TOKEN_ATTEMPTS
specifier|private
specifier|static
specifier|final
name|int
name|MAX_GET_TIMELINE_DELEGATION_TOKEN_ATTEMPTS
init|=
literal|10
decl_stmt|;
...
decl_stmt|;
DECL|field|getTimelineDelegtionTokenAttempts
specifier|private
name|int
name|getTimelineDelegtionTokenAttempts
init|=
literal|0
decl_stmt|;
DECL|field|hasReceivedTimelineDelegtionToken
specifier|private
name|boolean
name|hasReceivedTimelineDelegtionToken
init|=
literal|false
decl_stmt|;
...
name|error
argument_list|(
literal|"Error happens when getting timeline delegation token"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Run out of the attempts to get timeline delegation token. "
operator|+
literal|"Use kerberos authentication only."
argument_list|)
expr_stmt|;
block|}
block|}
