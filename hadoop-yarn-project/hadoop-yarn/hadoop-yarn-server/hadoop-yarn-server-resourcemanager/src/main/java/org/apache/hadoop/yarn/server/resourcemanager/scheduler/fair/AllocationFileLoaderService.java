...
argument_list|()
decl_stmt|;
comment|// check whether max resource is bigger or equals to min resource when max
comment|// resource are absolute values
if|if
condition|(
name|maxResource
operator|!=
