...
DECL|method|createSuccessLog (String user, String operation, String target, ApplicationId appId, ApplicationAttemptId attemptId, ContainerId containerId, Resource resource, CallerContext callerContext, InetAddress ip, String queueName, String partition)
specifier|static
name|String
name|createSuccessLog
parameter_list|(
...
block|}
block|}
comment|/**    * Create a readable and parseable audit log string for a successful event.    *    * @param user User who made the service request to the ResourceManager    * @param operation Operation requested by the user.    * @param target The target on which the operation is being performed.    * @param appId Application Id in which operation was performed.    * @param containerId Container Id in which operation was performed.    * @param resource Resource associated with container.    * @param queueName Name of queue.    * @param partition Name of labeled partition.    *    *<br><br>    * Note that the {@link RMAuditLogger} uses tabs ('\t') as a key-val delimiter    * and hence the value fields should not contains tabs ('\t').    */
DECL|method|logSuccess (String user, String operation, String target, ApplicationId appId, ContainerId containerId, Resource resource, String queueName, String partition)
specifier|public
specifier|static
name|void
name|logSuccess
...
block|}
block|}
DECL|method|logSuccess (String user, String operation, String target, ApplicationId appId, CallerContext callerContext, String queueName, String partition)
specifier|public
specifier|static
name|void
name|logSuccess
...
block|}
block|}
DECL|method|logSuccess (String user, String operation, String target, ApplicationId appId, CallerContext callerContext, String queueName)
specifier|public
specifier|static
name|void
name|logSuccess
...
DECL|method|createFailureLog (String user, String operation, String perm, String target, String description, ApplicationId appId, ApplicationAttemptId attemptId, ContainerId containerId, Resource resource, CallerContext callerContext, String queueName, String partition)
specifier|static
name|String
...
block|}
block|}
DECL|method|logFailure (String user, String operation, String perm, String target, String description, ApplicationId appId, CallerContext callerContext, String queueName)
specifier|public
specifier|static
name|void
name|logFailure
...
block|}
block|}
DECL|method|logFailure (String user, String operation, String perm, String target, String description, ApplicationId appId, String queueName)
specifier|public
specifier|static
name|void
name|logFailure
...
block|}
block|}
comment|/**    * Create a readable and parseable audit log string for a failed event.    *    * @param user User who made the service request.    * @param operation Operation requested by the user.    * @param perm Target permissions.    * @param target The target on which the operation is being performed.    * @param description Some additional information as to why the operation    *                    failed.    * @param appId ApplicationId in which operation was performed.    * @param callerContext Caller context    * @param queueName Name of queue.    * @param partition Name of labeled partition.    *    *<br><br>    * Note that the {@link RMAuditLogger} uses tabs ('\t') as a key-val delimiter    * and hence the value fields should not contains tabs ('\t').    */
DECL|method|logFailure (String user, String operation, String perm, String target, String description, ApplicationId appId, CallerContext callerContext, String queueName, String partition)
specifier|public
specifier|static
name|void
name|logFailure
