...
argument_list|)
decl_stmt|;
comment|// Make allocation periodic if request is periodic
if|if
condition|(
name|contract
operator|.
...
block|}
block|}
DECL|method|allocationsToPaddedMap ( RLESparseResourceAllocation allocation, long jobArrival, long jobDeadline, long period)
specifier|private
name|Map
argument_list|<
name|ReservationInterval
