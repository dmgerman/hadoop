...
argument_list|)
decl_stmt|;
DECL|field|numNodesForAnyAllocation
specifier|private
name|int
name|numNodesForAnyAllocation
init|=
name|DEFAULT_OPP_CONTAINER_ALLOCATION_NODES_NUMBER_USED
decl_stmt|;
...
return|;
block|}
comment|/**      * Increment the metric by a delta if it is below the threshold.      * @param c ClusterNode      * @param incrementSize increment size      * @return true if the metric was below threshold and was incremented.      */
DECL|method|compareAndIncrement (ClusterNode c, int incrementSize)
specifier|public
name|boolean
name|compareAndIncrement
parameter_list|(
name|ClusterNode
name|c
parameter_list|,
...
return|;
block|}
comment|// for queue wait time, we don't have any threshold.
return|return
literal|true
return|;
block|}
...
expr_stmt|;
block|}
DECL|method|NodeQueueLoadMonitor (long nodeComputationInterval, LoadComparator comparator, int numNodes)
specifier|public
name|NodeQueueLoadMonitor
parameter_list|(
name|long
...
block|}
block|}
DECL|method|selectLocalNode (String hostName, Set<String> blacklist)
specifier|public
name|RMNode
...
return|;
block|}
DECL|method|selectRackLocalNode (String rackName, Set<String> blacklist)
specifier|public
name|RMNode
...
return|;
block|}
DECL|method|selectAnyNode (Set<String> blacklist)
specifier|public
name|RMNode
name|selectAnyNode
parameter_list|(
...
return|;
block|}
DECL|method|removeFromNodeIdsByRack (RMNode removedNode)
specifier|private
name|void
name|removeFromNodeIdsByRack
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|addIntoNodeIdsByRack (RMNode addedNode)
specifier|private
name|void
name|addIntoNodeIdsByRack
parameter_list|(
