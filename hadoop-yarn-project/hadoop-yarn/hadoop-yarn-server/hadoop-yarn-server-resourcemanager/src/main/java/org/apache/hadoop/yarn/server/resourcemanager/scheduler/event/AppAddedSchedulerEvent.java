...
expr_stmt|;
block|}
DECL|method|AppAddedSchedulerEvent (ApplicationId applicationId, String queue, String user, boolean isAppRecovering, ReservationId reservationID, Priority appPriority)
specifier|public
name|AppAddedSchedulerEvent
parameter_list|(
name|ApplicationId
