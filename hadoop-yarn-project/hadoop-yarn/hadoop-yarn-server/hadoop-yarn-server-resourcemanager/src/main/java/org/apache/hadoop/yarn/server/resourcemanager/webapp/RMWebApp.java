...
name|APISERVER
init|=
literal|"org.apache.hadoop.yarn.service.webapp.ApiServer"
decl_stmt|;
...
try|try
block|{
comment|// Use reflection here to load ApiServer class,
comment|// this is done to avoid creating cyclic dependency
comment|// between maven projects.
name|Class
argument_list|<
name|?
argument_list|>
...
name|warn
argument_list|(
literal|"ApiServer REST API is not activated."
argument_list|)
expr_stmt|;
block|}
block|}
