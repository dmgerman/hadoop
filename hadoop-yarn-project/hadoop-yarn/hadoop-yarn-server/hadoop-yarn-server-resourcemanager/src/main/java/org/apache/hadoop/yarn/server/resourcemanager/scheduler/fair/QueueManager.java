...
expr_stmt|;
block|}
DECL|method|updatePlacementPolicy (FairSchedulerConfiguration conf)
specifier|public
name|void
name|updatePlacementPolicy
parameter_list|(
name|FairSchedulerConfiguration
name|conf
parameter_list|)
block|{        }
comment|/**    * Construct simple queue placement policy from allow-undeclared-pools and    * user-as-default-queue.    */
DECL|method|getSimplePlacementRules ()
specifier|private
name|List
argument_list|<
