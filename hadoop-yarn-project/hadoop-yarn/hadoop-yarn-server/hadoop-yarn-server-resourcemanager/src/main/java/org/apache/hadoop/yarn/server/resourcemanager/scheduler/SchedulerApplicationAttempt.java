...
block|{
return|return
name|pullContainersWithUpdatedExecType
argument_list|(
name|newlyPromotedContainers
argument_list|,
name|ContainerUpdateType
...
DECL|method|pullContainersWithUpdatedExecType ( Map<ContainerId, RMContainer> newlyUpdatedContainers, ContainerUpdateType updateTpe)
specifier|private
name|List
argument_list|<
name|Container
...
block|}
block|}
DECL|method|swapContainer (RMContainer rmContainer, ContainerId matchedContainerId)
specifier|private
name|RMContainer
name|swapContainer
parameter_list|(
