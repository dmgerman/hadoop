...
expr_stmt|;
block|}
comment|// Update multi-node sorting algorithm to scheduler envs
name|updateMultiNodeSortingPolicy
argument_list|(
name|rmApp
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|updateMultiNodeSortingPolicy (RMApp rmApp)
specifier|private
name|void
name|updateMultiNodeSortingPolicy
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// Make sure node is in RUNNING state
if|if
condition|(
name|schedulerContainer
operator|.
...
name|debug
argument_list|(
literal|"Failed to accept this proposal because node "
operator|+
name|schedulerContainer
operator|.
name|getSchedulerNode
