...
decl_stmt|;
DECL|method|InMemoryReservationAllocation (ReservationId reservationID, ReservationDefinition contract, String user, String planName, long startTime, long endTime, Map<ReservationInterval, ReservationRequest> allocationRequests, ResourceCalculator calculator, Resource minAlloc)
name|InMemoryReservationAllocation
parameter_list|(
name|ReservationId
name|reservationID
