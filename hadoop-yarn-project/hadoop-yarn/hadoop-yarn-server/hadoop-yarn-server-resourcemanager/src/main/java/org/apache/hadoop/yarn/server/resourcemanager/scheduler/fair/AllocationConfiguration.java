...
return|;
block|}
comment|/**    * Set the maximum resource allocation for the given queue.    *    * @param queue the target queue    * @param maxResource the maximum resource allocation    */
DECL|method|setMaxResources (String queue, Resource maxResource)
name|void
...
expr_stmt|;
block|}
comment|/**    * Get the maximum resource allocation for the given queue. If the max in not    * set, return the larger of the min and the default max.    *    * @param queue the target queue's name    * @return the max allocation on this queue    */
...
return|;
block|}
comment|/**    * Set the maximum resource allocation for the children of the given queue.    * Use of this method is primarily intended for testing purposes.    *    * @param queue the target queue    * @param maxResource the maximum resource allocation    */
DECL|method|setMaxChildResources (String queue, Resource maxResource)
name|void
