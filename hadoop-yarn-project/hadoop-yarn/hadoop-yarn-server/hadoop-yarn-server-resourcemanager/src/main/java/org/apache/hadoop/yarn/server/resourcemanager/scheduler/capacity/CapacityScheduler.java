...
argument_list|()
decl_stmt|;
comment|// Initialize UserGroupMappingPlacementRule
comment|// TODO, need make this defineable by configuration.
name|UserGroupMappingPlacementRule
name|ugRule
init|=
name|getUserGroupMappingPlacementRule
...
parameter_list|)
block|{
comment|// When application has some pending to-be-removed resource requests,
name|app
operator|.
...
expr_stmt|;
block|}
DECL|method|canAllocateMore (CSAssignment assignment, int offswitchCount)
specifier|private
name|boolean
...
condition|)
block|{
name|rollbackContainerResource
argument_list|(
name|containerId
argument_list|)
expr_stmt|;
...
argument_list|()
decl_stmt|;
comment|// Check container status before doing decrease
if|if
condition|(
name|rmContainer
operator|.
...
name|info
argument_list|(
literal|"Trying to decrease a container not in RUNNING state, container="
operator|+
name|rmContainer
operator|+
literal|" state="
...
annotation|@
name|Override
DECL|method|tryCommit (Resource cluster, ResourceCommitRequest r)
specifier|public
name|void
name|tryCommit
parameter_list|(
