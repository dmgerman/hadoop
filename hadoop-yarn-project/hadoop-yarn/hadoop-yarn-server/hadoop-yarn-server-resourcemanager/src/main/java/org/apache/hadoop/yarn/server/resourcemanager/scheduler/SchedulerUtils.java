...
expr_stmt|;
block|}
DECL|method|normalizeAndValidateRequest (ResourceRequest resReq, Resource maximumResource, String queueName, YarnScheduler scheduler, boolean isRecovery)
specifier|public
specifier|static
name|void
...
block|}
block|}
DECL|method|normalizeAndvalidateRequest (ResourceRequest resReq, Resource maximumResource, String queueName, YarnScheduler scheduler)
specifier|public
specifier|static
name|void
name|normalizeAndvalidateRequest
...
DECL|method|validateResourceRequest (ResourceRequest resReq, Resource maximumResource, QueueInfo queueInfo)
specifier|public
specifier|static
name|void
name|validateResourceRequest
