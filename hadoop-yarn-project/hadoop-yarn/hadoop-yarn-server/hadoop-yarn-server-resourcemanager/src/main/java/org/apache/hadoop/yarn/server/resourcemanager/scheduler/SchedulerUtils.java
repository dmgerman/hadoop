...
argument_list|)
decl_stmt|;
comment|// Reflect resource change to scheduler node.
name|node
operator|.
...
argument_list|)
expr_stmt|;
comment|// Reflect resource change to clusterResource.
name|Resources
operator|.
name|addTo
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO process resource over-commitment case (allocated containers
comment|//> total capacity) in different option by getting value of
comment|// overCommitTimeoutMillis.
comment|// Log resource change
name|log
operator|.
name|info
argument_list|(
literal|"Resource change on node: "
operator|+
name|rmNode
operator|.
name|getNodeAddress
