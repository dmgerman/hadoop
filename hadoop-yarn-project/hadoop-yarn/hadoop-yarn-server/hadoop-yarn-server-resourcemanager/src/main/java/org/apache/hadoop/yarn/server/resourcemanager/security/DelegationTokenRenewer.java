...
literal|false
decl_stmt|;
DECL|field|pendingTokenForRenewal
specifier|private
name|List
argument_list|<
name|DelegationTokenToRenew
argument_list|>
name|pendingTokenForRenewal
init|=
operator|new
name|ArrayList
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// Delegation token renewal is delayed until ClientRMService starts. As
comment|// it is required to short circuit the token renewal calls.
name|isServiceStarted
operator|=
literal|true
expr_stmt|;
name|renewIfServiceIsStarted
argument_list|(
name|pendingTokenForRenewal
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|renewIfServiceIsStarted (List<DelegationTokenToRenew> dtrs)
specifier|protected
name|void
name|renewIfServiceIsStarted
parameter_list|(
