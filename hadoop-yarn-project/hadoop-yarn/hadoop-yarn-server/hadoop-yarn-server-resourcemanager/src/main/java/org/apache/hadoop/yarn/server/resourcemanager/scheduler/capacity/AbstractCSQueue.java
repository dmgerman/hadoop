...
return|;
block|}
DECL|method|getCurrentResourceLimit (Resource clusterResource, ResourceLimits currentResourceLimits)
specifier|protected
name|Resource
...
parameter_list|)
block|{
comment|/*      * Queue's max available resource = min(my.max, my.limit)      * my.limit is set by my parent, considered used resource of my siblings      */
name|Resource
