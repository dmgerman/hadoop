...
annotation|@
name|Override
DECL|method|formatConfigurationInStore (Configuration config)
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|// Unset Ordering Policy of Leaf Queue converted from
comment|// Parent Queue after removeQueue
name|String
...
expr_stmt|;
block|}
comment|// Unset Ordering Policy of Parent Queue converted from
comment|// Leaf Queue after addQueue
name|String
name|queueOrderingPolicy
init|=
name|CapacitySchedulerConfiguration
