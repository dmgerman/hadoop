...
literal|"RMWebService"
argument_list|,
literal|"Trying to kill/move an absent application "
operator|+
name|appId
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|getCallerUserGroupInformation ( HttpServletRequest hsr)
specifier|private
name|UserGroupInformation
name|getCallerUserGroupInformation
parameter_list|(
