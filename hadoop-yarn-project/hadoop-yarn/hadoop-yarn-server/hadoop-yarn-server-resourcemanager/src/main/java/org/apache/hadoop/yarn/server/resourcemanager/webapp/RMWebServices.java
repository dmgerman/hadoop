...
name|dao
operator|.
name|ReservationSubmissionResponseInfo
import|;
end_import
...
argument_list|(
name|createAMBlackListingRequest
argument_list|(
name|newApp
operator|.
name|getAMBlackListingRequestInfo
...
return|;
block|}
DECL|method|createAMBlackListingRequest ( AMBlackListingRequestInfo amBlackListingRequestInfo)
specifier|private
name|AMBlackListingRequest
name|createAMBlackListingRequest
parameter_list|(
...
return|;
block|}
comment|/**    * Function to delete a Reservation to the RM.    *    * @param resContext provides information to construct    *          the ReservationDeleteRequest    * @param hsr the servlet request    * @return Response containing the status code    * @throws AuthorizationException    * @throws IOException    * @throws InterruptedException    */
annotation|@
name|POST
annotation|@
name|Path
