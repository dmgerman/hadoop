...
literal|false
decl_stmt|;
DECL|field|filterInvalidXMLChars
specifier|private
name|boolean
name|filterInvalidXMLChars
init|=
literal|false
decl_stmt|;
DECL|field|enableRestAppSubmissions
specifier|private
name|boolean
name|enableRestAppSubmissions
init|=
literal|true
decl_stmt|;
...
return|;
block|}
comment|/**    * This method ensures that the output String has only    * valid XML unicode characters as specified by the    * XML 1.0 standard. For reference, please see    *<a href="http://www.w3.org/TR/2000/REC-xml-20001006#NT-Char">    * the standard</a>.    *    * @param str The String whose invalid xml characters we want to escape.    * @return The str String after escaping invalid xml characters.    */
DECL|method|escapeInvalidXMLCharacters (String str)
specifier|public
specifier|static
name|String
name|escapeInvalidXMLCharacters
parameter_list|(
name|String
name|str
parameter_list|)
...
name|requiredActions
operator|=
name|parseAppActivitiesRequiredActions
argument_list|(
name|getFlatSet
argument_list|(
name|actions
...
name|AppActivitiesInfo
argument_list|(
literal|"request priorities must be integers!"
argument_list|,
name|appId
argument_list|)
return|;
...
name|Long
argument_list|>
name|parsedAllocationRequestIds
decl_stmt|;
try|try
block|{
name|parsedAllocationRequestIds
...
name|AppActivitiesInfo
argument_list|(
literal|"allocation request Ids must be integers!"
argument_list|,
name|appId
argument_list|)
return|;
...
name|AppActivitiesInfo
argument_list|(
literal|"limit must be greater than 0!"
argument_list|,
name|appId
argument_list|)
return|;
...
return|;
block|}
DECL|method|getFlatSet (Set<String> set)
specifier|private
name|Set
argument_list|<
name|String
...
name|AppActivitiesRequiredAction
argument_list|>
DECL|method|parseAppActivitiesRequiredActions (Set<String> actions)
name|parseAppActivitiesRequiredActions
parameter_list|(
name|Set
argument_list|<
...
name|errMesasge
init|=
literal|"Got invalid action: "
operator|+
name|action
operator|+
literal|", valid actions: "
operator|+
name|Arrays
operator|.
name|asList
...
name|msg
init|=
literal|"App submission via REST is disabled."
decl_stmt|;
return|return
name|Response
operator|.
...
block|}
argument_list|)
DECL|method|formatSchedulerConfiguration (@ontext HttpServletRequest hsr)
specifier|public
name|Response
name|formatSchedulerConfiguration
parameter_list|(
annotation|@
name|Context
name|HttpServletRequest
...
name|AuthorizationException
block|{
comment|// Only admin user allowed to format scheduler conf in configuration store
name|UserGroupInformation
name|callerUGI
init|=
name|getCallerUserGroupInformation
...
name|error
argument_list|(
literal|"Exception thrown when formatting configuration."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|entity
argument_list|(
literal|"Configuration under "
operator|+
literal|"store successfully formatted."
argument_list|)
operator|.
name|build
argument_list|()
...
name|error
argument_list|(
literal|"Exception thrown when formating configuration"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|entity
argument_list|(
literal|"Scheduler Configuration format only supported by "
operator|+
...
block|}
argument_list|)
DECL|method|getSchedulerConfigurationVersion (@ontext HttpServletRequest hsr)
specifier|public
name|Response
name|getSchedulerConfigurationVersion
parameter_list|(
annotation|@
name|Context
name|HttpServletRequest
...
name|AuthorizationException
block|{
comment|// Only admin user is allowed to get scheduler conf version
name|UserGroupInformation
name|callerUGI
init|=
name|getCallerUserGroupInformation
...
name|error
argument_list|(
literal|"Exception thrown when fetching configuration version."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|entity
argument_list|(
literal|"Configuration Version only supported by "
operator|+
literal|"MutableConfScheduler."
argument_list|)
operator|.
...
annotation|@
name|Override
DECL|method|signalToContainer ( @athParamRMWSConsts.CONTAINERID) String containerId, @PathParam(RMWSConsts.COMMAND) String command, @Context HttpServletRequest hsr)
specifier|public
name|Response
