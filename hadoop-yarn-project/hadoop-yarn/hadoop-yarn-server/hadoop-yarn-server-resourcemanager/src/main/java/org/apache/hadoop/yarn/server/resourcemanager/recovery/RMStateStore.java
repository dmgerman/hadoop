...
name|info
argument_list|(
literal|"State store is in Fenced state. Can't store RM Delegation Token."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|info
argument_list|(
literal|"State store is in Fenced state. Can't remove RM Delegation Token."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|info
argument_list|(
literal|"State store is in Fenced state. Can't update RM Delegation Token."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|info
argument_list|(
literal|"State store is in Fenced state. Can't store RM Delegation "
operator|+
...
name|info
argument_list|(
literal|"State store is in Fenced state. Can't remove RM Delegation "
operator|+
literal|"Token Master key."
argument_list|)
expr_stmt|;
