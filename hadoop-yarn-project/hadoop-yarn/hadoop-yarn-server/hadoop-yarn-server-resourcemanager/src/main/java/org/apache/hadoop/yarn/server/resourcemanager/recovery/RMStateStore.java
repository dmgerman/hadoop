...
argument_list|,
operator|new
name|UpdateReservationAllocationTransition
argument_list|()
argument_list|)
operator|.
name|addTransition
...
block|}
block|}
DECL|class|UpdateReservationAllocationTransition
specifier|private
specifier|static
class|class
name|UpdateReservationAllocationTransition
...
name|info
argument_list|(
literal|"Updating reservation allocation."
operator|+
name|reservationEvent
operator|.
name|getReservationIdName
...
name|error
argument_list|(
literal|"Error while updating reservation allocation."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|updateReservation ( ReservationAllocationStateProto reservationAllocation, String planName, String reservationIdName)
specifier|public
name|void
...
name|Exception
function_decl|;
comment|/**    * Blocking API    * Derived classes must implement this method to update the state of    * a reservation allocation.    */
