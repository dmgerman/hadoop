...
name|tempConfigPath
decl_stmt|;
DECL|field|configVersionFile
specifier|private
name|Path
name|configVersionFile
decl_stmt|;
annotation|@
name|Override
DECL|method|initialize (Configuration fsConf, Configuration vSchedConf, RMContext rmContext)
specifier|public
name|void
name|initialize
parameter_list|(
...
return|;
block|}
DECL|method|writeConfigVersion (long configVersion)
specifier|private
name|void
name|writeConfigVersion
parameter_list|(
...
name|info
argument_list|(
literal|"Failed to write config version at {}"
argument_list|,
name|configVersionFile
argument_list|,
name|e
...
name|info
argument_list|(
literal|"Failed to read config version at {}"
argument_list|,
name|configVersionFile
argument_list|,
name|e
