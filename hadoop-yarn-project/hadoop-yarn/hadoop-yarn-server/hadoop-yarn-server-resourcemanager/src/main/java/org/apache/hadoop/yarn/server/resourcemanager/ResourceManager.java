...
block|}
specifier|protected
name|RMStateStoreOperationFailedEventDispatcher
DECL|method|createRMStateStoreOperationFailedEventDispatcher ()
name|createRMStateStoreOperationFailedEventDispatcher
parameter_list|()
block|{
return|return
operator|new
...
annotation|@
name|Private
DECL|class|RMStateStoreOperationFailedEventDispatcher
specifier|public
specifier|static
class|class
name|RMStateStoreOperationFailedEventDispatcher
...
name|haService
decl_stmt|;
DECL|method|RMStateStoreOperationFailedEventDispatcher ( RMHAProtocolService haService)
specifier|public
name|RMStateStoreOperationFailedEventDispatcher
parameter_list|(
name|RMHAProtocolService
...
annotation|@
name|Override
DECL|method|handle (RMStateStoreOperationFailedEvent event)
specifier|public
name|void
name|handle
parameter_list|(
...
name|error
argument_list|(
literal|"Shutting down RM on receiving a "
operator|+
name|RMStateStoreOperationFailedEvent
operator|.
name|class
