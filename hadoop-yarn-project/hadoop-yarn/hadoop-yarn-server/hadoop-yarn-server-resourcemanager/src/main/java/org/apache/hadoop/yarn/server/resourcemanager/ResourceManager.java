...
argument_list|()
expr_stmt|;
comment|// Explicitly start DTRenewer too in secure mode before kicking recovery as
comment|// tokens will start getting added for renewal as part of the recovery
