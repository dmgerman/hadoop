...
specifier|static
name|FSConfigToCSConfigArgumentHandler
DECL|field|fsConfigConversionArgumentHandler
...
name|converter
init|=
name|initFSConfigConverter
argument_list|()
decl_stmt|;
name|initFSArgumentHandler
argument_list|(
name|converter
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Using SystemServiceManager: "
operator|+
name|schedulerClassName
argument_list|)
expr_stmt|;
...
name|YarnRuntimeException
argument_list|(
literal|"Could not instantiate SystemServiceManager: "
operator|+
name|schedulerClassName
argument_list|,
name|e
...
return|;
block|}
DECL|method|createNodeAttributesManager ()
specifier|protected
name|NodeAttributesManager
name|createNodeAttributesManager
parameter_list|()
block|{
name|NodeAttributesManagerImpl
name|namImpl
...
return|;
block|}
DECL|method|createAllocationTagsManager ()
specifier|protected
name|AllocationTagsManager
name|createAllocationTagsManager
parameter_list|()
block|{
return|return
operator|new
...
specifier|protected
name|PlacementConstraintManagerService
DECL|method|createPlacementConstraintManager ()
name|createPlacementConstraintManager
parameter_list|()
block|{
comment|// Use the in memory Placement Constraint Manager.
return|return
operator|new
name|MemoryPlacementConstraintManager
argument_list|()
...
return|;
block|}
DECL|method|createMultiNodeSortingManager ()
specifier|protected
name|MultiNodeSortingManager
argument_list|<
name|SchedulerNode
argument_list|>
name|createMultiNodeSortingManager
parameter_list|()
block|{
return|return
operator|new
...
argument_list|()
expr_stmt|;
name|createAndRegisterOpportunisticDispatcher
argument_list|(
name|masterService
argument_list|)
expr_stmt|;
...
condition|(
operator|!
name|isOpportunisticSchedulingEnabled
argument_list|(
name|conf
argument_list|)
condition|)
...
name|equals
argument_list|(
literal|"-convert-fs-configuration"
argument_list|)
condition|)
block|{
name|String
...
begin_comment
comment|/**    * Deletes the YarnConfigurationStore    *    * @param conf    * @throws Exception    */
end_comment

begin_function
annotation|@
name|VisibleForTesting
DECL|method|deleteRMConfStore (Configuration conf)
specifier|static
name|void
name|deleteRMConfStore
parameter_list|(
...
name|println
argument_list|(
literal|"Scheduler Configuration format only "
operator|+
literal|"supported by MutableConfScheduler."
argument_list|)
expr_stmt|;
block|}
block|}
...
annotation|@
name|VisibleForTesting
DECL|method|initFSArgumentHandler (FSConfigToCSConfigConverter converter)
specifier|static
name|void
name|initFSArgumentHandler
parameter_list|(
...
begin_function
DECL|method|initFSConfigConverter ()
specifier|private
specifier|static
name|FSConfigToCSConfigConverter
name|initFSConfigConverter
