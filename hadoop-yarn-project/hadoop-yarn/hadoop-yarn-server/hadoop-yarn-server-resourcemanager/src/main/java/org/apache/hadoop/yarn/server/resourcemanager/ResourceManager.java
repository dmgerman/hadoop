...
name|rm
decl_stmt|;
DECL|method|RMFatalEventDispatcher ( RMContext rmContext, ResourceManager resourceManager)
specifier|public
name|RMFatalEventDispatcher
parameter_list|(
name|RMContext
...
comment|// 3 conditions need to be satisfied -
...
block|}
block|}
comment|// if security is not enabled and the default filter initializer has been
comment|// set, set the initializer to include the
