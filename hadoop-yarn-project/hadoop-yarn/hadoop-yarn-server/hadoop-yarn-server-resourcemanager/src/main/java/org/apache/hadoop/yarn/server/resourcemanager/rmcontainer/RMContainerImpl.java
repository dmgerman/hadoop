...
expr_stmt|;
block|}
DECL|method|RMContainerImpl (Container container, ApplicationAttemptId appAttemptId, NodeId nodeId, String user, RMContext rmContext, long creationTime)
specifier|public
name|RMContainerImpl
parameter_list|(
name|Container
...
expr_stmt|;
block|}
DECL|method|updateMetricsIfPreempted (RMContainerImpl container)
specifier|private
specifier|static
name|void
name|updateMetricsIfPreempted
