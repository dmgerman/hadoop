...
decl_stmt|;
DECL|field|hasIncreaseReservation
specifier|private
specifier|volatile
name|boolean
...
condition|)
block|{
comment|// When container's state != NEW/RESERVED, it is an increase reservation
name|container
operator|.
name|hasIncreaseReservation
operator|=
...
comment|// decreased container, reservation will be cancelled anyway.
name|container
operator|.
name|hasIncreaseReservation
operator|=
