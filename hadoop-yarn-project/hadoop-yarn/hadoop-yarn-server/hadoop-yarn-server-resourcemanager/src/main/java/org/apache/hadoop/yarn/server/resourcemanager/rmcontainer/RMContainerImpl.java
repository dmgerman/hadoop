...
name|saveNonAMContainerMetaInfo
operator|=
name|shouldPublishNonAMContainerEventstoATS
argument_list|(
name|rmContext
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|shouldPublishNonAMContainerEventstoATS ( RMContext rmContext)
specifier|private
specifier|static
name|boolean
name|shouldPublishNonAMContainerEventstoATS
...
return|;
block|}
DECL|method|publishNonAMContainerEventstoATS ( RMContainerImpl rmContainer)
specifier|private
specifier|static
name|void
name|publishNonAMContainerEventstoATS
