...
argument_list|)
decl_stmt|;
DECL|field|activeUsersWithOnlyPendingApps
specifier|private
name|AtomicInteger
name|activeUsersWithOnlyPendingApps
init|=
operator|new
name|AtomicInteger
argument_list|(
...
argument_list|)
expr_stmt|;
name|computeNumActiveUsersWithOnlyPendingApps
argument_list|()
expr_stmt|;
return|return
name|userLimitPerSchedulingMode
return|;
block|}
comment|// This method is called within the lock.
DECL|method|computeNumActiveUsersWithOnlyPendingApps ()
specifier|private
name|void
name|computeNumActiveUsersWithOnlyPendingApps
parameter_list|()
...
annotation|@
name|VisibleForTesting
DECL|method|getNumActiveUsersWithOnlyPendingApps ()
specifier|public
name|int
