...
return|;
block|}
DECL|method|assignContainer (FiCaSchedulerNode node, FifoAppAttempt application, SchedulerRequestKey schedulerKey, int assignableContainers, Resource capability, NodeType type)
specifier|private
name|int
name|assignContainer
parameter_list|(
