...
argument_list|()
decl_stmt|;
comment|/*    * Because the Docker container's Ip, Port Mapping and other properties    * are generated after the container is launched, need to update the    * container property information to the applications in the RM.    */
DECL|field|updatedExistContainers
specifier|private
specifier|final
name|Map
argument_list|<
...
argument_list|()
expr_stmt|;
comment|// Synchronously update the last response in rmNode with updated
comment|// responseId
name|this
operator|.
name|latestNodeHeartBeatResponse
...
expr_stmt|;
block|}
comment|// Check if you need to update the exist container status
name|boolean
name|needUpdate
init|=
literal|false
