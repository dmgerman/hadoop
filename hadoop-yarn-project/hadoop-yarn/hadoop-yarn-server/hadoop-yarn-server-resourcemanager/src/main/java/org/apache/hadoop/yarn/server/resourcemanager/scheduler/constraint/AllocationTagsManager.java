...
expr_stmt|;
block|}
comment|/**    * Aggregates multiple {@link TypeToCountedTags} to a single one based on    * a given set of application IDs, the values are properly merged.    *    * @param appIds a set of application IDs.    * @return an aggregated {@link TypeToCountedTags}.    */
DECL|method|aggregateAllocationTags (Set<ApplicationId> appIds, Map<ApplicationId, TypeToCountedTags> mapping)
specifier|private
name|TypeToCountedTags
