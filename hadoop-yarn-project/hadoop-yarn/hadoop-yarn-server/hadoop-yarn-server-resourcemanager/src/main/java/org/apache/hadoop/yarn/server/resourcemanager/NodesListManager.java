...
decl_stmt|;
DECL|field|gracefulDecommissionableNodes
specifier|private
name|Set
argument_list|<
name|RMNode
argument_list|>
name|gracefulDecommissionableNodes
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|printConfiguredHosts (boolean graceful)
specifier|private
name|void
name|printConfiguredHosts
parameter_list|(
...
condition|)
block|{
comment|// update hosts, but don't make it visible just yet
name|hostsReader
operator|.
name|lazyRefresh
argument_list|(
...
return|;
block|}
DECL|method|isGracefullyDecommissionableNode (RMNode node)
name|boolean
name|isGracefullyDecommissionableNode
parameter_list|(
name|RMNode
name|node
parameter_list|)
