...
name|zkAcl
decl_stmt|;
comment|/**    *    * ROOT_DIR_PATH    * |--- VERSION_INFO    * |--- RM_ZK_FENCING_LOCK    * |--- RM_APP_ROOT    * |     |----- (#ApplicationId1)    * |     |        |----- (#ApplicationAttemptIds)    * |     |    * |     |----- (#ApplicationId2)    * |     |       |----- (#ApplicationAttemptIds)    * |     ....    * |    * |--- RM_DT_SECRET_MANAGER_ROOT    *        |----- RM_DT_SEQUENTIAL_NUMBER_ZNODE_NAME    *        |----- RM_DELEGATION_TOKENS_ROOT_ZNODE_NAME    *        |       |----- Token_1    *        |       |----- Token_2    *        |       ....    *        |    *        |----- RM_DT_MASTER_KEYS_ROOT_ZNODE_NAME    *        |      |----- Key_1    *        |      |----- Key_2    *                ....    *    */
...
parameter_list|)
block|{
comment|// We tried to delete a node that doesn't exist
if|if
condition|(
name|LOG
operator|.
