...
block|}
block|}
comment|/*    * ZK operations using curator    */
...
argument_list|)
expr_stmt|;
comment|// Set up authorization based on fencing scheme
name|List
argument_list|<
name|AuthInfo
argument_list|>
