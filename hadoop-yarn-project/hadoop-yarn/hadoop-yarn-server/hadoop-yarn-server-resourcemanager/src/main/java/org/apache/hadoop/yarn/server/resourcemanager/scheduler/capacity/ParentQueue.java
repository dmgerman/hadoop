...
name|queueOrderingPolicy
decl_stmt|;
DECL|field|lastSkipQueueDebugLoggingTimestamp
specifier|private
name|long
name|lastSkipQueueDebugLoggingTimestamp
init|=
operator|-
literal|1
decl_stmt|;
...
argument_list|()
decl_stmt|;
comment|// Do logging every 1 sec to avoid excessive logging.
if|if
condition|(
name|now
operator|-
...
name|debug
argument_list|(
literal|"assignedContainer reserved="
operator|+
name|isReserved
operator|+
literal|" queue="
...
argument_list|)
expr_stmt|;
comment|// Update configured capacity/max-capacity for default partition only
name|CSQueueUtils
operator|.
