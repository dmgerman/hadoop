...
return|;
block|}
DECL|method|getResourceLimitsOfChild (CSQueue child, Resource clusterResource, ResourceLimits parentLimits)
specifier|private
name|ResourceLimits
...
return|;
block|}
DECL|method|assignContainersToChildQueues ( Resource cluster, FiCaSchedulerNode node, ResourceLimits limits)
specifier|private
specifier|synchronized
name|CSAssignment
name|assignContainersToChildQueues
