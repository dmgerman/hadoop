...
decl_stmt|;
DECL|field|DIAGNOSTIC_LIMIT_CONFIG_ERROR_MESSAGE
specifier|private
specifier|static
specifier|final
name|String
name|DIAGNOSTIC_LIMIT_CONFIG_ERROR_MESSAGE
init|=
literal|"The value of %s should be a positive integer: %s"
decl_stmt|;
DECL|field|LOG
specifier|private
specifier|static
...
literal|0
decl_stmt|;
DECL|field|containerAllocatedTime
specifier|private
name|long
name|containerAllocatedTime
init|=
literal|0
decl_stmt|;
...
argument_list|()
decl_stmt|;
DECL|field|REGISTERED_TRANSITION
specifier|private
specifier|static
specifier|final
name|AMRegisteredTransition
name|REGISTERED_TRANSITION
init|=
operator|new
name|AMRegisteredTransition
argument_list|()
decl_stmt|;
DECL|field|LAUNCHED_TRANSITION
specifier|private
specifier|static
specifier|final
name|AMLaunchedTransition
name|LAUNCHED_TRANSITION
init|=
operator|new
name|AMLaunchedTransition
argument_list|()
...
init|=
name|getDiagnosticsLimitKCOrThrow
argument_list|(
name|conf
argument_list|)
decl_stmt|;
...
annotation|@
name|VisibleForTesting
DECL|method|appendDiagnostics (final CharSequence message)
name|void
...
argument_list|()
decl_stmt|;
comment|//Load queue only once since queue will be same across attempts
if|if
condition|(
name|queueInfo
operator|==
...
name|error
argument_list|(
literal|"Could not find queue for application : "
argument_list|,
name|e
argument_list|)
expr_stmt|;
comment|// Set application status to REJECTED since we cant find the
comment|// queue
name|appAttempt
operator|.
name|rmContext
...
block|}
block|}
DECL|method|registerClientToken ()
specifier|private
name|void
name|registerClientToken
parameter_list|()
...
condition|)
block|{
comment|// registered received before launch
name|LAUNCHED_TRANSITION
operator|.
name|transition
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Update tracking url if changed and save it to state store
name|String
name|newTrackingUrl
init|=
name|statusUpdateEvent
