...
expr_stmt|;
block|}
DECL|method|recoverAppAttemptTokens (Credentials appAttemptTokens)
specifier|private
name|void
name|recoverAppAttemptTokens
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// normally the client should set the service after acquiring the
comment|// token, but this token is directly provided to the AMs
name|SecurityUtil
operator|.
