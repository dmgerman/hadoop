...
argument_list|()
operator|+
literal|" attempts and final state = "
operator|+
name|this
operator|.
name|recoveredFinalState
...
name|msg
init|=
literal|"Failed to renew delegation token on recovery for "
operator|+
name|app
operator|.
name|applicationId
...
return|;
block|}
DECL|method|failToRecoverApp (RMAppImpl app, RMAppEvent event, String msg, Exception e)
specifier|private
name|void
name|failToRecoverApp
parameter_list|(
...
empty_stmt|;
block|}
DECL|method|getAppKilledDiagnostics ()
specifier|private
specifier|static
name|String
name|getAppKilledDiagnostics
