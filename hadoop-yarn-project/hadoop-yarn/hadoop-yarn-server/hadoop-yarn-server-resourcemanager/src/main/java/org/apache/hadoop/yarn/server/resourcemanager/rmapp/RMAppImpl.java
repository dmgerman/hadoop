...
argument_list|,
operator|new
name|AttemptLaunchedTransition
argument_list|()
argument_list|)
...
annotation|@
name|Override
DECL|method|pullRMNodeUpdates (Map<RMNode, NodeUpdateType> upNodes)
specifier|public
name|int
...
empty_stmt|;
block|}
DECL|class|AttemptLaunchedTransition
specifier|private
specifier|static
specifier|final
class|class
...
name|info
argument_list|(
literal|"update the launch time for applicationId: "
operator|+
name|app
operator|.
name|getApplicationId
