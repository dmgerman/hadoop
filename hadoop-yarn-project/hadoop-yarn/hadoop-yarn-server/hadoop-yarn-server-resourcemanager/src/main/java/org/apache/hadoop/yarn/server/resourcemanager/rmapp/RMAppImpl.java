...
argument_list|()
decl_stmt|;
DECL|field|isAppRemovalRequestSent
specifier|private
name|boolean
name|isAppRemovalRequestSent
init|=
literal|false
decl_stmt|;
DECL|field|previousStateAtRemoving
specifier|private
name|RMAppState
name|previousStateAtRemoving
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
argument_list|()
argument_list|)
comment|// Transitions from REMOVING state
operator|.
name|addTransition
argument_list|(
name|RMAppState
...
name|error
argument_list|(
literal|"Failed to remove application: "
operator|+
name|removeEvent
operator|.
name|getApplicationId
...
block|}
block|}
DECL|class|RMAppRemovingTransition
specifier|private
specifier|static
specifier|final
class|class
...
name|info
argument_list|(
literal|"Removing application with id "
operator|+
name|app
operator|.
name|applicationId
...
expr_stmt|;
block|}
comment|// application completely done and remove from state store.
name|app
operator|.
name|removeApplicationState
argument_list|()
...
argument_list|()
decl_stmt|;
comment|// If App is in REMOVING state, return its previous state.
if|if
condition|(
name|rmAppState
operator|.
...
block|}
block|}
DECL|method|removeApplicationState ()
specifier|private
name|void
name|removeApplicationState
parameter_list|()
