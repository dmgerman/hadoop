...
return|return;
block|}
comment|// Don't trigger a KILL event if application is in completed states
if|if
condition|(
operator|!
name|COMPLETED_APP_STATES
...
name|appId
operator|+
literal|" is about to complete. So not killing the application."
argument_list|)
expr_stmt|;
block|}
block|}
DECL|method|registerApp (ApplicationId appId, ApplicationTimeoutType timeoutType, long monitorStartTime, long timeout)
specifier|public
specifier|synchronized
name|void
name|registerApp
...
annotation|@
name|Override
DECL|method|getExpireInterval ( RMAppToMonitor monitoredAppKey)
specifier|protected
specifier|synchronized
name|long
...
expr_stmt|;
block|}
DECL|method|unregisterApp (ApplicationId appId, Set<ApplicationTimeoutType> types)
specifier|public
specifier|synchronized
name|void
name|unregisterApp
