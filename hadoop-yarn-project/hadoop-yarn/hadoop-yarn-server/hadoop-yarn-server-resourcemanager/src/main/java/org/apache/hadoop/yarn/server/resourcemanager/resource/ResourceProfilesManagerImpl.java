...
argument_list|()
expr_stmt|;
comment|// Load resource types, this should be done even if resource profile is
comment|// disabled, since we have mandatory resource types like vcores/memory.
name|loadResourceTypes
argument_list|()
expr_stmt|;
block|}
DECL|method|loadResourceTypes ()
specifier|private
name|void
name|loadResourceTypes
parameter_list|()
