...
literal|false
decl_stmt|;
DECL|field|AM_PREEMPTION_PREFIX
specifier|protected
specifier|static
specifier|final
name|String
name|AM_PREEMPTION_PREFIX
init|=
name|CONF_PREFIX
operator|+
literal|"am.preemption."
decl_stmt|;
DECL|field|DEFAULT_AM_PREEMPTION
specifier|protected
specifier|static
specifier|final
name|boolean
name|DEFAULT_AM_PREEMPTION
init|=
literal|true
decl_stmt|;
...
return|;
block|}
DECL|method|getAMPreemptionEnabled (String queueName)
specifier|public
name|boolean
name|getAMPreemptionEnabled
parameter_list|(
name|String
name|queueName
parameter_list|)
