...
parameter_list|)
block|{
comment|// This only comes from Long.parseLong()
throw|throw
name|createConfigException
argument_list|(
name|value
...
parameter_list|)
block|{
comment|// This only comes from findPercentage()
throw|throw
name|createConfigException
argument_list|(
name|value
...
literal|"The "
operator|+
literal|"resource values must all be percentages. \""
operator|+
name|resourceValue
operator|+
literal|"\" is either not a number or does not "
operator|+
literal|"include the '%' symbol."
argument_list|,
name|ex
argument_list|)
throw|;
...
return|;
block|}
DECL|method|parseOldStyleResource (String value)
specifier|private
specifier|static
name|ConfigurableResource
name|parseOldStyleResource
