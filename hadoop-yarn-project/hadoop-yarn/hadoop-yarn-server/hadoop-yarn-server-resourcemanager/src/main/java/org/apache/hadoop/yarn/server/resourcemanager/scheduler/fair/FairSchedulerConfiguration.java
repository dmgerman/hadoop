...
name|Configuration
block|{
DECL|field|FS_CONFIGURATION_FILE
specifier|public
specifier|static
specifier|final
name|String
name|FS_CONFIGURATION_FILE
init|=
...
expr_stmt|;
block|}
DECL|method|getMinimumMemoryAllocation ()
specifier|public
name|Resource
...
return|;
block|}
DECL|method|getMaximumMemoryAllocation ()
specifier|public
name|Resource
...
return|;
block|}
DECL|method|getLocalityThreshold ()
specifier|public
name|float
name|getLocalityThreshold
parameter_list|()
block|{
return|return
name|getFloat
