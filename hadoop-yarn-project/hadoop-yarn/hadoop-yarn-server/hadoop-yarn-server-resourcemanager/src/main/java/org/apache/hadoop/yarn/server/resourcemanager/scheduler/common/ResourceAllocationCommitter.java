...
begin_comment
comment|/**  * Scheduler should implement this interface if it wants to have multi-threading  * plus global scheduling functionality  */
end_comment

begin_interface
DECL|interface|ResourceAllocationCommitter
specifier|public
interface|interface
