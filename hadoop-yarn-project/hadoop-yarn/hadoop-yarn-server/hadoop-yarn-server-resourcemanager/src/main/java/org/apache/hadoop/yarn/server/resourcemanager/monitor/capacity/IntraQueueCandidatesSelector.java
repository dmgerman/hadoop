...
block|}
block|}
comment|/*    * Order first by amount used from least to most. Then order from oldest to    * youngest if amount used is the same.    */
DECL|class|TAFairOrderingComparator
specifier|static
class|class
...
name|clusterRes
decl_stmt|;
DECL|method|TAFairOrderingComparator (ResourceCalculator rc, Resource clusterRes)
name|TAFairOrderingComparator
parameter_list|(
name|ResourceCalculator
name|rc
