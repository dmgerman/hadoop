...
return|;
block|}
DECL|method|getNodeLabelCapacities (String queue, Set<String> labels, RMNodeLabelsManager mgr)
specifier|public
name|Map
argument_list|<
name|String
...
control|)
block|{
comment|// capacity of all labels in each queue should be 1
if|if
condition|(
name|org
operator|.
...
return|;
block|}
DECL|method|getMaximumNodeLabelCapacities (String queue, Set<String> labels, RMNodeLabelsManager mgr)
specifier|public
name|Map
argument_list|<
name|String
