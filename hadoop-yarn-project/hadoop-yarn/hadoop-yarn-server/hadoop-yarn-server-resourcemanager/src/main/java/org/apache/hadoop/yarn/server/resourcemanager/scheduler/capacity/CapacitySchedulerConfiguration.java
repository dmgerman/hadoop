...
parameter_list|)
block|{
comment|// Only support to specify memory and vcores maximum allocation per queue
comment|// for now.
name|String
name|queuePrefix
init|=
...
expr_stmt|;
block|}
comment|// Copy from clusterMax and overwrite per-queue's maximum memory/vcore
comment|// allocation.
name|Resource
name|result
init|=
