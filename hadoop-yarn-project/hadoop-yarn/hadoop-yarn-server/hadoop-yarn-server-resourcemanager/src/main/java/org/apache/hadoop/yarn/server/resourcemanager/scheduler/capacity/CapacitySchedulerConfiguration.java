...
literal|"fair"
decl_stmt|;
DECL|field|FIFO_WITH_PARTITIONS_APP_ORDERING_POLICY
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"fifo-with-partitions"
decl_stmt|;
DECL|field|FIFO_FOR_PENDING_APPS
specifier|public
specifier|static
specifier|final
name|String
...
annotation|@
name|Private
DECL|field|SCHEDULE_ASYNCHRONOUSLY_MAXIMUM_PENDING_BACKLOGS
specifier|public
specifier|static
specifier|final
name|String
...
name|SCHEDULE_ASYNCHRONOUSLY_PREFIX
operator|+
literal|".maximum-pending-backlogs"
decl_stmt|;
annotation|@
name|Private
DECL|field|APP_FAIL_FAST
specifier|public
specifier|static
specifier|final
name|String
...
name|PREFIX
operator|+
literal|"application.fail-fast"
decl_stmt|;
annotation|@
name|Private
DECL|field|DEFAULT_APP_FAIL_FAST
specifier|public
specifier|static
specifier|final
name|boolean
name|DEFAULT_APP_FAIL_FAST
init|=
literal|false
decl_stmt|;
annotation|@
...
specifier|final
name|Integer
DECL|field|DEFAULT_SCHEDULE_ASYNCHRONOUSLY_MAXIMUM_PENDING_BACKLOGS
...
annotation|@
name|Private
DECL|field|WORKFLOW_PRIORITY_MAPPINGS
specifier|public
specifier|static
specifier|final
name|String
name|WORKFLOW_PRIORITY_MAPPINGS
init|=
name|PREFIX
operator|+
literal|"workflow-priority-mappings"
decl_stmt|;
annotation|@
name|Private
DECL|field|ENABLE_WORKFLOW_PRIORITY_MAPPINGS_OVERRIDE
specifier|public
specifier|static
specifier|final
name|String
...
annotation|@
name|Private
DECL|field|DEFAULT_ENABLE_WORKFLOW_PRIORITY_MAPPINGS_OVERRIDE
specifier|public
specifier|static
specifier|final
name|boolean
name|DEFAULT_ENABLE_WORKFLOW_PRIORITY_MAPPINGS_OVERRIDE
init|=
literal|false
decl_stmt|;
annotation|@
...
annotation|@
name|VisibleForTesting
DECL|method|setCapacity (String queue, String absoluteResourceCapacity)
specifier|public
name|void
name|setCapacity
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"Cannot set capacity, root queue has a fixed capacity"
argument_list|)
throw|;
block|}
name|set
...
annotation|@
name|VisibleForTesting
DECL|method|setCapacityByLabel (String queue, String label, String absoluteResourceCapacity)
specifier|public
name|void
name|setCapacityByLabel
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Get maximum_allocation setting for the specified queue from the    * configuration.    *    * @param queue    *          name of the queue    * @return Resource object or Resource.none if not set    */
DECL|method|getQueueMaximumAllocation (String queue)
specifier|public
name|Resource
name|getQueueMaximumAllocation
parameter_list|(
name|String
name|queue
parameter_list|)
...
block|}
block|}
DECL|method|getQueueMaximumAllocationMb (String queue)
specifier|public
name|long
name|getQueueMaximumAllocationMb
parameter_list|(
name|String
name|queue
parameter_list|)
...
return|;
block|}
DECL|method|getQueueMaximumAllocationVcores (String queue)
specifier|public
name|int
name|getQueueMaximumAllocationVcores
parameter_list|(
name|String
name|queue
parameter_list|)
...
annotation|@
name|VisibleForTesting
DECL|method|setNodeLocalityDelay (int nodeLocalityDelay)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|getQueueMappingEntity ( String queueMappingSuffix)
specifier|public
name|List
argument_list|<
name|QueueMappingEntity
...
parameter_list|(
name|String
name|queueMappingSuffix
parameter_list|)
block|{
name|String
name|queueMappingName
init|=
name|buildQueueMappingRuleProperty
argument_list|(
name|queueMappingSuffix
argument_list|)
decl_stmt|;
...
return|;
block|}
DECL|method|buildQueueMappingRuleProperty (String queueMappingSuffix)
specifier|private
name|String
name|buildQueueMappingRuleProperty
parameter_list|(
...
annotation|@
name|VisibleForTesting
DECL|method|setQueueMappingEntities (List<QueueMappingEntity> queueMappings, String queueMappingSuffix)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|getOverrideWithWorkflowPriorityMappings ()
specifier|public
name|boolean
...
annotation|@
name|VisibleForTesting
DECL|method|setWorkflowPriorityMappings ( List<WorkflowPriorityMapping> workflowPriorityMappings)
name|void
...
return|;
block|}
DECL|method|shouldAppFailFast (Configuration conf)
specifier|public
name|boolean
...
decl_stmt|;
comment|/**    * Should we allow queues continue grow after all queue reaches their    * guaranteed capacity.    */
DECL|field|PREEMPTION_TO_BALANCE_QUEUES_BEYOND_GUARANTEED
specifier|public
specifier|static
specifier|final
name|String
...
name|PREEMPTION_CONFIG_PREFIX
operator|+
literal|"preemption-to-balance-queue-after-satisfied.enabled"
decl_stmt|;
DECL|field|DEFAULT_PREEMPTION_TO_BALANCE_QUEUES_BEYOND_GUARANTEED
specifier|public
specifier|static
specifier|final
name|boolean
name|DEFAULT_PREEMPTION_TO_BALANCE_QUEUES_BEYOND_GUARANTEED
init|=
literal|false
decl_stmt|;
comment|/**    * How long we will wait to balance queues, by default it is 5 mins.    */
DECL|field|MAX_WAIT_BEFORE_KILL_FOR_QUEUE_BALANCE_PREEMPTION
specifier|public
specifier|static
specifier|final
name|String
...
name|PREEMPTION_CONFIG_PREFIX
operator|+
literal|"preemption-to-balance-queue-after-satisfied.max-wait-before-kill"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|long
DECL|field|DEFAULT_MAX_WAIT_BEFORE_KILL_FOR_QUEUE_BALANCE_PREEMPTION
name|DEFAULT_MAX_WAIT_BEFORE_KILL_FOR_QUEUE_BALANCE_PREEMPTION
init|=
literal|300
operator|*
literal|1000
...
return|;
block|}
DECL|method|setGlobalMaximumApplicationsPerQueue (int val)
specifier|public
name|void
...
annotation|@
name|Private
DECL|field|AUTO_CREATE_CHILD_QUEUE_PREFIX
specifier|private
specifier|static
specifier|final
name|String
name|AUTO_CREATE_CHILD_QUEUE_PREFIX
init|=
literal|"auto-create-child-queue."
decl_stmt|;
annotation|@
name|Private
...
annotation|@
name|Private
DECL|field|AUTO_CREATED_QUEUE_MANAGEMENT_POLICY
specifier|public
specifier|static
specifier|final
name|String
name|AUTO_CREATED_QUEUE_MANAGEMENT_POLICY
init|=
name|AUTO_CREATE_CHILD_QUEUE_PREFIX
operator|+
literal|"management-policy"
decl_stmt|;
annotation|@
name|Private
DECL|field|DEFAULT_AUTO_CREATED_QUEUE_MANAGEMENT_POLICY
specifier|public
specifier|static
specifier|final
name|String
name|DEFAULT_AUTO_CREATED_QUEUE_MANAGEMENT_POLICY
init|=
literal|"org.apache.hadoop.yarn.server.resourcemanager.scheduler.capacity"
operator|+
literal|".queuemanagement."
operator|+
literal|"GuaranteedOrZeroCapacityOverTimePolicy"
decl_stmt|;
annotation|@
name|Private
DECL|field|QUEUE_MANAGEMENT_CONFIG_PREFIX
specifier|private
specifier|static
specifier|final
name|String
name|QUEUE_MANAGEMENT_CONFIG_PREFIX
init|=
literal|"yarn.resourcemanager.monitor.capacity.queue-management."
decl_stmt|;
comment|/**    * Time in milliseconds between invocations of this policy    */
annotation|@
name|Private
DECL|field|QUEUE_MANAGEMENT_MONITORING_INTERVAL
specifier|public
specifier|static
specifier|final
name|String
...
name|QUEUE_MANAGEMENT_CONFIG_PREFIX
operator|+
literal|"monitoring-interval"
decl_stmt|;
annotation|@
name|Private
DECL|field|DEFAULT_QUEUE_MANAGEMENT_MONITORING_INTERVAL
specifier|public
specifier|static
specifier|final
name|long
...
literal|1500L
decl_stmt|;
comment|/**    * Queue Management computation policy for Auto Created queues    * @param queue The queue's path    * @return Configured policy class name    */
annotation|@
name|Private
DECL|method|getAutoCreatedQueueManagementPolicy (String queue)
specifier|public
name|String
...
return|;
block|}
comment|/**    * Get The policy class configured to manage capacities for auto created leaf    * queues under the specified parent    *    * @param queueName The parent queue's name    * @return The policy class configured to manage capacities for auto created    * leaf queues under the specified parent queue    */
annotation|@
name|Private
specifier|protected
name|AutoCreatedQueueManagementPolicy
DECL|method|getAutoCreatedQueueManagementPolicyClass ( String queueName)
...
block|{
name|String
name|queueManagementPolicyClassName
init|=
name|getAutoCreatedQueueManagementPolicy
argument_list|(
name|queueName
...
name|info
argument_list|(
literal|"Using Auto Created Queue Management Policy: "
operator|+
name|queueManagementPolicyClassName
operator|+
literal|" for queue: "
...
name|?
argument_list|>
name|queueManagementPolicyClazz
init|=
name|getClassByName
argument_list|(
name|queueManagementPolicyClassName
...
operator|+
literal|"AutoCreatedQueueManagementPolicy: "
operator|+
name|queueManagementPolicyClassName
operator|+
literal|" for queue: "
...
annotation|@
name|Private
DECL|method|setAutoCreatedLeafQueueConfigCapacity (String queuePath, float val)
specifier|public
name|void
...
annotation|@
name|Private
DECL|method|setAutoCreatedLeafQueueTemplateCapacityByLabel (String queuePath, String label, float val)
specifier|public
name|void
name|setAutoCreatedLeafQueueTemplateCapacityByLabel
parameter_list|(
name|String
name|queuePath
parameter_list|,
...
annotation|@
name|VisibleForTesting
DECL|method|setAutoCreatedLeafQueueConfigMaxCapacity (String queuePath, float val)
specifier|public
name|void
...
annotation|@
name|VisibleForTesting
DECL|method|setAutoCreatedLeafQueueTemplateMaxCapacity (String queuePath, String label, float val)
specifier|public
name|void
...
annotation|@
name|Private
DECL|method|setAutoCreatedLeafQueueConfigUserLimit (String queuePath, int val)
specifier|public
name|void
...
annotation|@
name|Private
DECL|method|setAutoCreatedLeafQueueConfigUserLimitFactor (String queuePath, float val)
specifier|public
name|void
...
annotation|@
name|VisibleForTesting
DECL|method|setAutoCreatedLeafQueueConfigDefaultNodeLabelExpression (String queuePath, String expression)
specifier|public
name|void
name|setAutoCreatedLeafQueueConfigDefaultNodeLabelExpression
parameter_list|(
name|String
name|queuePath
parameter_list|,
...
block|}
block|}
DECL|field|MULTI_NODE_SORTING_POLICIES
annotation|@
name|Private
specifier|public
specifier|static
...
name|PREFIX
operator|+
literal|"multi-node-sorting.policy.names"
decl_stmt|;
DECL|field|MULTI_NODE_SORTING_POLICY_NAME
annotation|@
name|Private
specifier|public
specifier|static
...
name|PREFIX
operator|+
literal|"multi-node-sorting.policy"
decl_stmt|;
comment|/**    * resource usage based node sorting algorithm.    */
DECL|field|DEFAULT_NODE_SORTING_POLICY
specifier|public
specifier|static
specifier|final
name|String
name|DEFAULT_NODE_SORTING_POLICY
init|=
literal|"default"
decl_stmt|;
DECL|field|DEFAULT_NODE_SORTING_POLICY_CLASSNAME
specifier|public
specifier|static
specifier|final
name|String
name|DEFAULT_NODE_SORTING_POLICY_CLASSNAME
init|=
literal|"org.apache.hadoop.yarn.server.resourcemanager.scheduler.placement.ResourceUsageMultiNodeLookupPolicy"
decl_stmt|;
DECL|field|DEFAULT_MULTI_NODE_SORTING_INTERVAL
specifier|public
specifier|static
specifier|final
name|long
name|DEFAULT_MULTI_NODE_SORTING_INTERVAL
init|=
literal|1000L
decl_stmt|;
annotation|@
name|Private
DECL|field|MULTI_NODE_PLACEMENT_ENABLED
specifier|public
specifier|static
specifier|final
name|String
...
name|PREFIX
operator|+
literal|"multi-node-placement-enabled"
decl_stmt|;
annotation|@
name|Private
DECL|field|DEFAULT_MULTI_NODE_PLACEMENT_ENABLED
specifier|public
specifier|static
specifier|final
name|boolean
name|DEFAULT_MULTI_NODE_PLACEMENT_ENABLED
init|=
literal|false
decl_stmt|;
DECL|method|getMultiNodesSortingAlgorithmPolicy ( String queue)
specifier|public
name|String
name|getMultiNodesSortingAlgorithmPolicy
parameter_list|(
name|String
name|queue
parameter_list|)
...
expr_stmt|;
block|}
comment|// If node sorting policy is not configured in queue and in cluster level,
comment|// it is been assumed that this queue is not enabled with multi-node lookup.
if|if
condition|(
name|policyName
operator|==
...
argument_list|()
operator|+
literal|" Class is not configured or not an instance of "
operator|+
name|MultiNodeLookupPolicy
operator|.
name|class
...
return|;
block|}
DECL|method|getMultiNodePlacementEnabled ()
specifier|public
name|boolean
name|getMultiNodePlacementEnabled
parameter_list|()
block|{
return|return
name|getBoolean
...
return|;
block|}
DECL|method|getMultiNodePlacementPolicies ()
specifier|public
name|Set
argument_list|<
name|MultiNodePolicySpec
argument_list|>
name|getMultiNodePlacementPolicies
parameter_list|()
block|{
name|String
index|[]
...
expr_stmt|;
block|}
comment|// This check is needed as default class name is loaded only for
comment|// DEFAULT_NODE_SORTING_POLICY.
if|if
condition|(
name|policyClassName
operator|==
...
argument_list|()
operator|+
literal|" multi-node policy is configured with invalid"
operator|+
literal|" sorting-interval:"
operator|+
name|policySortingInterval
argument_list|)
throw|;
...
return|;
block|}
DECL|method|normalizePolicyName (String policyName)
specifier|private
name|String
name|normalizePolicyName
parameter_list|(
...
parameter_list|)
block|{
comment|// Ensure that custom node sorting algorithm class is valid.
try|try
block|{
name|Class
argument_list|<
