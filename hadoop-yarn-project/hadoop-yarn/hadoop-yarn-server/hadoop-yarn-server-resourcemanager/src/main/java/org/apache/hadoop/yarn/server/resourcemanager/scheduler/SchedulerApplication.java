...
name|rmContext
decl_stmt|;
DECL|method|SchedulerApplication (ApplicationAttemptId applicationAttemptId, String user, Queue queue, ActiveUsersManager activeUsersManager, RMContext rmContext)
specifier|public
name|SchedulerApplication
parameter_list|(
name|ApplicationAttemptId
