...
expr_stmt|;
block|}
comment|/*    * Get a Resource object with for the minimum allocation possible. If resource    * profiles are enabled then the 'minimum' resource profile will be used. If    * they are not enabled, use the minimums specified in the config files.    *    * @return a Resource object with the minimum allocation for the scheduler    */
...
name|error
argument_list|(
literal|"Exception while getting minimum profile from profile manager:"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * Get a Resource object with for the maximum allocation possible. If resource    * profiles are enabled then the 'maximum' resource profile will be used. If    * they are not enabled, use the maximums specified in the config files.    *    * @return a Resource object with the maximum allocation for the scheduler    */
...
name|error
argument_list|(
literal|"Exception while getting maximum profile from ResourceProfileManager:"
argument_list|,
name|e
argument_list|)
expr_stmt|;
