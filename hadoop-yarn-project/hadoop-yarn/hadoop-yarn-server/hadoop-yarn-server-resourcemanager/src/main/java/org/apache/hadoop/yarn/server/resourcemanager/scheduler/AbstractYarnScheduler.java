...
return|;
block|}
comment|/**    * Process completed container list.    * @param completedContainers Extracted list of completed containers    * @param releasedResources Reference resource object for completed containers    * @return The total number of released containers    */
DECL|method|updateCompletedContainers (List<ContainerStatus> completedContainers, Resource releasedResources)
specifier|protected
name|int
