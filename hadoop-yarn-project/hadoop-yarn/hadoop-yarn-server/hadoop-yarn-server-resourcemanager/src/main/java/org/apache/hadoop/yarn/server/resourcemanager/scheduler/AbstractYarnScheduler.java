...
block|}
block|}
DECL|method|handleExecutionTypeUpdates ( SchedulerApplicationAttempt appAttempt, List<UpdateContainerRequest> promotionRequests, List<UpdateContainerRequest> demotionRequests)
specifier|protected
name|void
...
block|}
block|}
DECL|method|handlePromotionRequests ( SchedulerApplicationAttempt applicationAttempt, List<UpdateContainerRequest> updateContainerRequests)
specifier|private
name|void
name|handlePromotionRequests
parameter_list|(
...
block|}
block|}
DECL|method|handleDemotionRequests (SchedulerApplicationAttempt appAttempt, List<UpdateContainerRequest> demotionRequests)
specifier|private
name|void
name|handleDemotionRequests
parameter_list|(
...
name|warn
argument_list|(
literal|"Cannot demote non-existent (or completed) Container ["
operator|+
name|uReq
operator|.
name|getContainerId
