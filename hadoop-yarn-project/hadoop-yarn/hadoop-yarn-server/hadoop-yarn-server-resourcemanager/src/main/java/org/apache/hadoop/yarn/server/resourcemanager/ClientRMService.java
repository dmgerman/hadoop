...
name|rValidator
decl_stmt|;
DECL|field|contextPreProcessor
specifier|private
name|SubmissionContextPreProcessor
...
name|YarnConfiguration
operator|.
name|DEFAULT_RM_SUBMISSION_PREPROCESSOR_ENABLED
argument_list|)
condition|)
block|{
name|this
...
annotation|@
name|VisibleForTesting
DECL|method|getContextPreProcessor ()
name|SubmissionContextPreProcessor
