...
literal|"ClientRMService"
argument_list|,
literal|"Trying to fail an attempt of an absent application"
argument_list|,
name|applicationId
argument_list|,
name|attemptId
...
name|ApplicationNotFoundException
argument_list|(
literal|"Trying to fail an attempt "
operator|+
name|attemptId
operator|+
...
return|;
block|}
comment|/**    * Signal a container.    * After the request passes some sanity check, it will be delivered    * to RMNodeImpl so that the next NM heartbeat will pick up the signal request    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
...
return|;
block|}
DECL|method|verifyUserAccessForRMApp (ApplicationId applicationId, UserGroupInformation callerUGI, String operation)
specifier|private
name|RMApp
name|verifyUserAccessForRMApp
parameter_list|(
