...
comment|// blocking call so make sure that RM has stored the information needed
comment|// to restart the AM after RM restart without further client communication
name|RMStateStore
name|stateStore
init|=
name|rmContext
