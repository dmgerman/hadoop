...
DECL|method|resetCapacity (ResourceCalculator rc, Resource clusterResource, List<TempQueue> queues)
specifier|private
name|void
name|resetCapacity
parameter_list|(
...
name|leafQueue
decl_stmt|;
DECL|method|TempQueue (String queueName, Resource current, Resource pending, Resource guaranteed)
name|TempQueue
parameter_list|(
name|String
name|queueName
...
parameter_list|)
block|{
comment|// remain = avail - min(avail, current + pending - assigned)
name|Resource
name|accepted
init|=
name|Resources
