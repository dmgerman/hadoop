...
begin_class
DECL|class|PreconditionException
specifier|public
class|class
...
init|=
literal|7976747724949372164L
decl_stmt|;
DECL|method|PreconditionException (String message)
specifier|public
name|PreconditionException
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|PreconditionException (String message, MissingArgumentException ex)
specifier|public
name|PreconditionException
parameter_list|(
name|String
