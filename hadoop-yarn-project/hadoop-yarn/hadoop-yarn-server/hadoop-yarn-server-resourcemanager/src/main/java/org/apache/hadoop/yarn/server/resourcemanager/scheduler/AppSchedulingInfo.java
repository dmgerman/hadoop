...
return|;
block|}
comment|/**    * Fetch SchedulingRequests.    * @return All pending SchedulingRequests.    */
DECL|method|getAllSchedulingRequests ()
specifier|public
name|List
argument_list|<
name|SchedulingRequest
...
expr_stmt|;
block|}
DECL|method|updateMetrics (ApplicationId applicationId, NodeType type, SchedulerNode node, Container containerAllocated, String user, Queue queue)
specifier|public
specifier|static
name|void
name|updateMetrics
