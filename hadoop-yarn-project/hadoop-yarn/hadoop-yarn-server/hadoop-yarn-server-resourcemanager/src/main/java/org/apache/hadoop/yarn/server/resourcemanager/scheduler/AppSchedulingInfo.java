...
argument_list|()
decl_stmt|;
DECL|method|AppSchedulingInfo (ApplicationAttemptId appAttemptId, String user, Queue queue, AbstractUsersManager abstractUsersManager, long epoch, ResourceUsage appResourceUsage, Map<String, String> applicationSchedulingEnvs)
specifier|public
name|AppSchedulingInfo
parameter_list|(
name|ApplicationAttemptId
...
block|}
block|}
DECL|method|acceptNodePartition (SchedulerRequestKey schedulerKey, String nodePartition, SchedulingMode schedulingMode)
specifier|public
name|boolean
