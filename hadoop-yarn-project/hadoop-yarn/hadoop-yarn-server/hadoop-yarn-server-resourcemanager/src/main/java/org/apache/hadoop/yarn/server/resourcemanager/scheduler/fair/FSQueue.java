...
return|;
block|}
comment|/**    * Helper method to check if requested VCores are over maxResource.    * @param requestedVCores the number of VCores requested    * @return true if the number of VCores requested is over the maxResource;    *         false otherwise    */
DECL|method|isVCoresOverMaxResource (int requestedVCores)
specifier|protected
name|boolean
name|isVCoresOverMaxResource
parameter_list|(
name|int
name|requestedVCores
parameter_list|)
block|{
if|if
condition|(
