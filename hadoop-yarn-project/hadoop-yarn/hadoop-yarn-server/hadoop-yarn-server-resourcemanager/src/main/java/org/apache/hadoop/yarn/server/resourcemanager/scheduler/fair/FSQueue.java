...
return|;
block|}
comment|/**    * Increase resource usage for this queue and all parent queues.    *    * @param res the resource to increase    */
DECL|method|incUsedResource (Resource res)
specifier|protected
name|void
...
block|}
block|}
comment|/**    * Decrease resource usage for this queue and all parent queues.    *    * @param res the resource to decrease    */
DECL|method|decUsedResource (Resource res)
specifier|protected
name|void
