...
expr_stmt|;
block|}
DECL|method|activateApplications ( Iterator<FiCaSchedulerApp> fsApp, Map<String, Resource> amPartitionLimit, Map<String, Resource> userAmPartitionLimit)
specifier|private
specifier|synchronized
name|void
name|activateApplications
