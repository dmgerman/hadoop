...
literal|null
decl_stmt|;
comment|// Always give preference to this while activating the application attempts.
DECL|field|pendingOPForRecoveredApps
specifier|private
name|OrderingPolicy
argument_list|<
name|FiCaSchedulerApp
argument_list|>
name|pendingOPForRecoveredApps
init|=
literal|null
decl_stmt|;
...
argument_list|)
expr_stmt|;
name|setPendingAppsOrderingPolicyRecovery
argument_list|(
name|conf
operator|.
expr|<
...
name|activateApplications
argument_list|(
name|getPendingAppsOrderingPolicyRecovery
argument_list|()
operator|.
...
expr_stmt|;
block|}
DECL|method|activateApplications ( Iterator<FiCaSchedulerApp> fsApp, Map<String, Resource> userAmPartitionLimit)
specifier|private
specifier|synchronized
name|void
name|activateApplications
...
return|;
block|}
DECL|method|setPendingAppsOrderingPolicy ( OrderingPolicy<FiCaSchedulerApp> pendingOrderingPolicy)
specifier|public
specifier|synchronized
name|void
name|setPendingAppsOrderingPolicy
...
name|FiCaSchedulerApp
argument_list|>
DECL|method|getPendingAppsOrderingPolicyRecovery ()
name|getPendingAppsOrderingPolicyRecovery
parameter_list|()
block|{
return|return
...
return|;
block|}
DECL|method|setPendingAppsOrderingPolicyRecovery ( OrderingPolicy<FiCaSchedulerApp> pendingOrderingPolicyRecovery)
specifier|public
specifier|synchronized
name|void
name|setPendingAppsOrderingPolicyRecovery
...
name|FiCaSchedulerApp
argument_list|>
name|pendingOrderingPolicyRecovery
parameter_list|)
block|{
if|if
condition|(
