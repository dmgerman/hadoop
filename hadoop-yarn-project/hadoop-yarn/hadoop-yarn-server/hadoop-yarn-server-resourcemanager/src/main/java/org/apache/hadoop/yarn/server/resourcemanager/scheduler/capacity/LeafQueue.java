...
expr_stmt|;
block|}
DECL|method|LeafQueue (CapacitySchedulerContext cs, CapacitySchedulerConfiguration configuration, String queueName, CSQueue parent, CSQueue old)
specifier|public
name|LeafQueue
parameter_list|(
name|CapacitySchedulerContext
...
expr_stmt|;
block|}
DECL|method|setupQueueConfigs (Resource clusterResource, CapacitySchedulerConfiguration conf)
specifier|protected
name|void
name|setupQueueConfigs
parameter_list|(
...
name|queueUL
operator|+
literal|", the number of concurrent active users in "
operator|+
name|getQueuePath
argument_list|()
operator|+
...
return|;
block|}
comment|/**    *    * @return UsersManager instance.    */
DECL|method|getUsersManager ()
specifier|public
name|UsersManager
...
block|}
block|}
DECL|method|reinitialize ( CSQueue newlyParsedQueue, Resource clusterResource, CapacitySchedulerConfiguration configuration)
specifier|protected
name|void
name|reinitialize
parameter_list|(
...
return|;
block|}
DECL|method|getUserAMResourceLimitPerPartition ( String nodePartition, String userName)
specifier|public
name|Resource
name|getUserAMResourceLimitPerPartition
parameter_list|(
...
parameter_list|)
block|{
comment|// Considering multi-node scheduling, its better to iterate through
comment|// all candidates and stop once we get atleast one good node to allocate
comment|// where reservation was made earlier. In normal case, there is only one
comment|// node and hence there wont be any impact after this change.
for|for
control|(
name|FiCaSchedulerNode
name|node
...
return|;
block|}
comment|// If there was no reservation and canAssignToThisQueue returned
comment|// true, there is no reason to check further.
if|if
condition|(
operator|!
name|this
...
name|clusterResource
argument_list|,
name|getResourceLimitForActiveUsers
argument_list|(
name|application
operator|.
name|getUser
...
block|}
argument_list|)
DECL|method|computeUserLimitAndSetHeadroom (FiCaSchedulerApp application, Resource clusterResource, String nodePartition, SchedulingMode schedulingMode, Resource userLimit)
name|Resource
name|computeUserLimitAndSetHeadroom
parameter_list|(
name|FiCaSchedulerApp
...
return|;
block|}
comment|/**    *    * @param userName    *          Name of user who has submitted one/more app to given queue.    * @param clusterResource    *          total cluster resource    * @param nodePartition    *          partition name    * @param schedulingMode    *          scheduling mode    *          RESPECT_PARTITION_EXCLUSIVITY/IGNORE_PARTITION_EXCLUSIVITY    * @return Computed User Limit    */
DECL|method|getResourceLimitForActiveUsers (String userName, Resource clusterResource, String nodePartition, SchedulingMode schedulingMode)
specifier|public
name|Resource
name|getResourceLimitForActiveUsers
parameter_list|(
...
block|}
comment|/**    *    * @param userName    *          Name of user who has submitted one/more app to given queue.    * @param clusterResource    *          total cluster resource    * @param nodePartition    *          partition name    * @param schedulingMode    *          scheduling mode    *          RESPECT_PARTITION_EXCLUSIVITY/IGNORE_PARTITION_EXCLUSIVITY    * @return Computed User Limit    */
DECL|method|getResourceLimitForAllUsers (String userName, Resource clusterResource, String nodePartition, SchedulingMode schedulingMode)
specifier|public
name|Resource
...
block|}
block|}
comment|/**    * Recalculate QueueUsage Ratio.    *    * @param clusterResource    *          Total Cluster Resource    * @param nodePartition    *          Partition    */
...
argument_list|)
expr_stmt|;
comment|// Update preemption metrics if exit status is PREEMPTED
if|if
condition|(
name|containerStatus
operator|!=
...
block|}
block|}
DECL|method|allocateResource (Resource clusterResource, SchedulerApplicationAttempt application, Resource resource, String nodePartition, RMContainer rmContainer)
name|void
name|allocateResource
parameter_list|(
name|Resource
...
argument_list|()
decl_stmt|;
comment|// Increment user's resource usage.
name|User
name|user
init|=
name|usersManager
...
block|}
block|}
DECL|method|releaseResource (Resource clusterResource, FiCaSchedulerApp application, Resource resource, String nodePartition, RMContainer rmContainer)
name|void
name|releaseResource
parameter_list|(
name|Resource
...
argument_list|()
expr_stmt|;
comment|// In case of any resource change, invalidate recalculateULCount to clear
comment|// the computed user-limit.
name|usersManager
operator|.
name|userLimitNeedsRecompute
argument_list|()
...
expr_stmt|;
block|}
DECL|method|setCapacity (String nodeLabel, float capacity)
specifier|public
name|void
name|setCapacity
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setAbsoluteCapacity (String nodeLabel, float absoluteCapacity)
specifier|public
name|void
name|setAbsoluteCapacity
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setMaxAMResourcePerQueuePercent ( float maxAMResourcePerQueuePercent)
specifier|public
name|void
name|setMaxAMResourcePerQueuePercent
parameter_list|(
name|float
name|maxAMResourcePerQueuePercent
parameter_list|)
...
block|}
block|}
comment|/**    * Get all valid users in this queue.    * @return user list    */
...
argument_list|()
decl_stmt|;
DECL|method|CachedUserLimit (Resource userLimit)
name|CachedUserLimit
parameter_list|(
name|Resource
name|userLimit
...
return|;
block|}
DECL|method|updateQueuePreemptionMetrics (RMContainer rmc)
specifier|private
name|void
name|updateQueuePreemptionMetrics
parameter_list|(
...
name|metrics
operator|.
name|updatePreemptedForCustomResources
argument_list|(
name|containerResource
argument_list|)
expr_stmt|;
