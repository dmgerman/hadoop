...
return|;
block|}
DECL|method|handleExcessReservedContainer (Resource clusterResource, CSAssignment assignment, FiCaSchedulerNode node, FiCaSchedulerApp app)
specifier|private
name|void
name|handleExcessReservedContainer
parameter_list|(
name|Resource
name|clusterResource
parameter_list|,
...
block|}
block|}
DECL|method|killToPreemptContainers (Resource clusterResource, FiCaSchedulerNode node, CSAssignment assignment)
specifier|private
name|void
name|killToPreemptContainers
parameter_list|(
name|Resource
name|clusterResource
parameter_list|,
...
condition|)
block|{
comment|// Get reserved or allocated container from application
name|RMContainer
name|reservedOrAllocatedRMContainer
init|=
name|application
operator|.
name|getRMContainer
