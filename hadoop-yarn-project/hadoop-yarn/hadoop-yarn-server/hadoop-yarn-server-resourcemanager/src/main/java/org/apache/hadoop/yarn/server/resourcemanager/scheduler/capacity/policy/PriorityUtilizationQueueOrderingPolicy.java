...
argument_list|)
decl_stmt|;
comment|//If q1's abs capacity> 0 and q2 is 0, then prioritize q1
if|if
condition|(
name|Float
operator|.
...
literal|1
return|;
comment|//If q2's abs capacity> 0 and q1 is 0, then prioritize q2
block|}
elseif|else
if|if
condition|(
...
condition|)
block|{
comment|// both q1 has 0 and q2 has 0 capacity, then fall back to using
comment|// priority, abs used capacity to prioritize
name|float
name|used1
init|=
name|q1
...
block|{
comment|// both q1 has positive abs capacity and q2 has positive abs
comment|// capacity
name|float
name|used1
init|=
...
block|}
block|}
DECL|method|compare (CSQueue q1, CSQueue q2, float q1Used, float q2Used, String partition)
specifier|private
name|int
name|compare
parameter_list|(
