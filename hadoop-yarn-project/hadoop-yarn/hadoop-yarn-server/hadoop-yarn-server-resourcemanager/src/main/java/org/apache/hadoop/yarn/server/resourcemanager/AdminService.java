...
literal|"AdminService"
argument_list|,
literal|"ResourceManager is not active. Can not refresh Service ACLs."
argument_list|)
expr_stmt|;
name|throwStandbyException
argument_list|()
...
literal|"AdminService"
argument_list|,
literal|"ResourceManager is not active. Can not update node resource."
argument_list|)
expr_stmt|;
name|throwStandbyException
argument_list|()
...
literal|"AdminService"
argument_list|,
literal|"ResourceManager is not active. Can not add labels."
argument_list|)
expr_stmt|;
name|throwStandbyException
argument_list|()
...
literal|"AdminService"
argument_list|,
literal|"ResourceManager is not active. Can not remove labels."
argument_list|)
expr_stmt|;
name|throwStandbyException
argument_list|()
...
name|info
argument_list|(
literal|"Exception remove labels"
argument_list|,
name|ioe
argument_list|)
expr_stmt|;
...
literal|"AdminService"
argument_list|,
literal|"Exception remove label"
argument_list|)
expr_stmt|;
throw|throw
name|RPCUtil
...
literal|"AdminService"
argument_list|,
literal|"ResourceManager is not active. Can not set node to labels."
argument_list|)
expr_stmt|;
name|throwStandbyException
argument_list|()
...
name|info
argument_list|(
literal|"Exception set node to labels. "
argument_list|,
name|ioe
argument_list|)
expr_stmt|;
