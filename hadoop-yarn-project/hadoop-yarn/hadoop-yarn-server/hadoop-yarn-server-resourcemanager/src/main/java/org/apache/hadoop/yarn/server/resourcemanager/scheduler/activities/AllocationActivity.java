...
argument_list|)
decl_stmt|;
DECL|method|AllocationActivity (String parentName, String queueName, String priority, ActivityState state, String diagnostic, String type, NodeId nodeId, String allocationRequestId)
specifier|public
name|AllocationActivity
parameter_list|(
name|String
