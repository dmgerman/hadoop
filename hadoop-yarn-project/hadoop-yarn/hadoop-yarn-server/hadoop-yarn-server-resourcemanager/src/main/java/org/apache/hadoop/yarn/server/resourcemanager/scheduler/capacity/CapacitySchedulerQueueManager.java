...
DECL|method|validateQueueHierarchy (Map<String, CSQueue> queues, Map<String, CSQueue> newQueues, CapacitySchedulerConfiguration newConf)
specifier|private
name|void
name|validateQueueHierarchy
parameter_list|(
...
name|warn
argument_list|(
literal|"Not a valid queue state for queue "
operator|+
name|oldQueue
operator|.
name|getQueuePath
