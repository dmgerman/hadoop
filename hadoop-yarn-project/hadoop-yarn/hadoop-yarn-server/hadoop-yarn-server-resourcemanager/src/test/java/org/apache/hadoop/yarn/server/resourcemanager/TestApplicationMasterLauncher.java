...
name|fail
argument_list|(
literal|"timed out while waiting for AM Launch to happen."
argument_list|)
expr_stmt|;
block|}
name|Assert
...
name|fail
argument_list|(
literal|"timed out while waiting for AM cleanup to happen."
argument_list|)
expr_stmt|;
block|}
name|Assert
...
annotation|@
name|Test
DECL|method|testAMCleanupBeforeLaunch ()
specifier|public
name|void
name|testAMCleanupBeforeLaunch
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|//send kill before launch
name|rm
operator|.
name|killApp
argument_list|(
...
name|assertFalse
argument_list|(
literal|"NullPointerException happens "
operator|+
literal|" while launching "
operator|+
name|containerId
argument_list|,
name|e
...
annotation|@
name|Test
DECL|method|testSetupTokensWithoutHTTPS ()
specifier|public
name|void
name|testSetupTokensWithoutHTTPS
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testSetupTokensWithHTTPS ()
specifier|public
name|void
name|testSetupTokensWithHTTPS
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSetupTokens (boolean https, YarnConfiguration conf)
specifier|private
name|void
name|testSetupTokens
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// verify keystore and truststore
if|if
condition|(
name|https
condition|)
...
name|tokenIdentifier
decl_stmt|;
DECL|method|MyAMLauncher (RMContext rmContext, RMAppAttempt application, AMLauncherEventType eventType, Configuration conf, AMRMTokenIdentifier tokenIdentifier)
specifier|public
name|MyAMLauncher
parameter_list|(
name|RMContext
