...
begin_comment
comment|/**  * Test class for {@link TargetApplicationsNamespace}.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|// Invalid app-tag namespace syntax
try|try
block|{
name|namespaceStr
operator|=
literal|"app-tag/tag123/tag234"
expr_stmt|;
name|TargetApplicationsNamespace
operator|.
name|parse
...
name|fail
argument_list|(
literal|"Parsing should fail as the given namespace is invalid"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
expr_stmt|;
comment|/**      * App to Application Tags      *  app1: A, B      *  app2: A      *  app3:      *  app4: C      *  app5: A, B, C      */
name|Map
argument_list|<
name|ApplicationId
argument_list|,
