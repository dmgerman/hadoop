...
expr_stmt|;
block|}
comment|/**    * Tests selection of local node from NodeQueueLoadMonitor. This test covers    * selection of node based on queue limit and blacklisted nodes.    */
annotation|@
name|Test
DECL|method|testSelectLocalNode ()
specifier|public
name|void
name|testSelectLocalNode
parameter_list|()
block|{
name|NodeQueueLoadMonitor
name|selector
...
argument_list|)
expr_stmt|;
comment|// basic test for selecting node which has queue length less
comment|// than queue capacity.
name|Set
argument_list|<
name|String
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// if node has been added to blacklist
name|blacklist
operator|.
name|add
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Tests selection of rack local node from NodeQueueLoadMonitor. This test    * covers selection of node based on queue limit and blacklisted nodes.    */
annotation|@
name|Test
DECL|method|testSelectRackLocalNode ()
specifier|public
name|void
name|testSelectRackLocalNode
parameter_list|()
block|{
name|NodeQueueLoadMonitor
name|selector
...
expr_stmt|;
block|}
comment|/**    * Tests selection of any node from NodeQueueLoadMonitor. This test    * covers selection of node based on queue limit and blacklisted nodes.    */
annotation|@
name|Test
DECL|method|testSelectAnyNode ()
specifier|public
name|void
name|testSelectAnyNode
parameter_list|()
block|{
name|NodeQueueLoadMonitor
name|selector
...
argument_list|)
expr_stmt|;
comment|// basic test for selecting node which has queue length
comment|// less than queue capacity.
name|Set
argument_list|<
name|String
argument_list|>
...
return|;
block|}
DECL|method|createRMNode (String host, int port, String rack, int waitTime, int queueLength, int queueCapacity)
specifier|private
name|RMNode
name|createRMNode
parameter_list|(
...
return|;
block|}
DECL|method|createRMNode (String host, int port, String rack, int waitTime, int queueLength, int queueCapacity, NodeState state)
specifier|private
name|RMNode
name|createRMNode
parameter_list|(
