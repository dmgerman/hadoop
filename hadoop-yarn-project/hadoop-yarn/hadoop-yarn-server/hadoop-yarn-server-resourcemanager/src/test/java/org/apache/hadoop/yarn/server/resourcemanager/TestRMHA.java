...
annotation|@
name|Test
DECL|method|testOpportunisticAllocatorAfterFailover ()
specifier|public
name|void
name|testOpportunisticAllocatorAfterFailover
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// 3. Transition to standby
name|rm
operator|.
name|adminService
operator|.
...
argument_list|)
expr_stmt|;
comment|// 4. Transition to active
name|rm
operator|.
name|adminService
operator|.
...
annotation|@
name|Test
DECL|method|testResourceProfilesManagerAfterRMWentStandbyThenBackToActive ()
specifier|public
name|void
name|testResourceProfilesManagerAfterRMWentStandbyThenBackToActive
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// 5. Check ResourceProfilesManager
name|Assert
operator|.
name|assertNotNull
argument_list|(
literal|"ResourceProfilesManager should not be null!"
argument_list|,
name|rm
operator|.
name|getRMContext
