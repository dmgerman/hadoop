...
annotation|@
name|Test
DECL|method|testClusterUserInfo ()
specifier|public
name|void
name|testClusterUserInfo
parameter_list|()
throws|throws
name|JSONException
throws|,
...
annotation|@
name|Test
DECL|method|testInvalidXMLChars ()
specifier|public
name|void
name|testInvalidXMLChars
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Incorrect Number of Apps"
argument_list|,
literal|1
argument_list|,
name|appsInfo
...
name|assertEquals
argument_list|(
literal|"Invalid XML Characters Present"
argument_list|,
literal|"java.lang.Exception: \uFFFD"
argument_list|,
name|appsInfo
...
annotation|@
name|Test
DECL|method|testDisableRestAppSubmission ()
specifier|public
name|void
name|testDisableRestAppSubmission
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|verifyClusterUserInfo (ClusterUserInfo userInfo, String rmLoginUser, String requestedUser)
specifier|public
name|void
name|verifyClusterUserInfo
parameter_list|(
...
name|assertEquals
argument_list|(
literal|"rmLoginUser doesn't match: "
argument_list|,
name|rmLoginUser
argument_list|,
name|userInfo
...
name|assertEquals
argument_list|(
literal|"requestedUser doesn't match: "
argument_list|,
name|requestedUser
argument_list|,
name|userInfo
