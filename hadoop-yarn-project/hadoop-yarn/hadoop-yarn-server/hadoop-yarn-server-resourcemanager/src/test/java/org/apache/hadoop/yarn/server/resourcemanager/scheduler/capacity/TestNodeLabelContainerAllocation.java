...
literal|120000
argument_list|)
DECL|method|testRMContainerLeakInLeafQueue ()
specifier|public
name|void
name|testRMContainerLeakInLeafQueue
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Do node heartbeats 1 time
comment|// scheduler will reserve a container for app1
name|cs
operator|.
name|handle
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// kill app2 then do node heartbeat 1 time
comment|// scheduler will allocate a container from the reserved container on nm1
name|rm1
operator|.
name|killApp
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// After kill app1, LeafQueue#ignorePartitionExclusivityRMContainers should
comment|// be clean, otherwise resource leak happened
name|rm1
operator|.
name|killApp
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// The total memory tracked by QueueMetrics is 0GB for the default partition
name|CSQueue
name|rootQueue
init|=
name|cs
...
comment|// So 0.5 GB is remaining from default label.
name|assertEquals
argument_list|(
literal|5
operator|*
...
argument_list|)
expr_stmt|;
comment|// The total memory tracked by QueueMetrics is 10GB
comment|// for the default partition
name|CSQueue
name|rootQueue
init|=
name|cs
...
annotation|@
name|Test
DECL|method|testQueueMetricsWithMixedLabels ()
specifier|public
name|void
name|testQueueMetricsWithMixedLabels
parameter_list|()
throws|throws
name|Exception
block|{
comment|// There is only one queue which can access both default label and label x.
comment|// There are two nodes of 10GB label x and 12GB no label.
comment|// The test is to make sure that the queue metrics is only tracking the
comment|// allocations and availability from default partition
name|CapacitySchedulerConfiguration
name|csConf
init|=
operator|new
...
expr_stmt|;
comment|// set node -> label
comment|// label x exclusivity is set to true
name|mgr
operator|.
name|addToCluserNodeLabels
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// app2 asks for 5 partition= containers
name|am2
operator|.
name|allocate
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// The total memory tracked by QueueMetrics is 12GB
comment|// for the default partition
name|CSQueue
name|rootQueue
init|=
