...
argument_list|)
expr_stmt|;
comment|// Verify, using get-labels-to-Nodes for specifiedset of labels
name|MultivaluedMapImpl
name|params
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|//  Case3 : Remove cluster label should be successfull
name|response
operator|=
name|r
operator|.
