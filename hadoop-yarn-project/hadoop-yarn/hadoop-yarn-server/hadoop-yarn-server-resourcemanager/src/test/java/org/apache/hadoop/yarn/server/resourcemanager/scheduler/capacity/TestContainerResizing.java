...
annotation|@
name|Test
DECL|method|testIncreaseContainerRequestGetPreferrence ()
specifier|public
name|void
name|testIncreaseContainerRequestGetPreferrence
parameter_list|()
throws|throws
name|Exception
block|{
comment|/**      * There're multiple containers need to be increased, and there're several      * container allocation request, scheduler will try to increase container      * before allocate new containers      */
name|MockRM
name|rm1
init|=
operator|new
