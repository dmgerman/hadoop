...
name|Exception
block|{
comment|// Disable relaunch app attempt on failure, in order to check
comment|// resource usages for current app only.
name|conf
operator|.
name|setInt
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Kill the application by killing the AM container
name|ContainerId
name|amContainer
init|=
name|ContainerId
