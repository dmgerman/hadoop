...
argument_list|)
expr_stmt|;
comment|// Add a queue root.formattest to the existing three queues
name|WebResource
name|r
init|=
name|resource
...
argument_list|)
expr_stmt|;
comment|// Format the scheduler config and validate root.formattest is not present
name|response
operator|=
name|r
operator|.
...
annotation|@
name|Test
DECL|method|testSchedulerConfigVersion ()
specifier|public
name|void
name|testSchedulerConfigVersion
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testUnsetParentQueueOrderingPolicy ()
specifier|public
name|void
name|testUnsetParentQueueOrderingPolicy
parameter_list|()
throws|throws
name|Exception
block|{
...
name|response
decl_stmt|;
comment|// Update ordering policy of Leaf Queue root.b to fair
name|SchedConfUpdateInfo
name|updateInfo1
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Add root.b.b1 which makes root.b a Parent Queue
name|SchedConfUpdateInfo
name|updateInfo2
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Validate unset ordering policy of root.b after converted to
...
name|assertNull
argument_list|(
literal|"Failed to unset Parent Queue OrderingPolicy"
argument_list|,
name|newCSConf
operator|.
name|get
...
annotation|@
name|Test
DECL|method|testUnsetLeafQueueOrderingPolicy ()
specifier|public
name|void
name|testUnsetLeafQueueOrderingPolicy
parameter_list|()
throws|throws
name|Exception
block|{
...
name|response
decl_stmt|;
comment|// Update ordering policy of Parent Queue root.c to priority-utilization
name|SchedConfUpdateInfo
name|updateInfo1
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Remove root.c.c1 which makes root.c a Leaf Queue
name|SchedConfUpdateInfo
name|updateInfo2
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Validate unset ordering policy of root.c after converted to
comment|// Leaf Queue
name|newCSConf
operator|=
operator|(
...
name|assertNull
argument_list|(
literal|"Failed to unset Leaf Queue OrderingPolicy"
argument_list|,
name|newCSConf
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"Failed to remove the queue"
argument_list|,
literal|1
argument_list|,
name|newCSConf
...
name|assertEquals
argument_list|(
literal|"Failed to remove the right queue"
argument_list|,
literal|"a1"
argument_list|,
name|newCSConf
...
annotation|@
name|Test
DECL|method|testStopWithRemoveQueue ()
specifier|public
name|void
name|testStopWithRemoveQueue
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testGlobalConfChange ()
specifier|public
name|void
name|testGlobalConfChange
parameter_list|()
throws|throws
name|Exception
block|{
...
name|response
decl_stmt|;
comment|// Set maximum-applications to 30000.
name|SchedConfUpdateInfo
name|updateInfo
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Unset maximum-applications. Should be set to default.
name|response
operator|=
name|r
operator|.
