...
begin_class
DECL|class|TestFifoOrderingPolicy
specifier|public
class|class
name|TestFifoOrderingPolicy
block|{
annotation|@
name|Test
DECL|method|testFifoOrderingPolicy ()
specifier|public
name|void
name|testFifoOrderingPolicy
parameter_list|()
...
argument_list|)
expr_stmt|;
comment|//Assignment, oldest to youngest
name|checkSerials
argument_list|(
name|schedOrder
operator|.
...
annotation|@
name|Test
DECL|method|testFifoOrderingPolicyAlongWithPriorty ()
specifier|public
name|void
name|testFifoOrderingPolicyAlongWithPriorty
parameter_list|()
block|{
name|FifoOrderingPolicy
argument_list|<
...
argument_list|)
decl_stmt|;
comment|// Both r1 and r1 priority is null
name|Assert
operator|.
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// r1 is null and r2 is not null
name|r2
operator|.
...
argument_list|)
expr_stmt|;
comment|// r1 is not null and r2 is null
name|r2
operator|.
name|setApplicationPriority
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// r1 is not null and r2 is not null
name|r1
operator|.
name|setApplicationPriority
argument_list|(
