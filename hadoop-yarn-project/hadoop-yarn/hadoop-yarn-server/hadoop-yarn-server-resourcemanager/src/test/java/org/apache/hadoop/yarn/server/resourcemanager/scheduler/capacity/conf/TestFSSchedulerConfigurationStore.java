...
annotation|@
name|Test
DECL|method|testFileSystemClose ()
specifier|public
name|void
name|testFileSystemClose
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Close the FileSystem object and validate
name|fs
operator|.
name|close
argument_list|()
...
name|fail
argument_list|(
literal|"FSSchedulerConfigurationStore failed to handle "
operator|+
...
annotation|@
name|Test
DECL|method|testFormatConfiguration ()
specifier|public
name|void
name|testFormatConfiguration
parameter_list|()
throws|throws
name|Exception
block|{
