...
annotation|@
name|Test
DECL|method|testGetRequestConstraint ()
specifier|public
name|void
name|testGetRequestConstraint
parameter_list|()
block|{
comment|// Request Constraint(RC), App Constraint(AC), Global Constraint(GC)
name|PlacementConstraint
name|constraint
decl_stmt|;
name|And
name|mergedConstraint
decl_stmt|;
name|SchedulingRequest
name|request
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// if the source tag in the request is not mapped to any existing
comment|// registered constraint, we should get an empty AND constraint.
name|constraint
operator|=
name|pcm
operator|.
...
argument_list|)
expr_stmt|;
comment|// if a mapping is found for a given source tag
name|constraint
operator|=
name|pcm
operator|.
...
argument_list|)
expr_stmt|;
comment|// both RC, AC and GC should be respected
name|constraint
operator|=
name|pcm
operator|.
