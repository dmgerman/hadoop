...
literal|30000
argument_list|)
DECL|method|testBlacklistAMDisableLabel ()
specifier|public
name|void
name|testBlacklistAMDisableLabel
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Nodes in label default h1,h8,h9
comment|// Nodes in label x h2,h3,h6
comment|// Nodes in label y h4,h5,h7
name|MockNM
name|nm1
init|=
name|rm
...
argument_list|)
expr_stmt|;
comment|// Submit app with AM container launched on default partition i.e. h1.
name|MockRMAppSubmissionData
name|data
init|=
name|MockRMAppSubmissionData
...
argument_list|()
decl_stmt|;
comment|// Add default node blacklist from default
name|appAttempt
operator|.
...
argument_list|)
expr_stmt|;
comment|// Adding second node from default parition
name|appAttempt
operator|.
name|getAMBlacklistManager
argument_list|()
...
return|;
block|}
DECL|method|waitForNodeLabelSchedulerEventUpdate (MockRM rm, String partition, long expectedNodeCount, long timeout)
specifier|private
name|long
name|waitForNodeLabelSchedulerEventUpdate
parameter_list|(
name|MockRM
name|rm
parameter_list|,
...
annotation|@
name|Test
DECL|method|testNodeCountBasedOnNodeLabelsFromClusterNodeTracker ()
specifier|public
name|void
name|testNodeCountBasedOnNodeLabelsFromClusterNodeTracker
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Ensure that cluster node tracker is updated with correct set of node
comment|// after Node registration.
name|Assert
operator|.
name|assertEquals
argument_list|(
...
expr_stmt|;
comment|// Ensure that cluster node tracker is updated with correct set of node
comment|// after new Node registration and old node label change.
name|Assert
operator|.
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Last node with label x is replaced by CLI or REST.
name|Assert
operator|.
name|assertEquals
argument_list|(
