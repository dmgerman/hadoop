...
annotation|@
name|Test
DECL|method|testRMAppColumnIndices ()
specifier|public
name|void
name|testRMAppColumnIndices
parameter_list|()
block|{
comment|// Find the columns to check
name|List
argument_list|<
name|Integer
argument_list|>
...
block|}
block|}
comment|// Verify that the table JS header matches the columns
name|String
name|tableInit
init|=
name|WebPageUtils
