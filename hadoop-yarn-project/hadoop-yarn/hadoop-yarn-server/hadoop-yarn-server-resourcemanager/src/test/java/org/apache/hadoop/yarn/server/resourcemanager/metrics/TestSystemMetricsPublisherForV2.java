...
literal|"1"
decl_stmt|;
DECL|field|DEFAULT_FLOW_RUN
specifier|private
specifier|static
specifier|final
name|long
name|DEFAULT_FLOW_RUN
init|=
literal|1
decl_stmt|;
...
name|assertTrue
argument_list|(
literal|"MultiThreadedDispatcher expected when container Metrics is not published"
argument_list|,
name|metricsPublisher
operator|.
name|getDispatcher
...
name|assertEquals
argument_list|(
literal|"Expected 3 events to be published"
argument_list|,
literal|3
argument_list|,
name|getNumOfNonEmptyLines
argument_list|(
name|appFile
argument_list|)
argument_list|)
...
name|assertEquals
argument_list|(
literal|"Expected 2 events to be published"
argument_list|,
literal|2
argument_list|,
name|getNumOfNonEmptyLines
...
return|;
block|}
DECL|method|getNumOfNonEmptyLines (File entityFile)
specifier|private
name|long
name|getNumOfNonEmptyLines
parameter_list|(
