...
expr_stmt|;
block|}
DECL|method|getApplicationIds (JSONArray array)
specifier|private
name|Set
argument_list|<
name|String
...
annotation|@
name|Test
DECL|method|testAppsQueryQueueAndStateTwoFinishedApps ()
specifier|public
name|void
name|testAppsQueryQueueAndStateTwoFinishedApps
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Finished app1 should be in the result list!"
argument_list|,
name|appIds
operator|.
name|contains
...
name|assertTrue
argument_list|(
literal|"Finished app2 should be in the result list!"
argument_list|,
name|appIds
operator|.
name|contains
...
annotation|@
name|Test
DECL|method|testAppsQueryQueueAndStateOneFinishedApp ()
specifier|public
name|void
name|testAppsQueryQueueAndStateOneFinishedApp
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertFalse
argument_list|(
literal|"Running app should not be in the result list!"
argument_list|,
name|appIds
operator|.
name|contains
...
name|assertTrue
argument_list|(
literal|"Finished app should be in the result list!"
argument_list|,
name|appIds
operator|.
name|contains
...
annotation|@
name|Test
DECL|method|testAppsQueryQueueOneFinishedApp ()
specifier|public
name|void
name|testAppsQueryQueueOneFinishedApp
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Running app should be in the result list!"
argument_list|,
name|appIds
operator|.
name|contains
...
expr_stmt|;
block|}
DECL|method|finishApp (MockNM amNodeManager, RMApp app)
specifier|private
name|void
name|finishApp
parameter_list|(
...
annotation|@
name|Test
DECL|method|testAppsQueryWithInvaildDeselects ()
specifier|public
name|void
name|testAppsQueryWithInvaildDeselects
parameter_list|()
throws|throws
name|JSONException
throws|,
...
literal|"deSelects"
argument_list|,
literal|"INVALIED_deSelectsParam"
argument_list|)
operator|.
name|accept
argument_list|(
...
literal|"exception message"
argument_list|,
literal|"java.lang.Exception: Invalid deSelects string"
operator|+
literal|" INVALIED_deSelectsParam "
operator|+
...
annotation|@
name|Test
DECL|method|testAppsQueryWithDeselects ()
specifier|public
name|void
name|testAppsQueryWithDeselects
parameter_list|()
throws|throws
name|JSONException
throws|,
...
name|assertTrue
argument_list|(
literal|"resource requests shouldn't exist"
argument_list|,
operator|!
name|app
operator|.
...
name|assertTrue
argument_list|(
literal|"AMNodeLabelExpression shouldn't exist"
argument_list|,
operator|!
name|app
operator|.
...
name|assertTrue
argument_list|(
literal|"Timeouts shouldn't exist"
argument_list|,
operator|!
name|app
operator|.
...
name|assertTrue
argument_list|(
literal|"AppNodeLabelExpression shouldn't exist"
argument_list|,
operator|!
name|app
operator|.
...
name|assertTrue
argument_list|(
literal|"Resource info shouldn't exist"
argument_list|,
operator|!
name|app
operator|.
