...
literal|300000
argument_list|)
DECL|method|testUserLimitThroughput ()
specifier|public
name|void
name|testUserLimitThroughput
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getProperty
argument_list|(
literal|"RunUserLimitThroughput"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// add nodes  to cluster, so cluster has 20GB and 20 vcores
name|Resource
name|newResource
init|=
name|Resource
...
expr_stmt|;
block|}
comment|// Now force everything to be over user limit
name|qb
operator|.
name|setUserLimitFactor
argument_list|(
