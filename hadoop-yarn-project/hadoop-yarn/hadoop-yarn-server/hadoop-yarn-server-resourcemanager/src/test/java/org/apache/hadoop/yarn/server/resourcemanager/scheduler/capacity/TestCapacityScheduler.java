...
block|}
block|}
DECL|method|getPrivateResourceTrackerService ( Dispatcher privateDispatcher, SleepHandler sleepHandler)
specifier|private
name|ResourceTrackerService
...
return|;
block|}
comment|/**    * Test the behaviour of the capacity scheduler when a node reconnects    * with changed capabilities. This test is to catch any race conditions    * that might occur due to the use of the RMNode object.    * @throws Exception    */
annotation|@
name|Test
