...
name|assertEquals
argument_list|(
literal|"Amount of preempted memory incorrectly recorded:"
argument_list|,
literal|4
operator|*
name|GB
...
argument_list|()
operator|.
name|getAggregateMemoryMBPreempted
argument_list|()
argument_list|)
expr_stmt|;
name|Assert
...
name|assertEquals
argument_list|(
literal|"Number of preempted vcores incorrectly recorded:"
argument_list|,
literal|4
argument_list|,
name|cs
...
argument_list|()
operator|.
name|getAggregateVcoresPreempted
argument_list|()
argument_list|)
expr_stmt|;
name|rm1
...
literal|600000
argument_list|)
DECL|method|testPreemptionToBalanceWithCustomTimeout ()
specifier|public
name|void
name|testPreemptionToBalanceWithCustomTimeout
parameter_list|()
throws|throws
name|Exception
block|{
comment|/**      * Test case: Submit two application (app1/app2) to different queues, queue      * structure:      *      *<pre>      *             Root      *            /  |  \      *           a   b   c      *          10   20  70      *</pre>      *      * 1) Two nodes (n1/n2) in the cluster, each of them has 20G.      *      * 2) app1 submit to queue-b, asks for 1G * 5      *      * 3) app2 submit to queue-c, ask for one 4G container (for AM)      *      * After preemption, we should expect:      * 1. Preempt 4 containers from app1      * 2. the selected containers will be killed after configured timeout.      * 3. AM of app2 successfully allocated.      */
name|conf
operator|.
name|setBoolean
argument_list|(
...
expr_stmt|;
block|}
comment|// App1 should have 39 containers now
name|FiCaSchedulerApp
name|schedulerApp1
init|=
name|cs
...
argument_list|)
expr_stmt|;
comment|// 20 from n1 and 19 from n2
name|waitNumberOfLiveContainersOnNodeFromApp
argument_list|(
name|cs
operator|.
...
argument_list|)
expr_stmt|;
comment|// check live containers immediately, nothing happen
name|Assert
operator|.
name|assertEquals
argument_list|(
