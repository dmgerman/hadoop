...
literal|300000
argument_list|)
DECL|method|testCSValidateRequestCapacityAgainstMinMaxAllocation ()
specifier|public
name|void
name|testCSValidateRequestCapacityAgainstMinMaxAllocation
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|300000
argument_list|)
DECL|method|testFSValidateRequestCapacityAgainstMinMaxAllocation ()
specifier|public
name|void
name|testFSValidateRequestCapacityAgainstMinMaxAllocation
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testValidateRequestCapacityAgainstMinMaxAllocation (Class<?> schedulerCls)
specifier|private
name|void
name|testValidateRequestCapacityAgainstMinMaxAllocation
parameter_list|(
...
name|Exception
block|{
comment|// Initialize resource map for 2 types.
name|Map
argument_list|<
name|String
argument_list|,
...
argument_list|(
literal|"Scheduler class is of wrong type: "
operator|+
name|schedulerCls
argument_list|)
throw|;
...
annotation|@
name|Test
DECL|method|testValidateRequestCapacityAgainstMinMaxAllocationWithDifferentUnits ()
specifier|public
name|void
name|testValidateRequestCapacityAgainstMinMaxAllocationWithDifferentUnits
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|300000
argument_list|)
DECL|method|testValidateRequestCapacityAgainstMinMaxAllocationFor3rdResourceTypes ()
specifier|public
name|void
name|testValidateRequestCapacityAgainstMinMaxAllocationFor3rdResourceTypes
parameter_list|()
throws|throws
name|Exception
block|{
...
try|try
block|{
comment|// Now request resource, res_1> allowed
name|am1
operator|.
name|allocate
argument_list|(
