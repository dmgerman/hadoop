...
literal|5000
argument_list|)
DECL|method|testIsStarvedForFairShareDRF ()
specifier|public
name|void
name|testIsStarvedForFairShareDRF
parameter_list|()
throws|throws
name|Exception
block|{
...
name|println
argument_list|(
literal|"<defaultFairSharePreemptionThreshold>1</defaultFairSharePreemptionThreshold>"
argument_list|)
expr_stmt|;
name|out
operator|.
...
argument_list|()
expr_stmt|;
comment|// Queue A wants 7 * 1024, 1. Node update gives this all to A
name|createSchedulingRequest
argument_list|(
literal|7
operator|*
...
argument_list|)
expr_stmt|;
comment|// Queue B has 3 reqs :
comment|// 1) 2 * 1024, 5 .. which will be granted
comment|// 2) 1 * 1024, 1 .. which will be granted
comment|// 3) 1 * 1024, 1 .. which wont
name|createSchedulingRequest
argument_list|(
literal|2
operator|*
...
argument_list|()
expr_stmt|;
comment|// Verify that Queue us not starved for fair share..
comment|// Since the Starvation logic now uses DRF when the policy = drf, The
comment|// Queue should not be starved
name|assertFalse
argument_list|(
name|queueB
operator|.
