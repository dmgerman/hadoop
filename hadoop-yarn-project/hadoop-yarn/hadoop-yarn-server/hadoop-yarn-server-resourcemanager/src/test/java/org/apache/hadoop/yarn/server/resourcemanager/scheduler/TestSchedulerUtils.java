...
annotation|@
name|Test
DECL|method|testEnforcePartitionExclusivity ()
specifier|public
name|void
name|testEnforcePartitionExclusivity
parameter_list|()
block|{
name|String
name|enforcedExclusiveLabel
init|=
literal|"x"
decl_stmt|;
name|Set
...
name|String
argument_list|>
name|enforcedExclusiveLabelSet
init|=
name|Collections
operator|.
name|singleton
...
argument_list|)
decl_stmt|;
comment|// RR label unset and app label does not match. Nothing should happen.
name|SchedulerUtils
operator|.
...
argument_list|)
expr_stmt|;
comment|// RR label and app label do not match. Nothing should happen.
name|rr
operator|.
name|setNodeLabelExpression
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// RR label matches but app label does not. RR label should be set
comment|// to app label
name|rr
operator|.
name|setNodeLabelExpression
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// RR label unset and app label matches. RR label should be set
comment|// to app label
name|rr
operator|.
name|setNodeLabelExpression
...
argument_list|)
expr_stmt|;
comment|// RR label does not match and app label matches. RR label should be set
comment|// to app label
name|rr
operator|.
name|setNodeLabelExpression
...
argument_list|)
expr_stmt|;
comment|// RR label and app label matches. Nothing should happen.
name|rr
operator|.
name|setNodeLabelExpression
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Unconfigured label: nothing should happen.
name|rr
operator|.
name|setNodeLabelExpression
argument_list|(
...
annotation|@
name|Test
DECL|method|testEnforcePartitionExclusivityMultipleLabels ()
specifier|public
name|void
name|testEnforcePartitionExclusivityMultipleLabels
parameter_list|()
block|{
name|String
name|enforcedLabel1
...
argument_list|)
expr_stmt|;
comment|// RR label and app label don't match, but they're both enforced labels.
comment|// RR label should be set to app label.
name|rr
operator|.
name|setNodeLabelExpression
argument_list|(
...
return|;
block|}
DECL|method|normalizeAndvalidateRequest (ResourceRequest resReq, String queueName, YarnScheduler scheduler, RMContext rmContext, Resource maxAllocation)
specifier|private
specifier|static
name|void
name|normalizeAndvalidateRequest
