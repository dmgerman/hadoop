...
literal|"Q-2"
decl_stmt|;
DECL|field|APPLICATION_TAG_SC_PREPROCESSOR
specifier|private
specifier|final
specifier|static
name|String
name|APPLICATION_TAG_SC_PREPROCESSOR
init|=
literal|"mytag:foo"
decl_stmt|;
...
literal|"rawtypes"
argument_list|)
DECL|method|testAppSubmitWithSubmissionPreProcessor ()
specifier|public
name|void
name|testAppSubmitWithSubmissionPreProcessor
parameter_list|()
throws|throws
name|Exception
block|{
...
name|YarnConfiguration
operator|.
name|RM_SUBMISSION_PREPROCESSOR_ENABLED
argument_list|,
literal|true
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Override the YARN configuration.
name|when
argument_list|(
name|rmContext
operator|.
...
name|write
argument_list|(
literal|"host.cluster1.com   NL=foo     Q=bar  TA=cluster:cluster1"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|write
argument_list|(
literal|"host.cluster2.com   Q=hello  NL=zuess   TA=cluster:cluster2"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|write
argument_list|(
literal|"host.cluster.*.com   Q=hello  NL=reg   TA=cluster:reg"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|write
argument_list|(
literal|"*   TA=cluster:other    Q=default  NL=barfoo"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|write
argument_list|(
literal|"host.testcluster1.com  Q=default"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|rmService
operator|.
name|getContextPreProcessor
argument_list|()
operator|.
name|refresh
argument_list|()
expr_stmt|;
name|setupCurrentCall
argument_list|(
literal|"host.cluster1.com"
argument_list|)
expr_stmt|;
name|SubmitApplicationRequest
name|submitRequest1
...
name|assertTrue
argument_list|(
literal|"custom tag not present"
argument_list|,
name|app1
operator|.
...
name|assertEquals
argument_list|(
literal|"app node label doesn't match"
argument_list|,
literal|"foo"
argument_list|,
name|app1
...
name|assertTrue
argument_list|(
literal|"client tag not present"
argument_list|,
name|app2
operator|.
name|getApplicationTags
...
argument_list|)
expr_stmt|;
comment|// Test Default commands
name|setupCurrentCall
argument_list|(
literal|"host2.cluster3.com"
argument_list|)
expr_stmt|;
name|ApplicationId
name|appId3
...
argument_list|)
expr_stmt|;
name|testSubmissionContextWithAbsentTAG
argument_list|(
name|rmService
argument_list|,
name|rmContext
...
expr_stmt|;
block|}
DECL|method|testSubmissionContextWithAbsentTAG (ClientRMService rmService, RMContext rmContext)
specifier|private
name|void
name|testSubmissionContextWithAbsentTAG
parameter_list|(
...
name|assertNull
argument_list|(
literal|"app node label present"
argument_list|,
name|app5
operator|.
name|getApplicationSubmissionContext
...
name|assertEquals
argument_list|(
literal|"Queue name is not present"
argument_list|,
name|app5
operator|.
name|getQueue
...
expr_stmt|;
block|}
DECL|method|setupCurrentCall (String hostName)
specifier|private
name|void
name|setupCurrentCall
parameter_list|(
...
literal|120000
argument_list|)
DECL|method|testGetAttributesToNodes ()
specifier|public
name|void
name|testGetAttributesToNodes
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|assertTrue
argument_list|(
name|findHostnameAndValInMapping
argument_list|(
name|node1
argument_list|,
literal|"3_0_2"
...
expr_stmt|;
block|}
DECL|method|findHostnameAndValInMapping (String hostname, String attrVal, List<NodeToAttributeValue> mappingVals)
specifier|private
name|boolean
name|findHostnameAndValInMapping
parameter_list|(
...
literal|120000
argument_list|)
DECL|method|testGetNodesToAttributes ()
specifier|public
name|void
name|testGetNodesToAttributes
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|)
decl_stmt|;
comment|// Specify null for hostnames.
name|GetNodesToAttributesRequest
name|request1
init|=
name|GetNodesToAttributesRequest
...
argument_list|)
expr_stmt|;
comment|// Specify particular node
name|GetNodesToAttributesRequest
name|request2
init|=
name|GetNodesToAttributesRequest
...
argument_list|)
expr_stmt|;
comment|// Test queury with empty set
name|GetNodesToAttributesRequest
name|request3
init|=
name|GetNodesToAttributesRequest
