...
argument_list|)
expr_stmt|;
comment|// List reservations, search by reservation ID
name|ReservationListRequest
name|request
init|=
name|ReservationListRequest
...
argument_list|)
expr_stmt|;
comment|// List reservations, search by time interval.
name|request
operator|=
name|ReservationListRequest
operator|.
...
argument_list|)
expr_stmt|;
comment|// List reservations, search by a very large start time.
name|request
operator|=
name|ReservationListRequest
operator|.
...
argument_list|)
expr_stmt|;
comment|// List reservations, search by a very small end time.
name|request
operator|=
name|ReservationListRequest
operator|.
