...
return|;
block|}
DECL|method|getRMApp (RMContext rmContext, YarnScheduler yarnScheduler, ApplicationId applicationId3, YarnConfiguration config, String queueName, final long memorySeconds, final long vcoreSeconds)
specifier|private
name|RMAppImpl
name|getRMApp
parameter_list|(
...
annotation|@
name|Test
DECL|method|testReservationAPIs ()
specifier|public
name|void
name|testReservationAPIs
parameter_list|()
block|{
comment|// initialize
name|CapacitySchedulerConfiguration
...
name|fail
argument_list|(
literal|"ApplicationNotFoundException should be thrown for invalid application id"
argument_list|)
expr_stmt|;
block|}
catch|catch
