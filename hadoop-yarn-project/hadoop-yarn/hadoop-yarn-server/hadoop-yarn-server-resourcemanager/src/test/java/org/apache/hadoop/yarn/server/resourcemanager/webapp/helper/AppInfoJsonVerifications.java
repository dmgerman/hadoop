...
begin_comment
comment|/**  * Contains all value verifications that are needed to verify {@link AppInfo}  * JSON objects.  */
end_comment

begin_class
DECL|class|AppInfoJsonVerifications
specifier|public
specifier|final
class|class
name|AppInfoJsonVerifications
block|{
DECL|method|AppInfoJsonVerifications ()
specifier|private
name|AppInfoJsonVerifications
parameter_list|()
block|{
...
block|}
comment|/**    * Tests whether {@link AppInfo} representation object contains the required    * values as per defined in the specified app parameter.    * @param  app  an RMApp instance that contains the required values    *              to test against.    */
DECL|method|verify (JSONObject info, RMApp app)
specifier|public
specifier|static
name|void
name|verify
...
name|assertEquals
argument_list|(
literal|"appNodeLabelExpression doesn't match"
argument_list|,
name|app
operator|.
name|getApplicationSubmissionContext
...
name|assertEquals
argument_list|(
literal|"amNodeLabelExpression doesn't match"
argument_list|,
name|app
operator|.
