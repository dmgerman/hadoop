...
block|}
block|}
comment|/**    * Test whether ResourceManager passes user-provided conf to    * UserGroupInformation class. If it reads this (incorrect)    * AuthenticationMethod enum an exception is thrown.    */
annotation|@
name|Test
...
block|}
block|}
comment|/**    * Example command:<br>    *   opt/hadoop/bin/yarn resourcemanager -convert-fs-configuration<br>    *   -o /tmp/output<br>    *   -y /opt/hadoop/etc/hadoop/yarn-site.xml<br>    *   -f /opt/hadoop/etc/hadoop/fair-scheduler.xml<br>    *   -r /home/systest/sample-rules-config.properties<br>    */
annotation|@
name|Test
annotation|@
...
argument_list|)
DECL|method|testResourceManagerConvertFSConfigurationDefaults ()
specifier|public
name|void
name|testResourceManagerConvertFSConfigurationDefaults
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testResourceManagerConvertFSConfigurationWithConsoleParam ()
specifier|public
name|void
name|testResourceManagerConvertFSConfigurationWithConsoleParam
parameter_list|()
throws|throws
name|Exception
block|{
