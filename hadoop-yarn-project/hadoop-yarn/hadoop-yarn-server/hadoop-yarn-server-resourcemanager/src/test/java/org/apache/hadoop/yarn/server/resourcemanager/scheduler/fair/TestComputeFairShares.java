...
block|}
block|}
comment|/**    * Test computeShares will not enter into infinite loop.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|10000
argument_list|)
DECL|method|testResourceUsedWithWeightToResourceRatio ()
specifier|public
name|void
name|testResourceUsedWithWeightToResourceRatio
parameter_list|()
block|{
name|Collection
argument_list|<
