...
expr_stmt|;
block|}
comment|/**    * Test that shares are computed accurately even when the number of    * resources is very large.    * Test adapted to accommodate long values for resources.    */
annotation|@
name|Test
...
expr_stmt|;
block|}
comment|/**    * Test overflow in the resources taken and upper bound.    */
annotation|@
name|Test
DECL|method|testLargeMinimums ()
specifier|public
name|void
name|testLargeMinimums
parameter_list|()
block|{
name|long
name|giga
...
expr_stmt|;
block|}
comment|/**    * Test overflow in the upper bound calculation for the binary search.    */
annotation|@
name|Test
DECL|method|testOverflowMaxShare ()
specifier|public
name|void
name|testOverflowMaxShare
parameter_list|()
block|{
name|long
name|giga
...
DECL|method|verifyMemoryShares (long... shares)
specifier|private
name|void
name|verifyMemoryShares
parameter_list|(
...
name|assertEquals
argument_list|(
literal|"Number of shares and schedulables are not consistent"
argument_list|,
name|scheds
operator|.
name|size
...
name|assertEquals
argument_list|(
literal|"Expected share number "
operator|+
name|i
operator|+
literal|" in list wrong"
argument_list|,
name|shares
index|[
name|i
