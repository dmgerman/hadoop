...
expr_stmt|;
block|}
comment|/**    * {@link LeafQueue#activateApplications()} should validate values of all    * resourceTypes before activating application.    *    * @throws Exception    */
annotation|@
name|Test
DECL|method|testAMLimitByAllResources ()
specifier|public
name|void
name|testAMLimitByAllResources
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Cluster Resource - 16GB, 64vcores
comment|// AMLimit 16384 x .1 mb , 64 x .1 vcore
comment|// Effective AM limit after normalized to minimum resource 2048,7
name|rm
operator|.
name|registerNode
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// app-3 should not be activated as amLimit will be reached
comment|// for memory
name|rm
operator|.
name|submitApp
...
name|assertEquals
argument_list|(
literal|"Active applications should be 2"
argument_list|,
literal|2
argument_list|,
name|queueA
...
argument_list|)
expr_stmt|;
comment|// Used AM Resource is 2048,2
name|Assert
operator|.
name|assertEquals
argument_list|(
