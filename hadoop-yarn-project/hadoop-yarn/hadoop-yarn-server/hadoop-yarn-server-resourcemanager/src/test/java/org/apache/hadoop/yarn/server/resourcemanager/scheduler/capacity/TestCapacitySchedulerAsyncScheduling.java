...
literal|30000
argument_list|)
DECL|method|testCommitProposalsForUnusableNode ()
specifier|public
name|void
name|testCommitProposalsForUnusableNode
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// app2 asks 1 * 8G container
name|am2
operator|.
name|allocate
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// try commit after nm1 decommissioned
name|boolean
name|isSuccess
init|=
name|cs
...
literal|30000
argument_list|)
DECL|method|testReturnNullWhenGetSchedulerContainer ()
specifier|public
name|void
name|testReturnNullWhenGetSchedulerContainer
parameter_list|()
throws|throws
name|Exception
block|{
comment|// disable async-scheduling for simulating complex scenario
name|Configuration
name|disableAsyncConf
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// app2 asks 1 * 1G container
name|am1
operator|.
name|allocate
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// hook CapacityScheduler#submitResourceCommitRequest
name|List
argument_list|<
name|CSAssignment
argument_list|>
name|assignmentSnapshots
init|=
operator|new
name|ArrayList
argument_list|<>
...
condition|)
block|{
comment|// decommission nm1 for first allocation on nm1
name|cs
operator|.
name|getRMContext
argument_list|()
...
block|{
comment|// add am container on nm1 to containersToKill
comment|// for second allocation on nm2
name|assignment
operator|.
...
expr_stmt|;
block|}
comment|// check no NPE in actual submit, before YARN-8233 will throw NPE
name|cs
operator|.
...
argument_list|)
expr_stmt|;
comment|// allocation on nm1, test return null when get scheduler container
name|CandidateNodeSet
argument_list|<
name|FiCaSchedulerNode
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// make sure unconfirmed resource is decreased correctly
name|Assert
operator|.
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// allocation on nm2,
comment|// test return null when get scheduler container to release
name|candidateNodeSet
operator|=
operator|new
name|SimpleCandidateNodeSet
