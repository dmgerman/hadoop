...
name|Text
argument_list|(
literal|"TestDelegationTokenRenewer.Token"
argument_list|)
decl_stmt|;
DECL|class|Renewer
specifier|public
...
annotation|@
name|Test
DECL|method|testInvalidDTWithAddApplication ()
specifier|public
name|void
name|testInvalidDTWithAddApplication
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|2000
argument_list|)
DECL|method|testConncurrentAddApplication ()
specifier|public
name|void
name|testConncurrentAddApplication
parameter_list|()
throws|throws
name|IOException
throws|,
