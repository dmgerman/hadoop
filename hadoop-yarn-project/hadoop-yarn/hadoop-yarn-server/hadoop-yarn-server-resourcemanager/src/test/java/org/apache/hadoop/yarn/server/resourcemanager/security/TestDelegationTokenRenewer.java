...
name|get
argument_list|(
literal|"override_token_expire_time"
argument_list|)
operator|!=
literal|null
condition|)
...
return|;
block|}
DECL|method|submitApp (MockRM rm, Credentials cred, ByteBuffer tokensConf)
specifier|private
name|RMApp
name|submitApp
parameter_list|(
...
block|}
block|}
comment|// Test if the token renewer returned an invalid expiration time, that token's
comment|// renewal should be ignored.
annotation|@
name|Test
DECL|method|testTokenRenewerInvalidReturn ()
specifier|public
name|void
name|testTokenRenewerInvalidReturn
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**    * Test that the DelegationTokenRenewer class can gracefully handle    * interactions that occur when it has been stopped.    */
annotation|@
name|Test
...
literal|10000
argument_list|)
DECL|method|testTokenSequenceNoAfterNewTokenAndRenewal ()
specifier|public
name|void
name|testTokenSequenceNoAfterNewTokenAndRenewal
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Ensure incrTokenSequenceNo has been called for new token request
name|Mockito
operator|.
name|verify
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Ensure incrTokenSequenceNo has been called for token renewal as well.
name|Mockito
operator|.
name|verify
argument_list|(
