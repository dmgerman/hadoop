...
parameter_list|()
block|{
comment|/*      * Queue hierarchy:      * root      * |--- preemptable      *      |--- child-1      *      |--- child-2      * |--- preemptable-sibling      * |--- nonpreemptable      *      |--- child-1      *      |--- child-2      */
name|AllocationFileWriter
name|allocationFileWriter
decl_stmt|;
if|if
...
annotation|@
name|Test
DECL|method|testDisableAMPreemption ()
specifier|public
name|void
name|testDisableAMPreemption
parameter_list|()
block|{
name|takeAllResources
argument_list|(
...
expr_stmt|;
block|}
comment|/* It tests the case that there is less-AM-container solution in the    * remaining nodes.    */
annotation|@
name|Test
DECL|method|testRelaxLocalityPreemptionWithLessAMInRemainingNodes ()
specifier|public
name|void
name|testRelaxLocalityPreemptionWithLessAMInRemainingNodes
parameter_list|()
throws|throws
name|Exception
block|{
...
init|=
name|getGreedyAppAttemptIdOnNode
argument_list|(
name|node1
operator|.
name|getNodeID
...
argument_list|)
decl_stmt|;
name|updateRelaxLocalityRequestSchedule
argument_list|(
name|node1
argument_list|,
name|GB
...
argument_list|)
expr_stmt|;
name|verifyRelaxLocalityPreemption
argument_list|(
name|node1
operator|.
name|getNodeID
...
expr_stmt|;
block|}
comment|/* It tests the case that there is no less-AM-container solution in the    * remaining nodes.    */
annotation|@
name|Test
DECL|method|testRelaxLocalityPreemptionWithNoLessAMInRemainingNodes ()
specifier|public
name|void
name|testRelaxLocalityPreemptionWithNoLessAMInRemainingNodes
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|setNumAMContainersOnNode (int num, NodeId nodeId)
specifier|private
name|void
name|setNumAMContainersOnNode
parameter_list|(
...
block|}
block|}
DECL|method|getGreedyAppAttemptIdOnNode (NodeId nodeId)
specifier|private
name|ApplicationAttemptId
name|getGreedyAppAttemptIdOnNode
parameter_list|(
...
return|;
block|}
comment|/*    * Send the resource requests allowed relax locality to scheduler. The    * params node/nodeMemory/numNodeContainers used for NODE_LOCAL request.    */
DECL|method|updateRelaxLocalityRequestSchedule (RMNode node, int nodeMemory, int numNodeContainers)
specifier|private
name|void
name|updateRelaxLocalityRequestSchedule
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|verifyRelaxLocalityPreemption (NodeId notBePreemptedNodeId, ApplicationAttemptId greedyAttemptId, int numGreedyAppContainers)
specifier|private
name|void
name|verifyRelaxLocalityPreemption
parameter_list|(
name|NodeId
name|notBePreemptedNodeId
parameter_list|,
name|ApplicationAttemptId
name|greedyAttemptId
parameter_list|,
name|int
name|numGreedyAppContainers
parameter_list|)
