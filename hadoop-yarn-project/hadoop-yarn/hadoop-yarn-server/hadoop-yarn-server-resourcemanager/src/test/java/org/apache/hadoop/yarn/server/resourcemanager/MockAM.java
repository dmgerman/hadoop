...
return|;
block|}
DECL|method|allocate ( String host, Resource cap, int numContainers, List<ContainerId> rels, String labelExpression)
specifier|public
name|AllocateResponse
name|allocate
parameter_list|(
...
return|;
block|}
DECL|method|createResourceReq (String host, Resource cap, int containers, String labelExpression)
specifier|public
name|ResourceRequest
name|createResourceReq
parameter_list|(
