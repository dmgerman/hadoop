...
annotation|@
name|Test
DECL|method|testMultipleAddRemoveContainer ()
specifier|public
name|void
name|testMultipleAddRemoveContainer
parameter_list|()
block|{
...
argument_list|)
expr_stmt|;
comment|// remove the same container again, the reducer no longer exists,
comment|// make sure there is no NPE here
name|atm
operator|.
name|removeContainer
argument_list|(
