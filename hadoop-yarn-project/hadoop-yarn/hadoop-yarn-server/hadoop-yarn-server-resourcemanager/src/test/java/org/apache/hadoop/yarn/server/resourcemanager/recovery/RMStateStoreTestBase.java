...
argument_list|()
decl_stmt|;
comment|// Epoch should have wrapped around and then incremented once for a total
comment|// of + 3
name|Assert
operator|.
name|assertEquals
...
expr_stmt|;
block|}
DECL|method|testProxyCA ( RMStateStoreHelper stateStoreHelper)
specifier|public
name|void
name|testProxyCA
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Try replacing with a different ProxyCA
name|ProxyCA
name|newProxyCA
init|=
operator|new
