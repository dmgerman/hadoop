...
return|;
block|}
DECL|method|testUserLimitThroughputWithNumberOfResourceTypes ( int numOfResourceTypes)
specifier|private
name|void
...
argument_list|)
decl_stmt|;
comment|// Don't reset resource types since we have already configured resource types
name|conf
operator|.
name|setBoolean
argument_list|(
