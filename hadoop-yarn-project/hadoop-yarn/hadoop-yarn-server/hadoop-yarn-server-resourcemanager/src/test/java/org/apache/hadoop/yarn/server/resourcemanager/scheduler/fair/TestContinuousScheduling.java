...
literal|60000
argument_list|)
DECL|method|testSchedulingDelay ()
specifier|public
name|void
name|testSchedulingDelay
parameter_list|()
throws|throws
...
argument_list|)
expr_stmt|;
comment|// Create one application and submit one each of node-local, rack-local
comment|// and ANY requests
name|ApplicationAttemptId
name|appAttemptId
init|=
...
argument_list|)
decl_stmt|;
comment|// Advance time and let continuous scheduling kick in
name|mockClock
operator|.
name|tick
argument_list|(
