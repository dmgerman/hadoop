...
begin_comment
comment|/**  * Test loading the allocation file for the FairScheduler.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|// reset the conf so we can detect the reload
name|confHolder
operator|.
name|allocConf
operator|=
...
argument_list|(
literal|"vcores=16, memory-mb=512, "
operator|+
name|A_CUSTOM_RESOURCE
operator|+
literal|"=10"
...
expr_stmt|;
name|Resource
name|expectedResourceWithCustomType
init|=
name|Resources
operator|.
name|createResource
...
literal|300
argument_list|)
comment|// Set default fair share preemption threshold to 0.6
operator|.
name|defaultFairSharePreemptionThreshold
argument_list|(
literal|0.6
...
name|assertFalse
argument_list|(
literal|"Create flag was not set to false"
argument_list|,
operator|(
operator|(
name|FSPlacementRule
