...
argument_list|)
expr_stmt|;
comment|//Make queue F a parent queue without configured leaf queues using the 'type' attribute
name|out
operator|.
name|println
argument_list|(
...
comment|// timeouts and preemption thresholds
name|out
operator|.
name|println
argument_list|(
