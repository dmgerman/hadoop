...
begin_comment
comment|/**  * Test RM Auth filter.  */
end_comment

begin_class
DECL|class|TestRMAuthenticationFilter
specifier|public
class|class
name|TestRMAuthenticationFilter
block|{
annotation|@
...
name|set
argument_list|(
literal|"hadoop.proxyuser.user.foo"
argument_list|,
literal|"bar1"
argument_list|)
expr_stmt|;
