...
expr_stmt|;
block|}
DECL|method|syncNodeGracefulDecommission ( MockNM nm, int timeout)
specifier|private
name|void
name|syncNodeGracefulDecommission
parameter_list|(
name|MockNM
name|nm
parameter_list|,
...
annotation|@
name|Test
DECL|method|testAMRMDecommissioningNodes ()
specifier|public
name|void
name|testAMRMDecommissioningNodes
parameter_list|()
throws|throws
name|Exception
block|{
