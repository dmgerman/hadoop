...
argument_list|()
decl_stmt|;
DECL|method|resetResourceInformationMap ()
specifier|private
name|void
name|resetResourceInformationMap
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|// If app has 0 container, and it has only pending, still make sure to
...
argument_list|>
argument_list|>
name|userResourceUsagePerLabel
init|=
operator|new
name|HashMap
argument_list|<>
...
argument_list|>
argument_list|>
name|userResourceUsagePerQueue
init|=
name|userResourceUsagePerLabel
operator|.
name|get
...
expr_stmt|;
block|}
comment|// Get queue to user based resource map
name|HashMap
argument_list|<
name|String
argument_list|,
...
expr_stmt|;
block|}
comment|// Get user to its resource usage.
name|ResourceUsage
name|usage
init|=
name|userResourceUsage
...
name|debug
argument_list|(
literal|"Updating user-limit from mock: totResoucePerPartition="
operator|+
name|totResoucePerPartition
operator|+
literal|", capacity="
...
condition|)
block|{
comment|// Using the same order of resources from ResourceUtils, set resource
...
annotation|@
name|Override
DECL|method|matches (ContainerPreemptEvent cpe)
specifier|public
name|boolean
name|matches
parameter_list|(
