...
return|;
block|}
comment|/**    * Format is:    *<pre>    * root (<partition-name-1>=[guaranteed max used pending (reserved)],<partition-name-2>=..);    * -A(...);    * --A1(...);    * --A2(...);    * -B...    *</pre>    * ";" splits queues, and there should no empty lines, no extra spaces    */
annotation|@
name|SuppressWarnings
argument_list|(
block|{
