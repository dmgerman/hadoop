...
annotation|@
name|Test
DECL|method|testFileSystemCloseWithFileSystemBasedConfigurationProvider ()
specifier|public
name|void
name|testFileSystemCloseWithFileSystemBasedConfigurationProvider
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"FileSystemBasedConfigurationProvider failed to handle "
operator|+
literal|"FileSystem close"
argument_list|)
expr_stmt|;
block|}
else|else
...
argument_list|)
expr_stmt|;
comment|// add attributes for later removals
name|request
operator|=
name|NodesToAttributesMappingRequest
operator|.
...
argument_list|)
expr_stmt|;
comment|// Assert node to attributes mappings are empty.
name|Assert
operator|.
name|assertTrue
argument_list|(
literal|"Attributes of host4 should be empty"
argument_list|,
name|rm
operator|.
name|getRMContext
...
argument_list|)
expr_stmt|;
comment|// remove non existing attributes.
name|request
operator|=
name|NodesToAttributesMappingRequest
operator|.
...
name|fail
argument_list|(
literal|"Should have failed for non exists attribute"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertTrue
argument_list|(
literal|"Exception expected if attributes does not exist"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
