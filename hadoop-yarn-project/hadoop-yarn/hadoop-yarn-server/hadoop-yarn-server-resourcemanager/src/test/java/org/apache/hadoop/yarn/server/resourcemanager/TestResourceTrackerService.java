...
annotation|@
name|Test
DECL|method|testNodeRegistrationWithContainers ()
specifier|public
name|void
name|testNodeRegistrationWithContainers
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Register node with some container statuses
name|ContainerStatus
name|status
init|=
name|ContainerStatus
...
argument_list|)
decl_stmt|;
comment|// The following shouldn't throw NPE
name|nm
operator|.
name|registerNode
argument_list|(
...
name|assertEquals
argument_list|(
literal|"Incorrect number of nodes"
argument_list|,
literal|1
argument_list|,
name|rm
