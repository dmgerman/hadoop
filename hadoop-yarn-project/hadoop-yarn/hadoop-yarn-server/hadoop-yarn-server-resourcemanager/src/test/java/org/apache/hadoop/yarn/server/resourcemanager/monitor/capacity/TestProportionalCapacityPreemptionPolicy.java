...
annotation|@
name|Test
DECL|method|testIdealAllocationForLabels ()
specifier|public
name|void
name|testIdealAllocationForLabels
parameter_list|()
block|{
name|int
index|[]
...
argument_list|)
decl_stmt|;
comment|// Subtracting Label X resources from cluster resources
name|when
argument_list|(
name|lm
operator|.
...
argument_list|()
expr_stmt|;
comment|// By skipping AM Container and Labeled container, all other 18 containers
comment|// of appD will be
comment|// preempted
name|verify
argument_list|(
name|mDisp
...
argument_list|)
expr_stmt|;
comment|// rest 4 containers from appB will be preempted
name|verify
argument_list|(
name|mDisp
argument_list|,
