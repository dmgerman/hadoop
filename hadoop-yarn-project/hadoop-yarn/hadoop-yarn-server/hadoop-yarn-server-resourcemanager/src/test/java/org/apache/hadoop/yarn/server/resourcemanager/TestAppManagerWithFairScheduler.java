...
name|println
argument_list|(
literal|"<aclSubmitApps>test</aclSubmitApps>"
argument_list|)
expr_stmt|;
name|out
operator|.
...
name|println
argument_list|(
literal|"<aclAdministerApps>test</aclAdministerApps>"
argument_list|)
expr_stmt|;
name|out
operator|.
...
name|println
argument_list|(
literal|"<queue name=\"noaccess\" type=\"parent\">"
argument_list|)
expr_stmt|;
name|out
operator|.
...
name|println
argument_list|(
literal|"<queue name=\"submitonly\" type=\"parent\">"
argument_list|)
expr_stmt|;
name|out
operator|.
