...
argument_list|)
expr_stmt|;
comment|// App1 should get 4 containers allocated (1 AM + 3 mappers).
name|FiCaSchedulerApp
name|schedulerApp
init|=
name|cs
...
argument_list|)
decl_stmt|;
comment|// App2 should get 4 containers allocated (1 AM + 3 container).
name|Assert
operator|.
name|assertEquals
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// App3 should get 2 containers allocated (1 AM + 1 container).
name|Assert
operator|.
name|assertEquals
argument_list|(
