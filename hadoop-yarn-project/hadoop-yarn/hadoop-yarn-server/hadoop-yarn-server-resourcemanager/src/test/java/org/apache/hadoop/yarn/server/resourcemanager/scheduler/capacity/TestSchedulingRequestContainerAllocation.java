...
expr_stmt|;
block|}
DECL|method|submitApp (MockRM rm, int memory, Set<String> appTags)
specifier|private
name|RMApp
name|submitApp
parameter_list|(
...
literal|30000L
argument_list|)
DECL|method|testInvalidSchedulingRequest ()
specifier|public
name|void
name|testInvalidSchedulingRequest
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Constraint with Invalid Allocation Tag Namespace
name|PlacementConstraint
name|constraint
init|=
name|targetNotIn
...
name|fail
argument_list|(
literal|"Failed to reject invalid scheduling request"
argument_list|)
expr_stmt|;
block|}
block|}
