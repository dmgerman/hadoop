...
name|fail
argument_list|(
literal|"App state is not correct (timedout): expected: "
operator|+
name|finalState
operator|+
literal|" actual: "
...
name|fail
argument_list|(
literal|"Attempt state is not correct (timedout): expected: "
operator|+
name|finalState
operator|+
literal|" actual: "
...
block|}
block|}
DECL|method|waitForContainerState (ContainerId containerId, RMContainerState state)
specifier|public
name|void
...
name|Exception
block|{
comment|// This method will assert if state is not expected after timeout.
name|Assert
operator|.
name|assertTrue
argument_list|(
...
expr_stmt|;
block|}
DECL|method|waitForContainerState (ContainerId containerId, RMContainerState containerState, int timeoutMillisecs)
specifier|public
name|boolean
name|waitForContainerState
parameter_list|(
...
name|assertEquals
argument_list|(
literal|"Container state is not correct (timedout)"
argument_list|,
name|containerState
argument_list|,
name|container
...
return|;
block|}
DECL|method|waitForContainerAllocated (MockNM nm, ContainerId containerId)
specifier|public
name|void
...
name|Exception
block|{
comment|// default is wait for 30,000 ms
return|return
name|waitForState
argument_list|(
name|nm
...
return|;
block|}
DECL|method|waitForState (MockNM nm, ContainerId containerId, RMContainerState containerState, int timeoutMillisecs)
specifier|public
name|boolean
name|waitForState
parameter_list|(
...
return|;
block|}
DECL|method|waitForState (Collection<MockNM> nms, ContainerId containerId, RMContainerState containerState, int timeoutMillisecs)
specifier|public
name|boolean
name|waitForState
parameter_list|(
...
name|assertNotNull
argument_list|(
literal|"Container shouldn't be null"
argument_list|,
name|container
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|submitApp (Resource capability, String name, String user, Map<ApplicationAccessType, String> acls, boolean unmanaged, String queue, int maxAppAttempts, Credentials ts, String appType, boolean waitForAccepted, boolean keepContainers, boolean isAppIdProvided, ApplicationId applicationId, long attemptFailuresValidityInterval, LogAggregationContext logAggregationContext, boolean cancelTokensWhenComplete, Priority priority, String amLabel)
specifier|public
name|RMApp
name|submitApp
parameter_list|(
