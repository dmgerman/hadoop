...
expr_stmt|;
block|}
comment|/**    * Test that active elector service triggers a fatal RM Event when connection    * to ZK fails. YARN-8409    */
annotation|@
name|Test
DECL|method|testFailureToConnectToZookeeper ()
specifier|public
name|void
name|testFailureToConnectToZookeeper
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"expect failure to connect to Zookeeper"
argument_list|)
expr_stmt|;
block|}
catch|catch
