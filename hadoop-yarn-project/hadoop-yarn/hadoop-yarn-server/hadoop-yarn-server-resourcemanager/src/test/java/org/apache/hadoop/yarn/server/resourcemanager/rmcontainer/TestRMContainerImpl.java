...
argument_list|)
expr_stmt|;
comment|// In RELEASED state. A FINISHED event may come in.
name|rmContainer
operator|.
name|handle
argument_list|(
...
annotation|@
name|Test
DECL|method|testContainerTransitionNotifyAllocationTagsManager ()
specifier|public
name|void
name|testContainerTransitionNotifyAllocationTagsManager
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|/* Fourth container: NEW -> RECOVERED */
name|rmContainer
operator|=
operator|new
name|RMContainerImpl
...
literal|30000
argument_list|)
DECL|method|testContainerAcquiredAtKilled ()
specifier|public
name|void
name|testContainerAcquiredAtKilled
parameter_list|()
block|{
name|DrainDispatcher
name|drainDispatcher
...
name|fail
argument_list|(
literal|"RMContainerImpl: can't handle "
operator|+
name|rmContainerEventType
operator|+
literal|" at state "
