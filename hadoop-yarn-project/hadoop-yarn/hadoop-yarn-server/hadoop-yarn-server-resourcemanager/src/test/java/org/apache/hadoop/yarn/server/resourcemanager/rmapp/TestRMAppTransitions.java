...
expr_stmt|;
block|}
DECL|method|assertAppRemoved (RMApp application)
specifier|private
name|void
name|assertAppRemoved
parameter_list|(
name|RMApp
name|application
parameter_list|)
...
return|;
block|}
DECL|method|testCreateAppRemoving ( ApplicationSubmissionContext submissionContext)
specifier|protected
name|RMApp
name|testCreateAppRemoving
parameter_list|(
name|ApplicationSubmissionContext
name|submissionContext
parameter_list|)
...
argument_list|)
decl_stmt|;
comment|// REMOVING => FINISHING event RMAppEventType.APP_REMOVED
name|RMAppEvent
name|finishingEvent
init|=
operator|new
...
annotation|@
name|Test
DECL|method|testAppRemovingFinished ()
specifier|public
name|void
name|testAppRemovingFinished
parameter_list|()
throws|throws
name|IOException
block|{
...
name|info
argument_list|(
literal|"--- START: testAppRemovingFINISHED ---"
argument_list|)
expr_stmt|;
name|RMApp
name|application
...
argument_list|)
decl_stmt|;
comment|// APP_REMOVING => FINISHED event RMAppEventType.ATTEMPT_FINISHED
name|RMAppEvent
name|finishedEvent
init|=
operator|new
...
annotation|@
name|Test
DECL|method|testAppRemovingKilled ()
specifier|public
name|void
name|testAppRemovingKilled
parameter_list|()
throws|throws
name|IOException
block|{
...
name|info
argument_list|(
literal|"--- START: testAppRemovingKilledD ---"
argument_list|)
expr_stmt|;
name|RMApp
name|application
...
argument_list|)
decl_stmt|;
comment|// APP_REMOVING => KILLED event RMAppEventType.KILL
name|RMAppEvent
name|event
init|=
operator|new
