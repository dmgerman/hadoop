...
annotation|@
name|Test
DECL|method|testAMBlackListConfigFromApp ()
specifier|public
name|void
name|testAMBlackListConfigFromApp
parameter_list|()
block|{
comment|// Scenario 1: Application enables AM blacklisting
name|float
...
argument_list|)
expr_stmt|;
comment|// Scenario 2: Application disables AM blacklisting
name|float
...
argument_list|)
decl_stmt|;
comment|// Am blacklisting will be disabled eventhough its enabled in RM.
name|Assert
operator|.
name|assertFalse
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Scenario 3: Application updates invalid AM threshold
name|float
name|invalidDisableThreshold
init|=
operator|-
literal|0.5f
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Scenario 4: Empty AMBlackListingRequest in Submission Context
name|conf
operator|.
name|setBoolean
argument_list|(
