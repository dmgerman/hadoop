...
argument_list|)
expr_stmt|;
comment|// send attempt final state saved event.
name|application
operator|.
...
argument_list|)
expr_stmt|;
comment|// this method is to make AMLaunchedTransition invoked inside which
comment|// ClientTokenMasterKey is registered in ClientTokenSecretManager
name|moveCurrentAttemptToLaunchedState
argument_list|(
name|app
operator|.
name|getCurrentAppAttempt
...
argument_list|)
expr_stmt|;
comment|// kill the app attempt and verify client token is unavailable
name|app
operator|.
name|handle
argument_list|(
...
literal|"unchecked"
argument_list|)
DECL|method|moveCurrentAttemptToLaunchedState (RMAppAttempt attempt)
specifier|private
name|void
name|moveCurrentAttemptToLaunchedState
parameter_list|(
