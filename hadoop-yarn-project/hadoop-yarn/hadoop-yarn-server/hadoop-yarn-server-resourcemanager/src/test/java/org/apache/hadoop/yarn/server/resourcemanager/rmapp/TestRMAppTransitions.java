...
literal|30000
argument_list|)
DECL|method|testAppRecoverToFailed ()
specifier|public
name|void
name|testAppRecoverToFailed
parameter_list|()
throws|throws
name|IOException
block|{
...
name|info
argument_list|(
literal|"--- START: testAppRecoverToFailed ---"
argument_list|)
expr_stmt|;
name|ApplicationSubmissionContext
name|sub
...
argument_list|)
decl_stmt|;
comment|// NEW => FINAL_SAVING, event RMAppEventType.RECOVER
name|RMState
name|state
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// NPE will throw on recovery.
name|application
operator|.
name|handle
argument_list|(
