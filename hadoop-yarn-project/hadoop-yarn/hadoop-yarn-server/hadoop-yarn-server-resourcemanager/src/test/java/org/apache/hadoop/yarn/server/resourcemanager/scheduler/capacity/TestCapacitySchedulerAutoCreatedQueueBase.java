...
literal|20f
decl_stmt|;
DECL|field|ASUBGROUP1_CAPACITY
specifier|public
specifier|static
specifier|final
name|float
name|ASUBGROUP1_CAPACITY
init|=
literal|10f
decl_stmt|;
DECL|field|AGROUP_CAPACITY
specifier|public
specifier|static
specifier|final
name|float
name|AGROUP_CAPACITY
init|=
literal|10f
decl_stmt|;
...
name|TEST_GROUP
init|=
literal|"testusergroup"
decl_stmt|;
DECL|field|TEST_GROUPUSER
specifier|public
specifier|static
specifier|final
name|String
...
literal|"SSD"
decl_stmt|;
DECL|field|NODE_LABEL_GPU_TEMPLATE_CAPACITY
specifier|public
specifier|static
specifier|final
name|float
name|NODE_LABEL_GPU_TEMPLATE_CAPACITY
init|=
literal|30.0f
decl_stmt|;
DECL|field|NODEL_LABEL_SSD_TEMPLATE_CAPACITY
specifier|public
specifier|static
specifier|final
name|float
name|NODEL_LABEL_SSD_TEMPLATE_CAPACITY
init|=
literal|40.0f
decl_stmt|;
DECL|field|mockRM
...
return|;
block|}
DECL|method|setupGroupQueueMappings (String parentQueue, CapacitySchedulerConfiguration conf, String leafQueueName)
specifier|public
specifier|static
name|CapacitySchedulerConfiguration
...
name|TEST_GROUP
operator|+
literal|";invalid_user=invalid_group"
argument_list|)
expr_stmt|;
name|UserGroupMappingPlacementRule
operator|.
...
return|;
block|}
DECL|method|setupSchedulerConfiguration ()
specifier|protected
name|CapacitySchedulerConfiguration
name|setupSchedulerConfiguration
parameter_list|()
...
name|RESOURCE_TYPES
operator|+
literal|".vcores.minimum-allocation"
argument_list|,
literal|1
argument_list|)
expr_stmt|;
...
name|RESOURCE_TYPES
operator|+
literal|".vcores.maximum-allocation"
argument_list|,
literal|8
argument_list|)
expr_stmt|;
...
name|RESOURCE_TYPES
operator|+
literal|".memory-mb.minimum-allocation"
argument_list|,
literal|1024
argument_list|)
expr_stmt|;
...
name|RESOURCE_TYPES
operator|+
literal|".memory-mb.maximum-allocation"
argument_list|,
literal|16384
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|validateContainerLimits ( AutoCreatedLeafQueue autoCreatedLeafQueue)
specifier|protected
name|void
...
expr_stmt|;
block|}
DECL|method|validateInitialQueueEntitlement (CSQueue parentQueue, String leafQueueName, Map<String, Float> expectedTotalChildQueueAbsCapacityByLabel, Set<String> nodeLabels)
specifier|protected
name|void
...
name|Float
argument_list|>
name|expectedTotalChildQueueAbsCapacityByLabel
parameter_list|,
name|Set
argument_list|<
name|String
...
expr_stmt|;
block|}
DECL|method|validateInitialQueueEntitlement ( CapacityScheduler capacityScheduler, CSQueue parentQueue, String leafQueueName, Map<String, Float> expectedTotalChildQueueAbsCapacityByLabel, Set<String> nodeLabels)
specifier|protected
name|void
name|validateInitialQueueEntitlement
parameter_list|(
...
block|}
block|}
DECL|method|validateActivatedQueueEntitlement (CSQueue parentQueue, String leafQueueName, Map<String, Float> expectedTotalChildQueueAbsCapacity, List<QueueManagementChange> queueManagementChanges, Set<String> expectedNodeLabels)
specifier|protected
name|void
...
expr_stmt|;
block|}
DECL|method|validateDeactivatedQueueEntitlement (CSQueue parentQueue, String leafQueueName, Map<String, Float> expectedTotalChildQueueAbsCapacity, List<QueueManagementChange> queueManagementChanges)
specifier|protected
name|void
...
expr_stmt|;
block|}
DECL|method|validateQueueEntitlements (String leafQueueName, Map<String, QueueEntitlement> expectedEntitlements, List<QueueManagementChange> queueEntitlementChanges, Set<String> expectedNodeLabels)
name|void
name|validateQueueEntitlements
parameter_list|(
name|String
...
argument_list|)
decl_stmt|;
name|validateQueueEntitlementChanges
argument_list|(
name|leafQueue
argument_list|,
name|expectedEntitlements
...
expr_stmt|;
block|}
DECL|method|validateQueueEntitlementChanges (AutoCreatedLeafQueue leafQueue, Map<String, QueueEntitlement> expectedQueueEntitlements, final List<QueueManagementChange> queueEntitlementChanges, Set<String> expectedNodeLabels)
specifier|private
name|void
name|validateQueueEntitlementChanges
parameter_list|(
...
block|}
block|}
DECL|method|populateExpectedAbsCapacityByLabelForParentQueue (int numLeafQueues)
specifier|protected
name|Map
argument_list|<
name|String
