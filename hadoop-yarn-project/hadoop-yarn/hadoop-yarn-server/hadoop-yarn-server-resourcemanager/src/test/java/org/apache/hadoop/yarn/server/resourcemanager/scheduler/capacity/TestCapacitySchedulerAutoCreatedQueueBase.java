...
expr_stmt|;
block|}
DECL|method|validateInitialQueueEntitlement (CSQueue parentQueue, String leafQueueName, float expectedTotalChildQueueAbsCapacity, Set<String> nodeLabels)
specifier|protected
name|void
...
expr_stmt|;
block|}
DECL|method|validateInitialQueueEntitlement ( CapacityScheduler capacityScheduler, CSQueue parentQueue, String leafQueueName, float expectedTotalChildQueueAbsCapacity, Set<String> nodeLabels)
specifier|protected
name|void
name|validateInitialQueueEntitlement
parameter_list|(
