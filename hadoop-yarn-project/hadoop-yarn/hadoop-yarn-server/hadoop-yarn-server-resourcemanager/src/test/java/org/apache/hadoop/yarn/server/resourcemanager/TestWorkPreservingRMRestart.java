...
specifier|private
name|CapacitySchedulerConfiguration
DECL|method|getSchedulerAutoCreatedQueueConfiguration ( boolean overrideWithQueueMappings)
name|getSchedulerAutoCreatedQueueConfiguration
parameter_list|(
name|boolean
...
expr_stmt|;
block|}
DECL|method|checkFSQueue (ResourceManager rm, SchedulerApplication schedulerApp, Resource usedResources, Resource availableResources, Resource amResources)
specifier|private
name|void
name|checkFSQueue
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|verifyAppRecoveryWithWrongQueueConfig ( CapacitySchedulerConfiguration csConf, RMApp app, String diagnostics, MockMemoryRMStateStore memStore, RMState state)
specifier|private
name|void
...
argument_list|)
expr_stmt|;
comment|//Reload previous state with cloned app sub context object
name|RMState
name|newState
init|=
name|memStore2
...
literal|30000
argument_list|)
DECL|method|testUnknownUserOnRecovery ()
specifier|public
name|void
name|testUnknownUserOnRecovery
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|30000
argument_list|)
DECL|method|testDynamicAutoCreatedQueueRecoveryWithDefaultQueue ()
specifier|public
name|void
name|testDynamicAutoCreatedQueueRecoveryWithDefaultQueue
parameter_list|()
throws|throws
name|Exception
block|{
comment|//if queue name is not specified, it should submit to 'default' queue
name|testDynamicAutoCreatedQueueRecovery
argument_list|(
name|USER1
argument_list|,
literal|null
...
literal|30000
argument_list|)
DECL|method|testDynamicAutoCreatedQueueRecoveryWithOverrideQueueMappingFlag ()
specifier|public
name|void
name|testDynamicAutoCreatedQueueRecoveryWithOverrideQueueMappingFlag
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// Test work preserving recovery of apps running on auto-created queues.
comment|// This involves:
comment|// 1. Setting up a dynamic auto-created queue,
comment|// 2. Submitting an app to it,
comment|// 3. Failing over RM,
comment|// 4. Validating that the app is recovered post failover,
comment|// 5. Check if all running containers are recovered,
comment|// 6. Verify the scheduler state like attempt info,
comment|// 7. Verify the queue/user metrics for the dynamic auto-created queue.
DECL|method|testDynamicAutoCreatedQueueRecovery (String user, String queueName)
specifier|public
name|void
name|testDynamicAutoCreatedQueueRecovery
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// 1. Set up dynamic auto-created queue.
name|CapacitySchedulerConfiguration
name|schedulerConf
init|=
literal|null
...
argument_list|()
expr_stmt|;
comment|// 2. submit app to queue which is auto-created.
name|RMApp
name|app1
init|=
name|rm1
...
argument_list|)
expr_stmt|;
comment|//    Resource availableResources = Resources.subtract(nmResource,
comment|// usedResources);
comment|// 6. Verify the scheduler state like attempt info.
name|Map
argument_list|<
name|ApplicationId
...
expr_stmt|;
block|}
comment|// Apps already completed before RM restart. Make sure we restore the queue
comment|// correctly
annotation|@
name|Test
argument_list|(
...
literal|20000
argument_list|)
DECL|method|testFairSchedulerCompletedAppsQueue ()
specifier|public
name|void
name|testFairSchedulerCompletedAppsQueue
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Queue in app not equal to submission context"
argument_list|,
name|fsQueueApp
argument_list|,
name|fsQueueContext
...
name|assertNotNull
argument_list|(
literal|"No AppAttempt found after recovery"
argument_list|,
name|rmAttemptRecovered
argument_list|)
expr_stmt|;
name|String
name|fsQueueContextRecovered
init|=
name|recoveredApp
operator|.
name|getApplicationSubmissionContext
...
name|assertEquals
argument_list|(
literal|"Recovered app queue is not the same as context queue"
argument_list|,
name|fsQueueAppRecovered
argument_list|,
name|fsQueueContextRecovered
