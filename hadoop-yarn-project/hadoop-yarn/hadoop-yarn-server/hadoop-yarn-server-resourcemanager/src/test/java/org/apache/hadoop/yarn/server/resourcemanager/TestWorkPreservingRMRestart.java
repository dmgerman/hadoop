...
expr_stmt|;
block|}
DECL|method|checkFifoQueue (ResourceManager rm, SchedulerApplication schedulerApp, Resource usedResources, Resource availableResources)
specifier|private
name|void
name|checkFifoQueue
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|initFairScheduler (ResourceManager rm)
specifier|private
name|void
name|initFairScheduler
parameter_list|(
