...
argument_list|)
expr_stmt|;
comment|// Update allocator with a newly constructed scheduling request different at
comment|// #allocations, should succeeded.
name|SchedulingRequest
...
annotation|@
name|Test
DECL|method|testNodeAttributesFunctionality ()
specifier|public
name|void
name|testNodeAttributesFunctionality
parameter_list|()
block|{
comment|// 1. Simple java=1.8 validation
name|SchedulingRequest
name|schedulingRequest
init|=
name|SchedulingRequest
...
name|assertTrue
argument_list|(
literal|"Allocation should be success for java=1.8"
argument_list|,
name|result
argument_list|)
expr_stmt|;
comment|// 2. verify python!=3 validation
name|SchedulingRequest
name|schedulingRequest2
init|=
name|SchedulingRequest
operator|.
name|newBuilder
...
name|assertTrue
argument_list|(
literal|"Allocation should be success as python doesn't exist"
argument_list|,
name|result
argument_list|)
expr_stmt|;
comment|// 3. verify python!=3 validation when node has python=2
name|allocator
operator|=
operator|new
name|SingleConstraintAppPlacementAllocator
...
name|assertTrue
argument_list|(
literal|"Allocation should be success as python=3 doesn't exist in node"
argument_list|,
name|result
argument_list|)
expr_stmt|;
comment|// 4. verify python!=3 validation when node has python=3
name|allocator
operator|=
operator|new
name|SingleConstraintAppPlacementAllocator
...
name|assertFalse
argument_list|(
literal|"Allocation should fail as python=3 exist in node"
argument_list|,
name|result
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testConjunctionNodeAttributesFunctionality ()
specifier|public
name|void
name|testConjunctionNodeAttributesFunctionality
parameter_list|()
block|{
comment|// 1. verify and(python!=3:java=1.8) validation when node has python=3
name|SchedulingRequest
name|schedulingRequest1
init|=
name|SchedulingRequest
operator|.
name|newBuilder
...
name|assertFalse
argument_list|(
literal|"Allocation should fail as python=3 exists in node"
argument_list|,
name|result
argument_list|)
expr_stmt|;
comment|// 2. verify and(python!=3:java=1.8) validation when node has python=2
comment|// and java=1.8
name|allocator
operator|=
operator|new
name|SingleConstraintAppPlacementAllocator
...
name|assertTrue
argument_list|(
literal|"Allocation should be success as python=2 exists in node"
argument_list|,
name|result
argument_list|)
expr_stmt|;
comment|// 3. verify or(python!=3:java=1.8) validation when node has python=3
name|SchedulingRequest
name|schedulingRequest2
init|=
name|SchedulingRequest
...
name|assertTrue
argument_list|(
literal|"Allocation should be success as java=1.8 exists in node"
argument_list|,
name|result
argument_list|)
expr_stmt|;
comment|// 4. verify or(python!=3:java=1.8) validation when node has python=3
comment|// and java=1.7.
name|allocator
operator|=
operator|new
name|SingleConstraintAppPlacementAllocator
...
name|assertFalse
argument_list|(
literal|"Allocation should fail as java=1.8 doesnt exist in node"
argument_list|,
name|result
argument_list|)
expr_stmt|;
