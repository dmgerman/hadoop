...
argument_list|)
expr_stmt|;
comment|// Invalid (with multiple allocation tags expression specified)
name|assertInvalidSchedulingRequest
argument_list|(
name|SchedulingRequest
operator|.
...
argument_list|)
expr_stmt|;
comment|// Invalid (with multiple node partition target expression specified)
name|assertInvalidSchedulingRequest
argument_list|(
name|SchedulingRequest
operator|.
...
argument_list|)
expr_stmt|;
comment|// Invalid (not anti-affinity cardinality)
name|assertInvalidSchedulingRequest
argument_list|(
name|SchedulingRequest
operator|.
...
argument_list|)
expr_stmt|;
comment|// Invalid (not NODE scope)
name|assertInvalidSchedulingRequest
argument_list|(
name|SchedulingRequest
operator|.
