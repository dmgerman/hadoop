...
name|dispatcher
decl_stmt|;
DECL|field|oppContainersStatus
specifier|private
name|OpportunisticContainersStatus
name|oppContainersStatus
init|=
name|getOpportunisticStatus
argument_list|()
decl_stmt|;
annotation|@
name|Before
...
literal|60000
argument_list|)
DECL|method|testOpportunisticSchedulerMetrics ()
specifier|public
name|void
name|testOpportunisticSchedulerMetrics
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|60000
argument_list|)
DECL|method|testAMCrashDuringAllocate ()
specifier|public
name|void
name|testAMCrashDuringAllocate
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|//simulate AM crash by replacing the current attempt
comment|//Do not use rm.failApplicationAttempt, the bug will skip due to
comment|//ApplicationDoesNotExistInCacheException
name|CapacityScheduler
name|scheduler
init|=
operator|(
...
literal|60000
argument_list|)
DECL|method|testAppAttemptRemovalAfterNodeRemoval ()
specifier|public
name|void
name|testAppAttemptRemovalAfterNodeRemoval
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|getOpportunisticStatus ()
specifier|private
name|OpportunisticContainersStatus
name|getOpportunisticStatus
parameter_list|()
...
return|;
block|}
DECL|method|getOppurtunisticStatus (int waitTime, int queueLength, int queueCapacity)
specifier|private
name|OpportunisticContainersStatus
name|getOppurtunisticStatus
parameter_list|(
