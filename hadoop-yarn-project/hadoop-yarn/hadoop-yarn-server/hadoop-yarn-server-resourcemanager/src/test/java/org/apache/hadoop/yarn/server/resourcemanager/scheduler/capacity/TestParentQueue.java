...
block|{
DECL|field|QUEUE_B_RESOURCE
specifier|private
specifier|static
specifier|final
name|Resource
name|QUEUE_B_RESOURCE
init|=
name|Resource
operator|.
name|newInstance
...
argument_list|)
decl_stmt|;
DECL|field|QUEUE_A_RESOURCE
specifier|private
specifier|static
specifier|final
name|Resource
name|QUEUE_A_RESOURCE
init|=
name|Resource
operator|.
name|newInstance
...
expr_stmt|;
block|}
DECL|method|setupSingleLevelQueuesWithAbsoluteResource ( CapacitySchedulerConfiguration conf)
specifier|private
name|void
name|setupSingleLevelQueuesWithAbsoluteResource
parameter_list|(
name|CapacitySchedulerConfiguration
name|conf
parameter_list|)
...
name|info
argument_list|(
literal|"Setup top-level queues a and b with absolute resource"
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|testAbsoluteResourceWithChangeInClusterResource ()
specifier|public
name|void
name|testAbsoluteResourceWithChangeInClusterResource
parameter_list|()
throws|throws
name|Exception
block|{
