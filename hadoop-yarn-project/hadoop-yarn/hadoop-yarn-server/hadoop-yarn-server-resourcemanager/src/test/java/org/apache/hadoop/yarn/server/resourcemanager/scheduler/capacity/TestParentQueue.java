...
argument_list|)
expr_stmt|;
comment|// Simulate returning 2 containers on node_0 before offswitch limit
name|stubQueueAllocation
argument_list|(
name|a
argument_list|,
...
comment|// Now, B should get the scheduling opportunity
comment|// since A has 2/6G while B has 2/14G,
comment|// A also gets an opportunity because offswitchlimit not reached
name|stubQueueAllocation
argument_list|(
name|a
argument_list|,
