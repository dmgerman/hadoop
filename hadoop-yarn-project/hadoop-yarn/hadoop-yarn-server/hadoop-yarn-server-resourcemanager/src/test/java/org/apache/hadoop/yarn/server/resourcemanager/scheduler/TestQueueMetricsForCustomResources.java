...
name|ResourceMetricsKey
operator|.
name|AGGREGATE_PREEMPTED_SECONDS_CUSTOM_RES1
import|;
end_import
...
name|ResourceMetricsKey
operator|.
name|AGGREGATE_PREEMPTED_SECONDS_CUSTOM_RES2
import|;
end_import
...
specifier|final
name|long
name|customResource1AfterDecrease
init|=
operator|(
name|testData
operator|.
...
specifier|final
name|long
name|customResource2AfterDecrease
init|=
operator|(
name|testData
operator|.
