...
argument_list|)
expr_stmt|;
comment|// assert memory and default vcores
name|ClientResponse
name|response
init|=
name|r
...
argument_list|)
expr_stmt|;
comment|// the RM needs to be running to process the resource update
name|rm
operator|.
name|start
argument_list|()
expr_stmt|;
comment|// update memory to 8192MB and 5 cores
name|Resource
name|resource
init|=
name|Resource
...
argument_list|)
expr_stmt|;
comment|// assert updated memory and cores
name|response
operator|=
name|r
operator|.
...
argument_list|)
expr_stmt|;
comment|// test non existing node
name|response
operator|=
name|r
operator|.
...
annotation|@
name|Test
DECL|method|testNodeAttributesInfo ()
specifier|public
name|void
name|testNodeAttributesInfo
parameter_list|()
throws|throws
name|Exception
block|{
