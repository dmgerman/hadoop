...
argument_list|)
expr_stmt|;
comment|// set resource of RMNode to 1024 and verify it works.
name|node0
operator|.
...
argument_list|)
expr_stmt|;
comment|// verify that SchedulerNode's resource hasn't been changed.
name|assertEquals
argument_list|(
name|schedulerNodes
operator|.
...
argument_list|)
expr_stmt|;
comment|// now, NM heartbeat comes.
name|NodeUpdateSchedulerEvent
name|node0Update
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// SchedulerNode's available resource is changed.
name|assertEquals
argument_list|(
name|schedulerNodes
operator|.
