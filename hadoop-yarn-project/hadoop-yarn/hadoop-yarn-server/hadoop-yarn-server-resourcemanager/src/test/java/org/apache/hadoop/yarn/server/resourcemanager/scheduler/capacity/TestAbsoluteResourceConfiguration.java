...
name|assertEquals
argument_list|(
literal|"Absolute capacity for QUEUEA is not correct"
argument_list|,
literal|0.4
argument_list|,
name|qA
...
name|assertEquals
argument_list|(
literal|"Absolute Max capacity for QUEUEA is not correct"
argument_list|,
literal|0.8
argument_list|,
name|qA
...
name|assertEquals
argument_list|(
literal|"Absolute capacity for QUEUEB is not correct"
argument_list|,
literal|0.2
argument_list|,
name|qB
...
name|assertEquals
argument_list|(
literal|"Absolute Max capacity for QUEUEB is not correct"
argument_list|,
literal|0.6
argument_list|,
name|qB
...
name|assertEquals
argument_list|(
literal|"Absolute capacity for QUEUEC is not correct"
argument_list|,
literal|0.2
argument_list|,
name|qC
...
name|assertEquals
argument_list|(
literal|"Absolute Max capacity for QUEUEC is not correct"
argument_list|,
literal|0.6
argument_list|,
name|qC
...
name|assertEquals
argument_list|(
literal|"Absolute capacity for QUEUEA1 is not correct"
argument_list|,
literal|0.2
argument_list|,
name|qA1
...
name|assertEquals
argument_list|(
literal|"Absolute Max capacity for QUEUEA1 is not correct"
argument_list|,
literal|0.8
argument_list|,
name|qA1
...
name|assertEquals
argument_list|(
literal|"Absolute capacity for QUEUEA2 is not correct"
argument_list|,
literal|0.2
argument_list|,
name|qA2
...
name|assertEquals
argument_list|(
literal|"Absolute Max capacity for QUEUEA2 is not correct"
argument_list|,
literal|0.8
argument_list|,
name|qA2
...
name|assertEquals
argument_list|(
literal|"Absolute capacity for QUEUEB1 is not correct"
argument_list|,
literal|0.16
argument_list|,
name|qB1
...
name|assertEquals
argument_list|(
literal|"Absolute Max capacity for QUEUEB1 is not correct"
argument_list|,
literal|0.6
argument_list|,
name|qB1
...
argument_list|)
expr_stmt|;
comment|// There will be no change in effective resource when nodes are added.
comment|// Since configured capacity was based on initial node capacity, a
comment|// re configurations is needed to use this added capacity.
name|Assert
operator|.
name|assertEquals
argument_list|(
