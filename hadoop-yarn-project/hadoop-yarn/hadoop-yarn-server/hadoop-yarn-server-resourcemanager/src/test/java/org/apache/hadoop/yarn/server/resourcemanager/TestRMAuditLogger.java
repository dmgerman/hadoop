...
expr_stmt|;
block|}
DECL|method|testSuccessLogFormatHelper (boolean checkIP, ApplicationId appId, ApplicationAttemptId attemptId, ContainerId containerId, CallerContext callerContext, Resource resource, InetAddress remoteIp, RMAuditLogger.ArgsBuilder args, String queueName, String partition)
specifier|private
name|void
name|testSuccessLogFormatHelper
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|testFailureLogFormatHelper (boolean checkIP, ApplicationId appId, ApplicationAttemptId attemptId, ContainerId containerId, CallerContext callerContext, Resource resource, String queueName, String partition, RMAuditLogger.ArgsBuilder args)
specifier|private
name|void
name|testFailureLogFormatHelper
parameter_list|(
