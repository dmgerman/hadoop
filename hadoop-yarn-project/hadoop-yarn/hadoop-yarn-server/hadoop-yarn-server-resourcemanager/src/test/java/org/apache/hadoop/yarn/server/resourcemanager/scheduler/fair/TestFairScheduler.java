...
name|println
argument_list|(
literal|"<minResources>1024mb,5vcores</minResources>"
argument_list|)
expr_stmt|;
name|out
operator|.
...
argument_list|)
expr_stmt|;
comment|// Now remove app of queue2
name|AppAttemptRemovedSchedulerEvent
...
argument_list|)
expr_stmt|;
comment|// Reserved container should will be at higher priority,
comment|// since old reservation cannot be satisfied
for|for
control|(
name|RMContainer
name|container
...
argument_list|)
expr_stmt|;
comment|// Reserved container (at higher priority) should be run
name|Collection
argument_list|<
name|RMContainer
argument_list|>
