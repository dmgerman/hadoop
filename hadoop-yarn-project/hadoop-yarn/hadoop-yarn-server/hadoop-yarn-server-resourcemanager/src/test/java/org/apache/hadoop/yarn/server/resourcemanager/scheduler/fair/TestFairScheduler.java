...
name|maxResources
argument_list|(
literal|"1073741824 mb 1000 vcores"
argument_list|)
operator|.
name|weight
argument_list|(
...
comment|// Submit fails before we reach the placement check.
name|ApplicationAttemptId
name|appAttemptId
init|=
name|createAppAttemptId
...
comment|// Submit does not fail we must have a placement context.
name|ApplicationAttemptId
name|appAttemptId3
init|=
name|createAppAttemptId
...
expr_stmt|;
block|}
DECL|method|testIncreaseQueueSettingOnTheFlyInternal ( AllocationFileWriter allocBefore, AllocationFileWriter allocAfter)
specifier|private
name|void
name|testIncreaseQueueSettingOnTheFlyInternal
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|testDecreaseQueueSettingOnTheFlyInternal ( AllocationFileWriter allocBefore, AllocationFileWriter allocAfter)
specifier|private
name|void
name|testDecreaseQueueSettingOnTheFlyInternal
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// The placement rule should add it to the user based queue but the
...
name|fail
argument_list|(
literal|"Submit should have failed with InvalidQueueNameException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
parameter_list|)
block|{
comment|// expected ignore: rules should have filtered this out
block|}
comment|// submission rejected
name|assertEquals
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//ensure ALLOC_FILE contains an 'empty' config
name|AllocationFileWriter
operator|.
name|create
argument_list|()
