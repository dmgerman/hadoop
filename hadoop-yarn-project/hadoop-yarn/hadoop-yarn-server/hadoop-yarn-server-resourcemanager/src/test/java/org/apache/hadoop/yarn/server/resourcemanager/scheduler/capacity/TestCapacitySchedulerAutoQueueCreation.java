...
begin_comment
comment|/**  * Tests for creation and reinitialization of auto created leaf queues  * under a ManagedParentQueue.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|//Verify if USER_2 can be deactivated since it has no pending appsA
name|List
argument_list|<
...
argument_list|)
expr_stmt|;
comment|//USER_3 should now get activated
...
annotation|@
name|Test
DECL|method|testAutoCreatedQueueInheritsNodeLabels ()
specifier|public
name|void
name|testAutoCreatedQueueInheritsNodeLabels
parameter_list|()
throws|throws
name|Exception
block|{
