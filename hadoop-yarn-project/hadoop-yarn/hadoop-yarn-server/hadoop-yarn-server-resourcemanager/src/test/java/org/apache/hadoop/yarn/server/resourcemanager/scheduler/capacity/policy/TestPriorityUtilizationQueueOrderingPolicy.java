...
block|{
DECL|method|mockCSQueues (String[] queueNames, int[] priorities, float[] utilizations, float[] absCapacities, String partition)
specifier|private
name|List
argument_list|<
name|CSQueue
...
argument_list|)
expr_stmt|;
comment|// Case 14, 5 queues, different priority,
comment|// partition default - abs capacity is 0;
name|policy
operator|.
name|setQueues
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Case 17, 2 queues, one's abs capacity is 0
name|policy
operator|.
name|setQueues
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Case 18, 2 queues, one's abs capacity is 0
name|policy
operator|.
name|setQueues
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//Case 19, 5 queues with 2 having abs capacity 0 are prioritized last
name|policy
operator|.
name|setQueues
argument_list|(
