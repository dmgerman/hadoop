...
expr_stmt|;
block|}
comment|// Test to verify that the containers of previous attempt are returned in
comment|// the RM response to the heartbeat of AM if these containers were not
comment|// recovered by the time AM registered.
comment|//
comment|// 1. App is started with 2 containers running on 2 different nodes-
comment|//    container 2 on the NM1 node and container 3 on the NM2 node.
comment|// 2. Fail the AM of the application.
comment|// 3. Simulate RM restart.
comment|// 4. NM1 connects to the restarted RM immediately. It sends the RM the status
comment|//    of container 2.
comment|// 5. 2nd attempt of the app is launched and the app master registers with RM.
comment|// 6. Verify that app master receives container 2 in the RM response to
comment|//    register request.
comment|// 7. NM2 connects to the RM after a delay. It sends the RM the status of
comment|//    container 3.
comment|// 8. Verify that the app master receives container 3 in the RM response to
comment|//    its heartbeat.
annotation|@
name|Test
argument_list|(
name|timeout
