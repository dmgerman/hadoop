...
expr_stmt|;
block|}
comment|// AM container preempted should not be counted towards AM max retry count.
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|20000
argument_list|)
DECL|method|testAMPreemptedNotCountedForAMFailures ()
specifier|public
name|void
name|testAMPreemptedNotCountedForAMFailures
parameter_list|()
throws|throws
name|Exception
block|{
