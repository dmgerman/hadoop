...
begin_comment
comment|/**  * Test AM restart functions.  */
end_comment
...
name|ParameterizedSchedulerTestBase
block|{
DECL|method|TestAMRestart (SchedulerType type)
specifier|public
name|TestAMRestart
parameter_list|(
name|SchedulerType
...
expr_stmt|;
block|}
comment|/**    * AM container preempted, nm disk failure    * should not be counted towards AM max retry count.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
argument_list|)
decl_stmt|;
comment|// Preempt the next attempt;
name|scheduler
operator|.
name|killContainer
argument_list|(
...
literal|100000
argument_list|)
DECL|method|testMaxAttemptOneMeansOne ()
specifier|public
name|void
name|testMaxAttemptOneMeansOne
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**    * Test RM restarts after AM container is preempted, new RM should not count    * AM preemption failure towards the max-retry-account and should be able to    * re-launch the AM.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
argument_list|)
expr_stmt|;
comment|// wait for the next AM to start
name|rm1
operator|.
name|waitForState
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// state store has 2 attempts stored.
name|ApplicationStateData
name|appState
init|=
name|memStore
...
expr_stmt|;
block|}
comment|/**    * Test regular RM restart/failover, new RM should not count    * AM failure towards the max-retry-account and should be able to    * re-launch the AM.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
expr_stmt|;
block|}
comment|/**    * Test restarting AM launched with the KeepContainers and AM reset window.    * after AM reset window, even if AM who was the last is failed,    * all containers are launched by previous AM should be kept.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
argument_list|)
expr_stmt|;
comment|// container 2 launched and running on node 1
name|nm1
operator|.
name|nodeHeartbeat
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// container 3 launched and running node 2
name|nm2
operator|.
name|nodeHeartbeat
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// container2 is recovered from previous attempt
name|Assert
operator|.
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// container 2 is running on node 1
name|Assert
operator|.
name|assertEquals
argument_list|(
...
name|assertEquals
argument_list|(
literal|"new containers should not be allocated"
argument_list|,
literal|0
argument_list|,
name|allocateResponse
...
argument_list|)
expr_stmt|;
comment|// container 3 is running on node 2
name|Assert
operator|.
name|assertEquals
argument_list|(
...
literal|30000
argument_list|)
DECL|method|testQueueResourceDoesNotLeak ()
specifier|public
name|void
name|testQueueResourceDoesNotLeak
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// After app1 failed, used resource of this queue should
comment|// be cleaned up, otherwise resource leak happened.
if|if
condition|(
name|getSchedulerType
argument_list|()
