...
block|}
block|}
comment|// Account for all containers that got killed while they were still queued.
name|pendingCompletedContainers
operator|.
name|putAll
argument_list|(
name|getKilledQueuedContainerStatuses
argument_list|()
argument_list|)
expr_stmt|;
name|containerStatuses
...
return|;
block|}
comment|/**    * Add to the container statuses the status of the containers that got killed    * while they were queued.    */
DECL|method|getKilledQueuedContainerStatuses ()
specifier|private
name|Map
argument_list|<
name|ContainerId
...
name|ContainerStatus
argument_list|>
name|killedQueuedContainerStatuses
init|=
operator|new
name|HashMap
argument_list|<>
...
block|}
block|}
comment|// Remove null containers from queuing context for killed queued containers.
name|Iterator
argument_list|<
name|ContainerTokenIdentifier
argument_list|>
name|killedQueuedContIter
init|=
name|context
operator|.
name|getQueuingContext
