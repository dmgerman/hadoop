...
begin_package
DECL|package|org.apache.hadoop.yarn.server.nodemanager.recovery.records
package|package
name|org
operator|.
name|apache
...
begin_comment
comment|/**  * The version information of DB Schema for NM.  */
end_comment
...
return|;
block|}
DECL|method|isCompatibleTo (NMDBSchemaVersion version)
specifier|public
name|boolean
name|isCompatibleTo
parameter_list|(
