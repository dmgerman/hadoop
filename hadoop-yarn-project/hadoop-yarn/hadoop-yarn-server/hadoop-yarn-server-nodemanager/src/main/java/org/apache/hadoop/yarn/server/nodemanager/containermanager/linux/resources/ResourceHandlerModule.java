...
return|;
block|}
comment|/**    * Returns relative root for cgroups.  Returns null if cGroupsHandler is    * not initialized, or if the path is empty.    */
DECL|method|getCgroupsRelativeRoot ()
specifier|public
specifier|static
name|String
...
return|;
block|}
DECL|method|getNumaResourceHandler (Configuration conf, Context nmContext)
specifier|private
specifier|static
name|ResourceHandler
name|getNumaResourceHandler
parameter_list|(
name|Configuration
name|conf
parameter_list|,
