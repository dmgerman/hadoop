...
decl_stmt|;
comment|/*    * When AMRMProxy HA is enabled, secondary AMRMTokens will be stored in Yarn    * Registry. Otherwise if NM recovery is enabled, the UAM token are store in    * local NMSS instead under this directory name.    */
...
name|info
argument_list|(
literal|"Recovering data for FederationInterceptor"
argument_list|)
expr_stmt|;
if|if
condition|(
