...
argument_list|()
operator|+
literal|" from home sub-cluster. Will use default queue name "
operator|+
name|YarnConfiguration
operator|.
...
name|subClusterId
decl_stmt|;
DECL|method|RegisterApplicationMasterResponseInfo ( RegisterApplicationMasterResponse response, SubClusterId subClusterId)
name|RegisterApplicationMasterResponseInfo
parameter_list|(
name|RegisterApplicationMasterResponse
name|response
