...
throw|;
block|}
comment|/**    * Perform any cleanup before the next launch of the container.    * @param container         container    */
DECL|method|cleanupBeforeRelaunch (Container container)
specifier|public
name|void
...
block|}
block|}
DECL|method|resolveSymLinks (Map<Path, List<String>> resources, String user)
specifier|private
name|Map
argument_list|<
name|Path
