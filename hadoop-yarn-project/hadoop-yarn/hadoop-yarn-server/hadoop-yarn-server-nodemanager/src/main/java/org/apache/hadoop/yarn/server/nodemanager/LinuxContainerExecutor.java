...
return|;
block|}
comment|/**    * Performs container exec.    *    * @param ctx Encapsulates information necessary for exec container.    * @return stdin and stdout of container exec.    * @throws ContainerExecutionException if container exec fails.    */
annotation|@
name|Override
...
name|ContainerExecutionException
block|{
comment|// TODO: calls PrivilegedOperationExecutor and return IOStream pairs
name|InputStream
name|in
init|=
literal|null
...
name|error
argument_list|(
literal|"Failed to execute command to container runtime"
argument_list|,
name|e
argument_list|)
expr_stmt|;
