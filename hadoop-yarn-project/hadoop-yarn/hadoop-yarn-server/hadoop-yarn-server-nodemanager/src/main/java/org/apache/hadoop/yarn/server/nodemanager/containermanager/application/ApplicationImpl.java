...
argument_list|()
decl_stmt|;
DECL|field|INIT_CONTAINER_TRANSITION
specifier|private
specifier|static
specifier|final
name|InitContainerTransition
name|INIT_CONTAINER_TRANSITION
init|=
operator|new
name|InitContainerTransition
argument_list|()
...
name|warn
argument_list|(
literal|"Killing {} because {} is in state {}"
argument_list|,
name|container
operator|.
name|getContainerId
...
argument_list|,
literal|"Application no longer running.\n"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
argument_list|>
block|{
DECL|method|updateCollectorStatus (ApplicationImpl app)
specifier|private
name|void
name|updateCollectorStatus
parameter_list|(
name|ApplicationImpl
name|app
parameter_list|)
