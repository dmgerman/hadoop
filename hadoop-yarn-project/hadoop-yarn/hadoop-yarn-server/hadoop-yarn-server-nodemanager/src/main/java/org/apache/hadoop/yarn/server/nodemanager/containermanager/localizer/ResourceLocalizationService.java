...
name|lfs
decl_stmt|;
DECL|method|ResourceLocalizationService (Dispatcher dispatcher, ContainerExecutor exec, DeletionService delService, LocalDirsHandlerService dirsHandler, NMStateStoreService stateStore)
specifier|public
name|ResourceLocalizationService
parameter_list|(
name|Dispatcher
...
name|error
argument_list|(
literal|"local path for PRIVATE localization could not be found."
operator|+
literal|"Disks might have failed."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|getPathForLocalization (LocalResource rsrc)
specifier|private
name|Path
name|getPathForLocalization
parameter_list|(
...
block|}
block|}
DECL|method|initializeLogDir (FileContext lfs, String logDir)
specifier|private
name|void
name|initializeLogDir
parameter_list|(
...
block|}
block|}
comment|/**    * Synchronized method to get a list of initialized local dirs. Method will    * check each local dir to ensure it has been setup correctly and will attempt    * to fix any issues it finds.    *     * @return list of initialized local dirs    */
DECL|method|getInitializedLocalDirs ()
specifier|synchronized
specifier|private
name|List
argument_list|<
...
return|;
block|}
comment|/**    * Synchronized method to get a list of initialized log dirs. Method will    * check each local dir to ensure it has been setup correctly and will attempt    * to fix any issues it finds.    *     * @return list of initialized log dirs    */
DECL|method|getInitializedLogDirs ()
specifier|synchronized
specifier|private
name|List
argument_list|<
