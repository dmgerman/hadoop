...
return|;
block|}
DECL|method|getUserAppCachePath (String user, String appId)
specifier|private
name|String
name|getUserAppCachePath
parameter_list|(
name|String
name|user
parameter_list|,
...
expr_stmt|;
block|}
comment|// let the other containers know about the localization failure
for|for
control|(
name|LocalizerResourceRequestEvent
name|reqEvent
...
return|;
block|}
DECL|method|localizationCompleted (LocalResourceStatus stat)
specifier|private
name|void
name|localizationCompleted
parameter_list|(
...
name|error
argument_list|(
literal|"Invalid resource URL specified"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|cleanUpLocalDir (FileContext lfs, DeletionService del)
specifier|private
name|void
name|cleanUpLocalDir
parameter_list|(
...
block|}
block|}
DECL|method|cleanUpFilesFromSubDir (FileContext lfs, DeletionService del, Path dirPath)
specifier|private
name|void
name|cleanUpFilesFromSubDir
parameter_list|(
