...
argument_list|)
decl_stmt|;
DECL|field|PUBLIC_FILECACHE_FOLDER_PERMS
specifier|private
specifier|static
specifier|final
name|FsPermission
name|PUBLIC_FILECACHE_FOLDER_PERMS
init|=
operator|new
name|FsPermission
argument_list|(
...
name|privLocalizers
decl_stmt|;
DECL|field|recentlyCleanedLocalizers
specifier|private
specifier|final
name|Map
argument_list|<
...
name|String
argument_list|>
name|recentlyCleanedLocalizers
decl_stmt|;
DECL|field|maxRecentlyCleaned
specifier|private
specifier|final
name|int
name|maxRecentlyCleaned
init|=
literal|128
decl_stmt|;
...
condition|)
block|{
comment|// Old localizer thread has been stopped, remove it and create
...
condition|)
block|{
comment|// Don't create a new localizer if this one has been recently
comment|// cleaned up - this can happen if localization requests come
comment|// in after cleanupPrivLocalizers has been called.
if|if
condition|(
name|recentlyCleanedLocalizers
operator|.
...
name|info
argument_list|(
literal|"Skipping localization request for recently cleaned "
operator|+
literal|"localizer "
operator|+
name|locId
...
expr_stmt|;
block|}
DECL|method|createDir (Path dirPath, FsPermission perms)
specifier|private
name|void
name|createDir
parameter_list|(
...
DECL|method|findNextResource ( String user, ApplicationId applicationId)
specifier|private
name|ResourceLocalizationSpec
...
block|{
comment|// We failed to get a path for this, don't try to localize this
comment|// resource again.
name|nRsrc
operator|.
name|unlock
argument_list|()
...
return|;
block|}
DECL|method|getLocalizedResource (LocalResourceRequest req, String user, ApplicationId appId)
specifier|public
name|LocalizedResource
name|getLocalizedResource
parameter_list|(
