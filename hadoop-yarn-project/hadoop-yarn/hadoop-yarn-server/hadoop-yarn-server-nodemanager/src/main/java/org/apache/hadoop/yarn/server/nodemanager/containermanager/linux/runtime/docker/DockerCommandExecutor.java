...
block|}
block|}
comment|/**    * Parses the container status string.    *    * @param containerStatusStr container status.    * @return a {@link DockerContainerStatus} representing the status.    */
DECL|method|parseContainerStatus ( String containerStatusStr)
specifier|public
specifier|static
name|DockerContainerStatus
name|parseContainerStatus
