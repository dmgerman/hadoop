...
decl_stmt|;
DECL|field|diskFreeSpaceCutoffLow
specifier|private
name|long
name|diskFreeSpaceCutoffLow
decl_stmt|;
DECL|field|diskFreeSpaceCutoffHigh
specifier|private
name|long
name|diskFreeSpaceCutoffHigh
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Create collection for the directories specified. Users must specify the    * minimum amount of free space that must be available for the dir to be used.    *    * @param dirs    *          directories to be monitored    * @param utilizationSpaceCutOffLow    *          minimum space, in MB, that must be available on the disk for the    *          dir to be taken out of the good dirs list    * @param utilizationSpaceCutOffHigh    *          minimum space, in MB, that must be available on the disk for the    *          dir to be moved from the bad dirs list to the good dirs list    */
DECL|method|DirectoryCollection (String[] dirs, long utilizationSpaceCutOffLow, long utilizationSpaceCutOffHigh)
specifier|public
name|DirectoryCollection
parameter_list|(
name|String
...
parameter_list|,
name|long
name|utilizationSpaceCutOffLow
parameter_list|,
name|long
name|utilizationSpaceCutOffHigh
parameter_list|)
block|{
name|this
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Create collection for the directories specified. Users must specify the    * maximum percentage of disk utilization allowed and the minimum amount of    * free space that must be available for the dir to be used. If either check    * fails the dir is removed from the good dirs list.    *    * @param dirs    *          directories to be monitored    * @param utilizationPercentageCutOffHigh    *          percentage of disk that can be used before the dir is taken out    *          of the good dirs list    * @param utilizationPercentageCutOffLow    *          percentage of disk that can be used when the dir is moved from    *          the bad dirs list to the good dirs list    * @param utilizationSpaceCutOffLow    *          minimum space, in MB, that must be available on the disk for the    *          dir to be taken out of the good dirs list    * @param utilizationSpaceCutOffHigh    *          minimum space, in MB, that must be available on the disk for the    *          dir to be moved from the bad dirs list to the good dirs list    */
DECL|method|DirectoryCollection (String[] dirs, float utilizationPercentageCutOffHigh, float utilizationPercentageCutOffLow, long utilizationSpaceCutOffLow, long utilizationSpaceCutOffHigh)
specifier|public
name|DirectoryCollection
parameter_list|(
name|String
...
return|;
block|}
DECL|method|isDiskFreeSpaceUnderLimit (File dir, long freeSpaceCutoff)
specifier|private
name|boolean
name|isDiskFreeSpaceUnderLimit
parameter_list|(
...
annotation|@
name|VisibleForTesting
DECL|method|getDiskUtilizationSpaceCutoffLow ()
name|long
name|getDiskUtilizationSpaceCutoffLow
parameter_list|()
block|{
...
annotation|@
name|VisibleForTesting
DECL|method|getDiskUtilizationSpaceCutoffHigh ()
name|long
...
return|;
block|}
DECL|method|setDiskUtilizationSpaceCutoff (long freeSpaceCutoff)
specifier|public
name|void
name|setDiskUtilizationSpaceCutoff
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setDiskUtilizationSpaceCutoff (long freeSpaceCutoffLow, long freeSpaceCutoffHigh)
specifier|public
name|void
name|setDiskUtilizationSpaceCutoff
parameter_list|(
name|long
name|freeSpaceCutoffLow
parameter_list|,
name|long
name|freeSpaceCutoffHigh
parameter_list|)
block|{
name|diskFreeSpaceCutoffLow
operator|=
