...
return|;
block|}
comment|/**    * Convert the Protobuf format into the {@link DockerContainerDeletionTask}.    *    * @param proto Protobuf format of the {@link DockerContainerDeletionTask}.    * @param deletionService the {@link DeletionService}.    * @param taskId the ID of the {@link DeletionTask}.    * @return the populated {@link DockerContainerDeletionTask}.    */
specifier|public
specifier|static
name|DockerContainerDeletionTask
DECL|method|convertProtoToDockerContainerDeletionTask ( DeletionServiceDeleteTaskProto proto, DeletionService deletionService, int taskId)
name|convertProtoToDockerContainerDeletionTask
parameter_list|(
name|DeletionServiceDeleteTaskProto
name|proto
