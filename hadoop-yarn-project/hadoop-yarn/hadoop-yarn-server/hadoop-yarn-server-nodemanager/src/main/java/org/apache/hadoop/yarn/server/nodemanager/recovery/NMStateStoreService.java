...
name|containerId
decl_stmt|;
DECL|method|RecoveredContainerState (ContainerId containerId)
name|RecoveredContainerState
parameter_list|(
name|ContainerId
name|containerId
...
name|LocalizedResourceProto
argument_list|>
DECL|field|completedResourcesIterator
...
argument_list|>
argument_list|>
DECL|field|startedResourcesIterator
name|startedResourcesIterator
decl_stmt|;
DECL|method|LocalResourceTrackerState (RecoveryIterator<LocalizedResourceProto> crIt, RecoveryIterator<Entry<LocalResourceProto, Path>> srIt)
name|LocalResourceTrackerState
parameter_list|(
name|RecoveryIterator
argument_list|<
...
name|LocalizedResourceProto
argument_list|>
DECL|method|getCompletedResourcesIterator ()
name|getCompletedResourcesIterator
parameter_list|()
block|{
return|return
name|completedResourcesIterator
...
argument_list|>
argument_list|>
DECL|method|getStartedResourcesIterator ()
name|getStartedResourcesIterator
parameter_list|()
block|{
return|return
name|startedResourcesIterator
...
name|IOException
function_decl|;
comment|/**    * get the Recovered Container State Iterator    * @return recovery iterator    */
