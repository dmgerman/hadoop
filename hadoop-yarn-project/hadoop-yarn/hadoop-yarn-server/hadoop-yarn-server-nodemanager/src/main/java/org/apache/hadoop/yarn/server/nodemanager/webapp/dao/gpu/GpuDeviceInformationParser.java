...
name|xmlReader
decl_stmt|;
DECL|method|GpuDeviceInformationParser ()
specifier|public
name|GpuDeviceInformationParser
parameter_list|()
throws|throws
...
block|}
block|}
comment|/**    * Disable external-dtd since by default nvidia-smi output contains    *&lt;!DOCTYPE nvidia_smi_log SYSTEM "nvsmi_device_v8.dtd"> in header.    */
DECL|method|initSaxParserFactory ()
specifier|private
name|SAXParserFactory
name|initSaxParserFactory
parameter_list|()
