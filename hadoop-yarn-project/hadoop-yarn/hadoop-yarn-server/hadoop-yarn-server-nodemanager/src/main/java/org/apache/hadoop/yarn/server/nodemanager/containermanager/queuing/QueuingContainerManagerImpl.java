...
decl_stmt|;
DECL|field|allocatedMemoryOpportunistic
specifier|private
name|long
name|allocatedMemoryOpportunistic
decl_stmt|;
DECL|field|allocatedVCoresOpportunistic
specifier|private
name|int
name|allocatedVCoresOpportunistic
decl_stmt|;
...
block|{
comment|// Check if part of the stopped/killed queued containers.
for|for
control|(
name|ContainerTokenIdentifier
name|cTokenId
...
argument_list|)
expr_stmt|;
comment|// TODO: Include wait time as well once it is implemented
if|if
condition|(
name|this
operator|.
...
argument_list|)
decl_stmt|;
comment|// The Container might have already started while we were
comment|// iterating..
if|if
condition|(
name|containerTokenIdentifier
