...
block|}
block|}
comment|/** Set a DNS friendly hostname. */
DECL|method|setHostname (DockerRunCommand runCommand, String containerIdStr, String name)
specifier|private
name|void
name|setHostname
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// Only add hostname if network is not host or if Registry DNS is enabled.
if|if
condition|(
operator|!
name|network
...
name|ContainerExecutionException
argument_list|(
literal|"Invalid mount mode requested for mount: "
operator|+
name|parsedMounts
operator|.
name|group
...
block|}
block|}
DECL|method|handleContainerStop (String containerId, Map<String, String> env)
specifier|private
name|void
name|handleContainerStop
parameter_list|(
