...
name|warn
argument_list|(
literal|"unable to use cgroups handler. Exception: "
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|/** Disabling docker's cgroup parent support for the time being. Docker      * needs to use a more recent libcontainer that supports net_cls. In      * addition we also need to revisit current cgroup creation in YARN.      */
comment|//addCGroupParentIfRequired(resourcesOpts, containerIdStr, runCommand);
name|Path
