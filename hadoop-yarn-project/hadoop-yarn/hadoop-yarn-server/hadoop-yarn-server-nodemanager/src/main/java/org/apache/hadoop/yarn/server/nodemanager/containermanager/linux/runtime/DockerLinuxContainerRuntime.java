...
operator|.
name|Private
DECL|field|ENV_DOCKER_CONTAINER_PID_NAMESPACE
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"YARN_CONTAINER_RUNTIME_DOCKER_CONTAINER_PID_NAMESPACE"
decl_stmt|;
annotation|@
name|InterfaceAudience
operator|.
...
return|;
block|}
comment|/**    * This function only returns whether a privileged container was requested,    * not whether the container was or will be launched as privileged.    * @param container    * @return    */
