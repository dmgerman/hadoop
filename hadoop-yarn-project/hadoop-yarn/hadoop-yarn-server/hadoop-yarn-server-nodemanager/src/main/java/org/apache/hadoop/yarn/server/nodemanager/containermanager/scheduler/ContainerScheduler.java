...
argument_list|)
expr_stmt|;
comment|// If this is a running container.. just change the execution type
...
argument_list|)
decl_stmt|;
comment|// Resume opportunistic containers, if resource available.
if|if
condition|(
name|resourcesAvailable
condition|)
...
argument_list|()
decl_stmt|;
comment|// Find containers that were not already started and are in paused state
if|if
condition|(
literal|false
operator|==
