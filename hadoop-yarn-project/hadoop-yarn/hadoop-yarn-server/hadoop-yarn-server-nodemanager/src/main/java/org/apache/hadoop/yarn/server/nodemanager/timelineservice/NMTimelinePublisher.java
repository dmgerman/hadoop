...
literal|"unchecked"
argument_list|)
DECL|method|publishContainerResumedEvent ( ContainerEvent event)
specifier|private
name|void
name|publishContainerResumedEvent
parameter_list|(
name|ContainerEvent
name|event
parameter_list|)
...
literal|"unchecked"
argument_list|)
DECL|method|publishContainerPausedEvent ( ContainerEvent event)
specifier|private
name|void
name|publishContainerPausedEvent
parameter_list|(
name|ContainerEvent
name|event
parameter_list|)
...
literal|"unchecked"
argument_list|)
DECL|method|publishContainerKilledEvent ( ContainerEvent event)
specifier|private
name|void
name|publishContainerKilledEvent
parameter_list|(
name|ContainerEvent
name|event
parameter_list|)
...
literal|"unchecked"
argument_list|)
DECL|method|publishContainerFinishedEvent (ContainerStatus containerStatus, long containerFinishTime, long containerStartTime)
specifier|private
name|void
...
name|warn
argument_list|(
literal|"Unable to create timeline client for app "
operator|+
name|appId
argument_list|,
name|e
