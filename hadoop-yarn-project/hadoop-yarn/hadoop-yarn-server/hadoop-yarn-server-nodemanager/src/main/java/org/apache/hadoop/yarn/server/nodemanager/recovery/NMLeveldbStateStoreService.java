...
literal|"AMRMProxy/"
decl_stmt|;
comment|/**    * The Local Tracker State DB key locations - "completed" and "started".    * To seek through app tracker states in RecoveredUserResources    * we need to move from one app tracker state to another using key "zzz".    * zzz comes later in lexicographical order than started.    * Similarly to move one user to another in RLS,we can use "zzz",    * as RecoveredUserResources uses two keys appcache and filecache.    */
DECL|field|BEYOND_ENTRIES_SUFFIX
specifier|private
specifier|static
specifier|final
name|String
name|BEYOND_ENTRIES_SUFFIX
init|=
literal|"zzz/"
decl_stmt|;
...
return|;
block|}
DECL|method|loadResourceTrackerState (String keyPrefix)
specifier|private
...
init|=
operator|new
name|CompletedResourcesIterator
argument_list|(
name|completedPrefix
argument_list|)
decl_stmt|;
...
return|;
block|}
DECL|class|CompletedResourcesIterator
specifier|private
class|class
name|CompletedResourcesIterator
extends|extends
...
name|startKey
decl_stmt|;
DECL|method|CompletedResourcesIterator (String startKey)
name|CompletedResourcesIterator
parameter_list|(
name|String
name|startKey
...
block|}
block|}
DECL|method|getNextCompletedResource ( LeveldbIterator iter, String keyPrefix)
specifier|private
name|LocalizedResourceProto
name|getNextCompletedResource
parameter_list|(
...
return|;
block|}
DECL|class|StartedResourcesIterator
specifier|private
class|class
name|StartedResourcesIterator
extends|extends
...
name|startKey
decl_stmt|;
DECL|method|StartedResourcesIterator (String startKey)
name|StartedResourcesIterator
parameter_list|(
name|String
name|startKey
...
block|}
block|}
DECL|method|getNextStartedResource ( LeveldbIterator iter, String keyPrefix)
specifier|private
name|Entry
argument_list|<
name|LocalResourceProto
...
return|;
block|}
DECL|method|seekPastPrefix (LeveldbIterator iter, String keyPrefix)
specifier|private
name|void
name|seekPastPrefix
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// seek through App cache
name|String
name|appCachePrefix
init|=
name|keyPrefix
...
argument_list|)
expr_stmt|;
comment|// Seek to next application
name|seekPastPrefix
argument_list|(
name|iter
argument_list|,
