...
block|}
block|}
comment|/**    * Create the log directory, if the directory exists, make sure its permission    * is 750.    */
DECL|method|createLogDir ()
specifier|private
specifier|static
name|void
name|createLogDir
...
argument_list|)
expr_stmt|;
comment|// set permission again to make sure the permission is correct
comment|// in case the directory is already there.
name|localFs
operator|.
name|setPermission
argument_list|(
...
name|YarnRuntimeException
argument_list|(
literal|"Unable to create the log dir"
argument_list|,
name|e
argument_list|)
throw|;
