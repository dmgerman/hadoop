...
decl_stmt|;
DECL|method|ReInitializationContext (ContainerLaunchContext newLaunchContext, ResourceSet resourceSet)
specifier|private
name|ReInitializationContext
parameter_list|(
name|ContainerLaunchContext
...
block|}
block|}
DECL|method|createReInitContext ( ContainerEvent event)
specifier|protected
name|ReInitializationContext
name|createReInitContext
parameter_list|(
...
literal|null
expr_stmt|;
comment|// Set rollback context here..
name|container
operator|.
