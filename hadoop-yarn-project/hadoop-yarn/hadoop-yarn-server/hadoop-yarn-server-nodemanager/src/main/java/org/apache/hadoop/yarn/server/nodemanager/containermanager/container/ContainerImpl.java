...
literal|false
decl_stmt|;
DECL|field|containerRuntimeData
specifier|private
name|Object
...
argument_list|()
expr_stmt|;
comment|// Remove the container from the resource-monitor. When container
comment|// is launched again, it is added back to monitoring service.
name|container
operator|.
name|dispatcher
operator|.
...
return|;
block|}
DECL|method|setIsPaused (boolean paused)
specifier|private
name|void
name|setIsPaused
parameter_list|(
...
name|warn
argument_list|(
literal|"Unable to update finishTimeForRetryAttempts in state store for "
operator|+
name|containerId
argument_list|,
name|e
...
expr_stmt|;
block|}
DECL|method|getContainerRuntimeData (Class<T> runtimeClass)
specifier|public
parameter_list|<
name|T
parameter_list|>
...
argument_list|()
operator|+
literal|" is invalid. Expected class "
operator|+
name|runtimeClass
operator|.
name|getCanonicalName
