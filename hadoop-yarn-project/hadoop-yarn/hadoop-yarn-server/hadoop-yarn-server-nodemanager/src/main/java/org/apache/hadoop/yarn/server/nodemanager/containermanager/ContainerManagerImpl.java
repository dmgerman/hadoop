...
name|msg
init|=
literal|"Cannot obtain the user-name for containerId: "
operator|+
name|containerIDStr
operator|+
...
annotation|@
name|VisibleForTesting
DECL|method|getContainerTokenIdentifier ( UserGroupInformation remoteUgi, org.apache.hadoop.yarn.api.records.Container container)
specifier|protected
name|ContainerTokenIdentifier
...
annotation|@
name|VisibleForTesting
DECL|method|authorizeRequest (String containerIDStr, ContainerLaunchContext launchContext, org.apache.hadoop.yarn.api.records.Container container, UserGroupInformation remoteUgi, ContainerTokenIdentifier tokenId)
specifier|protected
name|void
