...
return|;
block|}
DECL|method|createContainersLauncher ( Context ctxt, ContainerExecutor exec)
specifier|protected
name|AbstractContainersLauncher
name|createContainersLauncher
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// update flowContext reference in ApplicationImpl
name|application
operator|.
name|setFlowContext
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Required to update state store for recovery.
name|context
operator|.
name|getNMStateStore
argument_list|()
...
name|info
argument_list|(
literal|"Updated application reference with flowContext "
operator|+
name|flowContext
operator|+
literal|" for app "
...
name|info
argument_list|(
literal|"TimelineService V2.0 is not enabled. Skipping updating "
operator|+
literal|"flowContext for application "
operator|+
name|applicationID
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|getFlowContext (ContainerLaunchContext launchContext, ApplicationId applicationID)
specifier|private
name|FlowContext
name|getFlowContext
parameter_list|(
...
return|;
block|}
DECL|method|logContainerStatus (String prefix, ContainerStatus status)
specifier|private
name|void
name|logContainerStatus
parameter_list|(
...
name|statuses
init|=
name|getLocalizationStatusesInternal
argument_list|(
name|id
argument_list|,
name|identifier
...
return|;
block|}
DECL|method|getLocalizationStatusesInternal ( ContainerId containerID, NMTokenIdentifier nmTokenIdentifier, String remoteUser)
specifier|private
name|List
argument_list|<
name|LocalizationStatus
...
name|info
argument_list|(
literal|"Getting localization status for {}"
argument_list|,
name|containerID
argument_list|)
expr_stmt|;
