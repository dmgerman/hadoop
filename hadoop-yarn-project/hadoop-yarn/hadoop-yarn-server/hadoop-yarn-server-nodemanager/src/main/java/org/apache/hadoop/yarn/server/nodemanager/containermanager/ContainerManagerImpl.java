...
block|{
comment|//a bind-host case with an address, to support overriding the first hostname
comment|//found when querying for our hostname with the specified address, combine
comment|//the specified address with the actual port listened on by the server
name|connectAddress
operator|=
name|NetUtils
operator|.
...
block|}
block|}
comment|/**    * @param containerTokenIdentifier    *          of the container to be started    * @throws YarnException    */
annotation|@
name|Private
annotation|@
name|VisibleForTesting
...
return|;
block|}
DECL|method|buildAppProto (ApplicationId appId, String user, Credentials credentials, Map<ApplicationAccessType, String> appAcls)
specifier|private
name|ContainerManagerApplicationProto
name|buildAppProto
parameter_list|(
