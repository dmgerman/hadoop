...
expr_stmt|;
block|}
DECL|method|cleanUpApplications (NodeManagerEventType eventType)
specifier|public
name|void
name|cleanUpApplications
parameter_list|(
...
name|warn
argument_list|(
literal|"Interrupted while sleeping on applications finish on resync"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
...
name|YarnRuntimeException
argument_list|(
literal|"Get an unknown NodeManagerEventType: "
operator|+
name|eventType
argument_list|)
throw|;
...
name|YarnRuntimeException
argument_list|(
literal|"Get an unknown ContainerManagerEvent type: "
operator|+
name|event
operator|.
name|getType
