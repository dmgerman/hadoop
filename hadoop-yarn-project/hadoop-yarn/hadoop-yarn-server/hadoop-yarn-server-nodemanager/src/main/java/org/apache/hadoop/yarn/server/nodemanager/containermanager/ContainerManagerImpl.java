...
return|;
block|}
comment|/**    * @param containerTokenIdentifier    *          of the container to be started    * @param ugi    *          ugi corresponding to the remote end making the api-call    * @throws YarnException    */
annotation|@
name|Private
annotation|@
name|VisibleForTesting
...
argument_list|)
decl_stmt|;
comment|// Validate containerToken
name|ContainerTokenIdentifier
name|containerTokenIdentifier
init|=
...
return|;
block|}
DECL|method|verifyAndGetContainerTokenIdentifier ( org.apache.hadoop.yarn.api.records.Token token)
specifier|protected
name|ContainerTokenIdentifier
name|verifyAndGetContainerTokenIdentifier
parameter_list|(
