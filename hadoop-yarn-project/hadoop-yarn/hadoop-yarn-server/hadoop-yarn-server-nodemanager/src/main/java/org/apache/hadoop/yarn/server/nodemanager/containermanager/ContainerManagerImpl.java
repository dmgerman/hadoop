...
name|container
init|=
name|preUpgradeOrLocalizeCheck
argument_list|(
name|containerId
argument_list|,
name|ReInitOp
...
block|}
block|}
comment|/**    * Rollback the last reInitialization, if possible.    * @param containerId Container ID.    * @throws YarnException Yarn Exception.    */
DECL|method|rollbackReInitialization (ContainerId containerId)
specifier|public
name|void
name|rollbackReInitialization
parameter_list|(
name|ContainerId
name|containerId
parameter_list|)
...
block|}
block|}
comment|/**    * Commit last reInitialization after which no rollback will be possible.    * @param containerId Container ID.    * @throws YarnException Yarn Exception.    */
DECL|method|commitReInitialization (ContainerId containerId)
specifier|public
name|void
name|commitReInitialization
parameter_list|(
name|ContainerId
name|containerId
parameter_list|)
...
block|}
block|}
DECL|method|preUpgradeOrLocalizeCheck (ContainerId containerId, ReInitOp op)
specifier|private
name|Container
name|preUpgradeOrLocalizeCheck
parameter_list|(
