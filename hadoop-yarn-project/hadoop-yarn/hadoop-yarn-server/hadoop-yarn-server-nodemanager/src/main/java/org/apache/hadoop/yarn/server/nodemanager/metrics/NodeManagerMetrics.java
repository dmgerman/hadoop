...
name|Metric
argument_list|(
literal|"Memory used by Opportunistic Containers in MB"
argument_list|)
DECL|field|opportMemoryUsed
name|MutableGaugeLong
...
name|Metric
argument_list|(
literal|"# of Virtual Cores used by opportunistic containers"
argument_list|)
DECL|field|opportCoresUsed
name|MutableGaugeInt
...
argument_list|)
DECL|field|runningOpportContainers
name|MutableGaugeInt
...
return|;
block|}
DECL|method|opportunisticContainerCompleted (Container container)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|opportunisticContainerStarted (Container container)
specifier|public
name|void
