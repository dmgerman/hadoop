...
name|KEYSTORE_FILE
init|=
literal|"yarn_provided.keystore"
decl_stmt|;
DECL|field|TRUSTSTORE_FILE
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"yarn_provided.truststore"
decl_stmt|;
...
return|;
block|}
DECL|method|expandAllEnvironmentVars ( ContainerLaunchContext launchContext, Path containerLogDir)
specifier|private
name|Map
argument_list|<
name|String
...
comment|// Use this to track variables that are added to the environment by nm.
name|LinkedHashSet
argument_list|<
name|String
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Select a root dir for all csi volumes for the container
name|Path
name|csiVolumesRoot
init|=
name|deriveCsiVolumesRootDir
argument_list|()
decl_stmt|;
name|recordContainerCsiVolumesRootDir
argument_list|(
name|containerID
argument_list|,
name|csiVolumesRoot
...
return|;
block|}
DECL|method|getUserFilecacheDirs (List<String> localDirs)
specifier|protected
name|List
argument_list|<
name|String
...
return|;
block|}
DECL|method|getApplicationLocalDirs (List<String> localDirs, String appIdStr)
specifier|protected
name|List
argument_list|<
name|String
...
block|}
block|}
DECL|method|prepareForLaunch (ContainerStartContext ctx)
specifier|protected
name|int
name|prepareForLaunch
parameter_list|(
...
block|}
block|}
comment|/**    * Loop through for a time-bounded interval waiting to    * read the process id from a file generated by a running process.    * @return Process ID; null when pidFilePath is null    * @throws Exception    */
DECL|method|getContainerPid ()
name|String
name|getContainerPid
parameter_list|()
throws|throws
...
annotation|@
name|VisibleForTesting
DECL|method|create (Shell.OSType osType)
specifier|public
specifier|static
name|ShellScriptBuilder
name|create
...
return|;
block|}
comment|/**      * Parse an environment value and returns all environment keys it uses.      * @param envVal an environment variable's value      * @return all environment variable names used in<code>envVal</code>.      */
DECL|method|getEnvDependencies (final String envVal)
specifier|public
name|Set
argument_list|<
name|String
...
return|;
block|}
comment|/**      * Returns a dependency ordered version of<code>envs</code>. Does not alter      * input<code>envs</code> map.      * @param envs environment map      * @return a dependency ordered version of<code>envs</code>      */
DECL|method|orderEnvByDependencies ( Map<String, String> envs)
specifier|public
specifier|final
name|Map
argument_list|<
...
expr_stmt|;
block|}
comment|/**      * Parse<code>envVal</code> using bash-like syntax to extract env variables      * it depends on.      */
annotation|@
name|Override
DECL|method|getEnvDependencies (final String envVal)
specifier|public
...
argument_list|()
decl_stmt|;
comment|// env/whitelistedEnv dump values inside double quotes
name|boolean
name|inDoubleQuotes
init|=
literal|true
...
operator|++
expr_stmt|;
comment|// eat until closing simple quote
while|while
condition|(
name|i
operator|<
...
expr_stmt|;
block|}
comment|/**      * Parse<code>envVal</code> using cmd/bat-like syntax to extract env      * variables it depends on.      */
DECL|method|getEnvDependencies (final String envVal)
specifier|public
name|Set
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// find beginning of variable
if|if
condition|(
name|i
operator|<
...
block|{
break|break;
comment|// even %var:...% syntax ends with a %, so j cannot be negative
block|}
specifier|final
name|int
name|k
...
expr_stmt|;
block|}
DECL|method|sanitizeEnv (Map<String, String> environment, Path pwd, List<Path> appDirs, List<String> userLocalDirs, List<String> containerLogDirs, Map<Path, List<String>> resources, Path nmPrivateClasspathJarDir, Set<String> nmVars)
specifier|public
name|void
name|sanitizeEnv
parameter_list|(
...
block|}
block|}
DECL|method|recordContainerCsiVolumesRootDir (ContainerId containerId, String volumesRoot)
specifier|private
name|void
name|recordContainerCsiVolumesRootDir
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO persistent to the NM store...
block|}
...
return|;
block|}
comment|/**    * Clean up container's files for container relaunch or cleanup.    */
DECL|method|cleanupContainerFiles (Path containerWorkDir)
specifier|protected
name|void
name|cleanupContainerFiles
parameter_list|(
...
name|debug
argument_list|(
literal|"cleanup container {} files"
argument_list|,
name|containerWorkDir
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * Returns the PID File Path.    */
DECL|method|getPidFilePath ()
name|Path
name|getPidFilePath
parameter_list|()
block|{
...
return|;
block|}
comment|/**    * Marks the container to be launched only if it was not launched.    *    * @return true if successful; false otherwise.    */
DECL|method|markLaunched ()
name|boolean
name|markLaunched
parameter_list|()
block|{
...
return|;
block|}
comment|/**    * Returns if the launch is completed or not.    */
DECL|method|isLaunchCompleted ()
name|boolean
