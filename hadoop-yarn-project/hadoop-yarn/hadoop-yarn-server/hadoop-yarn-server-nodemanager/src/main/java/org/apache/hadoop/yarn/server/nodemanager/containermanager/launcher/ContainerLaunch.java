...
name|dirsHandler
decl_stmt|;
DECL|method|ContainerLaunch (Context context, Configuration configuration, Dispatcher dispatcher, ContainerExecutor exec, Application app, Container container, LocalDirsHandlerService dirsHandler)
specifier|public
name|ContainerLaunch
parameter_list|(
name|Context
...
block|}
block|}
DECL|method|sanitizeEnv (Map<String, String> environment, Path pwd, List<Path> appDirs, List<String> containerLogDirs, Map<Path, List<String>> resources)
specifier|public
name|void
name|sanitizeEnv
parameter_list|(
