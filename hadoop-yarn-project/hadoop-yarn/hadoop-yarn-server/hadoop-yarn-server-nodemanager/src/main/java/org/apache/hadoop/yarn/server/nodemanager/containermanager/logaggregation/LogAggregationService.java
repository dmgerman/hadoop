...
expr_stmt|;
block|}
DECL|method|calculateRollingMonitorInterval (Configuration conf)
specifier|private
specifier|static
name|long
name|calculateRollingMonitorInterval
parameter_list|(
name|Configuration
name|conf
parameter_list|)
...
decl_stmt|;
name|long
name|minRollingMonitorInterval
init|=
name|conf
operator|.
name|getLong
...
decl_stmt|;
name|boolean
name|warnHardMinLimitLowerThanDefault
init|=
name|minRollingMonitorInterval
operator|<
name|YarnConfiguration
...
name|warn
argument_list|(
literal|"{} has been set to {}, which is less than the default "
operator|+
literal|"minimum value {}. This may impact NodeManager's performance."
argument_list|,
name|YarnConfiguration
operator|.
name|MIN_LOG_ROLLING_INTERVAL_SECONDS
...
name|info
argument_list|(
literal|"Log aggregation debug mode enabled. "
operator|+
literal|"Skipped checking minimum limit."
argument_list|)
expr_stmt|;
block|}
else|else
...
name|warn
argument_list|(
literal|"rollingMonitorInterval should be more than "
operator|+
literal|"or equal to {} seconds. Using {} seconds instead."
argument_list|,
name|minRollingMonitorInterval
argument_list|,
name|minRollingMonitorInterval
...
name|info
argument_list|(
literal|"rollingMonitorInterval is set as {}. The logs will be "
operator|+
literal|"aggregated every {} seconds"
argument_list|,
name|rollingMonitorInterval
argument_list|,
name|rollingMonitorInterval
