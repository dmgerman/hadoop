...
argument_list|)
decl_stmt|;
DECL|method|ContainersLauncher ()
specifier|public
name|ContainersLauncher
parameter_list|()
block|{
...
annotation|@
name|Override
DECL|method|init (Context nmContext, Dispatcher nmDispatcher, ContainerExecutor containerExec, LocalDirsHandlerService nmDirsHandler, ContainerManagerImpl nmContainerManager)
specifier|public
name|void
name|init
parameter_list|(
...
annotation|@
name|VisibleForTesting
DECL|method|cleanup (ContainersLauncherEvent event, ContainerId containerId, boolean async)
name|void
name|cleanup
parameter_list|(
name|ContainersLauncherEvent
