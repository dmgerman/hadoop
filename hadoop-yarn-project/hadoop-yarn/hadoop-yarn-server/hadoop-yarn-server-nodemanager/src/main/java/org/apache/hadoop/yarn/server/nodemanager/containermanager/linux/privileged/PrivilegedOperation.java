...
argument_list|)
block|,
DECL|enumConstant|DEVICE
name|DEVICE
argument_list|(
literal|"--module-devices"
argument_list|)
block|,
...
argument_list|)
block|,
DECL|enumConstant|RUN_RUNC_CONTAINER
name|RUN_RUNC_CONTAINER
argument_list|(
literal|"--run-runc-container"
argument_list|)
block|,
DECL|enumConstant|REAP_RUNC_LAYER_MOUNTS
name|REAP_RUNC_LAYER_MOUNTS
argument_list|(
literal|"--reap-runc-layer-mounts"
argument_list|)
block|;
DECL|field|option
specifier|private
