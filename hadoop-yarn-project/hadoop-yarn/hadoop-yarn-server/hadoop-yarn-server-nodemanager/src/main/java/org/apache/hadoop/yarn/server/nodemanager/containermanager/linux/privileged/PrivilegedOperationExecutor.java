...
return|;
block|}
comment|/**    *    * @param prefixCommands    * @param operation    * @return stdin and stdout of container exec    * @throws PrivilegedOperationException    */
DECL|method|executePrivilegedInteractiveOperation ( List<String> prefixCommands, PrivilegedOperation operation)
specifier|public
name|IOStreamPair
...
name|StringBuilder
argument_list|(
literal|"Interactive Shell execution returned exit code: "
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|". Privileged Interactive Operation Stderr: "
argument_list|)
operator|.
name|append
argument_list|(
