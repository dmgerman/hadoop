...
name|boolean
name|pluggableDeviceFrameworkEnabled
init|=
name|conf
operator|.
name|getBoolean
...
expr_stmt|;
block|}
DECL|method|getPluginsFromConfig (Configuration conf)
specifier|private
name|String
index|[]
name|getPluginsFromConfig
...
return|;
block|}
DECL|method|ensurePluginIsSupported (String resourceName)
specifier|private
name|void
name|ensurePluginIsSupported
parameter_list|(
...
block|}
block|}
DECL|method|isPluginDuplicate (Map<String, ResourcePlugin> pluginMap, String resourceName)
specifier|private
name|boolean
name|isPluginDuplicate
parameter_list|(
