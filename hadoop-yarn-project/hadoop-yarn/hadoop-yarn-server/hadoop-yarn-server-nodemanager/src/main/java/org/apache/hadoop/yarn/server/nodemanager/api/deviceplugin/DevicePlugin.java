...
name|DevicePlugin
block|{
comment|/**    * Called first when device plugin framework wants to register.    * @return DeviceRegisterRequest {@link DeviceRegisterRequest}    * */
...
name|Exception
function_decl|;
comment|/**    * Called when update node resource.    * @return a set of {@link Device}, {@link java.util.TreeSet} recommended    * */
...
name|Exception
function_decl|;
comment|/**    * Called after device released.    * @param releasedDevices A set of released devices    * */
