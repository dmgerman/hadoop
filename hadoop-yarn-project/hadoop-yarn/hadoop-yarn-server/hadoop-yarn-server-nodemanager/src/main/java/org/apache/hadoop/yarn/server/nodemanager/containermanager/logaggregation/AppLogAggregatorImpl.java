...
specifier|final
name|boolean
DECL|field|DEFAULT_NM_LOG_AGGREGATION_DEBUG_ENABLED
name|DEFAULT_NM_LOG_AGGREGATION_DEBUG_ENABLED
init|=
literal|false
decl_stmt|;
specifier|private
...
specifier|final
name|long
DECL|field|NM_LOG_AGGREGATION_MIN_ROLL_MONITORING_INTERVAL_SECONDS
name|NM_LOG_AGGREGATION_MIN_ROLL_MONITORING_INTERVAL_SECONDS
init|=
literal|3600
decl_stmt|;
...
block|}
block|}
DECL|method|sendLogAggregationReport ( LogAggregationStatus logAggregationStatus, String diagnosticMessage)
specifier|private
name|void
name|sendLogAggregationReport
parameter_list|(
...
parameter_list|)
block|{
comment|// do post clean up of log directories on any exception
name|LOG
operator|.
name|error
argument_list|(
