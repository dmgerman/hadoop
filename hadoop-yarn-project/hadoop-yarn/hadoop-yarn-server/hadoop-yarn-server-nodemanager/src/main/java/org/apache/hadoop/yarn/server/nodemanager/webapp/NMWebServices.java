...
return|;
block|}
comment|/**    * Returns log file's name as well as current file size for a container.    *    * @param hsr    *    HttpServletRequest    * @param containerIdStr    *    The container ID    * @return    *    The log file's name and current file size    */
annotation|@
name|GET
annotation|@
name|Path
...
annotation|@
name|Unstable
DECL|method|getLogs (@athParamR) String containerIdStr, @PathParam(R) String filename, @QueryParam(R) String format, @QueryParam(R) String size)
specifier|public
name|Response
name|getLogs
parameter_list|(
