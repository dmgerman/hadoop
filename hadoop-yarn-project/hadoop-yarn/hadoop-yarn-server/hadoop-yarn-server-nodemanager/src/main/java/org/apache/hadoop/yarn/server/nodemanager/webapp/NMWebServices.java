...
name|BadRequestException
argument_list|(
literal|"Auxiliary services manifest is not "
operator|+
literal|"enabled"
argument_list|)
throw|;
...
block|}
argument_list|)
DECL|method|putAuxiliaryServices (@avax.ws.rs.core.Context HttpServletRequest req, AuxServiceRecords services)
specifier|public
name|Response
name|putAuxiliaryServices
parameter_list|(
annotation|@
name|javax
operator|.
...
name|error
argument_list|(
literal|"Fail to reload auxiliary services, reason: "
argument_list|,
name|e
argument_list|)
expr_stmt|;
