...
begin_class
DECL|class|RecoveredContainerLaunch
specifier|public
class|class
...
argument_list|)
decl_stmt|;
DECL|method|RecoveredContainerLaunch (Context context, Configuration configuration, Dispatcher dispatcher, ContainerExecutor exec, Application app, Container container, LocalDirsHandlerService dirsHandler, ContainerManagerImpl containerManager)
specifier|public
name|RecoveredContainerLaunch
parameter_list|(
name|Context
...
expr_stmt|;
block|}
comment|/**    * Wait on the process specified in pid file and return its exit code    */
annotation|@
...
name|error
argument_list|(
literal|"Unable to recover container "
operator|+
name|containerIdStr
argument_list|,
name|e
