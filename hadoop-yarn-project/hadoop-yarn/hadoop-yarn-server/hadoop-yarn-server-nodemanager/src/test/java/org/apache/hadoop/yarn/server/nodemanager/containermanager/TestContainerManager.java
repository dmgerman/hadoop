...
operator|+
literal|"container is in RUNNING or SCHEDULED state"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|testContainerUpdateExecTypeOpportunisticToGuaranteed ()
specifier|public
name|void
name|testContainerUpdateExecTypeOpportunisticToGuaranteed
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|)
expr_stmt|;
comment|//Make sure the container is running
name|List
argument_list|<
name|ContainerId
argument_list|>
