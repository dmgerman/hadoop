...
parameter_list|()
block|{   }
comment|// Recovery Iterator Implementation.
DECL|class|NMMemoryRecoveryIterator
specifier|private
class|class
name|NMMemoryRecoveryIterator
parameter_list|<
name|T
parameter_list|>
...
name|it
decl_stmt|;
DECL|method|NMMemoryRecoveryIterator (Iterator<T> it)
name|NMMemoryRecoveryIterator
parameter_list|(
name|Iterator
argument_list|<
