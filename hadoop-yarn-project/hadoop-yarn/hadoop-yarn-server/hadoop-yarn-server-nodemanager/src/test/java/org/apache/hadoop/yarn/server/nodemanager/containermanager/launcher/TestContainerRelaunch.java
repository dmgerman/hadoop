...
annotation|@
name|Test
DECL|method|testRelaunchContextWithoutHTTPS ()
specifier|public
name|void
name|testRelaunchContextWithoutHTTPS
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testRelaunchContextWithHTTPS ()
specifier|public
name|void
name|testRelaunchContextWithHTTPS
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testRelaunchContext (boolean https)
specifier|private
name|void
name|testRelaunchContext
parameter_list|(
...
name|assertNull
argument_list|(
literal|"keystore path not null"
argument_list|,
name|csc
operator|.
name|getNmPrivateKeystorePath
...
name|assertNull
argument_list|(
literal|"truststore path not null"
argument_list|,
name|csc
operator|.
name|getNmPrivateTruststorePath
