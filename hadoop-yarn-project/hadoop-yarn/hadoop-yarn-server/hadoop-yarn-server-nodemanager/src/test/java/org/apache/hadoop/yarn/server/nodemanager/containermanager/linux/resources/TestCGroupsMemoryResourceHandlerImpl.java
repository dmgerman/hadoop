...
annotation|@
name|Test
DECL|method|testContainerUnderOom ()
specifier|public
name|void
name|testContainerUnderOom
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"The container should be reported to run under oom"
argument_list|,
name|outOfOom
operator|.
name|isPresent
...
name|assertTrue
argument_list|(
literal|"The container should not be reported to run under oom"
argument_list|,
name|outOfOom
operator|.
name|isPresent
...
name|assertFalse
argument_list|(
literal|"No report of the oom status should be available."
argument_list|,
name|outOfOom
operator|.
name|isPresent
