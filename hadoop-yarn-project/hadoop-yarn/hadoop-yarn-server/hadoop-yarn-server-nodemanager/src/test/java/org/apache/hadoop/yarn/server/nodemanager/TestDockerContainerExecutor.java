...
annotation|@
name|Before
comment|//Initialize a new DockerContainerExecutor that will be used to launch mocked
comment|//containers.
DECL|method|setup ()
specifier|public
name|void
...
return|;
block|}
comment|// Write the script used to launch the docker container in a temp file
