...
return|;
block|}
DECL|method|getSecondaryRM (String scId)
specifier|protected
name|MockResourceManagerFacade
name|getSecondaryRM
parameter_list|(
...
name|info
argument_list|(
literal|"waiting to drain home heartbeat handler"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|info
argument_list|(
literal|"waiting to drain UAM heartbeat handlers"
argument_list|)
expr_stmt|;
name|UnmanagedAMPoolManager
name|uamPool
