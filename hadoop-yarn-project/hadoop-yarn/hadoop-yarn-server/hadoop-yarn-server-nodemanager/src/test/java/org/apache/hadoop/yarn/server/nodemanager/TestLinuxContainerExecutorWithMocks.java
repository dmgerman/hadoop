...
name|MOCK_EXECUTOR
init|=
literal|"mock-container-executor"
decl_stmt|;
...
init|=
literal|"mock-container-executer-with-error"
decl_stmt|;
...
init|=
literal|"mock-container-executer-with-configuration-error"
decl_stmt|;
...
return|;
block|}
DECL|method|setupMockExecutor (String executorName, Configuration conf)
specifier|private
name|void
...
annotation|@
name|Test
DECL|method|testContainerLaunchWithoutHTTPS ()
specifier|public
name|void
name|testContainerLaunchWithoutHTTPS
parameter_list|()
throws|throws
name|IOException
throws|,
...
annotation|@
name|Test
DECL|method|testContainerLaunchWithHTTPS ()
specifier|public
name|void
name|testContainerLaunchWithHTTPS
parameter_list|()
throws|throws
name|IOException
throws|,
...
expr_stmt|;
block|}
DECL|method|testContainerLaunch (boolean https)
specifier|private
name|void
name|testContainerLaunch
parameter_list|(
...
name|format
argument_list|(
literal|"-Dyarn.app.container.log.dir=%s/application_0/12345"
argument_list|,
name|mockExec
operator|.
name|getConf
...
operator|+
literal|"nodemanager.containermanager.localizer.ContainerLocalizer"
argument_list|)
expr_stmt|;
name|assertThat
argument_list|(
