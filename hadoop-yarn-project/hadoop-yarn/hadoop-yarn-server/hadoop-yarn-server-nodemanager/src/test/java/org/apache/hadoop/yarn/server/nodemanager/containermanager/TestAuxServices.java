...
begin_comment
comment|/**  * Test for auxiliary services. Parameter 0 tests the Configuration-based aux  * services and parameter 1 tests manifest-based aux services.  */
end_comment
...
expr_stmt|;
block|}
DECL|method|TestAuxServices (Boolean useManifest)
specifier|public
name|TestAuxServices
parameter_list|(
name|Boolean
...
block|}
block|}
DECL|method|writeManifestFile (AuxServiceRecords services, Configuration conf)
specifier|private
name|void
name|writeManifestFile
parameter_list|(
name|AuxServiceRecords
name|services
parameter_list|,
...
literal|15000
argument_list|)
DECL|method|testReuseLocalizedAuxiliaryJar ()
specifier|public
name|void
name|testReuseLocalizedAuxiliaryJar
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// First Time the jar gets localized
name|Path
name|path
init|=
name|aux
...
argument_list|)
decl_stmt|;
comment|// Validate the path on reuse of localized jar
name|path
operator|=
name|aux
operator|.
...
name|assertFalse
argument_list|(
literal|"Failed to reuse the localized jar"
argument_list|,
name|path
operator|.
name|toString
...
return|;
block|}
DECL|method|getABConf (String aName, String bName, Class<? extends Service> aClass, Class<? extends Service> bClass)
specifier|private
name|Configuration
name|getABConf
parameter_list|(
...
name|IOException
block|{
comment|// AuxServices no longer expected to stop when services stop
name|Configuration
name|conf
init|=
name|getABConf
...
name|assertEquals
argument_list|(
literal|"Auxiliary service stop caused AuxServices stop"
argument_list|,
name|STARTED
argument_list|,
name|aux
...
name|contains
argument_list|(
literal|"The auxiliary service name: 1Asrv1 is "
operator|+
literal|"invalid. The valid service name should only contain a-zA-Z0-9_"
operator|+
...
annotation|@
name|Test
DECL|method|testAuxServicesManifestPermissions ()
specifier|public
name|void
name|testAuxServicesManifestPermissions
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testRemoveManifest ()
specifier|public
name|void
name|testRemoveManifest
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testManualReload ()
specifier|public
name|void
name|testManualReload
parameter_list|()
throws|throws
name|IOException
block|{
...
name|equals
argument_list|(
literal|"Auxiliary services have not been started "
operator|+
literal|"yet, please retry later"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|testReloadWhenDisabled ()
specifier|public
name|void
name|testReloadWhenDisabled
parameter_list|()
throws|throws
name|IOException
block|{
