...
name|updateBarrier
decl_stmt|;
DECL|field|resyncThreadCount
specifier|private
name|AtomicInteger
name|resyncThreadCount
decl_stmt|;
...
literal|30000
argument_list|)
DECL|method|testNMMultipleResyncEvent ()
specifier|public
name|void
name|testNMMultipleResyncEvent
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|info
argument_list|(
literal|"NM dispatcher drained"
argument_list|)
expr_stmt|;
comment|// Wait for the resync thread to finish
try|try
block|{
name|syncBarrier
operator|.
...
name|info
argument_list|(
literal|"Barrier wait done for the resync thread"
argument_list|)
expr_stmt|;
comment|// Resync should only happen once
name|Assert
operator|.
name|assertEquals
argument_list|(
...
name|YarnRuntimeException
argument_list|(
literal|"Multiple resync thread created!"
argument_list|)
throw|;
block|}
try|try
