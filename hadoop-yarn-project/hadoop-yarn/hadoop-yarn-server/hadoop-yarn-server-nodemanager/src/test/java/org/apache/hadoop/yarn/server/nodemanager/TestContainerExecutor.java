...
annotation|@
name|Test
DECL|method|testCleanupBeforeLaunch ()
specifier|public
name|void
name|testCleanupBeforeLaunch
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|//deletes the link if it already exists because of previous test failures
name|FileUtils
operator|.
name|deleteQuietly
argument_list|(
