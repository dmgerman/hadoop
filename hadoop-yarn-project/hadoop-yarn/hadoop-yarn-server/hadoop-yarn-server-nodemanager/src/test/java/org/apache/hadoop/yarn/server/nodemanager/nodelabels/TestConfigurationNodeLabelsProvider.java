...
block|}
block|}
DECL|method|getConfForNodeLabels ()
specifier|private
name|Configuration
name|getConfForNodeLabels
parameter_list|()
block|{
name|Configuration
name|conf
...
argument_list|)
expr_stmt|;
comment|// sleep so that timer has run once during
...
expr_stmt|;
block|}
DECL|method|modifyConfAndCallTimer (TimerTask timerTask, String nodeLabels)
specifier|private
specifier|static
name|void
name|modifyConfAndCallTimer
