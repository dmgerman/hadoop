...
comment|// that were released in the allocated containers. The release request will
comment|// be split and handled by the corresponding UAM. The release containers
comment|// returned by the mock resource managers will be aggregated and returned
comment|// back to us and we can check if total request size and returned size are
comment|// the same
name|List
argument_list|<
name|Container
