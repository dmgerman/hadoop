...
block|}
block|}
DECL|class|DummyShellExecutor
specifier|private
specifier|static
class|class
name|DummyShellExecutor
extends|extends
name|DefaultContainerExecutor
block|{
DECL|field|numLocalizers
...
name|fail
argument_list|(
literal|"Shell finished without being interrupted"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|println
argument_list|(
literal|"Got expected exception executing shell "
operator|+
name|e
operator|.
name|toString
...
block|}
block|}
DECL|method|waitForShellCount (int num)
specifier|private
name|void
name|waitForShellCount
parameter_list|(
name|int
name|num
parameter_list|)
...
literal|"unchecked"
argument_list|)
DECL|method|testShellDestroyedOnContainerKill ()
specifier|public
name|void
name|testShellDestroyedOnContainerKill
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Send localization request for container c1.
specifier|final
name|LocalResourceRequest
name|req1
init|=
...
argument_list|)
expr_stmt|;
comment|// Wait for localizer of container c1 to begin.
name|exec
operator|.
name|waitForLocalizers
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Wait for localizer of container c1 to stop.
name|exec
operator|.
name|waitForShellCount
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Check that the thread is no longer running
while|while
condition|(
name|localizerRunner
operator|.
