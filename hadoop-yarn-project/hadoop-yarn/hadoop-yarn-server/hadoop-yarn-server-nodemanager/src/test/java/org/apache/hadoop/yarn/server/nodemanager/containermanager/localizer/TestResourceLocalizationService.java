...
annotation|@
name|Override
DECL|method|matches (Path[] downloadingPaths)
specifier|public
name|boolean
name|matches
parameter_list|(
...
block|}
block|}
DECL|method|yieldForLocalizers (int num)
specifier|private
name|void
name|yieldForLocalizers
parameter_list|(
name|int
name|num
parameter_list|)
...
expr_stmt|;
block|}
DECL|method|getNumLocalizers ()
specifier|private
name|int
name|getNumLocalizers
parameter_list|()
block|{
return|return
name|numLocalizers
...
annotation|@
name|Test
DECL|method|testResourceLocalizationReqsAfterContainerKill ()
specifier|public
name|void
name|testResourceLocalizationReqsAfterContainerKill
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
name|doLocalizationAfterCleanup
argument_list|(
name|spyService
argument_list|,
name|dispatcher
...
expr_stmt|;
block|}
DECL|method|doLocalizationAfterCleanup ( ResourceLocalizationService spyService, DrainDispatcher dispatcher, DummyExecutor exec, DeletionService delService)
specifier|private
name|void
name|doLocalizationAfterCleanup
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Start Localization without any resources (so we can simulate the
comment|// resource requests being delayed until after cleanup.
name|spyService
operator|.
name|handle
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Kill c1 which leads to cleanup
name|spyService
operator|.
name|handle
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Now we will send the resource requests and releases directly to tracker
name|privateResourceList
operator|.
name|add
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Now start a second container with the same list of resources
name|spyService
operator|.
name|handle
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Wait for localizers to begin (should only be one for container2)
name|exec
operator|.
name|yieldForLocalizers
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// Container c2 is killed which leads to cleanup
name|spyService
operator|.
name|handle
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// Only one resource gets localized for container c2.
name|verify
argument_list|(
name|containerBus
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// Container c2 was killed but this resource was localized before kill
comment|// hence its not removed despite ref cnt being 0.
name|LocalizedResource
name|rsrc1
init|=
...
argument_list|)
expr_stmt|;
comment|// Container c1 and c2 were killed before this finished downloading
comment|// these should no longer be there.
name|LocalizedResource
name|rsrc2
init|=
name|tracker
...
argument_list|)
expr_stmt|;
comment|// Double-check that we never created a Localizer for C1
name|assertThat
argument_list|(
name|exec
operator|.
...
literal|"unchecked"
argument_list|)
DECL|method|testPublicCacheDirPermission ()
specifier|public
name|void
name|testPublicCacheDirPermission
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"target"
argument_list|,
literal|"testPublicCacheDirPermission"
argument_list|)
decl_stmt|;
name|String
name|sDir
...
return|;
block|}
DECL|method|getMockedResource (Random r, LocalResourceVisibility vis, boolean create, Configuration conf, String path)
specifier|private
specifier|static
name|LocalResource
name|getMockedResource
...
parameter_list|)
block|{
comment|// Failed to create test resource
name|e
operator|.
...
return|;
block|}
DECL|method|getPublicMockedResource (Random r, boolean create, Configuration conf, String path)
specifier|private
specifier|static
name|LocalResource
name|getPublicMockedResource
...
name|assertNotNull
argument_list|(
literal|"dirHandler for appTracker is null!"
argument_list|,
operator|(
operator|(
...
name|assertNotNull
argument_list|(
literal|"dirHandler for privTracker is null!"
argument_list|,
operator|(
operator|(
name|LocalResourcesTrackerImpl
...
name|assertNotNull
argument_list|(
literal|"dirHandler for pubTracker is null!"
argument_list|,
operator|(
operator|(
name|LocalResourcesTrackerImpl
