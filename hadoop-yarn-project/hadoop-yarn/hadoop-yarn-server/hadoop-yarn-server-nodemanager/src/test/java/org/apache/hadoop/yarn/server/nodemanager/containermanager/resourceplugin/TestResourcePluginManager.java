...
literal|30000
argument_list|)
DECL|method|testNormalInitializationOfPluggableDeviceClasses ()
specifier|public
name|void
...
expr_stmt|;
block|}
comment|// Fail to load a class which doesn't implement interface DevicePlugin
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|30000
argument_list|)
DECL|method|testLoadInvalidPluggableDeviceClasses ()
specifier|public
name|void
...
expr_stmt|;
block|}
comment|// Fail to register duplicated resource name.
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|30000
argument_list|)
DECL|method|testLoadDuplicateResourceNameDevicePlugin ()
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Fail a plugin due to incompatible interface implemented.    * It doesn't implement the "getRegisterRequestInfo"    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|30000
argument_list|)
DECL|method|testIncompatibleDevicePlugin ()
specifier|public
name|void
...
name|expectedMessage
init|=
literal|"Method getRegisterRequestInfo"
operator|+
...
annotation|@
name|Test
DECL|method|testLoadPluginWithCustomizedScheduler ()
specifier|public
name|void
name|testLoadPluginWithCustomizedScheduler
parameter_list|()
block|{
name|ResourcePluginManager
name|rpm
...
argument_list|()
expr_stmt|;
comment|// only 1 plugin has the customized scheduler
name|verify
argument_list|(
name|rpmSpy
argument_list|,
...
literal|30000
argument_list|)
DECL|method|testRequestedResourceNameIsConfigured ()
specifier|public
name|void
