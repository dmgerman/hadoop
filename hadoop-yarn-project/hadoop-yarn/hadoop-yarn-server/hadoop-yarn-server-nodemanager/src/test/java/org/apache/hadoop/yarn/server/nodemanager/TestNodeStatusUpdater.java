...
literal|false
decl_stmt|;
DECL|field|durationWhenTriggered
specifier|private
name|long
name|durationWhenTriggered
init|=
operator|-
literal|1
decl_stmt|;
...
return|;
block|}
DECL|method|getWaitStartTime ()
specifier|private
name|long
name|getWaitStartTime
parameter_list|()
block|{
return|return
name|waitStartTime
return|;
block|}
DECL|method|getDurationWhenTriggered ()
specifier|private
name|long
name|getDurationWhenTriggered
parameter_list|()
block|{
return|return
name|durationWhenTriggered
...
block|{
return|return
literal|"MyNodeStatusUpdater4{"
operator|+
literal|"rmNeverStart="
operator|+
name|rmNeverStart
operator|+
literal|", triggered="
...
name|resourceTracker
decl_stmt|;
DECL|method|MyNodeStatusUpdater5 (Context context, Dispatcher dispatcher, NodeHealthCheckerService healthChecker, NodeManagerMetrics metrics)
specifier|public
name|MyNodeStatusUpdater5
parameter_list|(
name|Context
...
name|syncBarrier
decl_stmt|;
DECL|method|MyNodeManager2 (CyclicBarrier syncBarrier)
specifier|public
name|MyNodeManager2
parameter_list|(
name|CyclicBarrier
...
name|assertTrue
argument_list|(
literal|"Updater was never started"
argument_list|,
name|myUpdater
operator|.
name|getWaitStartTime
...
argument_list|()
decl_stmt|;
DECL|method|MyNMContext (NMContainerTokenSecretManager containerTokenSecretManager)
specifier|public
name|MyNMContext
parameter_list|(
name|NMContainerTokenSecretManager
