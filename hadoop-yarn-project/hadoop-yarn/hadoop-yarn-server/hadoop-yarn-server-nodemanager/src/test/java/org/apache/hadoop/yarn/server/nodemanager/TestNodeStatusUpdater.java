...
name|nm
decl_stmt|;
DECL|field|rebootedNodeManager
specifier|protected
name|NodeManager
name|rebootedNodeManager
decl_stmt|;
...
name|info
argument_list|(
literal|"Waiting for NM to reinitialize.."
argument_list|)
expr_stmt|;
name|Thread
operator|.
...
name|assertTrue
argument_list|(
literal|"NM should have connected to RM within "
operator|+
name|delta
operator|/
literal|1000
operator|+
literal|" seconds of RM starting up."
argument_list|,
operator|(
name|System
operator|.
