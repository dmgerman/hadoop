...
expr_stmt|;
block|}
comment|/**    * Test if the {@link NodeManager} updates the resources in the    * {@link ContainersMonitor} when the {@link ResourceManager} triggers the    * change.    * @throws Exception If the test cannot run.    */
annotation|@
name|Test
DECL|method|testUpdateNMResources ()
specifier|public
name|void
name|testUpdateNMResources
parameter_list|()
throws|throws
name|Exception
block|{
comment|// The resource set for the Node Manager from the Resource Tracker
specifier|final
name|Resource
name|resource
init|=
...
name|info
argument_list|(
literal|"Start the Resource Tracker to mock heartbeats"
argument_list|)
expr_stmt|;
name|Server
name|resourceTracker
init|=
name|getMockResourceTracker
argument_list|(
name|resource
argument_list|)
decl_stmt|;
...
name|info
argument_list|(
literal|"Start the Node Manager"
argument_list|)
expr_stmt|;
name|NodeManager
name|nodeManager
...
name|info
argument_list|(
literal|"Initially the Node Manager should have the default resources"
argument_list|)
expr_stmt|;
name|ContainerManager
name|containerManager
...
name|info
argument_list|(
literal|"The first heartbeat should trigger a resource change to {}"
argument_list|,
name|resource
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Change the resources to {}"
argument_list|,
name|resource
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Create a mock Resource Tracker server that returns the resources we want    * in the heartbeat.    * @param resource Resource to reply in the heartbeat.    * @return RPC server for the Resource Tracker.    * @throws Exception If it cannot create the Resource Tracker.    */
DECL|method|getMockResourceTracker (final Resource resource)
specifier|private
specifier|static
name|Server
name|getMockResourceTracker
...
name|Exception
block|{
comment|// Setup the mock Resource Tracker
specifier|final
name|ResourceTracker
name|rt
init|=
