...
name|nm
decl_stmt|;
DECL|field|containerStatusBackupSuccessfully
specifier|private
name|boolean
name|containerStatusBackupSuccessfully
init|=
literal|true
decl_stmt|;
DECL|field|completedContainerStatusList
specifier|private
name|List
argument_list|<
name|ContainerStatus
argument_list|>
name|completedContainerStatusList
init|=
operator|new
name|ArrayList
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// ensure that containers are empty
if|if
condition|(
operator|!
name|containers
...
name|context
decl_stmt|;
DECL|field|lastRequestedHeartBeat
specifier|private
name|int
name|lastRequestedHeartBeat
init|=
literal|0
decl_stmt|;
DECL|field|gotDuplicateHeartBeatRequest
specifier|private
name|boolean
name|gotDuplicateHeartBeatRequest
init|=
literal|false
decl_stmt|;
DECL|field|appId
...
argument_list|)
decl_stmt|;
DECL|method|MyResourceTracker7 (Context context)
name|MyResourceTracker7
parameter_list|(
name|Context
name|context
...
name|info
argument_list|(
literal|"GOT Duplicate heartbeatId "
operator|+
name|request
operator|.
name|getNodeStatus
...
return|;
block|}
DECL|method|isGotDuplicateHeartBeatRequest ()
specifier|public
name|boolean
name|isGotDuplicateHeartBeatRequest
parameter_list|()
block|{
return|return
name|gotDuplicateHeartBeatRequest
...
name|waitStartTime
decl_stmt|;
DECL|method|MyResourceTracker6 (Context context, long rmStartIntervalMS, boolean rmNeverStart)
specifier|public
name|MyResourceTracker6
parameter_list|(
name|Context
...
literal|"rawtypes"
argument_list|)
DECL|class|MyDispatcher7
class|class
name|MyDispatcher7
extends|extends
name|AsyncDispatcher
block|{
DECL|field|finishapp_event
specifier|public
specifier|volatile
name|int
name|finishapp_event
decl_stmt|;
...
literal|60000
argument_list|)
DECL|method|testDuplicateResponseFromRM ()
specifier|public
name|void
name|testDuplicateResponseFromRM
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// We are sending two FINISH_APPS in heartbeat 5 and 6
comment|// Checking we get only one time FINISH_APPS event which is the first one
name|Assert
operator|.
name|assertEquals
argument_list|(
...
block|}
block|}
comment|/**    * Test completed containerStatus get back up when heart beat lost    */
annotation|@
name|Test
argument_list|(
name|timeout
