...
literal|90000
argument_list|)
DECL|method|testKilledQueuedContainers ()
specifier|public
name|void
name|testKilledQueuedContainers
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Add application to context.
name|nm
operator|.
name|getNMContext
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// Create a running container and add it to the context.
name|ContainerId
name|runningContainerId
init|=
name|ContainerId
...
argument_list|)
expr_stmt|;
comment|// Create two killed queued containers and add them to the queuing context.
name|ContainerId
...
decl_stmt|;
name|ContainerTokenIdentifier
name|killedQueuedContainerTokenId1
init|=
name|BuilderUtils
operator|.
name|newContainerTokenIdentifier
...
decl_stmt|;
name|ContainerTokenIdentifier
name|killedQueuedContainerTokenId2
init|=
name|BuilderUtils
operator|.
name|newContainerTokenIdentifier
...
name|killedQueuedContainerTokenId1
argument_list|,
literal|"Queued container killed."
argument_list|)
expr_stmt|;
name|nm
operator|.
...
expr_stmt|;
name|ContainerStatus
name|runningContainerStatus
init|=
literal|null
decl_stmt|;
name|ContainerStatus
name|killedQueuedContainerStatus1
init|=
literal|null
decl_stmt|;
name|ContainerStatus
name|killedQueuedContainerStatus2
init|=
literal|null
decl_stmt|;
for|for
...
block|}
block|}
comment|// Check container IDs and Container Status.
name|Assert
operator|.
name|assertNotNull
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Killed queued container should have ABORTED exit status.
name|Assert
operator|.
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Killed queued container should appear in the recentlyStoppedContainers.
name|Assert
operator|.
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Check if killed queued containers are successfully removed from the
comment|// queuing context.
name|List
argument_list|<
name|ContainerId
argument_list|>
...
argument_list|()
expr_stmt|;
comment|// Only the running container should be in the container statuses now.
name|Assert
operator|.
name|assertEquals
argument_list|(
