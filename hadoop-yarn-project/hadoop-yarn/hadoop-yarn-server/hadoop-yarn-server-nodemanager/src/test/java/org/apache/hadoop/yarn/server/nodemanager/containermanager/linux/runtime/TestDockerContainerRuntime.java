...
literal|"DOCKER"
decl_stmt|;
DECL|field|ENV_OCI_CONTAINER_PID_NAMESPACE
specifier|private
specifier|final
specifier|static
name|String
name|ENV_OCI_CONTAINER_PID_NAMESPACE
init|=
name|formatOciEnvKey
argument_list|(
name|RUNTIME_TYPE
...
argument_list|)
decl_stmt|;
DECL|field|ENV_OCI_CONTAINER_RUN_PRIVILEGED_CONTAINER
specifier|private
specifier|final
specifier|static
name|String
name|ENV_OCI_CONTAINER_RUN_PRIVILEGED_CONTAINER
init|=
name|formatOciEnvKey
argument_list|(
name|RUNTIME_TYPE
...
name|gid
expr_stmt|;
comment|// Prevent gid threshold failures for these tests
name|conf
operator|.
name|setInt
argument_list|(
...
annotation|@
name|Test
DECL|method|testSelectDockerContainerTypeWithDockerAsDefault ()
specifier|public
name|void
name|testSelectDockerContainerTypeWithDockerAsDefault
parameter_list|()
block|{
name|Map
argument_list|<
...
annotation|@
name|Test
DECL|method|testSelectDockerContainerTypeWithDefaultSet ()
specifier|public
name|void
name|testSelectDockerContainerTypeWithDefaultSet
parameter_list|()
block|{
name|Map
argument_list|<
...
argument_list|()
decl_stmt|;
comment|//This invocation of container-executor should use 15 or 13 arguments in a
...
literal|"  mounts="
operator|+
literal|"/test_container_log_dir:/test_container_log_dir:rw,"
operator|+
literal|"/test_application_local_dir:/test_application_local_dir:rw,"
operator|+
literal|"/test_filecache_dir:/test_filecache_dir:ro,"
operator|+
literal|"/test_user_filecache_dir:/test_user_filecache_dir:ro"
argument_list|,
name|dockerCommands
operator|.
name|get
...
annotation|@
name|Test
DECL|method|testDockerContainerLaunchWithDefaultImage ()
specifier|public
name|void
name|testDockerContainerLaunchWithDefaultImage
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
annotation|@
name|Test
DECL|method|testDockerContainerLaunchWithoutDefaultImageUpdate ()
specifier|public
name|void
name|testDockerContainerLaunchWithoutDefaultImageUpdate
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
annotation|@
name|Test
DECL|method|testDockerContainerLaunchWithDefaultImageUpdate ()
specifier|public
name|void
name|testDockerContainerLaunchWithDefaultImageUpdate
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
argument_list|)
decl_stmt|;
comment|//Two invocations expected.
name|verify
argument_list|(
name|mockExecutor
argument_list|,
...
argument_list|()
decl_stmt|;
comment|// pull image from remote hub firstly
name|PrivilegedOperation
name|op
init|=
name|allCaptures
...
argument_list|()
expr_stmt|;
comment|// launch docker container
name|List
argument_list|<
name|String
argument_list|>
...
literal|"unchecked"
argument_list|)
DECL|method|testContainerLaunchWithHostDnsNetwork ()
specifier|public
name|void
name|testContainerLaunchWithHostDnsNetwork
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
name|PrivilegedOperationException
block|{
comment|// Make it look like Registry DNS is enabled so we can test whether
comment|// hostname goes through
name|conf
operator|.
name|setBoolean
argument_list|(
...
name|ENV_DOCKER_CONTAINER_MOUNTS
argument_list|,
literal|"test_dir/test_resource_file:test_mount:ro"
argument_list|)
expr_stmt|;
name|runtime
operator|.
...
literal|"/test_user_filecache_dir:/test_user_filecache_dir:ro,"
operator|+
literal|"/test_local_dir/test_resource_file:test_mount:ro"
argument_list|,
name|dockerCommands
operator|.
name|get
...
name|ENV_DOCKER_CONTAINER_MOUNTS
argument_list|,
literal|"test_dir/test_resource_file:test_mount1:ro,"
operator|+
literal|"test_dir/test_resource_file:test_mount2:ro"
argument_list|)
expr_stmt|;
name|runtime
operator|.
...
literal|"/test_user_filecache_dir:/test_user_filecache_dir:ro,"
operator|+
literal|"/test_local_dir/test_resource_file:test_mount1:ro,"
operator|+
literal|"/test_local_dir/test_resource_file:test_mount2:ro"
argument_list|,
name|dockerCommands
operator|.
name|get
...
name|ENV_DOCKER_CONTAINER_MOUNTS
argument_list|,
literal|"/tmp/foo:/tmp/foo:ro,/tmp/bar:/tmp/bar:rw,/tmp/baz:/tmp/baz,"
operator|+
literal|"/a:/a:shared,/b:/b:ro+shared,/c:/c:rw+rshared,/d:/d:private"
argument_list|)
expr_stmt|;
name|runtime
operator|.
...
literal|"/test_user_filecache_dir:/test_user_filecache_dir:ro,"
operator|+
literal|"/tmp/foo:/tmp/foo:ro,"
operator|+
literal|"/tmp/bar:/tmp/bar:rw,/tmp/baz:/tmp/baz:rw,/a:/a:rw+shared,"
operator|+
literal|"/b:/b:ro+shared,/c:/c:rw+rshared,/d:/d:rw+private"
argument_list|,
name|dockerCommands
operator|.
name|get
...
name|ENV_DOCKER_CONTAINER_MOUNTS
argument_list|,
literal|"/source:target:ro,/source:target:other,/source:target:rw"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|DockerLinuxContainerRuntime
operator|.
name|ENV_DOCKER_CONTAINER_TMPFS_MOUNTS
argument_list|,
literal|"/run"
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testTmpfsMountMulti ()
specifier|public
name|void
name|testTmpfsMountMulti
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
annotation|@
name|Test
DECL|method|testDefaultTmpfsMounts ()
specifier|public
name|void
name|testDefaultTmpfsMounts
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
name|contains
argument_list|(
literal|"  tmpfs=/tmpfs,/run,/var/run"
argument_list|)
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
DECL|method|testDefaultTmpfsMountsInvalid ()
specifier|public
name|void
name|testDefaultTmpfsMountsInvalid
parameter_list|()
throws|throws
name|ContainerExecutionException
block|{
...
name|fail
argument_list|(
literal|"Expected a launch container failure due to non-absolute path."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
annotation|@
name|Test
DECL|method|testTmpfsRelativeInvalid ()
specifier|public
name|void
name|testTmpfsRelativeInvalid
parameter_list|()
throws|throws
name|ContainerExecutionException
block|{
...
annotation|@
name|Test
DECL|method|testTmpfsColonInvalid ()
specifier|public
name|void
name|testTmpfsColonInvalid
parameter_list|()
throws|throws
name|ContainerExecutionException
block|{
...
name|fail
argument_list|(
literal|"Expected a launch container failure due to invalid character."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
annotation|@
name|Test
DECL|method|testTmpfsNulInvalid ()
specifier|public
name|void
name|testTmpfsNulInvalid
parameter_list|()
throws|throws
name|ContainerExecutionException
block|{
...
name|fail
argument_list|(
literal|"Expected a launch container failure due to NUL in tmpfs mount."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|NM_DOCKER_DEFAULT_RO_MOUNTS
argument_list|,
literal|"/tmp/foo:/tmp/foo,/tmp/bar:/tmp/bar"
argument_list|)
expr_stmt|;
name|DockerLinuxContainerRuntime
name|runtime
...
literal|"/test_user_filecache_dir:/test_user_filecache_dir:ro,"
operator|+
literal|"/tmp/foo:/tmp/foo:ro,/tmp/bar:/tmp/bar:ro"
argument_list|,
name|dockerCommands
operator|.
name|get
...
literal|"/test_user_filecache_dir:/test_user_filecache_dir:ro,"
operator|+
literal|"/tmp/foo:/tmp/foo:rw,/tmp/bar:/tmp/bar:rw"
argument_list|,
name|dockerCommands
operator|.
name|get
...
annotation|@
name|Test
DECL|method|testContainerLivelinessFileExistsNoException ()
specifier|public
name|void
name|testContainerLivelinessFileExistsNoException
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testContainerLivelinessNoFileException ()
specifier|public
name|void
name|testContainerLivelinessNoFileException
parameter_list|()
throws|throws
name|Exception
block|{
...
name|dockerCommands
init|=
name|getDockerCommandsForDockerStop
argument_list|(
name|ContainerExecutor
operator|.
name|Signal
...
literal|"unchecked"
argument_list|)
DECL|method|testDockerStopWithQuitSignalWhenRunning ()
specifier|public
name|void
name|testDockerStopWithQuitSignalWhenRunning
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
annotation|@
name|Test
DECL|method|testDockerStopOnTermSignalWhenRunningPrivileged ()
specifier|public
name|void
name|testDockerStopOnTermSignalWhenRunningPrivileged
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
annotation|@
name|Test
DECL|method|testDockerStopOnKillSignalWhenRunningPrivileged ()
specifier|public
name|void
name|testDockerStopOnKillSignalWhenRunningPrivileged
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
annotation|@
name|Test
DECL|method|testDockerKillOnQuitSignalWhenRunningPrivileged ()
specifier|public
name|void
name|testDockerKillOnQuitSignalWhenRunningPrivileged
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|getDockerCommandsForDockerStop ( ContainerExecutor.Signal signal)
specifier|private
name|List
argument_list|<
name|String
...
annotation|@
name|Test
DECL|method|testValidDockerHostnameLength ()
specifier|public
name|void
name|testValidDockerHostnameLength
parameter_list|()
throws|throws
name|Exception
block|{
...
name|class
argument_list|)
DECL|method|testInvalidDockerHostnameLength ()
specifier|public
name|void
name|testInvalidDockerHostnameLength
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"/test_user_filecache_dir:/test_user_filecache_dir:ro,"
operator|+
literal|"/source/path:/destination/path:ro"
argument_list|,
name|dockerCommands
operator|.
name|get
...
annotation|@
name|Test
DECL|method|testLaunchContainerWithDockerTokens ()
specifier|public
name|void
name|testLaunchContainerWithDockerTokens
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
name|IOException
block|{
comment|// Write the JSOn to a temp file.
name|File
name|file
init|=
name|File
...
argument_list|()
expr_stmt|;
comment|// Get the credentials object with the Tokens.
name|Credentials
name|credentials
init|=
name|DockerClientConfigHandler
...
argument_list|)
decl_stmt|;
comment|// Configure the runtime and launch the container
name|when
argument_list|(
name|context
operator|.
...
argument_list|(
literal|"docker-client-config-out"
argument_list|,
name|attr
argument_list|)
operator|.
...
annotation|@
name|Test
DECL|method|testDockerContainerRelaunch ()
specifier|public
name|void
name|testDockerContainerRelaunch
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
annotation|@
name|Test
DECL|method|testLaunchContainersWithSpecificDockerRuntime ()
specifier|public
name|void
name|testLaunchContainersWithSpecificDockerRuntime
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
name|DockerLinuxContainerRuntime
operator|.
name|ENV_DOCKER_CONTAINER_DOCKER_RUNTIME
argument_list|,
literal|"runc"
argument_list|)
expr_stmt|;
...
literal|"unchecked"
argument_list|)
DECL|method|testContainerLaunchWithAllowedRuntimes ()
specifier|public
name|void
name|testContainerLaunchWithAllowedRuntimes
parameter_list|()
throws|throws
name|ContainerExecutionException
throws|,
...
name|fail
argument_list|(
literal|"Runtime was expected to be disallowed: "
operator|+
name|disallowedRuntime
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|verifyStopCommand (List<String> dockerCommands, String signal)
specifier|private
specifier|static
name|void
name|verifyStopCommand
...
expr_stmt|;
block|}
DECL|method|readDockerCommands ()
specifier|private
name|List
argument_list|<
name|String
...
return|;
block|}
DECL|method|readDockerCommands (int invocations)
specifier|private
name|List
argument_list|<
name|String
