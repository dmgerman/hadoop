...
argument_list|)
expr_stmt|;
comment|// check that container cleanup hasn't started at this point.
name|LocalizationCleanupMatcher
...
argument_list|)
expr_stmt|;
comment|// check if containerlauncher cleans up the container launch.
name|verify
argument_list|(
name|wc
operator|.
...
annotation|@
name|Test
DECL|method|testContainerRetryFailureValidityInterval ()
specifier|public
name|void
name|testContainerRetryFailureValidityInterval
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// Argument matcher for matching container localization cleanup event.
DECL|class|LocalizationCleanupMatcher
specifier|private
specifier|static
class|class
name|LocalizationCleanupMatcher
...
name|c
decl_stmt|;
DECL|method|LocalizationCleanupMatcher (Container c)
name|LocalizationCleanupMatcher
parameter_list|(
name|Container
name|c
...
annotation|@
name|Override
DECL|method|matches (LocalizationEvent e)
specifier|public
name|boolean
name|matches
parameter_list|(
...
argument_list|()
decl_stmt|;
DECL|method|ResourcesReleasedMatcher (Map<String, LocalResource> allResources, EnumSet<LocalResourceVisibility> vis, Container c)
name|ResourcesReleasedMatcher
parameter_list|(
name|Map
argument_list|<
...
parameter_list|)
block|{
comment|// match event type and container.
if|if
condition|(
operator|!
name|super
