...
expr_stmt|;
block|}
comment|//Lets manually create a path to (partially) simulate a mounted controller
comment|//this is required because the handler uses a mocked privileged operation
comment|//executor
operator|new
name|File
argument_list|(
...
return|;
block|}
DECL|method|createMockCgroupMount (File parentDir, String type, String hierarchy)
specifier|private
specifier|static
name|File
name|createMockCgroupMount
...
return|;
block|}
DECL|method|createMockMTab (File parentDir)
specifier|public
specifier|static
name|File
name|createMockMTab
...
argument_list|()
operator|+
literal|"/blkio cgroup rw,relatime,blkio 0 0\n"
decl_stmt|;
name|File
name|mockMtab
init|=
...
annotation|@
name|Test
DECL|method|testPreMountedController ()
specifier|public
name|void
name|testPreMountedController
parameter_list|()
throws|throws
name|Exception
block|{
