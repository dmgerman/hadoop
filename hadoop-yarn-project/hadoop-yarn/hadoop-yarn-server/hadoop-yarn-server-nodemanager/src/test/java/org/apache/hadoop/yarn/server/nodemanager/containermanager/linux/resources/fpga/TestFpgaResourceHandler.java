...
argument_list|()
decl_stmt|;
DECL|field|HASHABLE_STRING
specifier|private
specifier|static
specifier|final
name|String
name|HASHABLE_STRING
init|=
literal|"abcdef"
decl_stmt|;
DECL|field|EXPECTED_HASH
specifier|private
specifier|static
specifier|final
name|String
...
argument_list|)
expr_stmt|;
comment|// initPlugin() was also called in setup()
name|verify
argument_list|(
name|mockVendorPlugin
argument_list|,
...
comment|// Add some characters to the dummy file to have its hash changed
name|Files
operator|.
name|asCharSink
argument_list|(
...
annotation|@
name|Test
DECL|method|testSha256CalculationFails ()
specifier|public
name|void
name|testSha256CalculationFails
parameter_list|()
throws|throws
name|ResourceHandlerException
block|{
...
annotation|@
name|Test
DECL|method|testSha256CalculationSucceeds ()
specifier|public
name|void
name|testSha256CalculationSucceeds
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|)
expr_stmt|;
comment|// IP file is assigned to the first device
name|List
argument_list|<
name|FpgaDevice
argument_list|>
...
block|}
block|}
DECL|method|mockPlugin (String type, List<FpgaDevice> list, String aocxPath)
specifier|private
specifier|static
name|IntelFpgaOpenclPlugin
name|mockPlugin
...
return|;
block|}
DECL|method|mockStateStoreForContainer (Container container, List<FpgaDevice> assigned)
specifier|private
name|void
name|mockStateStoreForContainer
parameter_list|(
