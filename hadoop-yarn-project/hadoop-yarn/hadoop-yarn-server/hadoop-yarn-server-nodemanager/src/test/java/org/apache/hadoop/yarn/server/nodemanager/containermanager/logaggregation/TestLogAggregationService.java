...
block|}
block|}
DECL|method|verifyContainerLogs (LogAggregationService logAggregationService, ApplicationId appId, ContainerId[] expectedContainerIds, String[] logFiles, int numOfContainerLogs, boolean multiLogs)
specifier|private
name|void
name|verifyContainerLogs
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|numOfLogsAvailable (LogAggregationService logAggregationService, ApplicationId appId)
specifier|private
name|int
name|numOfLogsAvailable
parameter_list|(
