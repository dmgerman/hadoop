...
expr_stmt|;
block|}
DECL|method|writeContainerLogs (File appLogDir, ContainerId containerId, String[] fileName, String[] emptyFiles)
specifier|private
name|void
name|writeContainerLogs
parameter_list|(
...
block|}
block|}
DECL|method|verifyContainerLogs ( LogAggregationService logAggregationService, ApplicationId appId, ContainerId[] expectedContainerIds, String[] logFiles, int numOfLogsPerContainer, boolean multiLogs, String[] zeroLengthFiles)
specifier|private
...
DECL|method|verifyContainerLogs ( LogAggregationService logAggregationService, ApplicationId appId, ContainerId[] expectedContainerIds, int minNumOfContainers, int maxNumOfContainers, String[] logFiles, int numOfLogsPerContainer, boolean multiLogs, String[] zeroLengthLogFiles)
specifier|private
name|LogFileStatusInLastCycle
name|verifyContainerLogs
parameter_list|(
