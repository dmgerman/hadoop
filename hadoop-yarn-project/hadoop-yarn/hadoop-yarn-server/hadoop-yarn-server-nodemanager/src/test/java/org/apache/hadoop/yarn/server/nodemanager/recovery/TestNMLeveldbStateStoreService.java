...
expr_stmt|;
block|}
DECL|method|loadContainersState ( RecoveryIterator<RecoveredContainerState> it)
specifier|private
name|List
argument_list|<
name|RecoveredContainerState
...
return|;
block|}
DECL|method|loadApplicationProtos ( RecoveryIterator<ContainerManagerApplicationProto> it)
specifier|private
name|List
argument_list|<
name|ContainerManagerApplicationProto
argument_list|>
name|loadApplicationProtos
parameter_list|(
name|RecoveryIterator
argument_list|<
name|ContainerManagerApplicationProto
...
return|;
block|}
DECL|method|loadDeletionTaskProtos ( RecoveryIterator<DeletionServiceDeleteTaskProto> it)
specifier|private
name|List
argument_list|<
name|DeletionServiceDeleteTaskProto
argument_list|>
name|loadDeletionTaskProtos
parameter_list|(
name|RecoveryIterator
argument_list|<
name|DeletionServiceDeleteTaskProto
...
return|;
block|}
DECL|method|loadUserResources ( RecoveryIterator<Map.Entry<String, RecoveredUserResources>> it)
specifier|private
name|Map
argument_list|<
name|String
...
return|;
block|}
DECL|method|loadNMTokens ( RecoveryIterator<Map.Entry<ApplicationAttemptId, MasterKey>> it)
specifier|private
name|Map
argument_list|<
name|ApplicationAttemptId
...
return|;
block|}
DECL|method|loadContainerTokens ( RecoveryIterator<Map.Entry<ContainerId, Long>> it)
specifier|private
name|Map
argument_list|<
name|ContainerId
...
return|;
block|}
DECL|method|loadCompletedResources ( RecoveryIterator<LocalizedResourceProto> it)
specifier|private
name|List
argument_list|<
name|LocalizedResourceProto
...
return|;
block|}
DECL|method|loadStartedResources ( RecoveryIterator <Map.Entry<LocalResourceProto, Path>> it)
specifier|private
name|Map
argument_list|<
name|LocalResourceProto
...
annotation|@
name|Test
DECL|method|testContainerStorageWhenContainerIsRequested ()
specifier|public
name|void
name|testContainerStorageWhenContainerIsRequested
parameter_list|()
throws|throws
name|IOException
block|{
specifier|final
name|ContainerStateConstructParams
name|containerParams
init|=
name|storeContainerInStateStore
argument_list|()
decl_stmt|;
name|restartStateStore
argument_list|()
...
annotation|@
name|Test
DECL|method|testContainerStorageWhenContainerIsQueued ()
specifier|public
name|void
name|testContainerStorageWhenContainerIsQueued
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
decl_stmt|;
name|storeNewContainerRecordWithoutStartContainerRequest
argument_list|(
name|appAttemptId
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testContainerStorageWhenContainerIsLaunched ()
specifier|public
name|void
name|testContainerStorageWhenContainerIsLaunched
parameter_list|()
throws|throws
name|IOException
block|{
...
name|diags
init|=
name|launchContainerWithDiagnostics
argument_list|(
name|containerId
argument_list|)
decl_stmt|;
...
annotation|@
name|Test
DECL|method|testContainerStorageWhenContainerIsPaused ()
specifier|public
name|void
name|testContainerStorageWhenContainerIsPaused
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testContainerStorageWhenContainerSizeIncreased ()
specifier|public
name|void
name|testContainerStorageWhenContainerSizeIncreased
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testContainerStorageWhenContainerMarkedAsKilled ()
specifier|public
name|void
name|testContainerStorageWhenContainerMarkedAsKilled
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testContainerStorageWhenContainerCompleted ()
specifier|public
name|void
name|testContainerStorageWhenContainerCompleted
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// add yet more diags, mark container completed
name|diags
operator|.
name|append
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// remaining retry attempts, work dir and log dir are stored
name|stateStore
operator|.
...
annotation|@
name|Test
DECL|method|testContainerStorageWhenContainerRemoved ()
specifier|public
name|void
name|testContainerStorageWhenContainerRemoved
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// recover again to check remove clears all containers
name|restartStateStore
argument_list|()
expr_stmt|;
name|NMStateStoreService
...
expr_stmt|;
block|}
DECL|method|storeContainerInStateStore ()
specifier|private
name|ContainerStateConstructParams
name|storeContainerInStateStore
parameter_list|()
...
decl_stmt|;
name|long
name|anyContainerStartTime
init|=
literal|1573155078494L
decl_stmt|;
name|stateStore
operator|.
name|storeContainer
...
argument_list|)
operator|.
name|setContainerResource
argument_list|(
name|containerResource
argument_list|)
operator|.
name|setContainerStartTime
argument_list|(
name|anyContainerStartTime
argument_list|)
operator|.
...
return|;
block|}
DECL|class|ContainerStateConstructParams
specifier|private
specifier|static
class|class
name|ContainerStateConstructParams
...
return|;
block|}
DECL|method|setAppAttemptId (ApplicationAttemptId theAppAttemptId)
specifier|public
name|ContainerStateConstructParams
name|setAppAttemptId
parameter_list|(
name|ApplicationAttemptId
name|theAppAttemptId
parameter_list|)
block|{
name|this
operator|.
...
return|;
block|}
DECL|method|setContainerId (ContainerId theContainerId)
specifier|public
name|ContainerStateConstructParams
name|setContainerId
parameter_list|(
...
return|;
block|}
DECL|method|setContainerRequest ( StartContainerRequest theContainerRequest)
specifier|public
name|ContainerStateConstructParams
name|setContainerRequest
parameter_list|(
name|StartContainerRequest
name|theContainerRequest
parameter_list|)
block|{
name|this
operator|.
...
return|;
block|}
DECL|method|getContainerResource ()
specifier|public
name|Resource
name|getContainerResource
parameter_list|()
...
return|;
block|}
DECL|method|setContainerResource ( Resource theContainerResource)
specifier|public
name|ContainerStateConstructParams
name|setContainerResource
parameter_list|(
name|Resource
name|theContainerResource
parameter_list|)
block|{
name|this
operator|.
...
return|;
block|}
DECL|method|setContainerStartTime ( Long theContainerStartTime)
specifier|public
name|ContainerStateConstructParams
name|setContainerStartTime
parameter_list|(
name|Long
name|theContainerStartTime
parameter_list|)
block|{
name|this
operator|.
...
block|}
block|}
DECL|method|markContainerAsKilled (ContainerId containerId, StringBuilder diags)
specifier|private
name|void
name|markContainerAsKilled
parameter_list|(
...
name|IOException
block|{
comment|// mark the container killed, add some more diags
name|diags
operator|.
name|append
argument_list|(
...
expr_stmt|;
block|}
DECL|method|increaseContainerSize ( ContainerId containerId)
specifier|private
name|ContainerTokenIdentifier
name|increaseContainerSize
parameter_list|(
...
return|;
block|}
DECL|method|launchContainerWithDiagnostics (ContainerId containerId)
specifier|private
name|StringBuilder
name|launchContainerWithDiagnostics
parameter_list|(
...
return|;
block|}
DECL|method|storeNewContainerRecordWithoutStartContainerRequest ( ApplicationAttemptId appAttemptId)
specifier|private
name|void
name|storeNewContainerRecordWithoutStartContainerRequest
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|validateRetryAttempts (ContainerId containerId)
specifier|private
name|void
name|validateRetryAttempts
parameter_list|(
...
name|IOException
block|{
comment|// store finishTimeForRetryAttempts
name|List
argument_list|<
name|Long
argument_list|>
name|finishTimeForRetryAttempts
init|=
name|Arrays
operator|.
name|asList
argument_list|(
literal|1462700529039L
argument_list|,
literal|1462700529050L
argument_list|,
literal|1462700529120L
argument_list|)
decl_stmt|;
name|stateStore
operator|.
...
expr_stmt|;
block|}
DECL|method|createContainerRequest ( ContainerId containerId, Resource res)
specifier|private
name|StartContainerRequest
name|createContainerRequest
parameter_list|(
...
block|{
return|return
name|createContainerRequestInternal
argument_list|(
name|containerId
argument_list|,
name|res
...
return|;
block|}
DECL|method|createContainerRequestInternal (ContainerId containerId, Resource res)
specifier|private
name|StartContainerRequest
name|createContainerRequestInternal
parameter_list|(
...
annotation|@
name|Test
DECL|method|testLocalTrackerStateIterator ()
specifier|public
name|void
name|testLocalTrackerStateIterator
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// start and finish local resource for applications
name|Path
name|appRsrcPath1
init|=
operator|new
name|Path
argument_list|(
literal|"hdfs://some/app/resource1"
argument_list|)
decl_stmt|;
name|LocalResourcePBImpl
name|rsrcPb1
...
decl_stmt|;
name|Path
name|appRsrcLocalPath1
init|=
operator|new
name|Path
argument_list|(
literal|"/some/local/dir/for/apprsrc1"
argument_list|)
decl_stmt|;
name|Path
name|appRsrcPath2
...
name|Path
argument_list|(
literal|"hdfs://some/app/resource2"
argument_list|)
decl_stmt|;
name|LocalResourcePBImpl
name|rsrcPb2
...
decl_stmt|;
name|Path
name|appRsrcLocalPath2
init|=
operator|new
name|Path
argument_list|(
literal|"/some/local/dir/for/apprsrc2"
argument_list|)
decl_stmt|;
name|Path
name|appRsrcPath3
...
name|Path
argument_list|(
literal|"hdfs://some/app/resource3"
argument_list|)
decl_stmt|;
name|LocalResourcePBImpl
name|rsrcPb3
...
argument_list|()
decl_stmt|;
comment|// restart and verify two users exist and two apps completed for user1.
name|restartStateStore
argument_list|()
expr_stmt|;
name|RecoveredLocalizationState
...
annotation|@
name|Test
DECL|method|testStartResourceLocalizationForApplicationResource ()
specifier|public
name|void
name|testStartResourceLocalizationForApplicationResource
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testStartResourceLocalizationForPublicResources ()
specifier|public
name|void
name|testStartResourceLocalizationForPublicResources
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testStartResourceLocalizationForPrivateResource ()
specifier|public
name|void
name|testStartResourceLocalizationForPrivateResource
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testFinishResourceLocalizationForApplicationResource ()
specifier|public
name|void
name|testFinishResourceLocalizationForApplicationResource
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testFinishResourceLocalizationForPublicResources ()
specifier|public
name|void
name|testFinishResourceLocalizationForPublicResources
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testFinishResourceLocalizationForPrivateResource ()
specifier|public
name|void
name|testFinishResourceLocalizationForPrivateResource
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testRemoveLocalizedResourceForApplicationResource ()
specifier|public
name|void
name|testRemoveLocalizedResourceForApplicationResource
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testRemoveLocalizedResourceForPublicResources ()
specifier|public
name|void
name|testRemoveLocalizedResourceForPublicResources
parameter_list|()
throws|throws
name|IOException
block|{
comment|// add public resources and remove some
name|Path
name|pubRsrcPath1
init|=
operator|new
...
annotation|@
name|Test
DECL|method|testRemoveLocalizedResourceForPrivateResource ()
specifier|public
name|void
name|testRemoveLocalizedResourceForPrivateResource
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testAMRMProxyStorage ()
specifier|public
name|void
name|testAMRMProxyStorage
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// Generate currentMasterKey
name|secretManager
operator|.
name|start
argument_list|()
...
try|try
block|{
comment|// Add two applications, each with two data entries
name|stateStore
operator|.
...
argument_list|)
expr_stmt|;
comment|// Generate next master key and remove one entry of app2
name|secretManager
operator|.
name|rollMasterKey
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// Activate next master key and remove all entries of app1
name|secretManager
operator|.
...
annotation|@
name|Test
DECL|method|testStateStoreForResourceMapping ()
specifier|public
name|void
name|testStateStoreForResourceMapping
parameter_list|()
throws|throws
name|IOException
block|{
comment|// test that stateStore is initially empty
name|List
argument_list|<
name|RecoveredContainerState
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// This will overwrite the above
name|List
argument_list|<
name|Serializable
argument_list|>
...
name|NumaResourceAllocation
argument_list|(
literal|"testmemNodeId"
argument_list|,
literal|2048
argument_list|,
literal|"testCpuNodeId"
argument_list|,
literal|10
argument_list|)
argument_list|)
...
annotation|@
name|Test
DECL|method|testStateStoreNodeHealth ()
specifier|public
name|void
name|testStateStoreNodeHealth
parameter_list|()
throws|throws
name|IOException
block|{
comment|// keep the working DB clean, break a temp DB
name|DB
name|keepDB
init|=
name|stateStore
...
try|try
block|{
comment|// chosen a simple method could be any of the "void" methods
name|ContainerId
name|containerId
init|=
name|ContainerId
...
parameter_list|)
block|{
comment|// Cause should be wrapped DBException
name|assertTrue
argument_list|(
name|ioErr
operator|.
...
argument_list|)
expr_stmt|;
comment|// check the store is marked unhealthy
name|assertFalse
argument_list|(
literal|"Statestore should have been unhealthy"
argument_list|,
name|stateStore
operator|.
name|isHealthy
...
block|{
comment|// restore the working DB
name|stateStore
operator|.
name|setDB
argument_list|(
...
annotation|@
name|Test
DECL|method|testEmptyRestartTimes ()
specifier|public
name|void
name|testEmptyRestartTimes
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|storeMockContainer (ContainerId containerId)
specifier|private
name|StartContainerRequest
name|storeMockContainer
parameter_list|(
