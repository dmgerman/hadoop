...
expr_stmt|;
block|}
comment|/**    * Test AMRMProxy restart with application recovery failure.    */
annotation|@
name|Test
DECL|method|testAppRecoveryFailure ()
specifier|public
name|void
name|testAppRecoveryFailure
parameter_list|()
throws|throws
name|YarnException
throws|,
...
name|AMRM_PROXY_INTERCEPTOR_CLASS_PIPELINE
argument_list|,
name|BadRequestInterceptorAcrossRestart
operator|.
name|class
operator|.
name|getName
...
argument_list|)
expr_stmt|;
comment|// Create an app entry in NMSS
name|registerApplicationMaster
argument_list|(
literal|1
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// AMRMProxy restarts and recover
name|createAndStartAMRMProxyService
argument_list|(
name|conf
argument_list|)
...
argument_list|()
expr_stmt|;
comment|// The app that failed to recover should have been removed from NMSS
name|Assert
operator|.
name|assertEquals
argument_list|(
...
block|}
block|}
comment|/**    * A mock intercepter implementation that throws when recovering.    */
DECL|class|BadRequestInterceptorAcrossRestart
specifier|public
specifier|static
class|class
name|BadRequestInterceptorAcrossRestart
