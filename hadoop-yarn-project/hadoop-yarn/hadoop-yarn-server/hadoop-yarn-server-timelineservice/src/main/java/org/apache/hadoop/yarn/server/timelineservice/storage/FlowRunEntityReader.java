...
expr_stmt|;
block|}
DECL|method|FlowRunEntityReader (String userId, String clusterId, String flowId, Long flowRunId, String appId, String entityType, String entityId, EnumSet<Field> fieldsToRetrieve)
specifier|public
name|FlowRunEntityReader
parameter_list|(
name|String
...
argument_list|(
literal|"multiple entity query is not supported"
argument_list|)
throw|;
block|}
annotation|@
