...
expr_stmt|;
block|}
DECL|method|createTimelineReaderStore (Configuration conf)
specifier|private
name|TimelineReader
name|createTimelineReaderStore
parameter_list|(
...
block|}
block|}
comment|/**    * Sets up some options and filters.    *    * @param conf Configuration    */
DECL|method|setupOptions (Configuration conf)
specifier|protected
name|void
name|setupOptions
parameter_list|(
