...
block|}
block|}
DECL|method|getRenewalDelay (long renewInterval)
specifier|private
name|long
name|getRenewalDelay
parameter_list|(
name|long
name|renewInterval
parameter_list|)
...
return|;
block|}
DECL|method|getRegenerationDelay (long tokenMaxDate)
specifier|private
name|long
name|getRegenerationDelay
parameter_list|(
name|long
name|tokenMaxDate
parameter_list|)
...
return|;
block|}
DECL|method|generateTokenAndSetTimer ( ApplicationId appId, AppLevelTimelineCollector appCollector)
specifier|private
name|org
operator|.
name|apache
...
condition|)
block|{
comment|// if collector bind-host is not set, fall back to
comment|// timeline-service.bind-host to maintain compatibility
name|bindAddress
operator|=
name|conf
operator|.
...
name|appId
decl_stmt|;
comment|// Indicates whether timer is for renewal or regeneration of token.
DECL|field|timerForRenewal
specifier|private
name|boolean
name|timerForRenewal
init|=
literal|true
decl_stmt|;
DECL|method|CollectorTokenRenewer (ApplicationId applicationId, boolean forRenewal)
specifier|private
name|CollectorTokenRenewer
parameter_list|(
name|ApplicationId
...
expr_stmt|;
block|}
DECL|method|renewToken (AppLevelTimelineCollector appCollector)
specifier|private
name|void
name|renewToken
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// Set renewal or regeneration timer based on delay.
name|long
name|renewalDelay
init|=
literal|0
...
block|}
block|}
DECL|method|regenerateToken (AppLevelTimelineCollector appCollector)
specifier|private
name|void
...
name|warn
argument_list|(
literal|"Unable to report regenerated token to NM for "
operator|+
name|appId
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Cannot find active collector while "
operator|+
operator|(
name|timerForRenewal
condition|?
