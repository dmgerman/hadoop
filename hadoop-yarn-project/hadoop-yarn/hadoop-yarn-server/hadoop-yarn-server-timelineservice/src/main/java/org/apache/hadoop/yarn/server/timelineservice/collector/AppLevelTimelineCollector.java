...
return|;
block|}
DECL|method|setDelegationTokenAndFutureForApp ( Token<TimelineDelegationTokenIdentifier> token, Future<?> appRenewalFuture)
name|void
...
expr_stmt|;
block|}
DECL|method|setRenewalFutureForApp (Future<?> appRenewalFuture)
name|void
