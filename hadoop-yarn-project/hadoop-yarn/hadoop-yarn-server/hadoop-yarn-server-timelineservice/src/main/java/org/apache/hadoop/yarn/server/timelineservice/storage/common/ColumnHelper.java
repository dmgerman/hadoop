...
return|;
block|}
comment|/**    * Create a compound column qualifier by combining qualifier and components.    *    * @param qualifier Column QUalifier.    * @param components Other components.    * @return a byte array representing compound column qualifier.    */
DECL|method|getCompoundColumnQualifierBytes (String qualifier, byte[]...components)
specifier|public
specifier|static
name|byte
index|[]
