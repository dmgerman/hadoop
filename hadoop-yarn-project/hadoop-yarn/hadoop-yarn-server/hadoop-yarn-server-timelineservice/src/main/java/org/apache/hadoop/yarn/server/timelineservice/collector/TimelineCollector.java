...
name|debug
argument_list|(
literal|"putEntities(entities={}, callerUgi={})"
argument_list|,
name|entities
argument_list|,
name|callerUgi
...
name|debug
argument_list|(
literal|"putDomain(domain={}, callerUgi={})"
argument_list|,
name|domain
argument_list|,
name|callerUgi
...
name|debug
argument_list|(
literal|"putEntitiesAsync(entities={}, callerUgi={})"
argument_list|,
name|entities
argument_list|,
name|callerUgi
...
name|error
argument_list|(
literal|"Got an exception while writing entity"
argument_list|,
name|ie
argument_list|)
expr_stmt|;
