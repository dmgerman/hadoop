...
block|}
block|}
DECL|method|matchFilter (Object infoValue, Object filterValue)
specifier|private
specifier|static
name|boolean
name|matchFilter
...
return|;
block|}
DECL|method|matchFilters (Map<String, ? extends Object> entityInfo, Map<String, ? extends Object> filters)
specifier|private
specifier|static
name|boolean
name|matchFilters
...
return|;
block|}
DECL|method|matchRelations ( Map<String, Set<String>> entityRelations, Map<String, Set<String>> relations)
specifier|private
specifier|static
name|boolean
name|matchRelations
