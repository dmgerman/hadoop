...
argument_list|)
decl_stmt|;
DECL|field|PHOENIX_OPTION_SHORT
specifier|private
specifier|static
specifier|final
name|String
name|PHOENIX_OPTION_SHORT
init|=
literal|"p"
decl_stmt|;
...
expr_stmt|;
block|}
comment|// Create Phoenix data schema if needed
if|if
condition|(
name|commandLine
operator|.
...
name|info
argument_list|(
literal|"Successfully created Phoenix offline aggregation schema. "
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|error
argument_list|(
literal|"Error in creating phoenix tables: "
operator|+
name|e
operator|.
name|getMessage
...
literal|false
argument_list|,
literal|"create Phoenix offline aggregation tables"
argument_list|)
expr_stmt|;
