...
return|;
block|}
comment|/**    * Health check REST end point.    *    * @param req Servlet request.    * @param res Servlet response.    *    * @return A {@link Response} object with HTTP status 200 OK if the service    *         is running.    *         Otherwise, a {@link Response} object with HTTP status 500 is    *         returned.    */
annotation|@
name|GET
annotation|@
name|Path
...
name|UTF_8
argument_list|)
DECL|method|health ( @ontext HttpServletRequest req, @Context HttpServletResponse res )
specifier|public
name|Response
name|health
parameter_list|(
...
name|info
argument_list|(
literal|"Timeline services health check: timeline reader reported "
operator|+
...
argument_list|)
expr_stmt|;
name|checkAccessForGenericEntities
argument_list|(
name|entities
argument_list|,
name|callerUGI
...
argument_list|)
expr_stmt|;
name|checkAccessForGenericEntity
argument_list|(
name|entity
argument_list|,
name|callerUGI
...
return|;
block|}
comment|/**    * Return a set of flows runs for the given user and flow name.    * Cluster ID is not provided by client so default cluster ID has to be taken.    *    * @param req Servlet request.    * @param res Servlet response.    * @param userId User id representing the user who ran the flow runs(    *     Mandatory path param)    * @param flowName Flow name to which the flow runs to be queried belongs to(    *     Mandatory path param).    * @param limit If specified, defines the number of flow runs to return. The    *     maximum possible value for limit can be {@link Long#MAX_VALUE}. If it    *     is not specified or has a value less than 0, then limit will be    *     considered as 100. (Optional query param).    * @param createdTimeStart If specified, matched flow runs should not be    *     created before this timestamp(Optional query param).    * @param createdTimeEnd If specified, matched flow runs should not be created    *     after this timestamp(Optional query param).    * @param metricsToRetrieve If specified, defines which metrics to retrieve    *     and send back in response. These metrics will be retrieved    *     irrespective of whether metrics are specified in fields to retrieve or    *     not.    * @param fields Specifies which fields to retrieve, see {@link Field}. All    *     fields will be retrieved if fields=ALL. Amongst all the fields, only    *     METRICS makes sense for flow runs hence only ALL or METRICS are    *     supported as fields for fetching flow runs. Other fields will lead to    *     HTTP 400 (Bad Request) response. (Optional query param).    * @param fromId If specified, retrieve the next set of flow run entities    *     from the given fromId. The set of entities retrieved is inclusive of    *     specified fromId. fromId should be taken from the value associated    *     with FROM_ID info key in entity response which was sent earlier.    *    * @return If successful, a HTTP 200(OK) response having a JSON representing a    *     set of<cite>FlowRunEntity</cite> instances for the given flow are    *     returned.<br>    *     On failures,<br>    *     If any problem occurs in parsing request, HTTP 400(Bad Request) is    *     returned.<br>    *     For all other errors while retrieving data, HTTP 500(Internal Server    *     Error) is returned.    */
annotation|@
name|GET
annotation|@
name|Path
...
name|Path
argument_list|(
literal|"/users/{userid}/entities/{entitytype}"
argument_list|)
annotation|@
name|Produces
argument_list|(
...
name|UTF_8
argument_list|)
DECL|method|getSubAppEntities ( @ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String userId, @PathParam(R) String entityType, @QueryParam(R) String limit, @QueryParam(R) String createdTimeStart, @QueryParam(R) String createdTimeEnd, @QueryParam(R) String relatesTo, @QueryParam(R) String isRelatedTo, @QueryParam(R) String infofilters, @QueryParam(R) String conffilters, @QueryParam(R) String metricfilters, @QueryParam(R) String eventfilters, @QueryParam(R) String confsToRetrieve, @QueryParam(R) String metricsToRetrieve, @QueryParam(R) String fields, @QueryParam(R) String metricsLimit, @QueryParam(R) String metricsTimeStart, @QueryParam(R) String metricsTimeEnd, @QueryParam(R) String fromId)
specifier|public
name|Set
argument_list|<
name|TimelineEntity
argument_list|>
name|getSubAppEntities
parameter_list|(
annotation|@
name|Context
name|HttpServletRequest
...
name|Path
argument_list|(
literal|"/clusters/{clusterid}/users/{userid}/entities/{entitytype}"
argument_list|)
annotation|@
name|Produces
argument_list|(
...
name|UTF_8
argument_list|)
DECL|method|getSubAppEntities ( @ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String clusterId, @PathParam(R) String userId, @PathParam(R) String entityType, @QueryParam(R) String limit, @QueryParam(R) String createdTimeStart, @QueryParam(R) String createdTimeEnd, @QueryParam(R) String relatesTo, @QueryParam(R) String isRelatedTo, @QueryParam(R) String infofilters, @QueryParam(R) String conffilters, @QueryParam(R) String metricfilters, @QueryParam(R) String eventfilters, @QueryParam(R) String confsToRetrieve, @QueryParam(R) String metricsToRetrieve, @QueryParam(R) String fields, @QueryParam(R) String metricsLimit, @QueryParam(R) String metricsTimeStart, @QueryParam(R) String metricsTimeEnd, @QueryParam(R) String fromId)
specifier|public
name|Set
argument_list|<
name|TimelineEntity
...
argument_list|)
expr_stmt|;
name|checkAccessForSubAppEntities
argument_list|(
name|entities
argument_list|,
name|callerUGI
...
name|Path
argument_list|(
literal|"/users/{userid}/entities/{entitytype}/{entityid}"
argument_list|)
annotation|@
name|Produces
argument_list|(
...
name|UTF_8
argument_list|)
DECL|method|getSubAppEntities (@ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String userId, @PathParam(R) String entityType, @PathParam(R) String entityId, @QueryParam(R) String confsToRetrieve, @QueryParam(R) String metricsToRetrieve, @QueryParam(R) String fields, @QueryParam(R) String metricsLimit, @QueryParam(R) String metricsTimeStart, @QueryParam(R) String metricsTimeEnd, @QueryParam(R) String entityIdPrefix)
specifier|public
name|Set
argument_list|<
name|TimelineEntity
...
name|Path
argument_list|(
literal|"/clusters/{clusterid}/users/{userid}/entities/{entitytype}/{entityid}"
argument_list|)
annotation|@
name|Produces
argument_list|(
...
name|UTF_8
argument_list|)
DECL|method|getSubAppEntities (@ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String clusterId, @PathParam(R) String userId, @PathParam(R) String entityType, @PathParam(R) String entityId, @QueryParam(R) String confsToRetrieve, @QueryParam(R) String metricsToRetrieve, @QueryParam(R) String fields, @QueryParam(R) String metricsLimit, @QueryParam(R) String metricsTimeStart, @QueryParam(R) String metricsTimeEnd, @QueryParam(R) String entityIdPrefix)
specifier|public
name|Set
argument_list|<
name|TimelineEntity
...
return|;
block|}
DECL|method|isDisplayEntityPerUserFilterEnabled (Configuration config)
specifier|static
name|boolean
...
block|}
comment|// TODO to be removed or modified once ACL story is played
DECL|method|checkAccessForSubAppEntities (Set<TimelineEntity> entities, UserGroupInformation callerUGI)
specifier|private
name|void
name|checkAccessForSubAppEntities
parameter_list|(
...
block|}
comment|// TODO to be removed or modified once ACL story is played
DECL|method|checkAccessForAppEntity (TimelineEntity entity, UserGroupInformation callerUGI)
specifier|private
name|void
name|checkAccessForAppEntity
parameter_list|(
...
block|}
comment|// TODO to be removed or modified once ACL story is played
DECL|method|checkAccessForGenericEntity (TimelineEntity entity, UserGroupInformation callerUGI)
specifier|private
name|void
name|checkAccessForGenericEntity
parameter_list|(
...
block|}
comment|// TODO to be removed or modified once ACL story is played
DECL|method|checkAccessForGenericEntities (Set<TimelineEntity> entities, UserGroupInformation callerUGI, String entityType)
specifier|private
name|void
name|checkAccessForGenericEntities
parameter_list|(
...
block|}
comment|// TODO to be removed/modified once ACL story has played
DECL|method|checkAccess (TimelineReaderManager readerManager, UserGroupInformation ugi, String entityUser)
specifier|static
name|boolean
name|checkAccess
parameter_list|(
...
block|}
comment|// TODO to be removed or modified once ACL story is played
DECL|method|checkAccess (TimelineReaderManager readerManager, UserGroupInformation callerUGI, Set<TimelineEntity> entities, String entityUserKey, boolean verifyForAllEntity)
specifier|static
name|void
name|checkAccess
parameter_list|(
