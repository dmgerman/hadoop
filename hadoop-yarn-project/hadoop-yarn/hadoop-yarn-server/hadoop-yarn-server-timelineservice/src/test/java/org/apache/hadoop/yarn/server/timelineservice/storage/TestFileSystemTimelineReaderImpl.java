...
expr_stmt|;
block|}
DECL|method|getTimelineReader ()
specifier|public
name|TimelineReader
name|getTimelineReader
parameter_list|()
block|{
return|return
name|reader
...
comment|// only the id, created and modified time
name|TimelineEntity
name|result
init|=
name|reader
...
block|}
block|}
comment|// Get entities based on modified time start and end time range.
name|result
operator|=
name|reader
operator|.
...
argument_list|)
expr_stmt|;
comment|// Two entities with IDs' id_1 and id_4 should be returned.
for|for
control|(
name|TimelineEntity
name|entity
...
name|fail
argument_list|(
literal|"Incorrect filtering based on modified time range"
argument_list|)
expr_stmt|;
block|}
block|}
comment|// Get entities if only modified time end is specified.
name|result
operator|=
name|reader
operator|.
...
block|}
block|}
comment|// Get entities if only modified time start is specified.
name|result
operator|=
name|reader
operator|.
