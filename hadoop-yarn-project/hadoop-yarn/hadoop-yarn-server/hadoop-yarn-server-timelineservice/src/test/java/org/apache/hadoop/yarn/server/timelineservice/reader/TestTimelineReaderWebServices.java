...
literal|"/ws/v2/"
operator|+
literal|"timeline/entity/cluster1/app1/app/id_1"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
comment|// entity id, entity type, created and modified time.
name|assertEquals
argument_list|(
literal|0
argument_list|,
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entity/cluster1/app1/app/id_1?fields=CONFIGS,Metrics,info"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entity/cluster1/app1/app/id_1?fields=ALL"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entity/cluster1/app1/app/id_10"
argument_list|)
decl_stmt|;
name|verifyHttpResponse
argument_list|(
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entity/app1/app/id_1"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/app1/app"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?limit=2"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entities/cluster1/app1/app?limit=3"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?createdtimestart=1425016502030&"
operator|+
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entities/cluster1/app1/app?createdtimeend=1425016502010"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entities/cluster1/app1/app?createdtimestart=1425016502010"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
annotation|@
name|Test
DECL|method|testGetEntitiesBasedOnModifiedTime ()
specifier|public
name|void
name|testGetEntitiesBasedOnModifiedTime
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?modifiedtimestart=1425016502090"
operator|+
literal|"&modifiedtimeend=1425016503020"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
name|assertTrue
argument_list|(
literal|"Entities with id_1 and id_4 should have been"
operator|+
literal|" present in response."
argument_list|,
name|entities
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entities/cluster1/app1/app?modifiedtimeend=1425016502090"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
name|assertTrue
argument_list|(
literal|"Entities with id_2 and id_3 should have been "
operator|+
literal|"present in response."
argument_list|,
name|entities
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entities/cluster1/app1/app?modifiedtimestart=1425016503005"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?relatesto=flow:flow1"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entities/cluster1/app1/app?isrelatedto=type1:tid1_2,type2:"
operator|+
literal|"tid2_1%60"
argument_list|)
expr_stmt|;
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entities/cluster1/app1/app?isrelatedto=type1:tid1_1:tid1_2"
operator|+
literal|",type2:tid2_1%60"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?conffilters=config_1:123,"
operator|+
literal|"config_3:abc"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?infofilters=info2:3.5"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?metricfilters=metric3"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?eventfilters=event_2,event_4"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?metricfilters=metric7&"
operator|+
literal|"isrelatedto=type1:tid1_1;tid1_2,type2:tid2_1%60&relatesto="
operator|+
literal|"flow:flow1&eventfilters=event_2,event_4&infofilters=info2:3.5"
operator|+
...
literal|"/ws/v2/"
operator|+
literal|"timeline/entities/cluster1/app1/app?flowrunid=a23b"
argument_list|)
decl_stmt|;
name|verifyHttpResponse
argument_list|(
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entity/cluster1/app1/app/id_1?flowrunid=2ab15"
argument_list|)
expr_stmt|;
name|verifyHttpResponse
argument_list|(
...
literal|"/ws/v2/timeline/"
operator|+
literal|"entities/cluster1/app1/app/?limit=#$561av"
argument_list|)
expr_stmt|;
name|verifyHttpResponse
argument_list|(
