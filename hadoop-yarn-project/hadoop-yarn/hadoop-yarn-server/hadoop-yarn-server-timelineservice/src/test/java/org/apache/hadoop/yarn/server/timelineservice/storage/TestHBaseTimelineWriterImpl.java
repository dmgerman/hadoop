...
annotation|@
name|Test
DECL|method|testAdditionalEntityEmptyEventInfo ()
specifier|public
name|void
name|testAdditionalEntityEmptyEventInfo
parameter_list|()
throws|throws
name|IOException
block|{
...
name|byte
index|[]
name|compoundColumnQualifierWithTsBytes
init|=
name|Separator
operator|.
name|VALUES
...
control|)
block|{
comment|// the column qualifier key must match
name|assertEquals
argument_list|(
name|valueKey
argument_list|,
