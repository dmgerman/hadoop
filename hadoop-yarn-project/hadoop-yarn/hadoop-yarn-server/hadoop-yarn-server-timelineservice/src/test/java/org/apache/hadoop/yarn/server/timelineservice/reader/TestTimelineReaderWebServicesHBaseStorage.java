...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowruns/cluster1/flow_name?userid=user1"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowruns/cluster1/flow_name?userid=user1&limit=1"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowruns/cluster1/flow_name?userid=user1&fields=metrics"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"timeline/app/cluster1/application_1111111111_1111?"
operator|+
literal|"userid=user1&fields=ALL"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowrunapps/cluster1/flow_name/1002345678919?"
operator|+
literal|"userid=user1&fields=ALL"
argument_list|)
decl_stmt|;
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowrunapps/flow_name/1002345678919?userid=user1"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowrunapps/flow_name/1002345678919?userid=user1&limit=1"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowapps/cluster1/flow_name?userid=user1&fields=ALL"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowapps/flow_name?userid=user1"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowapps/flow_name?userid=user1&limit=1"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowapps/cluster1/flow_name?userid=user1&eventfilters="
operator|+
name|ApplicationMetricsConstants
operator|.
name|FINISHED_EVENT_TYPE
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowapps/cluster1/flow_name?userid=user1&metricfilters="
operator|+
literal|"HDFS_BYTES_READ"
argument_list|)
expr_stmt|;
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowapps/cluster1/flow_name?userid=user1&conffilters="
operator|+
literal|"cfg1:value1"
argument_list|)
expr_stmt|;
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowrun/cluster1/flow_name/1002345678929?userid=user1"
argument_list|)
decl_stmt|;
name|verifyHttpResponse
argument_list|(
...
literal|"/ws/v2/"
operator|+
literal|"timeline/app/cluster1/flow_name/1002345678919/"
operator|+
literal|"application_1111111111_1378?userid=user1"
argument_list|)
decl_stmt|;
name|verifyHttpResponse
argument_list|(
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowrunapps/cluster2/flow_name/1002345678919"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
...
literal|"/ws/v2/"
operator|+
literal|"timeline/flowapps/cluster2/flow_name55"
argument_list|)
decl_stmt|;
name|ClientResponse
name|resp
