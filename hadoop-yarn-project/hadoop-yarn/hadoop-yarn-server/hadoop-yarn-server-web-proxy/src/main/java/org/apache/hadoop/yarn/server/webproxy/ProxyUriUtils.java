...
condition|)
block|{
comment|/*        * check is made to make sure if AM reports with scheme then it will be        * used by default otherwise it will default to the one configured using        * "hadoop.ssl.enabled".        */
return|return
operator|new
name|URI
argument_list|(
