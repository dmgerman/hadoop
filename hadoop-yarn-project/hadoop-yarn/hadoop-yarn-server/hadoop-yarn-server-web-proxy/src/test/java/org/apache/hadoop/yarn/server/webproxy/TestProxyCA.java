...
argument_list|)
expr_stmt|;
comment|// null certificate and private key
name|proxyCA
operator|.
name|init
argument_list|(
...
annotation|@
name|Test
DECL|method|testInit2Mismatch ()
specifier|public
name|void
name|testInit2Mismatch
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// certificate and private key don't match
name|CertKeyPair
name|pair1
init|=
name|createCertAndKeyPair
argument_list|()
decl_stmt|;
name|CertKeyPair
name|pair2
...
annotation|@
name|Test
DECL|method|testInit2Invalid ()
specifier|public
name|void
name|testInit2Invalid
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Invalid key - fail the verification
name|X509Certificate
name|certificate
init|=
name|Mockito
...
name|fail
argument_list|(
literal|"Expected InvalidKeyException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
expr_stmt|;
comment|// certificate and private key do match
name|CertKeyPair
name|pair
init|=
name|createCertAndKeyPair
...
name|keyPair
decl_stmt|;
DECL|method|CertKeyPair (X509Certificate cert, KeyPair keyPair)
specifier|public
name|CertKeyPair
parameter_list|(
name|X509Certificate
...
block|}
block|}
DECL|method|createCertAndKeyPair ()
specifier|private
name|CertKeyPair
name|createCertAndKeyPair
parameter_list|()
...
name|Exception
block|{
comment|// Re-use a ProxyCA to generate a valid Certificate and KeyPair
name|ProxyCA
name|proxyCA
init|=
operator|new
