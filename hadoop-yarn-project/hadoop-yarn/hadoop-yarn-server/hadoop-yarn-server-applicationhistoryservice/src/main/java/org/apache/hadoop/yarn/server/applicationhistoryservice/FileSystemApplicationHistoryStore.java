...
specifier|private
name|void
DECL|method|retrieveStartFinishData ( ApplicationId appId, HistoryFileReader.Entry entry, Map<ApplicationAttemptId, StartFinishDataPair<ApplicationAttemptStartData, ApplicationAttemptFinishData>> startFinshDataMap, boolean start)
name|retrieveStartFinishData
parameter_list|(
name|ApplicationId
name|appId
...
specifier|private
name|void
DECL|method|retrieveStartFinishData ( ApplicationAttemptId appAttemptId, HistoryFileReader.Entry entry, Map<ContainerId, StartFinishDataPair<ContainerStartData, ContainerFinishData>> startFinshDataMap, boolean start)
name|retrieveStartFinishData
parameter_list|(
name|ApplicationAttemptId
name|appAttemptId
...
block|}
block|}
DECL|class|StartFinishDataPair
specifier|private
specifier|static
class|class
name|StartFinishDataPair
...
parameter_list|>
block|{
DECL|field|startData
specifier|private
name|S
name|startData
decl_stmt|;
DECL|field|finishData
specifier|private
name|F
name|finishData
decl_stmt|;
