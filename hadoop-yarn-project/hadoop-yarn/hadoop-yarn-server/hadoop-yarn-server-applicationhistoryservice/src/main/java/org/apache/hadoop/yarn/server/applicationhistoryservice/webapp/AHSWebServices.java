...
annotation|@
name|Unstable
DECL|method|getLogs (@ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String containerIdStr, @PathParam(R) String filename, @QueryParam(R) String download)
specifier|public
name|Response
name|getLogs
parameter_list|(
...
return|;
block|}
DECL|method|sendStreamOutputResponse (ApplicationId appId, String appOwner, String nodeId, String containerIdStr, String fileName, boolean downloadFile)
specifier|private
name|Response
name|sendStreamOutputResponse
parameter_list|(
...
return|;
block|}
DECL|method|getStreamingOutput (ApplicationId appId, String appOwner, final String nodeId, final String containerIdStr, final String logFile)
specifier|private
name|StreamingOutput
name|getStreamingOutput
parameter_list|(
