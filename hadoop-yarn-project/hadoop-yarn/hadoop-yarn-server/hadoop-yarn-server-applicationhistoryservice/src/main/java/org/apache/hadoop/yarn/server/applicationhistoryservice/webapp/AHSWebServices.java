...
annotation|@
name|Unstable
DECL|method|getLogs (@ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String containerIdStr, @PathParam(R) String filename, @QueryParam(R) String download, @QueryParam(R) String size)
specifier|public
name|Response
name|getLogs
parameter_list|(
...
return|;
block|}
DECL|method|sendStreamOutputResponse (ApplicationId appId, String appOwner, String nodeId, String containerIdStr, String fileName, boolean downloadFile, long bytes)
specifier|private
name|Response
name|sendStreamOutputResponse
parameter_list|(
