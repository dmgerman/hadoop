...
comment|/**    * Returns log file's name as well as current file size for a container.    *    * @param req    *    HttpServletRequest    * @param res    *    HttpServletResponse    * @param containerIdStr    *    The container ID    * @return    *    The log file's name and current file size    */
annotation|@
name|GET
annotation|@
name|Path
...
block|}
argument_list|)
DECL|method|getContainerLogsInfo ( @ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String containerIdStr)
specifier|public
name|Response
...
argument_list|,
literal|"Can not get ContainerInfo for the container: "
operator|+
name|containerId
argument_list|)
return|;
...
block|}
block|}
comment|/**    * Returns the contents of a container's log file in plain text.    *    * @param req    *    HttpServletRequest    * @param res    *    HttpServletResponse    * @param containerIdStr    *    The container ID    * @param filename    *    The name of the log file    * @param format    *    The content type    * @param size    *    the size of the log file    * @return    *    The contents of the container's log file    */
annotation|@
name|GET
annotation|@
name|Path
...
annotation|@
name|Unstable
DECL|method|getContainerLogFile (@ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String containerIdStr, @PathParam(R) String filename, @QueryParam(R) String format, @QueryParam(R) String size)
specifier|public
name|Response
...
annotation|@
name|Unstable
DECL|method|getLogs (@ontext HttpServletRequest req, @Context HttpServletResponse res, @PathParam(R) String containerIdStr, @PathParam(R) String filename, @QueryParam(R) String format, @QueryParam(R) String size)
specifier|public
name|Response
name|getLogs
parameter_list|(
...
return|;
block|}
DECL|method|sendStreamOutputResponse (ApplicationId appId, String appOwner, String nodeId, String containerIdStr, String fileName, String format, long bytes)
specifier|private
name|Response
name|sendStreamOutputResponse
parameter_list|(
...
name|INTERNAL_SERVER_ERROR
argument_list|,
literal|"Can not get log for container: "
operator|+
name|containerIdStr
argument_list|)
return|;
...
return|;
block|}
DECL|method|getStreamingOutput (ApplicationId appId, String appOwner, final String nodeId, final String containerIdStr, final String logFile, final long bytes)
specifier|private
name|StreamingOutput
name|getStreamingOutput
parameter_list|(
...
return|;
block|}
DECL|method|getContainerLogMeta (ApplicationId appId, String appOwner, final String nodeId, final String containerIdStr)
specifier|private
name|Response
name|getContainerLogMeta
parameter_list|(
