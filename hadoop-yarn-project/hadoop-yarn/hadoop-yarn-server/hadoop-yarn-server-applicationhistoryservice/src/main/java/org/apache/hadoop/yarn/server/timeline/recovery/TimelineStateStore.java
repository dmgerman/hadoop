...
annotation|@
name|Unstable
comment|/**  * Base class for timeline service state storage.  * Storage implementations need to implement blocking store and load methods  * to actually store and load the state.  */
DECL|class|TimelineStateStore
specifier|public
specifier|abstract
class|class
...
name|AbstractService
block|{
DECL|class|TimelineServiceState
specifier|public
specifier|static
class|class
...
block|}
block|}
DECL|method|TimelineStateStore ()
specifier|public
name|TimelineStateStore
parameter_list|()
block|{
...
expr_stmt|;
block|}
DECL|method|TimelineStateStore (String name)
specifier|public
name|TimelineStateStore
parameter_list|(
name|String
...
name|IOException
function_decl|;
comment|/**    * Load the timeline service state from the state storage.    *    * @throws IOException    */
