...
decl_stmt|;
DECL|method|ApplicationHistoryManagerOnTimelineStore ( TimelineDataManager timelineDataManager)
specifier|public
name|ApplicationHistoryManagerOnTimelineStore
parameter_list|(
name|TimelineDataManager
...
block|{
comment|// It is likely that the attemtps are not found due to non-existing
comment|// application. In this case, we need to throw ApplicationNotFoundException.
name|getApplication
argument_list|(
name|appId
argument_list|,
...
condition|)
block|{
comment|// Will throw ApplicationNotFoundException first
name|getApplication
argument_list|(
name|appAttemptId
operator|.
...
name|NONE
block|,
comment|// retrieve no fields
DECL|enumConstant|USER
name|USER
comment|// retrieve user info only
block|}
block|}
end_class
