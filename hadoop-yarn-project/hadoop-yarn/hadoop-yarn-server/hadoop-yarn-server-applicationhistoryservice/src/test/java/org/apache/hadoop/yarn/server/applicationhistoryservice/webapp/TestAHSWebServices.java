...
argument_list|)
expr_stmt|;
comment|// create container logs in local log file dir
comment|// create two container log files. We can get containerInfo
comment|// for container1 from AHS, but can not get such info for
comment|// container100
name|ApplicationAttemptId
name|appAttemptId
init|=
name|ApplicationAttemptId
