...
argument_list|()
decl_stmt|;
comment|// If we can get Container information from ATS, we re-direct the request
comment|// to the nodemamager who runs the container.
name|URI
name|requestURI
init|=
name|r
...
expr_stmt|;
comment|// If we can not container information from ATS, we would try to
comment|// get aggregated log meta from remote FileSystem.
name|ContainerId
name|containerId1000
init|=
name|ContainerId
