...
annotation|@
name|Test
DECL|method|testCleanBuckets ()
specifier|public
name|void
name|testCleanBuckets
parameter_list|()
throws|throws
name|Exception
block|{
comment|// ClusterTimeStampDir with App Log Dirs
name|Path
name|clusterTimeStampDir1
init|=
operator|new
name|Path
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// ClusterTimeStampDir with no App Log Dirs
name|Path
name|clusterTimeStampDir2
init|=
operator|new
name|Path
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// Irrevelant ClusterTimeStampDir
name|Path
name|clusterTimeStampDir3
init|=
operator|new
name|Path
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// ClusterTimeStampDir will be removed only if no App Log Dir Present
name|assertTrue
argument_list|(
name|fs
operator|.
...
annotation|@
name|Test
DECL|method|testNullCheckGetEntityTimelines ()
specifier|public
name|void
name|testNullCheckGetEntityTimelines
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"NPE when getEntityTimelines called with Null EntityIds"
argument_list|)
expr_stmt|;
block|}
block|}
...
annotation|@
name|Test
DECL|method|testScanActiveLogsWithInvalidFile ()
specifier|public
name|void
name|testScanActiveLogsWithInvalidFile
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"EntityLogScanner crashed with StackOverflowError"
argument_list|)
expr_stmt|;
block|}
finally|finally
