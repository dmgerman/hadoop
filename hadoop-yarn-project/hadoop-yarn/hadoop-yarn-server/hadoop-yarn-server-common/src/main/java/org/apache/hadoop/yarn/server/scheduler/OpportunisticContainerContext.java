...
expr_stmt|;
block|}
comment|// Set numContainers only for ANY request
if|if
condition|(
name|ResourceRequest
operator|.
...
block|}
block|}
comment|/**    * This method matches a returned list of Container Allocations to any    * outstanding OPPORTUNISTIC ResourceRequest.    * @param capability Capability    * @param allocations Allocations.    */
DECL|method|matchAllocationToOutstandingRequest (Resource capability, List<Allocation> allocations)
specifier|public
name|void
