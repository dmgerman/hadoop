...
begin_comment
comment|/**  *<p>  * The request sent by the<code>Router</code> to<code>Federation state  * store</code> to map the home subcluster of a newly submitted application.  *  *<p>  * The request includes the mapping details, i.e.:  *<ul>  *<li>{@code ApplicationId}</li>  *<li>{@code SubClusterId}</li>  *</ul>  */
end_comment
...
annotation|@
name|Unstable
DECL|class|AddApplicationHomeSubClusterRequest
specifier|public
specifier|abstract
class|class
