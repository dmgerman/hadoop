...
return|return;
block|}
comment|//TODO:YARN-3284
comment|//The preemption metrics will be exposed from ApplicationReport
comment|// and ApplicationAttemptReport
name|ApplicationResourceUsageReport
name|usageReport
init|=
name|appReport
...
block|}
comment|//TODO: YARN-3284
comment|//The containerLocality metrics will be exposed from AttemptReport
...
block|}
comment|//TODO:YARN-3284
comment|//The resource requests metrics will be exposed from attemptReport
DECL|method|createResourceRequestsTable (Block html, List<ResourceRequest> resouceRequests)
specifier|private
name|void
name|createResourceRequestsTable
parameter_list|(
