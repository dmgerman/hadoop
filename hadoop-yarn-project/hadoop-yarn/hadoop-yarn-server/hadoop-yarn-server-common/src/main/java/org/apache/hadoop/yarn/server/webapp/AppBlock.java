...
argument_list|)
expr_stmt|;
comment|//Validate if able to read application attempts
comment|// which should also validate if kill is allowed for the user based on ACLs
name|Collection
argument_list|<
name|ApplicationAttemptReport
argument_list|>
...
return|;
block|}
DECL|method|isAppInFinalState (AppInfo app)
specifier|private
name|boolean
name|isAppInFinalState
parameter_list|(
