...
name|YarnException
block|{
comment|// stateless policy does not care about responses except tracking headroom
name|headroom
operator|.
name|put
argument_list|(
...
return|;
block|}
comment|/**      * Return the total number of container coming from localized requests.      */
DECL|method|getTotNumLocalizedContainers ()
specifier|private
name|long
name|getTotNumLocalizedContainers
parameter_list|()
