...
begin_comment
comment|/**  * Base abstract class for {@link FederationAMRMProxyPolicy} implementations,  * that provides common validation for reinitialization.  */
end_comment

begin_class
DECL|class|AbstractAMRMProxyPolicy
specifier|public
specifier|abstract
class|class
...
name|YarnException
block|{
comment|// By default, a stateless policy does not care about responses
block|}
block|}
end_class
