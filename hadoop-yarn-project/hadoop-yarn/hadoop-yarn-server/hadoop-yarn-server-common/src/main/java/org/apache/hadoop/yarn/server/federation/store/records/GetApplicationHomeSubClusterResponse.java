...
begin_comment
comment|/**  *<p>  * The response sent by<code>Federation state  * store</code> to a query for the home subcluster of a newly submitted  * application.  *  *<p>  * The request includes the mapping details, i.e.:  *<ul>  *<li>{@code ApplicationId}</li>  *<li>{@code SubClusterId}</li>  *</ul>  */
end_comment
...
annotation|@
name|Unstable
DECL|class|GetApplicationHomeSubClusterResponse
specifier|public
specifier|abstract
class|class
