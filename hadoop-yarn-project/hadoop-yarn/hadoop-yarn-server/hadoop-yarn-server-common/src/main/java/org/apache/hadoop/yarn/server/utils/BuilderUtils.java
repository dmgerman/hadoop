...
return|;
block|}
DECL|method|newContainer (ContainerId containerId, NodeId nodeId, String nodeHttpAddress, Resource resource, Priority priority, Token containerToken, ExecutionType executionType)
specifier|public
specifier|static
name|Container
name|newContainer
