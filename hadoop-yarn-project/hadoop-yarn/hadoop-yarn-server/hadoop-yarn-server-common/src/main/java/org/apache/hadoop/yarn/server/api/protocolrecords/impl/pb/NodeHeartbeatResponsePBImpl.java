...
literal|null
decl_stmt|;
comment|// NOTE: This is required for backward compatibility.
...
condition|)
block|{
name|addContainersToDecreaseToProto
argument_list|()
expr_stmt|;
block|}
if|if
...
expr_stmt|;
block|}
DECL|method|initContainersToDecrease ()
specifier|private
name|void
name|initContainersToDecrease
parameter_list|()
block|{
if|if
condition|(
...
name|p
operator|.
name|getContainersToDecreaseList
argument_list|()
decl_stmt|;
name|this
operator|.
...
expr_stmt|;
block|}
DECL|method|addContainersToDecreaseToProto ()
specifier|private
name|void
name|addContainersToDecreaseToProto
parameter_list|()
...
name|builder
operator|.
name|clearContainersToDecrease
argument_list|()
expr_stmt|;
if|if
condition|(
...
annotation|@
name|Override
DECL|method|setSystemCredentialsForApps ( Collection<SystemCredentialsForAppsProto> systemCredentialsForAppsProto)
specifier|public
name|void
...
name|builder
operator|.
name|addAllSystemCredentialsForApps
argument_list|(
name|systemCredentialsForAppsProto
argument_list|)
expr_stmt|;
...
annotation|@
name|Override
DECL|method|setAppCollectors ( Map<ApplicationId, AppCollectorData> appCollectors)
specifier|public
name|void
