...
argument_list|)
decl_stmt|;
DECL|field|OPPORTUNISTIC_REQ
specifier|private
specifier|static
specifier|final
name|ExecutionTypeRequest
name|OPPORTUNISTIC_REQ
init|=
name|ExecutionTypeRequest
operator|.
name|newInstance
...
annotation|@
name|Test
DECL|method|testAllocationWithNodeLabels ()
specifier|public
name|void
name|testAllocationWithNodeLabels
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|/* Since there is no node satisfying node label constraints, requests        won't get fulfilled.     */
name|Assert
operator|.
name|assertEquals
argument_list|(
