...
literal|false
decl_stmt|;
DECL|field|shouldWaitForSyncNextAllocate
specifier|private
name|boolean
...
name|info
argument_list|(
literal|"Allocate call in RM start waiting"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|info
argument_list|(
literal|"Allocate call in RM wait finished"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|info
argument_list|(
literal|"Allocate call in RM wait interrupted"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|setWaitForSyncNextAllocate (boolean wait)
specifier|public
name|void
name|setWaitForSyncNextAllocate
parameter_list|(
name|boolean
name|wait
parameter_list|)
