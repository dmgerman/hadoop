...
literal|false
decl_stmt|;
comment|// Whether this mockRM will throw application already registered exception
comment|// upon next registerApplicationMaster call
DECL|field|throwAlreadyRegister
specifier|private
name|boolean
name|throwAlreadyRegister
init|=
literal|false
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|setThrowAlreadyRegister ()
specifier|public
name|void
name|setThrowAlreadyRegister
parameter_list|()
block|{
name|this
operator|.
...
annotation|@
name|Test
DECL|method|testConcurrentReregister ()
specifier|public
name|void
name|testConcurrentReregister
parameter_list|()
throws|throws
name|YarnException
throws|,
