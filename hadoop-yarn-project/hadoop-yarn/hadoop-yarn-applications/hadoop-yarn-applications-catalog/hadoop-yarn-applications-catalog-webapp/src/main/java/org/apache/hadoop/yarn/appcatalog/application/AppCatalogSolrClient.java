...
block|}
block|}
DECL|method|setSolrUrl (String url)
specifier|private
...
block|}
block|}
DECL|method|register (AppStoreEntry app)
specifier|protected
name|void
name|register
parameter_list|(
...
block|}
block|}
DECL|method|upgradeApp (Service service)
specifier|public
name|void
name|upgradeApp
parameter_list|(
...
block|}
block|}
DECL|method|commitSolrChanges (SolrClient solr, Collection<SolrInputDocument> docs)
specifier|private
name|void
name|commitSolrChanges
parameter_list|(
...
name|IOException
argument_list|(
literal|"Failed to commit document in solr, status code: "
operator|+
name|detailsResponse
operator|.
name|getStatus
