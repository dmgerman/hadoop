...
block|}
argument_list|)
DECL|method|getApplication (@athParamAPP_NAME) String appName)
specifier|public
name|Response
name|getApplication
parameter_list|(
...
block|}
argument_list|)
DECL|method|deleteApplication (@athParamAPP_NAME) String appName)
specifier|public
name|Response
...
block|}
argument_list|)
DECL|method|updateComponent (@athParamAPP_NAME) String appName, @PathParam(COMPONENT_NAME) String componentName, Component component)
specifier|public
name|Response
...
block|}
argument_list|)
DECL|method|updateApplication (@athParamAPP_NAME) String appName, Application updateAppData)
specifier|public
name|Response
