...
argument_list|()
decl_stmt|;
DECL|field|ACTION_LIST_ARGS
specifier|private
specifier|static
specifier|final
name|ActionListArgs
name|ACTION_LIST_ARGS
init|=
operator|new
name|ActionListArgs
argument_list|()
...
block|}
block|}
DECL|method|populateAppData (Application app, JsonObject appStatus, JsonObject appRegistryQuicklinks)
specifier|private
name|Response
name|populateAppData
parameter_list|(
...
block|{
comment|// Might have to handle tarballs here
name|artifact
operator|.
name|setType
argument_list|(
...
argument_list|(
name|jsonGetAsBoolean
argument_list|(
name|componentRole
argument_list|,
literal|"docker.usePrivileged"
argument_list|)
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|jsonGetAsBoolean (JsonObject object, String key)
specifier|private
name|Boolean
name|jsonGetAsBoolean
parameter_list|(
...
return|;
block|}
DECL|method|queryLifetime (String appName)
specifier|private
name|long
name|queryLifetime
parameter_list|(
...
name|error
argument_list|(
literal|"Error when querying lifetime for "
operator|+
name|appName
argument_list|,
name|e
...
name|error
argument_list|(
literal|"Exception calling slider.actionStatus"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// ignore and return empty object
return|return
name|EMPTY_JSON_OBJECT
return|;
block|}
...
name|error
argument_list|(
literal|"Exception calling slider.actionRegistryGetConfig"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|updateAppLifetime (String appName, long lifetime)
specifier|private
name|Void
name|updateAppLifetime
parameter_list|(
