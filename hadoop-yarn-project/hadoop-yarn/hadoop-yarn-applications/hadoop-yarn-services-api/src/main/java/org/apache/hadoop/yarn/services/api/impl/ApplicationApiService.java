...
return|;
block|}
DECL|method|getMetainfoJson (Application application, Map<String, String> compNameArtifactIdMap)
specifier|private
name|String
name|getMetainfoJson
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Use only one export group
name|JsonObject
name|exportGroup
init|=
operator|new
...
condition|)
block|{
comment|// Set exports at application level
name|Map
argument_list|<
name|String
argument_list|,
...
control|)
block|{
comment|// we also need the capability to specify ports and mount points
comment|// sometime
name|compObject
operator|=
name|createMetainfoComponent
argument_list|(
name|comp
argument_list|,
name|application
...
block|}
block|}
comment|// Translate dependencies into command orders
name|List
argument_list|<
name|String
argument_list|>
...
control|)
block|{
comment|// If APPLICATION type artifact then map component name dependencies
comment|// to artifact id
if|if
condition|(
name|comp
operator|.
...
expr_stmt|;
block|}
comment|// Quicklinks need to be added as appExports and componentExports at the
...
argument_list|)
expr_stmt|;
comment|// specify that there are published configs for this component
name|compObject
operator|.
name|addProperty
argument_list|(
literal|"publishConfig"
argument_list|,
literal|"true"
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|createMetainfoComponent (Component comp, Application application, String compName)
specifier|private
name|JsonObject
name|createMetainfoComponent
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// below is diff for each type
if|if
condition|(
name|comp
operator|.
...
argument_list|)
expr_stmt|;
comment|// if image not specified, then use global value
name|dockerContainerObj
operator|.
name|addProperty
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// If launch command not specified, then use global value. Resolve all
...
argument_list|)
expr_stmt|;
comment|// TODO: What to do with privContainer ?
name|dockerContainerObj
operator|.
name|addProperty
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO: add all properties which should include dictionaryName
name|configFileObj
operator|.
name|addProperty
argument_list|(
literal|"dictionaryName"
argument_list|,
name|configFile
operator|.
name|getSrcFile
...
block|}
block|}
comment|// we also need to specify artifact_management_service sometime
block|}
comment|// we also need the capability to specify ports and mount points sometime
return|return
name|compObj
return|;
block|}
