...
block|}
block|}
DECL|method|addHdfsClassPathIfNeeded (RunJobParameters parameters, FileWriter fw, Component comp)
specifier|private
name|void
...
condition|)
block|{
comment|// Do we need tensorboard?
if|if
condition|(
name|parameters
operator|.
...
literal|6006
decl_stmt|;
comment|// Run tensorboard at the background
name|fw
operator|.
name|append
argument_list|(
literal|"tensorboard --port "
operator|+
name|tensorboardPort
operator|+
literal|" --logdir "
