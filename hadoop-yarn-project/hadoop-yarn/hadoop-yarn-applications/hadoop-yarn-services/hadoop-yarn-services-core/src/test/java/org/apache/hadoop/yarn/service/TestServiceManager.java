...
argument_list|)
decl_stmt|;
comment|// wait till instances of first component are in upgrade
name|String
name|comp1
init|=
name|comps
...
argument_list|)
expr_stmt|;
comment|// wait till instances of second component are in upgrade
name|String
name|comp2
init|=
name|comps
...
expr_stmt|;
block|}
DECL|method|upgradeInstancesOf (ServiceContext context, String compName)
specifier|private
name|void
name|upgradeInstancesOf
parameter_list|(
