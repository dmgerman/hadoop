...
name|serviceName
init|=
literal|"testContainerCompletedWhenUpgrading"
decl_stmt|;
name|MockRunningServiceContext
name|context
init|=
...
name|assertEquals
argument_list|(
literal|"component not in needs upgrade state"
argument_list|,
name|ComponentState
operator|.
name|NEEDS_UPGRADE
...
annotation|@
name|Test
DECL|method|testContainerCompletedCancelUpgrade ()
specifier|public
name|void
name|testContainerCompletedCancelUpgrade
parameter_list|()
throws|throws
name|Exception
block|{
...
name|serviceName
init|=
literal|"testContainerCompletedCancelUpgrade"
decl_stmt|;
name|MockRunningServiceContext
name|context
init|=
...
argument_list|)
expr_stmt|;
comment|// reinitialization of a container done
for|for
control|(
name|ComponentInstance
name|instance
...
argument_list|()
decl_stmt|;
comment|// cancel upgrade failed of a container
name|ComponentInstance
name|instance1
init|=
name|iter
...
annotation|@
name|Test
DECL|method|testCancelUpgradeSuccessWhileUpgrading ()
specifier|public
name|void
name|testCancelUpgradeSuccessWhileUpgrading
parameter_list|()
throws|throws
name|Exception
block|{
...
name|serviceName
init|=
literal|"testCancelUpgradeWhileUpgrading"
decl_stmt|;
name|MockRunningServiceContext
name|context
init|=
...
argument_list|()
decl_stmt|;
name|cancelUpgradeWhileUpgrading
argument_list|(
name|context
argument_list|,
name|comp
argument_list|)
expr_stmt|;
comment|// cancel upgrade successful for both instances
for|for
control|(
name|ComponentInstance
name|instance
...
annotation|@
name|Test
DECL|method|testCancelUpgradeFailureWhileUpgrading ()
specifier|public
name|void
name|testCancelUpgradeFailureWhileUpgrading
parameter_list|()
throws|throws
name|Exception
block|{
...
name|serviceName
init|=
literal|"testCancelUpgradeFailureWhileUpgrading"
decl_stmt|;
name|MockRunningServiceContext
name|context
init|=
...
argument_list|)
expr_stmt|;
comment|// cancel upgrade failed for both instances
for|for
control|(
name|ComponentInstance
name|instance
...
expr_stmt|;
block|}
DECL|method|cancelUpgradeWhileUpgrading ( MockRunningServiceContext context, Component comp)
specifier|private
name|void
name|cancelUpgradeWhileUpgrading
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// instance1 is triggered to upgrade
name|instance1
operator|.
name|handle
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// component upgrade is cancelled
name|comp
operator|.
name|handle
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// all instances upgrade is cancelled.
name|comp
operator|.
name|getAllComponentInstances
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// regular upgrade failed for instance 1
name|comp
operator|.
name|handle
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// component should be in cancel upgrade
name|Assert
operator|.
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|testComponentStateUpdatesWithTerminatingDominantComponents ()
specifier|public
name|void
name|testComponentStateUpdatesWithTerminatingDominantComponents
parameter_list|()
throws|throws
name|Exception
block|{
...
name|serviceName
init|=
literal|"testComponentStateUpdatesWithTerminatingServiceStateComponents"
decl_stmt|;
name|Service
name|testService
init|=
