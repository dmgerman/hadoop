...
name|assertEquals
argument_list|(
literal|"num containers after by restart for "
operator|+
name|compName
argument_list|,
name|containersBeforeFailure
...
block|}
block|}
DECL|method|waitForContainers (ServiceClient client, Service exampleApp)
specifier|private
name|void
name|waitForContainers
parameter_list|(
...
literal|200000
argument_list|)
DECL|method|testRestartServiceForNonExistingInRM ()
specifier|public
name|void
name|testRestartServiceForNonExistingInRM
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"ignore ApplicationNotFoundException during stopping"
argument_list|)
expr_stmt|;
block|}
name|client
...
name|assertEquals
argument_list|(
literal|"Restarted service state should be STABLE"
argument_list|,
name|ServiceState
operator|.
name|STABLE
