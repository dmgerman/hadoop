...
name|EXCEPTION_PREFIX
operator|+
literal|"service with invalid keytab URI scheme"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|EXCEPTION_PREFIX
operator|+
literal|"service with invalid keytab"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
parameter_list|)
block|{
comment|// strip out the %s at the end of the RestApiErrorMessages string constant
name|assertTrue
argument_list|(
name|e
operator|.
