...
name|rule
argument_list|,
literal|"testContainerReadyAfterUpgrade"
argument_list|)
decl_stmt|;
name|Component
name|component
...
annotation|@
name|Test
DECL|method|testContainerUpgradeFailed ()
specifier|public
name|void
name|testContainerUpgradeFailed
parameter_list|()
throws|throws
name|Exception
block|{
...
name|rule
argument_list|,
literal|"testContainerUpgradeFailed"
argument_list|)
decl_stmt|;
name|Component
name|component
...
argument_list|)
decl_stmt|;
comment|// this is the call back from NM for the upgrade
name|instance
operator|.
name|handle
argument_list|(
...
annotation|@
name|Test
DECL|method|testFailureAfterReinit ()
specifier|public
name|void
name|testFailureAfterReinit
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testCancelNothingToUpgrade ()
specifier|public
name|void
name|testCancelNothingToUpgrade
parameter_list|()
throws|throws
name|Exception
block|{
...
name|rule
argument_list|,
literal|"testCancelUpgradeWhenContainerReady"
argument_list|)
decl_stmt|;
name|Component
name|component
...
annotation|@
name|Test
DECL|method|testCancelUpgradeFailed ()
specifier|public
name|void
name|testCancelUpgradeFailed
parameter_list|()
throws|throws
name|Exception
block|{
...
name|rule
argument_list|,
literal|"testCancelUpgradeFailed"
argument_list|)
decl_stmt|;
name|Component
name|component
...
annotation|@
name|Test
DECL|method|testCancelAfterCompProcessedCancel ()
specifier|public
name|void
name|testCancelAfterCompProcessedCancel
parameter_list|()
throws|throws
name|Exception
block|{
...
name|rule
argument_list|,
literal|"testCancelAfterCompProcessedCancel"
argument_list|)
decl_stmt|;
name|Component
name|component
...
name|assertEquals
argument_list|(
literal|"instance should start upgrading"
argument_list|,
name|ContainerState
operator|.
name|NEEDS_UPGRADE
...
annotation|@
name|Test
DECL|method|testCancelWhileUpgradeWithSuccess ()
specifier|public
name|void
name|testCancelWhileUpgradeWithSuccess
parameter_list|()
throws|throws
name|Exception
block|{
name|validateCancelWhileUpgrading
argument_list|(
literal|true
argument_list|,
literal|true
...
annotation|@
name|Test
DECL|method|testCancelWhileUpgradeWithFailure ()
specifier|public
name|void
name|testCancelWhileUpgradeWithFailure
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testCancelFailedWhileUpgradeWithSuccess ()
specifier|public
name|void
name|testCancelFailedWhileUpgradeWithSuccess
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testCancelFailedWhileUpgradeWithFailure ()
specifier|public
name|void
name|testCancelFailedWhileUpgradeWithFailure
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testUpdateLocalizationStatuses ()
specifier|public
name|void
name|testUpdateLocalizationStatuses
parameter_list|()
throws|throws
name|Exception
block|{
...
name|createBaseDef
argument_list|(
literal|"testUpdateLocalizationStatuses"
argument_list|)
decl_stmt|;
name|String
name|file1
...
name|assertTrue
argument_list|(
literal|"retriever should still be active"
argument_list|,
name|instance
operator|.
...
name|assertTrue
argument_list|(
literal|"retriever should not be active"
argument_list|,
operator|!
name|instance
operator|.
...
expr_stmt|;
block|}
DECL|method|validateCancelWhileUpgrading (boolean upgradeSuccessful, boolean cancelUpgradeSuccessful)
specifier|private
name|void
name|validateCancelWhileUpgrading
parameter_list|(
...
name|rule
argument_list|,
literal|"testCancelWhileUpgrading"
argument_list|)
decl_stmt|;
name|Component
name|component
...
name|assertEquals
argument_list|(
literal|"instance should be upgrading"
argument_list|,
name|ContainerState
operator|.
name|UPGRADING
...
argument_list|)
expr_stmt|;
comment|// either upgrade failed or successful
if|if
condition|(
name|upgradeSuccessful
condition|)
...
argument_list|)
expr_stmt|;
comment|// response for cancel received
if|if
condition|(
name|cancelUpgradeSuccessful
condition|)
...
expr_stmt|;
block|}
DECL|method|cancelCompUpgrade (Component component)
specifier|private
name|void
name|cancelCompUpgrade
parameter_list|(
