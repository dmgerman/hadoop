...
annotation|@
name|Test
DECL|method|testAMEnvCustomClasspath ()
specifier|public
name|void
name|testAMEnvCustomClasspath
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|//saving the original value of the param, for restoration purposes
name|String
name|oldParam
init|=
name|client
...
name|originalPath
operator|+
literal|"<CPS>{{VAR_1}}<CPS>{{VAR_2}}"
argument_list|,
name|newPath
argument_list|)
expr_stmt|;
comment|//restoring the original value for service classpath
name|client
operator|.
name|getConfig
argument_list|()
