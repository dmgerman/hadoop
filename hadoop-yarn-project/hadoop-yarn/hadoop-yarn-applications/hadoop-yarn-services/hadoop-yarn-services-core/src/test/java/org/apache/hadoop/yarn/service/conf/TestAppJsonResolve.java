...
argument_list|)
expr_stmt|;
comment|// load the external service
name|SliderFileSystem
name|sfs
init|=
name|ServiceTestUtils
...
argument_list|)
expr_stmt|;
comment|// perform the resolution on original service
name|sfs
operator|=
name|ServiceTestUtils
operator|.
...
argument_list|)
expr_stmt|;
comment|// Validate worker's resources
name|Resource
name|workerResource
init|=
name|orig
...
annotation|@
name|Test
DECL|method|testSetResourceAttributes ()
specifier|public
name|void
name|testSetResourceAttributes
parameter_list|()
throws|throws
name|IOException
block|{
