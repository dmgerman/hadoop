...
annotation|@
name|Test
DECL|method|testScheduleWithResourceAttributes ()
specifier|public
name|void
name|testScheduleWithResourceAttributes
parameter_list|()
throws|throws
name|Exception
block|{
...
name|setName
argument_list|(
literal|"testScheduleWithResourceAttributes"
argument_list|)
expr_stmt|;
name|exampleApp
operator|.
