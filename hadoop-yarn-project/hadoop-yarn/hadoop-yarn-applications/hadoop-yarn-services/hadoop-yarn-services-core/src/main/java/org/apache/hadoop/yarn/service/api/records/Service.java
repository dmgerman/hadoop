...
expr_stmt|;
block|}
comment|/**    * The custom launch command of an service component (optional). If not    * specified for services with docker images say, it will default to the    * default start command of the image. If there is a single component in this    * service, you can specify this without the need to have a 'components'    * section.    **/
...
name|value
operator|=
literal|"The custom launch command of an service component (optional). If not specified for services with docker images say, it will default to the default start command of the image. If there is a single component in this service, you can specify this without the need to have a 'components' section."
argument_list|)
annotation|@
name|JsonProperty
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Number of containers for each component in the service. Each    * component can further override this service-level global default.    **/
...
name|value
operator|=
literal|"Number of containers for each component in the service. Each component can further override this service-level global default."
argument_list|)
annotation|@
name|JsonProperty
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Containers of a started service. Specifying a value for this attribute    * for the POST payload raises a validation error. This blob is available only    * in the GET response of a started service.    **/
...
name|value
operator|=
literal|"Containers of a started service. Specifying a value for this attribute for the POST payload raises a validation error. This blob is available only in the GET response of a started service."
argument_list|)
annotation|@
name|JsonProperty
argument_list|(
