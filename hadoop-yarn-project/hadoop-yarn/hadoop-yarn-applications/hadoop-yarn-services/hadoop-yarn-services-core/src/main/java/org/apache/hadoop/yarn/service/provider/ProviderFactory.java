...
block|{
return|return
name|createServiceProviderFactory
argument_list|(
name|artifact
argument_list|)
operator|.
...
return|;
block|}
comment|/**    * Create a provider for a specific service    * @param artifact artifact    * @return provider factory    */
DECL|method|createServiceProviderFactory ( Artifact artifact)
specifier|public
specifier|static
specifier|synchronized
name|ProviderFactory
...
operator|+
literal|"%s should not be passed to createServiceProviderFactory"
argument_list|,
name|artifact
operator|.
name|getType
