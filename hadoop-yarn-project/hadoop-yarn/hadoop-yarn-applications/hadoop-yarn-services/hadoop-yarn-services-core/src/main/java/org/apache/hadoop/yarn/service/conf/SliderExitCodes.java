...
literal|68
decl_stmt|;
comment|/**    * the service instance is unknown: {@value}    */
...
literal|69
decl_stmt|;
comment|/**    * the service instance is in the wrong state for that operation: {@value}    */
...
literal|72
decl_stmt|;
comment|/**    * The service is live -and the requested operation    * does not work if the cluster is running    */
...
literal|73
decl_stmt|;
comment|/**    * There already is an service instance of that name    * when an attempt is made to create a new instance    */
