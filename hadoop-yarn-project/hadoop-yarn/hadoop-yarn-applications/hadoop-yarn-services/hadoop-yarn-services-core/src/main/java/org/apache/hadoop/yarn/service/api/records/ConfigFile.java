...
expr_stmt|;
block|}
comment|/**    * Visibility of the Config file.    **/
DECL|method|visibility (LocalResourceVisibility localrsrcVisibility)
specifier|public
name|ConfigFile
name|visibility
parameter_list|(
name|LocalResourceVisibility
name|localrsrcVisibility
parameter_list|)
block|{
name|this
operator|.
...
name|value
operator|=
literal|"Visibility of the Config file"
argument_list|)
annotation|@
name|JsonProperty
argument_list|(
...
literal|"APPLICATION"
argument_list|)
DECL|method|setVisibility (LocalResourceVisibility localrsrcVisibility)
specifier|public
name|void
name|setVisibility
parameter_list|(
