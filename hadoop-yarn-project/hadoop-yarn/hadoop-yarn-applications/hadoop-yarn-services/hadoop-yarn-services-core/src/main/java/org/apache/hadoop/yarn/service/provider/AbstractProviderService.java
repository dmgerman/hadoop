...
name|IOException
function_decl|;
DECL|method|buildContainerTokens (ComponentInstance instance, Container container, ContainerLaunchService.ComponentLaunchContext compLaunchContext)
specifier|public
name|Map
argument_list|<
name|String
...
return|;
block|}
DECL|method|buildContainerEnvironment (AbstractLauncher launcher, Service service, ComponentInstance instance, SliderFileSystem fileSystem, Configuration yarnConf, Container container, ContainerLaunchService.ComponentLaunchContext compLaunchContext, Map<String, String> tokensForSubstitution)
specifier|public
name|void
name|buildContainerEnvironment
parameter_list|(
name|AbstractLauncher
name|launcher
parameter_list|,
...
argument_list|)
decl_stmt|;
comment|// Setup launch context environment
name|buildContainerEnvironment
argument_list|(
name|launcher
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Setup container retry settings
name|buildContainerRetry
argument_list|(
name|launcher
argument_list|,
