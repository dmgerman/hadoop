...
name|systemClock
decl_stmt|;
comment|// For unit test override since we don't want to terminate UT process.
specifier|private
name|ServiceUtils
operator|.
name|ProcessTerminationHandler
DECL|field|terminationHandler
...
return|;
block|}
DECL|method|setGracefulStop (FinalApplicationStatus applicationStatus)
specifier|public
name|void
...
name|info
argument_list|(
literal|"{} Component instance state changed from {} to {}"
argument_list|,
name|instance
operator|.
name|getValue
...
name|info
argument_list|(
literal|"Service state changed to {}"
argument_list|,
name|finalApplicationStatus
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|terminateServiceIfNeeded (Component component)
specifier|public
name|boolean
...
block|{
name|boolean
name|serviceIsTerminated
init|=
name|terminateServiceIfDominantComponentFinished
argument_list|(
name|component
argument_list|)
operator|||
...
return|;
block|}
comment|/**    * If the service state component is finished, the service is also terminated.    * @param component    */
DECL|method|terminateServiceIfDominantComponentFinished (Component component)
specifier|private
name|boolean
name|terminateServiceIfDominantComponentFinished
parameter_list|(
...
name|info
argument_list|(
literal|"{} Component state changed from {} to {}"
argument_list|,
name|component
operator|.
name|getName
...
name|info
argument_list|(
literal|"Dominate component {} finished, exiting Service Master... "
operator|+
...
return|;
block|}
comment|/*    * Check if all components of the scheduler finished.    * If all components finished    * (which #failed-instances + #suceeded-instances = #total-n-containers)    * The service will be terminated.   */
DECL|method|terminateServiceIfAllComponentsFinished ()
specifier|private
name|boolean
name|terminateServiceIfAllComponentsFinished
parameter_list|()
...
literal|true
decl_stmt|;
comment|// Succeeded comps and failed comps, for logging purposes.
name|Set
argument_list|<
name|String
argument_list|>
...
name|info
argument_list|(
literal|"All component finished, exiting Service Master... "
operator|+
literal|", final status="
operator|+
operator|(
...
return|;
block|}
DECL|method|terminateService (boolean isSucceeded)
specifier|private
name|void
name|terminateService
parameter_list|(
...
return|;
block|}
DECL|method|isTimelineServiceEnabled ()
specifier|public
name|boolean
name|isTimelineServiceEnabled
parameter_list|()
...
return|;
block|}
DECL|method|getTerminationHandler ()
specifier|public
name|ServiceUtils
operator|.
name|ProcessTerminationHandler
...
return|;
block|}
DECL|method|syncSysFs (Service yarnApp)
specifier|public
name|void
name|syncSysFs
parameter_list|(
...
name|get
argument_list|(
literal|"yarn.nodemanager.webapp.address"
argument_list|)
operator|.
name|split
argument_list|(
...
name|warn
argument_list|(
literal|"Error synchronize YARN sysfs: "
operator|+
name|response
operator|.
name|getEntity
...
name|info
argument_list|(
literal|"YARN sysfs synchronized."
argument_list|)
expr_stmt|;
block|}
block|}
...
name|error
argument_list|(
literal|"Fail to sync service spec: {}"
argument_list|,
name|e
argument_list|)
expr_stmt|;
