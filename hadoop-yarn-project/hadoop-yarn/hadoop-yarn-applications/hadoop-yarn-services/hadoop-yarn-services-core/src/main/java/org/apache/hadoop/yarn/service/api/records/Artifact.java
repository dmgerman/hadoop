...
begin_comment
comment|/**  * Artifact of an service component.  **/
end_comment
...
literal|null
decl_stmt|;
comment|/**    * Artifact Type.  DOCKER, TARBALL or SERVICE    **/
annotation|@
name|XmlType
argument_list|(
name|name
...
literal|null
decl_stmt|;
comment|/**    * Artifact id. Examples are package location uri for tarball based services,    * image name for docker, etc.    **/
...
name|value
operator|=
literal|"Artifact id. Examples are package location uri for tarball based services, image name for docker, etc."
argument_list|)
annotation|@
name|JsonProperty
argument_list|(
