...
begin_enum
DECL|enum|ServiceTimelineEvent
specifier|public
enum|enum
...
block|,
DECL|enumConstant|COMPONENT_INSTANCE_IP_HOST_UPDATE
name|COMPONENT_INSTANCE_IP_HOST_UPDATE
block|,
DECL|enumConstant|COMPONENT_INSTANCE_BECOME_READY
name|COMPONENT_INSTANCE_BECOME_READY
block|,
DECL|enumConstant|COMPONENT_FINISHED
