...
name|JsonProperty
argument_list|(
literal|"decommissioned_instances"
argument_list|)
annotation|@
name|XmlElement
argument_list|(
...
literal|"decommissioned_instances"
argument_list|)
DECL|field|decommissionedInstances
specifier|private
name|List
argument_list|<
name|String
argument_list|>
name|decommissionedInstances
init|=
operator|new
name|ArrayList
argument_list|<>
...
name|ALWAYS
decl_stmt|;
comment|/**    * Policy of restart component. Including ALWAYS - Long lived components    * (Always restart component instance even if instance exit code&#x3D; 0.);    *    * ON_FAILURE (Only restart component instance if instance exit code !&#x3D;    * 0);    * NEVER (Do not restart in any cases)    *    * @return restartPolicy    **/
annotation|@
name|XmlType
argument_list|(
name|name
...
name|value
decl_stmt|;
DECL|method|RestartPolicyEnum (String value)
name|RestartPolicyEnum
parameter_list|(
name|String
name|value
...
block|}
block|}
DECL|method|restartPolicy (RestartPolicyEnum restartPolicyEnumVal)
specifier|public
name|Component
name|restartPolicy
parameter_list|(
name|RestartPolicyEnum
name|restartPolicyEnumVal
parameter_list|)
block|{
name|this
operator|.
...
return|;
block|}
comment|/**    * Policy of restart component.    *    * Including    * ALWAYS (Always restart component instance even if instance exit    * code&#x3D; 0);    *    * ON_FAILURE (Only restart component instance if instance exit code !&#x3D;    * 0);    *    * NEVER (Do not restart in any cases)    *    * @return restartPolicy    **/
annotation|@
name|ApiModelProperty
argument_list|(
name|value
operator|=
literal|"Policy of restart component. Including ALWAYS "
operator|+
literal|"(Always restart component even if instance exit code = 0); "
operator|+
literal|"ON_FAILURE (Only restart component if instance exit code != 0); "
operator|+
literal|"NEVER (Do not restart in any cases)"
argument_list|)
DECL|method|getRestartPolicy ()
specifier|public
name|RestartPolicyEnum
...
return|;
block|}
DECL|method|setRestartPolicy (RestartPolicyEnum restartPolicy)
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * A list of decommissioned component instances.    **/
DECL|method|decommissionedInstances (List<String> decommissionedInstances)
specifier|public
name|Component
name|decommissionedInstances
parameter_list|(
...
name|value
operator|=
literal|"A list of decommissioned component instances."
argument_list|)
DECL|method|getDecommissionedInstances ()
specifier|public
name|List
argument_list|<
name|String
...
return|;
block|}
DECL|method|setDecommissionedInstances (List<String> decommissionedInstances)
specifier|public
name|void
name|setDecommissionedInstances
parameter_list|(
name|List
argument_list|<
name|String
...
expr_stmt|;
block|}
DECL|method|addDecommissionedInstance (String componentInstanceName)
specifier|public
name|void
...
return|;
block|}
DECL|method|getComponentInstance (String compInstanceName)
specifier|public
name|Container
...
block|}
block|}
DECL|method|overwrite (Component that)
specifier|public
name|void
name|overwrite
parameter_list|(
