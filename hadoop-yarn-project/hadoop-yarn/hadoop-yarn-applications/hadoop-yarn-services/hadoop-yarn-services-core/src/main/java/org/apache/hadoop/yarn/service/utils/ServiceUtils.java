...
return|;
block|}
comment|/**    * Process termination handler - exist with specified exit code after    * waiting a while for ATS state to be in sync.    */
DECL|class|ProcessTerminationHandler
specifier|public
specifier|static
class|class
name|ProcessTerminationHandler
block|{
DECL|method|terminate (int exitCode)
specifier|public
name|void
name|terminate
parameter_list|(
