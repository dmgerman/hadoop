...
block|}
block|}
DECL|method|processUpgradeRequest (String upgradeVersion, boolean autoFinalize)
name|void
...
name|info
argument_list|(
literal|"The component {} has a restart "
operator|+
literal|"policy that doesnt allow upgrades {} "
argument_list|,
name|component
operator|.
name|getName
...
block|{
comment|// nothing to upgrade if upgrade auto finalize is requested, trigger a
comment|// state check.
if|if
condition|(
name|autoFinalize
