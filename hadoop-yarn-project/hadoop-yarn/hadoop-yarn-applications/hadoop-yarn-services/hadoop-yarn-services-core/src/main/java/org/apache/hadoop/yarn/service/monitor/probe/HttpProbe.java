...
name|max
decl_stmt|;
DECL|method|HttpProbe (String url, int timeout, int min, int max, Map<String, String> props)
specifier|public
name|HttpProbe
parameter_list|(
name|String
