...
expr_stmt|;
block|}
DECL|method|loadAppJsonFromLocalFS ( AbstractClusterBuildingActionArgs args)
specifier|private
name|Service
...
return|;
block|}
DECL|method|actionBuild (AbstractClusterBuildingActionArgs args)
specifier|public
name|int
name|actionBuild
parameter_list|(
...
return|;
block|}
DECL|method|actionCreate (ActionCreateArgs args)
specifier|public
name|int
name|actionCreate
parameter_list|(
...
condition|)
block|{
comment|// create an example service
name|args
operator|.
name|file
operator|=
name|findExampleService
argument_list|(
name|args
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|findExampleService (ActionCreateArgs args)
specifier|private
name|File
name|findExampleService
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// First look for the standard location.
name|File
name|file
init|=
operator|new
...
name|format
argument_list|(
literal|"{0}/share/hadoop/yarn/yarn-service-examples/{1}/{2}.json"
argument_list|,
name|yarnHome
argument_list|,
name|args
...
name|format
argument_list|(
literal|"{0}/yarn-service-examples/{1}/{2}.json"
argument_list|,
name|yarnHome
argument_list|,
name|args
...
return|;
block|}
comment|// Called by ServiceCLI
DECL|method|actionFlexByCLI (ClientArgs args)
specifier|protected
name|int
...
return|;
block|}
DECL|method|actionHelp (String actionName, CommonArgs args)
specifier|private
name|int
name|actionHelp
parameter_list|(
