...
argument_list|)
decl_stmt|;
DECL|field|CONTAINER_JSON_SERDE
specifier|public
specifier|static
specifier|final
name|JsonSerDeser
...
index|[]
argument_list|>
DECL|field|COMP_CONTAINERS_JSON_SERDE
...
throw|;
block|}
comment|// If artifact is of type SERVICE (which cannot be filled from global),
comment|// read external service and add its components to this service
if|if
condition|(
name|comp
operator|.
...
block|}
block|}
DECL|method|validateJvmOpts (String jvmOpts)
specifier|public
specifier|static
name|void
...
block|}
block|}
DECL|method|validateKerberosPrincipal ( KerberosPrincipal kerberosPrincipal)
specifier|public
specifier|static
name|void
name|validateKerberosPrincipal
...
return|;
block|}
DECL|method|writeAppDefinition (SliderFileSystem fs, Service service)
specifier|public
specifier|static
name|Path
name|writeAppDefinition
...
return|;
block|}
comment|/**    * Validates that the component instances that are requested to upgrade    * require an upgrade.    */
DECL|method|validateInstancesUpgrade (List<Container> liveContainers)
specifier|public
specifier|static
name|void
...
block|}
block|}
comment|/**    * Returns whether the container can be upgraded in the current state.    */
DECL|method|isUpgradable (Container container)
specifier|public
specifier|static
name|boolean
name|isUpgradable
...
return|;
block|}
comment|/**    * Validates the components that are requested to upgrade require an upgrade.    * It returns the instances of the components which need upgrade.    */
DECL|method|validateAndResolveCompsUpgrade ( Service liveService, Collection<String> compNames)
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
comment|/**    * Validates the components that are requested are stable for upgrade.    * It returns the instances of the components which are in ready state.    */
DECL|method|validateAndResolveCompsStable ( Service liveService, Collection<String> compNames)
specifier|public
specifier|static
name|List
argument_list|<
name|Container
argument_list|>
name|validateAndResolveCompsStable
parameter_list|(
name|Service
name|liveService
parameter_list|,
...
return|;
block|}
DECL|method|getHostnameSuffix (String serviceName, org.apache .hadoop.conf.Configuration conf)
specifier|public
specifier|static
name|String
...
return|;
block|}
DECL|method|parseAndValidateComponentInstanceName (String instanceOrHostname, String serviceName, org.apache.hadoop.conf .Configuration conf)
specifier|public
specifier|static
name|String
...
return|;
block|}
DECL|method|resolveCompsDependency (Service service)
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
DECL|method|serviceDependencySatisfied (Service service)
specifier|private
specifier|static
name|boolean
name|serviceDependencySatisfied
parameter_list|(
name|Service
name|service
parameter_list|)
...
name|info
argument_list|(
literal|"Service dependency is not satisfied for "
operator|+
...
name|info
argument_list|(
literal|"Service dependency is not satisified."
argument_list|)
expr_stmt|;
name|result
operator|=
...
return|;
block|}
DECL|method|checkServiceDependencySatisified (Service service)
specifier|public
specifier|static
name|void
...
name|info
argument_list|(
literal|"Waiting for service dependencies."
argument_list|)
expr_stmt|;
name|Thread
operator|.
