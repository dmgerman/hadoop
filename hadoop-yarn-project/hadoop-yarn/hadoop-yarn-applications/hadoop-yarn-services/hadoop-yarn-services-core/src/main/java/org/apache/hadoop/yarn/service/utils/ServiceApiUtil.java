...
argument_list|)
expr_stmt|;
comment|// If the service has no components do top-level checks
if|if
condition|(
operator|!
name|hasComponent
...
condition|)
block|{
comment|// If artifact is of type SERVICE, read other service components
if|if
condition|(
name|service
operator|.
...
block|{
comment|// Since it is a simple service with no components, create a default
comment|// component
name|Component
name|comp
init|=
...
return|;
block|}
DECL|method|createDefaultComponent (Service service)
specifier|public
specifier|static
name|Component
name|createDefaultComponent
