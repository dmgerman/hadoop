...
annotation|@
name|Test
DECL|method|testInternalServerErrorDockerClientConfigMissingCreateService ()
specifier|public
name|void
name|testInternalServerErrorDockerClientConfigMissingCreateService
parameter_list|()
block|{
name|Service
name|service
...
argument_list|(
literal|"/does/not/exist/config.json"
argument_list|)
expr_stmt|;
name|Artifact
name|artifact
...
name|assertEquals
argument_list|(
literal|"Response code don't match"
argument_list|,
name|RestApiConstants
operator|.
...
name|assertEquals
argument_list|(
literal|"Response diagnostics don't match"
argument_list|,
literal|"Service "
operator|+
name|serviceName
...
annotation|@
name|Test
DECL|method|testBadDeleteService3 ()
specifier|public
name|void
name|testBadDeleteService3
parameter_list|()
block|{
specifier|final
name|Response
...
annotation|@
name|Test
DECL|method|testBadDeleteService4 ()
specifier|public
name|void
name|testBadDeleteService4
parameter_list|()
block|{
specifier|final
name|Response
...
annotation|@
name|Test
DECL|method|testDeleteStoppedService ()
specifier|public
name|void
name|testDeleteStoppedService
parameter_list|()
block|{
specifier|final
name|Response
...
annotation|@
name|Test
DECL|method|testBadSecondStopServices ()
specifier|public
name|void
name|testBadSecondStopServices
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// simulates stop on an already stopped service
name|System
operator|.
name|out
operator|.
...
name|assertEquals
argument_list|(
literal|"stop service should have thrown 400 Bad Request: "
argument_list|,
name|Response
operator|.
name|status
...
name|assertEquals
argument_list|(
literal|"Stop service should have failed with service already stopped"
argument_list|,
literal|"Service jenkins-second-stop is already stopped"
argument_list|,
name|serviceStatus
operator|.
name|getDiagnostics
...
annotation|@
name|Test
DECL|method|testInitiateUpgrade ()
specifier|public
name|void
name|testInitiateUpgrade
parameter_list|()
block|{
name|Service
name|goodService
...
annotation|@
name|Test
DECL|method|testUpgradeSingleInstance ()
specifier|public
name|void
name|testUpgradeSingleInstance
parameter_list|()
block|{
name|Service
name|goodService
...
argument_list|)
expr_stmt|;
comment|// To be able to upgrade, the service needs to be in UPGRADING
comment|// and container state needs to be in NEEDS_UPGRADE.
name|Service
name|serviceStatus
init|=
name|mockServerClient
...
annotation|@
name|Test
DECL|method|testUpgradeMultipleInstances ()
specifier|public
name|void
name|testUpgradeMultipleInstances
parameter_list|()
block|{
name|Service
name|goodService
...
annotation|@
name|Test
DECL|method|testUpgradeComponent ()
specifier|public
name|void
name|testUpgradeComponent
parameter_list|()
block|{
name|Service
name|goodService
...
expr_stmt|;
comment|// To be able to upgrade, the service needs to be in UPGRADING
comment|// and component state needs to be in NEEDS_UPGRADE.
name|Service
name|serviceStatus
init|=
name|mockServerClient
...
annotation|@
name|Test
DECL|method|testUpgradeMultipleComps ()
specifier|public
name|void
name|testUpgradeMultipleComps
parameter_list|()
block|{
name|Service
name|goodService
...
argument_list|)
expr_stmt|;
comment|// To be able to upgrade, the live service needs to be in UPGRADING
comment|// and component states needs to be in NEEDS_UPGRADE.
name|Service
name|serviceStatus
init|=
name|mockServerClient
