...
block|}
argument_list|)
DECL|method|updateComponents (@ontext HttpServletRequest request, @PathParam(SERVICE_NAME) String serviceName, List<Component> requestComponents)
specifier|public
name|Response
...
name|YarnException
argument_list|(
literal|"No components provided."
argument_list|)
throw|;
block|}
name|UserGroupInformation
...
name|info
argument_list|(
literal|"PUT: upgrade components {} for service {} "
operator|+
literal|"user = {}"
argument_list|,
name|compNamesToUpgrade
...
name|info
argument_list|(
literal|"PUT: upgrade component {} for service {} "
operator|+
literal|"user = {}"
argument_list|,
name|component
...
return|;
block|}
comment|// If CANCEL_UPGRADING is requested
if|if
condition|(
name|updateServiceData
operator|.
...
block|}
argument_list|)
DECL|method|getComponentInstances (@ontext HttpServletRequest request, @PathParam(SERVICE_NAME) String serviceName, @QueryParam(PARAM_COMP_NAME) List<String> componentNames, @QueryParam(PARAM_VERSION) String version, @QueryParam(PARAM_CONTAINER_STATE) List<String> containerStates)
specifier|public
name|Response
...
name|info
argument_list|(
literal|"GET: component instances for service = {}, compNames in {}, "
operator|+
literal|"version = {}, containerStates in {}, user = {}"
argument_list|,
name|serviceName
argument_list|,
name|Objects
...
name|BAD_REQUEST
argument_list|,
literal|"valid container states are: "
operator|+
name|Arrays
operator|.
name|toString
...
name|appName
operator|+
literal|" is successfully started with ApplicationId: "
operator|+
name|appId
argument_list|)
expr_stmt|;
...
begin_function
unit|}    private
DECL|method|cancelUpgradeService (String serviceName, final UserGroupInformation ugi)
name|Response
name|cancelUpgradeService
parameter_list|(
name|String
...
name|info
argument_list|(
literal|"Service {} cancelling upgrade"
argument_list|,
name|serviceName
argument_list|)
expr_stmt|;
...
begin_function
DECL|method|processComponentsUpgrade (UserGroupInformation ugi, String serviceName, Set<String> compNames)
specifier|private
name|Response
name|processComponentsUpgrade
parameter_list|(
...
begin_function
DECL|method|processContainersUpgrade (UserGroupInformation ugi, Service service, List<Container> containers)
specifier|private
name|Response
name|processContainersUpgrade
parameter_list|(
...
begin_function
DECL|method|invokeContainersUpgrade (UserGroupInformation ugi, Service service, List<Container> containers)
specifier|private
name|int
name|invokeContainersUpgrade
parameter_list|(
...
begin_function
unit|}    private
DECL|method|decommissionInstances (Service service, UserGroupInformation ugi)
name|Response
name|decommissionInstances
parameter_list|(
name|Service
...
name|appName
operator|+
literal|" has successfully "
operator|+
literal|"decommissioned instances."
decl_stmt|;
name|LOG
operator|.
name|info
