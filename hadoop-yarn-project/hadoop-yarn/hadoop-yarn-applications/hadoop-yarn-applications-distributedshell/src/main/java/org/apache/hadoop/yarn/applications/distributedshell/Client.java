...
block|}
block|}
DECL|method|setAMResourceCapability (ApplicationSubmissionContext appContext, long memory, int vcores, String profile, int priority, Map<String, Resource> profiles)
specifier|private
name|void
name|setAMResourceCapability
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setContainerResources (long memory, int vcores, Map<String, Resource> profiles)
specifier|private
name|void
name|setContainerResources
parameter_list|(
