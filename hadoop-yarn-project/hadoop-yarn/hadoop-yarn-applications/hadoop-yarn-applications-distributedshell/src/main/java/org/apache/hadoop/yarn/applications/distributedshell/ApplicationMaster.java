...
literal|""
decl_stmt|;
DECL|field|newTimelineService
specifier|private
name|boolean
name|newTimelineService
init|=
literal|false
decl_stmt|;
comment|// For posting entities in new timeline service in a non-blocking way
comment|// TODO replace with event loop in TimelineClient.
...
condition|)
block|{
comment|// wait for all posting thread to finish
try|try
block|{
if|if
condition|(
...
name|warn
argument_list|(
literal|"Timeline client service stop interrupted!"
argument_list|)
expr_stmt|;
break|break;
block|}
...
condition|)
block|{
name|publishApplicationAttemptEventOnNewTimelineService
argument_list|(
name|timelineClient
argument_list|,
name|appAttemptID
...
condition|)
block|{
name|publishContainerEndEventOnNewTimelineService
argument_list|(
name|timelineClient
argument_list|,
name|containerStatus
...
name|ApplicationMaster
operator|.
name|publishContainerStartEventOnNewTimelineService
argument_list|(
name|applicationMaster
operator|.
name|timelineClient
...
return|;
block|}
DECL|method|publishContainerStartEventOnNewTimelineService ( final TimelineClient timelineClient, final Container container, final String domainId, final UserGroupInformation ugi)
specifier|private
specifier|static
name|void
name|publishContainerStartEventOnNewTimelineService
...
parameter_list|()
block|{
name|publishContainerStartEventOnNewTimelineServiceBase
argument_list|(
name|timelineClient
argument_list|,
name|container
...
expr_stmt|;
block|}
DECL|method|publishContainerStartEventOnNewTimelineServiceBase ( final TimelineClient timelineClient, Container container, String domainId, UserGroupInformation ugi)
specifier|private
specifier|static
name|void
name|publishContainerStartEventOnNewTimelineServiceBase
...
block|}
block|}
DECL|method|publishContainerEndEventOnNewTimelineService ( final TimelineClient timelineClient, final ContainerStatus container, final String domainId, final UserGroupInformation ugi)
specifier|private
specifier|static
name|void
name|publishContainerEndEventOnNewTimelineService
...
parameter_list|()
block|{
name|publishContainerEndEventOnNewTimelineServiceBase
argument_list|(
name|timelineClient
argument_list|,
name|container
...
expr_stmt|;
block|}
DECL|method|publishContainerEndEventOnNewTimelineServiceBase ( final TimelineClient timelineClient, final ContainerStatus container, final String domainId, final UserGroupInformation ugi)
specifier|private
specifier|static
name|void
name|publishContainerEndEventOnNewTimelineServiceBase
...
block|}
block|}
DECL|method|publishApplicationAttemptEventOnNewTimelineService ( final TimelineClient timelineClient, final String appAttemptId, final DSEvent appEvent, final String domainId, final UserGroupInformation ugi)
specifier|private
specifier|static
name|void
name|publishApplicationAttemptEventOnNewTimelineService
...
parameter_list|()
block|{
name|publishApplicationAttemptEventOnNewTimelineServiceBase
argument_list|(
name|timelineClient
argument_list|,
name|appAttemptId
...
expr_stmt|;
block|}
DECL|method|publishApplicationAttemptEventOnNewTimelineServiceBase ( final TimelineClient timelineClient, String appAttemptId, DSEvent appEvent, String domainId, UserGroupInformation ugi)
specifier|private
specifier|static
name|void
name|publishApplicationAttemptEventOnNewTimelineServiceBase
