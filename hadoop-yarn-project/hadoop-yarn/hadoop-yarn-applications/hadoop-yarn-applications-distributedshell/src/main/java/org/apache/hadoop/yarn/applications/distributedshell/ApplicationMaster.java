...
literal|true
argument_list|,
literal|"List of localized files"
argument_list|)
expr_stmt|;
name|opts
operator|.
...
return|;
block|}
DECL|method|parsePlacementSpecs (String decodedSpec, int globalNumOfContainers)
specifier|private
name|void
name|parsePlacementSpecs
parameter_list|(
...
control|)
block|{
comment|// Use global num of containers when the spec doesn't specify
comment|// source tags. This is allowed when using node-attribute constraints.
if|if
condition|(
name|Strings
operator|.
...
block|}
block|}
DECL|method|getDecodedPlacementSpec (String placementSpecifications)
specifier|private
name|String
name|getDecodedPlacementSpec
parameter_list|(
...
name|warn
argument_list|(
literal|"Failed to remove application staging directory"
argument_list|,
name|e
argument_list|)
expr_stmt|;
block|}
block|}
DECL|method|getAppSubmitterHomeDir ()
specifier|private
name|Path
name|getAppSubmitterHomeDir
parameter_list|()
...
name|info
argument_list|(
literal|"placementSpecs to create req:"
operator|+
name|placementSpecs
argument_list|)
expr_stmt|;
...
name|format
argument_list|(
literal|"Application Failure: desired = %d, "
operator|+
literal|"completed = %d, allocated = %d, failed = %d, "
operator|+
literal|"diagnostics = %s"
argument_list|,
name|numRequestedContainers
operator|.
name|get
...
return|;
block|}
DECL|method|getRelativePath (String appName, String appId, String fileDstPath)
specifier|public
specifier|static
name|String
name|getRelativePath
...
name|info
argument_list|(
literal|"The requested number of containers have been allocated."
operator|+
literal|" Releasing the extra container allocation from the RM."
argument_list|)
expr_stmt|;
name|amRMClient
operator|.
...
condition|)
block|{
name|publishContainerStartFailedEventOnTimelineServiceV2
argument_list|(
name|containerId
argument_list|,
name|t
...
condition|)
block|{
name|publishContainerStartFailedEvent
argument_list|(
name|containerId
argument_list|,
name|t
...
expr_stmt|;
block|}
comment|// Set up localization for the container which runs the command
if|if
condition|(
name|localizableFiles
operator|.
...
name|info
argument_list|(
literal|"Setting up file for localization: "
operator|+
name|dst
argument_list|)
expr_stmt|;
...
name|UncheckedIOException
argument_list|(
literal|"Error during localization setup"
argument_list|,
name|e
argument_list|)
throw|;
...
block|}
block|}
DECL|method|publishContainerStartFailedEventOnTimelineServiceV2 ( final ContainerId containerId, String diagnostics)
specifier|private
name|void
name|publishContainerStartFailedEventOnTimelineServiceV2
parameter_list|(
...
name|error
argument_list|(
literal|"Container start failed event could not be published for {}"
argument_list|,
name|containerId
argument_list|,
name|e
...
begin_function
DECL|method|publishContainerStartFailedEvent (final ContainerId containerId, String diagnostics)
specifier|private
name|void
name|publishContainerStartFailedEvent
parameter_list|(
