...
literal|90000
argument_list|)
DECL|method|testDistributedShellWithAllocationTagNamespace ()
specifier|public
name|void
name|testDistributedShellWithAllocationTagNamespace
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
name|NodeId
name|masterContainerNodeIdA
decl_stmt|;
name|NodeId
name|taskContainerNodeIdA
decl_stmt|;
name|ConcurrentMap
argument_list|<
name|ApplicationId
...
name|info
argument_list|(
literal|"Allocation Tag NameSpace Applications are="
operator|+
name|appA
operator|.
...
parameter_list|)
block|{
comment|// Ignore Exception while killing a job
block|}
block|}
