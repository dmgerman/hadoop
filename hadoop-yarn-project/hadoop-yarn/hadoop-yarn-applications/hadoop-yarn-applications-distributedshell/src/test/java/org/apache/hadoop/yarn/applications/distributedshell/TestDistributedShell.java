...
annotation|@
name|Test
DECL|method|testSpecifyingLogAggregationContext ()
specifier|public
name|void
name|testSpecifyingLogAggregationContext
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|2.0f
argument_list|)
DECL|method|testDSShellWithEnforceExecutionType ()
specifier|public
name|void
name|testDSShellWithEnforceExecutionType
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// we should get two containers.
name|Assert
operator|.
name|assertEquals
argument_list|(
...
name|fail
argument_list|(
literal|"Job execution with enforce execution type failed."
argument_list|)
expr_stmt|;
block|}
block|}
DECL|method|waitForContainersLaunch (YarnClient client, int nContainers)
specifier|private
name|void
name|waitForContainersLaunch
parameter_list|(
...
name|class
argument_list|)
DECL|method|testDistributedShellNonExistentQueue ()
specifier|public
name|void
name|testDistributedShellNonExistentQueue
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testDistributedShellWithSingleFileLocalization ()
specifier|public
name|void
name|testDistributedShellWithSingleFileLocalization
parameter_list|()
throws|throws
name|Exception
block|{
...
block|,
literal|"./src/test/resources/a.txt"
block|,
literal|"--shell_args"
block|,
literal|"a.txt"
...
name|assertTrue
argument_list|(
literal|"Client exited with an error"
argument_list|,
name|client
operator|.
name|run
...
annotation|@
name|Test
DECL|method|testDistributedShellWithMultiFileLocalization ()
specifier|public
name|void
name|testDistributedShellWithMultiFileLocalization
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"--localize_files"
block|,
literal|"./src/test/resources/a.txt,./src/test/resources/b.txt"
block|,
literal|"--shell_args"
block|,
literal|"a.txt b.txt"
...
name|class
argument_list|)
DECL|method|testDistributedShellWithNonExistentFileLocalization ()
specifier|public
name|void
name|testDistributedShellWithNonExistentFileLocalization
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"--localize_files"
block|,
literal|"/non/existing/path/file.txt"
block|,
literal|"--shell_args"
block|,
literal|"file.txt"
...
annotation|@
name|Test
DECL|method|testDistributedShellCleanup ()
specifier|public
name|void
name|testDistributedShellCleanup
parameter_list|()
throws|throws
name|Exception
block|{
...
name|appName
init|=
literal|"DistributedShellCleanup"
decl_stmt|;
name|String
index|[]
name|args
...
name|assertFalse
argument_list|(
literal|"Distributed Shell Cleanup failed"
argument_list|,
name|fs1
operator|.
name|exists
