...
block|}
block|}
DECL|method|checkTimelineV2 (boolean haveDomain, ApplicationId appId)
specifier|private
name|void
name|checkTimelineV2
parameter_list|(
...
parameter_list|)
block|{
comment|// For PoC check in /tmp/ YARN-3264
name|String
name|tmpRoot
init|=
name|FileSystemTimelineWriterImpl
...
expr_stmt|;
block|}
DECL|method|deleteAppFiles (File rootDir, String appTimeStamp)
specifier|private
name|void
name|deleteAppFiles
parameter_list|(
...
control|)
block|{
comment|// list all attempts for this app and delete them
if|if
condition|(
name|f1
operator|.
