...
block|}
block|}
comment|// Test applications defining external components(APPLICATION type)
...
argument_list|)
expr_stmt|;
comment|// external1 has 3 components: simple(APPLICATION - app1), master and other
name|buildAndCheckComponents
argument_list|(
literal|"external-1"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// external2 has 2 components: ext(APPLICATION - external1), another
name|buildAndCheckComponents
argument_list|(
literal|"external-2"
argument_list|,
