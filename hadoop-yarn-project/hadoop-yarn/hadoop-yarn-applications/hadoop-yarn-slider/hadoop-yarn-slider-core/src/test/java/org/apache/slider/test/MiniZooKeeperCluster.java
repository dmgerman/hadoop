...
begin_package
DECL|package|org.apache.slider.test
package|package
name|org
operator|.
name|apache
...
begin_comment
comment|/**  * This is a version of the HBase ZK cluster cut out to be standalone  */
end_comment

begin_class
DECL|class|MiniZooKeeperCluster
specifier|public
class|class
...
literal|30000
decl_stmt|;
DECL|field|MAX_CLIENT_CONNECTIONS
specifier|public
specifier|static
specifier|final
name|int
...
name|clientPort
decl_stmt|;
DECL|field|standaloneServerFactoryList
specifier|private
name|List
argument_list|<
name|NIOServerCnxnFactory
...
name|clientPortList
decl_stmt|;
DECL|field|activeZKServerIndex
specifier|private
name|int
...
name|configuration
decl_stmt|;
DECL|method|MiniZooKeeperCluster ()
specifier|public
name|MiniZooKeeperCluster
parameter_list|()
block|{
...
expr_stmt|;
block|}
DECL|method|MiniZooKeeperCluster (Configuration configuration)
specifier|public
name|MiniZooKeeperCluster
parameter_list|(
name|Configuration
...
expr_stmt|;
block|}
DECL|method|setDefaultClientPort (int clientPort)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|getBackupZooKeeperServerNum ()
specifier|public
name|int
...
return|;
block|}
DECL|method|getZooKeeperServerNum ()
specifier|public
name|int
...
expr_stmt|;
block|}
DECL|method|startup (File baseDir)
specifier|public
name|int
name|startup
parameter_list|(
...
DECL|method|startup (File baseDir, int numZooKeeperServers)
specifier|public
name|int
name|startup
parameter_list|(
...
return|;
block|}
DECL|method|recreateDir (File dir)
specifier|private
name|void
name|recreateDir
parameter_list|(
...
DECL|method|killCurrentActiveZooKeeperServer ()
specifier|public
name|int
...
DECL|method|killOneBackupZooKeeperServer ()
specifier|public
name|void
...
block|}
comment|// XXX: From o.a.zk.t.ClientBase
DECL|method|waitForServerDown (int port, long timeout)
specifier|private
specifier|static
name|boolean
name|waitForServerDown
...
block|}
comment|// XXX: From o.a.zk.t.ClientBase
DECL|method|waitForServerUp (int port, long timeout)
specifier|private
specifier|static
name|boolean
name|waitForServerUp
