...
return|;
block|}
DECL|method|getImageCommands ()
specifier|public
name|List
argument_list|<
name|String
argument_list|>
name|getImageCommands
parameter_list|()
block|{
if|if
condition|(
...
condition|)
block|{
comment|// its an image that had better be defined
name|assertNotNull
argument_list|(
name|getArchivePath
argument_list|()
...
condition|)
block|{
comment|// its not remote, so assert it exists
name|File
name|f
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// if it is remote, then its whatever the archivePath property refers to
return|return
name|Arrays
operator|.
name|asList
