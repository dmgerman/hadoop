...
literal|null
decl_stmt|;
DECL|method|MetainfoHolder (Metainfo metaInfo, Map<String, DefaultConfig> defaultConfigs)
specifier|public
name|MetainfoHolder
parameter_list|(
name|Metainfo
...
condition|)
block|{
comment|// component member is validated elsewhere, so we don't need to throw
comment|// an exception here
continue|continue;
block|}
name|MapOperations
...
DECL|method|buildMetainfo (AggregateConf instanceDefinition, SliderFileSystem fileSystem, String roleGroup)
specifier|private
name|void
name|buildMetainfo
parameter_list|(
...
name|info
argument_list|(
literal|"Modifying external metainfo component name to {}"
argument_list|,
name|comp
operator|.
name|getName
...
name|info
argument_list|(
literal|"Adding prefix {} to command order {}"
argument_list|,
name|mapKey
argument_list|,
name|co
...
name|debug
argument_list|(
literal|"Merging command orders {} for {}"
argument_list|,
name|commandOrders
argument_list|,
name|roleGroup
...
annotation|@
name|VisibleForTesting
DECL|method|localizeConfigFile (ContainerLauncher launcher, String roleName, String roleGroup, ConfigFile configFile, Map<String, Map<String, String>> configs, MapOperations env, SliderFileSystem fileSystem)
specifier|protected
name|void
name|localizeConfigFile
parameter_list|(
...
annotation|@
name|VisibleForTesting
DECL|method|getMetaInfo (String roleGroup)
specifier|protected
name|Metainfo
name|getMetaInfo
parameter_list|(
...
return|;
block|}
DECL|method|getDefaultConfigs (String roleGroup)
specifier|protected
name|Map
argument_list|<
name|String
...
DECL|method|canAnyMasterPublishConfig (String roleGroup)
specifier|protected
name|boolean
name|canAnyMasterPublishConfig
parameter_list|(
...
block|}
block|}
DECL|method|getPackageList (String roleGroup)
specifier|private
name|String
name|getPackageList
parameter_list|(
...
return|;
block|}
DECL|method|buildCommandConfigurations ( ConfTreeOperations appConf, ConfTreeOperations internalsConf, String containerId, String roleName, String roleGroup)
specifier|private
name|Map
argument_list|<
name|String
...
return|;
block|}
DECL|method|addNamedConfiguration (String configName, Map<String, String> sourceConfig, Map<String, Map<String, String>> configurations, Map<String, String> tokens, String containerId, String roleName, String roleGroup)
specifier|private
name|void
name|addNamedConfiguration
parameter_list|(
