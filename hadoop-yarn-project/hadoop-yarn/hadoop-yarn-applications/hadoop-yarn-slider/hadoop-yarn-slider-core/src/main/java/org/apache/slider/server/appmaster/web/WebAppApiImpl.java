...
name|contentCache
decl_stmt|;
DECL|method|WebAppApiImpl (StateAccessForProviders appState, ProviderService provider, CertificateManager certificateManager, RegistryOperations registryOperations, MetricsAndMonitoring metricsAndMonitoring, QueueAccess queues, AppMasterActionOperations appMasterOperations, ContentCache contentCache)
specifier|public
name|WebAppApiImpl
parameter_list|(
name|StateAccessForProviders
