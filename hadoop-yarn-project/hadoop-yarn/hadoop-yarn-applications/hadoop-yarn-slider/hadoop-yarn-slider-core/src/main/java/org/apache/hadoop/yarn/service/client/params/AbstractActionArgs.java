...
parameter_list|()
block|{   }
comment|/**    * URI/binding to the filesystem    */
annotation|@
name|Parameter
argument_list|(
name|names
...
name|description
operator|=
literal|"Filesystem Binding"
argument_list|)
DECL|field|filesystemBinding
specifier|public
name|String
...
name|description
operator|=
literal|"Binding (usually hostname:port) of the YARN resource manager"
argument_list|)
DECL|field|manager
specifier|public
name|String
