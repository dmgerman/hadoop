...
begin_comment
comment|/**  * Interface for accessing services that contain one or more child  * services.   */
end_comment

begin_interface
DECL|interface|ServiceParent
specifier|public
interface|interface
name|ServiceParent
extends|extends
name|Service
block|{
comment|/**    * Add a child service. It must be in a consistent state with the    * service to which it is being added.    * @param service the service to add.    */
