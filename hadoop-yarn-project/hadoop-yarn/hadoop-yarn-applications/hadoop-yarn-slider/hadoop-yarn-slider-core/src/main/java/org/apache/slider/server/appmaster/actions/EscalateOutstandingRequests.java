...
begin_comment
comment|/**  * Escalate outstanding requests by asking AM  */
end_comment

begin_class
DECL|class|EscalateOutstandingRequests
specifier|public
class|class
...
name|super
argument_list|(
literal|"EscalateOutstandingRequests"
argument_list|)
expr_stmt|;
block|}
DECL|method|EscalateOutstandingRequests (long delay, TimeUnit timeUnit)
specifier|public
name|EscalateOutstandingRequests
parameter_list|(
name|long
