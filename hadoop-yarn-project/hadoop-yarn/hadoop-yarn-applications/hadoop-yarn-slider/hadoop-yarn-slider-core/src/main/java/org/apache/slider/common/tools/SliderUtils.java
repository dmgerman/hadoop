...
block|}
block|}
comment|/**    * Given a source folder create a tar.gz file    *     * @param srcFolder    * @param tarGzipFile    *     * @throws IOException    */
DECL|method|tarGzipFolder (File srcFolder, File tarGzipFile, FilenameFilter filter)
specifier|public
specifier|static
name|void
name|tarGzipFolder
...
name|info
argument_list|(
literal|"Tar-gzipping folder {} to {}"
argument_list|,
name|srcFolder
operator|.
name|getAbsolutePath
