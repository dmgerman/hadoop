...
return|;
block|}
comment|/**    * Extract the first line of a multi-line string. This is typically used to    * prune the stack trace appended to the end of exception messages returned by    * YARN in AMRMClientAsync callbacks.    *    * @param msg    *          message string (most likely multi-lines)    * @return the first line of a multi-line string or the original string if it    *         is a null, empty or single-line    */
DECL|method|extractFirstLine (String msg)
specifier|public
specifier|static
name|String
...
DECL|method|buildEnvMap ( org.apache.slider.api.resource.Configuration conf, Map<String,String> tokenMap)
specifier|public
specifier|static
name|Map
argument_list|<
...
literal|".seconds"
decl_stmt|;
comment|/**    * Get the time range of a set of keys.    * @param conf configuration to read properties from    * @param basekey base key to which suffix gets applied    * @param defDays    * @param defHours    * @param defMins    * @param defSecs    * @return the aggregate time range in seconds    */
DECL|method|getTimeRange (org.apache.slider.api.resource .Configuration conf, String basekey, long defDays, long defHours, long defMins, long defSecs)
specifier|public
specifier|static
name|long
name|getTimeRange
...
return|;
block|}
DECL|method|resolve (Application application)
specifier|public
specifier|static
name|void
name|resolve
...
expr_stmt|;
block|}
comment|// TODO merge other information to components
block|}
block|}
end_class
