...
argument_list|()
operator|+
literal|": Container completed. Requested a new container."
operator|+
name|System
operator|.
name|lineSeparator
argument_list|()
operator|+
literal|" exitStatus={}, diagnostics={}."
argument_list|,
name|event
operator|.
name|getStatus
...
name|format
argument_list|(
literal|"[COMPONENT {0}]: Failed {1} times, exceeded the limit - {2}. Shutting down now... "
operator|+
name|System
operator|.
name|lineSeparator
...
comment|// in case there's a client polling the comp state, it can be notified.
try|try
block|{
name|Thread
operator|.
...
block|}
block|}
comment|// Release the container , cleanup registry, hdfs dir, and record in ATS
DECL|method|destroy ()
specifier|public
name|void
name|destroy
...
DECL|method|cleanupRegistryAndCompHdfsDir ()
specifier|public
name|void
name|cleanupRegistryAndCompHdfsDir
parameter_list|()
