...
return|;
block|}
comment|/**    * List Slider<i>deployed</i>instances belonging to a specific user in a    * given set of states.    *<p>    * Deployed means: known about in the YARN cluster; it will include all apps    * in the specified set of states.    *    * @param user    *          user: "" means all users    * @param appStates    *          filter by a set of YarnApplicationState    * @return a possibly empty list of Slider AMs    * @throws YarnException    * @throws IOException    */
DECL|method|listDeployedInstances (String user, EnumSet<YarnApplicationState> appStates)
specifier|public
name|List
argument_list|<
name|ApplicationReport
