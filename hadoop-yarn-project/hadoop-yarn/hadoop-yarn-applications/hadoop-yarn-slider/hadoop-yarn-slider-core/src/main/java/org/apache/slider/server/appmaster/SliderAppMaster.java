...
condition|)
block|{
name|uploadServerCertForLocalization
argument_list|(
name|clustername
argument_list|,
name|fs
...
argument_list|)
expr_stmt|;
comment|// start the agent web app
name|startAgentWebApp
argument_list|(
name|appInformation
argument_list|,
name|serviceConf
...
return|;
block|}
DECL|method|uploadServerCertForLocalization (String clustername, SliderFileSystem fs)
specifier|private
name|void
name|uploadServerCertForLocalization
parameter_list|(
...
name|info
argument_list|(
literal|"Uploaded server cert to localization path {}"
argument_list|,
name|destPath
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * Set up and start the agent web application     * @param appInformation application information    * @param serviceConf service configuration    * @param webAppApi web app API instance to bind to    * @throws IOException    */
DECL|method|startAgentWebApp (MapOperations appInformation, Configuration serviceConf, WebAppApiImpl webAppApi)
specifier|private
name|void
name|startAgentWebApp
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Start up the agent web app and track the URL for it
name|MapOperations
...
name|info
argument_list|(
literal|"Setting stopInitiated flag to true"
argument_list|)
expr_stmt|;
name|AgentProviderService
name|agentProviderService
