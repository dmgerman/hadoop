...
literal|"application"
decl_stmt|;
DECL|field|HOST_KEY_FORMAT
specifier|private
specifier|static
specifier|final
name|String
name|HOST_KEY_FORMAT
init|=
literal|"${%s_HOST}"
decl_stmt|;
DECL|field|IP_KEY_FORMAT
specifier|private
specifier|static
specifier|final
name|String
...
literal|"${%s_IP}"
decl_stmt|;
DECL|field|VARIABLE_INDICATOR
specifier|private
specifier|static
specifier|final
name|String
name|VARIABLE_INDICATOR
init|=
literal|"${"
decl_stmt|;
...
DECL|method|publishExportGroups (String containerId, String roleName, String roleGroup, String thisHost, List<String> ips)
specifier|protected
name|void
name|publishExportGroups
parameter_list|(
...
block|{
comment|// should not happen, but log if it does
name|log
operator|.
name|info
argument_list|(
literal|"Not replacing HOST or IP tokens because key was null for {}"
argument_list|,
name|roleName
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// not all variables have been substituted, so do not export
continue|continue;
block|}
name|ExportEntry
name|entry
...
name|info
argument_list|(
literal|"Preparing to publish for {}. Key {} and Value {}"
argument_list|,
name|roleName
argument_list|,
name|export
...
block|}
block|}
DECL|method|substituteIP (String roleNameIPKey, String roleGroupIPKey, String ip, String value)
specifier|protected
name|String
name|substituteIP
parameter_list|(
...
return|;
block|}
DECL|method|getExportEntries (String key)
specifier|protected
name|Set
argument_list|<
name|ExportEntry
