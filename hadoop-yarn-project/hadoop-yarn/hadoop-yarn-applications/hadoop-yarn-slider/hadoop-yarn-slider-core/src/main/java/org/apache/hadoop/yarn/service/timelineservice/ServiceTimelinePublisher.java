...
expr_stmt|;
block|}
DECL|method|serviceAttemptRegistered (Application application, org.apache.hadoop.conf.Configuration systemConf)
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|// publish user conf
name|publishUserConf
argument_list|(
name|application
operator|.
...
expr_stmt|;
block|}
DECL|method|serviceAttemptUnregistered (ServiceContext context, String diagnostics)
specifier|public
name|void
...
block|}
block|}
DECL|method|publishUserConf (Configuration configuration, String entityId, String entityType)
specifier|private
name|void
name|publishUserConf
parameter_list|(
