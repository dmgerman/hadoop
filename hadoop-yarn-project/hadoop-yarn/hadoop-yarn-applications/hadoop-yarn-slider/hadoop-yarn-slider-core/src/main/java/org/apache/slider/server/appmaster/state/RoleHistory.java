...
expr_stmt|;
block|}
comment|/**    * Register all metrics with the metrics infra    * @param metrics metrics    */
DECL|method|register (MetricsAndMonitoring metrics)
specifier|public
name|void
name|register
parameter_list|(
