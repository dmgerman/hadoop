...
block|}
block|}
comment|/**    * Extract the value for option    * {@code yarn.resourcemanager.am.retry-count-window-ms}    * and set it on the ApplicationSubmissionContext. Use the default value    * if option is not set.    *    * @param submissionContext    * @param map    */
DECL|method|extractAmRetryCount (ApplicationSubmissionContext submissionContext, Map<String, String> map)
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Important: the configuration must already be fully resolved     * in order to pick up global options    * Copy env vars into the launch context.    */
DECL|method|copyEnvVars (MapOperations options)
specifier|public
name|boolean
name|copyEnvVars
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Return the label expression and if not set null    * @param map map to look up    * @return extracted label or null    */
DECL|method|extractLabelExpression (Map<String, String> map)
specifier|public
name|String
