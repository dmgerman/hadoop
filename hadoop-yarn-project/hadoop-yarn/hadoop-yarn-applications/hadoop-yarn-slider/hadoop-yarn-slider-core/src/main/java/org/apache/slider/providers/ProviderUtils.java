...
block|}
block|}
DECL|method|addEnvForSubstitution (Map<String, String> env, Map<String, String> tokensForSubstitution)
specifier|public
specifier|static
name|void
name|addEnvForSubstitution
parameter_list|(
name|Map
argument_list|<
name|String
...
name|info
argument_list|(
literal|"Creating component instance dir: "
operator|+
name|compInstanceDir
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// add Configuration#env into tokens substitution
name|addEnvForSubstitution
argument_list|(
name|component
operator|.
...
name|info
argument_list|(
literal|"Tokens substitution for component: "
operator|+
name|roleInstance
operator|.
name|getCompInstanceName
...
block|}
block|}
DECL|method|resolveNonTemplateConfigsAndSaveOnHdfs (SliderFileSystem fs, Map<String, String> tokensForSubstitution, RoleInstance roleInstance, ConfigFile configFile, String fileName, Path remoteFile)
specifier|private
name|void
name|resolveNonTemplateConfigsAndSaveOnHdfs
parameter_list|(
