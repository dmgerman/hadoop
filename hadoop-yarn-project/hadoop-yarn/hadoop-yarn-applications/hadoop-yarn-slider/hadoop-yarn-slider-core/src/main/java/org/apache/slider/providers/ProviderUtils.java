...
return|;
block|}
comment|/**    * Return a list of hostnames based on current ClusterNodes.    * @param values cluster nodes    * @return list of hosts    */
DECL|method|getHostNamesList (Collection<ClusterNode> values)
specifier|public
name|Iterable
argument_list|<
name|String
...
return|;
block|}
comment|/**    * Return a list of IPs based on current ClusterNodes.    * @param values cluster nodes    * @return list of hosts    */
DECL|method|getIPsList (Collection<ClusterNode> values)
specifier|public
name|Iterable
argument_list|<
name|String
