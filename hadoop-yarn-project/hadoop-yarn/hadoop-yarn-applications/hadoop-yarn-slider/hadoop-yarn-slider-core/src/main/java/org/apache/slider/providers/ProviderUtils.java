...
name|info
argument_list|(
literal|"Skipping writing {} file {} because it already exists"
argument_list|,
name|configFormat
argument_list|,
name|file
...
DECL|method|localizeConfigFile (ContainerLauncher launcher, String roleName, String roleGroup, String configFileDN, ConfigFormat configFormat, String configFileName, Map<String, Map<String, String>> configs, MapOperations env, SliderFileSystem fileSystem, String clusterName, boolean perComponent, boolean perGroup)
specifier|public
name|void
name|localizeConfigFile
parameter_list|(
...
name|info
argument_list|(
literal|"Local {} file {} already exists"
argument_list|,
name|configFormat
argument_list|,
name|localFile
...
DECL|method|buildConfigurations ( ConfTreeOperations appConf, ConfTreeOperations internalsConf, String containerId, String clusterName, String roleName, String roleGroup, StateAccessForProviders amState)
specifier|public
name|Map
argument_list|<
name|String
...
expr_stmt|;
block|}
comment|/**    * Publish an export group.    * @param exportGroup export groups    * @param amState access to AM state    * @param groupName export group name    */
DECL|method|publishExportGroup ( Map<String, Set<ExportEntry>> exportGroup, StateAccessForProviders amState, String groupName)
specifier|public
name|void
...
return|;
block|}
DECL|method|getGroupKey (String roleGroup, ConfTreeOperations appConf)
specifier|public
name|String
name|getGroupKey
parameter_list|(
...
return|;
block|}
DECL|method|getNameKey (String roleName, String roleGroup, ConfTreeOperations appConf)
specifier|public
name|String
name|getNameKey
parameter_list|(
...
return|;
block|}
DECL|method|getNameOrGroupKey (String rolePrefix, String roleNameOrGroup)
specifier|public
name|String
name|getNameOrGroupKey
parameter_list|(
