...
DECL|method|flexByRestService (String appName, Map<String, Long> componentCounts)
specifier|public
name|Map
argument_list|<
name|String
...
return|;
block|}
DECL|method|flexComponents (String appName, Map<String, Long> componentCounts, Application persistedApp)
specifier|private
name|Map
argument_list|<
name|String
...
return|;
block|}
DECL|method|actionStop (String appName, boolean waitForAppStopped)
specifier|public
name|int
name|actionStop
parameter_list|(
...
name|info
argument_list|(
literal|"Stopping application {}, with appId = {}"
argument_list|,
name|appName
argument_list|,
name|currentAppId
...
name|info
argument_list|(
literal|"Forcefully kill the application: "
operator|+
name|appName
argument_list|)
expr_stmt|;
...
throw|;
block|}
DECL|method|verifyNoLiveAppInRM (String appname, String action)
specifier|private
name|void
name|verifyNoLiveAppInRM
parameter_list|(
...
return|;
block|}
DECL|method|createDirAndPersistApp (Path appDir, Application application)
specifier|private
name|void
name|createDirAndPersistApp
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|persistAppDef (Path appDir, Application application)
specifier|private
name|void
name|persistAppDef
parameter_list|(
...
block|}
block|}
comment|// Get AMProxy with the appReport provided
DECL|method|getAMProxy (String appName, ApplicationReport report)
specifier|protected
name|ClientAMProtocol
name|getAMProxy
parameter_list|(
...
return|;
block|}
comment|// Get AMProxy without appReport provided - it'll getAppReport from RM
DECL|method|getAMProxy (String appName)
specifier|protected
name|ClientAMProtocol
name|getAMProxy
parameter_list|(
...
block|}
block|}
DECL|method|insertAMProxy (String appName, String host, int port)
specifier|private
name|ClientAMProtocol
name|insertAMProxy
parameter_list|(
...
return|;
block|}
DECL|method|getAppId (String appName)
specifier|private
specifier|synchronized
name|ApplicationId
name|getAppId
