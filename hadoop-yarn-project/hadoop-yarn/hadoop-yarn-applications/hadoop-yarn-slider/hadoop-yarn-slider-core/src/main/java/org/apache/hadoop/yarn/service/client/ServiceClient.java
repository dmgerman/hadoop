...
block|}
block|}
DECL|method|connectToAM (String appName)
specifier|protected
name|ClientAMProtocol
name|connectToAM
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// Wait until app becomes running.
name|long
name|startTime
init|=
name|System
...
name|info
argument_list|(
literal|"Waiting for application {} to be running, current state is {}"
argument_list|,
name|currentAppId
argument_list|,
name|state
...
return|;
block|}
DECL|method|getAppIdFromPersistedApp (String appName)
specifier|private
specifier|synchronized
name|ApplicationId
name|getAppIdFromPersistedApp
