...
argument_list|()
decl_stmt|;
name|addProviderServiceOptions
argument_list|(
name|providerService
argument_list|,
name|ul
...
return|;
block|}
DECL|method|getInfoAvoidingNulls (String key)
specifier|private
name|String
name|getInfoAvoidingNulls
parameter_list|(
...
return|;
block|}
DECL|method|addProviderServiceOptions (ProviderService provider, UL ul, ClusterDescription clusterStatus)
specifier|protected
name|void
name|addProviderServiceOptions
parameter_list|(
...
return|return;
block|}
comment|// Loop over each entry, placing the text in the UL, adding an anchor when the URL is non-null/empty
for|for
control|(
name|Entry
argument_list|<
...
condition|)
block|{
comment|// Render an anchor if the value is a URL
name|item
operator|.
name|a
argument_list|(
