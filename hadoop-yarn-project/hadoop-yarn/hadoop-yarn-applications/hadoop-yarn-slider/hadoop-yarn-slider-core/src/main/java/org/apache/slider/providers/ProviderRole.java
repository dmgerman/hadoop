...
expr_stmt|;
block|}
comment|/**    * Create a provider role with a role group    * @param name role/component name    * @param id ID. This becomes the YARN priority    * @param policy placement policy    * @param nodeFailureThreshold threshold for node failures (within a reset interval)    * after which a node failure is considered an app failure    * @param placementTimeoutSeconds for lax placement, timeout in seconds before    * @param labelExpression label expression for requests; may be null    */
DECL|method|ProviderRole (String name, int id, int policy, int nodeFailureThreshold, long placementTimeoutSeconds, String labelExpression, Component component)
specifier|public
name|ProviderRole
parameter_list|(
name|String
