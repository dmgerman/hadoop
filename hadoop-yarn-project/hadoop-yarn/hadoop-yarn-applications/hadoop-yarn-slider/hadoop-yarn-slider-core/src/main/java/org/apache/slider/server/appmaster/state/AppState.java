...
literal|false
decl_stmt|;
comment|/**    * The definition of the instance. Flexing updates the resources section    * This is used as a synchronization point on activities that update    * the CD, and also to update some of the structures that    * feed in to the CD    */
DECL|field|instanceDefinition
specifier|private
name|AggregateConf
name|instanceDefinition
decl_stmt|;
comment|/**    * Time the instance definition snapshots were created    */
DECL|field|snapshotTime
specifier|private
name|long
name|snapshotTime
decl_stmt|;
comment|/**    * Snapshot of the instance definition. This is fully    * resolved.    */
DECL|field|instanceDefinitionSnapshot
specifier|private
name|AggregateConf
name|instanceDefinitionSnapshot
decl_stmt|;
comment|/**    * Snapshot of the raw instance definition; unresolved and    * without any patch of an AM into it.    */
DECL|field|unresolvedInstanceDefinition
specifier|private
name|AggregateConf
name|unresolvedInstanceDefinition
decl_stmt|;
comment|/**    * snapshot of resources as of last update time    */
DECL|field|resourcesSnapshot
specifier|private
name|ConfTreeOperations
name|resourcesSnapshot
decl_stmt|;
DECL|field|appConfSnapshot
specifier|private
name|ConfTreeOperations
name|appConfSnapshot
decl_stmt|;
DECL|field|internalsSnapshot
specifier|private
name|ConfTreeOperations
...
argument_list|()
decl_stmt|;
comment|/**    * Metadata provided by the AM for use in filling in status requests    */
...
decl_stmt|;
comment|/**    * Client properties created via the provider -static for the life    * of the application    */
...
DECL|field|completedContainerCount
specifier|private
specifier|final
name|LongGauge
...
DECL|field|failedContainerCount
specifier|private
specifier|final
name|LongGauge
...
argument_list|()
decl_stmt|;
comment|/**    * # of containers that failed to start     */
DECL|field|startFailedContainerCount
specifier|private
specifier|final
name|LongGauge
name|startFailedContainerCount
init|=
operator|new
name|LongGauge
argument_list|()
decl_stmt|;
comment|/**    * Track the number of surplus containers received and discarded    */
...
argument_list|()
decl_stmt|;
comment|/**    * Track the number of requested containers.    * Important: this does not include AA requests which are yet to be issued.    */
DECL|field|outstandingContainerRequests
specifier|private
specifier|final
name|LongGauge
name|outstandingContainerRequests
init|=
operator|new
name|LongGauge
argument_list|()
...
expr_stmt|;
block|}
DECL|method|register (String name, Metric counter)
specifier|private
name|void
name|register
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|getFailedCountainerCount ()
specifier|public
name|long
name|getFailedCountainerCount
parameter_list|()
block|{
return|return
name|failedContainerCount
...
DECL|method|incFailedCountainerCount ()
specifier|public
name|void
name|incFailedCountainerCount
parameter_list|()
block|{
name|failedContainerCount
operator|.
...
expr_stmt|;
block|}
DECL|method|getStartFailedCountainerCount ()
specifier|public
name|long
name|getStartFailedCountainerCount
parameter_list|()
block|{
return|return
name|startFailedContainerCount
...
return|;
block|}
comment|/**    * Increment the count and return the new value    */
DECL|method|incStartedCountainerCount ()
specifier|public
name|void
name|incStartedCountainerCount
parameter_list|()
block|{
name|startedContainers
operator|.
...
expr_stmt|;
block|}
DECL|method|getStartedCountainerCount ()
specifier|public
name|long
name|getStartedCountainerCount
parameter_list|()
block|{
return|return
name|startedContainers
...
block|}
comment|/**    * Increment the count and return the new value    */
DECL|method|incStartFailedCountainerCount ()
specifier|public
name|void
name|incStartFailedCountainerCount
parameter_list|()
block|{
name|startFailedContainerCount
operator|.
...
expr_stmt|;
block|}
DECL|method|getCompletionOfNodeNotInLiveListEvent ()
specifier|public
name|AtomicInteger
name|getCompletionOfNodeNotInLiveListEvent
parameter_list|()
block|{
return|return
name|completionOfNodeNotInLiveListEvent
return|;
block|}
DECL|method|getCompletionOfUnknownContainerEvent ()
specifier|public
name|AtomicInteger
name|getCompletionOfUnknownContainerEvent
parameter_list|()
block|{
return|return
name|completionOfUnknownContainerEvent
...
return|;
block|}
comment|/**    * Get the current view of the cluster status.    *<p>    *   Calls to {@link #refreshClusterStatus()} trigger a    *   refresh of this field.    *<p>    * This is read-only    * to the extent that changes here do not trigger updates in the    * application state.     * @return the cluster status    */
...
annotation|@
name|VisibleForTesting
DECL|method|setClusterStatus (ClusterDescription clusterDesc)
specifier|protected
specifier|synchronized
name|void
...
expr_stmt|;
block|}
comment|/**    * Set the instance definition -this also builds the (now obsolete)    * cluster specification from it.    *     * Important: this is for early binding and must not be used after the build    * operation is complete.     * @param definition initial definition    * @throws BadConfigException    */
DECL|method|setInitialInstanceDefinition (AggregateConf definition)
specifier|public
specifier|synchronized
name|void
...
name|debug
argument_list|(
literal|"Setting initial instance definition"
argument_list|)
expr_stmt|;
comment|// snapshot the definition
name|AggregateConfSerDeser
name|serDeser
init|=
operator|new
...
argument_list|)
expr_stmt|;
name|onInstanceDefinitionUpdated
argument_list|()
expr_stmt|;
block|}
...
argument_list|)
decl_stmt|;
comment|//  Add the -site configuration properties
for|for
control|(
name|String
name|key
...
name|dynamicRole
init|=
name|createDynamicProviderRole
argument_list|(
name|name
argument_list|,
name|resComponent
...
expr_stmt|;
block|}
DECL|method|initClusterStatus ()
specifier|public
name|void
name|initClusterStatus
parameter_list|()
block|{
comment|//copy into cluster status.
name|ClusterDescription
name|status
init|=
name|ClusterDescription
...
name|STATE_LIVE
expr_stmt|;
comment|//set the app state to this status
name|setClusterStatus
argument_list|(
name|status
argument_list|)
expr_stmt|;
block|}
comment|/**    * Build a dynamic provider role    * @param name name of role    * @return a new provider role    * @throws BadConfigException bad configuration    */
DECL|method|createDynamicProviderRole (String name, MapOperations component)
specifier|public
name|ProviderRole
name|createDynamicProviderRole
parameter_list|(
...
return|;
block|}
comment|/**    * Build a dynamic provider role    * @param name name of role    * @param group group of role    * @return a new provider role    * @throws BadConfigException bad configuration    */
DECL|method|createDynamicProviderRole (String name, String group, MapOperations component)
specifier|public
name|ProviderRole
name|createDynamicProviderRole
parameter_list|(
...
name|placement
argument_list|,
name|getNodeFailureThresholdForRole
argument_list|(
name|group
argument_list|)
argument_list|,
...
return|;
block|}
comment|/**    * Actions to perform when an instance definition is updated    * Currently:     *<ol>    *<li>    *     resolve the configuration    *</li>    *<li>    *     update the cluster spec derivative    *</li>    *</ol>    *      * @throws BadConfigException    */
DECL|method|onInstanceDefinitionUpdated ()
specifier|private
specifier|synchronized
name|void
name|onInstanceDefinitionUpdated
...
name|debug
argument_list|(
literal|"Instance definition updated"
argument_list|)
expr_stmt|;
comment|//note the time
name|snapshotTime
operator|=
name|now
argument_list|()
...
expr_stmt|;
block|}
comment|// resolve references if not already done
name|instanceDefinition
operator|.
name|resolve
argument_list|()
expr_stmt|;
comment|// force in the AM desired state values
name|ConfTreeOperations
name|resources
init|=
name|instanceDefinition
...
expr_stmt|;
block|}
comment|//snapshot all three sectons
name|resourcesSnapshot
operator|=
name|ConfTreeOperations
operator|.
...
block|}
block|}
comment|/**    * The resource configuration is updated -review and update state.    * @param resources updated resources specification    * @return a list of any dynamically added provider roles    * (purely for testing purposes)    */
annotation|@
name|VisibleForTesting
DECL|method|updateResourceDefinitions (ConfTree resources)
specifier|public
specifier|synchronized
name|List
argument_list|<
...
name|debug
argument_list|(
literal|"Updating resources to {}"
argument_list|,
name|resources
argument_list|)
expr_stmt|;
comment|// snapshot the (possibly unresolved) values
name|ConfTreeSerDeser
name|serDeser
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// assign another copy under the instance definition for resolving
comment|// and then driving application size
name|instanceDefinition
operator|.
name|setResources
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// propagate the role table
name|Map
argument_list|<
name|String
argument_list|,
...
name|BadConfigException
argument_list|(
literal|"Component is null for name = "
operator|+
name|name
operator|+
literal|", newPriority ="
...
return|;
block|}
comment|/**    * Get the desired instance count of a role, rejecting negative values    * @param resources resource map    * @param roleGroup role group    * @return the instance count    * @throws BadConfigException if the count is negative    */
DECL|method|getDesiredInstanceCount (ConfTreeOperations resources, String roleGroup)
specifier|private
name|int
name|getDesiredInstanceCount
parameter_list|(
...
name|error
argument_list|(
literal|"Role {} has negative desired instances : {}"
argument_list|,
name|roleGroup
argument_list|,
name|desiredInstanceCount
...
name|BadConfigException
argument_list|(
literal|"Negative instance count (%) requested for component %s"
argument_list|,
name|desiredInstanceCount
argument_list|,
name|roleGroup
...
return|;
block|}
DECL|method|hasUniqueNames (ConfTreeOperations resources, String group)
specifier|private
name|Boolean
name|hasUniqueNames
parameter_list|(
...
name|info
argument_list|(
literal|"Component was null for {} when checking unique names"
argument_list|,
name|group
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * build up the special master node, which lives    * in the live node set but has a lifecycle bonded to the AM    * @param containerId the AM master    * @param host hostname    * @param amPort port    * @param nodeHttpAddress http address: may be null    */
DECL|method|buildAppMasterNode (ContainerId containerId, String host, int amPort, String nodeHttpAddress)
specifier|public
name|void
...
name|am
expr_stmt|;
comment|//it is also added to the set of live nodes
name|getLiveContainers
argument_list|()
operator|.
name|put
...
argument_list|)
expr_stmt|;
comment|// patch up the role status
name|RoleStatus
name|roleStatus
init|=
name|roleStatusMap
...
expr_stmt|;
block|}
comment|/**    * Note that the master node has been launched,    * though it isn't considered live until any forked    * processes are running. It is NOT registered with    * the role history -the container is incomplete    * and it will just cause confusion    */
DECL|method|noteAMLaunched ()
specifier|public
name|void
name|noteAMLaunched
parameter_list|()
...
expr_stmt|;
block|}
comment|/**    * AM declares ourselves live in the cluster description.    * This is meant to be triggered from the callback    * indicating the spawned process is up and running.    */
DECL|method|noteAMLive ()
specifier|public
name|void
name|noteAMLive
parameter_list|()
...
name|warn
argument_list|(
literal|"Unexpected cloning failure: {}"
argument_list|,
name|e
argument_list|,
name|e
...
return|;
block|}
comment|/**    * Increment the request count of a role.    *<p>    *   Also updates application state counters    * @param role role being requested.    */
DECL|method|incrementRequestCount (RoleStatus role)
specifier|protected
name|void
name|incrementRequestCount
parameter_list|(
...
argument_list|()
expr_stmt|;
name|incOutstandingContainerRequests
argument_list|()
expr_stmt|;
block|}
comment|/**    * Inc #of outstanding requests.    */
DECL|method|incOutstandingContainerRequests ()
specifier|private
name|void
name|incOutstandingContainerRequests
parameter_list|()
...
expr_stmt|;
block|}
comment|/**    * Decrement the number of outstanding requests. This never goes below zero.    */
DECL|method|decOutstandingContainerRequests ()
specifier|private
name|void
name|decOutstandingContainerRequests
parameter_list|()
block|{
...
condition|)
block|{
comment|// decrement but never go below zero
name|outstandingContainerRequests
operator|.
name|dec
argument_list|()
...
return|;
block|}
comment|/**    * Build up the resource requirements for this role from the    * cluster specification, including substituing max allowed values    * if the specification asked for it.    * @param role role    * @param capability capability to set up. A new one may be created    * during normalization    */
DECL|method|buildResourceRequirements (RoleStatus role, Resource capability)
specifier|public
name|Resource
name|buildResourceRequirements
parameter_list|(
...
DECL|method|onCompletedNode (ContainerStatus status)
specifier|public
specifier|synchronized
name|NodeCompletionResult
...
name|info
argument_list|(
literal|"decrementing role count for role {} to {}; releasing={}, completed={}"
argument_list|,
name|roleStatus
operator|.
name|getName
...
condition|)
block|{
comment|//it was active, move it to failed
name|incFailedCountainerCount
argument_list|()
expr_stmt|;
name|failedContainers
...
return|;
block|}
comment|/**    * Update the cluster description with the current application state    * @param providerStatus status from the provider for the cluster info section    */
DECL|method|refreshClusterStatus (Map<String, String> providerStatus)
specifier|public
specifier|synchronized
name|ClusterDescription
name|refreshClusterStatus
...
argument_list|()
expr_stmt|;
comment|// build the map of node -> container IDs
name|Map
argument_list|<
name|String
argument_list|,
...
name|instanceMap
expr_stmt|;
comment|//build the map of node -> containers
name|Map
argument_list|<
name|String
argument_list|,
...
name|info
argument_list|(
literal|"app state clusterNodes {} "
argument_list|,
name|clusterNodes
operator|.
name|toString
...
operator|+
literal|" - failed with component %s failed 'recently' %d times (%d in startup);"
operator|+
...
return|;
block|}
comment|/**    * Get the node failure threshold for a specific role, falling back to    * the global one if not    * @param roleGroup role group    * @return the threshold for failures    */
DECL|method|getNodeFailureThresholdForRole (String roleGroup)
specifier|private
name|int
name|getNodeFailureThresholdForRole
parameter_list|(
...
DECL|method|addContainerRequest (List<AbstractRMOperation> operations, AMRMClient.ContainerRequest containerAsk)
specifier|private
name|boolean
name|addContainerRequest
parameter_list|(
...
return|;
block|}
comment|/**    * Find a container running on a specific host -looking    * into the node ID to determine this.    *    * @param node node    * @param roleId role the container must be in    * @return a container or null if there are no containers on this host    * that can be released.    */
DECL|method|findRoleInstanceOnHost (NodeInstance node, int roleId)
specifier|private
name|RoleInstance
name|findRoleInstanceOnHost
parameter_list|(
name|NodeInstance
name|node
parameter_list|,
...
argument_list|()
expr_stmt|;
comment|//and, as we aren't binding it to role, dec that role's actual count
name|role
operator|.
name|decActual
argument_list|()
...
block|{
comment|// Allocation being accepted -so decrement the number of outstanding requests
name|decOutstandingContainerRequests
argument_list|()
expr_stmt|;
name|log
...
name|append
argument_list|(
literal|", startFailedContainerCount="
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|", outstanding non-AA Container Requests="
argument_list|)
operator|.
name|append
argument_list|(
