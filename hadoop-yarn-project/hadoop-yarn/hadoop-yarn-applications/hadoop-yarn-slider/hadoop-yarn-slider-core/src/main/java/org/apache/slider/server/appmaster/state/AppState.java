...
return|;
block|}
DECL|method|updateComponents ( Messages.FlexComponentRequestProto requestProto)
specifier|public
specifier|synchronized
name|void
...
return|;
block|}
DECL|method|incPendingContainers (RoleStatus role)
specifier|private
name|void
name|incPendingContainers
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|decPendingContainers (RoleStatus role)
specifier|private
name|void
name|decPendingContainers
parameter_list|(
name|RoleStatus
name|role
parameter_list|)
...
expr_stmt|;
block|}
DECL|method|decPendingContainers (RoleStatus role, int n)
specifier|private
name|void
name|decPendingContainers
parameter_list|(
...
block|}
block|}
comment|/**    * Build up the resource requirements for this role from the    * cluster specification, including substituing max allowed values    * if the specification asked for it.    * @param role role    * during normalization    */
