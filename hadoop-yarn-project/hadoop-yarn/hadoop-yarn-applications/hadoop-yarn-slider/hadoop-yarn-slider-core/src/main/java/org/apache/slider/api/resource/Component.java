...
name|value
operator|=
literal|"Containers of a started component. Specifying a value for this attribute for the POST payload raises a validation error. This blob is available only in the GET response of a started application."
argument_list|)
annotation|@
name|JsonProperty
argument_list|(
