...
begin_comment
comment|/**  * This is a version of the HBase ZK cluster cut out to be standalone.  *   *<i>Important: keep this Java6 language level for now</i>  */
end_comment
...
name|baseDir
decl_stmt|;
DECL|field|numZooKeeperServers
specifier|private
specifier|final
name|int
...
literal|""
decl_stmt|;
DECL|method|MiniZooKeeperCluster (int numZooKeeperServers)
specifier|public
name|MiniZooKeeperCluster
parameter_list|(
name|int
...
DECL|method|selectClientPort (Random r)
specifier|private
name|int
