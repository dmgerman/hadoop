...
init|=
literal|"Application name is either empty or not provided"
decl_stmt|;
...
init|=
literal|"Application resource or memory not provided"
decl_stmt|;
DECL|field|ERROR_RESOURCE_CPUS_INVALID
name|String
name|ERROR_RESOURCE_CPUS_INVALID
init|=
literal|"Application resource or cpus not provided"
decl_stmt|;
