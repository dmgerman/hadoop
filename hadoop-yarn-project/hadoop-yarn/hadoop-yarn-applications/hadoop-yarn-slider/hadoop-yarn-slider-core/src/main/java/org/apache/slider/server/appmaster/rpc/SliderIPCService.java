...
DECL|method|SliderIPCService (AppMasterActionOperations amOperations, CertificateManager certificateManager, StateAccessForProviders state, QueueAccess actionQueues, MetricsAndMonitoring metricsAndMonitoring, ContentCache cache)
specifier|public
name|SliderIPCService
parameter_list|(
name|AppMasterActionOperations
