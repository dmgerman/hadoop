...
begin_comment
comment|/**  * Tell the AM to execute the full flex review operation  */
end_comment

begin_class
DECL|class|ReviewAndFlexApplicationSize
specifier|public
class|class
...
name|AsyncAction
block|{
DECL|method|ReviewAndFlexApplicationSize (String name, long delay, TimeUnit timeUnit)
specifier|public
name|ReviewAndFlexApplicationSize
parameter_list|(
name|String
