...
name|info
argument_list|(
literal|"Application {} is in a terminated state {}"
argument_list|,
name|appName
argument_list|,
name|app
...
return|;
block|}
DECL|method|flex (String appName, Component component)
specifier|public
name|long
name|flex
parameter_list|(
...
argument_list|()
operator|+
literal|" does not exist in app definition."
argument_list|)
throw|;
block|}
name|jsonSerDeser
...
name|info
argument_list|(
literal|"Updated app definition file for component "
operator|+
name|component
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|", number of containers updated from "
operator|+
name|original
operator|+
literal|" to "
