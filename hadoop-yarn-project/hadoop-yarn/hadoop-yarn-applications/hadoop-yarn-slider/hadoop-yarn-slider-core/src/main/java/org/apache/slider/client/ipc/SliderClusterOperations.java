...
block|}
block|}
comment|/**    * Get the AM instance definition.    *<p>    *   See {@link SliderClusterProtocol#getInstanceDefinition(Messages.GetInstanceDefinitionRequestProto)}    * @return current slider AM aggregate definition    * @throws YarnException    * @throws IOException    */
...
return|;
block|}
comment|/**    * Flex operation    * @param resources new resources    * @return the response    * @throws IOException    */
DECL|method|flex (ConfTree resources)
specifier|public
name|boolean
name|flex
parameter_list|(
...
block|{
return|return
name|unmarshallToAggregateConf
argument_list|(
name|appMaster
operator|.
name|getModelDesired
...
name|IOException
argument_list|(
literal|"Number of names returned ("
operator|+
name|namesCount
operator|+
literal|") does not match the number of records returned: "
operator|+
name|records
argument_list|)
throw|;
...
return|;
block|}
DECL|method|getClientCertificateStore (String hostname, String clientId, String password, String type)
specifier|public
name|byte
index|[]
