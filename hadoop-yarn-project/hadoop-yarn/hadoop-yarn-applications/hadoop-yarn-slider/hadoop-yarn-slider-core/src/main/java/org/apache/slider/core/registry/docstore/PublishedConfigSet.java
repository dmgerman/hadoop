...
argument_list|()
decl_stmt|;
DECL|method|PublishedConfigSet ()
specifier|public
name|PublishedConfigSet
parameter_list|()
block|{   }
comment|/**    * Put a name -it will be converted to lower case before insertion.    * Any existing entry will be overwritten (that includes an entry    * with a different case in the original name)    * @param name name of entry    * @param conf configuration    * @throws IllegalArgumentException if not a valid name    */
DECL|method|put (String name, PublishedConfiguration conf)
specifier|public
name|void
name|put
parameter_list|(
