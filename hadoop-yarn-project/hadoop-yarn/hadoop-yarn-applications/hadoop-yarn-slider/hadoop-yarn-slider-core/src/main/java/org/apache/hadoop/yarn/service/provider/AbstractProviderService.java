...
argument_list|)
decl_stmt|;
DECL|method|processArtifact (AbstractLauncher launcher, ComponentInstance compInstance, SliderFileSystem fileSystem, Application application)
specifier|public
specifier|abstract
name|void
...
name|IOException
function_decl|;
DECL|method|buildContainerLaunchContext (AbstractLauncher launcher, Application application, ComponentInstance instance, SliderFileSystem fileSystem, Configuration yarnConf)
specifier|public
name|void
