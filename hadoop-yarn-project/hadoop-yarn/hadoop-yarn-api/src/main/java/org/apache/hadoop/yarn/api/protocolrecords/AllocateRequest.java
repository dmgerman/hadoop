...
annotation|@
name|Unstable
DECL|method|newInstance (int responseID, float appProgress, List<ResourceRequest> resourceAsk, List<ContainerId> containersToBeReleased, ResourceBlacklistRequest resourceBlacklistRequest, String trackingUrl)
specifier|public
specifier|static
name|AllocateRequest
name|newInstance
...
parameter_list|)
block|{   }
comment|/**    * Get the tracking url update for this heartbeat.    * @return tracking url to update this application with    */
annotation|@
name|Public
annotation|@
name|Unstable
...
parameter_list|()
function_decl|;
comment|/**    * Set the new tracking url for this application.    * @param trackingUrl the new tracking url    */
annotation|@
name|Public
annotation|@
name|Unstable
...
return|;
block|}
comment|/**      * Set the<code>trackingUrl</code> of the request.      * @see AllocateRequest#setTrackingUrl(String)      * @param trackingUrl new tracking url      * @return {@link AllocateRequestBuilder}      */
annotation|@
name|Public
annotation|@
name|Unstable
DECL|method|trackingUrl (String trackingUrl)
specifier|public
name|AllocateRequestBuilder
name|trackingUrl
parameter_list|(
