...
DECL|field|RM_HA_ADMIN_ADDRESS
specifier|public
specifier|static
specifier|final
name|String
...
literal|"admin.address"
decl_stmt|;
DECL|field|DEFAULT_RM_HA_ADMIN_PORT
specifier|public
specifier|static
specifier|final
name|int
...
literal|8034
decl_stmt|;
DECL|field|DEFAULT_RM_HA_ADMIN_ADDRESS
specifier|public
specifier|static
name|String
...
name|DEFAULT_RM_HA_ADMIN_PORT
decl_stmt|;
DECL|field|RM_HA_ADMIN_CLIENT_THREAD_COUNT
specifier|public
specifier|static
specifier|final
name|String
...
literal|"admin.client.thread-count"
decl_stmt|;
DECL|field|DEFAULT_RM_HA_ADMIN_CLIENT_THREAD_COUNT
specifier|public
specifier|static
specifier|final
name|int
...
decl_stmt|;
comment|// end @Private
DECL|field|RM_RPC_ADDRESS_CONF_KEYS
specifier|public
specifier|static
specifier|final
name|List
...
literal|"num-retries"
decl_stmt|;
DECL|field|DEFAULT_ZK_RM_STATE_STORE_NUM_RETRIES
specifier|public
specifier|static
specifier|final
name|int
...
literal|"address"
decl_stmt|;
comment|/** Timeout in millisec for ZK server connection for ZKRMStateStore */
DECL|field|ZK_RM_STATE_STORE_TIMEOUT_MS
specifier|public
specifier|static
specifier|final
name|String
...
literal|"/rmstore"
decl_stmt|;
comment|/** ACL for znodes in ZKRMStateStore */
DECL|field|ZK_RM_STATE_STORE_ACL
specifier|public
specifier|static
specifier|final
name|String
...
literal|"acl"
decl_stmt|;
DECL|field|DEFAULT_ZK_RM_STATE_STORE_ACL
specifier|public
specifier|static
specifier|final
name|String
...
specifier|final
name|String
DECL|field|YARN_SECURITY_SERVICE_AUTHORIZATION_HA_SERVICE_PROTOCOL
