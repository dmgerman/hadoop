...
decl_stmt|;
DECL|field|attributeOpCode
specifier|private
name|NodeAttributeOpCode
name|attributeOpCode
decl_stmt|;
DECL|method|SingleConstraint (String scope, int minCardinality, int maxCardinality, NodeAttributeOpCode opCode, Set<TargetExpression> targetExpressions)
specifier|public
name|SingleConstraint
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|SingleConstraint (String scope, int minC, int maxC, NodeAttributeOpCode opCode, TargetExpression... targetExpressions)
specifier|public
name|SingleConstraint
parameter_list|(
name|String
...
return|;
block|}
comment|/**      * Get the NodeAttributeOpCode of the constraint.      *      * @return nodeAttribute Op Code      */
DECL|method|getNodeAttributeOpCode ()
specifier|public
name|NodeAttributeOpCode
