...
parameter_list|()
function_decl|;
comment|/**    * Set the<em>tracking URL</em>for the<code>ApplicationMaster</code>    * This url if contains scheme then that will be used by resource manager    * web application proxy otherwise it will default to http.    * @param url<em>tracking URL</em>for the    *<code>ApplicationMaster</code>    */
annotation|@
name|Public
annotation|@
name|Stable
