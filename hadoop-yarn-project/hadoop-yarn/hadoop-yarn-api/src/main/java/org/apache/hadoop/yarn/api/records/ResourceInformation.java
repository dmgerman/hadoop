...
expr_stmt|;
block|}
comment|/**    * Get the attributes of the resource.    * @return resource attributes    */
...
return|;
block|}
comment|/**    * Set a map of attributes to the resource.    * @param attributes resource attributes    */
...
block|}
block|}
comment|/**    * Get resource tags.    * @return resource tags    */
DECL|method|getTags ()
specifier|public
name|Set
argument_list|<
...
return|;
block|}
comment|/**    * Add tags to the resource.    * @param tags resource tags    */
...
return|;
block|}
DECL|method|newInstance (String name, String units, long value, ResourceTypes type, long minimumAllocation, long maximumAllocation, Set<String> tags, Map<String, String> attributes)
specifier|public
specifier|static
name|ResourceInformation
name|newInstance
