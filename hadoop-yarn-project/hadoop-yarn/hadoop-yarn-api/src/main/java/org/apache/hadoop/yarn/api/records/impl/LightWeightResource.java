...
name|vcoresResInfo
decl_stmt|;
comment|/**    * Create a new {@link LightWeightResource} instance with all resource values    * initialized to {@code value}.    * @param value the value to use for all resources    */
DECL|method|LightWeightResource (long value)
specifier|public
name|LightWeightResource
parameter_list|(
name|long
...
block|}
block|}
DECL|method|initResourceInformations (long memory, long vcores, int numberOfKnownResourceTypes)
specifier|private
name|void
name|initResourceInformations
parameter_list|(
