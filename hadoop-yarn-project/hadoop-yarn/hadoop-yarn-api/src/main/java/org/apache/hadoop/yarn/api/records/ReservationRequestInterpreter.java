...
begin_comment
comment|/**  * Enumeration of various types of dependencies among multiple  * {@link ReservationRequests} within one {@link ReservationDefinition} (from  * least constraining to most constraining).  */
end_comment
