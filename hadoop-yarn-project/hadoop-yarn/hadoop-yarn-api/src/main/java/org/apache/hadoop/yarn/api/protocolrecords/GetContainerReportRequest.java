...
begin_comment
comment|/**  *<p>  * The request sent by a client to the<code>ResourceManager</code> to get an  * {@link ContainerReport} for a container.  *</p>  */
end_comment
...
annotation|@
name|Unstable
DECL|class|GetContainerReportRequest
specifier|public
specifier|abstract
class|class
