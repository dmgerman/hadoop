...
expr_stmt|;
block|}
comment|/**    * Add rejected Scheduling Requests to {@link AllocateResponse}.    * @param allocateResponse Allocate Response.    * @param rejectedRequests Rejected SchedulingRequests.    */
DECL|method|addToRejectedSchedulingRequests ( AllocateResponse allocateResponse, List<RejectedSchedulingRequest> rejectedRequests)
specifier|public
specifier|static
name|void
