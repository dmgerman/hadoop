...
decl_stmt|;
DECL|field|EXTERNAL_VOLUME_RESOURCE_TAG
specifier|public
specifier|static
specifier|final
name|String
name|EXTERNAL_VOLUME_RESOURCE_TAG
init|=
...
name|resourceTypes
decl_stmt|;
DECL|field|nonCountableResourceTypes
specifier|private
specifier|static
specifier|volatile
name|Map
...
name|ResourceInformation
argument_list|>
name|nonCountableResourceTypes
decl_stmt|;
...
literal|1
decl_stmt|;
DECL|field|numNonCountableResourceTypes
specifier|private
specifier|static
specifier|volatile
name|int
name|numNonCountableResourceTypes
init|=
operator|-
literal|1
decl_stmt|;
...
block|}
block|}
DECL|method|setAllocationForMandatoryResources ( Map<String, ResourceInformation> res, Configuration conf)
specifier|private
specifier|static
name|void
name|setAllocationForMandatoryResources
parameter_list|(
name|Map
argument_list|<
name|String
...
expr_stmt|;
block|}
DECL|method|getAllocation (Configuration conf, String resourceTypesKey, String schedulerKey, long schedulerDefault)
specifier|private
specifier|static
name|long
name|getAllocation
...
block|}
block|}
comment|/**    * Get maximum allocation from config, *THIS WILL NOT UPDATE INTERNAL DATA*    * @param conf config    * @return maximum allocation    */
DECL|method|fetchMaximumAllocationFromConfig (Configuration conf)
specifier|public
specifier|static
name|Resource
...
name|resourceInformationMap
init|=
name|getResourceInformationMapFromConfig
argument_list|(
name|conf
argument_list|)
decl_stmt|;
...
return|;
block|}
DECL|method|getResourceInformationMapFromConfig ( Configuration conf)
specifier|private
specifier|static
name|Map
argument_list|<
...
block|}
block|}
comment|// Add all non-countable resource types to the end of the resource array.
for|for
control|(
name|ResourceInformation
name|resInfo
...
return|;
block|}
DECL|method|getNumberOfCountableResourceTypes ()
specifier|public
specifier|static
name|int
...
block|}
block|}
DECL|method|getValue (String resourceValue)
specifier|public
specifier|static
name|long
name|getValue
...
argument_list|()
decl_stmt|;
name|addResourceTypeInformation
argument_list|(
name|key
argument_list|,
name|value
...
return|;
block|}
DECL|method|addResourceTypeInformation (String prop, String value, Map<String, ResourceInformation> nodeResources)
specifier|private
specifier|static
name|void
name|addResourceTypeInformation
...
return|;
block|}
comment|/**    * Are mandatory resources like memory-mb, vcores available?    * If not, throw exceptions. On availability, ensure those values are    * within boundary.    * @param res resource    * @throws IllegalArgumentException if mandatory resource is not available or    * value is not within boundary    */
DECL|method|areMandatoryResourcesAvailable (Resource res)
specifier|public
specifier|static
name|void
...
block|{
name|ResourceInformation
name|memoryResourceInformation
init|=
name|res
operator|.
...
literal|"' for "
operator|+
literal|"resource memory is more than the maximum for an integer."
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"Invalid value for resource '"
operator|+
name|MEMORY
operator|+
literal|"'. Value cannot be 0(zero)."
argument_list|)
throw|;
block|}
block|}
...
name|IllegalArgumentException
argument_list|(
literal|"Mandatory resource 'memory-mb' "
operator|+
literal|"is missing."
argument_list|)
throw|;
block|}
name|ResourceInformation
name|vcoresResourceInformation
init|=
name|res
operator|.
name|getResourceInformation
...
operator|+
literal|" vcores is more than the maximum for an integer."
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"Mandatory resource 'vcores' "
operator|+
literal|"is missing."
argument_list|)
throw|;
...
operator|.
name|Unstable
DECL|method|createResourceFromString ( String resourceStr, List<ResourceTypeInfo> resourceTypeInfos)
specifier|public
specifier|static
name|Resource
...
return|;
block|}
DECL|method|validateResourceTypes ( Iterable<String> resourceNames, List<ResourceTypeInfo> resourceTypeInfos)
specifier|private
specifier|static
name|void
name|validateResourceTypes
