...
begin_comment
comment|/**  * Encodes the type of Container Update.  */
end_comment
...
operator|.
name|Unstable
DECL|enum|ContainerUpdateType
specifier|public
enum|enum
name|ContainerUpdateType
block|{
comment|/**    * Resource increase.    */
DECL|enumConstant|INCREASE_RESOURCE
name|INCREASE_RESOURCE
block|,
comment|/**    * Resource decrease.    */
