...
annotation|@
name|Override
DECL|method|updateContainerState ( String containerName, HdslProtos.LifeCycleEvent event)
specifier|public
name|HdslProtos
operator|.
name|LifeCycleState
...
DECL|method|reconcileState ( StorageContainerDatanodeProtocolProtos.ContainerInfo datanodeState, HdslProtos.SCMContainerInfo knownState)
specifier|private
name|HdslProtos
operator|.
name|SCMContainerInfo
...
DECL|method|closeContainerIfNeeded (HdslProtos.SCMContainerInfo newState)
specifier|private
name|boolean
name|closeContainerIfNeeded
parameter_list|(
