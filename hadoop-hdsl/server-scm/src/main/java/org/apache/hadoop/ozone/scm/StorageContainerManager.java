...
annotation|@
name|Override
DECL|method|queryNode (EnumSet<NodeState> nodeStatuses, HdslProtos.QueryScope queryScope, String poolName)
specifier|public
name|HdslProtos
operator|.
name|NodePool
...
return|;
block|}
comment|/**    * Notify from client when begin/finish operation for container/pipeline    * objects on datanodes.    * @param type    * @param name    * @param op    * @param stage    */
annotation|@
name|Override
...
annotation|@
name|Override
DECL|method|createReplicationPipeline ( HdslProtos.ReplicationType replicationType, HdslProtos.ReplicationFactor factor, HdslProtos.NodePool nodePool)
specifier|public
name|Pipeline
...
annotation|@
name|Override
DECL|method|allocateContainer (HdslProtos.ReplicationType replicationType, HdslProtos.ReplicationFactor replicationFactor, String containerName, String owner)
specifier|public
name|Pipeline
...
return|;
block|}
DECL|method|updateContainerReportMetrics ( ContainerReportsRequestProto reports)
specifier|private
name|void
name|updateContainerReportMetrics
parameter_list|(
...
return|;
block|}
comment|/**    * Get the clusterId and SCM Id from the version file in SCM.    */
annotation|@
name|Override
