...
name|containerID
decl_stmt|;
DECL|method|ContainerInfo ( long containerID, final String containerName, HdslProtos.LifeCycleState state, Pipeline pipeline, long allocatedBytes, long usedBytes, long numberOfKeys, long stateEnterTime, String owner)
name|ContainerInfo
parameter_list|(
name|long
name|containerID
...
parameter_list|()
block|{   }
DECL|method|fromProtobuf (HdslProtos.SCMContainerInfo info)
specifier|public
specifier|static
name|ContainerInfo
name|fromProtobuf
...
return|;
block|}
DECL|method|setState (HdslProtos.LifeCycleState lifeCycleState)
specifier|public
name|Builder
name|setState
parameter_list|(
