...
DECL|method|getFromProtoBuf ( HdslProtos.DatanodeDetailsProto datanodeDetailsProto)
specifier|public
specifier|static
name|DatanodeDetails
...
return|;
block|}
comment|/**    * Returns a DatanodeDetails protobuf message from a datanode ID.    * @return Hdsl.DatanodeDetailsProto    */
