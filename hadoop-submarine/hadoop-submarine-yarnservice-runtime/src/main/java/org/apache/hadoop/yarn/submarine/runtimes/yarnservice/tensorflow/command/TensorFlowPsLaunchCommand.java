...
name|launchCommand
decl_stmt|;
DECL|method|TensorFlowPsLaunchCommand (HadoopEnvironmentSetup hadoopEnvSetup, TaskType taskType, Component component, RunJobParameters parameters, Configuration yarnConfig)
specifier|public
name|TensorFlowPsLaunchCommand
parameter_list|(
name|HadoopEnvironmentSetup
