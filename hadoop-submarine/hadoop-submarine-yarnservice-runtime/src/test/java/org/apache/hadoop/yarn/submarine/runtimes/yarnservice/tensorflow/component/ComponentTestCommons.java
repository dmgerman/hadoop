...
name|resource
decl_stmt|;
DECL|method|ComponentTestCommons (Role role)
specifier|public
name|ComponentTestCommons
parameter_list|(
name|Role
...
expr_stmt|;
block|}
DECL|method|setupInternal (Framework framework)
specifier|private
name|void
name|setupInternal
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setupDependencies (Framework framework)
specifier|private
name|void
name|setupDependencies
parameter_list|(
...
argument_list|(
literal|"Unsupported framework type specified!"
argument_list|)
throw|;
block|}
name|AbstractLaunchCommand
