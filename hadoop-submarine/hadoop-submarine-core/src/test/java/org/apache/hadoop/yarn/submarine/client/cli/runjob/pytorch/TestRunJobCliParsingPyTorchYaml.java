...
begin_comment
comment|/**  * Test class that verifies the correctness of PyTorch  * YAML configuration parsing.  */
end_comment

begin_class
DECL|class|TestRunJobCliParsingPyTorchYaml
specifier|public
class|class
name|TestRunJobCliParsingPyTorchYaml
block|{
...
annotation|@
name|Test
DECL|method|testInvalidConfigPsSectionIsDefined ()
specifier|public
name|void
name|testInvalidConfigPsSectionIsDefined
parameter_list|()
throws|throws
name|Exception
block|{
...
name|expectMessage
argument_list|(
literal|"PS section should not be defined "
operator|+
literal|"when PyTorch is the selected framework"
argument_list|)
expr_stmt|;
name|yamlConfig
operator|=
...
name|DIR_NAME
operator|+
literal|"/invalid-config-ps-section.yaml"
argument_list|)
expr_stmt|;
name|runJobCli
operator|.
...
annotation|@
name|Test
DECL|method|testInvalidConfigTensorboardSectionIsDefined ()
specifier|public
name|void
name|testInvalidConfigTensorboardSectionIsDefined
parameter_list|()
throws|throws
name|Exception
block|{
...
name|expectMessage
argument_list|(
literal|"TensorBoard section should not be defined "
operator|+
literal|"when PyTorch is the selected framework"
argument_list|)
expr_stmt|;
...
name|DIR_NAME
operator|+
literal|"/invalid-config-tensorboard-section.yaml"
argument_list|)
expr_stmt|;
name|runJobCli
operator|.
