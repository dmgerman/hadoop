...
decl_stmt|;
DECL|field|SUBMARINE_CONFIGURATION_PREFIX
specifier|public
specifier|static
specifier|final
name|String
name|SUBMARINE_CONFIGURATION_PREFIX
init|=
literal|"submarine."
decl_stmt|;
DECL|field|SUBMARINE_LOCALIZATION_PREFIX
specifier|public
specifier|static
specifier|final
name|String
name|SUBMARINE_LOCALIZATION_PREFIX
init|=
name|SUBMARINE_CONFIGURATION_PREFIX
operator|+
literal|"localization."
decl_stmt|;
comment|/**    * Limit the size of directory/file to be localized.    * To avoid exhausting local disk space,    * this limit both remote and local file to be localized    */
DECL|field|LOCALIZATION_MAX_ALLOWED_FILE_SIZE_MB
specifier|public
specifier|static
specifier|final
name|String
...
name|SUBMARINE_LOCALIZATION_PREFIX
operator|+
literal|"max-allowed-file-size-mb"
decl_stmt|;
comment|// Default 2GB
DECL|field|DEFAULT_MAX_ALLOWED_REMOTE_URI_SIZE_MB
specifier|public
specifier|static
specifier|final
name|long
