...
argument_list|()
decl_stmt|;
comment|// FIXME: TestApplicationCleanup is relying on unnormalized behavior.
name|memory
operator|=
name|MINIMUM_MEMORY
operator|*
...
DECL|method|assignContainers (SchedulerNode node)
specifier|private
name|void
...
return|;
block|}
DECL|method|assignContainersOnNode (SchedulerNode node, SchedulerApp application, Priority priority )
specifier|private
name|int
name|assignContainersOnNode
parameter_list|(
...
return|;
block|}
DECL|method|assignNodeLocalContainers (SchedulerNode node, SchedulerApp application, Priority priority)
specifier|private
name|int
name|assignNodeLocalContainers
parameter_list|(
...
return|;
block|}
DECL|method|assignRackLocalContainers (SchedulerNode node, SchedulerApp application, Priority priority)
specifier|private
name|int
name|assignRackLocalContainers
parameter_list|(
...
return|;
block|}
DECL|method|assignOffSwitchContainers (SchedulerNode node, SchedulerApp application, Priority priority)
specifier|private
name|int
name|assignOffSwitchContainers
parameter_list|(
...
return|;
block|}
DECL|method|assignContainer (SchedulerNode node, SchedulerApp application, Priority priority, int assignableContainers, ResourceRequest request, NodeType type)
specifier|private
name|int
name|assignContainer
parameter_list|(
...
return|;
block|}
DECL|method|nodeUpdate (RMNode rmNode, Map<ApplicationId, List<Container>> remoteContainers)
specifier|private
specifier|synchronized
name|void
name|nodeUpdate
...
control|)
block|{
comment|/* make sure the scheduler hasnt already removed the applications */
if|if
condition|(
name|getApplication
argument_list|(
...
name|warn
argument_list|(
literal|"Scheduler not tracking application "
operator|+
name|container
operator|.
name|getId
