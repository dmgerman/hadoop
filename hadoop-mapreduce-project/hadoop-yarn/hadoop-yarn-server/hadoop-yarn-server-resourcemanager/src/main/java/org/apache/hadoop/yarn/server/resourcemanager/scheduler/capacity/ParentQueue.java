...
expr_stmt|;
block|}
DECL|method|setupQueueConfigs ( float capacity, float absoluteCapacity, float maximumCapacity, float absoluteMaxCapacity, QueueState state, Map<QueueACL, AccessControlList> acls )
specifier|private
...
block|}
block|}
DECL|method|addApplication (SchedulerApp application, String user)
specifier|private
specifier|synchronized
name|void
name|addApplication
...
block|}
block|}
DECL|method|removeApplication (SchedulerApp application, String user)
specifier|public
specifier|synchronized
name|void
name|removeApplication
...
return|;
block|}
DECL|method|canAssign (SchedulerNode node)
specifier|private
name|boolean
name|canAssign
parameter_list|(
