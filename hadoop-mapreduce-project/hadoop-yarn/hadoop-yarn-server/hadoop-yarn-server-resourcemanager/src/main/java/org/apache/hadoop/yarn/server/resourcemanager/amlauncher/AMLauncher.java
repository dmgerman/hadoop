...
argument_list|)
expr_stmt|;
comment|// Just not to touch the sec-info class
name|this
operator|.
name|applicationTokenSecretManager
operator|=
...
control|)
block|{
comment|// This is out-right wrong. AM FAIL count should be passed via env.
name|String
name|result
init|=
name|str
...
argument_list|)
expr_stmt|;
comment|/** add the failed count to the app master command line */
name|LOG
operator|.
name|info
argument_list|(
...
return|;
block|}
DECL|method|setupTokensInEnv ( ApplicationSubmissionContext asc)
specifier|private
name|Map
argument_list|<
name|String
