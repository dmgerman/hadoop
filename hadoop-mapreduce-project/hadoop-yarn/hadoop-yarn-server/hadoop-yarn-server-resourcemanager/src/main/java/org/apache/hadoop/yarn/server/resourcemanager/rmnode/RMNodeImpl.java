...
block|}
block|}
DECL|method|setNodeHealthStatus (NodeHealthStatus status)
specifier|private
name|void
...
block|}
block|}
DECL|method|updateMetricsForRejoinedNode (RMNodeState previousNodeState)
specifier|private
name|void
...
block|}
block|}
DECL|method|updateMetricsForDeactivatedNode (RMNodeState finalState)
specifier|private
name|void
...
parameter_list|)
block|{
comment|// Kill containers since node is rejoining.
name|rmNode
operator|.
name|context
operator|.
...
name|finalState
decl_stmt|;
DECL|method|DeactivateNodeTransition (RMNodeState finalState)
specifier|public
name|DeactivateNodeTransition
parameter_list|(
name|RMNodeState
