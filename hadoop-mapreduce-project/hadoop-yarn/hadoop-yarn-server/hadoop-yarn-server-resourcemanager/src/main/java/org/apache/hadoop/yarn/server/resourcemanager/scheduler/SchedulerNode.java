...
literal|"*"
decl_stmt|;
DECL|method|SchedulerNode (RMNode node)
specifier|public
name|SchedulerNode
parameter_list|(
name|RMNode
...
return|;
block|}
DECL|method|reserveResource ( SchedulerApp application, Priority priority, RMContainer reservedContainer)
specifier|public
specifier|synchronized
name|void
...
expr_stmt|;
block|}
DECL|method|unreserveResource (SchedulerApp application)
specifier|public
specifier|synchronized
name|void
