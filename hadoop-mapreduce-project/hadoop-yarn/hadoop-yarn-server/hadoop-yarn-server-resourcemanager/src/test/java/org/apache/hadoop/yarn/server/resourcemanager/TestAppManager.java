...
expr_stmt|;
block|}
DECL|method|TestRMAppManager (RMContext context, ClientToAMSecretManager clientToAMSecretManager, YarnScheduler scheduler, ApplicationMasterService masterService, Configuration conf)
specifier|public
name|TestRMAppManager
parameter_list|(
name|RMContext
