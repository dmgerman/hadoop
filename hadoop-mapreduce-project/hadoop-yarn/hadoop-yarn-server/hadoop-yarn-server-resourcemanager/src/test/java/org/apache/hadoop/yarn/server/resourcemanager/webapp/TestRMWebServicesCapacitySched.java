...
block|}
block|}
DECL|method|verifySubQueueGeneric (String q, float usedCapacity, float capacity, float maxCapacity, float absCapacity, float absMaxCapacity, float parentAbsCapacity, String qname, String state)
specifier|private
name|void
name|verifySubQueueGeneric
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|verifyLeafQueueGeneric (String q, int userLimit, float userLimitFactor)
specifier|private
name|void
name|verifyLeafQueueGeneric
parameter_list|(
