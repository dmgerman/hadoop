...
block|}
block|}
DECL|method|verifySubQueueXML (Element qElem, String q)
specifier|public
name|void
name|verifySubQueueXML
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|verifySubQueue (JSONObject info, String q)
specifier|private
name|void
name|verifySubQueue
parameter_list|(
...
block|}
block|}
DECL|method|verifySubQueueGeneric (String q, float usedCapacity, float capacity, float maxCapacity, String qname, String state)
specifier|private
name|void
name|verifySubQueueGeneric
parameter_list|(
