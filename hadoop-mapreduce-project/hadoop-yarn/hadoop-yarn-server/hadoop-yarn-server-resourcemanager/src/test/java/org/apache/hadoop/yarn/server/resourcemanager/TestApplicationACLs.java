...
name|fail
argument_list|(
literal|"App view by the enemy should fail!!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|info
argument_list|(
literal|"Got exception while viewing app as the enemy"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"User enemy cannot perform operation VIEW_APP on "
operator|+
name|applicationId
argument_list|,
name|e
...
name|assertEquals
argument_list|(
literal|"App view by enemy should not list any apps!!"
argument_list|,
literal|0
argument_list|,
name|enemyRmClient
