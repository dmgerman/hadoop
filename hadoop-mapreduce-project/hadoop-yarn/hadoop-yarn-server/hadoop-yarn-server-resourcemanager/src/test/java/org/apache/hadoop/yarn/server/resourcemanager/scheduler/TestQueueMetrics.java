...
expr_stmt|;
block|}
DECL|method|checkResources (MetricsSource source, int allocGB, int allocCtnrs, int availGB, int pendingGB, int pendingCtnrs, int reservedGB, int reservedCtnrs)
specifier|public
specifier|static
name|void
name|checkResources
