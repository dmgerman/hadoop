...
argument_list|)
expr_stmt|;
comment|//    appSubmissionContext.resources = new HashMap<String, URL>();
name|appSubmissionContext
operator|.
name|setUser
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//    appSubmissionContext.environment = new HashMap<String, String>();
comment|//    appSubmissionContext.command = new ArrayList<String>();
name|appSubmissionContext
operator|.
name|addCommand
argument_list|(
