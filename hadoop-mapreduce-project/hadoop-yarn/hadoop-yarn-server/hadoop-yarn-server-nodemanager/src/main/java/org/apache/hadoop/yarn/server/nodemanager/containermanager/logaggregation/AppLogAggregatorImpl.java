...
literal|null
decl_stmt|;
DECL|method|AppLogAggregatorImpl (DeletionService deletionService, Configuration conf, ApplicationId appId, UserGroupInformation userUgi, String[] localRootLogDirs, Path remoteNodeLogFileForApp, ContainerLogsRetentionPolicy retentionPolicy)
specifier|public
name|AppLogAggregatorImpl
parameter_list|(
name|DeletionService
...
parameter_list|()
block|{
comment|// Aggregation service is finishing
name|this
operator|.
name|finishLogAggregation
argument_list|()
...
name|warn
argument_list|(
literal|"Join interrupted. Some logs may not have been aggregated!!"
argument_list|)
expr_stmt|;
break|break;
block|}
