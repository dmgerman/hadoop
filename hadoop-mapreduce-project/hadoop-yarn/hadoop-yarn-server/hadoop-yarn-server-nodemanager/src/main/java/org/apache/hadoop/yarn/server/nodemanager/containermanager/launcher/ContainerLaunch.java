...
block|}
block|}
DECL|method|writeLaunchEnv (OutputStream out, Map<String,String> environment, Map<Path,String> resources, List<String> command, List<Path> appDirs)
specifier|private
specifier|static
name|void
name|writeLaunchEnv
...
condition|)
block|{
comment|// TODO: Get from whitelist.
name|sb
operator|.
name|env
argument_list|(
