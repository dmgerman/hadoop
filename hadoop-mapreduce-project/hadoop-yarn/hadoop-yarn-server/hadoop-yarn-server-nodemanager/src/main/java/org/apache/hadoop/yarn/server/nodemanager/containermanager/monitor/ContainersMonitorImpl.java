...
argument_list|)
decl_stmt|;
DECL|field|MONITORING_INTERVAL_CONFIG_KEY
specifier|private
specifier|final
specifier|static
name|String
name|MONITORING_INTERVAL_CONFIG_KEY
init|=
name|NMConfig
operator|.
name|NM_PREFIX
operator|+
literal|"containers-monitor.monitoring-interval"
decl_stmt|;
DECL|field|RESOURCE_CALCULATOR_PLUGIN_CONFIG_KEY
specifier|public
specifier|static
specifier|final
name|String
name|RESOURCE_CALCULATOR_PLUGIN_CONFIG_KEY
init|=
name|NMConfig
operator|.
name|NM_PREFIX
operator|+
literal|"containers-monitor.resourcecalculatorplugin"
decl_stmt|;
DECL|field|NM_RESERVED_PHYSICALMEMORY_MB
specifier|public
specifier|static
specifier|final
name|String
name|NM_RESERVED_PHYSICALMEMORY_MB
init|=
name|NMConfig
operator|.
name|NM_PREFIX
operator|+
literal|"reserved-physical-memory.mb"
decl_stmt|;
DECL|field|MONITORING_INTERVAL_DEFAULT
specifier|private
specifier|final
specifier|static
name|int
name|MONITORING_INTERVAL_DEFAULT
init|=
literal|3000
decl_stmt|;
