...
argument_list|)
decl_stmt|;
comment|// Clone to separate
comment|// sec-info classes
name|LocalizerTokenSecretManager
name|secretManager
init|=
literal|null
...
break|break;
block|}
comment|// We get separate events one each for all resources of one visibility. So
comment|// all the resources in this event are of the same visibility.
for|for
control|(
