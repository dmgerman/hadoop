...
argument_list|()
decl_stmt|;
DECL|method|ApplicationImpl (Dispatcher dispatcher, ApplicationACLsManager aclsManager, String user, ApplicationId appId, Credentials credentials)
specifier|public
name|ApplicationImpl
parameter_list|(
name|Dispatcher
...
argument_list|)
expr_stmt|;
comment|// TODO: Also make logService write the acls to the aggregated file.
block|}
block|}
annotation|@
name|Override
