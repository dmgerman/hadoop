...
name|nodeId
decl_stmt|;
DECL|field|isLogAggregationEnabled
specifier|private
name|boolean
...
name|threadPool
decl_stmt|;
DECL|method|LogAggregationService (Dispatcher dispatcher, Context context, DeletionService deletionService)
specifier|public
name|LogAggregationService
parameter_list|(
name|Dispatcher
...
parameter_list|)
block|{
comment|// Checking the existance of the TLD
name|FileSystem
name|remoteFS
init|=
literal|null
...
name|YarnException
argument_list|(
literal|"Unable to get Remote FileSystem isntance"
argument_list|,
name|e
argument_list|)
throw|;
...
name|YarnException
argument_list|(
literal|"Failed to check for existance of remoteLogDir ["
operator|+
name|this
operator|.
name|remoteRootLogDir
...
name|error
argument_list|(
literal|"Failed to get remote FileSystem while processing app "
operator|+
name|appId
argument_list|,
name|e
...
name|error
argument_list|(
literal|"Failed to create user dir ["
operator|+
name|userDir
operator|+
literal|"] while processing app "
operator|+
name|appId
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Failed to create suffixed user dir ["
operator|+
name|suffixDir
operator|+
literal|"] while processing app "
...
name|error
argument_list|(
literal|"Failed to  create application log dir ["
operator|+
name|appDir
operator|+
literal|"] while processing app "
