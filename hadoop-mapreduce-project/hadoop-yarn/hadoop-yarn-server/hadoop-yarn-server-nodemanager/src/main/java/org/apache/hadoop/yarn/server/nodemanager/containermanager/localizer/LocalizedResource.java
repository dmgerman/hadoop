...
name|info
argument_list|(
literal|"Attempt to release claim on "
operator|+
name|this
operator|+
literal|" from unregistered container "
operator|+
name|container
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|class|FetchDirectTransition
specifier|private
specifier|static
class|class
name|FetchDirectTransition
...
name|rsrc
operator|+
literal|" localized without listening container"
argument_list|)
expr_stmt|;
name|super
operator|.
...
block|}
block|}
DECL|class|ReleasePendingTransition
specifier|private
specifier|static
class|class
name|ReleasePendingTransition
