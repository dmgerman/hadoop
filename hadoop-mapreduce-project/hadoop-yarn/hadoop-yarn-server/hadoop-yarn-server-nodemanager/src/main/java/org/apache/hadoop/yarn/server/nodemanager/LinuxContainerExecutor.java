...
argument_list|)
block|,
DECL|enumConstant|DELETE_LOG_AS_USER
name|DELETE_LOG_AS_USER
argument_list|(
literal|4
argument_list|)
block|;
...
argument_list|)
block|,
DECL|enumConstant|INVALID_TASK_PID
name|INVALID_TASK_PID
argument_list|(
literal|9
argument_list|)
block|,
DECL|enumConstant|INVALID_TASKCONTROLLER_PERMISSIONS
