...
name|info
argument_list|(
literal|"Getting current user info failed when trying to launch the container"
operator|+
name|e
operator|.
name|getMessage
