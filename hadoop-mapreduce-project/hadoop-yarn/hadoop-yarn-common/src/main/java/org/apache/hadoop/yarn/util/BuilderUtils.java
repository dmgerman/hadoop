...
return|;
block|}
DECL|method|newContainer (RecordFactory recordFactory, ApplicationAttemptId appAttemptId, int containerId, NodeId nodeId, String nodeHttpAddress, Resource resource, Priority priority)
specifier|public
specifier|static
name|Container
name|newContainer
...
return|;
block|}
DECL|method|newContainer (ContainerId containerId, NodeId nodeId, String nodeHttpAddress, Resource resource, Priority priority)
specifier|public
specifier|static
name|Container
name|newContainer
