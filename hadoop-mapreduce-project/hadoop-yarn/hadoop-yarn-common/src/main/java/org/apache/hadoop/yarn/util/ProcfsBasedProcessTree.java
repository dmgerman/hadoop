...
return|;
block|}
DECL|method|checkPidPgrpidForMatch (int _pid, String procfs)
specifier|public
specifier|static
name|boolean
name|checkPidPgrpidForMatch
...
return|;
block|}
DECL|method|updateProcessInfo (String name, Integer ppid, Integer pgrpId, Integer sessionId, Long utime, Long stime, Long vmem, Long rssmem)
specifier|public
name|void
name|updateProcessInfo
parameter_list|(
