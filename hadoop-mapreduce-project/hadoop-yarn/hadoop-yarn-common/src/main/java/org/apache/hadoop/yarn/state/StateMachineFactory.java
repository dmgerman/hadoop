...
expr_stmt|;
block|}
DECL|method|StateMachineFactory (StateMachineFactory<OPERAND, STATE, EVENTTYPE, EVENT> that, ApplicableTransition t)
specifier|private
name|StateMachineFactory
parameter_list|(
name|StateMachineFactory
...
name|next
decl_stmt|;
DECL|method|TransitionsListNode (ApplicableTransition transition, TransitionsListNode next)
name|TransitionsListNode
parameter_list|(
name|ApplicableTransition
name|transition
