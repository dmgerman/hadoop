...
return|;
block|}
comment|/**    * Convert a protobuf token into a rpc token and set its service    *     * @param protoToken the yarn token    * @param serviceAddr the connect address for the service    * @return rpc token    */
specifier|public
specifier|static
parameter_list|<
name|T
...
name|T
argument_list|>
DECL|method|convertFromProtoFormat (DelegationToken protoToken, InetSocketAddress serviceAddr)
name|convertFromProtoFormat
parameter_list|(
name|DelegationToken
name|protoToken
