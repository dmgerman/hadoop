...
return|;
block|}
DECL|method|getMatchingLevelForNodes (Node n1, Node n2, int maxLevel)
specifier|static
name|int
name|getMatchingLevelForNodes
parameter_list|(
...
literal|0
decl_stmt|;
comment|// In the case that the two nodes are at different levels in the
comment|// node heirarchy, walk upwards on the deeper one until the
comment|// levels are equal. Each of these counts as "distance" since it
comment|// assumedly is going through another rack.
name|int
name|level1
init|=
name|n1
