...
expr_stmt|;
block|}
DECL|field|metricsUpdater
specifier|private
name|MetricsUpdater
name|metricsUpdater
decl_stmt|;
comment|// responsible for pushing hadoop metrics
...
return|;
block|}
comment|/**    * Register metrics for the fair scheduler, and start a thread    * to update them periodically.    */
...
block|}
block|}
comment|/**    * Responsible for updating metrics when the metrics context requests it.    */
DECL|class|MetricsUpdater
specifier|private
class|class
name|MetricsUpdater
implements|implements
...
block|}
block|}
DECL|method|jobNoLongerRunning (JobInProgress job)
specifier|private
name|void
name|jobNoLongerRunning
parameter_list|(
...
return|;
block|}
DECL|method|getLastPreemptionUpdateTime ()
name|long
