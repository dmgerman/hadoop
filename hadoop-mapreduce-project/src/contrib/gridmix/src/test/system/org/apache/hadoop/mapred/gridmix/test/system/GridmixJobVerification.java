...
argument_list|)
expr_stmt|;
name|verifyMemoryEmulationOfJobs
argument_list|(
name|zombieJob
argument_list|,
name|jhInfo
...
block|}
block|}
comment|/**    * It verifies the heap memory resource usage of gridmix jobs with    * corresponding original job in the trace.    * @param zombieJob - Original job history.    * @param jhInfo - Simulated job history.    * @param simuJobConf - simulated job configuration.    */
DECL|method|verifyMemoryEmulationOfJobs (ZombieJob zombieJob, JobHistoryParser.JobInfo jhInfo, JobConf simuJobConf)
specifier|public
name|void
name|verifyMemoryEmulationOfJobs
parameter_list|(
...
name|info
argument_list|(
literal|"Original Job Maps Total Heap Usage: "
operator|+
name|origJobMapsTHU
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Original Job Reduces Total Heap Usage: "
operator|+
name|origJobReducesTHU
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Simulated Job Maps Total Heap Usage: "
operator|+
name|simuJobMapsTHU
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Simulated Jobs Reduces Total Heap Usage: "
operator|+
name|simuJobReducesTHU
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Maps memory emulation accuracy of a job:"
operator|+
name|mapEmulAccuracy
operator|+
literal|"%"
...
name|assertTrue
argument_list|(
literal|"Map phase total memory emulation had crossed the "
operator|+
literal|"configured max limit."
argument_list|,
name|mapEmulAccuracy
operator|<=
name|GridMixConfig
...
name|assertTrue
argument_list|(
literal|"Map phase total memory emulation had not crossed "
operator|+
literal|"the configured min limit."
argument_list|,
name|mapEmulAccuracy
operator|>=
name|GridMixConfig
...
name|assertTrue
argument_list|(
literal|"Simulate job maps heap ratio not matched."
argument_list|,
name|actHeapRatio
operator|<=
name|expHeapRatio
...
name|info
argument_list|(
literal|"Reduces memory emulation accuracy of a job:"
operator|+
name|reduceEmulAccuracy
operator|+
literal|"%"
...
name|assertTrue
argument_list|(
literal|"Reduce phase total memory emulation had crossed "
operator|+
literal|"configured max limit."
argument_list|,
name|reduceEmulAccuracy
...
name|assertTrue
argument_list|(
literal|"Reduce phase total memory emulation had not "
operator|+
literal|"crosssed configured min limit."
argument_list|,
name|reduceEmulAccuracy
operator|>=
name|GridMixConfig
...
name|info
argument_list|(
literal|"expHeapRatio for reduces:"
operator|+
name|expHeapRatio
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"actHeapRatio for reduces:"
operator|+
name|actHeapRatio
argument_list|)
expr_stmt|;
...
name|assertTrue
argument_list|(
literal|"Simulate job reduces heap ratio not matched."
argument_list|,
name|actHeapRatio
operator|<=
name|expHeapRatio
...
block|}
block|}
comment|/**    * It verifies the cpu resource usage of  a gridmix job against    * their original job.    * @param origJobHistory - Original job history.    * @param simuJobHistoryInfo - Simulated job history.    * @param simuJobConf - simulated job configuration.    */
DECL|method|verifyCPUEmulationOfJobs (ZombieJob origJobHistory, JobHistoryParser.JobInfo simuJobHistoryInfo, JobConf simuJobConf)
specifier|public
name|void
name|verifyCPUEmulationOfJobs
parameter_list|(
...
name|simuJobMetrics
init|=
name|getSimulatedJobCPUMetrics
argument_list|(
name|simuJobHistoryInfo
argument_list|)
decl_stmt|;
...
name|info
argument_list|(
literal|"Maps cpu usage of original job:"
operator|+
name|origMapUsage
argument_list|)
expr_stmt|;
name|long
name|origReduceUsage
init|=
name|origJobMetrics
operator|.
name|get
...
name|info
argument_list|(
literal|"Reduces cpu usage of original job:"
operator|+
name|origReduceUsage
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Maps cpu usage of simulated job:"
operator|+
name|simuMapUsage
argument_list|)
expr_stmt|;
name|long
name|simuReduceUsage
init|=
name|simuJobMetrics
operator|.
name|get
...
name|info
argument_list|(
literal|"Reduces cpu usage of simulated job:"
operator|+
name|simuReduceUsage
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"CPU emulation accuracy for maps in job "
operator|+
name|simuJobHistoryInfo
operator|.
name|getJobId
...
name|assertTrue
argument_list|(
literal|"Map-side cpu emulaiton inaccurate!"
operator|+
literal|" Actual cpu usage: "
operator|+
name|simuMapUsage
operator|+
literal|" Expected cpu usage: "
operator|+
name|origMapUsage
argument_list|,
name|mapEmulAccuracy
...
name|info
argument_list|(
literal|"CPU emulation accuracy for reduces in job "
operator|+
name|simuJobHistoryInfo
operator|.
name|getJobId
...
name|assertTrue
argument_list|(
literal|"Reduce side cpu emulaiton inaccurate!"
operator|+
literal|" Actual cpu usage:"
operator|+
name|simuReduceUsage
...
block|}
block|}
comment|/**    *  Get the simulated job cpu metrics.    * @param jhInfo - Simulated job history    * @return - cpu metrics as a map.    * @throws Exception - if an error occurs.    */
DECL|method|getSimulatedJobCPUMetrics ( JobHistoryParser.JobInfo jhInfo)
specifier|private
name|Map
argument_list|<
name|String
...
return|;
block|}
comment|/**    * Get the original job cpu metrics.    * @param zombieJob - original job history.    * @return - cpu metrics as map.    */
DECL|method|getOriginalJobCPUMetrics (ZombieJob zombieJob)
specifier|private
name|Map
argument_list|<
name|String
...
block|{
name|long
name|mapTotalCPUUsage
init|=
literal|0
decl_stmt|;
name|long
name|reduceTotalCPUUsage
init|=
literal|0
decl_stmt|;
name|Map
