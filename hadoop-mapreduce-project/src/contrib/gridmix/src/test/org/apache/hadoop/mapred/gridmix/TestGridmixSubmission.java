...
expr_stmt|;
block|}
comment|/** Submit Gridmix run and verify that it succeeds */
...
expr_stmt|;
block|}
comment|/**    * Setup args for Gridmix run and run gridmix and verify the exit code.    * @param useDefaultQueue whether to use default queue or not    * @param argv array of arguments to gridmix    * @param expectedExitCode the expected exit code of Gridmix run    */
DECL|method|testGridmixExitCode (boolean useDefaultQueue, String[] argv, int expectedExitCode)
specifier|static
name|void
name|testGridmixExitCode
parameter_list|(
...
block|}
block|}
comment|/** Run gridmix with specified arguments and verify the exit code. */
DECL|method|runGridmix (boolean useDefaultQueue, String[] argv, int expectedExitCode)
specifier|private
specifier|static
name|void
name|runGridmix
...
name|assertEquals
argument_list|(
literal|"Gridmix exited with wrong exit status"
argument_list|,
name|expectedExitCode
argument_list|,
name|res
...
argument_list|)
expr_stmt|;
comment|// Verify the permissions of ioPath
name|FsPermission
name|perm
init|=
name|GridmixTestUtils
...
name|assertEquals
argument_list|(
literal|"Wrong permissions of ioPath"
argument_list|,
operator|new
name|FsPermission
argument_list|(
...
block|}
block|}
comment|/**    * Create the list of arguments for the Gridmix run.    * @param defaultOutputPath Should the default output path be used for the    *                          Gridmix run ?    * @param userResolver the user resolver for the Gridmix run    * @return the array of arguments to Gridmix    */
DECL|method|prepareArgs (boolean defaultOutputPath, String userResolver)
specifier|static
name|String
index|[]
name|prepareArgs
...
return|;
block|}
comment|/** If the given path exists, deletes it and its contents recursively */
DECL|method|deletePath (Path dir)
specifier|private
specifier|static
name|void
name|deletePath
