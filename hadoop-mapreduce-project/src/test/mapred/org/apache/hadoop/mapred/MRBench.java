...
argument_list|>
block|{
DECL|method|map (WritableComparable key, Text value, OutputCollector<UTF8, UTF8> output, Reporter reporter)
specifier|public
name|void
name|map
parameter_list|(
...
argument_list|>
block|{
DECL|method|reduce (UTF8 key, Iterator<UTF8> values, OutputCollector<UTF8, UTF8> output, Reporter reporter)
specifier|public
name|void
name|reduce
parameter_list|(
