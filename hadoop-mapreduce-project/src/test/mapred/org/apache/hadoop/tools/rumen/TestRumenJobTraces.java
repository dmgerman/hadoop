...
argument_list|)
decl_stmt|;
comment|// this is same as the one in input history file
name|String
name|jobId
init|=
literal|"job_200904211745_0002"
decl_stmt|;
name|JobBuilder
name|builder
init|=
...
argument_list|()
decl_stmt|;
comment|// validate the obtainXXX api of ParsedJob, ParsedTask and
comment|// ParsedTaskAttempt
name|validateParsedJob
argument_list|(
name|parsedJob
argument_list|,
literal|20
...
block|}
block|}
comment|/**    * Validate the parsing of given history file name.     *     * TODO: Also validate the history file name suffixed with old/stale file     *       suffix.    * @param jhFileName job history file path    * @param jid JobID    */
DECL|method|validateHistoryFileNameParsing (Path jhFileName, org.apache.hadoop.mapred.JobID jid)
specifier|private
name|void
name|validateHistoryFileNameParsing
parameter_list|(
name|Path
name|jhFileName
parameter_list|,
...
argument_list|)
expr_stmt|;
comment|//TODO test jobhistory filename with old/stale file suffix
block|}
comment|/**    * Validate the parsing of given history conf file name. Also validate the    * history conf file name suffixed with old/stale file suffix.    * @param jhConfFileName job history conf file path    * @param jid JobID    */
DECL|method|validateJHConfFileNameParsing (Path jhConfFileName, org.apache.hadoop.mapred.JobID jid)
specifier|private
name|void
name|validateJHConfFileNameParsing
parameter_list|(
name|Path
name|jhConfFileName
parameter_list|,
...
name|assertTrue
argument_list|(
literal|"TraceBuilder failed to parse the JH conf filename:"
operator|+
name|jhConfFileName
argument_list|,
name|JobHistoryUtils
...
expr_stmt|;
block|}
comment|/**    * Tests if {@link TraceBuilder} can correctly identify and parse different    * versions of jobhistory filenames. The testcase checks if    * {@link TraceBuilder}    *   - correctly identifies a jobhistory filename without suffix    *   - correctly parses a jobhistory filename without suffix to extract out     *     the jobid    *   - correctly identifies a jobhistory filename with suffix    *   - correctly parses a jobhistory filename with suffix to extract out the     *     jobid    *   - correctly identifies a job-configuration filename stored along with the     *     jobhistory files    */
annotation|@
name|Test
...
argument_list|)
decl_stmt|;
comment|// Check if current jobhistory filenames are detected properly
name|JobId
name|jobId
init|=
name|TypeConverter
...
argument_list|)
expr_stmt|;
comment|// Check if Pre21 V1 jophistory file names are detected properly
name|jhFilename
operator|=
operator|new
name|Path
argument_list|(
literal|"jt-identifier_"
operator|+
name|jid
operator|+
literal|"_user-name_job-name"
argument_list|)
expr_stmt|;
name|validateHistoryFileNameParsing
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Check if Pre21 V2 jobhistory file names are detected properly
name|jhFilename
operator|=
operator|new
name|Path
...
argument_list|)
expr_stmt|;
comment|// Check if the current jobhistory conf filenames are detected properly
name|Path
name|jhConfFilename
init|=
name|JobHistory
...
argument_list|)
expr_stmt|;
comment|// Check if Pre21 V1 jobhistory conf file names are detected properly
name|jhConfFilename
operator|=
operator|new
name|Path
...
argument_list|)
expr_stmt|;
comment|// Check if Pre21 V2 jobhistory conf file names are detected properly
name|jhConfFilename
operator|=
operator|new
name|Path
...
block|}
block|}
comment|/**    * Verify if the obtainXXX methods of {@link ParsedJob}, {@link ParsedTask}    * and {@link ParsedTaskAttempt} give valid info    */
DECL|method|validateParsedJob (ParsedJob parsedJob, int numMaps, int numReduces, boolean pre21JobHistory)
specifier|private
name|void
name|validateParsedJob
parameter_list|(
...
parameter_list|,
name|boolean
name|pre21JobHistory
parameter_list|)
block|{
name|validateParsedJobAPI
argument_list|(
name|parsedJob
argument_list|,
name|numMaps
...
block|}
block|}
comment|/** Verify if the obtainXXX methods of {@link ParsedJob} give valid info */
DECL|method|validateParsedJobAPI (ParsedJob parsedJob, int numMaps, int numReduces, boolean pre21JobHistory)
specifier|private
name|void
name|validateParsedJobAPI
parameter_list|(
...
name|info
argument_list|(
literal|"Validating ParsedJob.obtainXXX api... for "
operator|+
name|parsedJob
operator|.
name|getJobID
...
name|assertNotNull
argument_list|(
literal|"Job acls in ParsedJob is null"
argument_list|,
name|parsedJob
operator|.
name|obtainJobAcls
...
name|assertNotNull
argument_list|(
literal|"Job conf path in ParsedJob is null"
argument_list|,
name|parsedJob
operator|.
...
name|assertNotNull
argument_list|(
literal|"Map Counters in ParsedJob is null"
argument_list|,
name|parsedJob
operator|.
...
name|assertNotNull
argument_list|(
literal|"Reduce Counters in ParsedJob is null"
argument_list|,
name|parsedJob
operator|.
...
name|assertNotNull
argument_list|(
literal|"Total Counters in ParsedJob is null"
argument_list|,
name|parsedJob
operator|.
...
name|assertNotNull
argument_list|(
literal|"Map Tasks List in ParsedJob is null"
argument_list|,
name|parsedJob
operator|.
name|obtainMapTasks
...
name|assertNotNull
argument_list|(
literal|"Reduce Tasks List in ParsedJob is null"
argument_list|,
name|parsedJob
operator|.
name|obtainReduceTasks
...
name|assertNotNull
argument_list|(
literal|"Other Tasks List in ParsedJob is null"
argument_list|,
name|parsedJob
operator|.
name|obtainOtherTasks
...
argument_list|)
expr_stmt|;
comment|// 1 map and 1 reduce task should be there
name|assertEquals
argument_list|(
literal|"Number of map tasks in ParsedJob is wrong"
argument_list|,
name|numMaps
argument_list|,
name|parsedJob
...
name|assertEquals
argument_list|(
literal|"Number of reduce tasks in ParsedJob is wrong"
argument_list|,
name|numReduces
argument_list|,
name|parsedJob
...
argument_list|)
expr_stmt|;
comment|// old hadoop20 version history files don't have job-level-map-counters and
comment|// job-level-reduce-counters. Only total counters exist there.
name|assertTrue
argument_list|(
literal|"Total Counters in ParsedJob is empty"
argument_list|,
name|parsedJob
operator|.
name|obtainTotalCounters
...
name|assertTrue
argument_list|(
literal|"Map Counters in ParsedJob is empty"
argument_list|,
name|parsedJob
operator|.
name|obtainMapCounters
...
name|assertTrue
argument_list|(
literal|"Reduce Counters in ParsedJob is empty"
argument_list|,
name|parsedJob
operator|.
name|obtainReduceCounters
...
block|}
block|}
comment|/**    * Verify if the obtainXXX methods of {@link ParsedTask} and    * {@link ParsedTaskAttempt} give valid info    */
DECL|method|validateParsedTask (ParsedTask parsedTask)
specifier|private
name|void
name|validateParsedTask
parameter_list|(
...
control|)
block|{
name|validateParsedTaskAttemptAPI
argument_list|(
name|attempt
argument_list|)
expr_stmt|;
block|}
block|}
comment|/** Verify if the obtainXXX methods of {@link ParsedTask} give valid info */
DECL|method|validateParsedTaskAPI (ParsedTask parsedTask)
specifier|private
name|void
name|validateParsedTaskAPI
parameter_list|(
...
name|info
argument_list|(
literal|"Validating ParsedTask.obtainXXX api... for "
operator|+
name|parsedTask
operator|.
name|getTaskID
...
name|assertNotNull
argument_list|(
literal|"Task counters in ParsedTask is null"
argument_list|,
name|parsedTask
operator|.
name|obtainCounters
...
condition|)
block|{
comment|// task counters should not be empty
name|assertTrue
argument_list|(
literal|"Task counters in ParsedTask is empty"
argument_list|,
name|parsedTask
operator|.
name|obtainCounters
...
name|assertNull
argument_list|(
literal|"Diagnostic-info is non-null for a succeeded task"
argument_list|,
name|parsedTask
operator|.
...
name|assertNull
argument_list|(
literal|"Failed-due-to-attemptId is non-null for a succeeded task"
argument_list|,
name|parsedTask
operator|.
...
name|assertNotNull
argument_list|(
literal|"TaskAttempts list in ParsedTask is null"
argument_list|,
name|attempts
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
literal|"TaskAttempts list in ParsedTask is empty"
argument_list|,
name|attempts
operator|.
name|size
...
expr_stmt|;
block|}
comment|/**    * Verify if the obtainXXX methods of {@link ParsedTaskAttempt} give    * valid info    */
DECL|method|validateParsedTaskAttemptAPI ( ParsedTaskAttempt parsedTaskAttempt)
specifier|private
name|void
name|validateParsedTaskAttemptAPI
parameter_list|(
...
name|info
argument_list|(
literal|"Validating ParsedTaskAttempt.obtainXXX api... for "
operator|+
name|parsedTaskAttempt
operator|.
name|getAttemptID
...
name|assertNotNull
argument_list|(
literal|"Counters in ParsedTaskAttempt is null"
argument_list|,
name|parsedTaskAttempt
operator|.
name|obtainCounters
...
name|assertTrue
argument_list|(
literal|"Counters in ParsedTaskAttempt is empty"
argument_list|,
name|parsedTaskAttempt
operator|.
name|obtainCounters
...
name|assertNull
argument_list|(
literal|"Diagnostic-info is non-null for a succeeded taskAttempt"
argument_list|,
name|parsedTaskAttempt
operator|.
name|obtainDiagnosticInfo
...
name|assertNotNull
argument_list|(
literal|"TrackerName in ParsedTaskAttempt is null"
argument_list|,
name|parsedTaskAttempt
operator|.
...
name|assertNotNull
argument_list|(
literal|"http-port info in ParsedTaskAttempt is null"
argument_list|,
name|parsedTaskAttempt
operator|.
name|obtainHttpPort
...
name|assertNotNull
argument_list|(
literal|"Shuffle-port info in ParsedTaskAttempt is null"
argument_list|,
name|parsedTaskAttempt
operator|.
...
argument_list|()
decl_stmt|;
comment|// This 4 comes from
comment|//   TaskInProgress.ProgressibleSplitsBlock.burst().size , which
comment|//   is invisible here.
name|int
index|[]
index|[]
name|splits
...
literal|1234567890L
argument_list|,
literal|"/194\\.6\\.134\\.64"
argument_list|,
literal|"cluster50261\\.secondleveldomain\\.com"
argument_list|,
literal|"SUCCESS"
argument_list|,
literal|null
...
literal|1234567890L
argument_list|,
literal|"cluster50262\\.secondleveldomain\\.com"
argument_list|,
operator|-
literal|1
argument_list|,
literal|"/194\\.6\\.134\\.80"
argument_list|,
...
literal|1234567890L
argument_list|,
literal|"cluster50263\\.secondleveldomain\\.com"
argument_list|,
operator|-
literal|1
argument_list|,
