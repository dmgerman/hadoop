...
name|Job
block|{
comment|// Backward compatibility: if the failed or killed map/reduce
comment|// count is -1, that means the value was not recorded
comment|// so we count it as 0
DECL|field|UNDEFINED_VALUE
specifier|private
specifier|static
specifier|final
name|int
