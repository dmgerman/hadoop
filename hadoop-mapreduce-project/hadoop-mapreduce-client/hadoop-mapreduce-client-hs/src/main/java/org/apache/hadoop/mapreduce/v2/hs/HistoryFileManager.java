...
block|}
block|}
comment|/**    * DistributedFileSystem returns a RemoteException with a message stating    * SafeModeException in it. So this is only way to check it is because of    * being in safe mode.    */
DECL|method|isBecauseSafeMode (Throwable ex)
specifier|private
name|boolean
name|isBecauseSafeMode
parameter_list|(
name|Throwable
name|ex
parameter_list|)
...
argument_list|)
expr_stmt|;
name|checkHistoryDirsPermissions
argument_list|(
name|doneDirFc
argument_list|,
name|doneDirPrefixPath
...
block|}
block|}
DECL|method|checkHistoryDirsPermissions (FileContext fc, Path donePath, FsPermission fsp)
specifier|private
name|void
name|checkHistoryDirsPermissions
parameter_list|(
...
block|}
block|}
DECL|method|setPermission (FileContext fc, Path donePath, FsPermission fsp, FileStatus dir)
specifier|private
name|void
name|setPermission
parameter_list|(
