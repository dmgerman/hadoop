...
name|println
argument_list|(
literal|"Usage: mapred hsadmin [-refreshLoadedJobCache]"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|println
argument_list|(
literal|"Usage: mapred hsadmin [-refreshLogRetentionSettings]"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
init|=
literal|"-refreshLoadedJobCache: Refresh loaded job cache of Job history server\n"
decl_stmt|;
name|String
...
name|IOException
block|{
comment|// Refresh the loaded job cache
name|Configuration
name|conf
init|=
name|getConf
...
name|IOException
block|{
comment|// Refresh log retention settings
name|Configuration
name|conf
init|=
name|getConf
