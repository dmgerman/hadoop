...
name|message
init|=
literal|"Native output collector don't support customized java comparator "
operator|+
name|job
operator|.
name|get
...
name|message
init|=
literal|"Native output collector don't support compression codec "
operator|+
name|job
operator|.
name|get
...
argument_list|)
operator|+
literal|", We support Gzip, Lz4, snappy"
decl_stmt|;
name|LOG
operator|.
name|error
...
name|message
init|=
literal|"Native-Task don't support sort class "
operator|+
name|job
operator|.
name|get
...
name|message
init|=
literal|"Native-Task don't support secure shuffle"
decl_stmt|;
name|LOG
operator|.
name|error
...
name|message
init|=
literal|"Native output collector don't support this key, this key is not comparable in native "
operator|+
name|keyCls
operator|.
name|getName
...
expr_stmt|;
block|}
DECL|method|isCodecSupported (String string)
specifier|private
name|boolean
name|isCodecSupported
parameter_list|(
