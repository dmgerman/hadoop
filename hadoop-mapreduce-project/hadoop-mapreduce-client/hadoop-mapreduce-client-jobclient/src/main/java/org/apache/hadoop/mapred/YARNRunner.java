...
literal|"rack"
decl_stmt|;
DECL|field|NODE_IF_RACK_GROUP
specifier|private
specifier|static
specifier|final
name|String
name|NODE_IF_RACK_GROUP
init|=
literal|"node1"
decl_stmt|;
DECL|field|NODE_IF_NO_RACK_GROUP
specifier|private
specifier|static
specifier|final
name|String
name|NODE_IF_NO_RACK_GROUP
init|=
literal|"node2"
decl_stmt|;
comment|/**    * Matches any of the following patterns with capturing groups:    *<ul>    *<li>/rack</li>    *<li>/rack/node</li>    *<li>node (assumes /default-rack)</li>    *</ul>    * The groups can be retrieved using the RACK_GROUP, NODE_IF_RACK_GROUP,    * and/or NODE_IF_NO_RACK_GROUP group keys.    */
DECL|field|RACK_NODE_PATTERN
specifier|private
specifier|static
specifier|final
name|Pattern
name|RACK_NODE_PATTERN
init|=
name|Pattern
operator|.
name|compile
...
return|;
block|}
DECL|method|createApplicationResource (FileContext fs, Path p, String fileSymlink, LocalResourceType type, LocalResourceVisibility viz, Boolean uploadToSharedCache)
specifier|private
name|LocalResource
name|createApplicationResource
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// We hard code the job.jar symlink because mapreduce code expects the
comment|// job.jar to be named that way.
name|FileContext
name|fccc
init|=
name|FileContext
...
argument_list|)
expr_stmt|;
comment|// Setup the AM ResourceRequests
name|List
argument_list|<
name|ResourceRequest
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// set labels for the AM container requests if present
name|String
...
return|;
block|}
DECL|method|generateResourceRequests ()
specifier|private
name|List
argument_list|<
name|ResourceRequest
...
condition|)
block|{
comment|// the "mb", "cpu-vcores" resource types are not processed here
comment|// since the yarn.app.mapreduce.am.resource.mb,
comment|// yarn.app.mapreduce.am.resource.cpu-vcores keys are used for
comment|// backward-compatibility - which is handled after this loop
name|ResourceInformation
name|resourceInformation
init|=
name|capability
...
argument_list|()
decl_stmt|;
comment|// Always have an ANY request
name|ResourceRequest
name|amAnyResourceRequest
init|=
name|createAMResourceRequest
argument_list|(
name|ResourceRequest
operator|.
name|ANY
...
name|debug
argument_list|(
literal|"ResourceRequest: resource = "
operator|+
name|amResourceRequest
operator|.
...
return|;
block|}
DECL|method|createAMResourceRequest (String resource, Resource capability)
specifier|private
name|ResourceRequest
name|createAMResourceRequest
parameter_list|(
