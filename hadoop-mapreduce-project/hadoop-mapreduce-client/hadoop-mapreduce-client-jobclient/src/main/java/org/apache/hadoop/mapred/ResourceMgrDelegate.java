...
expr_stmt|;
block|}
comment|/**    * Delegate responsible for communicating with the Resource Manager's    * {@link ApplicationClientProtocol}.    * @param conf the configuration object.    * @param rmAddress the address of the Resource Manager    */
DECL|method|ResourceMgrDelegate (YarnConfiguration conf, InetSocketAddress rmAddress)
specifier|public
name|ResourceMgrDelegate
parameter_list|(
name|YarnConfiguration
