...
annotation|@
name|Test
DECL|method|testAMStandardEnvWithCustomLibPathWithSeparateEnvProps ()
specifier|public
name|void
name|testAMStandardEnvWithCustomLibPathWithSeparateEnvProps
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testAMStandardEnv (boolean customLibPath, boolean useSeparateEnvProps)
specifier|private
name|void
name|testAMStandardEnv
parameter_list|(
...
condition|)
block|{
comment|// Specify these as individual variables instead of k=v lists
name|jobConf
operator|.
name|set
argument_list|(
