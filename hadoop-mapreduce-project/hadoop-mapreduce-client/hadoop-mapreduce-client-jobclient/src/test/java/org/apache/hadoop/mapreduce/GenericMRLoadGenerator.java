...
name|Tool
block|{
DECL|field|MAP_PRESERVE_PERCENT
specifier|public
specifier|static
name|String
name|MAP_PRESERVE_PERCENT
init|=
literal|"mapreduce.loadgen.sort.map.preserve.percent"
decl_stmt|;
DECL|field|REDUCE_PRESERVE_PERCENT
specifier|public
specifier|static
name|String
name|REDUCE_PRESERVE_PERCENT
init|=
literal|"mapreduce.loadgen.sort.reduce.preserve.percent"
decl_stmt|;
DECL|field|INDIRECT_INPUT_FORMAT
specifier|public
specifier|static
name|String
name|INDIRECT_INPUT_FORMAT
init|=
literal|"mapreduce.loadgen.indirect.input.format"
decl_stmt|;
DECL|field|INDIRECT_INPUT_FILE
specifier|public
specifier|static
name|String
name|INDIRECT_INPUT_FILE
init|=
literal|"mapreduce.loadgen.indirect.input.file"
decl_stmt|;
...
DECL|method|parseArgs (String[] argv, Job job)
specifier|public
specifier|static
name|boolean
name|parseArgs
...
expr_stmt|;
block|}
DECL|method|map (Text key, Text val, Context context)
specifier|public
name|void
name|map
parameter_list|(
...
DECL|method|confRandom (Job job)
specifier|protected
specifier|static
name|void
name|confRandom
...
expr_stmt|;
block|}
DECL|method|emit (K key, V val, Context context)
specifier|protected
name|void
name|emit
parameter_list|(
...
block|}
block|}
DECL|class|SampleReduceBase
specifier|static
specifier|abstract
class|class
name|SampleReduceBase
parameter_list|<
name|K
extends|extends
name|WritableComparable
...
argument_list|>
block|{
DECL|method|reduce (K key, Iterable<V> values, Context context)
specifier|public
name|void
name|reduce
parameter_list|(
