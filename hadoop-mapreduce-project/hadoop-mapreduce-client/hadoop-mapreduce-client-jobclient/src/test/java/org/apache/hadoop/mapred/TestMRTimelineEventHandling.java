...
expr_stmt|;
block|}
DECL|method|verifyMetricsWhenEvent (File entityFile, String eventId)
specifier|private
name|void
name|verifyMetricsWhenEvent
parameter_list|(
...
expr_stmt|;
name|boolean
name|jobMetricsFoundForAppEntity
init|=
literal|false
decl_stmt|;
while|while
...
comment|// ApplicationEntity is published without events, hence loop all
if|if
condition|(
name|entity
operator|.
