...
annotation|@
name|Test
DECL|method|testClusterExceptionRootCause ()
specifier|public
name|void
name|testClusterExceptionRootCause
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Cluster init should fail because of non-existing FileSystem"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertTrue
argument_list|(
literal|"No root cause detected"
argument_list|,
name|stackTrace
operator|.
name|contains
