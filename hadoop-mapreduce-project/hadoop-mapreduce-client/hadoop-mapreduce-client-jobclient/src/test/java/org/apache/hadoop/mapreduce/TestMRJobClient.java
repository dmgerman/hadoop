...
DECL|method|testfailTask (Job job, Configuration conf)
specifier|private
name|void
name|testfailTask
parameter_list|(
...
name|fail
argument_list|(
literal|" this task should field"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
DECL|method|testKillTask (Job job, Configuration conf)
specifier|private
name|void
name|testKillTask
parameter_list|(
...
name|fail
argument_list|(
literal|" this task should be killed"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
DECL|method|testKillJob (String jobId, Configuration conf)
specifier|private
name|void
name|testKillJob
parameter_list|(
