...
begin_class
DECL|class|TestCombineSequenceFileInputFormat
specifier|public
class|class
name|TestCombineSequenceFileInputFormat
block|{
DECL|field|LOG
specifier|private
specifier|static
...
argument_list|)
argument_list|,
literal|"TestCombineSequenceFileInputFormat"
argument_list|)
decl_stmt|;
annotation|@
name|Test
...
literal|10
decl_stmt|;
comment|// create files with a variety of lengths
name|createFiles
argument_list|(
name|length
argument_list|,
...
argument_list|)
decl_stmt|;
comment|// create a combine split for the files
name|InputFormat
argument_list|<
name|IntWritable
argument_list|,
...
name|assertNotNull
argument_list|(
literal|"Value should not be null."
argument_list|,
name|value
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|createFiles (int length, int numFiles, Random random, Job job)
specifier|private
specifier|static
name|void
name|createFiles
