...
block|}
block|}
comment|/**    * Map class which checks if hadoop lib location     * is in the execution path    */
DECL|class|ExecutionEnvCheckMapClass
specifier|public
specifier|static
class|class
name|ExecutionEnvCheckMapClass
extends|extends
name|MapReduceBase
implements|implements
name|Mapper
...
name|assertTrue
argument_list|(
literal|"execution path does not include the hadoop lib location "
operator|+
name|toFind
argument_list|,
name|executionPaths
...
name|fail
argument_list|(
literal|"Exception in testing execution environment for MapReduce task"
argument_list|)
expr_stmt|;
name|tearDown
argument_list|()
...
literal|"The input"
decl_stmt|;
comment|// set config to use the ExecutionEnvCheckMapClass map class
name|configure
argument_list|(
name|conf
argument_list|,
...
name|fail
argument_list|(
literal|"Exception in testing propagation of env setting to child task"
argument_list|)
expr_stmt|;
name|tearDown
argument_list|()
