...
specifier|final
name|String
name|DEFAULT_ABS_TMP_PATH
init|=
literal|"/tmp"
decl_stmt|;
specifier|final
name|String
name|DEFAULT_REL_TMP_PATH
init|=
literal|"../temp"
decl_stmt|;
name|String
...
expr_stmt|;
block|}
comment|// Launch job by giving relative path to temp dir.
name|LOG
operator|.
name|info
argument_list|(
literal|"Testing with relative temp dir = "
operator|+
name|relativeTempPath
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Launch job by giving absolute path to temp dir
name|LOG
operator|.
name|info
argument_list|(
literal|"Testing with absolute temp dir = "
operator|+
name|absoluteTempPath
argument_list|)
expr_stmt|;
