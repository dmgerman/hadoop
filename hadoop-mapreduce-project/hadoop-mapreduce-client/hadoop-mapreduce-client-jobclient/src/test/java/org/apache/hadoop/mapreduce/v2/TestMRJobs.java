...
literal|300000
argument_list|)
DECL|method|testConfVerificationWithClassloader ()
specifier|public
name|void
name|testConfVerificationWithClassloader
parameter_list|()
throws|throws
name|Exception
block|{
name|testConfVerification
argument_list|(
literal|true
argument_list|,
literal|false
...
literal|300000
argument_list|)
DECL|method|testConfVerificationWithClassloaderCustomClasses ()
specifier|public
name|void
name|testConfVerificationWithClassloaderCustomClasses
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|300000
argument_list|)
DECL|method|testConfVerificationWithOutClassloader ()
specifier|public
name|void
name|testConfVerificationWithOutClassloader
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|300000
argument_list|)
DECL|method|testConfVerificationWithJobClient ()
specifier|public
name|void
name|testConfVerificationWithJobClient
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|300000
argument_list|)
DECL|method|testConfVerificationWithJobClientLocal ()
specifier|public
name|void
name|testConfVerificationWithJobClientLocal
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testConfVerification (boolean useJobClassLoader, boolean useCustomClasses, boolean useJobClientForMonitring, boolean useLocal)
specifier|private
name|void
name|testConfVerification
parameter_list|(
name|boolean
name|useJobClassLoader
parameter_list|,
name|boolean
name|useCustomClasses
parameter_list|,
name|boolean
name|useJobClientForMonitring
parameter_list|,
name|boolean
name|useLocal
parameter_list|)
...
operator|+
literal|" jobClassloader="
operator|+
name|useJobClassLoader
operator|+
literal|" customClasses="
operator|+
name|useCustomClasses
operator|+
literal|" jobClient="
...
condition|)
block|{
comment|// We can't use getJobID in useLocal case because JobClient and Job
comment|// point to different instances of LocalJobRunner
comment|//
specifier|final
name|JobID
name|mapredJobID
...
name|assertEquals
argument_list|(
literal|"Unexpected RunningJob's "
operator|+
name|MRJobConfig
operator|.
name|COUNTER_GROUPS_MAX_KEY
