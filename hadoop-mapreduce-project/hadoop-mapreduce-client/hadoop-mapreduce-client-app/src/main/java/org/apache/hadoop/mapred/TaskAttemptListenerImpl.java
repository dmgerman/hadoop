...
annotation|@
name|Override
DECL|method|fatalError (TaskAttemptID taskAttemptID, String msg, boolean fastFail)
specifier|public
name|void
name|fatalError
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|coalesceStatusUpdate (TaskAttemptId yarnAttemptID, TaskAttemptStatus taskAttemptStatus, AtomicReference<TaskAttemptStatus> lastStatusRef)
specifier|private
name|void
name|coalesceStatusUpdate
parameter_list|(
...
condition|)
block|{
comment|// merge fetchFailedMaps from the previous update
if|if
condition|(
name|taskAttemptStatus
operator|.
...
block|}
block|}
comment|// lastStatusRef may be changed by either the AsyncDispatcher when
comment|// it processes the update, or by another IPC server handler
name|done
operator|=
name|lastStatusRef
operator|.
...
name|yarnAttemptID
operator|+
literal|": lastStatusRef changed by another thread, retrying..."
argument_list|)
expr_stmt|;
comment|// let's revert taskAttemptStatus.fetchFailedMaps
name|taskAttemptStatus
operator|.
name|fetchFailedMaps
operator|=
...
name|TaskAttemptId
argument_list|,
DECL|method|getAttemptIdToStatus ()
name|AtomicReference
argument_list|<
name|TaskAttemptStatus
argument_list|>
