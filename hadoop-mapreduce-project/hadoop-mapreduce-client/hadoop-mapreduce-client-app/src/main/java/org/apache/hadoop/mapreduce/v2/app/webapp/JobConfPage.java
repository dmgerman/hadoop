...
begin_comment
comment|/**  * Render a page with the configuration for a given job in it.  */
end_comment

begin_class
DECL|class|JobConfPage
specifier|public
class|class
name|JobConfPage
extends|extends
...
expr_stmt|;
block|}
comment|/**    * The body of this block is the configuration block.    * @return ConfBlock.class    */
DECL|method|content ()
annotation|@
name|Override
specifier|protected
