...
argument_list|()
decl_stmt|;
DECL|field|handleTimelineEvent
specifier|protected
name|boolean
...
expr_stmt|;
block|}
comment|// initiate the atsEventDispatcher for timeline event
comment|// if timeline service is enabled.
if|if
condition|(
name|handleTimelineEvent
condition|)
...
name|AsyncDispatcher
argument_list|(
literal|"Job ATS Event Dispatcher"
argument_list|)
return|;
block|}
...
argument_list|)
expr_stmt|;
comment|// Process it for ATS (if enabled)
if|if
condition|(
name|handleTimelineEvent
condition|)
...
block|}
block|}
DECL|method|handleTimelineEvent (JobHistoryEvent event)
specifier|private
name|void
name|handleTimelineEvent
parameter_list|(
...
name|debug
argument_list|(
literal|"In HistoryEventHandler, handle timelineEvent:"
operator|+
name|event
operator|.
name|getHistoryEvent
