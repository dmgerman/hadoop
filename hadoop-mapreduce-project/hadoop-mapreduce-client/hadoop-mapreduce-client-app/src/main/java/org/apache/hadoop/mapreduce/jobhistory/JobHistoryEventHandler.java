...
literal|false
decl_stmt|;
comment|// For posting entities in new timeline service in a non-blocking way
comment|// TODO YARN-3367 replace with event loop in TimelineClient.
...
condition|)
block|{
comment|// initialize the thread pool for v.2 timeline service
name|threadPool
operator|=
...
expr_stmt|;
block|}
comment|// TODO remove threadPool after adding non-blocking call in TimelineClient
...
name|error
argument_list|(
literal|"putEntityNonBlocking get failed: "
operator|+
name|e
argument_list|)
expr_stmt|;
