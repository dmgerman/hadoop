...
return|;
block|}
comment|/**    * Create an event writer for the Job represented by the jobID.    * Writes out the job configuration to the log directory.    * This should be the first call to history for a job    *     * @param jobId the jobId.    * @param forcedJobStateOnShutDown    * @throws IOException    */
DECL|method|setupEventWriter (JobId jobId, String forcedJobStateOnShutDown)
specifier|protected
name|void
...
name|forcedJobStateOnShutDown
decl_stmt|;
DECL|method|MetaInfo (Path historyFile, Path conf, EventWriter writer, String user, String jobName, JobId jobId, String forcedJobStateOnShutDown)
name|MetaInfo
parameter_list|(
name|Path
name|historyFile
