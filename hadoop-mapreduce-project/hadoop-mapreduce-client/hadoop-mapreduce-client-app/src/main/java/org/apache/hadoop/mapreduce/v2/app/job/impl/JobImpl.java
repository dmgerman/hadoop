...
name|jobTokenSecretManager
decl_stmt|;
DECL|method|JobImpl (ApplicationAttemptId applicationAttemptId, Configuration conf, EventHandler eventHandler, TaskAttemptListener taskAttemptListener, JobTokenSecretManager jobTokenSecretManager, Credentials fsTokenCredentials, Clock clock, Set<TaskId> completedTasksFromPreviousRun, MRAppMetrics metrics, String userName, long appSubmitTime, List<AMInfo> amInfos)
specifier|public
name|JobImpl
parameter_list|(
name|ApplicationAttemptId
