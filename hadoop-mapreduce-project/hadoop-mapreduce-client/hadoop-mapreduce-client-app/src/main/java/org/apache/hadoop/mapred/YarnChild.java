...
annotation|@
name|VisibleForTesting
DECL|method|reportError (Exception exception, Task task, TaskUmbilicalProtocol umbilical)
specifier|static
name|void
name|reportError
parameter_list|(
...
decl_stmt|;
name|boolean
name|hasClusterStorageCapacityExceededException
init|=
name|ExceptionUtils
operator|.
name|indexOfType
...
block|{
name|boolean
name|killJobWhenExceedClusterStorageCapacity
init|=
name|task
operator|.
name|getConf
...
name|error
argument_list|(
literal|"Fast fail the job because the cluster storage capacity was exceeded."
argument_list|)
expr_stmt|;
name|fastFailJob
operator|=
