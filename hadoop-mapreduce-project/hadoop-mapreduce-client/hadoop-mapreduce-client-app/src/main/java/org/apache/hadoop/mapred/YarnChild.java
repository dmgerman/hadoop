...
block|}
block|}
DECL|method|loadCredentials (JobConf conf, InetSocketAddress address)
specifier|private
specifier|static
name|Token
argument_list|<
...
return|;
block|}
comment|/**    * Configure mapred-local dirs. This config is used by the task for finding    * out an output directory.    */
