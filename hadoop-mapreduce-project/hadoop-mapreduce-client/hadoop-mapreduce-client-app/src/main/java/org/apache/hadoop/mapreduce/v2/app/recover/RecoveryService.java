...
literal|false
decl_stmt|;
DECL|method|RecoveryService (ApplicationAttemptId applicationAttemptId, Clock clock, OutputCommitter committer, boolean newApiCommitter)
specifier|public
name|RecoveryService
parameter_list|(
name|ApplicationAttemptId
...
comment|// check the committer type and construct corresponding context
name|TaskAttemptContext
name|taskContext
init|=
literal|null
