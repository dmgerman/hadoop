...
expr_stmt|;
block|}
comment|//attempt ids are generated based on MR app startCount so that attempts
comment|//from previous lives don't overstep the current one.
comment|//this assumes that a task won't have more than 1000 attempts in its single
comment|//life
name|nextAttemptNumber
operator|=
operator|(
...
return|;
block|}
DECL|method|finished (TaskState finalState)
specifier|private
name|TaskState
name|finished
parameter_list|(
...
block|}
block|}
DECL|method|createTaskFinishedEvent (TaskImpl task, TaskState taskState)
specifier|private
specifier|static
name|TaskFinishedEvent
...
return|;
block|}
DECL|method|createTaskFailedEvent (TaskImpl task, List<String> diag, TaskState taskState, TaskAttemptId taId)
specifier|private
specifier|static
name|TaskFailedEvent
...
return|;
block|}
DECL|method|getDefaultState (Task task)
specifier|protected
name|TaskState
name|getDefaultState
parameter_list|(
