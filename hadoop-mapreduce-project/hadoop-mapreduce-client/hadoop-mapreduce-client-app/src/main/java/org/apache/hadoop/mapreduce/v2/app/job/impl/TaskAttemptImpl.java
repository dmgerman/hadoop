...
block|}
block|}
comment|/**    * Create the {@link ContainerLaunchContext} for this attempt.    */
DECL|method|createContainerLaunchContext ()
specifier|private
name|ContainerLaunchContext
...
argument_list|)
decl_stmt|;
comment|// Will be expanded by the shell.
name|String
...
decl_stmt|;
name|String
name|localizedApplicationTokensFile
init|=
operator|new
name|File
argument_list|(
