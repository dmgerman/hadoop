...
expr_stmt|;
block|}
DECL|method|setTaskFailFast (boolean failFast)
specifier|public
name|void
name|setTaskFailFast
parameter_list|(
name|boolean
name|failFast
parameter_list|)
...
condition|)
block|{
comment|// same reason as above for map only job after map task has succeeded.
comment|// ignore this for map only tasks
name|LOG
operator|.
name|info
argument_list|(
literal|"Ignoring killed event for successful map only task attempt"
operator|+
name|taskAttempt
operator|.
name|getID
...
literal|"unchecked"
argument_list|)
DECL|method|notifyTaskAttemptFailed (TaskAttemptImpl taskAttempt, boolean fastFail)
specifier|private
specifier|static
name|void
name|notifyTaskAttemptFailed
