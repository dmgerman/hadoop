...
argument_list|)
expr_stmt|;
comment|// Wait till all reduce-attempts request for containers
for|for
control|(
name|Task
name|t
...
expr_stmt|;
block|}
DECL|method|finishNextNTasks (MRApp mrApp, Iterator<Task> it, int nextN)
specifier|private
name|void
name|finishNextNTasks
parameter_list|(
...
block|}
block|}
DECL|method|finishTask (MRApp mrApp, Task task)
specifier|private
name|void
name|finishTask
parameter_list|(
