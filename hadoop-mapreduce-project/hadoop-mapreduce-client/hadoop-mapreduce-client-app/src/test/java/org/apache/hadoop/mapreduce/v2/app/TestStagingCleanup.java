...
name|JobHistoryEventHandler
block|{
DECL|method|TestJobHistoryEventHandler (AppContext context, int startCount)
specifier|public
name|TestJobHistoryEventHandler
parameter_list|(
name|AppContext
...
expr_stmt|;
block|}
comment|// assert JobHistoryEventHandlerStopped first, then
comment|// ContainerAllocatorStopped, and then stagingDirCleanedup
name|Assert
operator|.
name|assertEquals
argument_list|(
