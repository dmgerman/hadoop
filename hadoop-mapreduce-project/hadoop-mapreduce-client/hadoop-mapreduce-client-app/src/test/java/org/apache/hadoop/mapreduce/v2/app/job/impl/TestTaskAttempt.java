...
annotation|@
name|Test
DECL|method|testSlotMillisCounterUpdate ()
specifier|public
name|void
name|testSlotMillisCounterUpdate
parameter_list|()
throws|throws
name|Exception
block|{
name|verifySlotMillis
argument_list|(
literal|2048
argument_list|,
literal|2048
...
expr_stmt|;
block|}
DECL|method|verifySlotMillis (int mapMemMb, int reduceMemMb, int minContainerSize)
specifier|public
name|void
name|verifySlotMillis
parameter_list|(
