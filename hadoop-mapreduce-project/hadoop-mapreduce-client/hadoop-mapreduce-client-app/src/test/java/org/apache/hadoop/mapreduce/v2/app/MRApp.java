...
expr_stmt|;
block|}
DECL|method|MRApp (ApplicationAttemptId appAttemptId, ContainerId amContainerId, int maps, int reduces, boolean autoComplete, String testName, boolean cleanOnStart, int startCount, Clock clock)
specifier|public
name|MRApp
parameter_list|(
name|ApplicationAttemptId
...
literal|"rawtypes"
argument_list|)
DECL|method|TestJob (JobId jobId, ApplicationAttemptId applicationAttemptId, Configuration conf, EventHandler eventHandler, TaskAttemptListener taskAttemptListener, Clock clock, OutputCommitter committer, boolean newApiCommitter, String user, AppContext appContext)
specifier|public
name|TestJob
parameter_list|(
name|JobId
