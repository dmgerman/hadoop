...
annotation|@
name|Test
DECL|method|testIfApplicationPriorityIsNotSet ()
specifier|public
name|void
name|testIfApplicationPriorityIsNotSet
parameter_list|()
block|{
name|Job
name|mockJob
...
argument_list|)
expr_stmt|;
comment|// KILLED_BY_CONTAINER_SCHEDULER
name|ContainerId
name|containerId3
init|=
name|ContainerId
...
decl_stmt|;
name|ContainerStatus
name|killedByContainerSchedulerStatus
init|=
name|ContainerStatus
operator|.
name|newInstance
