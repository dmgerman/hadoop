...
begin_comment
comment|/**  * Test the app master web service Rest API for getting tasks, a specific task,  * and task counters.  *  * /ws/v1/mapreduce/jobs/{jobid}/tasks  * /ws/v1/mapreduce/jobs/{jobid}/tasks/{taskid}  * /ws/v1/mapreduce/jobs/{jobid}/tasks/{taskid}/counters  */
end_comment

begin_class
DECL|class|TestAMWebServicesTasks
specifier|public
class|class
name|TestAMWebServicesTasks
extends|extends
name|JerseyTest
block|{
DECL|field|conf
...
expr_stmt|;
block|}
DECL|method|TestAMWebServicesTasks ()
specifier|public
name|TestAMWebServicesTasks
parameter_list|()
block|{
...
block|}
block|}
DECL|method|verifyAMSingleTask (JSONObject info, Task task)
specifier|public
name|void
name|verifyAMSingleTask
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|verifyAMTask (JSONArray arr, Job job, String type)
specifier|public
name|void
name|verifyAMTask
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|verifyAMTaskXML (NodeList nodes, Job job)
specifier|public
name|void
name|verifyAMTaskXML
parameter_list|(
...
block|}
block|}
DECL|method|verifyAMJobTaskCounters (JSONObject info, Task task)
specifier|public
name|void
name|verifyAMJobTaskCounters
parameter_list|(
...
block|}
block|}
DECL|method|verifyAMTaskCountersXML (NodeList nodes, Task task)
specifier|public
name|void
name|verifyAMTaskCountersXML
parameter_list|(
