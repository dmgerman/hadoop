...
argument_list|)
expr_stmt|;
comment|// verify attempt is still reported as found if recently unregistered
name|tal
operator|.
name|unregister
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// verify attempt is not found if not recently unregistered
name|long
