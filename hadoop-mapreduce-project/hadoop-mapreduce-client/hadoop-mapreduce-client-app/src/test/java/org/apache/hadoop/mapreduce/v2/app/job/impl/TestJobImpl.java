...
annotation|@
name|Test
DECL|method|testJobNCompletedWhenAllReducersAreFinished ()
specifier|public
name|void
name|testJobNCompletedWhenAllReducersAreFinished
parameter_list|()
throws|throws
name|Exception
block|{
name|testJobCompletionWhenReducersAreFinished
argument_list|(
literal|true
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testJobNotCompletedWhenAllReducersAreFinished ()
specifier|public
name|void
name|testJobNotCompletedWhenAllReducersAreFinished
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testJobCompletionWhenReducersAreFinished (boolean killMappers)
specifier|private
name|void
name|testJobCompletionWhenReducersAreFinished
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|/*      * StubbedJob cannot finish in this test - we'd have to generate the      * necessary events in this test manually, but that wouldn't add too      * much value. Instead, we validate the T_KILL events.      */
if|if
condition|(
name|killMappers
condition|)
...
name|assertEquals
argument_list|(
literal|"Number of killed events"
argument_list|,
literal|2
argument_list|,
name|killedEvents
...
literal|"AttemptID"
argument_list|,
literal|"task_1234567890000_0001_m_000000"
argument_list|,
name|killedEvents
operator|.
name|get
...
literal|"AttemptID"
argument_list|,
literal|"task_1234567890000_0001_m_000001"
argument_list|,
name|killedEvents
operator|.
name|get
...
expr_stmt|;
block|}
DECL|method|createSpiedMapTasks (Map<NodeReport, TaskId> nodeReportsToTaskIds, Map<TaskId, Task> spiedTasks, JobImpl job, NodeState nodeState, List<NodeReport> nodeReports)
specifier|private
name|void
name|createSpiedMapTasks
parameter_list|(
