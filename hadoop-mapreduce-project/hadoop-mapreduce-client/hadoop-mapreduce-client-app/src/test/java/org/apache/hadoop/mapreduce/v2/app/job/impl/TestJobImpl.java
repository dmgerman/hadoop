...
return|;
block|}
DECL|method|StubbedJob (JobId jobId, ApplicationAttemptId applicationAttemptId, Configuration conf, EventHandler eventHandler, OutputCommitter committer, boolean newApiCommitter, String user)
specifier|public
name|StubbedJob
parameter_list|(
name|JobId
