...
argument_list|()
decl_stmt|;
DECL|method|Writer (Configuration conf, FileSystem fs, Path file, Class<K> keyClass, Class<V> valueClass, CompressionCodec codec, Counters.Counter writesCounter)
specifier|public
name|Writer
parameter_list|(
name|Configuration
...
block|}
block|}
DECL|method|Writer (Configuration conf, FileSystem fs, Path file)
specifier|public
name|Writer
parameter_list|(
name|Configuration
