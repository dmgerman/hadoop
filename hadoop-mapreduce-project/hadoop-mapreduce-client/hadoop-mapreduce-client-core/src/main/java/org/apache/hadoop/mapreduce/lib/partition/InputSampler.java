...
begin_comment
comment|/**  * Utility for collecting samples and writing a partition file for  * {@link TotalOrderPartitioner}.  */
end_comment
...
return|;
block|}
DECL|method|InputSampler (Configuration conf)
specifier|public
name|InputSampler
parameter_list|(
name|Configuration
...
DECL|method|getSample (InputFormat<K,V> inf, Job job)
name|K
index|[]
name|getSample
parameter_list|(
...
DECL|method|writePartitionFile (Job job, Sampler<K,V> sampler)
specifier|public
specifier|static
parameter_list|<
name|K
