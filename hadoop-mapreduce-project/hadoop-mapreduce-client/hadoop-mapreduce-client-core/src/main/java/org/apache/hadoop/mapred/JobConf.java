...
argument_list|()
decl_stmt|;
comment|/**    * Configuration key to set the logging level for the map task.    *    * The allowed logging levels are:    * OFF, FATAL, ERROR, WARN, INFO, DEBUG, TRACE and ALL.    */
...
name|MAP_LOG_LEVEL
decl_stmt|;
comment|/**    * Configuration key to set the logging level for the reduce task.    *    * The allowed logging levels are:    * OFF, FATAL, ERROR, WARN, INFO, DEBUG, TRACE and ALL.    */
