...
name|InterruptedException
function_decl|;
comment|/**    * Gets the location of the log file for a job if no taskAttemptId is    * specified, otherwise gets the log location for the taskAttemptId.    * @param jobID the jobId.    * @param taskAttemptID the taskAttemptId.    * @return log params.    * @throws IOException    * @throws InterruptedException    */
