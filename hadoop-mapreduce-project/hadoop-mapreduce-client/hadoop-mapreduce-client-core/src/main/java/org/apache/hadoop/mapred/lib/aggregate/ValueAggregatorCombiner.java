...
operator|.
name|Stable
DECL|class|ValueAggregatorCombiner
specifier|public
class|class
...
argument_list|>
block|{
comment|/**    * Combiner does not need to configure.    */
...
parameter_list|)
block|{    }
comment|/** Combines values for a given key.      * @param key the key is expected to be a Text object, whose prefix indicates    * the type of aggregation to aggregate the values.     * @param values the values to combine    * @param output to collect combined values    */
