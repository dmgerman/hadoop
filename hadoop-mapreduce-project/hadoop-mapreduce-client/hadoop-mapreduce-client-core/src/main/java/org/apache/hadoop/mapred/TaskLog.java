...
DECL|method|captureOutAndError (List<String> cmd, File stdoutFilename, File stderrFilename, long tailLength )
specifier|public
specifier|static
name|List
argument_list|<
...
DECL|method|captureOutAndError (List<String> setup, List<String> cmd, File stdoutFilename, File stderrFilename, long tailLength )
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
comment|/**    * Wrap a command in a shell to capture stdout and stderr to files.    * Setup commands such as setting memory limit can be passed which     * will be executed before exec.    * If the tailLength is 0, the entire output will be saved.    * @param setup The setup commands for the execed process.    * @param cmd The command and the arguments that should be run    * @param stdoutFilename The filename that stdout should be saved to    * @param stderrFilename The filename that stderr should be saved to    * @param tailLength The length of the tail to be saved.    * @param pidFileName The name of the pid-file. pid-file's usage is deprecated    * @return the modified command that should be run    *     * @deprecated     pidFiles are no more used. Instead pid is exported to    *                 env variable JVM_PID.    */
annotation|@
name|Deprecated
DECL|method|captureOutAndError (List<String> setup, List<String> cmd, File stdoutFilename, File stderrFilename, long tailLength, String pidFileName )
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
comment|/**    * Wrap a command in a shell to capture debug script's     * stdout and stderr to debugout.    * @param cmd The command and the arguments that should be run    * @param debugoutFilename The filename that stdout and stderr    *  should be saved to.    * @return the modified command that should be run    * @throws IOException    */
DECL|method|captureDebugOut (List<String> cmd, File debugoutFilename )
specifier|public
specifier|static
name|List
argument_list|<
