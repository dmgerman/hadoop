...
begin_comment
comment|/**  *<code>JobTracker</code> is no longer used since M/R 2.x. This is a dummy  * JobTracker class, which is used to be compatible with M/R 1.x applications.  */
end_comment
