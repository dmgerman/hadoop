...
DECL|method|checkPidPgrpidForMatch (String pidStr, String procfsDir)
specifier|static
name|boolean
...
condition|)
block|{
comment|// process group leader may have finished execution, but we still need to
comment|// kill the subProcesses in the process group.
return|return
literal|true
return|;
block|}
...
name|pidStr
operator|+
literal|" is not a process group leader. pgrpId is: "
operator|+
name|pInfo
operator|.
name|getPgrpId
