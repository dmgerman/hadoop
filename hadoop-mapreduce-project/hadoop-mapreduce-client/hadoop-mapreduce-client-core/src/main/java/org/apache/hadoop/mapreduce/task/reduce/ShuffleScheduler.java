...
operator|.
name|Unstable
DECL|interface|ShuffleScheduler
specifier|public
interface|interface
...
function_decl|;
comment|/**    * Interpret a {@link TaskCompletionEvent} from the event stream.    * @param tce Intermediate output metadata    */
DECL|method|resolve (TaskCompletionEvent tce)
specifier|public
name|void
name|resolve
parameter_list|(
