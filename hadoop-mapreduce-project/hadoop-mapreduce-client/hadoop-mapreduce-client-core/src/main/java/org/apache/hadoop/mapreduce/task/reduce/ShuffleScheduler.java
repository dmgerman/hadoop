...
expr_stmt|;
block|}
DECL|method|copySucceeded (TaskAttemptID mapId, MapHost host, long bytes, long millis, MapOutput<K,V> output )
specifier|public
...
expr_stmt|;
block|}
DECL|method|informMaxMapRunTime (int duration)
specifier|public
specifier|synchronized
name|void
