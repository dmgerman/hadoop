...
argument_list|)
expr_stmt|;
comment|// Key should be 12 right after "1234567890ab"
name|assertEquals
argument_list|(
literal|12
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Key should be 16 right after "1234567890ab12ab"
name|assertEquals
argument_list|(
literal|16
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Key should be 19 right after "1234567890ab12ab345"
name|assertEquals
argument_list|(
literal|19
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Key should be 12 right after "123456789aab"
name|assertEquals
argument_list|(
literal|12
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Key should be 10 right after "123456789a"
name|assertEquals
argument_list|(
literal|10
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Key should be 11 right after "123456789ab"
name|assertEquals
argument_list|(
literal|11
argument_list|,
