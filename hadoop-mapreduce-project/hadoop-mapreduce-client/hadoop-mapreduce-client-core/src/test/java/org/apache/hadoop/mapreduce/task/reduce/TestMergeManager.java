...
expr_stmt|;
block|}
DECL|method|fillOutput (MapOutput<Text, Text> output)
specifier|private
name|void
name|fillOutput
parameter_list|(
...
name|mergeComplete
decl_stmt|;
DECL|method|TestMergeThread (MergeManager<Text, Text> mergeManager, ExceptionReporter reporter)
specifier|public
name|TestMergeThread
parameter_list|(
name|MergeManager
...
annotation|@
name|Override
DECL|method|merge (List<MapOutput<Text, Text>> inputs)
specifier|public
name|void
name|merge
parameter_list|(
