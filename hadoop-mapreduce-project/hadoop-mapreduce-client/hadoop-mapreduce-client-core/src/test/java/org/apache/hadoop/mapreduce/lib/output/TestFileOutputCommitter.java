...
annotation|@
name|Test
DECL|method|testProgressDuringMerge ()
specifier|public
name|void
name|testProgressDuringMerge
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//make sure progress flag was set.
comment|// The first time it is set is during commit but ensure that
comment|// mergePaths call makes it go again.
name|verify
argument_list|(
name|tContext
argument_list|,
