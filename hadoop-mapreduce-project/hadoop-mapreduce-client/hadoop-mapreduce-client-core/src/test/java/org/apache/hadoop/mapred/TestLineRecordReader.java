...
literal|"abc+++def+++ghi+++"
operator|+
literal|"jkl+++mno+++pqr+++stu+++vw +++xyz"
decl_stmt|;
name|Path
name|inputFile
init|=
...
argument_list|)
expr_stmt|;
comment|// Position should be 12 right after "1234567890ab"
name|assertEquals
argument_list|(
literal|12
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Position should be 16 right after "1234567890ab12ab"
name|assertEquals
argument_list|(
literal|16
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Position should be 19 right after "1234567890ab12ab345"
name|assertEquals
argument_list|(
literal|19
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// No record is in the second split because the second split dropped
comment|// the first record, which was already reported by the first split.
comment|// The position should be 19 right after "1234567890ab12ab345"
name|assertEquals
argument_list|(
literal|19
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Get first record:"123456789a"
name|assertEquals
argument_list|(
literal|10
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Position should be 12 right after "123456789aab"
name|assertEquals
argument_list|(
literal|12
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Position should be 10 right after "123456789a"
name|assertEquals
argument_list|(
literal|10
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Position should be 11 right after "123456789ab"
name|assertEquals
argument_list|(
literal|11
argument_list|,
