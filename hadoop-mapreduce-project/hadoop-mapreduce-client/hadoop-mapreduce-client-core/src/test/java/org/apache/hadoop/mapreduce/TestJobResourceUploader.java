...
annotation|@
name|Test
DECL|method|testOriginalPathEndsInSlash ()
specifier|public
name|void
name|testOriginalPathEndsInSlash
parameter_list|()
throws|throws
name|IOException
throws|,
name|URISyntaxException
block|{
name|testOriginalPathWithTrailingSlash
argument_list|(
operator|new
name|Path
argument_list|(
...
name|URI
argument_list|(
literal|"file:/local/mapred/test/"
argument_list|)
argument_list|)
argument_list|,
operator|new
name|Path
argument_list|(
literal|"hdfs://localhost:1234/home/hadoop/test/"
argument_list|)
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
DECL|method|testOriginalPathIsRoot ()
specifier|public
name|void
name|testOriginalPathIsRoot
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|Path
argument_list|(
literal|"hdfs://localhost:1234/home/hadoop/"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testOriginalPathWithTrailingSlash (Path path, Path expectedRemotePath)
specifier|private
name|void
name|testOriginalPathWithTrailingSlash
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// make sure that FileUtils.copy() doesn't try to copy anything
name|when
argument_list|(
name|fs
operator|.
...
name|JobResourceUploader
block|{
DECL|field|callOriginalCopy
specifier|private
name|boolean
name|callOriginalCopy
init|=
literal|false
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|StubedUploader (FileSystem fs, boolean useWildcard, boolean callOriginalCopy)
name|StubedUploader
parameter_list|(
name|FileSystem
name|fs
