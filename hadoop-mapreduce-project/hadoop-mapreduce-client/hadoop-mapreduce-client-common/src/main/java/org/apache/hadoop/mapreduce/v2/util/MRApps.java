...
return|;
block|}
DECL|method|setupDistributedCache ( Configuration conf, Map<String, LocalResource> localResources, Map<String, String> env)
specifier|public
specifier|static
name|void
...
DECL|method|parseDistributedCacheArtifacts ( Configuration conf, Map<String, LocalResource> localResources, Map<String, String> env, LocalResourceType type, URI[] uris, long[] timestamps, long[] sizes, boolean visibilities[], Path[] pathsToPutOnClasspath)
specifier|private
specifier|static
name|void
name|parseDistributedCacheArtifacts
