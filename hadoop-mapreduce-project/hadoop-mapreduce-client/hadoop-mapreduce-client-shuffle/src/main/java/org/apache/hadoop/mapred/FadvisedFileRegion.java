...
name|readaheadRequest
decl_stmt|;
DECL|method|FadvisedFileRegion (RandomAccessFile file, long position, long count, boolean manageOsCache, int readaheadLength, ReadaheadPool readaheadPool, String identifier, int shuffleBufferSize, boolean shuffleTransferToAllowed)
specifier|public
name|FadvisedFileRegion
parameter_list|(
name|RandomAccessFile
...
annotation|@
name|VisibleForTesting
DECL|method|customShuffleTransfer (WritableByteChannel target, long position)
name|long
name|customShuffleTransfer
parameter_list|(
name|WritableByteChannel
