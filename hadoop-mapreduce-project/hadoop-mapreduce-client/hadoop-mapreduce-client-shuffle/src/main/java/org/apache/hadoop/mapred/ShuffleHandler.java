...
name|jobId
decl_stmt|;
DECL|method|ReduceContext (List<String> mapIds, int rId, ChannelHandlerContext context, String usr, Map<String, Shuffle.MapOutputInfo> mapOutputInfoMap, String jobId)
specifier|public
name|ReduceContext
parameter_list|(
name|List
