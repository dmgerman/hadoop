...
begin_comment
comment|/**  * This test class ensures that everything works as expected when XAttr  * support is turned off HDFS.  This is the default configuration.  The other  * tests operate with XAttr support turned on.  */
end_comment

begin_class
DECL|class|TestHttpFSServerNoXAttrs
specifier|public
class|class
name|TestHttpFSServerNoXAttrs
extends|extends
name|HTestCase
block|{
DECL|field|miniDfs
...
name|nnConf
decl_stmt|;
comment|/**    * Fire up our own hand-rolled MiniDFSCluster.  We do this here instead    * of relying on TestHdfsHelper because we don't want to turn on XAttr    * support.    *    * @throws Exception    */
...
argument_list|)
expr_stmt|;
comment|// Explicitly turn off XAttr support
name|conf
operator|.
name|setBoolean
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Talks to the http interface to get the json output of a *STATUS command    * on the given file.    *    * @param filename The file to query.    * @param command Either GETXATTRS, SETXATTR, or REMOVEXATTR    * @throws Exception    */
...
expr_stmt|;
block|}
comment|/**    * General-purpose http PUT command to the httpfs server.    * @param filename The file to operate upon    * @param command The command to perform (SETXATTR, etc)    * @param params Parameters    */
...
expr_stmt|;
block|}
comment|/**    * Ensure that GETXATTRS, SETXATTR, REMOVEXATTR fail.    */
annotation|@
name|Test
annotation|@
name|TestDir
...
argument_list|()
expr_stmt|;
comment|/* GETXATTRS, SETXATTR, REMOVEXATTR fail */
name|getStatus
argument_list|(
name|path
argument_list|,
