...
name|set
argument_list|(
literal|"server.hadoop.filesystem.cache.purge.timeout"
argument_list|,
literal|"0"
argument_list|)
expr_stmt|;
...
name|set
argument_list|(
literal|"server.hadoop.filesystem.cache.purge.frequency"
argument_list|,
literal|"1"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//still around because of caching
name|fs1
operator|.
name|mkdirs
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//should be same instance because of caching
name|Assert
operator|.
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//still around because of lease count is 1 (fs2 is out)
name|fs1
operator|.
name|mkdirs
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//should not be around as lease count is 0
try|try
block|{
name|fs2
operator|.
