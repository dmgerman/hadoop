...
expr_stmt|;
block|}
comment|/**    * Talks to the http interface to get the json output of the GETFILESTATUS    * command on the given file.    *    * @param filename The file to query.    * @return A string containing the JSON output describing the file.    * @throws Exception    */
DECL|method|getFileStatus ( String filename )
specifier|private
name|String
name|getFileStatus
parameter_list|(
...
name|format
argument_list|(
literal|"/webhdfs/v1/{0}?user.name={1}&op=GETFILESTATUS"
argument_list|,
name|filename
argument_list|,
name|user
