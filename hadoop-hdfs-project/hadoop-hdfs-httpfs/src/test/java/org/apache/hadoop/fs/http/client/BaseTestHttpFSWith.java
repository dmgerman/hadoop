...
literal|null
decl_stmt|;
comment|// Test single block file block locations.
try|try
init|(
name|FileSystem
name|fs
...
argument_list|)
expr_stmt|;
comment|// Test multi-block single replica file block locations.
try|try
init|(
name|FileSystem
name|fs
...
argument_list|)
expr_stmt|;
comment|// Test multi-block multi-replica file block locations.
try|try
init|(
name|FileSystem
name|fs
...
expr_stmt|;
block|}
DECL|method|verifyBlockLocations (BlockLocation[] locations1, BlockLocation[] locations2)
specifier|private
name|void
name|verifyBlockLocations
parameter_list|(
