...
literal|14000
decl_stmt|;
DECL|field|HTTP_HOSTNAME_KEY
specifier|static
specifier|final
name|String
name|HTTP_HOSTNAME_KEY
init|=
literal|"httpfs.http.hostname"
decl_stmt|;
DECL|field|HTTP_HOSTNAME_DEFAULT
specifier|private
specifier|static
specifier|final
name|String
name|HTTP_HOSTNAME_DEFAULT
init|=
literal|"0.0.0.0"
decl_stmt|;
...
init|=
literal|"httpfs.http.administrators"
decl_stmt|;
DECL|field|NAME
specifier|private
specifier|static
...
argument_list|)
decl_stmt|;
comment|// Allow the default authFilter HttpFSAuthenticationFilter
name|String
