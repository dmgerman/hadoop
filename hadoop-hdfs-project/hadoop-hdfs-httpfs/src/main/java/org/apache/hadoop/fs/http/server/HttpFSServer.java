...
name|UTF_8
argument_list|)
DECL|method|getRoot (@ontext UriInfo uriInfo, @QueryParam(OperationParam.NAME) OperationParam op, @Context Parameters params, @Context HttpServletRequest request)
specifier|public
name|Response
name|getRoot
parameter_list|(
...
return|;
block|}
comment|/**    * Binding to handle GET requests, supported operations are    *    * @param path the path for operation.    * @param uriInfo uri info of the request.    * @param op the HttpFS operation of the request.    * @param params the HttpFS parameters of the request.    *    * @return the request response.    *    * @throws IOException thrown if an IO error occurred. Thrown exceptions are    * handled by {@link HttpFSExceptionProvider}.    * @throws FileSystemAccessException thrown if a FileSystemAccess releated    * error occurred. Thrown exceptions are handled by    * {@link HttpFSExceptionProvider}.    */
annotation|@
name|GET
annotation|@
name|Path
...
block|}
argument_list|)
DECL|method|get (@athParamR) String path, @Context UriInfo uriInfo, @QueryParam(OperationParam.NAME) OperationParam op, @Context Parameters params, @Context HttpServletRequest request)
specifier|public
name|Response
name|get
parameter_list|(
...
return|;
block|}
comment|/**    * Create an open redirection URL from a request. It points to the same    * HttpFS endpoint but removes the "redirect" parameter.    * @param uriInfo uri info of the request.    * @return URL for the redirected location.    */
DECL|method|createOpenRedirectionURL (UriInfo uriInfo)
specifier|private
name|URI
name|createOpenRedirectionURL
parameter_list|(
