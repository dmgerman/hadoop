...
decl_stmt|;
DECL|field|HADOOP_CONF_PREFIX
specifier|private
specifier|static
specifier|final
name|String
name|HADOOP_CONF_PREFIX
init|=
literal|"conf:"
decl_stmt|;
DECL|field|NAME_NODE_PROPERTY
specifier|private
specifier|static
specifier|final
name|String
name|NAME_NODE_PROPERTY
init|=
...
name|debug
argument_list|(
literal|"FileSystemAccess default configuration:"
argument_list|)
expr_stmt|;
for|for
control|(
...
expr_stmt|;
block|}
DECL|method|createHadoopConf (Configuration conf)
specifier|protected
name|Configuration
...
return|;
block|}
DECL|method|createNameNodeConf (Configuration conf)
specifier|protected
name|Configuration
name|createNameNodeConf
parameter_list|(
name|Configuration
name|conf
parameter_list|)
