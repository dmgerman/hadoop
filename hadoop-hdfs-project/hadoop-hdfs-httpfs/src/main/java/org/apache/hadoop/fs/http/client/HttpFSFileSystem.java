...
decl_stmt|;
DECL|field|FSACTION_MODE_PARAM
specifier|public
specifier|static
specifier|final
name|String
name|FSACTION_MODE_PARAM
init|=
literal|"fsaction"
decl_stmt|;
...
literal|"blockSize"
decl_stmt|;
DECL|field|CHILDREN_NUM_JSON
specifier|public
specifier|static
specifier|final
name|String
name|CHILDREN_NUM_JSON
init|=
literal|"childrenNum"
decl_stmt|;
DECL|field|FILE_ID_JSON
specifier|public
specifier|static
specifier|final
name|String
...
literal|"replication"
decl_stmt|;
DECL|field|STORAGEPOLICY_JSON
specifier|public
specifier|static
specifier|final
name|String
name|STORAGEPOLICY_JSON
init|=
literal|"storagePolicy"
decl_stmt|;
...
decl_stmt|;
DECL|field|CONTENT_SUMMARY_ECPOLICY_JSON
specifier|public
specifier|static
specifier|final
name|String
name|CONTENT_SUMMARY_ECPOLICY_JSON
init|=
literal|"ecPolicy"
decl_stmt|;
...
begin_comment
comment|/**    * This filesystem's capabilities must be in sync with that of    * {@code DistributedFileSystem.hasPathCapability()} except    * where the feature is not exposed (e.g. symlinks).    * {@inheritDoc}    */
end_comment
...
name|IOException
block|{
comment|// query the superclass, which triggers argument validation.
specifier|final
name|Path
name|p
init|=
