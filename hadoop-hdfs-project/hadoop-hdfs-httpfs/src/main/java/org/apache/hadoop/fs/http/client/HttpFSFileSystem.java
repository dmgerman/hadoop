...
begin_comment
comment|//This method enables handling UGI doAs with SPNEGO, we have to
end_comment

begin_comment
comment|//fallback to the realuser who logged in with Kerberos credentials
end_comment

begin_function
DECL|method|doAsRealUserIfNecessary (final Callable<T> callable)
specifier|private
parameter_list|<
name|T
parameter_list|>
name|T
name|doAsRealUserIfNecessary
parameter_list|(
specifier|final
name|Callable
argument_list|<
