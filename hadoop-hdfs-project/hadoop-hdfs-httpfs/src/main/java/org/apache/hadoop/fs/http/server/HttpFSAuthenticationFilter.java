...
decl_stmt|;
DECL|field|HADOOP_HTTP_CONF_PREFIX
specifier|static
specifier|final
name|String
name|HADOOP_HTTP_CONF_PREFIX
init|=
...
literal|".file"
decl_stmt|;
comment|/**    * Returns the hadoop-auth configuration from HttpFSServer's configuration.    *<p>    * It returns all HttpFSServer's configuration properties prefixed with    *<code>hadoop.http.authentication</code>. The    *<code>hadoop.http.authentication</code> prefix is removed from the    * returned property names.    *    * @param configPrefix parameter not used.    * @param filterConfig parameter not used.    *    * @return hadoop-auth configuration read from HttpFSServer's configuration.    */
annotation|@
name|Override
...
block|}
block|}
comment|// Replace Hadoop Http Authentication Configs with HttpFS specific Configs
for|for
control|(
name|Map
operator|.
