...
condition|)
block|{
comment|// Add HDFS-specific fields to response
name|HdfsFileStatus
name|hdfsFileStatus
init|=
operator|(
...
return|;
block|}
comment|/**    * Converts a<code>QuotaUsage</code> object into a JSON array    * object.    */
annotation|@
name|SuppressWarnings
argument_list|(
block|{
...
block|}
argument_list|)
DECL|method|quotaUsageToJSON (QuotaUsage quotaUsage)
specifier|private
specifier|static
name|Map
name|quotaUsageToJSON
parameter_list|(
name|QuotaUsage
name|quotaUsage
parameter_list|)
...
return|;
block|}
DECL|method|quotaUsageToMap (QuotaUsage quotaUsage)
specifier|private
specifier|static
name|Map
argument_list|<
...
block|}
block|}
comment|/**    * Executor that performs a quota-usage FileSystemAccess files system    * operation.    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
DECL|class|FSQuotaUsage
specifier|public
specifier|static
class|class
name|FSQuotaUsage
...
name|path
decl_stmt|;
DECL|method|FSQuotaUsage (String path)
specifier|public
name|FSQuotaUsage
parameter_list|(
name|String
...
block|}
block|}
comment|/**    * Executor that performs a check access operation.    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
name|mode
decl_stmt|;
comment|/**      * Creates a access executor.      */
DECL|method|FSAccess (String path, FsAction mode)
specifier|public
name|FSAccess
parameter_list|(
name|String
