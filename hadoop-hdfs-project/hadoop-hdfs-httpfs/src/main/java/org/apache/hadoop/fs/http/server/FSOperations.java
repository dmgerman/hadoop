...
block|}
block|}
comment|/**    * Executor that performs a getFileBlockLocations FileSystemAccess    * file system operation.    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
literal|"rawtypes"
argument_list|)
DECL|class|FSFileBlockLocations
specifier|public
specifier|static
class|class
name|FSFileBlockLocations
implements|implements
name|FileSystemAccess
operator|.
name|FileSystemExecutor
...
name|path
decl_stmt|;
DECL|field|offsetValue
specifier|private
name|long
name|offsetValue
decl_stmt|;
DECL|field|lengthValue
specifier|private
name|long
name|lengthValue
decl_stmt|;
comment|/**      * Creates a file-block-locations executor.      *      * @param path the path to retrieve the location      * @param offsetValue offset into the given file      * @param lengthValue length for which to get locations for      */
DECL|method|FSFileBlockLocations (String path, long offsetValue, long lengthValue)
specifier|public
name|FSFileBlockLocations
parameter_list|(
name|String
