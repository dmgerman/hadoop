...
name|contains
argument_list|(
literal|"Too many arguments, Max=2 argument allowed"
argument_list|)
argument_list|)
expr_stmt|;
name|out
...
annotation|@
name|Test
DECL|method|testListWithDetails ()
specifier|public
name|void
name|testListWithDetails
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Create mount entry.
name|String
index|[]
name|argv
init|=
...
argument_list|)
expr_stmt|;
comment|// Test list with detail for a mount entry.
name|argv
operator|=
operator|new
name|String
...
argument_list|()
expr_stmt|;
comment|// Test list with detail without path.
name|argv
operator|=
operator|new
name|String
...
annotation|@
name|Test
DECL|method|testListNestedMountTable ()
specifier|public
name|void
name|testListNestedMountTable
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
comment|// Add one more mount table entry.
name|argv
operator|=
operator|new
name|String
...
annotation|@
name|Test
DECL|method|testSafeModePermission ()
specifier|public
name|void
name|testSafeModePermission
parameter_list|()
throws|throws
name|Exception
block|{
...
block|{
comment|// set back login user to make sure it doesn't pollute other unit tests
comment|// even this one fails.
name|UserGroupInformation
operator|.
name|setLoginUser
argument_list|(
...
annotation|@
name|Test
DECL|method|testUpdateReadonlyWithQuota ()
specifier|public
name|void
name|testUpdateReadonlyWithQuota
parameter_list|()
throws|throws
name|Exception
block|{
...
name|src
init|=
literal|"/test-updateReadonlywithQuota"
decl_stmt|;
name|String
name|dest
init|=
literal|"/UpdateReadonlywithQuota"
decl_stmt|;
name|String
index|[]
name|argv
