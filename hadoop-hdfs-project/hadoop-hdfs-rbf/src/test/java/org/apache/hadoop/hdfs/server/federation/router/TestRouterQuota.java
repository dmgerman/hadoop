...
return|;
block|}
comment|/**    * Update a mount table entry to the mount table through the admin API.    * @param entry Mount table entry to update.    * @return If it was successfully updated    * @throws IOException Problems update entries    */
DECL|method|updateMountTable (final MountTable entry)
specifier|private
name|boolean
name|updateMountTable
parameter_list|(
specifier|final
name|MountTable
name|entry
...
annotation|@
name|Test
DECL|method|testSetQuotaToMountTableEntry ()
specifier|public
name|void
name|testSetQuotaToMountTableEntry
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Path
argument_list|(
literal|"/testSetQuotaToFederationPath"
argument_list|)
argument_list|)
expr_stmt|;
name|nnFs1
...
name|Path
argument_list|(
literal|"/testSetQuotaToFederationPath/dir0"
argument_list|)
argument_list|)
expr_stmt|;
comment|// Add one mount table:
comment|// /setquota --> ns0---testSetQuotaToFederationPath
name|MountTable
name|mountTable
init|=
name|MountTable
...
argument_list|()
decl_stmt|;
comment|// ensure mount table is updated to Router.
name|updateService
operator|.
name|periodicInvoke
argument_list|()
...
argument_list|()
decl_stmt|;
comment|// setting quota on a mount point should fail.
name|LambdaTestUtils
operator|.
name|intercept
argument_list|(
...
argument_list|,
literal|"Expect an AccessControlException."
argument_list|,
parameter_list|()
lambda|->
name|routerFs
...
argument_list|)
expr_stmt|;
comment|// setting storage quota on a mount point should fail.
name|LambdaTestUtils
operator|.
name|intercept
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// quota should still be unset.
name|assertEquals
argument_list|(
operator|-
literal|1
...
argument_list|)
expr_stmt|;
comment|// setting quota on a non-mount point should succeed.
name|routerFs
operator|.
name|setQuota
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// setting storage quota on a non-mount point should succeed.
name|routerFs
operator|.
name|setQuotaByStorageType
argument_list|(
...
return|;
block|}
comment|/**    * Test {@link RouterQuotaUpdateService#periodicInvoke()} updates quota usage    * in RouterQuotaManager.    */
annotation|@
name|Test
...
argument_list|()
expr_stmt|;
comment|// verify if quota usage has been updated in quota manager.
name|assertEquals
argument_list|(
name|nsQuota
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// verify quota sync on adding new destination to mount entry.
name|updatedMountTable
operator|=
name|getMountTable
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Verify updating mount entry with actual destinations not present.
name|mountTable
operator|=
name|MountTable
operator|.
...
expr_stmt|;
block|}
comment|/**    * Verify whether quota usage cache in RouterQuotaManager is updated properly.    * {@link RouterQuotaUpdateService#periodicInvoke()} should be able to update    * the cache even if the destination directory for some mount entry is not    * present in the filesystem.    */
annotation|@
name|Test
...
annotation|@
name|Test
DECL|method|testClearQuotaDefAfterRemovingMountTable ()
specifier|public
name|void
name|testClearQuotaDefAfterRemovingMountTable
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Verify current quota definitions
name|assertEquals
argument_list|(
name|nsQuota
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Verify quota definitions are cleared after removing the mount table
name|assertNull
argument_list|(
name|routerQuota
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// Verify removing mount entry with actual destinations not present.
name|mountTable
operator|=
name|MountTable
operator|.
...
annotation|@
name|Test
DECL|method|testSetQuotaNotMountTable ()
specifier|public
name|void
name|testSetQuotaNotMountTable
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// setQuota should run for any directory
name|MountTable
name|mountTable1
init|=
name|MountTable
...
argument_list|)
expr_stmt|;
comment|// Add a directory not present in mount table.
name|nnFs1
operator|.
name|mkdirs
argument_list|(
...
annotation|@
name|Test
DECL|method|testNoQuotaaExceptionForUnrelatedOperations ()
specifier|public
name|void
name|testNoQuotaaExceptionForUnrelatedOperations
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Quota check for related operation.
name|intercept
argument_list|(
name|NSQuotaExceededException
operator|.
name|class
argument_list|,
literal|"The NameSpace quota (directories and files) is exceeded"
argument_list|,
parameter_list|()
lambda|->
name|routerFs
...
argument_list|)
expr_stmt|;
comment|//Quotas shouldn't be checked for unrelated operations.
name|routerFs
operator|.
...
name|BLOCK_SIZE
decl_stmt|;
name|prepareGlobalQuotaTestMountTable
argument_list|(
name|nsQuota
argument_list|,
name|ssQuota
...
annotation|@
name|Test
DECL|method|testFixGlobalQuota ()
specifier|public
name|void
name|testFixGlobalQuota
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testGetQuotaUsageOnMountPoint ()
specifier|public
name|void
name|testGetQuotaUsageOnMountPoint
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Verify getQuotaUsage() of the mount point /dir-1.
name|QuotaUsage
name|quotaUsage
init|=
name|routerFs
...
argument_list|)
expr_stmt|;
comment|// Verify getQuotaUsage() of the mount point /dir-1/dir-2.
name|quotaUsage
operator|=
name|routerFs
operator|.
...
argument_list|)
expr_stmt|;
comment|// Verify getQuotaUsage() of the mount point /dir-1/dir-2/dir-3
name|quotaUsage
operator|=
name|routerFs
operator|.
...
argument_list|)
expr_stmt|;
comment|// Verify getQuotaUsage() of the mount point /dir-4
name|quotaUsage
operator|=
name|routerFs
operator|.
...
name|Path
argument_list|(
literal|"/dir-1/dir-normal"
argument_list|)
argument_list|)
expr_stmt|;
try|try
block|{
comment|// Verify getQuotaUsage() of the normal path /dir-1/dir-normal.
name|quotaUsage
operator|=
name|routerFs
operator|.
...
block|}
block|}
comment|/**    * RouterQuotaUpdateService.periodicInvoke() should only update usage in    * cache. The mount table in state store shouldn't be updated.    */
annotation|@
name|Test
DECL|method|testRouterQuotaUpdateService ()
specifier|public
name|void
name|testRouterQuotaUpdateService
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// verify the mount table in state store is updated.
name|QueryResult
argument_list|<
name|MountTable
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// test RouterQuotaUpdateService.periodicInvoke().
name|updateService
operator|.
name|periodicInvoke
argument_list|()
expr_stmt|;
comment|// RouterQuotaUpdateService should update usage in local cache.
name|RouterQuotaUsage
name|quotaUsage
init|=
name|quotaManager
...
argument_list|)
expr_stmt|;
comment|// RouterQuotaUpdateService shouldn't update mount entry in state store.
name|result
operator|=
name|driver
operator|.
...
expr_stmt|;
block|}
comment|/**    * Verify whether quota is updated properly.    * {@link RouterQuotaUpdateService#periodicInvoke()} should be able to update    * the quota even if the destination directory for some mount entry is not    * present in the filesystem.    */
annotation|@
name|Test
DECL|method|testQuotaUpdateWhenDestinationNotPresent ()
specifier|public
name|void
name|testQuotaUpdateWhenDestinationNotPresent
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
comment|// Add one mount table:
comment|// /dst-not-present --> ns0---/dst-not-present.
name|nnFs
operator|.
name|mkdirs
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// verify quota usage is updated in RouterQuotaManager.
name|updateService
operator|.
name|periodicInvoke
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// Update quota to [nsQuota*2, ssQuota*2].
name|mountTable
operator|.
name|setQuota
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Remove /dst-not-present.
name|nnFs
operator|.
name|delete
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// verify quota is updated in RouterQuotaManager.
name|updateService
operator|.
name|periodicInvoke
argument_list|()
...
expr_stmt|;
block|}
comment|/**    * Add three mount tables.    * /dir-1              --> ns0---/dir-1 [nsQuota, ssQuota]    * /dir-1/dir-2        --> ns0---/dir-2 [QUOTA_UNSET, ssQuota * 2]    * /dir-1/dir-2/dir-3  --> ns0---/dir-3 [QUOTA_UNSET, QUOTA_UNSET]    * /dir-4              --> ns0---/dir-4 [QUOTA_UNSET, QUOTA_UNSET]    *    * Expect three remote locations' global quota.    * ns0---/dir-1 --> [nsQuota, ssQuota]    * ns0---/dir-2 --> [nsQuota, ssQuota * 2]    * ns0---/dir-3 --> [nsQuota, ssQuota * 2]    * ns0---/dir-4 --> [-1, -1]    */
DECL|method|prepareGlobalQuotaTestMountTable (long nsQuota, long ssQuota)
specifier|private
name|void
name|prepareGlobalQuotaTestMountTable
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Ensure setQuota RPC was invoked and mount table was updated.
name|RouterQuotaUpdateService
name|updateService
init|=
name|routerContext
