...
name|STANDBY
decl_stmt|;
comment|/** Datanodes registered in this Namenode. */
DECL|field|dns
specifier|private
name|List
argument_list|<
...
expr_stmt|;
block|}
comment|/**    * Get the datanodes that this NN will return.    * @return The datanodes that this NN will return.    */
...
expr_stmt|;
block|}
comment|/**    * Add datanode related operations.    * @throws IOException If it cannot be setup.    */
DECL|method|addDatanodeMock ()
specifier|public
name|void
