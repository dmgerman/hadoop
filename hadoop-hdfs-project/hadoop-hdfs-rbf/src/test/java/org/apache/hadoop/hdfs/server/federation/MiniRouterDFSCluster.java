...
decl_stmt|;
comment|/** Router configuration initializes. */
DECL|field|routerConf
specifier|private
name|Configuration
name|routerConf
decl_stmt|;
...
decl_stmt|;
comment|/** If the DNs are shared. */
DECL|field|sharedDNs
specifier|private
name|boolean
name|sharedDNs
init|=
...
block|}
block|}
DECL|method|MiniRouterDFSCluster ( boolean ha, int numNameservices, int numNamenodes, long heartbeatInterval, long cacheFlushInterval, Configuration overrideConf)
specifier|public
name|MiniRouterDFSCluster
parameter_list|(
name|boolean
...
expr_stmt|;
block|}
DECL|method|MiniRouterDFSCluster (boolean ha, int numNameservices, Configuration overrideConf)
specifier|public
name|MiniRouterDFSCluster
parameter_list|(
name|boolean
...
return|;
block|}
DECL|method|configureNameservices (int numNameservices, int numNamenodes, Configuration overrideConf)
specifier|public
name|void
name|configureNameservices
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Set independent DNs across subclusters
name|int
name|numDNs
init|=
name|nameservices
...
argument_list|)
expr_stmt|;
comment|// Router also uses this configurations as initial values.
name|routerConf
operator|=
operator|new
name|Configuration
