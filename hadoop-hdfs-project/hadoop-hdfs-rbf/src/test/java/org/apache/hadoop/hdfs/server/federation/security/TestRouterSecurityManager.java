...
annotation|@
name|Test
DECL|method|testCreateSecretManagerUsingReflection ()
specifier|public
name|void
name|testCreateSecretManagerUsingReflection
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testWithoutSecretManager ()
specifier|public
name|void
name|testWithoutSecretManager
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// router will throw an exception since zookeeper isn't running
name|intercept
argument_list|(
name|ServiceStateException
operator|.
...
annotation|@
name|Test
DECL|method|testNotRunningSecretManager ()
specifier|public
name|void
name|testNotRunningSecretManager
parameter_list|()
throws|throws
name|Exception
block|{
