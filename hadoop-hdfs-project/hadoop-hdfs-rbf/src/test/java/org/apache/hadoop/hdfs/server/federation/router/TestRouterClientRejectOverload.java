...
annotation|@
name|Test
DECL|method|testAsyncCallerPoolMetrics ()
specifier|public
name|void
name|testAsyncCallerPoolMetrics
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Set only one router to make test easier
name|cluster
operator|.
name|getRouters
argument_list|()
...
argument_list|()
decl_stmt|;
comment|// No active connection initially
name|Map
argument_list|<
name|String
argument_list|,
...
try|try
block|{
comment|// Run a client request to create an active connection
name|exec
operator|.
name|submit
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Wait for client request to be active
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
...
name|error
argument_list|(
literal|"Not able to parse metrics result: "
operator|+
name|e
argument_list|)
expr_stmt|;
