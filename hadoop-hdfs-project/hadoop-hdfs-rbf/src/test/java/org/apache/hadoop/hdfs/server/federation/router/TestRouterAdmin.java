...
argument_list|()
expr_stmt|;
comment|// Add two name services for testing disabling
name|ActiveNamenodeResolver
name|membership
init|=
name|router
...
argument_list|)
expr_stmt|;
comment|// Avoid running with random users
name|routerContext
operator|.
...
argument_list|()
decl_stmt|;
comment|// There shouldn't be any name service disabled
name|Set
argument_list|<
name|String
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Disable one and see it
name|DisableNameserviceRequest
name|disableReq
init|=
name|DisableNameserviceRequest
...
argument_list|)
expr_stmt|;
comment|// Enable one and we should have no disabled name services
name|EnableNameserviceRequest
name|enableReq
init|=
name|EnableNameserviceRequest
...
argument_list|)
expr_stmt|;
comment|// Non existing name services should fail
name|disableReq
operator|=
name|DisableNameserviceRequest
operator|.
...
expr_stmt|;
block|}
DECL|method|testNameserviceManagerUser (String username)
specifier|private
name|DisableNameserviceResponse
name|testNameserviceManagerUser
parameter_list|(
name|String
name|username
parameter_list|)
...
annotation|@
name|Test
DECL|method|testNameserviceManagerUnauthorized ()
specifier|public
name|void
name|testNameserviceManagerUnauthorized
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testNameserviceManagerWithRules ()
specifier|public
name|void
name|testNameserviceManagerWithRules
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Try to disable a name service with a kerberos principal name
name|String
name|username
init|=
...
begin_function
DECL|method|getDisabledNameservices (NameserviceManager nsManager)
specifier|private
name|Set
argument_list|<
name|String
