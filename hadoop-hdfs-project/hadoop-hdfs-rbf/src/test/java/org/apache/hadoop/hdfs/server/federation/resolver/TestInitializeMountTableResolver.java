...
name|assertFalse
argument_list|(
literal|"Default NS should be disabled if default NS is set empty"
argument_list|,
name|mountTable
operator|.
...
expr_stmt|;
block|}
comment|// Default NS should be empty if configured false.
annotation|@
name|Test
DECL|method|testRouterDefaultNameserviceDisabled ()
specifier|public
name|void
name|testRouterDefaultNameserviceDisabled
parameter_list|()
block|{
name|Configuration
name|conf
