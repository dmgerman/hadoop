...
return|;
block|}
comment|/**    * Get the client configuration which targets all the Routers. It uses the HA    * setup to fails over between them.    * @return Configuration for the client which uses two routers.    */
DECL|method|getRouterClientConf ()
specifier|public
name|Configuration
