...
begin_comment
comment|/**  * Test secure set times operations on the Router-based FS.  */
end_comment

begin_class
DECL|class|TestRouterHDFSContractSetTimesSecure
specifier|public
class|class
name|TestRouterHDFSContractSetTimesSecure
extends|extends
name|AbstractContractSetTimesTest
block|{
annotation|@
