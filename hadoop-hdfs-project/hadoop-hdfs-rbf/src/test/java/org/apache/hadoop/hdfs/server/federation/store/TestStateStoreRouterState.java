...
annotation|@
name|Test
DECL|method|testRouterStateExpiredAndDeletion ()
specifier|public
name|void
name|testRouterStateExpiredAndDeletion
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|()
decl_stmt|;
comment|// Verify entry is expired
return|return
name|routerState
operator|.
name|getStatus
...
argument_list|)
expr_stmt|;
comment|// Heartbeat again and this shouldn't be EXPIRED at this point
name|assertTrue
argument_list|(
name|routerStore
operator|.
...
argument_list|)
expr_stmt|;
comment|// Wait deletion (set in conf to 2 seconds)
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// Verify entry is deleted
return|return
name|routerState
operator|.
name|getStatus
