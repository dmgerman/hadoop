...
annotation|@
name|Test
DECL|method|testAllowDisallowSnapshots ()
specifier|public
name|void
name|testAllowDisallowSnapshots
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Check that initially doesn't allow snapshots
name|NamenodeContext
name|nnContext
init|=
name|cluster
...
argument_list|)
expr_stmt|;
comment|// Allow snapshots and verify the folder allows them
name|routerProtocol
operator|.
name|allowSnapshot
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Disallow snapshot on dir and verify does not allow snapshots anymore
name|routerProtocol
operator|.
...
annotation|@
name|Test
DECL|method|testManageSnapshot ()
specifier|public
name|void
name|testManageSnapshot
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"Setup a mount point for snapshots: {}"
argument_list|,
name|mountPoint
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Rename the snapshot and check it changed"
argument_list|)
expr_stmt|;
name|routerProtocol
operator|.
...
name|class
argument_list|,
literal|"Cannot delete snapshot snap from path "
operator|+
name|snapshotFolder
operator|+
literal|":"
...
name|info
argument_list|(
literal|"Delete the snapshot and check it is not there"
argument_list|)
expr_stmt|;
name|routerProtocol
operator|.
...
annotation|@
name|Test
DECL|method|testGetSnapshotListing ()
specifier|public
name|void
name|testGetSnapshotListing
parameter_list|()
throws|throws
name|IOException
block|{
comment|// Create a directory via the router and allow snapshots
specifier|final
name|String
name|snapshotPath
init|=
literal|"/testGetSnapshotListing"
decl_stmt|;
specifier|final
name|String
name|childDir
...
argument_list|)
expr_stmt|;
comment|// Check for listing through the Router
name|SnapshottableDirectoryStatus
index|[]
name|dirList
init|=
...
argument_list|)
expr_stmt|;
comment|// Check for difference report in two snapshot
name|SnapshotDiffReport
name|diffReport
init|=
name|routerProtocol
...
argument_list|)
expr_stmt|;
comment|// Check for difference in two snapshot
name|byte
index|[]
name|startPath
init|=
...
expr_stmt|;
block|}
comment|/**    * Create a file for each NameSpace, then find their 1st block and mark one of    * the replica as corrupt through BlockManager#findAndMarkBlockAsCorrupt.    *    * After all NameNode received the corrupt replica report, the    * replicatedBlockStats.getCorruptBlocks() should equal to the sum of    * corruptBlocks of all NameSpaces.    */
annotation|@
name|Test
DECL|method|testGetReplicatedBlockStats ()
specifier|public
name|void
name|testGetReplicatedBlockStats
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// mark a replica as corrupt
name|LocatedBlock
name|block
init|=
name|NameNodeAdapter
...
argument_list|)
expr_stmt|;
comment|// save the getReplicatedBlockStats result
name|ReplicatedBlockStats
name|stats
init|=
name|context
...
name|assertEquals
argument_list|(
literal|"There should be 1 corrupt blocks for each NN"
argument_list|,
name|cluster
operator|.
name|getNameservices
...
annotation|@
name|Test
DECL|method|testRBFMetricsMethodsRelayOnStateStore ()
specifier|public
name|void
name|testRBFMetricsMethodsRelayOnStateStore
parameter_list|()
block|{
name|assertNull
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// These 2 methods relays on {@link RBFMetrics#getNamespaceInfo()}
name|assertEquals
argument_list|(
literal|"[]"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// These methods relays on
comment|// {@link RBFMetrics#getActiveNamenodeRegistration()}
name|assertEquals
argument_list|(
literal|"{}"
argument_list|,
...
name|routerFS
decl_stmt|;
comment|// Verify cache directive commands.
name|CachePoolInfo
name|cpInfo
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// Modify cache directive.
name|routerDFS
operator|.
...
annotation|@
name|Test
DECL|method|testgetGroupsForUser ()
specifier|public
name|void
name|testgetGroupsForUser
parameter_list|()
throws|throws
name|IOException
block|{
