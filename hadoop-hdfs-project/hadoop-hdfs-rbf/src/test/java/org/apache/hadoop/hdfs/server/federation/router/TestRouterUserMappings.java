...
begin_comment
comment|/**  * Test RefreshUserMappingsProtocol and GetUserMappingsProtocol with Routers.  */
end_comment

begin_class
DECL|class|TestRouterUserMappings
specifier|public
class|class
name|TestRouterUserMappings
block|{
DECL|field|LOG
specifier|private
specifier|static
...
argument_list|)
expr_stmt|;
name|testGroupsForUserProtocol
argument_list|(
name|conf
argument_list|,
literal|"user"
...
expr_stmt|;
block|}
comment|/**    * Use the command line to get the groups.    * @param config Configuration containing the default filesystem.    * @param username Username to check.    * @throws Exception If it cannot get the groups.    */
DECL|method|testGroupsForUserCLI (Configuration config, String username)
specifier|private
name|void
name|testGroupsForUserCLI
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Use the GetUserMappingsProtocol protocol to get the groups.    * @param config Configuration containing the default filesystem.    * @param username Username to check.    * @throws IOException If it cannot get the groups.    */
DECL|method|testGroupsForUserProtocol (Configuration config, String username)
specifier|private
name|void
name|testGroupsForUserProtocol
parameter_list|(
