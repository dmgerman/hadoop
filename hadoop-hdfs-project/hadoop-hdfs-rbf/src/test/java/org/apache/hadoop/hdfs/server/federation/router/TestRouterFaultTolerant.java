...
name|add
argument_list|(
name|getContentSummaryFailTask
argument_list|(
name|router0Fs
argument_list|,
name|mountPoint
...
name|add
argument_list|(
name|getContentSummarySuccessTask
argument_list|(
name|router1Fs
argument_list|,
name|mountPoint
...
name|assertEquals
argument_list|(
literal|"Failed content summary"
argument_list|,
literal|2
argument_list|,
name|results
...
block|}
comment|/**    * Task that lists a directory and expects to fail.    * @param fs File system to check.    * @param path Path to try to list.    * @return If the listing failed as expected.    */
DECL|method|getContentSummaryFailTask ( FileSystem fs, Path path)
specifier|private
specifier|static
name|Callable
argument_list|<
...
block|}
comment|/**    * Task that lists a directory and succeeds.    * @param fs File system to check.    * @param path Path to list.    * @param expected Number of files to expect to find.    * @return If the listing succeeds.    */
DECL|method|getContentSummarySuccessTask ( FileSystem fs, Path path, int expected)
specifier|private
specifier|static
name|Callable
argument_list|<
