...
annotation|@
name|Test
DECL|method|testDestinationOfConsecutiveSlash ()
specifier|public
name|void
name|testDestinationOfConsecutiveSlash
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testGetMountPointOfConsecutiveSlashes ()
specifier|public
name|void
name|testGetMountPointOfConsecutiveSlashes
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testTrailingSlashInInputPath ()
specifier|public
name|void
name|testTrailingSlashInInputPath
parameter_list|()
throws|throws
name|IOException
block|{
comment|// Check mount points beneath the path with trailing slash.
name|getMountPoints
argument_list|(
literal|true
argument_list|)
...
name|IOException
block|{
comment|// Check mount points beneath the path without trailing slash.
name|getMountPoints
argument_list|(
literal|false
argument_list|)
expr_stmt|;
block|}
DECL|method|getMountPoints (boolean trailingSlash)
specifier|private
name|void
name|getMountPoints
parameter_list|(
...
annotation|@
name|Test
DECL|method|testSuccessiveSlashesInInputPath ()
specifier|public
name|void
name|testSuccessiveSlashesInInputPath
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testGetMountsOfConsecutiveSlashes ()
specifier|public
name|void
name|testGetMountsOfConsecutiveSlashes
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**    * Test if we add a new entry, the cached locations which are children of it    * should be invalidate    */
annotation|@
name|Test
DECL|method|testInvalidateCache ()
specifier|public
name|void
...
name|Exception
block|{
comment|// Add the entry 1->/ and ensure cache update correctly
name|Map
argument_list|<
name|String
argument_list|,
...
name|assertEquals
argument_list|(
literal|"1->/testInvalidateCache/foo"
argument_list|,
name|mountTable
operator|.
name|getDestinationForPath
argument_list|(
literal|"/testInvalidateCache/foo"
argument_list|)
operator|.
name|toString
argument_list|()
argument_list|)
expr_stmt|;
comment|// Add the entry 2->/testInvalidateCache and ensure the cached location
comment|// under it is invalidated correctly
name|Map
argument_list|<
name|String
argument_list|,
...
name|assertEquals
argument_list|(
literal|"2->/testInvalidateCache/foo"
argument_list|,
name|mountTable
operator|.
name|getDestinationForPath
