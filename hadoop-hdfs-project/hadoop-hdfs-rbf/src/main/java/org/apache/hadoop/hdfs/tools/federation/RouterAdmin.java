...
return|;
block|}
comment|/**    * Refresh superuser proxy groups mappings on Router.    *    * @throws IOException if the operation was not successful.    */
...
name|println
argument_list|(
literal|"Successfully updated superuser proxy groups on router "
operator|+
name|address
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// Check if -d parameter is specified.
name|detail
operator|=
literal|true
expr_stmt|;
...
literal|"/"
expr_stmt|;
comment|// If no path is provide with -ls -d.
block|}
else|else
block|{
name|path
...
expr_stmt|;
block|}
DECL|method|printMounts (List<MountTable> entries, boolean detail)
specifier|private
specifier|static
name|void
name|printMounts
...
name|format
argument_list|(
literal|"%-25s %-25s %-25s %-25s %-10s %-30s %-10s %-10s %-15s"
argument_list|,
literal|"Source"
argument_list|,
...
name|format
argument_list|(
literal|"%-25s %-25s %-25s %-25s %-10s %-30s"
argument_list|,
literal|"Source"
argument_list|,
literal|"Destinations"
