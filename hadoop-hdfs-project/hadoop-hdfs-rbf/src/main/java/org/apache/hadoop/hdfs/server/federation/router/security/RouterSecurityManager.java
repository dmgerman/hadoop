...
expr_stmt|;
block|}
comment|/**    * Creates an instance of a SecretManager from the configuration.    *    * @param conf Configuration that defines the secret manager class.    * @return New secret manager.    */
specifier|public
specifier|static
name|AbstractDelegationTokenSecretManager
argument_list|<
...
name|info
argument_list|(
literal|"Delegation token secret manager object instantiated"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|error
argument_list|(
literal|"RuntimeException to instantiate: {}"
argument_list|,
name|clazz
operator|.
name|getSimpleName
