...
name|ugi
decl_stmt|;
comment|/** Protocol for the connection. */
DECL|field|protocol
specifier|private
specifier|final
name|Class
...
name|protocol
decl_stmt|;
comment|/**    * New connection pool identifier.    *    * @param ugi Information of the user issuing the request.    * @param nnId Namenode address with port.    * @param proto Protocol of the connection.    */
DECL|method|ConnectionPoolId (final UserGroupInformation ugi, final String nnId, final Class<?> proto)
specifier|public
name|ConnectionPoolId
parameter_list|(
specifier|final
