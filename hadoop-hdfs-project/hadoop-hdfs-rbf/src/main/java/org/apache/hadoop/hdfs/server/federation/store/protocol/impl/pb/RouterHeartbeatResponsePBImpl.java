...
operator|.
name|RouterHeartbeatResponseProto
import|;
end_import
...
name|HdfsServerFederationProtos
operator|.
name|RouterHeartbeatResponseProtoOrBuilder
import|;
end_import
...
begin_comment
comment|/**  * Protobuf implementation of the state store API object  * RouterHeartbeatResponse.  */
end_comment

begin_class
DECL|class|RouterHeartbeatResponsePBImpl
specifier|public
class|class
name|RouterHeartbeatResponsePBImpl
extends|extends
name|RouterHeartbeatResponse
...
argument_list|)
decl_stmt|;
DECL|method|RouterHeartbeatResponsePBImpl ()
specifier|public
name|RouterHeartbeatResponsePBImpl
parameter_list|()
block|{   }
