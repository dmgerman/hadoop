...
decl_stmt|;
DECL|field|ERROR_MSG_FAULT_TOLERANT_MULTI_DEST
specifier|private
specifier|static
specifier|final
name|String
name|ERROR_MSG_FAULT_TOLERANT_MULTI_DEST
init|=
literal|"Invalid entry, fault tolerance requires multiple destinations "
decl_stmt|;
DECL|field|ERROR_MSG_FAULT_TOLERANT_ALL
specifier|private
specifier|static
specifier|final
name|String
name|ERROR_MSG_FAULT_TOLERANT_ALL
init|=
...
parameter_list|)
function_decl|;
comment|/**    * Check if the mount point supports a failed destination.    *    * @return If it supports failures.    */
DECL|method|isFaultTolerant ()
specifier|public
specifier|abstract
name|boolean
...
parameter_list|()
function_decl|;
comment|/**    * Set if the mount point supports failed destinations.    *    * @param faultTolerant If it supports failures.    */
DECL|method|setFaultTolerant (boolean faultTolerant)
specifier|public
specifier|abstract
name|void
