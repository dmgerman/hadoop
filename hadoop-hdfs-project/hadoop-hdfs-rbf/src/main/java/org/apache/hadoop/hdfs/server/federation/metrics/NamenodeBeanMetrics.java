...
name|IOException
argument_list|(
literal|"Federated metrics is not initialized"
argument_list|)
throw|;
block|}
return|return
...
name|debug
argument_list|(
literal|"Failed to get the used capacity"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get remaining capacity"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to Get total capacity"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get provided capacity"
argument_list|,
name|e
operator|.
name|getMessage
...
block|{
return|return
literal|"Failed to get safemode status. Please check router"
operator|+
literal|"log for more detail."
return|;
block|}
block|}
annotation|@
...
name|debug
argument_list|(
literal|"Failed to get number of blocks"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of missing blocks"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of blocks pending replica"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of blocks under replicated"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of blocks pending deletion"
argument_list|,
name|e
operator|.
name|getMessage
...
name|error
argument_list|(
literal|"Cannot get {} nodes, subclusters timed out responding"
argument_list|,
name|type
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Failed to get the router startup time"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of files"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of live nodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of dead nodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of stale nodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get the number of live decommissioned datanodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get the number of dead decommissioned datanodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of decommissioning nodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of live in maintenance nodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of dead in maintenance nodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get number of entering maintenance nodes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|debug
argument_list|(
literal|"Failed to get security status."
argument_list|,
name|e
operator|.
name|getMessage
...
name|IOException
argument_list|(
literal|"Router is not initialized"
argument_list|)
throw|;
block|}
return|return
