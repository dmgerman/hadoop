...
block|}
block|}
comment|/**    * Update quota in cache. The usage will be preserved.    * @param path Mount table path.    * @param quota Corresponding quota value.    */
DECL|method|updateQuota (String path, RouterQuotaUsage quota)
specifier|public
name|void
name|updateQuota
parameter_list|(
