...
expr_stmt|;
block|}
comment|/**    * Set quota for the federation path.    * @param path Federation path.    * @param locations Locations of the Federation path.    * @param namespaceQuota Name space quota.    * @param storagespaceQuota Storage space quota.    * @param type StorageType that the space quota is intended to be set on.    * @throws IOException If the quota system is disabled.    */
DECL|method|setQuotaInternal (String path, List<RemoteLocation> locations, long namespaceQuota, long storagespaceQuota, StorageType type)
name|void
name|setQuotaInternal
parameter_list|(
name|String
...
begin_comment
comment|/**    * Get aggregated quota usage for the federation path.    * @param path Federation path.    * @return Aggregated quota.    * @throws IOException If the quota system is disabled.    */
end_comment
...
begin_comment
comment|/**    * Get quota usage for the federation path.    * @param path Federation path.    * @return quota usage for each remote location.    * @throws IOException If the quota system is disabled.    */
end_comment

begin_function
DECL|method|getEachQuotaUsage (String path)
name|Map
argument_list|<
name|RemoteLocation
argument_list|,
...
begin_comment
unit|}
comment|/**    * Get global quota for the federation path.    * @param path Federation path.    * @return global quota for path.    * @throws IOException If the quota system is disabled.    */
end_comment

begin_expr_stmt
DECL|method|getGlobalQuota (String path)
unit|QuotaUsage
name|getGlobalQuota
argument_list|(
name|String
