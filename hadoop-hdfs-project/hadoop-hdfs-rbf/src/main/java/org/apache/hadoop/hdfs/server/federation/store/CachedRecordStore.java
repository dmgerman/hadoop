...
return|;
block|}
comment|/**    * Updates the state store with any record overrides we detected, such as an    * expired state. If an expired record exists beyond deletion time, it is    * removed.    *    * @param query RecordQueryResult containing the data to be inspected.    * @throws IOException If the values cannot be updated.    */
...
name|info
argument_list|(
literal|"Deleted State Store record {}: {}"
argument_list|,
name|recordName
argument_list|,
name|record
...
name|warn
argument_list|(
literal|"Couldn't delete State Store record {}: {}"
argument_list|,
name|recordName
argument_list|,
name|record
