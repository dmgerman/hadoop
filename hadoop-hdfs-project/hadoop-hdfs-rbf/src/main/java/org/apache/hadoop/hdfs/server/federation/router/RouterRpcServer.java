...
begin_comment
unit|}
comment|/**    * Get the permissions for the parent of a child with given permissions. If    * the child has r--, we will set it to r-x.    * @param mask The permission mask of the child.    * @return The permission mask of the parent.    */
end_comment
...
begin_comment
comment|/**    * Apply the execute permissions if it can be read.    * @param action Input permission.    * @return Output permission.    */
end_comment

begin_function
DECL|method|applyExecute (final FsAction action)
specifier|private
specifier|static
name|FsAction
name|applyExecute
