...
begin_comment
comment|/**    * Check if a path should be in all subclusters.    *    * @param path Path to check.    * @return If a path should be in all subclusters.    */
end_comment

begin_function
DECL|method|isPathAll (final String path)
specifier|private
name|boolean
name|isPathAll
parameter_list|(
