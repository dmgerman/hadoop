...
literal|false
decl_stmt|;
comment|/** If the mount table is manually disabled*/
DECL|field|disabled
specifier|private
name|boolean
name|disabled
...
expr_stmt|;
block|}
DECL|method|MountTableResolver (Configuration conf, Router routerService, StateStoreService store)
specifier|public
name|MountTableResolver
parameter_list|(
name|Configuration
...
name|warn
argument_list|(
literal|"Default name service is disabled."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|warn
argument_list|(
literal|"Default name service is not set."
argument_list|)
expr_stmt|;
block|}
else|else
...
name|info
argument_list|(
literal|"Default name service: {}, enabled to read or write"
argument_list|,
name|this
operator|.
name|defaultNameService
...
return|return;
block|}
comment|// Go through the entries and remove the ones from the path to invalidate
name|ConcurrentMap
argument_list|<
name|String
argument_list|,
...
name|debug
argument_list|(
literal|"Removing default cache {}"
argument_list|,
name|dest
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Location cache after invalidation: {}"
argument_list|,
name|locationCache
argument_list|)
expr_stmt|;
...
annotation|@
name|VisibleForTesting
DECL|method|setDisabled (boolean disable)
specifier|public
name|void
name|setDisabled
parameter_list|(
