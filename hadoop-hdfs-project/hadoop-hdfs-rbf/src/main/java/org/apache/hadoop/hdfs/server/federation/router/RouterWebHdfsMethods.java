...
block|{
comment|// Reset ugi to remote user for remaining operations.
name|RouterRpcServer
operator|.
...
return|;
block|}
comment|/**    * Generate the credentials for this request.    * @param ugi User group information.    * @param renewer Who is asking for the renewal.    * @return Credentials holding delegation token.    * @throws IOException If it cannot create the credentials.    */
annotation|@
name|Override
