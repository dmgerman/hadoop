...
decl_stmt|;
DECL|field|dtpReplaceDatanodeOnFailureReplication
specifier|final
name|short
...
decl_stmt|;
DECL|field|serverDefaultsValidityPeriod
specifier|private
specifier|final
name|long
...
literal|false
expr_stmt|;
comment|// close dead node detector thread
name|clientContext
operator|.
name|stopDeadNodeDetectorThread
argument_list|()
expr_stmt|;
...
name|debug
argument_list|(
literal|"Start decrypting EDEK for file: {}, output stream: 0x{}"
argument_list|,
name|dfsos
operator|.
name|getSrc
...
name|debug
argument_list|(
literal|"Decrypted EDEK for file: {}, output stream: 0x{}"
argument_list|,
name|dfsos
operator|.
name|getSrc
...
argument_list|)
expr_stmt|;
comment|// check invariants in path handle
name|LocatedBlocks
name|locatedBlocks
init|=
name|s
...
block|}
block|}
DECL|method|openInternal (LocatedBlocks locatedBlocks, String src, boolean verifyChecksum)
specifier|private
name|DFSInputStream
name|openInternal
parameter_list|(
...
return|;
block|}
comment|/**    * Same as {@link #create(String, FsPermission, EnumSet, boolean, short, long,    * addition of Progressable, int, ChecksumOpt, InetSocketAddress[], String)}    * with the storagePolicy that is used to specify a specific storage policy    * instead of inheriting any policy from this new file's parent directory.    * This policy will be persisted in HDFS. A value of null means inheriting    * parent groups' whatever policy.    */
DECL|method|create (String src, FsPermission permission, EnumSet<CreateFlag> flag, boolean createParent, short replication, long blockSize, Progressable progress, int buffersize, ChecksumOpt checksumOpt, InetSocketAddress[] favoredNodes, String ecPolicyName, String storagePolicy)
specifier|public
name|DFSOutputStream
name|create
parameter_list|(
...
block|}
block|}
comment|/**    * Get the file info for a specific file or directory.    * @param src The string representation of the path to the file    * @param needBlockToken Include block tokens in {@link LocatedBlocks}.    *        When block tokens are included, this call is a superset of    *        {@link #getBlockLocations(String, long)}.    * @return object containing information regarding the file    *         or null if file not found    *    * @see DFSClient#open(HdfsPathHandle, int, boolean)    * @see ClientProtocol#getFileInfo(String) for description of    *      exceptions    */
...
return|;
block|}
DECL|method|getFileChecksumInternal ( String src, long length, ChecksumCombineMode combineMode)
specifier|private
name|FileChecksum
name|getFileChecksumInternal
parameter_list|(
name|String
name|src
parameter_list|,
...
DECL|method|getFileChecksumWithCombineMode (String src, long length)
specifier|public
name|FileChecksum
...
block|}
block|}
comment|/**    * Get the difference between two snapshots, or between a snapshot and the    * current tree of a directory.    * @see ClientProtocol#getSnapshotDiffReport    */
...
block|}
block|}
comment|/**    * Get the difference between two snapshots of a directory iteratively.    * @see ClientProtocol#getSnapshotDiffReportListing    */
...
name|newPathTraceScope
argument_list|(
literal|"reencryptEncryptionZone"
argument_list|,
name|zone
argument_list|)
init|)
...
block|}
block|}
comment|/**    * Satisfy storage policy for an existing file/directory.    * @param src file/directory name    * @throws IOException    */
...
return|;
block|}
comment|/**    * If deadNodeDetectionEnabled is true, return the dead nodes that detected by    * all the DFSInputStreams in the same client. Otherwise return the dead nodes    * that detected by given DFSInputStream.    */
DECL|method|getDeadNodes ( DFSInputStream dfsInputStream)
specifier|public
name|ConcurrentHashMap
argument_list|<
name|DatanodeInfo
...
block|}
block|}
comment|/**    * If deadNodeDetectionEnabled is true, judgement based on whether this    * datanode is included or not in DeadNodeDetector. Otherwise judgment based    * given DFSInputStream.    */
DECL|method|isDeadNode (DFSInputStream dfsInputStream, DatanodeInfo datanodeInfo)
specifier|public
name|boolean
name|isDeadNode
parameter_list|(
...
block|}
block|}
comment|/**    * Add given datanode in DeadNodeDetector.    */
DECL|method|addNodeToDeadNodeDetector (DFSInputStream dfsInputStream, DatanodeInfo datanodeInfo)
specifier|public
name|void
...
name|debug
argument_list|(
literal|"DeadNode detection is not enabled, skip to add node {}."
argument_list|,
name|datanodeInfo
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Remove given datanode from DeadNodeDetector.    */
...
name|debug
argument_list|(
literal|"DeadNode detection is not enabled, skip to remove node {}."
argument_list|,
name|datanodeInfo
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Remove datanodes that given block placed on from DeadNodeDetector.    */
DECL|method|removeNodeFromDeadNodeDetector (DFSInputStream dfsInputStream, LocatedBlocks locatedBlocks)
specifier|public
name|void
name|removeNodeFromDeadNodeDetector
parameter_list|(
...
name|debug
argument_list|(
literal|"DeadNode detection is not enabled or given block {} "
operator|+
literal|"is null, skip to remove node."
argument_list|,
name|locatedBlocks
argument_list|)
expr_stmt|;
