...
begin_comment
comment|/**  * AddBlockFlag provides hints for new block allocation and placement.  * Users can use this flag to control<em>per DFSOutputStream</em>  * @see ClientProtocol#addBlock(String, String, ExtendedBlock, DatanodeInfo[],  *      long, String[], EnumSet)  */
end_comment
