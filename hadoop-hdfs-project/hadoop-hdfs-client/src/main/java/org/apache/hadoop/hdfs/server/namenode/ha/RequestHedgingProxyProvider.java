...
begin_comment
comment|/**    * Check if the returned exception is caused by an standby namenode.    * @param ex Exception to check.    * @return If the exception is caused by an standby namenode.    */
end_comment

begin_function
DECL|method|isStandbyException (Exception ex)
specifier|private
name|boolean
name|isStandbyException
parameter_list|(
...
begin_comment
comment|/**    * Unwraps the exception.<p>    * Example:    *<blockquote><pre>    * if ex is    * ExecutionException(InvocationTargetExeption(SomeException))    * returns SomeException    *</pre></blockquote>    *    * @return unwrapped exception    */
end_comment

begin_function
DECL|method|unwrapException (Exception ex)
specifier|private
name|Exception
name|unwrapException
parameter_list|(
