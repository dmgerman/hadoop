...
literal|false
decl_stmt|;
DECL|field|exceptionInClose
specifier|private
name|boolean
name|exceptionInClose
init|=
literal|false
decl_stmt|;
...
annotation|@
name|VisibleForTesting
DECL|method|setExceptionInClose (boolean enable)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|class|EmulateExceptionInClose
specifier|private
class|class
name|EmulateExceptionInClose
block|{
DECL|field|rand
specifier|private
name|Random
...
literal|null
decl_stmt|;
DECL|field|kickedNum
specifier|private
name|int
name|kickedNum
decl_stmt|;
DECL|method|EmulateExceptionInClose (int callNum)
name|EmulateExceptionInClose
parameter_list|(
name|int
name|callNum
...
expr_stmt|;
block|}
DECL|method|kickRandomException ()
name|void
name|kickRandomException
parameter_list|()
throws|throws
name|IOException
block|{
...
name|IOException
argument_list|(
literal|"Emulated random IOException in close"
argument_list|)
throw|;
block|}
block|}
...
name|IOException
argument_list|(
literal|"Emulated IOException in close"
argument_list|)
throw|;
block|}
block|}
...
name|warn
argument_list|(
literal|"Fail to recover lease for {}"
argument_list|,
name|src
argument_list|,
name|e
...
parameter_list|)
block|{
comment|// Ignore exception rendered by recoverLease. Throw original
comment|// exception
block|}
block|}
throw|throw
...
name|sleeptime
operator|=
name|calculateDelayForNextRetry
argument_list|(
name|sleeptime
argument_list|,
name|maxSleepTime
...
block|}
block|}
comment|/**    * Calculates the delay for the next retry.    *    * The delay is increased exponentially until the maximum delay is reached.    *    * @param previousDelay delay for the previous retry    * @param maxDelay maximum delay    * @return the minimum of the double of the previous delay    * and the maximum delay    */
DECL|method|calculateDelayForNextRetry (long previousDelay, long maxDelay)
specifier|private
specifier|static
name|long
name|calculateDelayForNextRetry
