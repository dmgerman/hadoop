...
name|ClientNamenodeProtocolProtos
operator|.
name|CheckStoragePolicySatisfyPathStatusResponseProto
operator|.
...
argument_list|()
decl_stmt|;
comment|/**    * Map used to cache fixed strings to ByteStrings. Since there is no    * automatic expiration policy, only use this for strings from a fixed, small    * set.    *<p/>    * This map should not be accessed directly. Used the getFixedByteString    * methods instead.    */
DECL|field|fixedByteStringCache
specifier|private
specifier|static
name|ConcurrentHashMap
argument_list|<
...
argument_list|()
decl_stmt|;
DECL|method|getFixedByteString (Text key)
specifier|private
specifier|static
name|ByteString
name|getFixedByteString
parameter_list|(
name|Text
name|key
parameter_list|)
...
return|;
block|}
DECL|method|getFixedByteString (String key)
specifier|private
specifier|static
name|ByteString
name|getFixedByteString
...
return|;
block|}
comment|/**    * Guava cache for caching String to ByteString encoding. Use this when the    * set of Strings is large, mutable, or unknown.    */
DECL|field|bytestringCache
specifier|private
specifier|static
name|LoadingCache
argument_list|<
...
name|res
operator|.
name|hasHighestPrioLowRedundancyBlocks
argument_list|()
condition|)
block|{
return|return
...
name|res
operator|.
name|getHighestPrioLowRedundancyBlocks
argument_list|()
argument_list|)
return|;
block|}
...
name|result
operator|.
name|setHighestPrioLowRedundancyBlocks
argument_list|(
name|replicatedBlockStats
operator|.
...
return|;
block|}
DECL|method|convert ( HdfsConstants.StoragePolicySatisfyPathStatus status)
specifier|public
specifier|static
name|StoragePolicySatisfyPathStatus
name|convert
...
block|}
block|}
DECL|method|convert ( StoragePolicySatisfyPathStatus status)
specifier|public
specifier|static
name|HdfsConstants
operator|.
