...
block|}
block|}
DECL|method|BlockReaderRemote (String file, long blockId, DataChecksum checksum, boolean verifyChecksum, long startOffset, long firstChunkOffset, long bytesToRead, Peer peer, DatanodeID datanodeID, PeerCache peerCache, Tracer tracer, int networkDistance)
specifier|protected
name|BlockReaderRemote
parameter_list|(
name|String
