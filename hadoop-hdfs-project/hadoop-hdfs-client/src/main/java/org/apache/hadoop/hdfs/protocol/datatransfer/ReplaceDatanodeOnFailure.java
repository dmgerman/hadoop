...
block|{
comment|/**    * DEFAULT condition:    *   Let r be the replication number.    *   Let n be the number of existing datanodes.    *   Add a new datanode only if r>= 3 and either    *   (1) floor(r/2)>= n or (2) the block is hflushed/appended.    */
DECL|field|CONDITION_DEFAULT
specifier|private
specifier|static
specifier|final
name|Condition
name|CONDITION_DEFAULT
init|=
operator|new
name|Condition
argument_list|()
...
constructor|NEVER(CONDITION_FALSE
block|)
enum|,
comment|/** @see ReplaceDatanodeOnFailure#CONDITION_DEFAULT */
...
constructor|ALWAYS(CONDITION_TRUE
block|)
class|;
end_class
