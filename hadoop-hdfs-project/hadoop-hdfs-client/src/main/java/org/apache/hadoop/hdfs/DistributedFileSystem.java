...
expr_stmt|;
block|}
comment|/**    * Returns a remote iterator so that followup calls are made on demand    * while consuming the SnapshotDiffReportListing entries.    * This reduces memory consumption overhead in case the snapshotDiffReport    * is huge.    *    * @param snapshotDir    *          full path of the directory where snapshots are taken    * @param fromSnapshot    *          snapshot name of the from point. Null indicates the current    *          tree    * @param toSnapshot    *          snapshot name of the to point. Null indicates the current    *          tree.    * @return Remote iterator    */
specifier|public
name|RemoteIterator
DECL|method|snapshotDiffReportListingRemoteIterator ( final Path snapshotDir, final String fromSnapshot, final String toSnapshot)
argument_list|<
name|SnapshotDiffReportListing
argument_list|>
...
return|;
block|}
comment|/**    * This class defines an iterator that returns    * the SnapshotDiffReportListing for a snapshottable directory    * between two given snapshots.    */
DECL|class|SnapshotDiffReportListingIterator
specifier|private
specifier|final
class|class
name|SnapshotDiffReportListingIterator
...
literal|true
decl_stmt|;
DECL|method|SnapshotDiffReportListingIterator (String snapshotDir, String fromSnapshot, String toSnapshot)
specifier|private
name|SnapshotDiffReportListingIterator
parameter_list|(
name|String
...
specifier|private
name|SnapshotDiffReport
name|getSnapshotDiffReportInternal
parameter_list|(
specifier|final
name|String
name|snapshotDir
...
return|;
block|}
comment|/**    * Get the difference between two snapshots, or between a snapshot and the    * current tree of a directory.    *    * @see DFSClient#getSnapshotDiffReportListing    */
...
block|}
comment|/* HDFS only */
DECL|method|provisionEZTrash (final Path path, final FsPermission trashPermission)
specifier|public
name|void
...
name|UnsupportedOperationException
argument_list|(
literal|"Cannot provisionEZTrash "
operator|+
literal|"through a symlink to a non-DistributedFileSystem: "
operator|+
name|fs
operator|+
literal|" -> "
...
expr_stmt|;
block|}
DECL|method|provisionEZTrash (String path, FsPermission trashPermission)
specifier|private
name|void
name|provisionEZTrash
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Set the source path to satisfy storage policy. This API is non-recursive    * in nature, i.e., if the source path is a directory then all the files    * immediately under the directory would be considered for satisfying the    * policy and the sub-directories if any under this path will be skipped.    *    * @param path The source path referring to either a directory or a file.    * @throws IOException    */
...
name|UnsupportedOperationException
argument_list|(
literal|"Cannot satisfyStoragePolicy through a symlink to a "
operator|+
literal|"non-DistributedFileSystem: "
operator|+
name|path
