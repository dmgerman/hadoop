...
return|;
block|}
DECL|method|updateToken (Token<BlockTokenIdentifier> accessToken, SecretKey secretKey, Map<String, String> saslProps)
specifier|private
name|void
name|updateToken
parameter_list|(
...
comment|// a new version but the cluster does not have this feature.
comment|// In which case there will be no encrypted secret sent from NN.
name|BlockTokenIdentifier
name|blockTokenIdentifier
init|=
name|accessToken
...
name|debug
argument_list|(
literal|"Handshake secret is null, "
operator|+
literal|"sending without handshake secret."
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Block token id is null, sending without handshake secret."
argument_list|)
expr_stmt|;
name|sendSaslMessage
argument_list|(
