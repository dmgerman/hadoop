...
parameter_list|)
block|{
comment|// See the error message from ExceptionHandle
if|if
condition|(
name|e
operator|.
...
condition|)
block|{
comment|// Old webhdfs server doesn't support GETFILEBLOCKLOCATIONS
comment|// operation, fall back to query again using old API
comment|// GET_BLOCK_LOCATIONS.
name|LOG
operator|.
name|info
argument_list|(
literal|"Invalid webhdfs operation parameter "
operator|+
name|GetOpParam
operator|.
name|Op
