...
decl_stmt|;
DECL|field|isInsecureCluster
specifier|private
name|boolean
name|isInsecureCluster
decl_stmt|;
...
argument_list|)
decl_stmt|;
comment|//in insecure, use user.name parameter, in secure, use spnego auth
if|if
condition|(
name|isInsecureCluster
condition|)
...
name|warn
argument_list|(
literal|"Write to output stream for file '{}' failed. "
operator|+
literal|"Attempting to fetch the cause from the connection."
argument_list|,
name|getFspath
argument_list|()
argument_list|,
...
annotation|@
name|Override
DECL|method|satisfyStoragePolicy (final Path p)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|enableECPolicy (String policyName)
specifier|public
name|void
name|enableECPolicy
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|disableECPolicy (String policyName)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|setErasureCodingPolicy (Path p, String policyName)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|unsetErasureCodingPolicy (Path p)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|getErasureCodingPolicy (Path p)
specifier|public
name|ErasureCodingPolicy
...
annotation|@
name|Override
DECL|method|getQuotaUsage (final Path p)
specifier|public
name|QuotaUsage
name|getQuotaUsage
parameter_list|(
...
annotation|@
name|Override
DECL|method|setQuota (Path p, final long namespaceQuota, final long storagespaceQuota)
specifier|public
name|void
name|setQuota
parameter_list|(
...
annotation|@
name|Override
DECL|method|setQuotaByStorageType (Path path, StorageType type, long quota)
specifier|public
name|void
...
name|IllegalArgumentException
argument_list|(
literal|"Quota for storage type '"
operator|+
name|type
operator|.
name|toString
...
expr_stmt|;
block|}
comment|/**    * HDFS client capabilities.    * Uses {@link DfsPathCapabilities} to keep in sync with HDFS.    * {@inheritDoc}    */
annotation|@
name|Override
