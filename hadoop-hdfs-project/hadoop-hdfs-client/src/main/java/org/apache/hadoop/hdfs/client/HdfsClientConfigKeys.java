...
decl_stmt|;
block|}
comment|/** dfs.client.write.striped configuration properties */
DECL|interface|StripedWrite
interface|interface
name|StripedWrite
block|{
DECL|field|PREFIX
...
literal|"striped."
decl_stmt|;
DECL|field|MAX_SECONDS_GET_STRIPED_BLOCK_KEY
name|String
name|MAX_SECONDS_GET_STRIPED_BLOCK_KEY
init|=
name|PREFIX
operator|+
literal|"max-seconds-get-striped-block"
decl_stmt|;
DECL|field|MAX_SECONDS_GET_STRIPED_BLOCK_DEFAULT
name|int
name|MAX_SECONDS_GET_STRIPED_BLOCK_DEFAULT
init|=
literal|90
decl_stmt|;
DECL|field|MAX_SECONDS_GET_ENDED_BLOCK_KEY
name|String
name|MAX_SECONDS_GET_ENDED_BLOCK_KEY
init|=
name|PREFIX
operator|+
literal|"max-seconds-get-ended-block"
decl_stmt|;
DECL|field|MAX_SECONDS_GET_ENDED_BLOCK_DEFAULT
name|int
