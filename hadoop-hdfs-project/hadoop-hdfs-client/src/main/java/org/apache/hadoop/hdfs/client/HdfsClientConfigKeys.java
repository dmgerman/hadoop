...
literal|8192
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_ENABLED_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_ENABLED_KEY
init|=
literal|"dfs.client.deadnode.detection.enabled"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_ENABLED_DEFAULT
name|boolean
name|DFS_CLIENT_DEAD_NODE_DETECTION_ENABLED_DEFAULT
init|=
literal|false
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_DEAD_NODE_QUEUE_MAX_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_DEAD_NODE_QUEUE_MAX_KEY
init|=
literal|"dfs.client.deadnode.detection.deadnode.queue.max"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_DEAD_NODE_QUEUE_MAX_DEFAULT
name|int
name|DFS_CLIENT_DEAD_NODE_DETECTION_DEAD_NODE_QUEUE_MAX_DEFAULT
init|=
literal|100
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_SUSPECT_NODE_QUEUE_MAX_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_SUSPECT_NODE_QUEUE_MAX_KEY
init|=
literal|"dfs.client.deadnode.detection.suspectnode.queue.max"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_SUSPECT_NODE_QUEUE_MAX_DEFAULT
name|int
name|DFS_CLIENT_DEAD_NODE_DETECTION_SUSPECT_NODE_QUEUE_MAX_DEFAULT
init|=
literal|1000
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_CONNECTION_TIMEOUT_MS_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_CONNECTION_TIMEOUT_MS_KEY
init|=
literal|"dfs.client.deadnode.detection.probe.connection.timeout.ms"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_CONNECTION_TIMEOUT_MS_DEFAULT
name|long
name|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_CONNECTION_TIMEOUT_MS_DEFAULT
init|=
literal|20000
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_DEAD_NODE_THREADS_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_DEAD_NODE_THREADS_KEY
init|=
literal|"dfs.client.deadnode.detection.probe.deadnode.threads"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_DEAD_NODE_THREADS_DEFAULT
name|int
name|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_DEAD_NODE_THREADS_DEFAULT
init|=
literal|10
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_SUSPECT_NODE_THREADS_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_SUSPECT_NODE_THREADS_KEY
init|=
literal|"dfs.client.deadnode.detection.probe.suspectnode.threads"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_SUSPECT_NODE_THREADS_DEFAULT
name|int
name|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_SUSPECT_NODE_THREADS_DEFAULT
init|=
literal|10
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_RPC_THREADS_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_RPC_THREADS_KEY
init|=
literal|"dfs.client.deadnode.detection.rpc.threads"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_RPC_THREADS_DEFAULT
name|int
name|DFS_CLIENT_DEAD_NODE_DETECTION_RPC_THREADS_DEFAULT
init|=
literal|20
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_DEAD_NODE_INTERVAL_MS_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_DEAD_NODE_INTERVAL_MS_KEY
init|=
literal|"dfs.client.deadnode.detection.probe.deadnode.interval.ms"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_DEAD_NODE_INTERVAL_MS_DEFAULT
name|long
...
decl_stmt|;
comment|// 60s
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_SUSPECT_NODE_INTERVAL_MS_KEY
name|String
name|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_SUSPECT_NODE_INTERVAL_MS_KEY
init|=
literal|"dfs.client.deadnode.detection.probe.suspectnode.interval.ms"
decl_stmt|;
DECL|field|DFS_CLIENT_DEAD_NODE_DETECTION_PROBE_SUSPECT_NODE_INTERVAL_MS_DEFAULT
name|long
