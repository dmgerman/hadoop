...
return|;
block|}
DECL|method|setFactor (OzoneProtos.ReplicationFactor factor)
specifier|public
name|void
name|setFactor
parameter_list|(
...
return|;
block|}
comment|/**    * Sets the lifecycleState.    *    * @param lifeCycleStates - Enum    */
DECL|method|setLifeCycleState (OzoneProtos.LifeCycleState lifeCycleStates)
specifier|public
name|void
name|setLifeCycleState
parameter_list|(
...
return|;
block|}
comment|/**    * Sets the pipeline name.    *    * @param pipelineName - Sets the name.    */
...
return|;
block|}
comment|/**    * Sets the type of this pipeline.    *    * @param type - Standalone, Ratis, Chained.    */
DECL|method|setType (OzoneProtos.ReplicationType type)
specifier|public
name|void
name|setType
parameter_list|(
