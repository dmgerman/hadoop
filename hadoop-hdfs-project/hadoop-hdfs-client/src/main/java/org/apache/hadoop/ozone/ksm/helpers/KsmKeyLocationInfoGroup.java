...
begin_class
DECL|class|KsmKeyLocationInfoGroup
specifier|public
class|class
...
name|locationList
decl_stmt|;
DECL|method|KsmKeyLocationInfoGroup (long version, List<KsmKeyLocationInfo> locations)
specifier|public
name|KsmKeyLocationInfoGroup
parameter_list|(
name|long
...
DECL|method|generateNextVersion ( List<KsmKeyLocationInfo> newLocationList)
name|KsmKeyLocationInfoGroup
