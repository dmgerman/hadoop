...
DECL|method|finalizeDecodeInputs (final ByteBuffer[] decodeInputs, AlignedStripe alignedStripe)
specifier|public
specifier|static
name|void
...
condition|)
block|{
comment|//ZERO it. Will be better handled in other following issue.
name|byte
index|[]
name|emptyBytes
init|=
...
DECL|method|decodeAndFillBuffer (final ByteBuffer[] decodeInputs, AlignedStripe alignedStripe, int dataBlkNum, int parityBlkNum, RawErasureDecoder decoder)
specifier|public
specifier|static
name|void
