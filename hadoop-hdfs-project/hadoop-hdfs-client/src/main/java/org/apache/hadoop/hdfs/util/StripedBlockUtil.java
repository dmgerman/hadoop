...
argument_list|)
decl_stmt|;
comment|/**    * Struct holding the read statistics. This is used when reads are done    * asynchronously, to allow the async threads return the read stats and let    * the main reading thread to update the stats. This is important for the    * ThreadLocal stats for the main reading thread to be correct.    */
DECL|class|BlockReadStats
specifier|public
specifier|static
class|class
name|BlockReadStats
...
decl_stmt|;
DECL|method|BlockReadStats (int numBytesRead, boolean shortCircuit, int distance)
specifier|public
name|BlockReadStats
parameter_list|(
name|int
...
DECL|method|getNextCompletedStripedRead ( CompletionService<BlockReadStats> readService, Map<Future<BlockReadStats>, Integer> futures, final long timeoutMillis)
specifier|public
specifier|static
...
expr_stmt|;
block|}
DECL|method|StripingChunkReadResult (int index, int state, BlockReadStats stats)
specifier|public
name|StripingChunkReadResult
parameter_list|(
name|int
