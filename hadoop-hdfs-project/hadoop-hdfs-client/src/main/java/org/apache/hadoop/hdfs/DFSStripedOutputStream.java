...
decl_stmt|;
DECL|field|prevBlockGroup4Append
specifier|private
name|ExtendedBlock
name|prevBlockGroup4Append
decl_stmt|;
...
expr_stmt|;
block|}
comment|/** Construct a new output stream for appending to a file. */
DECL|method|DFSStripedOutputStream (DFSClient dfsClient, String src, EnumSet<CreateFlag> flags, Progressable progress, LocatedBlock lastBlock, HdfsFileStatus stat, DataChecksum checksum, String[] favoredNodes)
name|DFSStripedOutputStream
parameter_list|(
name|DFSClient
name|dfsClient
