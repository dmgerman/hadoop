...
block|}
block|}
comment|// should update the block group length based on the acked length
specifier|final
name|long
name|sentBytes
init|=
...
expr_stmt|;
block|}
comment|/**    * Get the number of acked stripes. An acked stripe means at least data block    * number size cells of the stripe were acked.    */
DECL|method|getNumAckedStripes ()
specifier|private
name|long
name|getNumAckedStripes
parameter_list|()
