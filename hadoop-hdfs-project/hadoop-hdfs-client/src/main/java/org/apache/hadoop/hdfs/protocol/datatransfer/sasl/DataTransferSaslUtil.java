...
block|}
block|}
DECL|class|SaslMessageWithHandshake
specifier|static
class|class
...
name|bpid
decl_stmt|;
DECL|method|SaslMessageWithHandshake (byte[] payload, byte[] secret, String bpid)
name|SaslMessageWithHandshake
parameter_list|(
name|byte
index|[]
...
block|}
block|}
DECL|method|readSaslMessageWithHandshakeSecret ( InputStream in)
specifier|public
specifier|static
name|SaslMessageWithHandshake
...
expr_stmt|;
block|}
DECL|method|sendSaslMessageHandshakeSecret (OutputStream out, byte[] payload, byte[] secret, String bpid)
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
DECL|method|sendSaslMessage (OutputStream out, DataTransferEncryptorStatus status, byte[] payload, String message, HandshakeSecretProto handshakeSecret)
specifier|public
specifier|static
name|void
name|sendSaslMessage
...
expr_stmt|;
block|}
DECL|method|sendSaslMessageHandshakeSecret (OutputStream out, DataTransferEncryptorStatus status, byte[] payload, String message, byte[] secret, String bpid)
specifier|public
specifier|static
name|void
name|sendSaslMessageHandshakeSecret
