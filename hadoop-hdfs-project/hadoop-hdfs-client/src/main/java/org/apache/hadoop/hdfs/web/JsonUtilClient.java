...
return|;
block|}
comment|/** Convert a JSON map to a QuotaUsage. */
DECL|method|toQuotaUsage (final Map<?, ?> json)
specifier|static
name|QuotaUsage
name|toQuotaUsage
parameter_list|(
...
return|;
block|}
comment|/**    * Given a builder for QuotaUsage, parse the provided map and    * construct the relevant fields. Return the updated builder.    */
DECL|method|buildQuotaUsage ( T builder, Map<?, ?> m, Class<T> type)
specifier|private
specifier|static
parameter_list|<
name|T
