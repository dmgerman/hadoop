...
block|}
block|}
DECL|method|toBlockLocationArray (Map<?, ?> json)
specifier|static
name|BlockLocation
index|[]
...
return|;
block|}
comment|/** Convert a Json map to BlockLocation. **/
DECL|method|toBlockLocation (Map<?, ?> m)
specifier|static
name|BlockLocation
name|toBlockLocation
parameter_list|(
...
return|;
block|}
DECL|method|toStringArray (List<?> list)
specifier|static
name|String
index|[]
name|toStringArray
