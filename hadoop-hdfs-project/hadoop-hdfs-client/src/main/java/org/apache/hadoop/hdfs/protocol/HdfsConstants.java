...
block|}
comment|/**    * Storage policy satisfier service modes.    */
DECL|enum|StoragePolicySatisfierMode
specifier|public
enum|enum
...
name|EXTERNAL
block|,
comment|/**      * This mode represents that SPS service is disabled and cannot accept any      * SPS call request.      */
...
block|}
block|}
comment|/** Convert the given String to a StoragePolicySatisfierMode. */
