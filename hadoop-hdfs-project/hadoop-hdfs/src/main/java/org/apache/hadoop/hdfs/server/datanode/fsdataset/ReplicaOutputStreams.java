...
DECL|method|ReplicaOutputStreams ( OutputStream dataOut, OutputStream checksumOut, DataChecksum checksum, FsVolumeSpi volume, FileIoProvider fileIoProvider)
specifier|public
name|ReplicaOutputStreams
parameter_list|(
name|OutputStream
...
block|}
block|}
DECL|method|writeDataToDisk (byte[] b, int off, int len)
specifier|public
name|void
