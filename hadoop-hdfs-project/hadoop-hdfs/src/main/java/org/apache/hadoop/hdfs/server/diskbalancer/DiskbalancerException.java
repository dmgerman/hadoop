...
DECL|method|DiskbalancerException (String message, int result)
specifier|public
name|DiskbalancerException
parameter_list|(
name|String
...
DECL|method|DiskbalancerException (String message, Throwable cause, int result)
specifier|public
name|DiskbalancerException
parameter_list|(
name|String
...
DECL|method|DiskbalancerException (Throwable cause, int result)
specifier|public
name|DiskbalancerException
parameter_list|(
name|Throwable
