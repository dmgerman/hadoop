...
return|;
block|}
DECL|method|computeQuotaDelta (INodeFile target, INodeFile[] srcList)
specifier|private
specifier|static
name|long
name|computeQuotaDelta
parameter_list|(
name|INodeFile
name|target
parameter_list|,
...
return|;
block|}
DECL|method|verifyQuota (FSDirectory fsd, INodesInPath targetIIP, long delta)
specifier|private
specifier|static
name|void
name|verifyQuota
