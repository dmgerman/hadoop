...
specifier|final
name|StorageContainerLocationProtocolClientSideTranslatorPB
DECL|field|storageContainerLocation
...
name|xceiverClientManager
decl_stmt|;
comment|/**    * Creates a new DistributedStorageHandler.    *    * @param conf configuration    * @param storageContainerLocation StorageContainerLocationProtocol proxy    */
DECL|method|DistributedStorageHandler (OzoneConfiguration conf, StorageContainerLocationProtocolClientSideTranslatorPB storageContainerLocation)
specifier|public
name|DistributedStorageHandler
parameter_list|(
name|OzoneConfiguration
...
argument_list|(
literal|"setVolumeOwner not implemented"
argument_list|)
throw|;
block|}
annotation|@
...
name|UnsupportedOperationException
argument_list|(
literal|"setVolumeQuota not implemented"
argument_list|)
throw|;
block|}
annotation|@
