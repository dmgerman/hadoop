...
name|Keys
block|{
comment|/**    * Gets the Key if it exists.    *    * @param volume  Storage Volume    * @param bucket  Name of the bucket    * @param req     Request    * @param info    - UriInfo    * @param headers Http Header    * @return Response    * @throws OzoneException    */
annotation|@
name|Override
DECL|method|getKey (String volume, String bucket, String key, Request req, UriInfo info, HttpHeaders headers)
specifier|public
name|Response
name|getKey
parameter_list|(
