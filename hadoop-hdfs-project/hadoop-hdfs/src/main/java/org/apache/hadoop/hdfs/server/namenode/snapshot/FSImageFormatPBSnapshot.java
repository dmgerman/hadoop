...
block|}
block|}
comment|/**      * Load the deleted list in a DirectoryDiff      * @param totalSize the total size of the deleted list      * @param deletedNodes non-reference inodes in the deleted list. These      *        inodes' ids are directly recorded in protobuf      */
DECL|method|loadDeletedList (InputStream in, INodeDirectory dir, int refNum, List<Long> deletedNodes)
specifier|private
name|List
argument_list|<
name|INode
...
DECL|method|loadDirectoryDiffList (InputStream in, INodeDirectory dir, int size)
specifier|private
name|void
name|loadDirectoryDiffList
parameter_list|(
...
block|}
block|}
DECL|method|saveCreatedDeletedList (List<INode> created, List<INodeReference> deletedRefs, OutputStream out)
specifier|private
name|void
name|saveCreatedDeletedList
parameter_list|(
name|List
argument_list|<
name|INode
...
expr_stmt|;
block|}
comment|// reference nodes in deleted list
for|for
control|(
name|INodeReference
name|ref
...
block|}
block|}
DECL|method|serializeDirDiffList (INodeDirectory dir, OutputStream out)
specifier|private
name|void
name|serializeDirDiffList
parameter_list|(
