...
name|length
argument_list|,
literal|"List of nodes to exclude | -f<filename> is missing: args = "
operator|+
name|Arrays
operator|.
name|toString
...
name|length
argument_list|,
literal|"File containing nodes to exclude is not specified: args = "
operator|+
name|Arrays
operator|.
name|toString
...
name|length
argument_list|,
literal|"List of nodes to include | -f<filename> is missing: args = "
operator|+
name|Arrays
operator|.
name|toString
...
name|length
argument_list|,
literal|"File containing nodes to include is not specified: args = "
operator|+
name|Arrays
operator|.
name|toString
