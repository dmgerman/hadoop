...
literal|false
decl_stmt|;
DECL|field|exceptionsSinceLastBalance
specifier|private
specifier|static
specifier|volatile
name|int
name|exceptionsSinceLastBalance
init|=
literal|0
decl_stmt|;
DECL|field|failedTimesSinceLastSuccessfulBalance
specifier|private
specifier|static
specifier|volatile
name|int
name|failedTimesSinceLastSuccessfulBalance
init|=
literal|0
decl_stmt|;
...
return|;
block|}
DECL|method|getExceptionsSinceLastBalance ()
specifier|static
name|int
...
return|;
block|}
DECL|method|getFailedTimesSinceLastSuccessfulBalance ()
specifier|static
name|int
name|getFailedTimesSinceLastSuccessfulBalance
parameter_list|()
block|{
return|return
name|failedTimesSinceLastSuccessfulBalance
...
DECL|method|doBalance (Collection<URI> namenodes, final BalancerParameters p, Configuration conf)
specifier|static
specifier|private
name|int
name|doBalance
...
name|warn
argument_list|(
literal|"Balancer already running as a long-service!"
argument_list|)
expr_stmt|;
return|return
name|ExitStatus
...
name|info
argument_list|(
literal|"Balance failed, error code: "
operator|+
name|retCode
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// The caller will process and log the exception
throw|throw
name|e
throw|;
block|}
...
name|warn
argument_list|(
literal|"Encounter exception while do balance work. Already tried {} times"
argument_list|,
name|exceptionsSinceLastBalance
argument_list|,
name|e
...
expr_stmt|;
block|}
comment|// sleep for next round, will retry for next round when it's interrupted
name|LOG
operator|.
name|info
argument_list|(
literal|"Finished one round, will wait for {} for next round"
argument_list|,
name|time2Str
argument_list|(
name|scheduleInterval
...
name|info
argument_list|(
literal|"Balancer will run as a long running service"
argument_list|)
expr_stmt|;
block|}
else|else
