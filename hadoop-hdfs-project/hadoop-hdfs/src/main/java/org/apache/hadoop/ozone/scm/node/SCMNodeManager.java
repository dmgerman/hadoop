...
expr_stmt|;
block|}
comment|/**    * Add a New Datanode to the NodeManager. This function is invoked with    * synchronised(this) being held.    *    * @param nodeReg - node to register    */
annotation|@
name|Override
...
expr_stmt|;
block|}
comment|/**    * Register the heartbeat with Machine Manager.    *    * This requires no synchronization since the heartbeat queue is    * ConcurrentLinkedQueue. Hence we don't protect it specifically via a lock.    *    * @param datanodeID - Name of the datanode that send us heartbeat.    */
annotation|@
name|Override
