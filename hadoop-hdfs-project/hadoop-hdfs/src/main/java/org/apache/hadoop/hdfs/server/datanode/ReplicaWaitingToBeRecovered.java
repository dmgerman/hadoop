...
DECL|method|ReplicaWaitingToBeRecovered (long blockId, long len, long genStamp, FSVolumeInterface vol, File dir)
name|ReplicaWaitingToBeRecovered
parameter_list|(
name|long
name|blockId
...
DECL|method|ReplicaWaitingToBeRecovered (Block block, FSVolumeInterface vol, File dir)
name|ReplicaWaitingToBeRecovered
parameter_list|(
name|Block
name|block
