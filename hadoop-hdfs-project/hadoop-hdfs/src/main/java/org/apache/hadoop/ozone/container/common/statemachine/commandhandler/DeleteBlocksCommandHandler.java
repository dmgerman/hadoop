...
name|totalTime
decl_stmt|;
DECL|method|DeleteBlocksCommandHandler (ContainerManager containerManager, Configuration conf)
specifier|public
name|DeleteBlocksCommandHandler
parameter_list|(
name|ContainerManager
...
expr_stmt|;
block|}
comment|/**    * Move a bunch of blocks from a container to deleting state.    * This is a meta update, the actual deletes happen in async mode.    *    * @param delTX a block deletion transaction.    * @param config configuration.    * @throws IOException if I/O error occurs.    */
DECL|method|deleteContainerBlocks (DeletedBlocksTransaction delTX, Configuration config)
specifier|private
name|void
name|deleteContainerBlocks
parameter_list|(
