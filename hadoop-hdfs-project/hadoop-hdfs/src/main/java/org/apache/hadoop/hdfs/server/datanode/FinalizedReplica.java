...
throw|;
block|}
comment|/**    * gets the last chunk checksum and the length of the block corresponding    * to that checksum.    * Note, need to be called with the FsDataset lock acquired. May improve to    * lock only the FsVolume in the future.    * @throws IOException    */
...
parameter_list|)
block|{
comment|// meta file is lost. Try to continue anyway.
name|DataNode
operator|.
name|LOG
operator|.
...
name|warn
argument_list|(
literal|"Unable to read checksum from meta file "
operator|+
name|getMetaFile
argument_list|()
argument_list|,
