...
return|;
block|}
comment|/**    * Returns Volume info. This API can be invoked either    * by admin or the owner    *    * @param volume - Storage Volume Name    * @param req - Http Req    * @param uriInfo - http URI    * @param headers - Http headers  @return - Response    *    * @throws OzoneException    */
annotation|@
name|Override
DECL|method|getVolumeInfo (String volume, final String info, Request req, final UriInfo uriInfo, HttpHeaders headers)
specifier|public
name|Response
name|getVolumeInfo
parameter_list|(
...
argument_list|)
return|;
comment|// Return list of volumes
default|default:
name|LOG
operator|.
name|debug
