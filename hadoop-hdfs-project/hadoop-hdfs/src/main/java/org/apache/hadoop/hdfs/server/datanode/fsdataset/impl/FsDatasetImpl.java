...
block|}
return|return
name|getBlockInputStreamWithCheckingPmemCache
argument_list|(
name|info
argument_list|,
name|b
...
return|;
block|}
comment|/**    * Check whether the replica is cached to persistent memory.    * If so, get DataInputStream of the corresponding cache file on pmem.    */
DECL|method|getBlockInputStreamWithCheckingPmemCache ( ReplicaInfo info, ExtendedBlock b, long seekOffset)
specifier|private
name|InputStream
name|getBlockInputStreamWithCheckingPmemCache
parameter_list|(
...
name|debug
argument_list|(
literal|"Get InputStream by cache address."
argument_list|)
expr_stmt|;
return|return
name|FsDatasetUtil
operator|.
name|getDirectInputStream
argument_list|(
name|addr
argument_list|,
name|info
...
name|debug
argument_list|(
literal|"Get InputStream by cache file path."
argument_list|)
expr_stmt|;
return|return
name|FsDatasetUtil
operator|.
name|getInputStreamAndSeek
argument_list|(
operator|new
name|File
argument_list|(
