...
literal|null
decl_stmt|;
DECL|method|RequestHedgingProxyProvider ( Configuration conf, URI uri, Class<T> xface)
specifier|public
name|RequestHedgingProxyProvider
parameter_list|(
name|Configuration
...
annotation|@
name|VisibleForTesting
DECL|method|RequestHedgingProxyProvider (Configuration conf, URI uri, Class<T> xface, ProxyFactory<T> factory)
name|RequestHedgingProxyProvider
parameter_list|(
name|Configuration
name|conf
