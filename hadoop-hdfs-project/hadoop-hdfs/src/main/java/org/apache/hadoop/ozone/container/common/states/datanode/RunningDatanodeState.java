...
block|}
block|}
comment|/**    * Create a DatanodeID from the datanode information.    *    * @return DatanodeID    * @throws UnknownHostException    */
...
name|DatanodeID
argument_list|(
comment|//TODO : Replace this with proper network and kerberos
...
literal|0
argument_list|,
comment|/** XferPort - SCM does not use this port  */
literal|0
argument_list|,
comment|/** Info port - SCM does not use this port */
literal|0
argument_list|,
comment|/** Info Secure Port - SCM does not use this port */
literal|0
argument_list|)
decl_stmt|;
comment|/** IPC port - SCM does not use this port */
comment|// TODO: make this dynamically discoverable. SCM can hand out this
comment|// port number to calling applications. This makes it easy to run multiple
comment|// container endpoints on the same machine.
name|temp
operator|.
...
return|;
block|}
comment|/**    * Creates a new ContainerID that persists both DatanodeID and ClusterID.    *    * @param idPath Path to the id file.    * @return ContainerNodeIDProto    * @throws UnknownHostException    */
specifier|private
name|StorageContainerDatanodeProtocolProtos
operator|.
name|ContainerNodeIDProto
DECL|method|createNewContainerID (Path idPath)
name|createNewContainerID
parameter_list|(
name|Path
name|idPath
parameter_list|)
...
expr_stmt|;
block|}
comment|// Not found, let us create a new datanode ID, persist it and return that
comment|// info to SCM.
try|try
block|{
name|nodeID
...
name|error
argument_list|(
literal|"Creating new node ID failed."
argument_list|,
name|ex
argument_list|)
expr_stmt|;
