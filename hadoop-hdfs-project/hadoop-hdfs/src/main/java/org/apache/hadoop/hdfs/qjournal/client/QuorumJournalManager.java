...
expr_stmt|;
block|}
DECL|field|RECOVERY_COMPARATOR
specifier|private
specifier|static
specifier|final
name|Comparator
...
name|start
argument_list|()
comment|// If one of them has accepted something and the other hasn't,
comment|// use the one with an accepted recovery
operator|.
name|compare
argument_list|(
name|r1
...
argument_list|()
argument_list|)
comment|// If they both accepted, use the one that's more recent
operator|.
name|compare
argument_list|(
name|r1
...
argument_list|()
argument_list|)
comment|// Otherwise, choose based on which log is longer
operator|.
name|compare
argument_list|(
name|r1
...
return|;
block|}
DECL|method|createLoggers (Configuration conf, URI uri, NamespaceInfo nsInfo)
specifier|static
name|List
argument_list|<
name|AsyncLogger
