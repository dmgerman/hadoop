...
DECL|method|chooseTarget (int numOfReplicas, Node writer, List<DatanodeStorageInfo> chosenStorage, boolean returnChosenNodes, Set<Node> excludedNodes, long blocksize, final BlockStoragePolicy storagePolicy)
specifier|private
name|DatanodeStorageInfo
index|[]
name|chooseTarget
...
DECL|method|addIfIsGoodTarget (DatanodeStorageInfo storage, Set<Node> excludedNodes, long blockSize, List<DatanodeStorageInfo> results, StorageType storageType)
name|int
name|addIfIsGoodTarget
parameter_list|(
name|DatanodeStorageInfo
...
block|}
block|}
comment|/**    * Determine if a datanode is good for placing block.    *    * @param node The target datanode    * @param maxTargetPerRack Maximum number of targets per rack. The value of    *                       this parameter depends on the number of racks in    *                       the cluster and total number of replicas for a block    * @param considerLoad whether or not to consider load of the target node    * @param results A list containing currently chosen nodes. Used to check if    *                too many nodes has been chosen in the target rack.    * @param avoidStaleNodes Whether or not to avoid choosing stale nodes    * @return Reture true if the datanode is good candidate, otherwise false    */
...
return|;
block|}
comment|/**    * Determine if a storage is a good target.    *    * @param storage The target storage    * @param blockSize Size of block    * @param results A list containing currently chosen nodes. Used to check if    *                too many nodes has been chosen in the target rack.    * @return Return true if<i>node</i> has enough space.    */
DECL|method|isGoodTarget (DatanodeStorageInfo storage, long blockSize, List<DatanodeStorageInfo> results, StorageType requiredStorageType)
specifier|private
name|boolean
name|isGoodTarget
parameter_list|(
...
annotation|@
name|Override
DECL|method|chooseReplicaToDelete (BlockCollection bc, Block block, short replicationFactor, Collection<DatanodeStorageInfo> first, Collection<DatanodeStorageInfo> second, final List<StorageType> excessTypes)
specifier|public
name|DatanodeStorageInfo
