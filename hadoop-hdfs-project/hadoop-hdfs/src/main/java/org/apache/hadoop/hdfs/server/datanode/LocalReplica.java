...
expr_stmt|;
block|}
DECL|method|renameMeta (File newMetaFile)
specifier|public
name|void
name|renameMeta
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|renameBlock (File newBlockFile)
specifier|public
name|void
name|renameBlock
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Get input stream for a local file and optionally seek to the offset.    * @param f path to the file    * @param seekOffset offset to seek    * @return    * @throws IOException    */
...
return|;
block|}
DECL|method|getHardLinkCount (File fileName)
specifier|public
specifier|static
name|int
name|getHardLinkCount
...
return|;
block|}
comment|/**    *  Get pin status of a file by checking the sticky bit.    * @param localFS local file system    * @param path path to be checked    * @return    * @throws IOException    */
