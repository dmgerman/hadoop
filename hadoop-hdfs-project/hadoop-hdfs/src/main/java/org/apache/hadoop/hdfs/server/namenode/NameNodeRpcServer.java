...
annotation|@
name|VisibleForTesting
DECL|method|getAuxiliaryRpcAddresses ()
specifier|public
name|Set
argument_list|<
name|InetSocketAddress
...
control|)
block|{
name|wrapEstablishedQOP
argument_list|(
name|lb
argument_list|,
name|getEstablishedClientQOP
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|debug
argument_list|(
literal|"Datanode {} is attempting to report but not register yet."
argument_list|,
name|nodeReg
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * Return the QOP of the client that the current handler thread    * is handling. Assuming the negotiation is done at this point,    * otherwise returns null.    *    * @return the established QOP of this client.    */
DECL|method|getEstablishedClientQOP ()
specifier|private
specifier|static
name|String
name|getEstablishedClientQOP
