...
decl_stmt|;
DECL|method|StripedBlockChecksumReconstructor (ErasureCodingWorker worker, StripedReconstructionInfo stripedReconInfo, DataOutputBuffer checksumWriter)
specifier|public
name|StripedBlockChecksumReconstructor
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// step4: updates the digest using the checksum array of bytes
name|digester
operator|.
name|update
argument_list|(
