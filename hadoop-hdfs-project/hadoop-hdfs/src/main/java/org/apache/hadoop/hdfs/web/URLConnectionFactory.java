...
return|;
block|}
comment|/**    * Opens a url with read and connect timeouts    *    * @param url URL to open    * @return URLConnection    * @throws IOException    * @throws AuthenticationException    */
DECL|method|openConnection (HttpOpParam.Op op, URL url)
specifier|public
name|URLConnection
name|openConnection
parameter_list|(
