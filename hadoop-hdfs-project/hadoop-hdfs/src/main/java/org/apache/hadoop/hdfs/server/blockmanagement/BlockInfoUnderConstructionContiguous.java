...
DECL|method|BlockInfoUnderConstructionContiguous (Block blk, short replication, BlockUCState state, DatanodeStorageInfo[] targets)
specifier|public
name|BlockInfoUnderConstructionContiguous
parameter_list|(
name|Block
...
literal|"BLOCK*"
operator|+
literal|" BlockInfoUnderConstructionContiguous.initLeaseRecovery:"
operator|+
