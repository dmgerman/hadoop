...
name|FileWithLink
parameter_list|,
DECL|method|getBlockReplication ( final F file)
name|N
extends|extends
name|INodeFile
operator|&
...
name|FileWithLink
parameter_list|>
DECL|method|collectSubtreeBlocksAndClear (F file, BlocksMapUpdateInfo info)
name|int
...
name|FileWithLink
parameter_list|>
DECL|method|collectBlocksBeyondMaxAndClear (final F file, final long max, final BlocksMapUpdateInfo info)
name|void
name|collectBlocksBeyondMaxAndClear
parameter_list|(
specifier|final
