...
DECL|method|addDirDiff (INodeDirectoryWithSnapshot dir, byte[][] relativePath, ChildrenDiff diff)
specifier|private
name|void
name|addDirDiff
parameter_list|(
...
DECL|method|replaceSelf (final Snapshot latest, final INodeMap inodeMap)
name|INodeDirectory
name|replaceSelf
parameter_list|(
specifier|final
