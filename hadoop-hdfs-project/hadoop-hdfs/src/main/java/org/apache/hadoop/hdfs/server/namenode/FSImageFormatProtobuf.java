...
return|;
block|}
DECL|method|getExtendedAclTable ()
specifier|public
name|ImmutableList
argument_list|<
name|AclEntry
...
name|imgTxId
decl_stmt|;
DECL|method|Loader (Configuration conf, FSNamesystem fsn)
name|Loader
parameter_list|(
name|Configuration
name|conf
...
literal|"unchecked"
argument_list|)
DECL|method|loadExtendedAclSection (InputStream in)
specifier|private
name|void
name|loadExtendedAclSection
parameter_list|(
...
block|}
block|}
DECL|method|loadSecretManagerSection (InputStream in)
specifier|private
name|void
name|loadSecretManagerSection
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|loadCacheManagerSection (InputStream in)
specifier|private
name|void
name|loadCacheManagerSection
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|saveExtendedAclSection (FileSummary.Builder summary)
specifier|private
name|void
name|saveExtendedAclSection
parameter_list|(
