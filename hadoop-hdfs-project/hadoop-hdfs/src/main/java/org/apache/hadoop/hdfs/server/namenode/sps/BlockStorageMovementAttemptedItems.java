...
argument_list|>
argument_list|>
name|scheduledBlkLocs
decl_stmt|;
comment|// Maintains separate Queue to keep the movement finished blocks. This Q
comment|// is used to update the storageMovementAttemptedItems list asynchronously.
...
block|}
block|}
comment|/**    * Notify the storage movement attempt finished block.    *    * @param reportedDn    *          reported datanode    * @param type    *          storage type    * @param reportedBlock    *          reported block    */
DECL|method|notifyReportedBlock (DatanodeInfo reportedDn, StorageType type, Block reportedBlock)
specifier|public
name|void
...
block|}
block|}
DECL|method|matchesReportedBlock (DatanodeInfo reportedDn, StorageType type, Block reportedBlock)
specifier|private
name|void
name|matchesReportedBlock
parameter_list|(
...
block|{
return|return;
comment|// unknown block, simply skip.
block|}
for|for
control|(
name|StorageTypeNodePair
...
argument_list|)
expr_stmt|;
comment|// clean-up reported block
block|}
return|return;
comment|// found
block|}
...
name|debug
argument_list|(
literal|"Reported block:{} not found in attempted blocks. Datanode:{}"
operator|+
literal|", StorageType:{}"
argument_list|,
name|reportedBlock
...
name|IOException
block|{
comment|// Removes all available blocks from this queue and process it.
name|Collection
argument_list|<
name|Block
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Update attempted items list
for|for
control|(
name|Block
name|blk
