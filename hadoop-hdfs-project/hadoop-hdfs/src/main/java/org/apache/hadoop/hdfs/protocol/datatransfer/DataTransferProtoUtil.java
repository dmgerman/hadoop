...
block|{
comment|/**    * Map between the internal DataChecksum identifiers and the protobuf-    * generated identifiers on the wire.    */
DECL|field|checksumTypeMap
specifier|static
name|BiMap
argument_list|<
name|Integer
