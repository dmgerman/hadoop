...
operator|.
name|Stable
DECL|class|HdfsFileStatusWritable
specifier|public
class|class
...
operator|.
name|HdfsFileStatus
DECL|method|convertHdfsFileStatus (HdfsFileStatusWritable fs)
...
return|;
block|}
DECL|method|convertHdfsFileStatus (org.apache.hadoop.hdfs.protocol.HdfsFileStatus[] fs)
specifier|static
specifier|public
name|HdfsFileStatusWritable
index|[]
...
DECL|method|HdfsFileStatusWritable ()
specifier|public
name|HdfsFileStatusWritable
parameter_list|()
block|{
...
DECL|method|HdfsFileStatusWritable (long length, boolean isdir, int block_replication, long blocksize, long modification_time, long access_time, FsPermissionWritable permission, String owner, String group, byte[] symlink, byte[] path)
specifier|public
name|HdfsFileStatusWritable
parameter_list|(
name|long
