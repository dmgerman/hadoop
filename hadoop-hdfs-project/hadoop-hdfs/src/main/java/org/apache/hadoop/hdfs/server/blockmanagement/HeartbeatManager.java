...
argument_list|)
decl_stmt|;
comment|/**    * The initial setting of end user which indicates whether or not to avoid    * writing to stale datanodes.    */
DECL|field|initialAvoidWriteStaleNodes
specifier|private
specifier|final
name|boolean
name|initialAvoidWriteStaleNodes
decl_stmt|;
...
block|}
block|}
comment|// Change whether to avoid using stale datanodes for writing
comment|// based on proportion of stale datanodes
if|if
condition|(
name|checkStaleNodes
condition|)
