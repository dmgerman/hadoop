...
name|IllegalArgumentException
argument_list|(
literal|"Could not modify concurrent moves thread count"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|debug
argument_list|(
literal|"HandleAddBlockPoolError called with empty exception list"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|info
argument_list|(
literal|"Waiting up to 30 seconds for transfer threads to complete"
argument_list|)
expr_stmt|;
name|HadoopExecutors
operator|.
...
name|info
argument_list|(
literal|"{} Starting thread to transfer {} to {}"
argument_list|,
name|bpReg
argument_list|,
name|block
...
name|debug
argument_list|(
literal|"Transferring a replica to {}"
argument_list|,
name|xferTargetsString
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"report bad block {} failed"
argument_list|,
name|block
argument_list|,
name|ie
