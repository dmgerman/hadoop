...
argument_list|)
decl_stmt|;
comment|// TODO(HA) when HDFS-1971 (dual BRs) is done, pass all of the NNs
comment|// to BPOS
name|InetSocketAddress
name|isa
init|=
...
argument_list|)
expr_stmt|;
comment|// TODO(HA): need to update this for multiple NNs per nameservice
comment|// For now, just list all of the NNs into this set
name|Map
argument_list|<
name|String
argument_list|,
...
expr_stmt|;
block|}
comment|// stoping the BPOSes causes them to call remove() on their own when they
comment|// clean up.
...
name|conf
decl_stmt|;
DECL|field|userWithLocalPathAccess
specifier|private
specifier|final
name|String
...
name|ClientDatanodeProtocolServerSideTranslatorR23
name|clientDatanodeProtocolServerTranslator
init|=
operator|new
name|ClientDatanodeProtocolServerSideTranslatorR23
argument_list|(
...
expr_stmt|;
name|InterDatanodeProtocolServerSideTranslatorR23
name|interDatanodeProtocolServerTranslator
init|=
operator|new
name|InterDatanodeProtocolServerSideTranslatorR23
argument_list|(
