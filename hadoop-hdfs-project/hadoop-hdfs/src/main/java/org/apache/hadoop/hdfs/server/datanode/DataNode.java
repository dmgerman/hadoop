...
DECL|method|startDataNode (Configuration conf, AbstractList<StorageLocation> dataDirs, SecureResources resources )
name|void
name|startDataNode
parameter_list|(
name|Configuration
...
return|;
block|}
DECL|method|parseStorageLocations ( Collection<String> rawLocations)
specifier|static
name|Collection
argument_list|<
name|StorageLocation
argument_list|>
name|parseStorageLocations
parameter_list|(
name|Collection
argument_list|<
name|String
...
name|error
argument_list|(
literal|"Failed to parse storage location "
operator|+
name|locationString
argument_list|)
expr_stmt|;
