...
decl_stmt|;
comment|/** The RPC server that listens to requests from nodes to find containers. */
DECL|field|storageRpcServer
specifier|private
specifier|final
name|RPC
operator|.
...
DECL|method|StorageContainerManager (Configuration conf)
specifier|public
name|StorageContainerManager
parameter_list|(
name|Configuration
...
block|}
block|}
comment|/**    * Returns listen address of StorageContainerLocation RPC server.    *    * @return listen address of StorageContainerLocation RPC server    */
annotation|@
name|VisibleForTesting
DECL|method|getStorageContainerLocationRpcAddress ()
specifier|public
name|InetSocketAddress
...
DECL|method|startRpcServer (Configuration conf, InetSocketAddress addr, Class<?> protocol, BlockingService instance, String bindHostKey, String handlerCountKey, int handlerCountDefault)
specifier|private
specifier|static
name|RPC
operator|.
