...
argument_list|()
decl_stmt|;
DECL|field|VOID_CREATE_SNAPSHOT_RESPONSE
specifier|static
specifier|final
name|CreateSnapshotResponseProto
name|VOID_CREATE_SNAPSHOT_RESPONSE
init|=
name|CreateSnapshotResponseProto
operator|.
name|newBuilder
...
return|;
block|}
DECL|field|NULL_APPEND_RESPONSE
specifier|static
specifier|final
name|AppendResponseProto
name|NULL_APPEND_RESPONSE
init|=
name|AppendResponseProto
operator|.
name|newBuilder
...
block|}
block|}
DECL|field|NULL_GETLISTING_RESPONSE
specifier|static
specifier|final
name|GetListingResponseProto
name|NULL_GETLISTING_RESPONSE
init|=
name|GetListingResponseProto
operator|.
name|newBuilder
...
block|}
block|}
DECL|field|NULL_GETFILEINFO_RESPONSE
specifier|static
specifier|final
name|GetFileInfoResponseProto
name|NULL_GETFILEINFO_RESPONSE
init|=
name|GetFileInfoResponseProto
operator|.
name|newBuilder
...
block|}
block|}
DECL|field|NULL_GETFILELINKINFO_RESPONSE
specifier|static
specifier|final
name|GetFileLinkInfoResponseProto
name|NULL_GETFILELINKINFO_RESPONSE
init|=
name|GetFileLinkInfoResponseProto
operator|.
name|newBuilder
...
annotation|@
name|Override
DECL|method|createSnapshot (RpcController controller, CreateSnapshotRequestProto request)
specifier|public
name|CreateSnapshotResponseProto
name|createSnapshot
parameter_list|(
...
annotation|@
name|Override
DECL|method|deleteSnapshot (RpcController controller, DeleteSnapshotRequestProto request)
specifier|public
name|DeleteSnapshotResponseProto
name|deleteSnapshot
parameter_list|(
...
annotation|@
name|Override
DECL|method|listSnapshots (RpcController controller, ListSnapshotsRequestProto request)
specifier|public
name|ListSnapshotsResponseProto
name|listSnapshots
parameter_list|(
