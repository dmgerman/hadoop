...
annotation|@
name|Override
DECL|method|getErasureCodingInfo (RpcController controller, GetErasureCodingInfoRequestProto request)
specifier|public
name|GetErasureCodingInfoResponseProto
...
annotation|@
name|Override
DECL|method|getECSchemas (RpcController controller, GetECSchemasRequestProto request)
specifier|public
name|GetECSchemasResponseProto
name|getECSchemas
parameter_list|(
