...
annotation|@
name|Override
DECL|method|msync (RpcController controller, MsyncRequestProto req)
specifier|public
name|MsyncResponseProto
name|msync
parameter_list|(
...
annotation|@
name|Override
DECL|method|getHAServiceState ( RpcController controller, HAServiceStateRequestProto request)
specifier|public
name|HAServiceStateResponseProto
