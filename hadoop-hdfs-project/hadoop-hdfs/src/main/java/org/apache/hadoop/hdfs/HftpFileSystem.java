...
name|renewToken
decl_stmt|;
DECL|field|hftpTokenSelector
specifier|private
specifier|static
specifier|final
name|HftpDelegationTokenSelector
...
name|IOException
block|{
comment|// look for hftp token, then try hdfs
name|Token
argument_list|<
name|?
argument_list|>
name|token
init|=
name|selectHftpDelegationToken
argument_list|()
decl_stmt|;
if|if
condition|(
...
expr_stmt|;
block|}
comment|// we already had a token or getDelegationToken() didn't fail.
if|if
condition|(
name|token
operator|!=
...
block|}
block|}
DECL|method|selectHftpDelegationToken ()
specifier|protected
name|Token
argument_list|<
name|DelegationTokenIdentifier
...
begin_class
DECL|class|HftpDelegationTokenSelector
specifier|private
specifier|static
class|class
name|HftpDelegationTokenSelector
...
argument_list|>
block|{
DECL|method|HftpDelegationTokenSelector ()
specifier|public
name|HftpDelegationTokenSelector
parameter_list|()
block|{
