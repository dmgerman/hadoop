...
argument_list|()
return|;
comment|//TODO: un-comment the following once HDFS-7510 is committed.
comment|//    return getConf().getInt(DFSConfigKeys.DFS_NAMENODE_HTTP_PORT_KEY,
comment|//        DFSConfigKeys.DFS_NAMENODE_HTTP_PORT_DEFAULT);
block|}
...
block|}
block|}
DECL|method|normalizeService (String service)
specifier|private
name|String
name|normalizeService
parameter_list|(
...
argument_list|(
literal|"Invalid service for hftp token: "
operator|+
name|service
argument_list|)
throw|;
...
block|}
comment|//TODO: un-comment the following once HDFS-7510 is committed.
comment|//  protected Token<DelegationTokenIdentifier> selectHftpDelegationToken() {
comment|//    Text serviceName = SecurityUtil.buildTokenService(nnSecureAddr);
comment|//    return hftpTokenSelector.selectToken(serviceName, ugi.getTokens());
comment|//  }
DECL|method|selectHdfsDelegationToken ()
specifier|protected
name|Token
argument_list|<
name|DelegationTokenIdentifier
