...
argument_list|()
decl_stmt|;
comment|/**    * In order to prevent serial No. of different NameNode from overlapping,    * Using 6 bits (identify 64=2^6 namenodes, and presuppose that no scenario    * where deploy more than 64 namenodes (include ANN, SBN, Observers, etc.)    * in one namespace) to identify index of NameNode, and the remainder 26 bits    * auto-incr to change the serial No.    */
annotation|@
name|VisibleForTesting
DECL|field|NUM_VALID_BITS
specifier|public
specifier|static
specifier|final
name|int
...
expr_stmt|;
block|}
DECL|method|BlockTokenSecretManager (long keyUpdateInterval, long tokenLifetime, int nnIndex, int numNNs, String blockPoolId, String encryptionAlgorithm, boolean useProto, boolean shouldWrapQOP)
specifier|public
name|BlockTokenSecretManager
parameter_list|(
name|long
