...
name|isAppend
decl_stmt|;
DECL|method|DataStreamer (HdfsFileStatus stat, ExtendedBlock block)
specifier|private
name|DataStreamer
parameter_list|(
name|HdfsFileStatus
...
block|}
block|}
DECL|method|writeChunkImpl (byte[] b, int offset, int len, byte[] checksum, int ckoff, int cklen)
specifier|private
specifier|synchronized
name|void
name|writeChunkImpl
