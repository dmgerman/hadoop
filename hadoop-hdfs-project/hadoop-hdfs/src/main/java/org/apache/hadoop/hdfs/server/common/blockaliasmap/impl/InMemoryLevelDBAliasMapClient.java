...
name|aliasMap
decl_stmt|;
DECL|method|LevelDbReader (InMemoryAliasMapProtocol aliasMap)
name|LevelDbReader
parameter_list|(
name|InMemoryAliasMapProtocol
name|aliasMap
...
name|aliasMap
decl_stmt|;
DECL|method|LevelDbWriter (InMemoryAliasMapProtocol aliasMap)
name|LevelDbWriter
parameter_list|(
name|InMemoryAliasMapProtocol
name|aliasMap
...
expr_stmt|;
block|}
DECL|method|getAliasMap (String blockPoolID)
specifier|private
name|InMemoryAliasMapProtocol
name|getAliasMap
parameter_list|(
...
name|IOException
argument_list|(
literal|"Block pool id required to get aliasmap reader"
argument_list|)
throw|;
block|}
comment|// if a block pool id has been supplied, and doesn't match the associated
comment|// block pool ids, return null.
for|for
control|(
name|InMemoryAliasMapProtocol
name|aliasMap
...
name|error
argument_list|(
literal|"Exception in retrieving block pool id {}"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Loading InMemoryAliasMapReader for block pool id {}"
argument_list|,
name|blockPoolID
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Loading InMemoryAliasMapWriter for block pool id {}"
argument_list|,
name|blockPoolID
argument_list|)
expr_stmt|;
