...
name|remoteAddr
decl_stmt|;
DECL|field|serverDefaultsResponse
specifier|private
specifier|static
specifier|volatile
name|String
...
annotation|@
name|VisibleForTesting
DECL|method|chooseDatanode (final NameNode namenode, final String path, final HttpOpParam.Op op, final long openOffset, final long blocksize, final String excludeDatanodes, final String remoteAddr)
specifier|static
name|DatanodeInfo
name|chooseDatanode
parameter_list|(
...
block|}
block|}
comment|/*    * This is used only and only for testing.    * Please don't use it otherwise.    */
annotation|@
name|VisibleForTesting
DECL|method|resetServerDefaultsResponse ()
specifier|public
specifier|static
name|void
