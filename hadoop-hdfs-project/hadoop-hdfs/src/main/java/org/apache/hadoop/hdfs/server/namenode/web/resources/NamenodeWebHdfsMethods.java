...
return|;
block|}
DECL|method|redirectURI (final NameNode namenode, final String path, final HttpOpParam.Op op, final long openOffset, final Param<?, ?>... parameters)
specifier|private
specifier|static
name|URI
name|redirectURI
...
block|}
argument_list|)
DECL|method|root ( @ueryParamGetOpParam.NAME) @efaultValueGetOpParam.DEFAULT) final GetOpParam op, @QueryParam(OffsetParam.NAME) @DefaultValue(OffsetParam.DEFAULT) final OffsetParam offset, @QueryParam(LengthParam.NAME) @DefaultValue(LengthParam.DEFAULT) final LengthParam length, @QueryParam(BufferSizeParam.NAME) @DefaultValue(BufferSizeParam.DEFAULT) final BufferSizeParam bufferSize )
specifier|public
name|Response
name|root
parameter_list|(
