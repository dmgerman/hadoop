...
block|}
block|}
DECL|method|traverse (File path, HashMap<String, ArrayList<String>> files)
specifier|private
name|void
name|traverse
parameter_list|(
...
return|;
block|}
comment|/**    * Close the DB if we don't have any outstanding refrences.    *    * @param dbPath - dbPath    * @throws IOException    */
