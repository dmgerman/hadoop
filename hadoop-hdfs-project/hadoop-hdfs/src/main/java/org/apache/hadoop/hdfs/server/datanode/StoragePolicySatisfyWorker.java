...
block|}
block|}
comment|/**    * Blocks movements completion handler, which is used to collect details of    * the completed list of block movements and notify the namenode about the    * success or failures.    */
DECL|class|BlocksMovementsCompletionHandler
specifier|static
class|class
name|BlocksMovementsCompletionHandler
block|{
DECL|field|completedBlocks
specifier|private
specifier|final
name|List
argument_list|<
...
argument_list|()
decl_stmt|;
comment|/**      * Collect all the block movement results and notify namenode.      *      * @param results      *          result of all the block movements per trackId      */
DECL|method|handle (List<BlockMovementResult> results)
name|void
name|handle
parameter_list|(
name|List
...
argument_list|)
expr_stmt|;
comment|// TODO: notify namenode about the success/failures.
block|}
annotation|@
name|VisibleForTesting
DECL|method|getCompletedBlocks ()
name|List
argument_list|<
name|BlockMovementResult
argument_list|>
