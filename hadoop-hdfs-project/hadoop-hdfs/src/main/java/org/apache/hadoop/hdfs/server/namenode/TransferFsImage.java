...
block|}
block|}
comment|/**    * Download the InMemoryAliasMap from the remote NN.    * @param fsName http address of remote NN.    * @param aliasMap location of the alias map.    * @param isBootstrapStandby flag to indicate if for bootstrap of standby.    * @throws IOException    */
DECL|method|downloadAliasMap (URL fsName, File aliasMap, boolean isBootstrapStandby)
specifier|public
specifier|static
name|void
...
name|total
operator|+
literal|" bytes. Size of last segment intended to send: "
operator|+
name|num
operator|+
literal|" bytes."
