...
name|RollingUpgradeException
argument_list|(
literal|"Unexpected OP_ROLLING_UPGRADE_START in edit log: op="
operator|+
name|op
argument_list|)
throw|;
...
name|RollingUpgradeException
argument_list|(
literal|"Unexpected OP_ROLLING_UPGRADE_FINALIZE "
operator|+
literal|" since there is no rolling upgrade in progress."
argument_list|)
throw|;
block|}
name|fsNamesys
