...
literal|5000
decl_stmt|;
DECL|field|loadEditsLogHelper
specifier|private
specifier|final
name|LogThrottlingHelper
name|loadEditsLogHelper
init|=
operator|new
name|LogThrottlingHelper
argument_list|(
...
annotation|@
name|VisibleForTesting
DECL|method|FSEditLogLoader (FSNamesystem fsNamesys, long lastAppliedTxId, Timer timer)
name|FSEditLogLoader
parameter_list|(
name|FSNamesystem
name|fsNamesys
...
name|info
argument_list|(
literal|"Loaded {} edits file(s) (the last named {}) of "
operator|+
literal|"total size {}, total edits {}, total load time {} ms"
argument_list|,
name|postLogAction
operator|.
name|getCount
