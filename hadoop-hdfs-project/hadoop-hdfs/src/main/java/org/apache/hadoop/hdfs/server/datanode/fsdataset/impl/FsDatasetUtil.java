...
block|}
block|}
DECL|method|getInputStreamAndSeek (File file, long offset)
specifier|public
specifier|static
name|InputStream
...
block|}
block|}
DECL|method|getDirectInputStream (long addr, long length)
specifier|public
specifier|static
name|InputStream
...
block|}
block|}
comment|/**    * Find the meta-file for the specified block file and then return the    * generation stamp from the name of the meta-file. Generally meta file will    * be the next file in sorted array of file's.    *    * @param listdir    *          sorted list of file based on name.    * @param blockFile    *          block file for which generation stamp is needed.    * @param index    *          index of block file in array.    * @return generation stamp for block file.    */
DECL|method|getGenerationStampFromFile (File[] listdir, File blockFile, int index)
specifier|static
name|long
...
condition|)
block|{
comment|// Check if next index file is meta file
name|String
name|metaFile
init|=
name|listdir
...
expr_stmt|;
block|}
DECL|method|deleteMappedFile (String filePath)
specifier|public
specifier|static
name|void
...
name|IOException
argument_list|(
literal|"The filePath should not be null!"
argument_list|)
throw|;
block|}
name|boolean
