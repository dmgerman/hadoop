...
name|println
argument_list|(
literal|"Source Disk\t\t Dest.Disk\t\t Move Size\t Type\n "
argument_list|)
expr_stmt|;
for|for
control|(
...
block|}
block|}
comment|/**    * Returns a Json represenation of the plans.    *    * @param plan - List of plans.    * @return String.    * @throws IOException    */
DECL|method|getPlan (List<NodePlan> plan)
specifier|private
name|String
name|getPlan
parameter_list|(
