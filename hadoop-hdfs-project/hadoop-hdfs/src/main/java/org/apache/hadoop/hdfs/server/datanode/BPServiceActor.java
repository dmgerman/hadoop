...
index|]
decl_stmt|;
comment|// When block reports are split, the last RPC in the block report
comment|// has the information about all storages in the block report.
comment|// See HDFS-10301 for more details. To achieve this, the last RPC
comment|// has 'n' storage reports, where 'n' is the number of storages in
comment|// a DN. The actual block replicas are reported only for the
comment|// last/n-th storage.
name|i
operator|=
literal|0
expr_stmt|;
...
decl_stmt|;
DECL|method|Scheduler (long heartbeatIntervalMs, long lifelineIntervalMs, long blockReportIntervalMs)
name|Scheduler
parameter_list|(
name|long
name|heartbeatIntervalMs
