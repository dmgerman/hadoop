...
argument_list|()
decl_stmt|;
DECL|field|commandProcessingThread
specifier|private
specifier|final
name|CommandProcessingThread
name|commandProcessingThread
decl_stmt|;
DECL|method|BPServiceActor (String serviceId, String nnId, InetSocketAddress nnAddr, InetSocketAddress lifelineNnAddr, BPOfferService bpos)
name|BPServiceActor
parameter_list|(
name|String
name|serviceId
...
return|;
block|}
DECL|method|getRpcMetricSuffix ()
specifier|private
name|String
name|getRpcMetricSuffix
parameter_list|()
...
name|warn
argument_list|(
literal|"RemoteException in register"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * CommandProcessingThread that process commands asynchronously.    */
DECL|class|CommandProcessingThread
class|class
name|CommandProcessingThread
extends|extends
name|Thread
...
name|queue
decl_stmt|;
DECL|method|CommandProcessingThread (BPServiceActor actor)
name|CommandProcessingThread
parameter_list|(
name|BPServiceActor
name|actor
...
name|error
argument_list|(
literal|"{} encountered fatal exception and exit."
argument_list|,
name|getName
argument_list|()
argument_list|,
...
block|}
block|}
comment|/**      * Process commands in queue one by one, and wait until queue not empty.      */
...
name|error
argument_list|(
literal|"{} encountered interrupt and exit."
argument_list|,
name|getName
argument_list|()
argument_list|)
...
return|;
block|}
DECL|method|enqueue (DatanodeCommand cmd)
name|void
name|enqueue
parameter_list|(
name|DatanodeCommand
...
expr_stmt|;
block|}
DECL|method|enqueue (List<DatanodeCommand> cmds)
name|void
name|enqueue
parameter_list|(
name|List
...
expr_stmt|;
block|}
DECL|method|enqueue (DatanodeCommand[] cmds)
name|void
name|enqueue
parameter_list|(
name|DatanodeCommand
