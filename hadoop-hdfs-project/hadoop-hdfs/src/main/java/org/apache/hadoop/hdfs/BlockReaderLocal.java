...
return|;
block|}
comment|// Skip by reading the data so we stay in sync with checksums.
comment|// This could be implemented more efficiently in the future to
comment|// skip to the beginning of the appropriate checksum chunk
comment|// and then only read to the middle of that chunk.
if|if
condition|(
name|skipBuf
operator|==
