...
return|;
block|}
DECL|method|setStreams (FileInputStream streams[])
specifier|public
name|Builder
name|setStreams
parameter_list|(
...
return|;
block|}
DECL|method|setFileInputStreamCache (FileInputStreamCache fisCache)
specifier|public
name|Builder
name|setFileInputStreamCache
parameter_list|(
name|FileInputStreamCache
name|fisCache
parameter_list|)
...
return|;
block|}
DECL|method|setMlocked (boolean mlocked)
specifier|public
name|Builder
name|setMlocked
parameter_list|(
...
return|;
block|}
DECL|method|setBlockMetadataHeader (BlockMetadataHeader header)
specifier|public
name|Builder
name|setBlockMetadataHeader
parameter_list|(
name|BlockMetadataHeader
name|header
parameter_list|)
...
name|verifyChecksum
decl_stmt|;
comment|/**    * If true, this block is mlocked on the DataNode.    */
DECL|field|mlocked
specifier|private
specifier|final
name|AtomicBoolean
...
name|filename
decl_stmt|;
comment|/**    * DataNode which contained this block.    */
DECL|field|datanodeID
specifier|private
specifier|final
name|DatanodeID
...
name|checksumSize
decl_stmt|;
comment|/**    * FileInputStream cache to return the streams to upon closing,    * or null if we should just close them unconditionally.    */
DECL|field|fisCache
specifier|private
specifier|final
name|FileInputStreamCache
...
return|;
block|}
DECL|method|getCanSkipChecksum ()
specifier|private
name|boolean
name|getCanSkipChecksum
parameter_list|()
block|{
return|return
operator|(
...
return|;
block|}
comment|/**    * Set the mlocked state of the BlockReader.    * This method does NOT need to be synchronized because mlocked is atomic.    *    * @param mlocked  the new mlocked state of the BlockReader.    */
DECL|method|setMlocked (boolean mlocked)
specifier|public
name|void
name|setMlocked
