...
name|IOException
block|{
comment|/**      * Don't forward this to the server. The protocol version and signature is      * that of {@link RefreshAuthorizationPolicyProtocol}      */
if|if
condition|(
operator|!
name|protocol
...
name|IOException
block|{
comment|/**      * Don't forward this to the server. The protocol version and signature is      * that of {@link RefreshAuthorizationPolicyProtocolPB}      */
return|return
name|ProtocolSignatureWritable
operator|.
name|convert
