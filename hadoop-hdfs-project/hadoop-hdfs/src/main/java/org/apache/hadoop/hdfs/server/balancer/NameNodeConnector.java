...
literal|0
decl_stmt|;
DECL|method|NameNodeConnector (String name, URI nameNodeUri, Path idPath, Configuration conf)
specifier|public
name|NameNodeConnector
parameter_list|(
name|String
...
return|;
block|}
comment|/** @return the namenode proxy. */
...
return|;
block|}
comment|/** @return the client proxy. */
