...
expr_stmt|;
block|}
DECL|method|getFileRegionProvider ()
name|FileRegionProvider
...
annotation|@
name|VisibleForTesting
DECL|method|setFileRegionProvider (FileRegionProvider newProvider)
name|void
...
block|{
comment|/* refresh the provider and return the list of blocks found.        * the assumption here is that the block ids in the external        * block map, after the refresh, are consistent with those        * from before the refresh, i.e., for blocks which did not change,        * the ids remain the same.        */
name|provider
operator|.
name|refresh
argument_list|()
...
name|state
decl_stmt|;
DECL|method|ProviderBlockIteratorImpl (String bpid, String name, FileRegionProvider provider)
name|ProviderBlockIteratorImpl
parameter_list|(
name|String
name|bpid
...
annotation|@
name|VisibleForTesting
DECL|method|setFileRegionProvider (String bpid, FileRegionProvider provider)
name|void
name|setFileRegionProvider
parameter_list|(
name|String
