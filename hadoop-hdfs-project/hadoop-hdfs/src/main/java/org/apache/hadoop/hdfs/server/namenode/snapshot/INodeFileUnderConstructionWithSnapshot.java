...
block|{
comment|/**    * The difference of an {@link INodeFileUnderConstruction} between two snapshots.    */
DECL|class|FileUcDiff
specifier|static
class|class
name|FileUcDiff
extends|extends
name|FileDiff
block|{
DECL|method|FileUcDiff (Snapshot snapshot, INodeFile file)
specifier|private
name|FileUcDiff
parameter_list|(
name|Snapshot
...
annotation|@
name|Override
DECL|method|createSnapshotCopyOfCurrentINode (INodeFile file)
name|INodeFileUnderConstruction
...
name|FileDiffList
block|{
DECL|method|FileUcDiffList (INodeFile currentINode, final List<FileDiff> diffs)
specifier|private
name|FileUcDiffList
parameter_list|(
name|INodeFile
