...
DECL|method|createFileStatus ( FSDirectory fsd, byte[] path, INodeAttributes nodeAttrs, boolean needLocation, byte storagePolicy, INodesInPath iip)
specifier|private
specifier|static
name|HdfsFileStatus
name|createFileStatus
...
DECL|method|createFileStatus ( FSDirectory fsd, byte[] path, INodeAttributes nodeAttrs, byte storagePolicy, INodesInPath iip)
specifier|static
name|HdfsFileStatus
name|createFileStatus
parameter_list|(
...
DECL|method|createLocatedFileStatus ( FSDirectory fsd, byte[] path, INodeAttributes nodeAttrs, byte storagePolicy, INodesInPath iip)
specifier|private
specifier|static
name|HdfsFileStatus
name|createLocatedFileStatus
