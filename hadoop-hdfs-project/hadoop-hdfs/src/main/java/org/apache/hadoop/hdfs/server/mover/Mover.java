...
DECL|method|processFile (HdfsLocatedFileStatus status)
specifier|private
name|boolean
name|processFile
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Remove the overlap between the expected types and the existing types.      * @return if the existing types or the expected types is empty after      *         removing the overlap.      */
