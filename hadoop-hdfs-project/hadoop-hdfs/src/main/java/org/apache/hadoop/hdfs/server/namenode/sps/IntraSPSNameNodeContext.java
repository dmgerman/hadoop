...
name|isSpsRunning
decl_stmt|;
DECL|method|IntraSPSNameNodeContext (Namesystem namesystem, BlockManager blockManager, Configuration conf)
specifier|public
name|IntraSPSNameNodeContext
parameter_list|(
name|Namesystem
...
parameter_list|()
block|{
comment|// TODO : 'isSpsRunning' flag has been added to avoid the NN lock inside
comment|// SPS. Context interface will be further refined as part of HDFS-12911
comment|// modularization task. One idea is to introduce a cleaner interface similar
comment|// to Namesystem for better abstraction.
return|return
name|namesystem
operator|.
name|isRunning
...
annotation|@
name|Override
DECL|method|setSPSRunning (Supplier<Boolean> spsRunningFlag)
specifier|public
name|void
name|setSPSRunning
parameter_list|(
