...
name|println
argument_list|(
literal|"Warning: unsetting erasure coding policy on a "
operator|+
literal|"non-empty directory will not automatically convert existing"
operator|+
literal|" files to replicated data."
argument_list|)
expr_stmt|;
block|}
block|}
...
name|println
argument_list|(
literal|"Use '-setPolicy -path<PATH> -replicate' to enforce"
operator|+
literal|" default replication policy irrespective of EC policy"
operator|+
literal|" defined on parent."
argument_list|)
expr_stmt|;
return|return
literal|2
...
name|result
init|=
name|getECTopologyVerifierResultForPolicy
argument_list|(
name|dfs
argument_list|,
name|ecPolicyName
...
block|}
block|}
comment|/**    * Command to verify the cluster setup can support all enabled EC policies.    */
DECL|class|VerifyClusterSetupCommand
specifier|private
specifier|static
class|class
name|VerifyClusterSetupCommand
implements|implements
name|AdminHelper
operator|.
name|Command
...
literal|"\n"
operator|+
literal|"Verify if the cluster setup can support all enabled erasure "
operator|+
literal|"coding policies. If optional parameter -policy is specified, "
operator|+
literal|"verify if the cluster setup can support the given policy.\n"
return|;
block|}
annotation|@
name|Override
...
block|}
block|}
DECL|method|getECTopologyVerifierResult ( final DistributedFileSystem dfs)
specifier|private
specifier|static
name|ECTopologyVerifierResult
name|getECTopologyVerifierResult
...
return|;
block|}
DECL|method|getECTopologyResultForPolicies ( final DistributedFileSystem dfs, final String... policyNames)
specifier|private
specifier|static
name|ECTopologyVerifierResult
name|getECTopologyResultForPolicies
...
return|;
block|}
DECL|method|getECTopologyVerifierResultForPolicy ( final DistributedFileSystem dfs, final String policyName)
specifier|private
specifier|static
name|ECTopologyVerifierResult
name|getECTopologyVerifierResultForPolicy
...
return|;
block|}
DECL|method|getPolicy ( final ErasureCodingPolicyInfo[] policies, final String policyName)
specifier|private
specifier|static
name|ErasureCodingPolicy
name|getPolicy
...
name|HadoopIllegalArgumentException
argument_list|(
literal|"The given erasure coding "
operator|+
literal|"policy "
operator|+
name|policyName
...
throw|;
block|}
DECL|method|getEnabledPolicies ( final ErasureCodingPolicyInfo[] policies)
specifier|private
specifier|static
name|ErasureCodingPolicy
index|[]
