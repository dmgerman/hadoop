...
name|HdfsServerFederationProtos
operator|.
name|StateStoreVersionRecordProtoOrBuilder
import|;
end_import
...
begin_comment
comment|/**  * Protobuf implementation of the StateStoreVersion record.  */
end_comment

begin_class
DECL|class|StateStoreVersionPBImpl
specifier|public
class|class
...
argument_list|)
decl_stmt|;
DECL|method|StateStoreVersionPBImpl ()
specifier|public
name|StateStoreVersionPBImpl
parameter_list|()
block|{   }
