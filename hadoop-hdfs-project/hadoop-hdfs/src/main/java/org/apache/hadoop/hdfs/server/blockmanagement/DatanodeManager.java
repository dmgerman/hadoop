...
block|}
block|}
DECL|method|resolveNetworkLocation (String host)
specifier|public
name|String
name|resolveNetworkLocation
parameter_list|(
...
name|name
range|:
name|getNodeNamesForHostFiltering
argument_list|(
name|node
argument_list|)
control|)
...
condition|)
block|{
comment|// Put all nodes referenced in the hosts files in the map
name|Iterator
argument_list|<
name|String
argument_list|>
...
comment|// head from. Eg. a host that is no longer part of the cluster
...
return|;
block|}
DECL|method|getNodeNamesForHostFiltering (DatanodeID node)
specifier|private
specifier|static
name|List
argument_list|<
