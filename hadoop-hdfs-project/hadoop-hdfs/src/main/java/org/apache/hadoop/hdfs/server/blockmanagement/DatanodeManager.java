...
decl_stmt|;
comment|/** Whether or not to consider lad for reading. */
DECL|field|readConsiderLoad
specifier|private
specifier|final
name|boolean
name|readConsiderLoad
decl_stmt|;
...
name|activeLen
argument_list|,
name|createSecondaryNodeSorter
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
DECL|method|createSecondaryNodeSorter ()
specifier|private
name|Consumer
argument_list|<
name|List
...
name|debug
argument_list|(
literal|"Pending replication tasks: "
operator|+
name|numReplicationTasks
operator|+
...
expr_stmt|;
block|}
comment|// check pending replication tasks
name|List
argument_list|<
name|BlockTargetPair
argument_list|>
