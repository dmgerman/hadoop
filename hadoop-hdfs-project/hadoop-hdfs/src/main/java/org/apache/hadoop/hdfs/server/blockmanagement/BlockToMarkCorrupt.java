...
name|reasonCode
decl_stmt|;
DECL|method|BlockToMarkCorrupt (Block corrupted, BlockInfo stored, String reason, CorruptReplicasMap.Reason reasonCode)
name|BlockToMarkCorrupt
parameter_list|(
name|Block
name|corrupted
...
expr_stmt|;
block|}
DECL|method|BlockToMarkCorrupt (Block corrupted, BlockInfo stored, long gs, String reason, CorruptReplicasMap.Reason reasonCode)
name|BlockToMarkCorrupt
parameter_list|(
name|Block
name|corrupted
