...
init|=
literal|"dfs.client.write.max-packets-in-flight"
decl_stmt|;
...
init|=
literal|"dfs.client.write.byte-array-manager.enabled"
decl_stmt|;
...
init|=
literal|"dfs.client.write.byte-array-manager.count-threshold"
decl_stmt|;
...
init|=
literal|"dfs.client.write.byte-array-manager.count-limit"
decl_stmt|;
...
init|=
literal|"dfs.client.write.byte-array-manager.count-reset-time-period-ms"
decl_stmt|;
...
init|=
literal|"dfs.client.block.write.replace-datanode-on-failure.best-effort"
decl_stmt|;
...
init|=
literal|"dfs.client.retry.times.get-last-block-length"
decl_stmt|;
...
init|=
literal|"dfs.client.retry.interval-ms.get-last-block-length"
decl_stmt|;
...
init|=
literal|"dfs.client.write.exclude.nodes.cache.expiry.interval.millis"
decl_stmt|;
...
name|class
decl_stmt|;
DECL|field|DFS_DATANODE_RAM_DISK_LOW_WATERMARK_PERCENT
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"dfs.datanode.ram.disk.low.watermark.percent"
decl_stmt|;
DECL|field|DFS_DATANODE_RAM_DISK_LOW_WATERMARK_PERCENT_DEFAULT
specifier|public
specifier|static
specifier|final
name|float
...
literal|10.0f
decl_stmt|;
DECL|field|DFS_DATANODE_RAM_DISK_LOW_WATERMARK_BYTES
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"dfs.datanode.ram.disk.low.watermark.bytes"
decl_stmt|;
DECL|field|DFS_DATANODE_RAM_DISK_LOW_WATERMARK_BYTES_DEFAULT
specifier|public
specifier|static
specifier|final
name|long
...
init|=
literal|"dfs.client.read.shortcircuit.streams.cache.size"
decl_stmt|;
...
init|=
literal|"dfs.client.read.shortcircuit.streams.cache.expiry.ms"
decl_stmt|;
...
init|=
literal|"dfs.client.mmap.enabled"
decl_stmt|;
...
init|=
literal|"dfs.client.mmap.cache.size"
decl_stmt|;
...
init|=
literal|"dfs.client.mmap.retry.timeout.ms"
decl_stmt|;
...
init|=
literal|"dfs.http.client.retry.policy.enabled"
decl_stmt|;
...
init|=
literal|"dfs.http.client.retry.policy.spec"
decl_stmt|;
...
init|=
literal|"dfs.http.client.failover.max.attempts"
decl_stmt|;
...
init|=
literal|"dfs.http.client.retry.max.attempts"
decl_stmt|;
...
init|=
literal|"dfs.http.client.failover.sleep.base.millis"
decl_stmt|;
...
init|=
literal|"dfs.http.client.failover.sleep.max.millis"
decl_stmt|;
...
init|=
literal|"dfs.client.hedged.read.threshold.millis"
decl_stmt|;
...
init|=
literal|"dfs.client.hedged.read.threadpool.size"
decl_stmt|;
