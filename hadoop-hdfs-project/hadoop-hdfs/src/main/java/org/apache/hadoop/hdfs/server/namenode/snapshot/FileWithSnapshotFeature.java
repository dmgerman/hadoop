...
return|;
block|}
DECL|method|cleanFile (final BlockStoragePolicySuite bsps, final INodeFile file, final int snapshotId, int priorSnapshotId, final BlocksMapUpdateInfo collectedBlocks, final List<INode> removedINodes)
specifier|public
name|QuotaCounts
name|cleanFile
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|updateQuotaAndCollectBlocks (BlockStoragePolicySuite bsps, INodeFile file, FileDiff removed, BlocksMapUpdateInfo collectedBlocks, final List<INode> removedINodes)
specifier|public
name|QuotaCounts
...
DECL|method|collectBlocksAndClear (final BlockStoragePolicySuite bsps, final INodeFile file, final BlocksMapUpdateInfo info, final List<INode> removedINodes)
specifier|public
name|void
name|collectBlocksAndClear
parameter_list|(
