...
name|truncateBlock
decl_stmt|;
DECL|method|BlockUnderConstructionFeature (Block blk, BlockUCState state, DatanodeStorageInfo[] targets)
specifier|public
name|BlockUnderConstructionFeature
parameter_list|(
name|Block
...
DECL|method|setExpectedLocations (Block block, DatanodeStorageInfo[] targets)
specifier|public
name|void
name|setExpectedLocations
parameter_list|(
