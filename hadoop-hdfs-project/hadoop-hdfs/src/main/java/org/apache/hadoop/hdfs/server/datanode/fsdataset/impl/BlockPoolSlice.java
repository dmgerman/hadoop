...
block|}
block|}
comment|// Delete all checkpointed replicas on startup.
comment|// TODO: We can move checkpointed replicas to the finalized dir and delete
comment|//       the copy on RAM_DISK. For now we take the simpler approach.
name|FileUtil
operator|.
name|fullyDelete
argument_list|(
...
return|;
block|}
DECL|method|lazyPersistReplica (Block b, File f)
name|File
