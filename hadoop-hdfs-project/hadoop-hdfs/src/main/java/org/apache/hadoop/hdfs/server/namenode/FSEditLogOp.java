...
block|}
block|}
comment|/**    * Although {@link ClientProtocol#appendFile} may also log a close op, we do    * not need to record the rpc ids here since a successful appendFile op will    * finally log an AddOp.    */
DECL|class|CloseOp
specifier|static
class|class
name|CloseOp
...
block|}
block|}
comment|/**    * The corresponding operations are either {@literal @Idempotent} (    * {@link ClientProtocol#updateBlockForPipeline},    * {@link ClientProtocol#recoverLease}, {@link ClientProtocol#addBlock}) or    * already bound with other editlog op which records rpc ids (    * {@link ClientProtocol#startFile}). Thus no need to record rpc ids here.    */
...
block|}
block|}
comment|/**    * {@literal @AtMostOnce} for    * {@link ClientProtocol#removePathBasedCacheDescriptor}    */
DECL|class|RemovePathBasedCacheDescriptorOp
specifier|static
class|class
name|RemovePathBasedCacheDescriptorOp
extends|extends
...
name|id
decl_stmt|;
DECL|method|RemovePathBasedCacheDescriptorOp ()
specifier|public
name|RemovePathBasedCacheDescriptorOp
parameter_list|()
block|{
...
return|;
block|}
DECL|method|cachePoolInfoToXml (ContentHandler contentHandler, CachePoolInfo info)
specifier|public
specifier|static
name|void
name|cachePoolInfoToXml
...
block|}
block|}
DECL|method|cachePoolInfoFromXml (Stanza st)
specifier|public
specifier|static
name|CachePoolInfo
name|cachePoolInfoFromXml
