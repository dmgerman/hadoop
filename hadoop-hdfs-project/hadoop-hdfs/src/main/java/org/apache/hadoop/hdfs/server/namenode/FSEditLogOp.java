...
return|;
block|}
DECL|method|getFinalizeInstance (OpInstanceCache cache)
specifier|static
name|RollingUpgradeOp
...
return|;
block|}
DECL|method|appendXAttrToXml (ContentHandler contentHandler, XAttr xAttr)
specifier|private
specifier|static
name|void
name|appendXAttrToXml
...
expr_stmt|;
block|}
DECL|method|readXAttrFromXml (Stanza st)
specifier|private
specifier|static
name|XAttr
name|readXAttrFromXml
