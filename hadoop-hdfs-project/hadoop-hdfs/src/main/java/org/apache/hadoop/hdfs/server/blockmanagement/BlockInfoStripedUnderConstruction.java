...
DECL|method|BlockInfoStripedUnderConstruction (Block blk, ErasureCodingPolicy ecPolicy)
specifier|public
name|BlockInfoStripedUnderConstruction
parameter_list|(
name|Block
...
DECL|method|BlockInfoStripedUnderConstruction (Block blk, ErasureCodingPolicy ecPolicy, BlockUCState state, DatanodeStorageInfo[] targets)
specifier|public
name|BlockInfoStripedUnderConstruction
parameter_list|(
name|Block
...
control|)
block|{
comment|// when creating a new block we simply sequentially assign block index to
comment|// each storage
name|Block
name|blk
init|=
operator|new
...
return|;
block|}
comment|/** @return the index array indicating the block index in each storage */
