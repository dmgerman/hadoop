...
argument_list|>
block|{
DECL|method|IntegerParam (final Domain domain, final Integer value, final Integer min, final Integer max)
name|IntegerParam
parameter_list|(
specifier|final
name|Domain
...
expr_stmt|;
block|}
DECL|method|checkRange (final Integer min, final Integer max)
specifier|private
name|void
name|checkRange
parameter_list|(
...
block|}
block|}
comment|/** Convert an Integer to a String. */
DECL|method|toString (final Integer n)
name|String
name|toString
parameter_list|(
specifier|final
