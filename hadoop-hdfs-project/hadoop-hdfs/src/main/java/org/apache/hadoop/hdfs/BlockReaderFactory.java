...
DECL|method|newBlockReader ( Configuration conf, Socket sock, String file, ExtendedBlock block, Token<BlockTokenIdentifier> blockToken, long startOffset, long len, DataEncryptionKey encryptionKey)
specifier|public
specifier|static
name|BlockReader
name|newBlockReader
...
literal|"deprecation"
argument_list|)
DECL|method|newBlockReader ( Conf conf, Socket sock, String file, ExtendedBlock block, Token<BlockTokenIdentifier> blockToken, long startOffset, long len, int bufferSize, boolean verifyChecksum, String clientName, DataEncryptionKey encryptionKey, IOStreamPair ioStreams)
specifier|public
specifier|static
name|BlockReader
name|newBlockReader
