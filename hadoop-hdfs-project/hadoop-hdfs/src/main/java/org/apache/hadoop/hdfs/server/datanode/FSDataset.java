...
literal|0
decl_stmt|;
DECL|method|FSDir (File dir, int maxBlocksPerDir)
specifier|private
name|FSDir
parameter_list|(
name|File
...
block|}
block|}
comment|/**    * A BlockPoolSlice represents a portion of a BlockPool stored on a volume.      * Taken together, all BlockPoolSlices sharing a block pool ID across a     * cluster represent a single block pool.    *     * This class is synchronized by {@link FSVolume}.    */
...
return|;
block|}
comment|/**      * This should be used only by {@link FSVolume#decDfsUsed(String, long)}      * and it will be synchronized there.      */
...
block|}
block|}
comment|/**    * The underlying volume used to store replica.    *     * It uses the {@link FSDataset} object for synchronization.    */
DECL|class|FSVolume
specifier|static
class|class
name|FSVolume
...
name|reserved
decl_stmt|;
DECL|method|FSVolume (FSDataset dataset, String storageID, File currentDir, Configuration conf)
name|FSVolume
parameter_list|(
name|FSDataset
name|dataset
...
return|;
block|}
comment|/**      * This should be used only by {@link FSVolumeSet#checkDirs()}      * and it will be synchronized there.      */
DECL|method|checkDirs ()
name|void
name|checkDirs
parameter_list|()
