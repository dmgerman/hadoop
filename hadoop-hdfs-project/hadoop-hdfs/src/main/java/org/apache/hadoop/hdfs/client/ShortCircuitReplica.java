...
argument_list|)
decl_stmt|;
comment|/**    * Immutable class which identifies a ShortCircuitReplica object.    */
DECL|class|Key
specifier|public
specifier|static
specifier|final
...
name|Key
block|{
DECL|method|Key (long blockId, String bpId)
specifier|public
name|Key
parameter_list|(
name|long
...
return|;
block|}
comment|/**      * The block ID for this BlockDescriptors object.      */
DECL|field|blockId
specifier|private
specifier|final
name|long
name|blockId
decl_stmt|;
comment|/**      * The block pool ID for this BlockDescriptors object.      */
DECL|field|bpId
specifier|private
specifier|final
name|String
...
literal|null
decl_stmt|;
DECL|method|ShortCircuitReplica (Key key, FileInputStream dataStream, FileInputStream metaStream, ShortCircuitCache cache, long creationTimeMs)
specifier|public
name|ShortCircuitReplica
parameter_list|(
name|Key
