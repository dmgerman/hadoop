...
return|;
block|}
DECL|method|loadAclEntries (int id, final ImmutableList<AclEntry>[] aclTable)
specifier|public
specifier|static
name|ImmutableList
argument_list|<
...
return|;
block|}
DECL|method|loadINodeReference ( INodeSection.INodeReference r, FSDirectory dir)
specifier|public
specifier|static
name|INodeReference
...
block|}
block|}
DECL|method|loadINodeReference (InputStream in)
specifier|private
name|INodeReference
name|loadINodeReference
parameter_list|(
...
return|;
block|}
comment|/**      * Get a unique id for the AclEntry list. Notice that the code does not      * deduplicate the list of aclentry yet.      */
DECL|method|buildAclEntries (AclFeature f, final SaverContext.DeduplicationMap<ImmutableList<AclEntryProto>> map)
specifier|private
specifier|static
name|int
