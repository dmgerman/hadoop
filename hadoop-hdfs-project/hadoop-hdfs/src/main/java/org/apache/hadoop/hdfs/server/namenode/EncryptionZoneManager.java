...
begin_comment
comment|/**  * Manages the list of encryption zones in the filesystem. Relies on the  * FSDirectory lock for synchronization.  */
end_comment
...
expr_stmt|;
block|}
comment|/**    * Add a new encryption zone.    *    * @param inodeId of the encryption zone    * @param keyId   encryption zone key id    */
...
expr_stmt|;
block|}
comment|/**    * Returns true if an IIP is within an encryption zone.    */
...
return|;
block|}
comment|/**    * Throws an exception if the provided inode cannot be renamed into the    * destination because of differing encryption zones.    *    * @param srcIIP source IIP    * @param dstIIP destination IIP    * @param src    source path, used for debugging    * @throws IOException if the src cannot be renamed to the dst    */
