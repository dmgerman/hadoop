...
DECL|method|chooseLocalNodeGroup ( NetworkTopologyWithNodeGroup clusterMap, Node localMachine, Set<Node> excludedNodes, long blocksize, int maxNodesPerRack, List<DatanodeStorageInfo> results, boolean avoidStaleNodes, StorageType storageType)
specifier|private
name|DatanodeStorageInfo
name|chooseLocalNodeGroup
parameter_list|(
