...
return|;
block|}
DECL|method|buildBlockMovingInfos (BlockInfo blockInfo, List<DatanodeInfo> sourceNodes, List<StorageType> sourceStorageTypes, List<DatanodeInfo> targetNodes, List<StorageType> targetStorageTypes, List<BlockMovingInfo> blkMovingInfos)
specifier|private
name|void
name|buildBlockMovingInfos
parameter_list|(
