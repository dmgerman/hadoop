...
DECL|method|call (Set<StorageLocation> healthyVolumes, Set<StorageLocation> failedVolumes)
name|void
name|call
parameter_list|(
name|Set
...
name|callback
decl_stmt|;
DECL|method|ResultHandler (FsVolumeReference reference, Set<StorageLocation> healthyVolumes, Set<StorageLocation> failedVolumes, CountDownLatch latch, @Nullable Callback callback)
name|ResultHandler
parameter_list|(
name|FsVolumeReference
name|reference
