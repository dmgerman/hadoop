...
expr_stmt|;
block|}
DECL|method|createLocatedBlock (ExtendedBlock b, DatanodeStorageInfo[] storages, long startOffset, boolean corrupt)
specifier|public
specifier|static
name|LocatedBlock
...
return|;
block|}
DECL|method|LocatedBlock (ExtendedBlock b, DatanodeInfo[] locs, String[] storageIDs, StorageType[] storageTypes, long startOffset, boolean corrupt)
specifier|public
name|LocatedBlock
parameter_list|(
name|ExtendedBlock
