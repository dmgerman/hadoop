...
name|locs
decl_stmt|;
DECL|field|hasStorageIDs
specifier|private
specifier|final
name|boolean
name|hasStorageIDs
decl_stmt|;
DECL|field|hasStorageTypes
specifier|private
specifier|final
name|boolean
name|hasStorageTypes
decl_stmt|;
...
return|;
block|}
comment|/**    * Invalidates the cached StorageID and StorageType information. Must be    * called when the locations array is modified.    */
DECL|method|invalidateCachedStorageInfo ()
specifier|public
name|void
