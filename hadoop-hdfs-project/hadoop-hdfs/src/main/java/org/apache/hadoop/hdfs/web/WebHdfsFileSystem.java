...
return|;
block|}
DECL|method|addDt2Query (String query)
specifier|private
name|String
name|addDt2Query
parameter_list|(
...
condition|)
block|{
comment|// Skip adding delegation token for getting or renewing delegation token,
comment|// because these operations require kerberos authentication.
name|url
operator|=
name|getNamenodeURL
argument_list|(
...
literal|null
decl_stmt|;
DECL|method|Runner (final HttpOpParam.Op op, final URL url, final boolean redirected)
name|Runner
parameter_list|(
specifier|final
name|HttpOpParam
...
expr_stmt|;
block|}
DECL|method|Runner (final HttpOpParam.Op op, final Path fspath, final Param<?,?>... parameters)
name|Runner
parameter_list|(
specifier|final
name|HttpOpParam
...
expr_stmt|;
block|}
DECL|method|Runner (final HttpOpParam.Op op, final HttpURLConnection conn)
name|Runner
parameter_list|(
specifier|final
name|HttpOpParam
