...
argument_list|)
decl_stmt|;
comment|// Note that the role is always {@link NamenodeRole#NAMENODE} as this
comment|// conversion happens for messages from Namenode to Journal receivers.
comment|// Addresses in the registration are unused.
return|return
operator|new
name|NamenodeRegistration
argument_list|(
...
DECL|method|convertToJournalInfo ( NamenodeRegistration reg)
specifier|public
specifier|static
name|JournalInfoProto
