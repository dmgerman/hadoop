...
name|ClientNamenodeProtocolProtos
operator|.
name|PathBasedCacheDirectiveInfoProto
import|;
end_import
...
index|]
decl_stmt|;
comment|// The media should correspond to targets 1:1. If not then
comment|// ignore the media information (left as default).
if|if
condition|(
operator|(
name|storageTypesList
...
literal|false
argument_list|,
literal|"Failed to update StorageTypeProto with new StorageType "
operator|+
name|type
operator|.
name|toString
...
return|;
block|}
DECL|method|convert (PathBasedCacheDirective directive)
specifier|public
specifier|static
name|PathBasedCacheDirectiveInfoProto
name|convert
...
return|;
block|}
DECL|method|convert (PathBasedCacheDirectiveInfoProto proto)
specifier|public
specifier|static
name|PathBasedCacheDirective
name|convert
