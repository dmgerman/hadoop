...
name|xAttrs
operator|=
name|createErasureCodingPolicyXAttr
argument_list|(
name|fsn
argument_list|,
name|iip
...
return|;
block|}
DECL|method|createErasureCodingPolicyXAttr (final FSNamesystem fsn, final INodesInPath srcIIP, ErasureCodingPolicy ecPolicy)
specifier|static
name|List
argument_list|<
name|XAttr
