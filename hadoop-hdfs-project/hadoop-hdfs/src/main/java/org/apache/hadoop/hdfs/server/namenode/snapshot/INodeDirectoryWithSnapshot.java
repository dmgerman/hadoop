...
return|;
block|}
comment|/**      * Print out the content of the Diff. In general, "M"/"+"/"-" are used to       * represent files/directories that were modified, created, and deleted,       * respectively.      *       * @param str A StringBuilder used to storing the description of the Diff.      * @param parent The directory that the Diff is about. Used to get the full       *               path of the INodes contained in the Diff.                   */
DECL|method|printDiff (StringBuilder str, INodeDirectoryWithSnapshot parent, boolean reverse)
specifier|public
name|void
name|printDiff
parameter_list|(
