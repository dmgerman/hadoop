...
annotation|@
name|Override
DECL|method|createSnapshotCopyOfCurrentINode (INodeDirectory currentDir)
name|INodeDirectory
...
argument_list|>
block|{
DECL|method|DirectoryDiffList (List<DirectoryDiff> diffs)
name|DirectoryDiffList
parameter_list|(
name|List
argument_list|<
...
operator|++
expr_stmt|;
comment|//count this dir only if a snapshot diff is removed.
block|}
block|}
return|return
name|n
