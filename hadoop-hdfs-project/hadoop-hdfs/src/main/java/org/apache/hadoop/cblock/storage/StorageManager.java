...
name|containerSizeB
decl_stmt|;
DECL|method|StorageManager (IStorageClient storageClient)
specifier|public
name|StorageManager
parameter_list|(
name|IStorageClient
...
argument_list|)
throw|;
comment|// TODO : delete already created containers? or re-try policy
block|}
name|makeVolumeReady
argument_list|(
name|userName
