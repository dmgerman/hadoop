...
argument_list|()
decl_stmt|;
comment|// if the xmits is smaller than 1, the xmitsSubmitted should be set to 1
comment|// because if it set to zero, we cannot to measure the xmits submitted
name|int
name|xmitsSubmitted
init|=
name|Math
