...
name|queues
decl_stmt|;
DECL|method|MultipleBlockingQueue (int numQueue, int queueSize, int pullTimeout)
name|MultipleBlockingQueue
parameter_list|(
name|int
name|numQueue
...
expr_stmt|;
block|}
DECL|method|putEndBlock (int i, ExtendedBlock block)
name|void
name|putEndBlock
parameter_list|(
name|int
...
return|;
block|}
DECL|method|putUpdateBlock (int i, ExtendedBlock block)
name|void
name|putUpdateBlock
parameter_list|(
name|int
...
expr_stmt|;
block|}
DECL|method|getUpdateBlock (int i)
name|ExtendedBlock
name|getUpdateBlock
parameter_list|(
name|int
...
expr_stmt|;
block|}
DECL|method|putStripedBlock (int i, LocatedBlock block)
name|void
...
expr_stmt|;
block|}
DECL|method|getStripedBlock (int i)
name|LocatedBlock
...
expr_stmt|;
block|}
comment|/**    * Generate packets from a given buffer. This is only used for streamers    * writing parity blocks.    *    * @param byteBuffer the given buffer to generate packets    * @param checksumBuf the checksum buffer    * @return packets generated    * @throws IOException    */
DECL|method|generatePackets ( ByteBuffer byteBuffer, byte[] checksumBuf)
specifier|private
name|List
argument_list|<
name|DFSPacket
...
argument_list|)
expr_stmt|;
comment|// cell is full and current packet has not been enqueued,
if|if
condition|(
name|cellFull
operator|&&
