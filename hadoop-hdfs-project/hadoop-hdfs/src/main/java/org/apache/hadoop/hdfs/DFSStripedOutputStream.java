...
expr_stmt|;
block|}
comment|// TODO collect excludedNodes from all the data streamers
specifier|final
name|LocatedBlock
name|lb
init|=
...
condition|)
block|{
comment|// skipping failed data streamer
if|if
condition|(
name|blocks
index|[
...
expr_stmt|;
block|}
comment|// get all the current failed streamers after the flush
name|newFailed
operator|=
name|checkStreamers
argument_list|()
...
return|;
block|}
DECL|method|waitCreatingNewStreams ( Set<StripedDataStreamer> healthyStreamers)
specifier|private
name|Set
argument_list|<
name|StripedDataStreamer
