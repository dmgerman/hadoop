...
name|stripedBlocks
decl_stmt|;
DECL|field|shouldLocateFollowingBlock
specifier|private
specifier|volatile
name|boolean
...
block|}
block|}
DECL|method|shouldLocateFollowingBlock ()
name|boolean
name|shouldLocateFollowingBlock
parameter_list|()
block|{
...
argument_list|(
literal|"getEndBlock interrupted, i="
operator|+
name|i
argument_list|,
name|e
...
name|toInterruptedIOException
argument_list|(
literal|"getStripedBlock interrupted"
argument_list|,
name|e
argument_list|)
throw|;
