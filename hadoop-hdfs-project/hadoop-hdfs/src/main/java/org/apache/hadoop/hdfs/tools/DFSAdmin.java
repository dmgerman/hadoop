...
operator|+
literal|"\t[-reconfig<datanode|...><host:ipc_port><start|status|properties>]\n"
operator|+
...
operator|+
literal|"\tCurrently, only reloading DataNode's configuration is supported.\n"
decl_stmt|;
name|String
name|genericRefresh
init|=
...
return|;
block|}
DECL|method|startReconfiguration (String nodeType, String address)
name|int
name|startReconfiguration
parameter_list|(
name|String
...
name|println
argument_list|(
literal|"Started reconfiguration task on DataNode "
operator|+
name|address
argument_list|)
expr_stmt|;
...
name|print
argument_list|(
literal|"Reconfiguring status for DataNode["
operator|+
name|address
operator|+
literal|"]: "
...
name|println
argument_list|(
literal|"DataNode reloading configuration: "
operator|+
name|e
operator|+
literal|"."
...
return|;
block|}
DECL|method|getReconfigurableProperties (String nodeType, String address, PrintStream out, PrintStream err)
name|int
name|getReconfigurableProperties
parameter_list|(
name|String
...
name|println
argument_list|(
literal|"Configuration properties that are allowed to be reconfigured:"
argument_list|)
expr_stmt|;
for|for
control|(
...
name|println
argument_list|(
literal|"DataNode reconfiguration: "
operator|+
name|e
operator|+
literal|"."
