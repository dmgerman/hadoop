...
literal|"]\n"
operator|+
literal|"\t[-upgrade<query | finalize>]\n"
operator|+
...
operator|+
literal|"\t[-getVolumeReport datanode_host:ipc_port]\n"
operator|+
...
specifier|final
name|boolean
name|listEnteringMaintenance
init|=
name|StringUtils
operator|.
name|popOption
argument_list|(
literal|"-enteringmaintenance"
argument_list|,
name|args
argument_list|)
decl_stmt|;
specifier|final
name|boolean
name|listInMaintenance
init|=
name|StringUtils
operator|.
name|popOption
argument_list|(
literal|"-inmaintenance"
argument_list|,
name|args
argument_list|)
decl_stmt|;
...
block|}
block|}
DECL|method|printDataNodeReports (DistributedFileSystem dfs, DatanodeReportType type, boolean listNodes, String nodeState)
specifier|private
specifier|static
name|void
name|printDataNodeReports
...
return|;
block|}
DECL|method|printOpenFiles (RemoteIterator<OpenFileEntry> openFilesIterator)
specifier|private
name|void
name|printOpenFiles
parameter_list|(
...
block|}
block|}
comment|/**    * Command to ask the active namenode to set the balancer bandwidth.    * Usage: hdfs dfsadmin -setBalancerBandwidth bandwidth    * @param argv List of of command line parameters.    * @param idx The index of the command that is being processed.    * @exception IOException     */
...
literal|"-upgrade<query | finalize>:\n"
operator|+
literal|"     query: query the current upgrade status.\n"
operator|+
literal|"  finalize: finalize the upgrade of HDFS (equivalent to "
operator|+
literal|"-finalizeUpgrade."
decl_stmt|;
name|String
...
return|;
block|}
comment|/**    * Command to get the upgrade status of each namenode in the nameservice.    * Usage: hdfs dfsadmin -upgrade query    * @exception IOException    */
...
condition|)
block|{
comment|// In the case of HA and logical URI, run upgrade query for all
comment|// NNs in this nameservice.
name|String
name|nsId
init|=
...
return|;
block|}
comment|/**    * Upgrade command to get the status of upgrade or ask NameNode to finalize    * the previously performed upgrade.    * Usage: hdfs dfsadmin -upgrade [query | finalize]    * @exception IOException    */
DECL|method|upgrade (String arg)
specifier|public
name|int
name|upgrade
parameter_list|(
...
name|println
argument_list|(
literal|"Skip Standby NameNode, since it cannot perform"
operator|+
literal|" metasave operation"
argument_list|)
expr_stmt|;
block|}
else|else
...
return|;
block|}
DECL|method|getVolumeReport (String[] argv, int i)
specifier|private
name|int
name|getVolumeReport
parameter_list|(
