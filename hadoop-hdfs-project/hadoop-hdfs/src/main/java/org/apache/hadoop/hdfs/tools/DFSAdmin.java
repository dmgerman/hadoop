...
operator|+
literal|"\t[-reconfig<datanode|...><host:ipc_port><start|status>]\n"
operator|+
...
return|;
block|}
DECL|method|setStoragePolicy (String[] argv)
specifier|public
name|int
...
return|;
block|}
DECL|method|getStoragePolicy (String[] argv)
specifier|public
name|int
...
literal|"-reconfig<datanode|...><host:ipc_port><start|status>:\n"
operator|+
literal|"\tStarts reconfiguration or gets the status of an ongoing reconfiguration.\n"
operator|+
...
literal|"-setStoragePolicy path policyName\n"
operator|+
literal|"\tSet the storage policy for a file/directory.\n"
decl_stmt|;
name|String
name|getStoragePolicy
init|=
literal|"-getStoragePolicy path\n"
operator|+
literal|"\tGet the storage policy for a file/directory.\n"
decl_stmt|;
name|String
name|triggerBlockReport
init|=
