...
name|f
operator|.
name|getStripedBlocks
argument_list|()
operator|.
name|getBlocksList
argument_list|()
decl_stmt|;
comment|// Get total of actual data block size
for|for
control|(
name|StripedBlockProto
name|p
...
control|)
block|{
comment|// Total usage by this striped blocks should be the total of data
comment|// blocks and parity blocks
name|size
operator|+=
name|StripedBlockUtil
operator|.
