...
name|existing
operator|=
name|createChildrenDirectories
argument_list|(
name|fsd
argument_list|,
name|existing
...
condition|)
block|{
comment|// otherwise all ancestors have been created
name|List
argument_list|<
name|String
argument_list|>
...
expr_stmt|;
block|}
DECL|method|createSingleDirectory (FSDirectory fsd, INodesInPath existing, String localName, PermissionStatus perm)
specifier|private
specifier|static
name|INodesInPath
name|createSingleDirectory
