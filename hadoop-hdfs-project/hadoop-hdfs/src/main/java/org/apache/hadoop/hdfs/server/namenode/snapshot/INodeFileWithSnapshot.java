...
DECL|method|collectBlocksAndClear (final BlocksMapUpdateInfo info, final List<INode> removedINodes)
name|void
name|collectBlocksAndClear
parameter_list|(
specifier|final
...
block|}
block|}
DECL|method|updateQuotaAndCollectBlocks (FileDiff removed, BlocksMapUpdateInfo collectedBlocks, final List<INode> removedINodes)
name|Quota
operator|.
name|Counts
