...
return|;
block|}
DECL|method|loadDataStorage (DataNode datanode, NamespaceInfo nsInfo, Collection<StorageLocation> dataDirs, StartupOption startOpt)
specifier|private
name|List
argument_list|<
name|StorageLocation
...
return|;
block|}
DECL|method|loadBlockPoolSliceStorage (DataNode datanode, NamespaceInfo nsInfo, Collection<StorageLocation> dataDirs, StartupOption startOpt)
specifier|private
name|List
argument_list|<
name|StorageDirectory
...
expr_stmt|;
block|}
DECL|method|doUgrade (final StorageDirectory sd, final NamespaceInfo nsInfo, final File prevDir, final File tmpDir, final File bbwDir, final File toDir, final int oldLV, Configuration conf)
specifier|private
name|void
name|doUgrade
parameter_list|(
