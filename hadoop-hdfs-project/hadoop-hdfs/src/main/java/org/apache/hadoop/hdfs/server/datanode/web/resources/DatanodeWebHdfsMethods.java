...
name|response
decl_stmt|;
DECL|method|init (final UserGroupInformation ugi, final DelegationParam delegation, final UriFsPathParam path, final HttpOpParam<?> op, final Param<?, ?>... parameters)
specifier|private
name|void
name|init
parameter_list|(
