...
expr_stmt|;
block|}
comment|/**    * Open an EditLogInputStream for the given URL.    *    * @param url the url hosting the log    * @param startTxId the expected starting txid    * @param endTxId the expected ending txid    * @param inProgress whether the log is in-progress    * @return a stream from which edits may be read    */
DECL|method|fromUrl (URL url, long startTxId, long endTxId, boolean inProgress)
specifier|public
specifier|static
name|EditLogInputStream
name|fromUrl
