...
argument_list|()
decl_stmt|;
comment|/** Select the delegation token for hdfs from the ugi. */
DECL|method|selectHdfsDelegationToken ( final InetSocketAddress nnAddr, final UserGroupInformation ugi, final Configuration conf)
specifier|public
specifier|static
name|Token
argument_list|<
