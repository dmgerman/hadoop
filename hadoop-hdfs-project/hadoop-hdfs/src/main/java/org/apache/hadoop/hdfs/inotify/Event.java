...
name|timestamp
decl_stmt|;
DECL|method|RenameEvent (String srcPath, String dstPath, long timestamp)
specifier|public
name|RenameEvent
parameter_list|(
name|String
...
name|path
decl_stmt|;
DECL|method|AppendEvent (String path)
specifier|public
name|AppendEvent
parameter_list|(
name|String
...
name|timestamp
decl_stmt|;
DECL|method|UnlinkEvent (String path, long timestamp)
specifier|public
name|UnlinkEvent
parameter_list|(
name|String
