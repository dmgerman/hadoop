...
block|}
block|}
DECL|method|readFromBlock (final StripedReader reader, final ByteBuffer buf, final int length, final Map<ExtendedBlock, Set<DatanodeInfo>> corruptionMap)
specifier|private
name|Callable
argument_list|<
name|Void
...
return|;
block|}
DECL|method|reportCorruptedBlocks ( Map<ExtendedBlock, Set<DatanodeInfo>> corruptionMap)
specifier|private
name|void
name|reportCorruptedBlocks
parameter_list|(
...
block|}
block|}
DECL|method|addCorruptedBlock (ExtendedBlock blk, DatanodeInfo node, Map<ExtendedBlock, Set<DatanodeInfo>> corruptionMap)
specifier|private
name|void
name|addCorruptedBlock
parameter_list|(
...
name|source
decl_stmt|;
DECL|method|StripedReader (short index, ExtendedBlock block, DatanodeInfo source)
name|StripedReader
parameter_list|(
name|short
name|index
