...
DECL|method|readMinimumStripedData4Reconstruction (final int[] success, int reconstructLength, CorruptedBlocks corruptedBlocks)
specifier|private
name|int
index|[]
name|readMinimumStripedData4Reconstruction
...
DECL|method|scheduleNewRead (BitSet used, int reconstructLen, CorruptedBlocks corruptedBlocks)
specifier|private
name|int
name|scheduleNewRead
parameter_list|(
...
block|}
block|}
DECL|method|readFromBlock (final StripedReader reader, final ByteBuffer buf, final int length, final CorruptedBlocks corruptedBlocks)
specifier|private
name|Callable
argument_list|<
name|Void
