...
return|;
block|}
DECL|method|satisfyStoragePolicy (FSDirectory fsd, BlockManager bm, String src)
specifier|static
name|void
...
block|}
block|}
DECL|method|unprotectedSatisfyStoragePolicy (BlockManager bm, INodesInPath iip)
specifier|static
name|void
name|unprotectedSatisfyStoragePolicy
parameter_list|(
...
name|IOException
block|{
comment|// check whether file exists.
name|INode
name|inode
init|=
name|iip
...
throw|;
block|}
comment|// TODO: need to check whether inode's storage policy
comment|// has been satisfied or inode exists in the satisfier
comment|// list before calling satisfyStoragePolicy in BlockManager.
if|if
condition|(
name|inode
operator|.
