...
return|;
block|}
comment|/**    * Get the blocks to move to satisfy the storage media type.    *    * @param numBlocksToMoveTasks    *          total number of blocks which will be send to this datanode for    *          block movement.    *    * @return block infos which needs to move its storage locations.    */
