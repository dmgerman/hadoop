...
expr_stmt|;
block|}
comment|/**    * DatanodeDescriptor constructor    * @param nodeID id of the data node    * @param networkLocation location of the data node in network    * @param cacheCapacity cache capacity of the data node    * @param cacheUsed cache used on the data node    * @param xceiverCount # of data transfers at the data node    */
DECL|method|DatanodeDescriptor (DatanodeID nodeID, String networkLocation, long cacheCapacity, long cacheUsed, int xceiverCount, int failedVolumes)
specifier|public
name|DatanodeDescriptor
parameter_list|(
name|DatanodeID
