...
literal|0
decl_stmt|;
comment|/**    * Head of the list of cached blocks on the datanode    */
DECL|field|cachedBlockList
specifier|private
specifier|volatile
name|BlockInfo
name|cachedBlockList
init|=
literal|null
decl_stmt|;
comment|/**    * Number of cached blocks on the datanode    */
DECL|field|numCachedBlocks
specifier|private
name|int
...
argument_list|()
decl_stmt|;
comment|/** A queue of blocks to be cached by this datanode */
DECL|field|cacheBlocks
specifier|private
name|BlockQueue
argument_list|<
name|Block
...
argument_list|()
decl_stmt|;
comment|/** A set of blocks to be uncached by this datanode */
...
return|;
block|}
comment|/**    * Add block to the list of cached blocks on the data-node.    * @return true if block was successfully added, false if already present    */
DECL|method|addCachedBlock (BlockInfo b)
specifier|public
name|boolean
name|addCachedBlock
parameter_list|(
...
return|;
block|}
comment|/**    * Remove block from the list of cached blocks on the data-node.    * @return true if block was successfully removed, false if not present    */
DECL|method|removeCachedBlock (BlockInfo b)
specifier|public
name|boolean
...
block|}
block|}
comment|/**    * Move block to the head of the list of cached blocks on the data-node.    * @return the index of the head of the blockList    */
DECL|method|moveCachedBlockToHead (BlockInfo b, int curIndex, int headIndex)
name|int
...
return|;
block|}
DECL|method|getCachedBlockIterator ()
specifier|public
name|Iterator
argument_list|<
name|BlockInfo
argument_list|>
name|getCachedBlockIterator
parameter_list|()
block|{
return|return
operator|new
...
expr_stmt|;
block|}
comment|/**    * Store block caching work.    */
DECL|method|addBlockToBeCached (Block block)
name|void
...
block|}
block|}
comment|/**    * Store block uncaching work.    */
DECL|method|addBlocksToBeUncached (List<Block> blocklist)
name|void
...
return|;
block|}
comment|/**    * The number of pending cache work items    */
DECL|method|getNumberOfBlocksToBeCached ()
name|int
name|getNumberOfBlocksToBeCached
parameter_list|()
block|{
return|return
name|cacheBlocks
...
block|}
block|}
comment|/**    * The number of pending uncache work items    */
DECL|method|getNumberOfBlocksToBeUncached ()
name|int
name|getNumberOfBlocksToBeUncached
parameter_list|()
block|{
synchronized|synchronized
init|(
...
block|}
block|}
comment|/**    * Remove up to the maximum number of blocks to be uncached    */
DECL|method|getInvalidateCacheBlocks ()
specifier|public
name|Block
index|[]
name|getInvalidateCacheBlocks
parameter_list|()
block|{
synchronized|synchronized
init|(
