...
expr_stmt|;
block|}
comment|/**    * DatanodeDescriptor constructor    * @param nodeID id of the data node    * @param networkLocation location of the data node in network    * @param xceiverCount # of data transfers at the data node    */
DECL|method|DatanodeDescriptor (DatanodeID nodeID, String networkLocation, int xceiverCount, int failedVolumes)
specifier|public
name|DatanodeDescriptor
parameter_list|(
name|DatanodeID
...
DECL|method|updateHeartbeat (StorageReport[] reports, int xceiverCount, int volFailures)
specifier|public
name|void
name|updateHeartbeat
parameter_list|(
