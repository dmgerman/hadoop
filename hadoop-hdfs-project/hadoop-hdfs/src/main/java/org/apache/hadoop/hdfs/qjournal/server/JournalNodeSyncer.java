...
operator|+
literal|"it has been configured with different journalnode values "
operator|+
name|sharedEditsUri
operator|.
name|toString
...
return|;
block|}
DECL|method|getJournalAddrList (String uriStr)
specifier|private
name|List
argument_list|<
name|InetSocketAddress
...
name|error
argument_list|(
literal|"EditLogManifest response does not have fromUrl "
operator|+
literal|"field set. Aborting current sync attempt"
argument_list|)
expr_stmt|;
break|break;
block|}
...
name|error
argument_list|(
literal|"EditLogManifest's fromUrl field syntax incorrect"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|getHttpServerURI (String fromUrl, String hostAddr)
specifier|private
name|URL
name|getHttpServerURI
parameter_list|(
