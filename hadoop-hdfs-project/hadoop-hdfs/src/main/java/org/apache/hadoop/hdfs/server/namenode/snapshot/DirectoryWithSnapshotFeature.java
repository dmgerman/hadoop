...
block|}
block|}
comment|/**      * Interpret the diff and generate a list of {@link DiffReportEntry}.      * @param parentPath The relative path of the parent.      * @param fromEarlier True indicates {@code diff=later-earlier},      *                    False indicates {@code diff=earlier-later}      * @return A list of {@link DiffReportEntry} as the diff report.      */
DECL|method|generateReport (byte[][] parentPath, boolean fromEarlier, Map<Long, RenameEntry> renameMap)
specifier|public
name|List
argument_list|<
name|DiffReportEntry
