...
expr_stmt|;
block|}
comment|/**      * Replace the given child from the created list.      * @return true if the child is replaced; false if the child is not found.      */
DECL|method|replaceCreated (final INode oldChild, final INode newChild)
specifier|private
name|boolean
name|replaceCreated
parameter_list|(
...
name|directoryDiffList
operator|.
name|getDiffListBetweenSnapshots
argument_list|(
name|diffIndex
argument_list|,
name|directoryDiffList
...
DECL|method|replaceCreatedChild (final INode oldChild, final INode newChild)
specifier|public
name|boolean
...
return|;
block|}
comment|/** Remove the given child from the deleted list, if there is any. */
DECL|method|removeDeletedChild (final INode child)
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * Returns the list of diffs between two indexes corresponding to two      * snapshots.      * @param fromIndex Index of the diff corresponding to the earlier snapshot      * @param toIndex   Index of the diff corresponding to the later snapshot      * @param dir       The Directory to which the diffList belongs      * @return list of directory diffs      */
DECL|method|getDiffListBetweenSnapshots (int fromIndex, int toIndex, INodeDirectory dir)
name|List
argument_list|<
name|DirectoryDiff
argument_list|>
