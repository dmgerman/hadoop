...
block|}
block|}
DECL|field|SOURCE_BLOCKS_MIN_SIZE
specifier|private
specifier|static
specifier|final
name|int
name|SOURCE_BLOCKS_MIN_SIZE
init|=
literal|5
decl_stmt|;
...
condition|)
block|{
comment|// source and target are on the same rack
return|return
literal|false
return|;
block|}
...
condition|)
block|{
comment|// target is not on the same rack as any replica
return|return
literal|false
return|;
block|}
...
condition|)
block|{
comment|// source is on the same rack of another replica
return|return
literal|false
return|;
block|}
