...
literal|false
decl_stmt|;
comment|/**    * True if the user specified the -replicate option.    *    * When this option is in effect, we will initiate replication work to make    * mis-replicated blocks confirm the block placement policy.    */
DECL|field|doReplicate
specifier|private
name|boolean
name|doReplicate
init|=
...
continue|continue;
block|}
name|printDatanodeReplicaStatus
argument_list|(
name|block
argument_list|,
name|corruptionRecord
...
block|}
block|}
DECL|method|printDatanodeReplicaStatus (Block block, Collection<DatanodeDescriptor> corruptionRecord, DatanodeDescriptor dn)
specifier|private
name|void
name|printDatanodeReplicaStatus
parameter_list|(
...
name|warn
argument_list|(
literal|"Fsck: Block manager is able to process only "
operator|+
name|processedBlocks
operator|+
literal|" mis-replicated blocks (Total count : "
operator|+
name|misReplicatedBlocks
operator|.
name|size
...
name|res
operator|.
name|numBlocksQueuedForReplication
operator|+=
name|processedBlocks
expr_stmt|;
block|}
...
block|}
block|}
DECL|method|copyBock (BlockReader blockReader, OutputStream os)
specifier|private
name|long
name|copyBock
parameter_list|(
...
literal|0L
decl_stmt|;
DECL|field|numBlocksQueuedForReplication
name|long
name|numBlocksQueuedForReplication
init|=
literal|0L
