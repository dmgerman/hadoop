...
name|mirrorAddr
decl_stmt|;
DECL|field|mirrorNameForMetrics
specifier|private
name|String
name|mirrorNameForMetrics
decl_stmt|;
...
decl_stmt|;
DECL|field|dirSyncOnHSyncDone
specifier|private
name|boolean
name|dirSyncOnHSyncDone
init|=
literal|false
decl_stmt|;
...
block|}
block|}
comment|/**    * If we have downstream DNs and peerMetrics are enabled, then initialize    * some state for monitoring the performance of downstream DNs.    *    * @param downstreams downstream DNs, or null if there are none.    */
DECL|method|initPerfMonitoring (DatanodeInfo[] downstreams)
specifier|private
name|void
name|initPerfMonitoring
parameter_list|(
...
name|debug
argument_list|(
literal|"Will collect peer metrics for downstream node {}"
argument_list|,
name|mirrorNameForMetrics
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * Fetch the base URI of the volume on which this replica resides.    *    * @returns Volume base URI as string if available. Else returns the    *          the string "unavailable".    */
DECL|method|getVolumeBaseUri ()
specifier|private
name|String
name|getVolumeBaseUri
parameter_list|()
