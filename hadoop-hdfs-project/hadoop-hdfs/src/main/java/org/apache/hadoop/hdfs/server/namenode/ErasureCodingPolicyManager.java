...
block|}
decl_stmt|;
comment|/**    * All user defined policies sorted by name for fast querying.    */
DECL|field|userPoliciesByName
specifier|private
name|Map
argument_list|<
name|String
...
decl_stmt|;
comment|/**    * All user defined policies sorted by ID for fast querying.    */
DECL|field|userPoliciesByID
specifier|private
name|Map
argument_list|<
name|Byte
...
decl_stmt|;
comment|/**    * All removed policies sorted by name.    */
DECL|field|removedPoliciesByName
specifier|private
name|Map
argument_list|<
name|String
