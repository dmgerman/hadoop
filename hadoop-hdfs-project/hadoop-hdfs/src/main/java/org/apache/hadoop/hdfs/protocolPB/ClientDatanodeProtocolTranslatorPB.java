...
name|IOException
block|{
comment|// Convert to proto objects
name|List
argument_list|<
name|ExtendedBlockProto
argument_list|>
...
throw|;
block|}
comment|// List of volumes in the response
name|List
argument_list|<
name|ByteString
argument_list|>
...
expr_stmt|;
block|}
comment|// Array of indexes into the list of volumes, one per block
name|List
argument_list|<
name|Integer
argument_list|>
...
name|response
operator|.
name|getVolumeIndexesList
argument_list|()
decl_stmt|;
comment|// Parsed HdfsVolumeId values, one per block
return|return
operator|new
name|HdfsBlocksMetadata
argument_list|(
