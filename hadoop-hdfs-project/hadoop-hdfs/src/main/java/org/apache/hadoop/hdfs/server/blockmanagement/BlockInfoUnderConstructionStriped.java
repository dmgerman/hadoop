...
begin_class
DECL|class|BlockInfoUnderConstructionStriped
specifier|public
class|class
...
name|COMPLETE
operator|:
literal|"BlockInfoUnderConstructionStriped cannot be in COMPLETE state"
assert|;
name|this
operator|.
name|blockUCState
...
literal|"BLOCK*"
operator|+
literal|" BlockInfoUnderConstructionStriped.initLeaseRecovery:"
operator|+
