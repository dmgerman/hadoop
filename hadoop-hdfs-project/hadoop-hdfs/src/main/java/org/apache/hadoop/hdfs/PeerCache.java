...
expr_stmt|;
block|}
comment|/**    * Get a cached peer connected to the given DataNode.    * @param dnId         The DataNode to get a Peer for.    * @return             An open Peer connected to the DN, or null if none    *                     was found.     */
DECL|method|get (DatanodeID dnId)
specifier|public
specifier|synchronized
name|Peer
name|get
