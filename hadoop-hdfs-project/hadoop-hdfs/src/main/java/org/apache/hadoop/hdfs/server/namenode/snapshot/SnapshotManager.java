...
return|;
block|}
DECL|class|SnapshotDirectoryMXBean
specifier|public
class|class
name|SnapshotDirectoryMXBean
block|{
...
argument_list|()
decl_stmt|;
DECL|method|SnapshotDirectoryMXBean (SnapshottableDirectoryStatus[] stats)
specifier|public
name|SnapshotDirectoryMXBean
parameter_list|(
name|SnapshottableDirectoryStatus
...
expr_stmt|;
block|}
DECL|method|set (SnapshottableDirectoryStatus[] stats)
specifier|public
name|void
name|set
parameter_list|(
