...
literal|false
decl_stmt|;
comment|/**    * If snapshotDiffAllowSnapRootDescendant is set to true, snapshot diff    * operation can be run for any descendant directory under a snapshot root    * directory and the diff calculation will be scoped to the descendant    * directory.    */
DECL|field|snapshotDiffAllowSnapRootDescendant
specifier|private
specifier|final
name|boolean
...
expr_stmt|;
block|}
DECL|method|isAllowNestedSnapshots ()
specifier|public
name|boolean
...
return|;
block|}
comment|/**    * Get the snapshot root directory for the given directory. The given    * directory must either be a snapshot root or a descendant of any    * snapshot root directories.    * @param iip INodesInPath for the directory to get snapshot root.    * @return the snapshot root INodeDirectory    */
DECL|method|getSnapshottableAncestorDir (final INodesInPath iip)
specifier|public
name|INodeDirectory
name|getSnapshottableAncestorDir
parameter_list|(
specifier|final
name|INodesInPath
name|iip
...
name|SnapshotException
argument_list|(
literal|"Directory is neither snapshottable nor"
operator|+
literal|" under a snap root!"
argument_list|)
throw|;
block|}
block|}
DECL|method|isDescendantOfSnapshotRoot (INodeDirectory dir)
specifier|public
name|boolean
...
DECL|method|diff (final INodesInPath iip, final String snapshotPath, final String from, final String to)
specifier|public
name|SnapshotDiffReport
name|diff
parameter_list|(
...
return|;
block|}
comment|/**    * Compute the partial difference between two snapshots of a directory,    * or between a snapshot of the directory and its current tree.    */
DECL|method|diff (final INodesInPath iip, final String snapshotPath, final String from, final String to, byte[] startPath, int index, int snapshotDiffReportLimit)
specifier|public
name|SnapshotDiffReportListing
name|diff
parameter_list|(
