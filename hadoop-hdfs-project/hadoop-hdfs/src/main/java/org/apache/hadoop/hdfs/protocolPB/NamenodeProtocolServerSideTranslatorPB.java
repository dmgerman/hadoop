...
name|NamenodeProtocolProtos
operator|.
name|HasLowRedundancyBlocksResponseProto
import|;
end_import
...
annotation|@
name|Override
DECL|method|getNextSPSPathId ( RpcController controller, GetNextSPSPathIdRequestProto request)
specifier|public
name|GetNextSPSPathIdResponseProto
...
annotation|@
name|Override
DECL|method|getFilePath (RpcController controller, GetFilePathRequestProto request)
specifier|public
name|GetFilePathResponseProto
name|getFilePath
parameter_list|(
...
annotation|@
name|Override
DECL|method|hasLowRedundancyBlocks ( RpcController controller, HasLowRedundancyBlocksRequestProto request)
specifier|public
name|HasLowRedundancyBlocksResponseProto
...
argument_list|()
operator|.
name|setHasLowRedundancyBlocks
argument_list|(
name|impl
operator|.
name|hasLowRedundancyBlocks
