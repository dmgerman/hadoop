...
argument_list|()
decl_stmt|;
DECL|field|highestPriorityLowRedundancyReplicatedBlocks
specifier|private
specifier|final
name|LongAdder
...
argument_list|()
decl_stmt|;
DECL|field|highestPriorityLowRedundancyECBlocks
specifier|private
specifier|final
name|LongAdder
...
return|;
block|}
comment|/** Return the number of under replicated blocks    * with the highest priority to recover */
...
return|;
block|}
comment|/** Return the number of under replicated EC blocks    * with the highest priority to recover */
