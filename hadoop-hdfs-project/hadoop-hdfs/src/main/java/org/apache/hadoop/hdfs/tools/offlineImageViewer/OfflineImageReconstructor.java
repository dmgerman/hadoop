...
name|put
argument_list|(
name|ErasureCodingSectionProcessor
operator|.
name|NAME
argument_list|,
operator|new
...
block|}
block|}
DECL|class|ErasureCodingSectionProcessor
specifier|private
class|class
name|ErasureCodingSectionProcessor
implements|implements
...
name|node
argument_list|,
literal|"ErasureCodingSection fields"
argument_list|)
expr_stmt|;
name|ErasureCodingSection
operator|.
...
condition|)
block|{
comment|// Add all snapshottable directories, one by one
name|bld
operator|.
