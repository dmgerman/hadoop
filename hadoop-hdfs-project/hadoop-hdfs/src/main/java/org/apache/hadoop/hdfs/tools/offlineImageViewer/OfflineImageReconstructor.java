...
comment|// Will check remaining keys and serialize in processINodeXml
block|}
DECL|method|aclXmlToProto (Node acl)
specifier|private
name|INodeSection
operator|.
...
name|IOException
block|{
comment|// TODO: support ACLs
throw|throw
operator|new
name|IOException
argument_list|(
literal|"ACLs are not supported yet."
argument_list|)
throw|;
block|}
...
expr_stmt|;
block|}
comment|// TODO: add missing snapshotCopy field to XML
name|Integer
...
expr_stmt|;
block|}
comment|// TODO: missing snapshotCopy
comment|// TODO: missing blocks
name|fileDiff
operator|.
name|verifyNoRemainingKeys
argument_list|(
