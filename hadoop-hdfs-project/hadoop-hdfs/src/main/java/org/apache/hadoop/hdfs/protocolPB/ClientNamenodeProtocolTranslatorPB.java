...
name|poolId
decl_stmt|;
DECL|method|PathCacheEntriesIterator (long prevKey, int maxRepliesPerRequest, long poolId)
specifier|public
name|PathCacheEntriesIterator
parameter_list|(
name|long
...
annotation|@
name|Override
DECL|method|makeRequest ( Long prevEntryId, int maxRepliesPerRequest)
specifier|public
name|BatchedEntries
argument_list|<
name|PathCacheEntry
...
annotation|@
name|Override
DECL|method|listPathCacheEntries (long prevId, long poolId, int repliesPerRequest)
specifier|public
name|RemoteIterator
argument_list|<
name|PathCacheEntry
...
block|}
block|}
DECL|class|BatchedPathDirectiveEntries
specifier|private
specifier|static
class|class
name|BatchedPathDirectiveEntries
implements|implements
name|BatchedEntries
argument_list|<
name|CachePool
...
name|proto
decl_stmt|;
DECL|method|BatchedPathDirectiveEntries (ListCachePoolsResponseProto proto)
specifier|public
name|BatchedPathDirectiveEntries
parameter_list|(
name|ListCachePoolsResponseProto
...
argument_list|>
block|{
DECL|method|CachePoolIterator (Long prevKey, int maxRepliesPerRequest)
specifier|public
name|CachePoolIterator
parameter_list|(
name|Long
