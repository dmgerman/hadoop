...
name|rpcProxy
decl_stmt|;
DECL|method|ClientNamenodeProtocolTranslatorPB (InetSocketAddress nameNodeAddr, Configuration conf, UserGroupInformation ugi)
specifier|public
name|ClientNamenodeProtocolTranslatorPB
parameter_list|(
name|InetSocketAddress
...
expr_stmt|;
block|}
DECL|method|getNamenodeRetryProxy ( InetSocketAddress nameNodeAddr, Configuration conf, UserGroupInformation ugi)
specifier|private
specifier|static
name|ClientNamenodeProtocolPB
name|getNamenodeRetryProxy
