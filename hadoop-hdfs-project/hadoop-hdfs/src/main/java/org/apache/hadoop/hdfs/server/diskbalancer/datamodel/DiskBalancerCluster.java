...
expr_stmt|;
block|}
comment|/**    * Creates an Output directory for the cluster output.    *    * @throws IOException - On failure to create an new directory    */
DECL|method|createOutPutDirectory ()
specifier|public
name|void
...
name|fatal
argument_list|(
literal|"An output directory already exists at this location. Path : "
operator|+
name|this
operator|.
name|getOutput
...
name|fatal
argument_list|(
literal|"Unable to create the output directory. Path : "
operator|+
name|this
operator|.
name|getOutput
...
name|info
argument_list|(
literal|"Output directory created. Path : "
operator|+
name|this
operator|.
name|getOutput
...
DECL|method|computePlan (float thresholdPercent)
specifier|public
name|List
argument_list|<
name|NodePlan
