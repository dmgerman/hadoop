...
return|;
block|}
comment|/**     * Bit format:    * [4-bit storagePolicyID][1-bit isStriped]    * [11-bit replication][48-bit preferredBlockSize]    */
...
argument_list|)
expr_stmt|;
comment|// Replication factor for striped files is zero
if|if
condition|(
name|isStriped
condition|)
...
comment|// TODO properly handle striped files
