...
return|;
block|}
comment|/* Start of StripedBlock Feature */
DECL|method|getStripedBlocksFeature ()
specifier|public
specifier|final
...
return|;
block|}
DECL|method|addStripedBlocksFeature ()
specifier|public
name|FileWithStripedBlocksFeature
...
literal|0
operator|:
literal|"The file contains contiguous blocks"
assert|;
assert|assert
operator|!
...
DECL|method|hasNoContiguousBlock ()
specifier|private
name|boolean
name|hasNoContiguousBlock
parameter_list|()
block|{
return|return
operator|(
...
DECL|method|assertAllBlocksComplete (BlockInfo[] blks)
specifier|private
name|void
name|assertAllBlocksComplete
parameter_list|(
...
block|}
block|}
comment|/**    * Instead of adding a new block, this function is usually used while loading    * fsimage or converting the last block to UC/Complete.    */
annotation|@
name|Override
comment|// BlockCollection
...
block|}
block|}
comment|/** Used by snapshot diff */
DECL|method|getContiguousBlocks ()
specifier|public
name|BlockInfoContiguous
index|[]
...
expr_stmt|;
block|}
comment|/**    * add a contiguous block to the block list    */
DECL|method|addContiguousBlock (BlockInfoContiguous newblock)
specifier|private
name|void
name|addContiguousBlock
parameter_list|(
name|BlockInfoContiguous
name|newblock
parameter_list|)
...
block|}
block|}
comment|/** add a striped or contiguous block */
...
DECL|method|setContiguousBlocks (BlockInfoContiguous[] blocks)
specifier|public
name|void
name|setContiguousBlocks
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// In case of contiguous blocks
if|if
condition|(
name|blockInfos
operator|==
...
block|{
return|return
name|storagespaceConsumedWithReplication
argument_list|(
name|bsp
argument_list|)
return|;
block|}
block|}
DECL|method|storagespaceConsumedWithStriped ( BlockStoragePolicy bsp)
specifier|public
specifier|final
name|QuotaCounts
name|storagespaceConsumedWithStriped
...
return|;
block|}
DECL|method|storagespaceConsumedWithReplication ( BlockStoragePolicy bsp)
specifier|public
specifier|final
name|QuotaCounts
name|storagespaceConsumedWithReplication
...
DECL|method|collectBlocksBeyondMax (final long max, final BlocksMapUpdateInfo collectedBlocks)
specifier|public
name|long
...
return|;
block|}
comment|/**    * compute the quota usage change for a truncate op    * @param newLength the length for truncation    **/
...
block|}
block|}
DECL|method|truncateContiguousBlocks (int n)
specifier|private
name|void
name|truncateContiguousBlocks
parameter_list|(
...
DECL|method|excludeSnapshotBlocks (int snapshotId, BlocksMapUpdateInfo collectedBlocks)
name|void
