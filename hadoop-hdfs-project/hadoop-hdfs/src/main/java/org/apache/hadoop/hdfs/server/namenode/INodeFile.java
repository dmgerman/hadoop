...
return|;
block|}
comment|/**    * compute the quota usage change for a truncate op    * @param newLength the length for truncation    * @return the quota usage delta (not considering replication factor)    */
DECL|method|computeQuotaDeltaForTruncate (final long newLength)
name|long
