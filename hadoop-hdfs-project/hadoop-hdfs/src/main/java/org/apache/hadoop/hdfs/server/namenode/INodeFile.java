...
DECL|method|getBlockLayoutRedundancy (final BlockType blockType, final Short replication, final Byte erasureCodingPolicyID)
specifier|static
name|long
...
name|BLOCK_TYPE_MASK_STRIPED
expr_stmt|;
comment|// Following bitwise OR with signed byte erasureCodingPolicyID is safe
comment|// as the PolicyID can never be in negative.
name|layoutRedundancy
operator||=
name|erasureCodingPolicyID
expr_stmt|;
