...
argument_list|)
decl_stmt|;
comment|/**    * Check the first block to see if two INodes are about the same file    */
DECL|method|isOfSameFile (INodeFile file1, INodeFile file2)
specifier|public
specifier|static
name|boolean
name|isOfSameFile
...
argument_list|()
decl_stmt|;
comment|// next link pointing to itself is equivalent to no link
if|if
condition|(
name|withSnapshot
operator|.
