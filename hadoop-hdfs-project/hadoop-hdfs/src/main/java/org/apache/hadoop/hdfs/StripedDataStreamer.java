...
name|IOException
argument_list|(
literal|"Failed to get datablocks number of nodes from namenode: blockGroupSize= "
operator|+
operator|(
name|HdfsConstants
operator|.
...
block|}
block|}
comment|//streamer i just have polled the block, sleep and retry.
name|sleep
argument_list|(
literal|100
argument_list|,
