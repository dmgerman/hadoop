...
return|;
block|}
comment|/**    * Generate other blocks in a block group according to the first one.    *    * @param firstBlockInGroup the first block in a block group    * @return  other blocks in this group    */
DECL|method|unwrapBlockGroup ( final LocatedBlock firstBlockInGroup)
specifier|public
specifier|static
name|LocatedBlock
index|[]
...
control|)
block|{
comment|//each block in a group has the same number of bytes and timestamp
name|ExtendedBlock
name|extendedBlock
init|=
operator|new
