...
return|;
block|}
comment|/**    * Check whether the given storage directories already exist.    * If running in interactive mode, will prompt the user for each    * directory to allow them to format anyway. Otherwise, returns    * false, unless 'force' is specified.    *     * @param dirsToFormat the dirs to check    * @param force format regardless of whether dirs exist    * @param interactive prompt the user when a dir exists    * @return true if formatting should proceed    * @throws IOException    */
DECL|method|confirmFormat (Collection<URI> dirsToFormat, boolean force, boolean interactive)
specifier|public
specifier|static
name|boolean
name|confirmFormat
...
name|println
argument_list|(
literal|"Storage directory exists in "
operator|+
name|curDir
operator|+
...
name|println
argument_list|(
literal|"Running in non-interactive mode, and image appears to exist in "
operator|+
name|curDir
operator|+
...
return|;
block|}
comment|/**    * Format a new shared edits dir.    *     * @param conf configuration    * @param force format regardless of whether or not the shared edits dir exists    * @param interactive prompt the user when a dir exists    * @return true if the command aborts, false otherwise    */
...
name|error
argument_list|(
literal|"Could not format shared edits dir"
argument_list|,
name|e
argument_list|)
expr_stmt|;
