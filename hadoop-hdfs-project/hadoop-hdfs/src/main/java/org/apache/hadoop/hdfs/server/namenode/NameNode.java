...
DECL|method|makeMetricsLoggerAsync ()
specifier|private
specifier|static
name|void
name|makeMetricsLoggerAsync
...
name|warn
argument_list|(
literal|"Metrics logging will not be async since the logger is not log4j"
argument_list|)
expr_stmt|;
return|return;
block|}
...
argument_list|)
expr_stmt|;
comment|// Don't pollute NN logs with metrics dump
annotation|@
...
name|Runnable
block|{
DECL|field|MAX_LOGGED_VALUE_LEN
specifier|private
specifier|static
specifier|final
name|int
name|MAX_LOGGED_VALUE_LEN
init|=
literal|128
decl_stmt|;
...
block|}
block|}
comment|/**      * Write NameNode metrics to the metrics appender when invoked.      */
annotation|@
name|Override
DECL|method|run ()
specifier|public
...
name|info
argument_list|(
literal|">> Begin NameNode metrics dump"
argument_list|)
expr_stmt|;
specifier|final
name|MBeanServer
...
name|error
argument_list|(
literal|"Failed to get NameNode metrics for mbean "
operator|+
name|mbeanName
operator|.
name|toString
...
name|info
argument_list|(
literal|"<< End NameNode metrics dump"
argument_list|)
expr_stmt|;
block|}
