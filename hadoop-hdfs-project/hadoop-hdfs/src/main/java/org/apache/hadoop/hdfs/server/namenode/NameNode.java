...
name|println
argument_list|(
literal|"Skipping format for directory \""
operator|+
name|dirUri
operator|+
literal|"\". Can only format local directories with scheme \""
operator|+
name|NNStorage
operator|.
name|LOCAL_URI_SCHEME
...
continue|continue;
block|}
comment|// To validate only file based schemes are formatted
assert|assert
name|dirUri
operator|.
name|getScheme
...
argument_list|)
operator|:
literal|"formatting is not supported for "
operator|+
name|dirUri
assert|;
name|File
...
name|error
argument_list|(
literal|"Cannot populate shared edits dir from non-file "
operator|+
literal|"journal manager: "
operator|+
name|jas
operator|.
name|getManager
