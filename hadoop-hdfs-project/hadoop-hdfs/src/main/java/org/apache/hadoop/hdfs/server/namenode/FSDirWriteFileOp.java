...
DECL|method|startFile ( FSNamesystem fsn, FSPermissionChecker pc, String src, PermissionStatus permissions, String holder, String clientMachine, EnumSet<CreateFlag> flag, boolean createParent, short replication, long blockSize, EncryptionKeyInfo ezInfo, INode.BlocksMapUpdateInfo toRemoveBlocks, boolean logRetryEntry)
specifier|static
name|HdfsFileStatus
name|startFile
parameter_list|(
...
return|;
block|}
DECL|method|getEncryptionKeyInfo (FSNamesystem fsn, FSPermissionChecker pc, String src, CryptoProtocolVersion[] supportedVersions)
specifier|static
name|EncryptionKeyInfo
...
try|try
block|{
comment|// check if the file is in an EC zone
specifier|final
name|boolean
name|isStriped
init|=
...
expr_stmt|;
block|}
DECL|method|setNewINodeStoragePolicy (BlockManager bm, INodeFile inode, INodesInPath iip, boolean isLazyPersist)
specifier|private
specifier|static
name|void
name|setNewINodeStoragePolicy
...
name|edek
decl_stmt|;
DECL|method|EncryptionKeyInfo ( CryptoProtocolVersion protocolVersion, CipherSuite suite, String ezKeyName)
name|EncryptionKeyInfo
parameter_list|(
name|CryptoProtocolVersion
name|protocolVersion
