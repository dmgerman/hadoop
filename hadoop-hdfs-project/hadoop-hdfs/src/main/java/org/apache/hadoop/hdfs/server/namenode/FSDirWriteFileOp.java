...
operator|)
decl_stmt|;
comment|// If client locality is ignored, clientNode remains 'null' to indicate
if|if
condition|(
operator|!
name|ignoreClientLocality
...
name|format
argument_list|(
literal|"Cannot find erasure coding policy for new file %s/%s, "
operator|+
literal|"ecPolicyID=%d"
argument_list|,
name|existing
operator|.
name|getPath
...
DECL|method|addFile ( FSDirectory fsd, INodesInPath existing, byte[] localName, PermissionStatus permissions, short replication, long preferredBlockSize, String clientName, String clientMachine, boolean shouldReplicate, String ecPolicyName, String storagePolicy)
specifier|private
specifier|static
name|INodesInPath
name|addFile
