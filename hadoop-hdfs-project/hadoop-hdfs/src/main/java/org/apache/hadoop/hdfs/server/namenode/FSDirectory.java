...
DECL|method|createFileStatus (byte[] path, INode node, boolean needLocation, byte storagePolicy, int snapshot, boolean isRawPath)
specifier|private
name|HdfsFileStatus
name|createFileStatus
parameter_list|(
...
DECL|method|createFileStatus (byte[] path, INode node, byte storagePolicy, int snapshot, boolean isRawPath)
name|HdfsFileStatus
name|createFileStatus
parameter_list|(
name|byte
...
return|;
block|}
DECL|method|getStoragePolicy (INode[] inodes, int snapshotId)
specifier|private
name|byte
name|getStoragePolicy
parameter_list|(
...
DECL|method|createLocatedFileStatus (byte[] path, INode node, byte storagePolicy, int snapshot, boolean isRawPath)
specifier|private
name|HdfsLocatedFileStatus
name|createLocatedFileStatus
parameter_list|(
