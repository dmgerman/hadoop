...
return|;
block|}
name|checkEncryptionZoneMoveValidity
argument_list|(
name|src
argument_list|,
name|dst
...
throw|;
block|}
DECL|method|checkEncryptionZoneMoveValidity (String src, String dst)
specifier|private
name|void
name|checkEncryptionZoneMoveValidity
parameter_list|(
...
block|}
block|}
comment|/**    * Return the FileEncryptionInfo for an INode, or null if the INode is not    * an encrypted file.    */
DECL|method|getFileEncryptionInfo (INode inode, int snapshotId)
name|FileEncryptionInfo
name|getFileEncryptionInfo
parameter_list|(
name|INode
