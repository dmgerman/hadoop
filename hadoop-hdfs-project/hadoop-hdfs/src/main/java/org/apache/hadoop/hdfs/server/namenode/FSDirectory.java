...
return|;
block|}
comment|/** Add an INodeFileSnapshot to the source file. */
DECL|method|addFileSnapshot (String srcPath, String dstPath )
name|INodeFileSnapshot
name|addFileSnapshot
parameter_list|(
name|String
name|srcPath
parameter_list|,
...
try|try
block|{
comment|//add destination snaplink
name|snapshot
operator|=
name|addNode
argument_list|(
...
name|info
argument_list|(
literal|"DIR* FSDirectory.addFileSnapshot: failed to add "
operator|+
name|dstPath
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"DIR* FSDirectory.addFileSnapshot: "
operator|+
name|dstPath
operator|+
literal|" is added to the file system"
