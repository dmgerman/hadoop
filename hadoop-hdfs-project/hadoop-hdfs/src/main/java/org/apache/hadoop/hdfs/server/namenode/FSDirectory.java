...
argument_list|()
decl_stmt|;
comment|// This method cannot toggle the ACL bit.
if|if
condition|(
name|oldPerm
operator|.
...
name|inode
init|=
name|resolveINodeWithAdditionalFields
argument_list|(
name|src
argument_list|,
name|iip
...
block|}
block|}
DECL|method|resolveINodeWithAdditionalFields ( String src, INodesInPath iip)
specifier|private
specifier|static
name|INodeWithAdditionalFields
name|resolveINodeWithAdditionalFields
