...
DECL|method|unprotectedDelete (INode[] inodes, List<Block> collectedBlocks, long mtime)
name|int
name|unprotectedDelete
parameter_list|(
name|INode
...
return|;
block|}
comment|/**    * Check if the given INode (or one of its descendants) is snapshottable and    * already has snapshots.    *     * @param target The given INode    * @return The INode which is snapshottable and already has snapshots.    */
DECL|method|hasSnapshot (INode target)
specifier|private
specifier|static
name|INode
name|hasSnapshot
