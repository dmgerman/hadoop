...
DECL|method|resolvePath (FSPermissionChecker pc, String path)
name|String
name|resolvePath
parameter_list|(
...
block|}
block|}
comment|// this double conversion will be unnecessary when resolving returns
comment|// INodesInPath (needs components byte[][])
return|return
name|DFSUtil
operator|.
