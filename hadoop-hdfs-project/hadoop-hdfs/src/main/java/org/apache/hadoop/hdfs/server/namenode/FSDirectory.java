...
DECL|method|createFileStatus (byte[] path, INode node, boolean needLocation, byte storagePolicy, int snapshot)
specifier|private
name|HdfsFileStatus
name|createFileStatus
parameter_list|(
...
DECL|method|createFileStatus (byte[] path, INode node, byte storagePolicy, int snapshot)
name|HdfsFileStatus
name|createFileStatus
parameter_list|(
name|byte
...
DECL|method|createLocatedFileStatus (byte[] path, INode node, byte storagePolicy, int snapshot)
specifier|private
name|HdfsLocatedFileStatus
name|createLocatedFileStatus
parameter_list|(
