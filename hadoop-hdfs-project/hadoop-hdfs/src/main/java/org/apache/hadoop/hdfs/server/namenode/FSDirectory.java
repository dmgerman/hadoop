...
block|}
block|}
DECL|method|unprotectedReplaceINode (String path, INode oldnode, INode newnode, Snapshot latest)
specifier|private
name|void
...
expr_stmt|;
block|}
DECL|method|unprotectedReplaceINodeFile (String path, INodeFile oldnode, INodeFile newnode, Snapshot latest )
name|void
name|unprotectedReplaceINodeFile
parameter_list|(
name|String
