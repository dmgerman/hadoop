...
return|;
block|}
comment|/**    * Set cache replication for a file    *     * @param src file name    * @param replication new replication    * @param blockRepls block replications - output parameter    * @return array of file blocks    * @throws QuotaExceededException    * @throws SnapshotAccessControlException    */
DECL|method|setCacheReplication (String src, short replication, short[] blockRepls)
name|Block
index|[]
...
block|{
return|return
name|unprotectedSetCacheReplication
argument_list|(
name|src
argument_list|,
name|replication
...
block|}
block|}
DECL|method|unprotectedSetCacheReplication (String src, short replication, short[] blockRepls)
name|Block
index|[]
name|unprotectedSetCacheReplication
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// TODO: Update quotas here as repl goes up or down
name|file
operator|.
name|setCacheReplication
argument_list|(
