...
block|}
comment|/**    */
DECL|method|unprotectedAddFile ( String path, PermissionStatus permissions, BlockInfo[] blocks, short replication, long modificationTime, long atime, long preferredBlockSize, String clientName, String clientMachine)
name|INode
...
comment|// First complete last old Block
name|getBlockManager
argument_list|()
operator|.
name|completeBlock
