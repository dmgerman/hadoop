...
throw|;
block|}
comment|/** The renamed inode is also in a snapshot, create references */
DECL|method|createReferences4Rename (final INode srcChild, final byte[] srcChildName, final INodeDirectoryWithSnapshot srcParent, final INodeDirectory dstParent)
specifier|private
specifier|static
name|void
name|createReferences4Rename
...
return|;
block|}
comment|/**    * For a given inode, get its relative path from its ancestor.    * @param inode The given inode.    * @param ancestor An ancestor inode of the given inode.    * @return The relative path name represented in an array of byte array.    */
DECL|method|getRelativePathNameBytes (INode inode, INode ancestor)
specifier|static
name|byte
index|[]
index|[]
...
expr_stmt|;
block|}
comment|/**    * Verify that filesystem limit constraints are not violated    */
DECL|method|verifyFsLimits (INode[] pathComponents, int pos, INode child)
name|void
name|verifyFsLimits
parameter_list|(
name|INode
...
DECL|method|verifyMaxComponentLength (String childName, Object parentPath, int pos)
specifier|public
name|void
name|verifyMaxComponentLength
parameter_list|(
...
name|error
argument_list|(
literal|"FSDirectory.verifyMaxComponentLength: "
operator|+
name|e
operator|.
