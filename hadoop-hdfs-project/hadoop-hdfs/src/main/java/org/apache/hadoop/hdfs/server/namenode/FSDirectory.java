...
return|;
block|}
DECL|method|resolvePathForWrite (FSPermissionChecker pc, String src)
name|INodesInPath
...
return|;
block|}
DECL|method|resolvePathForWrite (FSPermissionChecker pc, String src, boolean resolveLink)
name|INodesInPath
name|resolvePathForWrite
parameter_list|(
name|FSPermissionChecker
