...
block|}
block|}
DECL|method|getLatestKeyVersion (INodesInPath iip)
name|KeyVersion
...
name|IOException
block|{
comment|// No locking, this operation does not involve any FSDirectory operations
return|return
name|ezManager
operator|.
name|updateLatestKeyVersion
...
return|;
block|}
DECL|method|isValidKeyVersion (INodesInPath iip, String keyVersionName)
name|boolean
