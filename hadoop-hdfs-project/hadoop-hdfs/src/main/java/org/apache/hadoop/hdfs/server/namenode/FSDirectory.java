...
return|;
block|}
comment|/**    * Returns an inode's FsPermission for use in an outbound FileStatus.  If the    * inode has an ACL, then this method will convert to a FsAclPermission.    *    * @param node INode to check    * @param snapshot int snapshot ID    * @return FsPermission from inode, with ACL bit on if the inode has an ACL    */
DECL|method|getPermissionForFileStatus (INode node, int snapshot)
specifier|private
specifier|static
name|FsPermission
name|getPermissionForFileStatus
...
block|}
block|}
DECL|method|unprotectedRemoveXAttr (String src, XAttr xAttr)
name|XAttr
name|unprotectedRemoveXAttr
parameter_list|(
name|String
...
return|;
block|}
DECL|method|filterINodeXAttr (List<XAttr> existingXAttrs, XAttr xAttr)
name|List
argument_list|<
name|XAttr
argument_list|>
...
name|IOException
argument_list|(
literal|"Attempt to delete an encryption zone for a non-empty directory."
argument_list|)
throw|;
block|}
specifier|final
...
name|src
operator|+
literal|" does not appear to be the root of an encryption zone"
argument_list|)
throw|;
block|}
return|return
...
block|}
block|}
DECL|method|unprotectedSetXAttr (String src, XAttr xAttr, EnumSet<XAttrSetFlag> flag)
name|void
name|unprotectedSetXAttr
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|setINodeXAttr (List<XAttr> existingXAttrs, XAttr xAttr, EnumSet<XAttrSetFlag> flag)
name|List
argument_list|<
name|XAttr
argument_list|>
...
return|;
block|}
comment|/**    * The same functionality with {@link #getPathComponents(INode)}, but can    * handle snapshots.    */
DECL|method|getPathComponentsWithSnapshot (INode inode)
specifier|public
specifier|static
name|byte
index|[]
...
condition|)
block|{
comment|// identify the corresponding WithName or DstReference node
name|inode
operator|=
operator|(
operator|(
...
block|{
comment|// normal INode and WithName/DstReference
if|if
condition|(
name|inode
operator|instanceof
...
argument_list|)
expr_stmt|;
comment|// the snapshot has been found, thus no need to check snapshottable
comment|// directory afterwards
name|inSnapshot
operator|=
literal|false
expr_stmt|;
