...
expr_stmt|;
block|}
comment|/**    * Remove the SPS xattr from the inode, retrieve the inode from the    * block collection id.    * @param id    *           - file block collection id.    */
DECL|method|removeSPSXattr (long id)
specifier|public
name|void
name|removeSPSXattr
parameter_list|(
