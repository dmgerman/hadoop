...
DECL|method|createFileStatus (byte[] path, INode node, boolean needLocation, int snapshot, boolean isRawPath)
specifier|private
name|HdfsFileStatus
name|createFileStatus
parameter_list|(
...
DECL|method|createFileStatus (byte[] path, INode node, int snapshot, boolean isRawPath)
name|HdfsFileStatus
name|createFileStatus
parameter_list|(
name|byte
...
DECL|method|createLocatedFileStatus (byte[] path, INode node, int snapshot, boolean isRawPath)
specifier|private
name|HdfsLocatedFileStatus
name|createLocatedFileStatus
parameter_list|(
