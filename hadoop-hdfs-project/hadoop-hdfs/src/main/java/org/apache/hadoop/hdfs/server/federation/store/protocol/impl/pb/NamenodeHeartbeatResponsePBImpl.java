...
operator|.
name|NamenodeHeartbeatResponseProto
import|;
end_import
...
name|HdfsServerFederationProtos
operator|.
name|NamenodeHeartbeatResponseProtoOrBuilder
import|;
end_import
...
begin_comment
comment|/**  * Protobuf implementation of the state store API object  * NamenodeHeartbeatResponse.  */
end_comment

begin_class
DECL|class|NamenodeHeartbeatResponsePBImpl
specifier|public
class|class
name|NamenodeHeartbeatResponsePBImpl
extends|extends
name|NamenodeHeartbeatResponse
...
argument_list|)
decl_stmt|;
DECL|method|NamenodeHeartbeatResponsePBImpl ()
specifier|public
name|NamenodeHeartbeatResponsePBImpl
parameter_list|()
block|{   }
