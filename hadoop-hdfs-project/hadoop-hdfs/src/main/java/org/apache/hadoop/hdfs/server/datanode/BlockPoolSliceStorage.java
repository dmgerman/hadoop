...
expr_stmt|;
block|}
comment|/**    * Load one storage directory. Recover from previous transitions if required.    *    * @param datanode datanode instance    * @param nsInfo namespace information    * @param dataDir the root path of the storage directory    * @param startOpt startup option    * @return the StorageDirectory successfully loaded.    * @throws IOException    */
...
DECL|method|loadBpStorageDirectories ( DataNode datanode, NamespaceInfo nsInfo, Collection<File> dataDirs, StartupOption startOpt)
name|List
argument_list|<
name|StorageDirectory
argument_list|>
