...
DECL|method|FsDatasetAsyncDiskService (DataNode datanode)
name|FsDatasetAsyncDiskService
parameter_list|(
name|DataNode
name|datanode
...
DECL|method|deleteAsync (FsVolumeReference volumeRef, File blockFile, File metaFile, ExtendedBlock block, String trashDirectory)
name|void
name|deleteAsync
parameter_list|(
name|FsVolumeReference
...
name|trashDirectory
decl_stmt|;
DECL|method|ReplicaFileDeleteTask (FsVolumeReference volumeRef, File blockFile, File metaFile, ExtendedBlock block, String trashDirectory)
name|ReplicaFileDeleteTask
parameter_list|(
name|FsVolumeReference
name|volumeRef
