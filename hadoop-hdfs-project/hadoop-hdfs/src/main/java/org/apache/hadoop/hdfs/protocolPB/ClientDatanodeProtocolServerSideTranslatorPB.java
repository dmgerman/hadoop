...
annotation|@
name|Override
DECL|method|getHdfsBlockLocations ( RpcController controller, GetHdfsBlockLocationsRequestProto request)
specifier|public
name|GetHdfsBlockLocationsResponseProto
...
try|try
block|{
comment|// Construct the Lists to make the actual call
name|List
argument_list|<
name|ExtendedBlock
argument_list|>
...
expr_stmt|;
block|}
comment|// Call the real implementation
name|resp
operator|=
name|impl
operator|.
...
expr_stmt|;
block|}
comment|// Build and return the response
name|Builder
name|builder
init|=
name|GetHdfsBlockLocationsResponseProto
