...
return|;
block|}
DECL|method|searchChildrenForExistingINode (INode inode)
specifier|public
name|int
...
return|;
block|}
DECL|method|removeChild (INode node, Snapshot latestSnapshot)
specifier|public
name|INode
name|removeChild
parameter_list|(
...
return|;
block|}
comment|// find the old child and replace it
specifier|final
name|int
name|low
init|=
...
argument_list|)
decl_stmt|;
comment|// set the parent of the children of the child.
for|for
control|(
name|INode
name|i
...
DECL|method|addChild (final INode node, final boolean setModTime, Snapshot latestSnapshot)
specifier|public
name|boolean
name|addChild
parameter_list|(
...
return|;
block|}
DECL|method|getParentINodesInPath (byte[][] pathComponents )
name|INodesInPath
name|getParentINodesInPath
parameter_list|(
name|byte
