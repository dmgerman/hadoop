...
return|;
block|}
DECL|method|addDirectoryWithQuotaFeature ( long nsQuota, long dsQuota)
name|DirectoryWithQuotaFeature
name|addDirectoryWithQuotaFeature
parameter_list|(
name|long
...
return|;
block|}
comment|/**     * Replace the given child with a new child. Note that we no longer need to    * replace an normal INodeDirectory or INodeFile into an    * INodeDirectoryWithSnapshot or INodeFileUnderConstruction. The only cases    * for child replacement is for {@link INodeDirectorySnapshottable} and     * reference nodes.    */
...
block|}
block|}
DECL|method|computeDirectoryQuotaUsage (Quota.Counts counts, boolean useCache, int lastSnapshotId)
specifier|private
name|Quota
operator|.
name|Counts
