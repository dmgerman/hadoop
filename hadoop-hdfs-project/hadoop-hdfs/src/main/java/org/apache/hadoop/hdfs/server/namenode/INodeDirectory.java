...
return|;
block|}
comment|/**    * Check if this directory is a descendant directory    * of a snapshot root directory.    * @param snapshotRootDir the snapshot root directory    * @return true if this directory is a descendant of snapshot root    */
DECL|method|isDescendantOfSnapshotRoot (INodeDirectory snapshotRootDir)
specifier|public
name|boolean
...
return|;
block|}
comment|/**    * During image loading, the search is unnecessary since the insert position    * should always be at the end of the map given the sequence they are    * serialized on disk.    */
DECL|method|addChildAtLoading (INode node)
specifier|public
name|boolean
