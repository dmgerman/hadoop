...
return|;
block|}
comment|/** @return the INodeFile corresponding to the path. */
DECL|method|getINodeFile (String path)
name|INodeFile
name|getINodeFile
parameter_list|(
name|String
