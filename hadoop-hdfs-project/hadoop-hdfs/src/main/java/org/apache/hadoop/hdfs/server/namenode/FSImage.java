...
argument_list|()
decl_stmt|;
comment|// Plan our load. This will throw if it's impossible to load from the
comment|// data that's available.
name|LoadPlan
name|loadPlan
init|=
name|inspector
...
name|debug
argument_list|(
literal|"Planning to load image using following plan:\n"
operator|+
name|loadPlan
argument_list|)
expr_stmt|;
...
DECL|method|loadEdits (List<File> editLogs)
specifier|protected
name|long
name|loadEdits
parameter_list|(
