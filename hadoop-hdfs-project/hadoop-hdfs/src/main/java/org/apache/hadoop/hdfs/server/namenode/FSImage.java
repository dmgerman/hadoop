...
parameter_list|)
block|{
comment|// The stack is not needed since we could use the 'parent' field in INode.
comment|// However, using 'parent' is not recommended.
name|stack
operator|.
name|push
argument_list|(
