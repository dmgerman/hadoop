...
DECL|field|blockReaderOffsets
specifier|private
specifier|final
name|long
index|[]
name|blockReaderOffsets
decl_stmt|;
...
argument_list|)
decl_stmt|;
comment|// TODO handle null elements in blks (e.g., NN does not know locations for
comment|// all the internal blocks)
specifier|final
name|LocatedBlock
index|[]
name|blks
...
name|service
decl_stmt|;
DECL|method|StripeReader (CompletionService<Void> service, AlignedStripe alignedStripe)
name|StripeReader
parameter_list|(
name|CompletionService
argument_list|<
...
expr_stmt|;
block|}
comment|/** submit reading chunk task */
DECL|method|readChunk (final CompletionService<Void> service, final LocatedBlock block, int chunkIndex, Map<ExtendedBlock, Set<DatanodeInfo>> corruptedBlockMap)
specifier|abstract
name|void
name|readChunk
parameter_list|(
...
parameter_list|)
function_decl|;
comment|/**      * When seeing first missing block, initialize decode input buffers.      * Also prepare the reading for data blocks outside of the reading range.      */
...
name|IOException
function_decl|;
comment|/**      * Prepare reading for one more parity chunk.      */
DECL|method|prepareParityChunk ()
specifier|abstract
name|void
...
DECL|method|readStripe (LocatedBlock[] blocks, Map<ExtendedBlock, Set<DatanodeInfo>> corruptedBlockMap)
name|void
name|readStripe
parameter_list|(
name|LocatedBlock
...
literal|null
decl_stmt|;
DECL|method|PositionStripeReader (CompletionService<Void> service, AlignedStripe alignedStripe)
name|PositionStripeReader
parameter_list|(
name|CompletionService
argument_list|<
...
name|targetBlocks
decl_stmt|;
DECL|method|StatefulStripeReader (CompletionService<Void> service, AlignedStripe alignedStripe, LocatedBlock[] targetBlocks)
name|StatefulStripeReader
parameter_list|(
name|CompletionService
argument_list|<
...
parameter_list|()
block|{
comment|// TODO no copy for data chunks. this depends on HADOOP-12047 for some
comment|// decoders to work
specifier|final
name|int
name|span
init|=
