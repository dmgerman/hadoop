...
return|;
block|}
comment|/**    * BlockInfo represents a block that is not being constructed.    * In order to start modifying the block, the BlockInfo should be converted    * to {@link BlockInfoContiguousUnderConstruction}.    * @return {@link HdfsServerConstants.BlockUCState#COMPLETE}    */
