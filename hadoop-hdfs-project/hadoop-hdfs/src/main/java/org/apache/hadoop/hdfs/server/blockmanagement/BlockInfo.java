...
expr_stmt|;
block|}
DECL|method|copyOf (BlockInfo b)
specifier|static
name|BlockInfo
name|copyOf
parameter_list|(
...
block|}
block|}
DECL|method|convertToCompleteBlock (BlockInfo blk)
specifier|static
name|BlockInfo
...
block|}
block|}
DECL|method|commitBlock (BlockInfo blockInfo, Block reported)
specifier|static
name|void
name|commitBlock
parameter_list|(
...
block|}
block|}
DECL|method|addReplica (BlockInfo ucBlock, DatanodeStorageInfo storageInfo, Block reportedBlock, HdfsServerConstants.ReplicaState reportedState)
specifier|static
name|void
name|addReplica
parameter_list|(
...
block|}
block|}
DECL|method|getNumExpectedLocations (BlockInfo ucBlock)
specifier|static
name|int
...
block|}
block|}
DECL|method|getExpectedStorageLocations ( BlockInfo ucBlock)
specifier|public
specifier|static
name|DatanodeStorageInfo
index|[]
...
block|}
block|}
DECL|method|setExpectedLocations (BlockInfo ucBlock, DatanodeStorageInfo[] targets)
specifier|public
specifier|static
name|void
...
block|}
block|}
DECL|method|getBlockRecoveryId (BlockInfo ucBlock)
specifier|public
specifier|static
name|long
