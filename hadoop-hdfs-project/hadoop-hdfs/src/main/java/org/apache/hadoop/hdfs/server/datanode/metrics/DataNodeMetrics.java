...
name|Metric
argument_list|(
literal|"Milliseconds spent on calling NN rpc"
argument_list|)
specifier|private
name|MutableRatesWithAggregation
DECL|field|nnRpcLatency
name|nnRpcLatency
init|=
name|registry
operator|.
...
literal|null
decl_stmt|;
DECL|field|dnUsageReportUtil
specifier|private
name|DataNodeUsageReportUtil
name|dnUsageReportUtil
decl_stmt|;
...
return|;
block|}
DECL|method|addHeartbeat (long latency, String rpcMetricSuffix)
specifier|public
name|void
name|addHeartbeat
parameter_list|(
...
block|}
block|}
DECL|method|addHeartbeatTotal (long latency, String rpcMetricSuffix)
specifier|public
name|void
...
block|}
block|}
DECL|method|addLifeline (long latency, String rpcMetricSuffix)
specifier|public
name|void
name|addLifeline
parameter_list|(
...
block|}
block|}
DECL|method|addBlockReport (long latency, String rpcMetricSuffix)
specifier|public
name|void
name|addBlockReport
parameter_list|(
...
block|}
block|}
DECL|method|addIncrementalBlockReport (long latency, String rpcMetricSuffix)
specifier|public
name|void
...
name|add
argument_list|(
literal|"IncrementalBlockReportsFor"
operator|+
name|rpcMetricSuffix
argument_list|,
name|latency
...
expr_stmt|;
block|}
DECL|method|getDNUsageReport (long timeSinceLastReport)
specifier|public
name|DataNodeUsageReport
name|getDNUsageReport
parameter_list|(
name|long
