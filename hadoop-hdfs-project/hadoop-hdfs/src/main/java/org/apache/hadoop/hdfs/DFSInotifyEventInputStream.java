...
literal|10
decl_stmt|;
DECL|method|DFSInotifyEventInputStream (ClientProtocol namenode)
name|DFSInotifyEventInputStream
parameter_list|(
name|ClientProtocol
name|namenode
...
argument_list|)
expr_stmt|;
comment|// only consider new txn's
block|}
DECL|method|DFSInotifyEventInputStream (ClientProtocol namenode, long lastReadTxid)
name|DFSInotifyEventInputStream
parameter_list|(
name|ClientProtocol
name|namenode
