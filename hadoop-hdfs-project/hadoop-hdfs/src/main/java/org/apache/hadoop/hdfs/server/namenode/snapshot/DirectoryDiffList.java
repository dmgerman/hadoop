...
expr_stmt|;
block|}
DECL|method|createSkipList (int capacity, int interval, int skipLevel)
specifier|public
specifier|static
name|DirectoryDiffList
name|createSkipList
...
return|;
block|}
comment|/**    * This function returns the minimal set of diffs required to combine in    * order to generate all the changes occurred between fromIndex and    * toIndex.    *    * @param fromIndex index from where the summation has to start    * @param toIndex   index till where the summation has to end    * @return list of Directory Diff    */
annotation|@
name|Override
