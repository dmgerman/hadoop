...
annotation|@
name|VisibleForTesting
DECL|method|chooseSourceDatanodes (BlockInfo block, List<DatanodeDescriptor> containingNodes, List<DatanodeStorageInfo> nodesContainingLiveReplicas, NumberReplicas numReplicas, List<Short> missingBlockIndices, int numSourceNodes, int priority)
name|DatanodeDescriptor
index|[]
name|chooseSourceDatanodes
parameter_list|(
...
name|BlockToMarkCorrupt
block|{
comment|/**      * The corrupted block in a datanode. This is the one reported by the      * datanode.      */
...
name|reasonCode
decl_stmt|;
DECL|method|BlockToMarkCorrupt (Block corrupted, BlockInfo stored, String reason, Reason reasonCode)
name|BlockToMarkCorrupt
parameter_list|(
name|Block
name|corrupted
...
expr_stmt|;
block|}
DECL|method|BlockToMarkCorrupt (Block corrupted, BlockInfo stored, long gs, String reason, Reason reasonCode)
name|BlockToMarkCorrupt
parameter_list|(
name|Block
name|corrupted
...
block|}
block|}
DECL|method|reportDiff (DatanodeStorageInfo storageInfo, BlockListAsLongs newReport, Collection<BlockInfoToAdd> toAdd, Collection<BlockInfo> toRemove, Collection<Block> toInvalidate, Collection<BlockToMarkCorrupt> toCorrupt, Collection<StatefulBlockInfo> toUC)
specifier|private
name|void
name|reportDiff
parameter_list|(
...
DECL|method|chooseExcessReplicates (final Collection<DatanodeStorageInfo> nonExcess, BlockInfo storedBlock, short replication, DatanodeDescriptor addedNode, DatanodeDescriptor delNodeHint, BlockPlacementPolicy replicator)
specifier|private
name|void
name|chooseExcessReplicates
parameter_list|(
...
block|}
block|}
DECL|method|addToExcessReplicate (DatanodeInfo dn, BlockInfo storedBlock)
specifier|private
name|void
name|addToExcessReplicate
parameter_list|(
...
return|;
block|}
comment|// TODO: update the enough rack logic for striped blocks
...
return|;
block|}
comment|/**    * This class is used internally by {@link this#computeRecoveryWorkForBlocks}    * to represent a task to recover a block through replication or erasure    * coding. Recovery is done by transferring data from srcNodes to targets    */
...
name|BlockRecoveryWork
block|{
DECL|field|missingBlockIndicies
specifier|private
name|short
index|[]
...
literal|null
decl_stmt|;
DECL|method|ErasureCodingWork (BlockInfo block, BlockCollection bc, DatanodeDescriptor[] srcNodes, List<DatanodeDescriptor> containingNodes, List<DatanodeStorageInfo> liveReplicaStorages, int additionalReplRequired, int priority)
specifier|public
name|ErasureCodingWork
parameter_list|(
name|BlockInfo
...
expr_stmt|;
block|}
DECL|method|getMissingBlockIndicies ()
specifier|public
name|short
index|[]
name|getMissingBlockIndicies
...
return|;
block|}
DECL|method|setMissingBlockIndices (short[] missingBlockIndicies)
specifier|public
name|void
name|setMissingBlockIndices
parameter_list|(
