...
DECL|method|chooseExcessReplicasContiguous (BlockCollection bc, final Collection<DatanodeStorageInfo> nonExcess, BlockInfo storedBlock, short replication, DatanodeDescriptor addedNode, DatanodeDescriptor delNodeHint, List<StorageType> excessTypes)
specifier|private
name|void
name|chooseExcessReplicasContiguous
parameter_list|(
...
DECL|method|chooseExcessReplicasStriped (BlockCollection bc, final Collection<DatanodeStorageInfo> nonExcess, BlockInfo storedBlock, DatanodeDescriptor delNodeHint, List<StorageType> excessTypes)
specifier|private
name|void
name|chooseExcessReplicasStriped
parameter_list|(
...
block|{
return|return
name|blockHasEnoughRacksStriped
argument_list|(
name|storedBlock
argument_list|,
name|corruptNodes
...
block|{
return|return
name|blockHashEnoughRacksContiguous
argument_list|(
name|storedBlock
argument_list|,
name|expectedStorageNum
...
block|}
block|}
comment|/**    * Verify whether given striped block is distributed through enough racks.    * As dicussed in HDFS-7613, ec file requires racks at least as many as    * the number of data block number.    */
DECL|method|blockHasEnoughRacksStriped (BlockInfo storedBlock, Collection<DatanodeDescriptor> corruptNodes)
name|boolean
name|blockHasEnoughRacksStriped
parameter_list|(
name|BlockInfo
...
return|;
block|}
DECL|method|blockHashEnoughRacksContiguous (BlockInfo storedBlock, int expectedStorageNum, Collection<DatanodeDescriptor> corruptNodes)
name|boolean
name|blockHashEnoughRacksContiguous
parameter_list|(
name|BlockInfo
