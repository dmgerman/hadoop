...
return|;
block|}
comment|/**    * Choose target datanodes according to the replication policy.    *     * @throws IOException    *           if the number of targets< minimum replication.    * @see BlockPlacementPolicy#chooseTarget(String, int, Node,    *      List, boolean, Set, long, StorageType)    */
...
DECL|method|processReport (final DatanodeID nodeID, final DatanodeStorage storage, final BlockListAsLongs newReport)
specifier|public
name|boolean
name|processReport
parameter_list|(
