...
argument_list|)
expr_stmt|;
comment|// notify SPS about the reported block
...
expr_stmt|;
block|}
DECL|method|notifyStorageMovementAttemptFinishedBlk ( DatanodeStorageInfo storageInfo, Block block)
specifier|private
name|void
name|notifyStorageMovementAttemptFinishedBlk
parameter_list|(
...
block|}
block|}
comment|/**    * Check file has low redundancy blocks.    */
DECL|method|hasLowRedundancyBlocks (BlockCollection bc)
specifier|public
name|boolean
...
return|;
block|}
comment|/**    * Check whether file id has low redundancy blocks.    *    * @param inodeID    *          - inode id    */
