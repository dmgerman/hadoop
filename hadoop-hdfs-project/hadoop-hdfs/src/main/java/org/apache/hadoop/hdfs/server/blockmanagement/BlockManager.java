...
block|}
block|}
DECL|method|getStripedDataBlockNum (BlockInfo block)
name|short
name|getStripedDataBlockNum
parameter_list|(
name|BlockInfo
...
condition|)
block|{
comment|// if the sblock is committed/completed and its length is less than a
comment|// full stripe, the minimum storage number needs to be adjusted
name|dataBlockNum
operator|=
operator|(
name|short
