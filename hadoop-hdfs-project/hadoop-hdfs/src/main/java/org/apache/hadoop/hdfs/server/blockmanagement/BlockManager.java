...
return|;
block|}
DECL|method|scheduleReplication (BlockInfo block, int priority)
specifier|private
name|ReplicationWork
name|scheduleReplication
parameter_list|(
...
return|;
block|}
DECL|method|validateReplicationWork (ReplicationWork rw)
specifier|private
name|boolean
name|validateReplicationWork
parameter_list|(
...
DECL|method|markBlockReplicasAsCorrupt (BlockInfo block, long oldGenerationStamp, long oldNumBytes, DatanodeStorageInfo[] newStorages)
specifier|public
name|void
