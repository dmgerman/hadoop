...
return|;
block|}
comment|/**    * Reposition the DB cursor to the user name.    *    * @param iterator - Current Iterator.    * @param userName - userName to seek to    * @return - DBIterator.    * @throws IOException    */
DECL|method|seekToUser (DBIterator iterator, String userName)
name|DBIterator
name|seekToUser
parameter_list|(
name|DBIterator
