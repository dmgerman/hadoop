...
throw|;
block|}
comment|/**    * Check if this CachePool can be accessed.    *    * @param pc    *          Permission checker object with user name and groups.    * @param write    *          True if we care about write access; false otherwise.    * @return    *          True only if the cache pool is accessible.    */
DECL|method|checkPermission (String userName, String groupName, int mode, int mask)
specifier|private
name|boolean
name|checkPermission
parameter_list|(
...
return|;
block|}
DECL|method|checkWritePermission (String userName, String groupName, int mode)
specifier|public
name|boolean
...
return|;
block|}
DECL|method|checkReadPermission (String userName, String groupName, int mode)
specifier|public
name|boolean
