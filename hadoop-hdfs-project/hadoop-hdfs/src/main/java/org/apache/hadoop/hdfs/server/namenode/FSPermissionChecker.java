...
argument_list|)
decl_stmt|;
DECL|method|constructPath (INodeAttributes[] inodes, int end)
specifier|private
specifier|static
name|String
name|constructPath
...
DECL|method|checkOwner (INodeAttributes[] inodes, int i)
specifier|private
name|void
name|checkOwner
parameter_list|(
...
block|}
comment|/** Guarded by {@link FSNamesystem#readLock()} */
DECL|method|checkTraverse (INodeAttributes[] inodeAttrs, int last)
specifier|private
name|void
name|checkTraverse
parameter_list|(
...
block|}
comment|/** Guarded by {@link FSNamesystem#readLock()} */
DECL|method|check (INodeAttributes[] inodes, int i, FsAction access)
specifier|private
name|void
name|check
parameter_list|(
...
block|}
comment|/** Guarded by {@link FSNamesystem#readLock()} */
DECL|method|checkStickyBit (INodeAttributes[] inodes, int index)
specifier|private
name|void
name|checkStickyBit
parameter_list|(
