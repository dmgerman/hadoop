...
DECL|method|toAccessControlString (INodeAttributes inodeAttrib, String path, FsAction access, FsPermission mode)
specifier|private
name|String
...
block|}
comment|/** @return a string for throwing {@link AccessControlException} */
DECL|method|toAccessControlString (INodeAttributes inodeAttrib, String path, FsAction access, FsPermission mode, boolean deniedFromAcl)
specifier|private
name|String
name|toAccessControlString
parameter_list|(
...
DECL|method|checkOwner (INodeAttributes inode )
specifier|private
name|void
name|checkOwner
parameter_list|(
...
block|}
comment|/** Guarded by {@link FSNamesystem#readLock()} */
DECL|method|checkSubAccess (byte[][] pathByNameArr, int pathIdx, INode inode, int snapshotId, FsAction access, boolean ignoreEmptyDir)
specifier|private
name|void
name|checkSubAccess
parameter_list|(
...
block|}
comment|/** Guarded by {@link FSNamesystem#readLock()} */
DECL|method|check (INodeAttributes[] inodes, String path, int i, FsAction access )
specifier|private
name|void
name|check
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|check (INodeAttributes inode, String path, FsAction access )
specifier|private
name|void
name|check
parameter_list|(
...
DECL|method|checkAccessAcl (INodeAttributes inode, String path, FsAction access, FsPermission mode, AclFeature aclFeature)
specifier|private
name|void
name|checkAccessAcl
parameter_list|(
...
block|}
comment|/** Guarded by {@link FSNamesystem#readLock()} */
DECL|method|checkStickyBit (INodeAttributes parent, INodeAttributes inode, String path)
specifier|private
name|void
name|checkStickyBit
parameter_list|(
...
name|format
argument_list|(
literal|"Permission denied by sticky bit: user=%s, path=\"%s\":%s:%s:%s%s, "
operator|+
