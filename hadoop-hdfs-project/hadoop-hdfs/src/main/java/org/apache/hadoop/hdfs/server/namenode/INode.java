...
condition|)
block|{
comment|//not sym link and numBlocks< 0? directory!
name|INodeDirectory
name|dir
init|=
literal|null
...
condition|)
block|{
comment|// print block information
name|String
name|blocksInfo
init|=
operator|(
...
argument_list|()
decl_stmt|;
comment|// An INodeFileWithSnapshot whose next link pointing to itself should be
comment|// equivalent with a normal INodeFile
if|if
condition|(
operator|!
operator|(
