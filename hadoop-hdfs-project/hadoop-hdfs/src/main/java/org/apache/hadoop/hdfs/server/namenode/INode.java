...
expr_stmt|;
block|}
DECL|method|INode (long id, byte[] name, PermissionStatus permissions, long modificationTime, long accessTime)
name|INode
parameter_list|(
name|long
name|id
...
return|;
block|}
comment|/**    * Count subtree content summary with a {@link Content.CountsMap}.    *    * @param countsMap The subtree counts for returning.    * @return The same objects as the counts parameter.    */
