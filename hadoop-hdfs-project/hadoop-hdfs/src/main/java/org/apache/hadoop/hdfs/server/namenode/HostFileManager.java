...
annotation|@
name|VisibleForTesting
DECL|field|dnsResolutionDisabledForTesting
specifier|public
specifier|static
name|boolean
...
return|;
block|}
DECL|method|fromPrefixAndPort (String fileName, String prefix, int port)
specifier|static
name|Entry
name|fromPrefixAndPort
parameter_list|(
name|String
name|fileName
parameter_list|,
...
name|UnknownHostException
argument_list|(
literal|"dns resolution disabled for "
operator|+
literal|"testing"
argument_list|)
throw|;
...
name|setNameFormat
argument_list|(
literal|"HostFileManagerDnsRefresh thread"
argument_list|)
operator|.
name|build
argument_list|()
...
init|)
block|{
comment|// Don't replace an entry set that has already been replaced by
comment|// refresh().
if|if
condition|(
name|includes
...
block|}
block|}
DECL|method|HostFileManager (int dnsResolutionSeconds)
specifier|public
name|HostFileManager
parameter_list|(
name|int
