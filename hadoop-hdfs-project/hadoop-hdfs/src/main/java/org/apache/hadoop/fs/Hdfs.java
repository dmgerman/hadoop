...
operator|)
argument_list|,
literal|"Only one of the Key and IV were found."
argument_list|)
expr_stmt|;
if|if
condition|(
...
condition|)
block|{
comment|/*        * The Key and IV were found. Wrap up the output stream with an encryption        * wrapper.        */
specifier|final
name|CryptoOutputStream
name|cbos
init|=
...
condition|)
block|{
comment|/*        * The Key and IV were found. Wrap up the input stream with an encryption        * wrapper.        */
specifier|final
name|CryptoInputStream
name|cbis
init|=
