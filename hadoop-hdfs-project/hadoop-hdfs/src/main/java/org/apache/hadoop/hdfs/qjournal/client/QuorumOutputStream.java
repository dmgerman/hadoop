...
name|writeTimeoutMs
decl_stmt|;
DECL|field|updateCommittedTxId
specifier|private
specifier|final
name|boolean
name|updateCommittedTxId
decl_stmt|;
DECL|method|QuorumOutputStream (AsyncLoggerSet loggers, long txId, int outputBufferCapacity, int writeTimeoutMs, boolean updateCommittedTxId)
specifier|public
name|QuorumOutputStream
parameter_list|(
name|AsyncLoggerSet
...
argument_list|)
expr_stmt|;
comment|// If we don't have this dummy send, committed TxId might be one-batch
comment|// stale on the Journal Nodes
if|if
condition|(
name|updateCommittedTxId
condition|)
