...
name|info
argument_list|(
literal|"Filter initializers set : "
operator|+
name|initializers
argument_list|)
expr_stmt|;
...
name|AccessControlException
argument_list|(
literal|"Cannot delete/rename non-empty protected directory "
operator|+
name|src
argument_list|)
throw|;
block|}
comment|// Are any descendants of src protected?
comment|// The subSet call returns only the descendants of src since
comment|// {@link Path#SEPARATOR} is "/" and '0' is the next ASCII
comment|// character after '/'.
for|for
control|(
name|String
name|descendant
...
name|AccessControlException
argument_list|(
literal|"Cannot delete/rename non-empty protected subdirectory "
operator|+
name|descendant
argument_list|)
throw|;
...
block|}
block|}
comment|/**    * Generates HdfsFileStatus flags.    * @param isEncrypted Sets HAS_CRYPT    * @param isErasureCoded Sets HAS_EC    * @param isSnapShottable Sets SNAPSHOT_ENABLED    * @param hasAcl Sets HAS_ACL    * @return HdfsFileStatus Flags    */
DECL|method|getFlags ( final boolean isEncrypted, final boolean isErasureCoded, boolean isSnapShottable, boolean hasAcl)
specifier|public
specifier|static
name|EnumSet
argument_list|<
...
return|;
block|}
comment|/**    * Check if the given path is the child of parent path.    * @param path Path to be check.    * @param parent Parent path.    * @return True if parent path is parent entry for given path.    */
DECL|method|isParentEntry (final String path, final String parent)
specifier|public
specifier|static
name|boolean
name|isParentEntry
