...
return|;
block|}
comment|/**    * Build a proxy connection to the namenode with NamenodeProtocol and set up    * the proxy with retry policy.    * @param address - namenode address    * @param conf - configuration    * @param ugi - User group information    * @return a proxy connection with NamenodeProtocol    * @throws - IOException    */
DECL|method|createNNProxyWithNamenodeProtocol ( InetSocketAddress address, Configuration conf, UserGroupInformation ugi)
specifier|public
specifier|static
name|NamenodeProtocolTranslatorPB
...
return|;
block|}
comment|/**    * Build a proxy connection to the namenode with NamenodeProtocol.    * @param address - namenode address    * @param conf - configuration    * @param ugi - User group information    * @param withRetries  - indicates whether to create retry proxy or not    * @return a proxy connection with NamenodeProtocol    * @throws - IOException    */
...
return|;
block|}
comment|/**    * Build a proxy connection to the namenode with ClientProtocol.    * @param address - namenode address    * @param conf - configuration    * @param ugi - User group information    * @param withRetries  - indicates whether to create retry proxy or not    * @return a proxy connection with ClientProtocol    * @throws IOException    */
...
name|proxy
operator|=
name|createNameNodeProxyWithRetries
argument_list|(
name|proxy
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * Creates the retry proxy by setting up the retry policy.    * @param proxy - non retry proxy connection    * @return a retry proxy connection    */
DECL|method|createNameNodeProxyWithRetries ( ClientNamenodeProtocolPB proxy)
specifier|public
specifier|static
name|ClientNamenodeProtocolPB
name|createNameNodeProxyWithRetries
