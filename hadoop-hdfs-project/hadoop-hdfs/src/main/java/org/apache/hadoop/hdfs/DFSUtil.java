...
return|;
block|}
comment|/**    * Returns list of InetSocketAddress corresponding to HA NN HTTP addresses from    * the configuration.    *    * @param conf configuration    * @return list of InetSocketAddresses    */
DECL|method|getHaNnHttpAddresses ( Configuration conf)
specifier|public
specifier|static
name|Map
argument_list|<
...
DECL|method|resolve (URI uri, int schemeDefaultPort, Configuration conf)
specifier|public
specifier|static
name|InetSocketAddress
index|[]
