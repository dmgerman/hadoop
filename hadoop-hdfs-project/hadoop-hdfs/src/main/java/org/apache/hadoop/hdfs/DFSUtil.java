...
block|}
block|}
comment|/**    * Creates a new KeyProviderCryptoExtension by wrapping the    * KeyProvider specified in the given Configuration.    *    * @param conf Configuration specifying a single, non-transient KeyProvider.    * @return new KeyProviderCryptoExtension, or null if no provider was found.    * @throws IOException if the KeyProvider is improperly specified in    *                             the Configuration    */
...
name|append
argument_list|(
literal|"Found multiple KeyProviders but only one is permitted ["
argument_list|)
expr_stmt|;
name|String
name|prefix
