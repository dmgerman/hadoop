...
block|}
block|}
comment|/**    * Updates the existing ACL list with remove and add ACLs that are passed.    * Remove is done before Add.    *    * @param existingAcls - old ACL list.    * @param removeAclInfos - ACLs to be removed.    * @param addAclInfos - ACLs to be added.    * @return updated ACL list.    */
DECL|method|getUpdatedAclList (List<OzoneAclInfo> existingAcls, List<OzoneAclInfo> removeAclInfos, List<OzoneAclInfo> addAclInfos)
specifier|private
name|List
argument_list|<
name|OzoneAcl
