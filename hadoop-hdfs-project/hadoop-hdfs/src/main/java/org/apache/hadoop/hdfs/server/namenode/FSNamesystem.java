...
block|}
block|}
comment|/**    * Create an erasure coding zone on directory src.    *    * @param src     the path of a directory which will be the root of the    *                erasure coding zone. The directory must be empty.    * @throws AccessControlException  if the caller is not the superuser.    * @throws UnresolvedLinkException if the path can't be resolved.    * @throws SafeModeException       if the Namenode is in safe mode.    */
DECL|method|createErasureCodingZone (final String srcArg, final boolean logRetryCache)
name|void
...
condition|)
block|{
comment|// TODO HDFS-8074 and HDFS-7859 : To get from loaded schemas
name|Map
argument_list|<
name|String
argument_list|,
...
return|;
block|}
comment|/**    * Get available ECSchemas    */
...
argument_list|)
expr_stmt|;
comment|// TODO HDFS-7866 Need to return all schemas maintained by Namenode
name|ECSchema
name|defaultSchema
init|=
