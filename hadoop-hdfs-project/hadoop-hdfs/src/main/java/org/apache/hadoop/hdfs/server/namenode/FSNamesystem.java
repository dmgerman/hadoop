...
argument_list|)
decl_stmt|;
DECL|field|maxCorruptFileBlocksReturn
specifier|private
specifier|final
name|int
...
throw|;
block|}
comment|// checks SPS Q has many outstanding requests. It will throw IOException if
comment|// the limit exceeds.
name|blockManager
operator|.
name|getSPSManager
argument_list|()
...
condition|)
block|{
name|checkErasureCodingSupported
argument_list|(
literal|"createWithEC"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|IOException
argument_list|(
literal|"Specified block size ("
operator|+
name|blockSize
operator|+
literal|") is less than the cell size ("
operator|+
name|ecPolicy
operator|.
name|getCellSize
argument_list|()
operator|+
literal|") of the erasure coding policy ("
operator|+
name|ecPolicy
operator|+
literal|")."
...
name|IOException
argument_list|(
literal|"Delegation Token can be renewed only with kerberos or web "
operator|+
...
name|toSnapshot
operator|+
literal|"'. Total comparison dirs: "
operator|+
name|dstat
operator|.
name|getTotalDirsCompared
argument_list|()
operator|+
literal|"/"
operator|+
...
argument_list|()
operator|+
literal|". Time snapChildrenListing: "
operator|+
name|dstat
operator|.
name|getTotalChildrenListingTime
argument_list|()
operator|/
literal|1000.0
operator|+
...
expr_stmt|;
block|}
comment|/**    * FSNamesystem Default AuditLogger implementation;used when no access logger    * is defined in the config file. It can also be explicitly listed in the    * config file.    */
annotation|@
name|VisibleForTesting
DECL|class|FSNamesystemAuditLogger
specifier|static
class|class
name|FSNamesystemAuditLogger
extends|extends
...
block|}
block|}
comment|/**    * Check whether operation is supported.    * @param operationName the name of operation.    * @throws UnsupportedActionException throws UAE if not supported.    */
DECL|method|checkErasureCodingSupported (String operationName)
specifier|public
name|void
name|checkErasureCodingSupported
parameter_list|(
