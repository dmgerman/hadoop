...
DECL|field|isStoragePolicyEnabled
specifier|private
specifier|final
name|boolean
...
block|}
block|}
DECL|method|setStoragePolicyInt (String src, final String policyName)
specifier|private
name|void
name|setStoragePolicyInt
parameter_list|(
...
return|;
block|}
comment|/** @deprecated See {@link #renameTo(String, String, boolean)} */
annotation|@
name|Deprecated
...
DECL|method|renameTo (final String srcArg, final String dstArg, boolean logRetryCache, Options.Rename... options)
name|void
name|renameTo
parameter_list|(
specifier|final
...
block|}
block|}
comment|/**    * Remove an xattr for a file or directory.    *    * @param src    *          - path to remove the xattr from    * @param xAttr    *          - xAttr to remove    * @throws AccessControlException    * @throws SafeModeException    * @throws UnresolvedLinkException    * @throws IOException    */
