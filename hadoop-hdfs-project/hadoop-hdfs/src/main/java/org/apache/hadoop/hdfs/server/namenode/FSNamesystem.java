...
name|cacheManager
decl_stmt|;
DECL|field|cacheReplicationManager
specifier|private
specifier|final
...
return|;
block|}
DECL|method|setCacheReplicationInt (String src, final short replication)
name|boolean
...
return|;
block|}
DECL|method|makeLocatedBlock (Block blk, DatanodeInfo[] locs, long offset)
name|LocatedBlock
name|makeLocatedBlock
parameter_list|(
name|Block
...
DECL|method|saveAllocatedBlock (String src, INodesInPath inodesInPath, Block newBlock, DatanodeDescriptor targets[])
name|BlockInfo
name|saveAllocatedBlock
parameter_list|(
name|String
...
return|;
block|}
comment|/** @return the cache replication manager. */
DECL|method|getCacheReplicationManager ()
specifier|public
name|CacheReplicationManager
...
argument_list|)
expr_stmt|;
comment|//getEditLog().logAddPathBasedCacheDirective(result); FIXME: HDFS-5119
name|success
operator|=
literal|true
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//getEditLog().logAddCachePool(req); // FIXME: HDFS-5119
name|success
operator|=
literal|true
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//getEditLog().logModifyCachePool(req); // FIXME: HDFS-5119
name|success
operator|=
literal|true
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//getEditLog().logRemoveCachePool(req); // FIXME: HDFS-5119
name|success
operator|=
literal|true
expr_stmt|;
