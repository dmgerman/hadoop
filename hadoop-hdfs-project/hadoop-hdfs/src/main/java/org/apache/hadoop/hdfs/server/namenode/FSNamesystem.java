...
expr_stmt|;
block|}
DECL|method|loadFSImage (StartupOption startOpt, FSImage fsImage)
name|void
name|loadFSImage
parameter_list|(
name|StartupOption
...
expr_stmt|;
block|}
DECL|method|startSecrectManager ()
name|void
name|startSecrectManager
parameter_list|()
throws|throws
name|IOException
block|{
...
block|}
block|}
comment|/**     * Start services common to both active and standby states    * @throws IOException    */
...
block|}
block|}
comment|/**     * Start services required in active state     * @throws InterruptedException    */
