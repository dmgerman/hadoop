...
name|fsLock
decl_stmt|;
DECL|field|pendingDatanodeMessages
specifier|private
name|PendingDataNodeMessages
name|pendingDatanodeMessages
init|=
...
name|conf
decl_stmt|;
DECL|method|getPendingDataNodeMessages ()
name|PendingDataNodeMessages
name|getPendingDataNodeMessages
parameter_list|()
block|{
return|return
name|pendingDatanodeMessages
...
return|;
block|}
comment|/**    * Replace current node with a INodeUnderConstruction.    * Recreate in-memory lease record.    *     * @param src path to the file    * @param file existing file object    * @param leaseHolder identifier of the lease holder on this file    * @param clientMachine identifier of the client machine    * @param clientNode if the client is collocated with a DN, that DN's descriptor    * @return the last block locations if the block is partial or null otherwise    * @throws UnresolvedLinkException    * @throws IOException    */
DECL|method|prepareFileForWrite (String src, INode file, String leaseHolder, String clientMachine, DatanodeDescriptor clientNode)
specifier|public
name|LocatedBlock
name|prepareFileForWrite
parameter_list|(
...
name|newgenerationstamp
operator|+
literal|", Queuing commitBlockSynchronization message"
argument_list|)
expr_stmt|;
name|getPendingDataNodeMessages
argument_list|()
...
return|;
block|}
DECL|method|notifyGenStampUpdate (long gs)
specifier|public
name|void
...
name|warn
argument_list|(
literal|"Could not process the message "
operator|+
name|msg
operator|.
name|getType
