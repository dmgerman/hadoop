...
return|;
block|}
DECL|method|listPathCacheEntries (long startId, Long poolId, int maxReplies)
name|List
argument_list|<
name|PathCacheEntry
argument_list|>
...
name|info
argument_list|(
literal|"listPathCacheEntries with "
operator|+
name|startId
operator|+
literal|" "
...
name|AccessControlException
argument_list|(
literal|"Non-super users cannot "
operator|+
literal|"add cache pools."
argument_list|)
throw|;
block|}
if|if
