...
literal|"<path>"
argument_list|,
literal|"The path of the encryption zone to delete. "
operator|+
literal|"It must be an empty directory and an existing encryption zone."
argument_list|)
expr_stmt|;
return|return
name|getShortUsage
...
literal|"\n"
operator|+
literal|"Delete an encryption zone.\n\n"
operator|+
name|listing
operator|.
name|toString
...
name|println
argument_list|(
literal|"Deleted encryption zone "
operator|+
name|path
argument_list|)
expr_stmt|;
