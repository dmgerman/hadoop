...
block|}
block|}
DECL|method|reencryptEncryptionZone (final FSDirectory fsd, final String zone, final String keyVersionName, final boolean logRetryCache)
specifier|static
name|void
...
expr_stmt|;
block|}
DECL|method|cancelReencryptEncryptionZone (final FSDirectory fsd, final String zone, final boolean logRetryCache)
specifier|static
name|void
...
block|}
block|}
comment|/**    * Get the last key version name for the given EZ. This will contact    * the KMS to getKeyVersions.    * @param zone the encryption zone    * @param pc the permission checker    * @return the last element from the list of keyVersionNames returned by KMS.    * @throws IOException    */
DECL|method|getLatestKeyVersion (final FSDirectory dir, final String zone, final FSPermissionChecker pc)
specifier|static
name|KeyVersion
...
expr_stmt|;
block|}
comment|// Contact KMS out of locks.
name|KeyVersion
name|currKv
init|=
name|dir
...
name|currKv
argument_list|,
literal|"No current key versions for key name "
operator|+
name|ez
operator|.
name|getKeyName
