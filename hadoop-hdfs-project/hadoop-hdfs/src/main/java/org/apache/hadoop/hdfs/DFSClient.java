...
throw|;
block|}
comment|// read directly from the block file if configured.
name|this
operator|.
name|shortCircuitLocalReads
operator|=
...
return|;
block|}
DECL|method|disableShortCircuit ()
name|void
