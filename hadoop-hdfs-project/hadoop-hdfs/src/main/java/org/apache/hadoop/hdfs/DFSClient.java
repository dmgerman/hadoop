...
argument_list|)
expr_stmt|;
comment|// TODO(HA): This doesn't really apply in the case of HA. Need to get smart
comment|// about tokens in an HA setup, generally.
name|nnAddress
operator|=
name|NameNode
operator|.
...
argument_list|(
literal|"Expecting exactly one of nameNodeUri and rpcNamenode being null: "
operator|+
literal|"nameNodeUri="
operator|+
name|nameNodeUri
