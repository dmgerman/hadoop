...
name|encryptionKey
decl_stmt|;
DECL|field|shouldUseLegacyBlockReaderLocal
specifier|private
name|boolean
name|shouldUseLegacyBlockReaderLocal
decl_stmt|;
...
decl_stmt|;
DECL|field|mmapManager
specifier|private
name|ClientMmapManager
name|mmapManager
decl_stmt|;
DECL|field|MMAP_MANAGER_FACTORY
specifier|private
specifier|static
specifier|final
name|ClientMmapManagerFactory
name|MMAP_MANAGER_FACTORY
init|=
operator|new
name|ClientMmapManagerFactory
argument_list|()
decl_stmt|;
DECL|class|ClientMmapManagerFactory
specifier|private
specifier|static
specifier|final
class|class
...
literal|null
decl_stmt|;
comment|/**      * Tracks the number of users of mmapManager.      */
DECL|field|refcnt
specifier|private
name|int
name|refcnt
...
name|warn
argument_list|(
literal|"The ClientMmapManager settings you specified "
operator|+
literal|"have been ignored because another thread created the "
operator|+
literal|"ClientMmapManager first.  "
operator|+
name|mismatches
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|unref (ClientMmapManager mmapManager)
specifier|synchronized
name|void
name|unref
parameter_list|(
...
return|;
block|}
DECL|method|disableLegacyBlockReaderLocal ()
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|useLegacyBlockReaderLocal ()
specifier|public
name|boolean
name|useLegacyBlockReaderLocal
parameter_list|()
