...
begin_comment
comment|/**  * This is the CLI that can be use to convert a levelDB into a sqlite DB file.  */
end_comment
...
decl_stmt|;
DECL|field|CREATE_CONTAINER_MACHINE
specifier|private
specifier|static
specifier|final
name|String
name|CREATE_CONTAINER_MACHINE
init|=
literal|"CREATE TABLE containerMembers ("
operator|+
literal|"containerName INTEGER NOT NULL, "
operator|+
literal|"datanodeUUID INTEGER NOT NULL,"
operator|+
...
return|;
block|}
DECL|method|closeDB (Connection conn)
specifier|private
name|void
name|closeDB
parameter_list|(
