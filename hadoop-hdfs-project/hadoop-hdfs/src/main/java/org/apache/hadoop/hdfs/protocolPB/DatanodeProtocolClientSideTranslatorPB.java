...
annotation|@
name|Override
DECL|method|getProtocolSignature (String protocolName, long clientVersion, int clientMethodsHash)
specifier|public
name|ProtocolSignature
...
annotation|@
name|Override
DECL|method|blockReceivedAndDeleted (DatanodeRegistration reg, String poolId, ReceivedDeletedBlockInfo[] receivedAndDeletedBlocks)
specifier|public
name|void
