...
return|;
block|}
comment|/** A reference with a fixed id for fsimage serialization. */
DECL|class|INodeReferenceWithId
specifier|private
specifier|static
class|class
name|INodeReferenceWithId
extends|extends
name|INodeReference
block|{
DECL|field|id
...
name|id
decl_stmt|;
DECL|method|INodeReferenceWithId (WithCount parent, INode referred, long id)
specifier|private
name|INodeReferenceWithId
parameter_list|(
name|WithCount
...
expr_stmt|;
block|}
comment|/** @return the reference id. */
...
return|;
block|}
DECL|method|removeAllINodeReferenceWithId ()
specifier|public
name|void
