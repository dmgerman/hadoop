...
expr_stmt|;
block|}
comment|// To support older clients, we don't pass in empty storageIds
specifier|final
name|int
name|nsi
init|=
...
name|dnConf
operator|.
name|overwriteDownstreamDerivedQOP
condition|)
block|{
name|String
name|bpid
...
condition|)
block|{
comment|// Older clients may not have provided any targetStorageIds
name|targetStorageId
operator|=
name|targetStorageIds
index|[
...
throw|;
block|}
DECL|method|checkAccess (OutputStream out, final boolean reply, ExtendedBlock blk, Token<BlockTokenIdentifier> t, Op op, BlockTokenIdentifier.AccessMode mode)
specifier|private
name|void
name|checkAccess
parameter_list|(
