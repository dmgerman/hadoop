...
return|;
block|}
DECL|method|DataXceiver (Socket s, SocketInputWrapper socketInput, DataNode datanode, DataXceiverServer dataXceiverServer)
specifier|private
name|DataXceiver
parameter_list|(
name|Socket
...
expr_stmt|;
block|}
DECL|method|getStreamWithTimeout (Socket s, long timeout)
specifier|private
specifier|static
name|DataOutputStream
name|getStreamWithTimeout
