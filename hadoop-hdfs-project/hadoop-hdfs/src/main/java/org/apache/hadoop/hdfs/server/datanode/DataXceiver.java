...
block|}
block|}
comment|/**    * Returns InetAddress from peer    * The getRemoteAddressString is the form  /ip-address:port    * The ip-address is extracted from peer and InetAddress is formed    * @param peer    * @return    * @throws UnknownHostException    */
DECL|method|getClientAddress (Peer peer)
specifier|private
specifier|static
name|InetAddress
name|getClientAddress
