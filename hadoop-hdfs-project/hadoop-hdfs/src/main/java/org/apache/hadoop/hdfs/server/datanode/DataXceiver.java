...
expr_stmt|;
block|}
comment|/**    * Wait until the BP is registered, upto the configured amount of time.    * Throws an exception if times out, which should fail the client request.    * @param the requested block    */
