...
decl_stmt|;
DECL|field|shouldDropCacheBehindRead
specifier|private
name|boolean
...
decl_stmt|;
comment|// 1MB
comment|/**    * Minimum length of read below which management of the OS    * buffer cache is disabled.    */
...
condition|)
block|{
comment|// don't manage cache manually for short-reads, like
comment|// HBase random read workloads.
return|return;
block|}
