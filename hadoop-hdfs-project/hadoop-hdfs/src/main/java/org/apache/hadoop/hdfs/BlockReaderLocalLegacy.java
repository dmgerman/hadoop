...
return|;
block|}
DECL|method|BlockReaderLocalLegacy (Configuration conf, String hdfsfile, ExtendedBlock block, Token<BlockTokenIdentifier> token, long startOffset, long length, BlockLocalPathInfo pathinfo, FileInputStream dataIn)
specifier|private
name|BlockReaderLocalLegacy
parameter_list|(
name|Configuration
...
expr_stmt|;
block|}
DECL|method|BlockReaderLocalLegacy (Configuration conf, String hdfsfile, ExtendedBlock block, Token<BlockTokenIdentifier> token, long startOffset, long length, BlockLocalPathInfo pathinfo, DataChecksum checksum, boolean verifyChecksum, FileInputStream dataIn, long firstChunkOffset, FileInputStream checksumIn)
specifier|private
name|BlockReaderLocalLegacy
parameter_list|(
name|Configuration
