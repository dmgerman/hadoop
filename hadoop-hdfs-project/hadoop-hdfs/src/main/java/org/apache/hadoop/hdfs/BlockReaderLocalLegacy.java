...
DECL|method|newBlockReader (DFSClient dfsClient, String file, ExtendedBlock blk, Token<BlockTokenIdentifier> token, DatanodeInfo node, long startOffset, long length)
specifier|static
name|BlockReaderLocalLegacy
name|newBlockReader
parameter_list|(
...
return|;
block|}
DECL|method|BlockReaderLocalLegacy (DFSClient.Conf conf, String hdfsfile, ExtendedBlock block, Token<BlockTokenIdentifier> token, long startOffset, long length, BlockLocalPathInfo pathinfo, FileInputStream dataIn)
specifier|private
name|BlockReaderLocalLegacy
parameter_list|(
name|DFSClient
...
expr_stmt|;
block|}
DECL|method|BlockReaderLocalLegacy (DFSClient.Conf conf, String hdfsfile, ExtendedBlock block, Token<BlockTokenIdentifier> token, long startOffset, long length, BlockLocalPathInfo pathinfo, DataChecksum checksum, boolean verifyChecksum, FileInputStream dataIn, long firstChunkOffset, FileInputStream checksumIn)
specifier|private
name|BlockReaderLocalLegacy
parameter_list|(
name|DFSClient
