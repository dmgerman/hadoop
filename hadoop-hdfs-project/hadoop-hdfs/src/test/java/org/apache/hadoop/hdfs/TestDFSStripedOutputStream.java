...
expr_stmt|;
block|}
comment|//TODO: The following tests will pass after HDFS-8121 fixed
comment|//  @Test
...
index|[]
decl_stmt|;
comment|//calculate the size of this block group
name|int
name|lenOfBlockGroup
init|=
name|group
operator|<
name|blockGroupList
...
name|expected
decl_stmt|;
comment|//calculate the postion of this byte in the file
name|long
name|pos
init|=
name|group
