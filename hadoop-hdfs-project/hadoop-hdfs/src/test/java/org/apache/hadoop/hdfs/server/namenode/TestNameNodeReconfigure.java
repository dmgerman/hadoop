...
argument_list|)
expr_stmt|;
comment|// enable SPS internally by keeping DFS_STORAGE_POLICY_ENABLED_KEY
name|nameNode
operator|.
name|reconfigureProperty
argument_list|(
...
expr_stmt|;
block|}
DECL|method|verifySPSEnabled (final NameNode nameNode, String property, StoragePolicySatisfierMode expected, boolean isSatisfierRunning)
name|void
name|verifySPSEnabled
parameter_list|(
specifier|final
