...
argument_list|()
decl_stmt|;
comment|// get blocks of size fileLen from dataNodes[0], with minBlockSize as
comment|// fileLen
name|BlockWithLocations
index|[]
name|locs
decl_stmt|;
comment|// Should return all 13 blocks, as minBlockSize is not passed
name|locs
operator|=
name|namenode
operator|.
...
argument_list|)
expr_stmt|;
comment|// Should return 12 blocks, as minBlockSize is DEFAULT_BLOCK_SIZE
name|locs
operator|=
name|namenode
operator|.
...
argument_list|)
decl_stmt|;
name|getBlocksWithIncorrectDatanodeException
argument_list|(
name|namenode
argument_list|,
name|info
...
block|}
block|}
DECL|method|getBlocksWithException (NamenodeProtocol namenode, DatanodeInfo datanode, long size, long minBlockSize)
specifier|private
name|void
name|getBlocksWithException
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|getBlocksWithIncorrectDatanodeException ( NamenodeProtocol namenode, DatanodeInfo datanode, long size, long minBlockSize)
specifier|private
name|void
name|getBlocksWithIncorrectDatanodeException
parameter_list|(
