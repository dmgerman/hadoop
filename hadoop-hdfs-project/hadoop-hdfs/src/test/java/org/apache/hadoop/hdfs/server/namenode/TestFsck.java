...
argument_list|)
expr_stmt|;
comment|// validate if a directory have any invalid entries
name|util
operator|.
name|createFiles
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Wait for the namenode to see the corruption.    * @param corruptBlocks The expected number of corruptfilelocks    * @param path The Directory Path where corruptfileblocks exists    * @throws IOException    */
DECL|method|waitForCorruptionBlocks (int corruptBlocks, String path)
specifier|private
name|void
name|waitForCorruptionBlocks
parameter_list|(
...
name|error
argument_list|(
literal|"Exception while getting Corrupt file blocks"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
literal|300000
argument_list|)
DECL|method|testFsckCorruptWhenOneReplicaIsCorrupt ()
specifier|public
name|void
name|testFsckCorruptWhenOneReplicaIsCorrupt
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testFsckNonPrivilegedListCorrupt ()
specifier|public
name|void
name|testFsckNonPrivilegedListCorrupt
parameter_list|()
throws|throws
name|Exception
block|{
