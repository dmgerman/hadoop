...
expr_stmt|;
block|}
comment|/**    * Setup the mini-DFS cluster.    *    * @throws Exception thrown if the cluster setup fails    */
annotation|@
name|Before
...
expr_stmt|;
block|}
comment|/**    * Stop the mini-DFS cluster.    */
annotation|@
name|After
...
expr_stmt|;
block|}
comment|/**    * Create the /tmp directory as<i>hdfs</i> and /tmp/test as<i>sink</i> and    * return the UGI for<i>sink</i>.    *    * @throws IOException thrown if login or directory creation fails    * @throws InterruptedException thrown if interrupted while creating a    * file system handle    */
DECL|method|createDirectoriesSecurely ()
specifier|protected
name|void
name|createDirectoriesSecurely
parameter_list|()
