...
annotation|@
name|Test
DECL|method|testSafeModeExceptionText ()
specifier|public
name|void
name|testSafeModeExceptionText
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Should not succeed with no exceptions!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"AddErasureCodingPolicies should have failed."
argument_list|)
expr_stmt|;
block|}
catch|catch
