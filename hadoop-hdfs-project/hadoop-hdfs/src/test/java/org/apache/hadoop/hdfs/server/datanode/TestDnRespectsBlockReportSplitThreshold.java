...
expr_stmt|;
block|}
DECL|method|verifyCapturedArgumentsSplit ( ArgumentCaptor<StorageBlockReport[]> captor, int expectedReportsPerCall, int expectedTotalBlockCount)
specifier|private
name|void
name|verifyCapturedArgumentsSplit
parameter_list|(
name|ArgumentCaptor
argument_list|<
name|StorageBlockReport
