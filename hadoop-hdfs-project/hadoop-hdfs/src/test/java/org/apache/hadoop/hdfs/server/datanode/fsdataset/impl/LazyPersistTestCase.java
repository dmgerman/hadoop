...
DECL|method|startUpCluster ( int numDatanodes, boolean hasTransientStorage, StorageType[] storageTypes, int ramDiskReplicaCapacity, long ramDiskStorageLimit, long evictionLowWatermarkReplicas, long maxLockedMemory, boolean useSCR, boolean useLegacyBlockReaderLocal, boolean disableScrubber)
specifier|protected
specifier|final
name|void
name|startUpCluster
...
return|;
block|}
DECL|method|setEvictionLowWatermarkReplicas ( long evictionLowWatermarkReplicas)
specifier|public
name|ClusterWithRamDiskBuilder
...
literal|false
decl_stmt|;
DECL|field|evictionLowWatermarkReplicas
specifier|private
name|long
name|evictionLowWatermarkReplicas
init|=
