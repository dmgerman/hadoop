...
annotation|@
name|Test
DECL|method|testFetchOrCreateRetries ()
specifier|public
name|void
name|testFetchOrCreateRetries
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Arrange that fetch will throw RetriableException for any call
name|Mockito
operator|.
name|doThrow
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Act: calling fetchOrCreate two times
comment|//  first call: it will create and put entry to replicaInfoMap
comment|//  second call: it will call fetch to get info for entry, and should
comment|//               retry 3 times because RetriableException thrown
name|cache
operator|.
name|fetchOrCreate
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Assert that fetchOrCreate retried to fetch at least 3 times
name|Mockito
operator|.
name|verify
argument_list|(
...
annotation|@
name|Test
DECL|method|testRequestFileDescriptorsWhenULimit ()
specifier|public
name|void
name|testRequestFileDescriptorsWhenULimit
parameter_list|()
throws|throws
name|Exception
block|{
...
name|createShortCircuitConf
argument_list|(
literal|"testRequestFileDescriptorsWhenULimit"
argument_list|,
name|sockDir
argument_list|)
decl_stmt|;
...
name|thenAnswer
argument_list|(
comment|// we are mocking the FileOutputStream array with nulls
operator|(
name|Answer
argument_list|<
name|Void
...
name|fail
argument_list|(
literal|"Should not throw NPE when the native library is unable "
operator|+
literal|"to create new files!"
argument_list|)
expr_stmt|;
block|}
block|}
