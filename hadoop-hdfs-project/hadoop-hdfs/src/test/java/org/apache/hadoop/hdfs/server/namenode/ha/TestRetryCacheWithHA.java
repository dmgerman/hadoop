...
name|descriptor
decl_stmt|;
DECL|method|AddPathBasedCacheDirectiveOp (DFSClient client, String pool, String path)
name|AddPathBasedCacheDirectiveOp
parameter_list|(
name|DFSClient
name|client
...
block|}
block|}
comment|/** removePathBasedCacheDescriptor */
...
name|descriptor
decl_stmt|;
DECL|method|RemovePathBasedCacheDescriptorOp (DFSClient client, String pool, String path)
name|RemovePathBasedCacheDescriptorOp
parameter_list|(
name|DFSClient
name|client
