...
argument_list|()
expr_stmt|;
comment|// Delete the last edit log segment from randomly selected journal node
name|journalIndex
operator|=
name|randomJournal
operator|.
...
argument_list|)
expr_stmt|;
comment|// Delete the last edit log segment from two journals for some logs
if|if
condition|(
name|count
operator|%
...
name|Exception
block|{
comment|// Queuing is disabled during the cluster setup {@link #setUpMiniCluster()}
name|File
name|firstJournalDir
init|=
name|jCluster
