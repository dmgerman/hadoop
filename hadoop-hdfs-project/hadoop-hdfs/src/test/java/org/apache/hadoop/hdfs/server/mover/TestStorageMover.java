...
expr_stmt|;
block|}
DECL|method|MigrationTest (ClusterScheme cScheme, NamespaceScheme nsScheme, BlockStoragePolicySuite policies)
name|MigrationTest
parameter_list|(
name|ClusterScheme
name|cScheme
...
return|;
block|}
DECL|method|genCapacities (int nDatanodes, int numAllDisk, int numAllArchive, int numRamDisk, long diskCapacity, long archiveCapacity, long ramDiskCapacity)
specifier|private
specifier|static
name|long
index|[]
...
block|}
block|}
comment|/**    * Test blocks of lazy_persist file on RAM_DISK will not be moved to other    * storage types by the Storage Mover.    */
annotation|@
name|Test
DECL|method|testRamDiskNotMoved ()
specifier|public
name|void
name|testRamDiskNotMoved
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// test creating a hot RAM_DISK file
specifier|final
name|int
name|SEED
init|=
...
argument_list|)
expr_stmt|;
comment|// Verify policy related name change is allowed
specifier|final
name|Path
name|foo_hot_new
init|=
...
argument_list|)
expr_stmt|;
comment|// Verify blocks on ram disk will not be moved to other storage types by
comment|// policy based Storage Mover.
name|test
operator|.
name|migrate
argument_list|()
