...
annotation|@
name|Test
DECL|method|testMultiStreamsLoadEditWithConfMaxTxns ()
specifier|public
name|void
name|testMultiStreamsLoadEditWithConfMaxTxns
parameter_list|()
throws|throws
name|IOException
block|{
...
name|fail
argument_list|(
literal|"no exception should be thrown"
argument_list|)
expr_stmt|;
block|}
finally|finally
...
block|}
block|}
comment|/**    * Test edits can be writen and read without ErasureCoding supported.    */
annotation|@
name|Test
DECL|method|testEditLogWithoutErasureCodingSupported ()
specifier|public
name|void
name|testEditLogWithoutErasureCodingSupported
parameter_list|()
throws|throws
name|IOException
block|{
...
literal|null
decl_stmt|;
comment|// ERASURECODING not supported
name|int
name|logVersion
init|=
operator|-
...
argument_list|)
expr_stmt|;
comment|// Write new version edit log
name|long
name|txid
init|=
name|editLog
...
literal|1426222918
decl_stmt|;
comment|// Add a block to the file
name|BlockInfoContiguous
name|blockInfo
init|=
operator|new
