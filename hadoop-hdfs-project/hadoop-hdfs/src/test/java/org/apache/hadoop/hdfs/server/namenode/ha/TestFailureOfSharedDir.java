...
expr_stmt|;
block|}
comment|/**    * Multiple shared edits directories is an invalid configuration.    */
annotation|@
name|Test
DECL|method|testMultipleSharedDirsFails ()
specifier|public
name|void
name|testMultipleSharedDirsFails
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Allowed multiple shared edits directories"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertFalse
argument_list|(
literal|"StandBy NameNode should not go to SafeMode on resource unavailability"
argument_list|,
name|nn1
operator|.
name|isInSafeMode
