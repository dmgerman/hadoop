...
annotation|@
name|Test
DECL|method|testBlockChecksumTypeProto ()
specifier|public
name|void
name|testBlockChecksumTypeProto
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|testConvertAddingECPolicyResponse ()
specifier|public
name|void
name|testConvertAddingECPolicyResponse
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Check conversion of the built-in policies.
for|for
control|(
name|ErasureCodingPolicy
name|policy
...
argument_list|)
decl_stmt|;
comment|// Optional fields should not be set.
name|assertFalse
argument_list|(
literal|"Unnecessary field is set."
argument_list|,
name|proto
operator|.
name|hasErrorMsg
...
argument_list|)
expr_stmt|;
comment|// Convert proto back to an object and check for equality.
name|AddErasureCodingPolicyResponse
...
name|assertEquals
argument_list|(
literal|"Converted policy not equal"
argument_list|,
name|response
operator|.
name|getPolicy
...
annotation|@
name|Test
DECL|method|testConvertErasureCodingPolicy ()
specifier|public
name|void
name|testConvertErasureCodingPolicy
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// Check conversion of a non-built-in policy.
name|ECSchema
name|newSchema
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// Optional fields should be set.
name|assertTrue
argument_list|(
literal|"Optional field not set"
argument_list|,
name|proto
operator|.
name|hasName
...
argument_list|)
decl_stmt|;
comment|// Converted policy should be equal.
name|assertEquals
argument_list|(
literal|"Converted policy not equal"
argument_list|,
...
name|class
argument_list|)
DECL|method|testErasureCodingPolicyMissingId ()
specifier|public
name|void
name|testErasureCodingPolicyMissingId
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testErasureCodingPolicyMissingOptionalFields ()
specifier|public
name|void
name|testErasureCodingPolicyMissingOptionalFields
parameter_list|()
throws|throws
name|Exception
block|{
comment|// For non-built-in policies, the optional fields are required
comment|// when parsing an ErasureCodingPolicyProto.
name|HdfsProtos
operator|.
name|ECSchemaProto
name|schemaProto
