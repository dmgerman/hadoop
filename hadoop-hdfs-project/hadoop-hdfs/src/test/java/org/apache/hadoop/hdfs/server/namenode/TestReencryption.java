...
expr_stmt|;
block|}
comment|/**    * Verify the zone status' completion time is larger than 0, and is no less    * than submission time.    */
DECL|method|verifyZoneCompletionTime (final ZoneReencryptionStatus zs)
specifier|private
name|void
name|verifyZoneCompletionTime
parameter_list|(
...
name|assertTrue
argument_list|(
literal|"Completion time should be positive. "
operator|+
name|zs
operator|.
...
argument_list|()
operator|+
literal|" should be no less than submission time "
operator|+
name|zs
operator|.
