...
literal|54222
decl_stmt|;
DECL|field|CALLQUEUE_CONFIG_KEY
specifier|private
specifier|static
name|String
name|CALLQUEUE_CONFIG_KEY
init|=
literal|"ipc."
operator|+
name|NNPort
...
name|mockQueueConstructions
decl_stmt|;
comment|// Replace queue with the queue specified in core-site.xml, which would be the LinkedBlockingQueue
name|DFSAdmin
name|admin
init|=
operator|new
