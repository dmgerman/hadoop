...
block|}
block|}
comment|/**    * Generate testing environment and return a collection of blocks    * on which to run the tests.    *     * @param bpid Block pool ID to generate blocks for    * @param dataSet Namespace in which to insert blocks    * @return Contrived blocks for further testing.    * @throws IOException    */
DECL|method|setup (String bpid, FsDatasetImpl dataSet)
specifier|private
name|ExtendedBlock
index|[]
name|setup
...
return|;
block|}
DECL|method|testAppend (String bpid, FsDatasetImpl dataSet, ExtendedBlock[] blocks)
specifier|private
name|void
name|testAppend
parameter_list|(
...
block|}
block|}
DECL|method|testClose (FsDatasetImpl dataSet, ExtendedBlock [] blocks)
specifier|private
name|void
name|testClose
parameter_list|(
...
block|}
block|}
DECL|method|createReplicas (List<String> bpList, List<FsVolumeImpl> volumes, ReplicaMap volumeMap)
specifier|private
name|void
name|createReplicas
parameter_list|(
...
name|assertTrue
argument_list|(
literal|"Volume map can't be null"
argument_list|,
name|volumeMap
operator|!=
literal|null
