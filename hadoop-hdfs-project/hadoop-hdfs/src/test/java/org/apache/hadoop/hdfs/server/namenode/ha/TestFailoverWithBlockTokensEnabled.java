...
annotation|@
name|Test
DECL|method|testSerialNumberMaskMatchIndex ()
specifier|public
name|void
name|testSerialNumberMaskMatchIndex
parameter_list|()
block|{
name|BlockTokenSecretManager
name|btsm1
...
control|)
block|{
name|setAndCheckHighBitsSerialNumber
argument_list|(
name|testSet
index|[
name|i
...
block|}
block|}
comment|/**    * Check mask of serial number if equal to index of NameNode.    */
DECL|method|setAndCheckHighBitsSerialNumber (int serialNumber, BlockTokenSecretManager btsm, int nnIndex)
specifier|private
name|void
name|setAndCheckHighBitsSerialNumber
parameter_list|(
