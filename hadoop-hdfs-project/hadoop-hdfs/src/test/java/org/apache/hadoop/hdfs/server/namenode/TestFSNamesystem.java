...
argument_list|)
expr_stmt|;
comment|// Spin up a bunch of threads all grabbing the lock at once; assign some
comment|// to go over threshold and some under. Check that they all log correctly.
name|logs
operator|.
name|clearOutput
argument_list|()
