...
argument_list|)
expr_stmt|;
comment|// create a file under construction
name|FSDataOutputStream
name|outStream
init|=
name|fs
...
argument_list|)
expr_stmt|;
comment|// Apply editlogs to fsimage, test fsimage with inodeUnderConstruction can
comment|// be handled
name|fsn
operator|.
name|enterSafeMode
...
argument_list|()
expr_stmt|;
comment|// The lastInodeId in fsimage should remain 1006 after reboot
name|cluster
operator|.
name|restartNameNode
argument_list|()
