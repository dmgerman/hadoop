...
expr_stmt|;
block|}
comment|/**    * While rolling upgrade is in-progress the test truncates a file    * such that copy-on-truncate is triggered, then deletes the file,    * and makes sure that no blocks involved in truncate are hanging around.    */
annotation|@
name|Test
DECL|method|testTruncateWithRollingUpgrade ()
specifier|public
name|void
name|testTruncateWithRollingUpgrade
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"could not prepare for rolling upgrade"
argument_list|,
literal|0
argument_list|,
name|status
...
name|Path
argument_list|(
literal|"/testTruncateWithRollingUpgrade"
argument_list|)
decl_stmt|;
name|fs
operator|.
...
name|assertFalse
argument_list|(
literal|"should be copy-on-truncate"
argument_list|,
name|isReady
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"could not finalize rolling upgrade"
argument_list|,
literal|0
argument_list|,
name|status
