...
annotation|@
name|Test
DECL|method|testSpanReceiverHost ()
specifier|public
name|void
name|testSpanReceiverHost
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|assertSpanNamesFound (String[] expectedSpanNames)
specifier|private
name|void
name|assertSpanNamesFound
parameter_list|(
...
name|assertTrue
argument_list|(
literal|"Should find a span with name "
operator|+
name|spanName
argument_list|,
name|map
