...
annotation|@
name|Test
DECL|method|testDNShouldNotDeleteBlockONTooManyOpenFiles ()
specifier|public
name|void
name|testDNShouldNotDeleteBlockONTooManyOpenFiles
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//Before DN throws too many open files
...
name|assertTrue
argument_list|(
literal|"Should throw too many open files"
argument_list|,
name|fe
operator|.
name|getMessage
...
comment|//After DN throws too many open files
name|assertTrue
argument_list|(
name|cluster
operator|.
...
block|}
block|}
DECL|method|verifyBlockLocations (DistributedFileSystem fs, Path p, int expected)
specifier|private
name|void
name|verifyBlockLocations
parameter_list|(
...
annotation|@
name|Test
DECL|method|testNNRpcMetricsWithNonHA ()
specifier|public
name|void
name|testNNRpcMetricsWithNonHA
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
decl_stmt|;
comment|// setting heartbeat interval to 1 hour to prevent bpServiceActor sends
comment|// heartbeat periodically to NN during running test case, and bpServiceActor
comment|// only sends heartbeat once after startup
name|conf
operator|.
...
annotation|@
name|Test
DECL|method|testNNRpcMetricsWithHA ()
specifier|public
name|void
name|testNNRpcMetricsWithHA
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertCounter
argument_list|(
literal|"HeartbeatsForminidfs-ns-nn1NumOps"
argument_list|,
literal|1L
argument_list|,
name|rb
...
name|assertCounter
argument_list|(
literal|"HeartbeatsForminidfs-ns-nn2NumOps"
argument_list|,
literal|1L
argument_list|,
name|rb
...
annotation|@
name|Test
DECL|method|testNNRpcMetricsWithFederation ()
specifier|public
name|void
name|testNNRpcMetricsWithFederation
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertCounter
argument_list|(
literal|"HeartbeatsForns1NumOps"
argument_list|,
literal|1L
argument_list|,
name|rb
...
name|assertCounter
argument_list|(
literal|"HeartbeatsForns2NumOps"
argument_list|,
literal|1L
argument_list|,
name|rb
...
annotation|@
name|Test
DECL|method|testNNRpcMetricsWithFederationAndHA ()
specifier|public
name|void
name|testNNRpcMetricsWithFederationAndHA
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertCounter
argument_list|(
literal|"HeartbeatsForns0-nn0NumOps"
argument_list|,
literal|1L
argument_list|,
name|rb
...
name|assertCounter
argument_list|(
literal|"HeartbeatsForns0-nn1NumOps"
argument_list|,
literal|1L
argument_list|,
name|rb
...
name|assertCounter
argument_list|(
literal|"HeartbeatsForns1-nn0NumOps"
argument_list|,
literal|1L
argument_list|,
name|rb
...
name|assertCounter
argument_list|(
literal|"HeartbeatsForns1-nn1NumOps"
argument_list|,
literal|1L
argument_list|,
name|rb
