...
index|]
operator|=
literal|"hdfs://localhost/testfile2"
expr_stmt|;
name|int
name|ret
init|=
...
block|}
block|}
comment|/**    * Test -setrep with a replication factor that is too low.  We have to test    * this here because the mini-cluster used with testHDFSConf.xml uses a    * replication factor of 1 (for good reason).    */
annotation|@
name|Test
argument_list|(
name|timeout
