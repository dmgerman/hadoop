...
annotation|@
name|Test
DECL|method|testErasureCodingPolicyOnDotSnapshotDir ()
specifier|public
name|void
name|testErasureCodingPolicyOnDotSnapshotDir
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// set erasure coding policy and create snapshot
name|fs
operator|.
name|setErasureCodingPolicy
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// verify the EC policy correctness
name|ErasureCodingPolicy
name|ecSnap
init|=
name|fs
...
argument_list|)
expr_stmt|;
comment|// verify the EC policy is null, not an exception
specifier|final
name|Path
name|ecDotSnapshotDir
init|=
operator|new
name|Path
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Test creation of snapshot on directory which changes its    * erasure coding policy.    */
annotation|@
name|Test
DECL|method|testSnapshotsOnErasureCodingDirAfterECPolicyChanges ()
specifier|public
name|void
name|testSnapshotsOnErasureCodingDirAfterECPolicyChanges
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Verify the EC policy correctness after the unset operation
name|fs
operator|.
...
argument_list|)
expr_stmt|;
comment|// Change the erasure coding policy and take another snapshot
specifier|final
name|ErasureCodingPolicy
name|ec32Policy
init|=
...
argument_list|)
expr_stmt|;
comment|// Check that older snapshot still have the old ECPolicy settings
name|assertNull
argument_list|(
literal|"Expected null erasure coding policy"
argument_list|,
