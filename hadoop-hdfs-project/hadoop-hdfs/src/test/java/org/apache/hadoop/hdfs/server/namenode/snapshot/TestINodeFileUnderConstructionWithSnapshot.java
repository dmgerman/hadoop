...
block|}
block|}
comment|/**    * Check if the given nodes can form a circular list    */
DECL|method|checkCircularList (FileWithSnapshot... nodes)
specifier|private
name|void
...
argument_list|)
expr_stmt|;
comment|// check the circular list and corresponding inodes: there should only be a
comment|// reference of the current node in the created list
name|INodeFile
name|fileNode
init|=
operator|(
...
argument_list|)
expr_stmt|;
comment|// check the circular list and corresponding inodes
name|diff
operator|=
name|dirNode
operator|.
...
argument_list|()
expr_stmt|;
comment|// check: an INodeFileUnderConstructionSnapshot should be stored into s0's
...
argument_list|()
expr_stmt|;
comment|// check: an INodeFileUnderConstructionSnapshot with size BLOCKSIZE*3 should
...
argument_list|)
expr_stmt|;
comment|// also check the circular linked list
name|checkCircularList
argument_list|(
operator|(
name|INodeFileWithSnapshot
