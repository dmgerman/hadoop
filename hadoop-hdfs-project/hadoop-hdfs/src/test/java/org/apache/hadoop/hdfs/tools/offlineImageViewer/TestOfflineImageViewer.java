...
annotation|@
name|Test
DECL|method|testWebImageViewerNullOp ()
specifier|public
name|void
name|testWebImageViewerNullOp
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// should get HTTP_BAD_REQUEST. NPE gets HTTP_INTERNAL_ERROR
name|verifyHttpResponseCode
argument_list|(
name|HttpURLConnection
operator|.
...
block|}
block|}
DECL|method|createSampleFileInode ()
specifier|private
name|FsImageProto
operator|.
name|INodeSection
...
return|;
block|}
DECL|method|createSampleDirInode ()
specifier|private
name|FsImageProto
operator|.
name|INodeSection
...
return|;
block|}
DECL|method|createSampleSymlink ()
specifier|private
name|FsImageProto
operator|.
name|INodeSection
...
return|;
block|}
DECL|method|createDelimitedWriterSpy ()
specifier|private
name|PBImageDelimitedTextWriter
name|createDelimitedWriterSpy
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testWriterOutputEntryBuilderForFile ()
specifier|public
name|void
name|testWriterOutputEntryBuilderForFile
parameter_list|()
throws|throws
name|IOException
block|{
name|assertEquals
argument_list|(
literal|"/path/file,5,2000-01-01 00:00,2000-01-01 00:00,"
operator|+
literal|"1024,3,3072,0,0,-rwx-wx-w-+,user_1,group_1"
argument_list|,
name|createDelimitedWriterSpy
argument_list|()
operator|.
...
annotation|@
name|Test
DECL|method|testWriterOutputEntryBuilderForDirectory ()
specifier|public
name|void
name|testWriterOutputEntryBuilderForDirectory
parameter_list|()
throws|throws
name|IOException
block|{
name|assertEquals
argument_list|(
literal|"/path/dir,0,2000-01-01 00:00,1970-01-01 00:00"
operator|+
literal|",0,0,0,700,1000,drwx-wx-w-+,user_1,group_1"
argument_list|,
name|createDelimitedWriterSpy
argument_list|()
operator|.
...
annotation|@
name|Test
DECL|method|testWriterOutputEntryBuilderForSymlink ()
specifier|public
name|void
name|testWriterOutputEntryBuilderForSymlink
parameter_list|()
throws|throws
name|IOException
block|{
name|assertEquals
argument_list|(
literal|"/path/sym,0,2000-01-01 00:00,2000-01-01 00:00"
operator|+
literal|",0,0,0,0,0,-rwx-wx-w-,user_1,group_1"
argument_list|,
name|createDelimitedWriterSpy
argument_list|()
operator|.
...
annotation|@
name|Test
DECL|method|testCorruptionOutputEntryBuilder ()
specifier|public
name|void
name|testCorruptionOutputEntryBuilder
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
argument_list|,
literal|"MissingChild,342,false,/dir1/dir2/,1,,,3"
argument_list|)
expr_stmt|;
name|corrDetector
operator|=
...
argument_list|()
argument_list|,
literal|"CorruptNode\t781\ttrue\t/dir3/\tMissing\tfolder\tNode\t0"
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
DECL|method|testPBCorruptionDetector ()
specifier|public
name|void
name|testPBCorruptionDetector
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|class
argument_list|)
DECL|method|testDelimitedWithExistingFolder ()
specifier|public
name|void
name|testDelimitedWithExistingFolder
parameter_list|()
throws|throws
name|IOException
throws|,
...
block|{
name|String
name|tempDelimitedDirName
init|=
literal|"tempDirDelimited"
decl_stmt|;
name|String
name|tempDelimitedDirPath
init|=
operator|new
name|FileSystemTestHelper
argument_list|()
...
name|assertTrue
argument_list|(
literal|"Couldn't create temp directory!"
argument_list|,
name|tempDelimitedDir
operator|.
name|mkdirs
...
expr_stmt|;
block|}
DECL|method|testPBCorruptionDetector (String db)
specifier|private
name|void
name|testPBCorruptionDetector
parameter_list|(
...
block|}
block|}
DECL|method|properINodeDelete (List<Long> idsToDelete, Document doc)
specifier|private
name|void
name|properINodeDelete
parameter_list|(
name|List
argument_list|<
name|Long
...
name|IOException
argument_list|(
literal|"No id tags found in the image xml."
argument_list|)
throw|;
block|}
for|for
...
name|IOException
argument_list|(
literal|"Couldn't find the id in the image."
argument_list|)
throw|;
block|}
block|}
...
name|IOException
argument_list|(
literal|"More than one numInodes tag found."
argument_list|)
throw|;
block|}
name|Node
...
expr_stmt|;
block|}
DECL|method|deleteINodeFromXML (File inputFile, File outputFile, List<Long> corruptibleIds)
specifier|private
name|void
name|deleteINodeFromXML
parameter_list|(
name|File
name|inputFile
parameter_list|,
...
expr_stmt|;
block|}
DECL|method|generateMissingNodeCorruption (File goodImageXml, File corruptedImageXml, File corruptedImage, List<Long> corruptibleIds)
specifier|private
name|void
name|generateMissingNodeCorruption
parameter_list|(
name|File
name|goodImageXml
parameter_list|,
name|File
name|corruptedImageXml
parameter_list|,
name|File
name|corruptedImage
parameter_list|,
...
name|IOException
argument_list|(
literal|"Couldn't create from XML!"
argument_list|)
throw|;
block|}
end_block
...
begin_function
unit|}    private
DECL|method|testCorruptionDetectorRun (int runNumber, List<Long> corruptions, String db)
name|String
name|testCorruptionDetectorRun
parameter_list|(
name|int
name|runNumber
parameter_list|,
...
begin_function
DECL|method|readExpectedFile (String fileName)
specifier|private
name|String
name|readExpectedFile
parameter_list|(
name|String
name|fileName
parameter_list|)
...
annotation|@
name|Test
DECL|method|testCorruptionDetectionSingleFileCorruption ()
specifier|public
name|void
name|testCorruptionDetectionSingleFileCorruption
parameter_list|()
throws|throws
name|Exception
block|{
...
name|readExpectedFile
argument_list|(
literal|"testSingleFileCorruption.csv"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|testCorruptionDetectionMultipleFileCorruption ()
specifier|public
name|void
name|testCorruptionDetectionMultipleFileCorruption
parameter_list|()
throws|throws
name|Exception
block|{
...
name|readExpectedFile
argument_list|(
literal|"testMultipleFileCorruption.csv"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|testCorruptionDetectionSingleFolderCorruption ()
specifier|public
name|void
name|testCorruptionDetectionSingleFolderCorruption
parameter_list|()
throws|throws
name|Exception
block|{
...
name|readExpectedFile
argument_list|(
literal|"testSingleFolderCorruption.csv"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|testCorruptionDetectionMultipleCorruption ()
specifier|public
name|void
name|testCorruptionDetectionMultipleCorruption
parameter_list|()
throws|throws
name|Exception
block|{
...
name|readExpectedFile
argument_list|(
literal|"testMultipleCorruption.csv"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
