...
begin_comment
comment|/**  * In-memory cache/mock of a namenode and file resolver. Stores the most  * recently updated NN information for each nameservice and block pool. Also  * stores a virtual mount table for resolving global namespace paths to local NN  * paths.  */
end_comment
...
expr_stmt|;
block|}
DECL|method|addLocation (String mount, String nameservice, String location)
specifier|public
name|void
name|addLocation
parameter_list|(
