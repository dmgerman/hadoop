...
annotation|@
name|Test
DECL|method|testUpdatePipeLineAfterDNReg ()
specifier|public
name|void
name|testUpdatePipeLineAfterDNReg
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Path
argument_list|(
literal|"/testUpdatePipeLineAfterDNReg"
argument_list|)
decl_stmt|;
name|FSDataOutputStream
name|out
...
argument_list|()
expr_stmt|;
comment|//Get the First DN and disable the heartbeats and then put in Deadstate
name|DataNode
name|dn1
init|=
name|cluster
...
argument_list|)
expr_stmt|;
comment|//Re-register the DeadNode
name|DatanodeProtocolClientSideTranslatorPB
name|dnp
init|=
operator|new
...
argument_list|()
decl_stmt|;
comment|//Update the genstamp and call updatepipeline
name|LocatedBlock
name|newBlock
init|=
name|namenode
...
argument_list|)
expr_stmt|;
comment|//Should not throw any error Pipeline should be success
name|dfsO
operator|.
name|getStreamer
argument_list|()
