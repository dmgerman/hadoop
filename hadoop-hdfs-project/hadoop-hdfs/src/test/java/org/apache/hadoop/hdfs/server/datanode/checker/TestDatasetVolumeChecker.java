...
annotation|@
name|Test
DECL|method|testInvalidConfigurationValues ()
specifier|public
name|void
name|testInvalidConfigurationValues
parameter_list|()
throws|throws
name|Exception
block|{
...
name|class
argument_list|,
literal|"Invalid value configured for dfs.datanode.disk.check.timeout"
operator|+
literal|" - 0 (should be> 0)"
argument_list|,
parameter_list|()
lambda|->
operator|new
...
name|class
argument_list|,
literal|"Invalid value configured for dfs.datanode.disk.check.min.gap"
operator|+
literal|" - -1 (should be>= 0)"
argument_list|,
parameter_list|()
lambda|->
operator|new
