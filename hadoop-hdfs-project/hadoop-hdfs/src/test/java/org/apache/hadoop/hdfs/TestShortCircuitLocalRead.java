...
DECL|method|checkFileContent (URI uri, Path name, byte[] expected, int readOffset, String readingUser, Configuration conf, boolean shortCircuitFails)
specifier|static
name|void
...
condition|)
block|{
comment|// short circuit should be disabled due to failure
name|assertFalse
argument_list|(
name|fs
operator|.
...
DECL|method|checkFileContentDirect (URI uri, Path name, byte[] expected, int readOffset, String readingUser, Configuration conf, boolean shortCircuitFails)
specifier|static
name|void
...
DECL|method|doTestShortCircuitRead (boolean ignoreChecksum, int size, int readOffset, String shortCircuitUser, String readingUser, boolean shortCircuitFails)
specifier|public
name|void
name|doTestShortCircuitRead
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|getProxy (UserGroupInformation ugi, final DatanodeID dnInfo, final Configuration conf)
specifier|private
name|ClientDatanodeProtocol
name|getProxy
parameter_list|(
...
literal|10000
argument_list|)
DECL|method|testGetBlockLocalPathInfo ()
specifier|public
name|void
name|testGetBlockLocalPathInfo
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|DFS_BLOCK_LOCAL_PATH_ACCESS_USER_KEY
argument_list|,
literal|"alloweduser1,alloweduser2"
argument_list|)
expr_stmt|;
name|MiniDFSCluster
name|cluster
...
argument_list|)
expr_stmt|;
comment|// Try with the other allowed user
name|proxy
operator|=
name|getProxy
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// This should succeed as well
name|blpi
operator|=
name|proxy
operator|.
...
argument_list|)
expr_stmt|;
comment|// Now try with a disallowed user
name|UserGroupInformation
name|bUgi
init|=
name|UserGroupInformation
...
name|fail
argument_list|(
literal|"The call should have failed as "
operator|+
name|bUgi
operator|.
name|getShortUserName
