...
argument_list|)
expr_stmt|;
comment|//save namespace should fail
try|try
block|{
name|dfs
operator|.
...
expr_stmt|;
block|}
comment|//start checkpoint should fail
try|try
block|{
name|NameNodeAdapter
operator|.
...
argument_list|)
decl_stmt|;
comment|// use "started" option for ignoring upgrade marker in editlog
name|StartupOption
operator|.
name|ROLLINGUPGRADE
operator|.
...
name|info
argument_list|(
literal|"RESTART cluster 2 with -rollingupgrade started"
argument_list|)
expr_stmt|;
name|cluster2
operator|.
...
name|info
argument_list|(
literal|"RESTART cluster 2 with -rollingupgrade started again"
argument_list|)
expr_stmt|;
name|cluster2
operator|.
...
name|class
argument_list|)
DECL|method|testSecondaryNameNode ()
specifier|public
name|void
name|testSecondaryNameNode
parameter_list|()
throws|throws
name|Exception
block|{
