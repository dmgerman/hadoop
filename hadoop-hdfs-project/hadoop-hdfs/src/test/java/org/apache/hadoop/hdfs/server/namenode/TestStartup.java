...
name|assertExceptionContains
argument_list|(
literal|"Cannot set a negative value for the maximum size of an xattr"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
try|try
block|{
comment|// Set up a logger to check log message
specifier|final
name|LogVerificationAppender
name|appender
init|=
...
argument_list|(
literal|"Maximum size of an xattr: 0 (unlimited)"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
literal|"Expected no messages about unlimited xattr size"
argument_list|,
literal|0
argument_list|,
name|count
...
argument_list|)
expr_stmt|;
comment|// happens twice because we format then run
name|assertEquals
argument_list|(
literal|"Expected unlimited xattr size"
argument_list|,
literal|2
argument_list|,
name|count
