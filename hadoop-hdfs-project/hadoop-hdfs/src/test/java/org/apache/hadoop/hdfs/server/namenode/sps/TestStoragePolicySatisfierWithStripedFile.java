...
argument_list|()
expr_stmt|;
comment|// Sets external listener for assertion.
name|blkMoveListener
operator|.
name|clear
argument_list|()
...
block|}
block|}
DECL|method|waitForAttemptedItems (MiniDFSCluster cluster, long expectedBlkMovAttemptedCount, int timeout)
specifier|private
name|void
name|waitForAttemptedItems
parameter_list|(
...
name|assertNotNull
argument_list|(
literal|"Didn't set external block move listener"
argument_list|,
name|blkMoveListener
argument_list|)
expr_stmt|;
