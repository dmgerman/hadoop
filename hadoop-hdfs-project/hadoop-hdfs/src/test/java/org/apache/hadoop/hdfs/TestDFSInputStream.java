...
annotation|@
name|Test
DECL|method|testNullCheckSumWhenDNRestarted ()
specifier|public
name|void
name|testNullCheckSumWhenDNRestarted
parameter_list|()
throws|throws
name|IOException
throws|,
...
expr_stmt|;
block|}
comment|// wait for block to load
name|Thread
operator|.
name|sleep
argument_list|(
...
name|assertTrue
argument_list|(
literal|"DN start should be success and live dn should be 2"
argument_list|,
name|live
operator|.
name|size
