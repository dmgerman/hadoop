...
argument_list|()
expr_stmt|;
comment|// Make sure that we can't start the cluster normally before recovery
name|cluster
operator|=
literal|null
expr_stmt|;
...
name|fail
argument_list|(
literal|"expected the truncated edit log to prevent normal startup"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|debug
argument_list|(
literal|"testRecoverTruncatedEditLog: successfully recovered the "
operator|+
literal|"truncated edit log"
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
