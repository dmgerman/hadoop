...
annotation|@
name|Test
DECL|method|testExceedingFileSpaceQuota ()
specifier|public
name|void
name|testExceedingFileSpaceQuota
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"should have thrown exception during the write"
argument_list|)
expr_stmt|;
block|}
catch|catch
