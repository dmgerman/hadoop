...
expr_stmt|;
block|}
comment|/**    * Tests for journal node addresses.    * @throws Exception    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|10000
argument_list|)
DECL|method|testGetJournalNodes ()
specifier|public
name|void
name|testGetJournalNodes
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// With out Name service Id
name|HdfsConfiguration
name|conf
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|//Federation with HA, but suffixed only with Name service Id
name|setupNameServices
argument_list|(
name|conf
argument_list|,
...
argument_list|()
expr_stmt|;
comment|// Name service setup, but no journal node
name|setupNameServices
argument_list|(
name|conf
argument_list|,
...
argument_list|()
expr_stmt|;
comment|//name node edits dir is present, but set
comment|//to location of storage shared directory
name|conf
operator|.
name|set
argument_list|(
name|DFS_NAMENODE_SHARED_EDITS_DIR_KEY
argument_list|,
literal|"file:///mnt/filer1/dfs/ha-name-dir-shared"
argument_list|)
expr_stmt|;
name|expected
operator|=
...
expr_stmt|;
block|}
comment|/*    ** Test for unknown journal node host exception.   */
annotation|@
name|Test
argument_list|(
name|expected
...
literal|10000
argument_list|)
DECL|method|testUnknownJournalNodeHost ()
specifier|public
name|void
name|testUnknownJournalNodeHost
parameter_list|()
throws|throws
name|URISyntaxException
throws|,
...
expr_stmt|;
block|}
comment|/*    ** Test for malformed journal node urisyntax exception.   */
annotation|@
name|Test
argument_list|(
name|expected
...
literal|10000
argument_list|)
DECL|method|testJournalNodeUriError ()
specifier|public
name|void
name|testJournalNodeUriError
parameter_list|()
throws|throws
name|URISyntaxException
throws|,
