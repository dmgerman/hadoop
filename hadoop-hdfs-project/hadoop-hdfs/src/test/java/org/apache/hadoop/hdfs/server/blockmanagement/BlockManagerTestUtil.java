...
expr_stmt|;
block|}
comment|/**    * @return a tuple of the replica state (number racks, number live    * replicas, number needed replicas and number of UpgradeDomains) for the    * given block.    */
...
return|;
block|}
comment|/**    * @return the number of UpgradeDomains over which a given block is replicated    * decommissioning/decommissioned nodes are not counted. corrupt replicas    * are also ignored.    */
DECL|method|getNumberOfDomains (final BlockManager blockManager, final Block b)
specifier|private
specifier|static
name|int
name|getNumberOfDomains
