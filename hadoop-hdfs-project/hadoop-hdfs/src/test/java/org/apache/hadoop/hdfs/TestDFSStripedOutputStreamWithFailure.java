...
block|}
block|}
comment|/**    * When all the two DataNodes with partial data block fail    */
annotation|@
name|Test
DECL|method|runTestWithMultipleFailure2 ()
specifier|public
name|void
name|runTestWithMultipleFailure2
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// two DNs have cellSize and the other DNs have cellSize*2
specifier|final
name|int
name|length
init|=
