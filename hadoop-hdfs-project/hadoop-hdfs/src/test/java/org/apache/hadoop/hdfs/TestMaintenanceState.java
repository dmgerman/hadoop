...
literal|120000
argument_list|)
DECL|method|testReportMaintenanceNodes ()
specifier|public
name|void
name|testReportMaintenanceNodes
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"Starting testReportMaintenanceNodes"
argument_list|)
expr_stmt|;
name|int
name|expirationInMs
...
name|containsString
argument_list|(
literal|"Entering maintenance datanodes (0):"
argument_list|)
argument_list|,
name|containsString
argument_list|(
literal|"In maintenance datanodes (0):"
argument_list|)
argument_list|,
name|not
argument_list|(
...
name|Path
argument_list|(
literal|"/testReportMaintenanceNodes.dat"
argument_list|)
decl_stmt|;
name|writeFile
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// Request maintenance for DataNodes1. The DataNode1 will not transition
comment|// to the next state AdminStates.IN_MAINTENANCE immediately since there
comment|// are not enough candidate nodes to satisfy the min maintenance
comment|// replication.
name|DatanodeInfo
name|maintenanceDN
init|=
...
name|containsString
argument_list|(
literal|"Entering maintenance datanodes (1):"
argument_list|)
argument_list|,
name|containsString
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// start a new datanode to make state transition to
comment|// AdminStates.IN_MAINTENANCE
name|getCluster
argument_list|()
operator|.
name|startDataNodes
...
name|containsString
argument_list|(
literal|"In maintenance datanodes (1):"
argument_list|)
argument_list|,
name|containsString
argument_list|(
