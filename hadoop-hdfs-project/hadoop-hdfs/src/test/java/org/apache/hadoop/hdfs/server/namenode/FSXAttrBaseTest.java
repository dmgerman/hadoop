...
comment|// ignore
block|}
comment|/*              * Test that only root can see raw.* xattrs returned from listXAttr              * and non-root can't do listXAttrs on /.reserved/raw.              */
comment|// non-raw path
specifier|final
name|List
argument_list|<
...
name|fail
argument_list|(
literal|"listXAttrs on raw path should have thrown"
argument_list|)
expr_stmt|;
block|}
catch|catch
