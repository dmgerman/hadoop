...
argument_list|)
decl_stmt|;
DECL|field|failedToConsumeBacklog
specifier|private
specifier|volatile
name|boolean
name|failedToConsumeBacklog
decl_stmt|;
...
block|}
block|}
DECL|method|assumeBacklogConsumed ()
specifier|private
name|void
name|assumeBacklogConsumed
parameter_list|()
...
name|AssumptionViolatedException
argument_list|(
literal|"failed to fill up connection backlog."
argument_list|)
throw|;
block|}
block|}
