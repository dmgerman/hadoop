...
literal|1
decl_stmt|;
DECL|field|storageCount
specifier|private
specifier|final
name|int
name|storageCount
decl_stmt|;
DECL|method|TestSimulatedFSDataset ()
specifier|public
name|TestSimulatedFSDataset
parameter_list|()
block|{
...
expr_stmt|;
block|}
DECL|method|TestSimulatedFSDataset (int storageCount)
specifier|protected
name|TestSimulatedFSDataset
parameter_list|(
name|int
...
argument_list|()
decl_stmt|;
name|assertBlockReportCountAndSize
argument_list|(
name|fsdataset
argument_list|,
literal|0
...
argument_list|)
expr_stmt|;
name|assertBlockLengthInBlockReports
argument_list|(
name|fsdataset
argument_list|)
expr_stmt|;
...
argument_list|()
decl_stmt|;
name|injectBlocksFromBlockReport
argument_list|(
name|fsdataset
argument_list|,
name|sfsdataset
...
block|}
block|}
comment|/**    * Inject all of the blocks returned from sourceFSDataset's block reports    * into destinationFSDataset.    */
DECL|method|injectBlocksFromBlockReport (SimulatedFSDataset sourceFSDataset, SimulatedFSDataset destinationFSDataset)
specifier|private
name|void
name|injectBlocksFromBlockReport
parameter_list|(
name|SimulatedFSDataset
name|sourceFSDataset
parameter_list|,
name|SimulatedFSDataset
name|destinationFSDataset
parameter_list|)
throws|throws
name|IOException
block|{
...
block|}
block|}
comment|/**    * Assert that the number of block reports returned from fsdataset matches    * {@code storageCount}, and that the total number of blocks is equal to    * expectedBlockCount.    */
DECL|method|assertBlockReportCountAndSize (SimulatedFSDataset fsdataset, int expectedBlockCount)
specifier|private
name|void
name|assertBlockReportCountAndSize
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Convenience method to call {@link #assertBlockLengthInBlockReports(    * SimulatedFSDataset,SimulatedFSDataset)} with a null second parameter.    */
DECL|method|assertBlockLengthInBlockReports (SimulatedFSDataset fsdataset)
specifier|private
name|void
name|assertBlockLengthInBlockReports
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Assert that, for all of the blocks in the block report(s) returned from    * fsdataset, they are not null and their length matches the expectation.    * If otherFSDataset is non-null, additionally confirm that its idea of the    * length of the block matches as well.    */
DECL|method|assertBlockLengthInBlockReports (SimulatedFSDataset fsdataset, SimulatedFSDataset otherFSDataset)
specifier|private
name|void
name|assertBlockLengthInBlockReports
parameter_list|(
