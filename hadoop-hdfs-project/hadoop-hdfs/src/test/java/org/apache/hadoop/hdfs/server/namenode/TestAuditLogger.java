...
argument_list|()
decl_stmt|;
comment|// Set up mock FSDirectory to test FSN audit logging during failure
specifier|final
name|FSDirectory
name|mockedDir
init|=
...
name|AccessControlException
argument_list|(
literal|"mock getAclStatus exception"
argument_list|)
argument_list|)
operator|.
name|when
...
name|AccessControlException
argument_list|(
literal|"mock removeAcl exception"
argument_list|)
argument_list|)
operator|.
name|when
...
name|AccessControlException
argument_list|(
literal|"mock removeDefaultAcl exception"
argument_list|)
argument_list|)
operator|.
name|when
...
name|AccessControlException
argument_list|(
literal|"mock removeAclEntries exception"
argument_list|)
argument_list|)
operator|.
name|when
...
name|AccessControlException
argument_list|(
literal|"mock modifyAclEntries exception"
argument_list|)
argument_list|)
operator|.
name|when
...
argument_list|)
expr_stmt|;
comment|// Replace the FSD with the mock FSD.
name|cluster
operator|.
name|getNamesystem
argument_list|()
