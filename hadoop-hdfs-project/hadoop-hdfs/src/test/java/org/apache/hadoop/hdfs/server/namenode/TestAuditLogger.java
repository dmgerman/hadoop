...
name|endsWith
argument_list|(
literal|"callerContext=setTimes\n"
argument_list|)
argument_list|)
expr_stmt|;
name|auditlog
...
name|endsWith
argument_list|(
literal|"callerContext=setTimes:L\n"
argument_list|)
argument_list|)
expr_stmt|;
name|auditlog
...
name|endsWith
argument_list|(
literal|"callerContext=setPermission:L\n"
argument_list|)
argument_list|)
expr_stmt|;
name|auditlog
...
name|endsWith
argument_list|(
literal|"callerContext=mkdirs:L\n"
argument_list|)
argument_list|)
expr_stmt|;
name|auditlog
...
argument_list|()
expr_stmt|;
comment|// caller context with too long signature is abandoned
name|context
operator|=
operator|new
name|CallerContext
