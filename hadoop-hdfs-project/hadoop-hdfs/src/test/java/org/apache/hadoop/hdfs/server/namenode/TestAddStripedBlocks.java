...
annotation|@
name|Test
DECL|method|testStripedFlagInBlockLocation ()
specifier|public
name|void
name|testStripedFlagInBlockLocation
parameter_list|()
throws|throws
name|IOException
block|{
...
name|Path
argument_list|(
literal|"/blockLocation/replicated"
argument_list|)
decl_stmt|;
try|try
init|(
...
name|write
argument_list|(
literal|"this is a replicated file"
operator|.
name|getBytes
argument_list|()
argument_list|)
...
name|assertEquals
argument_list|(
literal|"There should be exactly one Block present"
argument_list|,
literal|1
argument_list|,
name|locations
...
name|write
argument_list|(
literal|"this is a striped file"
operator|.
name|getBytes
argument_list|()
argument_list|)
...
name|assertTrue
argument_list|(
literal|"The file is not Striped"
argument_list|,
name|locations
index|[
literal|0
