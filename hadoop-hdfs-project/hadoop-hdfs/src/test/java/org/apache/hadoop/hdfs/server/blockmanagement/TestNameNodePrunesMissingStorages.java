...
literal|300000
argument_list|)
DECL|method|testInterleavedFullBlockReports ()
specifier|public
name|void
name|testInterleavedFullBlockReports
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Get the datanode registration and the block reports
name|DataNode
name|dn
init|=
name|cluster
...
argument_list|()
decl_stmt|;
comment|// Send the full block report concurrently using
comment|// numThreads=numStoragesPerDatanode
name|ExecutorService
name|executorService
init|=
name|Executors
