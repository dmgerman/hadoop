...
literal|0
decl_stmt|;
DECL|field|FAKE_EDIT_STREAM_NAME
specifier|private
specifier|static
specifier|final
name|String
name|FAKE_EDIT_STREAM_NAME
init|=
literal|"FAKE_STREAM"
decl_stmt|;
...
annotation|@
name|Test
DECL|method|setLoadFSEditLogThrottling ()
specifier|public
name|void
name|setLoadFSEditLogThrottling
parameter_list|()
throws|throws
name|Exception
block|{
...
name|loadFSEdits
argument_list|(
name|getFakeEditLogInputStream
argument_list|(
literal|1
argument_list|,
literal|10
...
name|contains
argument_list|(
literal|"suppressed logging 1 times"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"total size 2.0"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|getFakeEditLogInputStream (long startTx, long endTx)
specifier|private
