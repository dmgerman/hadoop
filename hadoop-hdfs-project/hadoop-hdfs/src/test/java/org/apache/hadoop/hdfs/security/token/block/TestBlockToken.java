...
annotation|@
name|Test
DECL|method|testRetrievePasswordWithUnknownFields ()
specifier|public
name|void
name|testRetrievePasswordWithUnknownFields
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
expr_stmt|;
comment|// write something at the end that BlockTokenIdentifier#readFields()
comment|// will ignore, but which is still a part of the password
name|out
operator|.
name|write
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// master create password
name|byte
index|[]
name|password
init|=
...
argument_list|)
expr_stmt|;
comment|// slave retrieve password
name|assertArrayEquals
argument_list|(
name|password
argument_list|,
...
annotation|@
name|Test
DECL|method|testRetrievePasswordWithRecognizableFieldsOnly ()
specifier|public
name|void
name|testRetrievePasswordWithRecognizableFieldsOnly
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// set cache to null, so that master getBytes() were only recognizable bytes
name|masterId
operator|.
name|setExpiryDate
argument_list|(
...
expr_stmt|;
block|}
comment|/** Test for last in-progress block token expiry.    * 1. Write file with one block which is in-progress.    * 2. Open input stream and close the output stream.    * 3. Wait for block token expiration and read the data.    * 4. Read should be success.    */
annotation|@
name|Test
DECL|method|testLastLocatedBlockTokenExpiry ()
specifier|public
name|void
name|testLastLocatedBlockTokenExpiry
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|()
expr_stmt|;
comment|// wait for last block token to expire
name|Thread
operator|.
name|sleep
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// DFSInputStream#refetchLocations() minimum wait for 1sec to refetch
comment|// complete located blocks.
name|assertTrue
argument_list|(
literal|"Should not wait for refetch complete located blocks"
argument_list|,
literal|1000L
operator|>
operator|(
