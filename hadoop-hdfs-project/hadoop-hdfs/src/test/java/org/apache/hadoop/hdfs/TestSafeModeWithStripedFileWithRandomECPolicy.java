...
begin_comment
comment|/**  * This test extends TestSafeModeWithStripedFile to use a random  * (non-default) EC policy.  */
end_comment

begin_class
DECL|class|TestSafeModeWithStripedFileWithRandomECPolicy
specifier|public
class|class
name|TestSafeModeWithStripedFileWithRandomECPolicy
extends|extends
...
name|ecPolicy
decl_stmt|;
DECL|method|TestSafeModeWithStripedFileWithRandomECPolicy ()
specifier|public
name|TestSafeModeWithStripedFileWithRandomECPolicy
parameter_list|()
block|{
