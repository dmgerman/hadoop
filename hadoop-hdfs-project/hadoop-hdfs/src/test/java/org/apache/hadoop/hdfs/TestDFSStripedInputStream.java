...
annotation|@
name|Test
DECL|method|testReadWhenLastIncompleteCellComeInToDecodeAlignedStripe ()
specifier|public
name|void
name|testReadWhenLastIncompleteCellComeInToDecodeAlignedStripe
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|//1. File with one stripe, last data cell should be half filed.
name|long
name|fileLength
init|=
operator|(
...
argument_list|)
expr_stmt|;
comment|//2. Stop first DN from stripe.
name|LocatedBlocks
name|lbs
init|=
name|cluster
...
argument_list|)
expr_stmt|;
comment|//3. Do pread for fist cell, reconstruction should happen
try|try
init|(
name|FSDataInputStream
name|in
