...
literal|120000
argument_list|)
DECL|method|testNodesPerInterval ()
specifier|public
name|void
name|testNodesPerInterval
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Set the deprecated configuration key which limits the # of nodes per
comment|// interval
name|newConf
operator|.
name|setInt
...
argument_list|()
decl_stmt|;
comment|// Write a 3 block file, so each node has one block. Should scan 1 node
comment|// each time.
name|DFSTestUtil
operator|.
name|createFile
