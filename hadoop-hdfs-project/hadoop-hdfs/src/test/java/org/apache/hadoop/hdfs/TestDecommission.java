...
name|HostFileManager
operator|.
name|dnsResolutionDisabledForTesting
operator|=
literal|false
expr_stmt|;
comment|// Setup conf
...
literal|360000
argument_list|)
DECL|method|testBackgroundDnsResolution ()
specifier|public
name|void
name|testBackgroundDnsResolution
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|()
expr_stmt|;
comment|// Set up an includes file with just 127.0.0.1
name|ArrayList
argument_list|<
name|String
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// The DN will be marked dead because DNS resolution was turned off,
comment|// and we are in the include file by hostname only.
name|DFSClient
name|client
init|=
name|getDfsClient
...
expr_stmt|;
block|}
comment|// Allow hostname resolution
name|HostFileManager
operator|.
name|dnsResolutionDisabledForTesting
operator|=
