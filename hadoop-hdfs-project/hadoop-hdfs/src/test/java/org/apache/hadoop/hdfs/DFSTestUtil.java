...
return|;
block|}
DECL|method|createECFile (MiniDFSCluster cluster, Path file, Path dir, int numBlocks, int numStripesPerBlk)
specifier|public
specifier|static
name|void
name|createECFile
...
block|}
block|}
DECL|method|createBlock (List<DataNode> dataNodes, DistributedFileSystem fs, FSNamesystem ns, String file, INodeFile fileNode, String clientName, ExtendedBlock previous, int numStripes)
specifier|static
name|Block
name|createBlock
parameter_list|(
