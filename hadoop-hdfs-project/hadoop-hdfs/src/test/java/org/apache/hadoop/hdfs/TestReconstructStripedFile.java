...
return|;
block|}
DECL|method|writeFile (DistributedFileSystem fs, String fileName, int fileLen)
specifier|private
specifier|static
name|void
name|writeFile
...
specifier|public
name|void
name|testNNSendsErasureCodingTasks
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testNNSendsErasureCodingTasks (int deadDN)
specifier|private
name|void
name|testNNSendsErasureCodingTasks
parameter_list|(
...
expr_stmt|;
block|}
comment|// Inject data-loss by tear down desired number of DataNodes.
name|assumeTrue
argument_list|(
literal|"Ignore case where num dead DNs> num parity units"
argument_list|,
name|policy
operator|.
name|getNumParityUnits
...
argument_list|)
expr_stmt|;
comment|// Make sure that all pending reconstruction tasks can be processed.
while|while
condition|(
name|ns
operator|.
...
name|format
argument_list|(
literal|"Found %d timeout pending reconstruction tasks"
argument_list|,
name|timeoutPending
argument_list|)
argument_list|,
...
expr_stmt|;
block|}
comment|// Verify all DN reaches zero xmitsInProgress.
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
...
literal|180000
argument_list|)
DECL|method|testErasureCodingWorkerXmitsWeight ()
specifier|public
name|void
name|testErasureCodingWorkerXmitsWeight
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testErasureCodingWorkerXmitsWeight ( float weight, int expectedWeight)
specifier|private
name|void
name|testErasureCodingWorkerXmitsWeight
parameter_list|(
...
name|Exception
block|{
comment|// Reset cluster with customized xmits weight.
name|conf
operator|.
name|setFloat
argument_list|(
