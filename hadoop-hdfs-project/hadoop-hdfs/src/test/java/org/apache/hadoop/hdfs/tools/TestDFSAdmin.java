...
argument_list|()
expr_stmt|;
comment|/* invoke getDatanodeInfo */
name|ret
operator|=
name|ToolRunner
operator|.
...
name|assertTrue
argument_list|(
literal|"Unexpected getDatanodeInfo stdout"
argument_list|,
name|outs
operator|.
name|isEmpty
