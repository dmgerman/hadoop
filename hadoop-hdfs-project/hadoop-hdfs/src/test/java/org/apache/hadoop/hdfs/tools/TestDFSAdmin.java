...
argument_list|()
decl_stmt|;
comment|/* run and verify report command */
name|resetStream
argument_list|()
expr_stmt|;
name|assertEquals
...
block|}
block|}
DECL|method|verifyNodesAndCorruptBlocks ( final int numDn, final int numLiveDn, final int numCorruptBlocks, final DFSClient client)
specifier|private
name|void
name|verifyNodesAndCorruptBlocks
parameter_list|(
