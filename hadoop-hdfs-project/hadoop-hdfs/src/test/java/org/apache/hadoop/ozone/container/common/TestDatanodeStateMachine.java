...
specifier|public
name|void
name|testDatanodeStateMachineStartThread
parameter_list|()
throws|throws
name|IOException
throws|,
...
block|}
block|}
comment|/**    * Test state transition with a list of invalid SCM names,    * and verify the state transits to SHUTDOWN each time.    */
annotation|@
name|Test
DECL|method|testDatanodeStateMachineWithInvalidSCMNames ()
specifier|public
name|void
name|testDatanodeStateMachineWithInvalidSCMNames
parameter_list|()
throws|throws
name|Exception
block|{
