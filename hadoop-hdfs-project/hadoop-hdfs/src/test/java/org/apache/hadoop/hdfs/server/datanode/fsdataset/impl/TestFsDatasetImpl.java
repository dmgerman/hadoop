...
return|;
block|}
comment|/**    * Finds a new destination volume for block.    *    * @param block         - Extended Block    * @param fsDataSetImpl - FsDatasetImpl reference    * @throws IOException    */
DECL|method|getDestinationVolume (ExtendedBlock block, FsDatasetImpl fsDataSetImpl)
specifier|private
name|FsVolumeSpi
name|getDestinationVolume
parameter_list|(
...
literal|3000000
argument_list|)
DECL|method|testBlockReadOpWhileMovingBlock ()
specifier|public
name|void
name|testBlockReadOpWhileMovingBlock
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// Create test file with ASCII data
name|Path
name|filePath
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// Part 1: Read partial data from block
name|LOG
operator|.
name|info
argument_list|(
literal|"Reading partial data for block {} before moving it: "
argument_list|,
name|blk
operator|.
name|getBlock
...
argument_list|)
expr_stmt|;
comment|// Part 2: Move block and than read remaining block
name|FsDatasetImpl
name|fsDataSetImpl
init|=
operator|(
...
name|assertNotNull
argument_list|(
literal|"Destination volume should not be null."
argument_list|,
name|destVolume
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Trigger block report to update block info in NN
name|cluster
operator|.
...
argument_list|)
expr_stmt|;
comment|// Part 3: 1. Close the block reader
comment|// 2. Assert source block doesn't exist on initial volume
comment|// 3. Assert new file location for block is different
comment|// 4. Confirm client can read data from new location
name|blkReader
operator|.
name|close
argument_list|()
