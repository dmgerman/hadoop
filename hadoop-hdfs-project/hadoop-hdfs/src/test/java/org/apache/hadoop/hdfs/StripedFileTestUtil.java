...
argument_list|)
decl_stmt|;
comment|/*    * These values correspond to the values used by the system default erasure    * coding policy.    */
DECL|field|TEST_EC_POLICY
specifier|public
specifier|static
specifier|final
name|ErasureCodingPolicy
...
block|}
block|}
DECL|method|checkData (DistributedFileSystem dfs, Path srcPath, int length, List<DatanodeInfo> killedList, List<Long> oldGSList)
specifier|static
name|void
name|checkData
parameter_list|(
...
block|}
block|}
DECL|method|verifyParityBlocks (Configuration conf, final long size, final int cellSize, byte[][] dataBytes, byte[][] parityBytes, Set<Integer> checkSet)
specifier|static
name|void
name|verifyParityBlocks
parameter_list|(
