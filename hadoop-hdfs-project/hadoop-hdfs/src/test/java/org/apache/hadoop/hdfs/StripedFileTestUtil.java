...
expr_stmt|;
block|}
DECL|method|verifyPread (DistributedFileSystem fs, Path srcPath, int fileLength, byte[] expected, byte[] buf)
specifier|static
name|void
name|verifyPread
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|verifyPread (FileSystem fs, Path srcPath, int fileLength, byte[] expected, byte[] buf, ErasureCodingPolicy ecPolicy)
specifier|static
name|void
name|verifyPread
parameter_list|(
...
return|;
block|}
comment|/**    * Get non-default Erasure Coding Policy randomly.    * @return ErasureCodingPolicy    */
DECL|method|getRandomNonDefaultECPolicy ()
specifier|public
specifier|static
name|ErasureCodingPolicy
...
return|;
block|}
comment|/**    * Get all Erasure Coding Policies for Parameterized tests.    * @return Collection<Object[]>    */
DECL|method|getECPolicies ()
specifier|public
specifier|static
name|Collection
argument_list|<
