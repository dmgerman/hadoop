...
block|}
block|}
DECL|method|checkData (DistributedFileSystem dfs, Path srcPath, int length, int[] killedDnIndex, long oldGS)
specifier|static
name|void
name|checkData
parameter_list|(
...
block|}
block|}
DECL|method|verifyParityBlocks (Configuration conf, final long size, final int cellSize, byte[][] dataBytes, byte[][] parityBytes, int[] killedDnIndex)
specifier|static
name|void
name|verifyParityBlocks
parameter_list|(
