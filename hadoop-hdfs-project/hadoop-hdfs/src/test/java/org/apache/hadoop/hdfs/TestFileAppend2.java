...
expr_stmt|;
block|}
comment|/**    * Make sure when the block length after appending is less than 512 bytes, the    * checksum re-calculation and overwrite are performed correctly.    */
annotation|@
name|Test
DECL|method|testAppendLessThanChecksumChunk ()
specifier|public
name|void
name|testAppendLessThanChecksumChunk
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// flush but leave open
name|out
operator|.
name|hflush
argument_list|()
expr_stmt|;
comment|// read data to verify the replica's content and checksum are correct
name|FSDataInputStream
name|in
init|=
name|fs
