...
begin_comment
comment|/**  * This test extends TestFileStatusWithDefaultECPolicy to use a random  * (non-default) EC policy.  */
end_comment

begin_class
DECL|class|TestFileStatusWithRandomECPolicy
specifier|public
class|class
name|TestFileStatusWithRandomECPolicy
extends|extends
...
name|ecPolicy
decl_stmt|;
DECL|method|TestFileStatusWithRandomECPolicy ()
specifier|public
name|TestFileStatusWithRandomECPolicy
parameter_list|()
block|{
