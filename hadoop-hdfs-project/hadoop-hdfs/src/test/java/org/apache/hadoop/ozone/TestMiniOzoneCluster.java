...
argument_list|()
expr_stmt|;
comment|// make sure datanode.id file is correct
name|File
name|idPath
init|=
operator|new
...
control|)
block|{
comment|// Each datanode ID should match an entry in the ID file
name|assertTrue
argument_list|(
literal|"Datanode ID not found in ID file"
argument_list|,
name|ids
operator|.
name|contains
...
argument_list|)
expr_stmt|;
comment|// Write should avoid duplicate entries
name|File
name|noDupIDFile
init|=
operator|new
