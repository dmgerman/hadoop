...
parameter_list|)
block|{
comment|// Unfortunately, we can't assert on the message containing the
comment|// configuration key here.  That message is logged, but a more generic
comment|// fsimage loading exception propagates up to this layer.
name|GenericTestUtils
operator|.
name|assertExceptionContains
argument_list|(
