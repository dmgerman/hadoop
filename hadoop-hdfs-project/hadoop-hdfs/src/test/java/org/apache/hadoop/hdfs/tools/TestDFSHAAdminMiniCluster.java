...
argument_list|)
expr_stmt|;
comment|/*  This test case doesn't allow nn2 to transition to Active even with         forceActive switch since nn1 is already active  */
if|if
condition|(
name|nn1
operator|.
...
name|assertFalse
argument_list|(
literal|"Both namenodes cannot be active even though with forceActive"
argument_list|,
name|nn1
operator|.
name|isActiveState
