...
begin_comment
comment|/**  * A test class for {@link InstrumentedReentrantLock}.  */
end_comment

begin_class
DECL|class|TestInstrumentedReentrantLock
specifier|public
class|class
name|TestInstrumentedReentrantLock
block|{
DECL|field|LOG
specifier|static
specifier|final
...
block|}
decl_stmt|;
comment|// do not log warning when the lock held time is<= warningThreshold.
name|lock
operator|.
name|lock
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// log a warning when the lock held time exceeds the threshold.
name|lock
operator|.
name|lock
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// Ensure that nested acquisitions do not log.
name|wlogged
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// No warnings on nested release.
name|assertEquals
argument_list|(
literal|0
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Last release immediately logs.
name|assertEquals
argument_list|(
literal|0
argument_list|,
