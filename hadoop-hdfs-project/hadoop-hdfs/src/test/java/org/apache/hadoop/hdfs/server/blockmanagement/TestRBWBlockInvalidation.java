...
argument_list|()
decl_stmt|;
comment|// Deleting partial block and its meta information from the RBW folder
...
name|assertEquals
argument_list|(
literal|"The corrupt replica could not be invalidated"
argument_list|,
literal|0
argument_list|,
name|countReplicas
...
argument_list|)
expr_stmt|;
comment|/*        * Sleep for 3 seconds, for under replicated block to get replicated. As        * one second will be taken by ReplicationMonitor and one more second for        * invalidated block to get deleted from the datanode.        */
name|Thread
operator|.
name|sleep
argument_list|(
...
name|assertEquals
argument_list|(
literal|"There should be three live replicas"
argument_list|,
literal|3
argument_list|,
name|countReplicas
