...
annotation|@
name|Test
DECL|method|testAddProvidedStorage ()
specifier|public
name|void
name|testAddProvidedStorage
parameter_list|()
throws|throws
name|Exception
block|{
comment|// block with only provided storage
name|BlockInfo
name|blockInfo
init|=
operator|new
...
annotation|@
name|Test
DECL|method|testAddTwoStorageTypes ()
specifier|public
name|void
name|testAddTwoStorageTypes
parameter_list|()
throws|throws
name|Exception
block|{
comment|// block with only disk storage
name|BlockInfo
name|blockInfo
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// now add provided storage
name|DatanodeStorageInfo
name|providedStorage
init|=
name|mock
