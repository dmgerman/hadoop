...
return|;
block|}
DECL|method|getURIForAuxiliaryPort (int nnIndex)
name|URI
name|getURIForAuxiliaryPort
parameter_list|(
name|int
name|nnIndex
parameter_list|)
...
argument_list|(
literal|"No auxiliary port found"
argument_list|)
throw|;
block|}
name|URI
...
return|;
block|}
DECL|method|getNNIndexes (String nameserviceId)
specifier|public
name|List
argument_list|<
name|Integer
...
return|;
block|}
comment|/**    * Get the auxiliary port of NameNode, NameNode specified by index.    */
DECL|method|getNameNodeAuxiliaryPort ()
specifier|public
name|int
name|getNameNodeAuxiliaryPort
parameter_list|()
block|{
name|checkSingleNameNode
argument_list|()
...
return|;
block|}
comment|/**    * Gets the rpc port used by the NameNode at the given index, if the    * NameNode has multiple auxiliary ports configured, a arbitrary    * one is returned.    */
DECL|method|getNameNodeAuxiliaryPort (int nnIndex)
specifier|public
name|int
name|getNameNodeAuxiliaryPort
parameter_list|(
...
return|;
block|}
DECL|method|getFileSystemFromAuxiliaryPort ()
specifier|public
name|DistributedFileSystem
name|getFileSystemFromAuxiliaryPort
parameter_list|()
throws|throws
name|IOException
block|{
...
return|;
block|}
DECL|method|getFileSystemFromAuxiliaryPort (int nnIndex)
specifier|public
name|DistributedFileSystem
name|getFileSystemFromAuxiliaryPort
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|transitionToObserver (int nnIndex)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|rollEditLogAndTail (int nnIndex)
specifier|public
name|void
...
block|}
block|}
comment|/**    * Setup the namenode-level PROVIDED configurations, using the    * {@link InMemoryLevelDBAliasMapClient}.    *    * @param conf Configuration, which is modified, to enable provided storage.    *        This cannot be null.    */
DECL|method|setupNamenodeProvidedConfiguration (Configuration conf)
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
comment|/**    * Updates configuration objects with keys required to setup a secure    * {@link org.apache.hadoop.minikdc.MiniKdc} based DFS cluster.    * @param conf the configuration object to be updated    * @param userName username to be used in kerberos principal    * @param realm realm to be used in the kerberos principal    * @param keytab absolute path of the the keytab file    * @param keystoresDir absolute path of the keystore    * @param sslConfDir absolute path of the ssl conf dir    * @throws Exception    */
DECL|method|setupKerberosConfiguration (Configuration conf, String userName, String realm, String keytab, String keystoresDir, String sslConfDir)
specifier|public
specifier|static
name|void
