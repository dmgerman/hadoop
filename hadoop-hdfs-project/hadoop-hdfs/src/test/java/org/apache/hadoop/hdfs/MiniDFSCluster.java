...
literal|".testing"
decl_stmt|;
comment|// Changing this value may break some tests that assume it is 2.
DECL|field|DIRS_PER_DATANODE
specifier|public
specifier|static
specifier|final
name|int
...
name|secureResources
decl_stmt|;
DECL|method|DataNodeProperties (DataNode node, Configuration conf, String[] args, SecureResources secureResources)
name|DataNodeProperties
parameter_list|(
name|DataNode
name|node
...
name|nnId
decl_stmt|;
DECL|method|NameNodeInfo (NameNode nn, String nameserviceId, String nnId, Configuration conf)
name|NameNodeInfo
parameter_list|(
name|NameNode
name|nn
...
expr_stmt|;
block|}
DECL|method|createNameNode (int nnIndex, Configuration conf, int numDataNodes, boolean format, StartupOption operation, String clusterId, String nameserviceId, String nnId)
specifier|private
name|void
name|createNameNode
parameter_list|(
