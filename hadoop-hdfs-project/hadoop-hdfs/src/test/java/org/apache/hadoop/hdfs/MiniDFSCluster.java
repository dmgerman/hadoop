...
argument_list|)
decl_stmt|;
comment|// TODO in HDFS-1971: conf.set(DFS_NAMENODE_SHARED_EDITS_DIR_KEY, sharedEditsUri.toString());
block|}
block|}
comment|// Now start all the NNs in this nameservice.
name|int
name|i
init|=
literal|0
...
block|}
block|}
DECL|method|copyNameDirs (Configuration srcConf, Configuration dstConf)
specifier|private
name|void
name|copyNameDirs
parameter_list|(
...
return|;
block|}
DECL|method|getHaServiceClient (int nnIndex)
specifier|private
name|HAServiceProtocol
name|getHaServiceClient
parameter_list|(
name|int
name|nnIndex
parameter_list|)
