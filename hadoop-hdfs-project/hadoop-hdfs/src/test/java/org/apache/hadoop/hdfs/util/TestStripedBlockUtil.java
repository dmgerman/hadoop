...
return|;
block|}
DECL|method|createDummyLocatedBlock (long bgSize)
specifier|private
name|LocatedStripedBlock
...
argument_list|)
decl_stmt|;
comment|// This offset will cause overflow before HDFS-12860.
name|long
name|offsetInInternalBlk
init|=
name|Integer
operator|.
name|MAX_VALUE
...
literal|1
decl_stmt|;
comment|// each block is 4GB, each block group has 4GB * (6 + 3) = 36GB.
name|long
name|blockGroupSize
init|=
literal|4096L
