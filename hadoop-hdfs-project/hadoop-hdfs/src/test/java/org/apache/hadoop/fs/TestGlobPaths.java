...
block|{
DECL|method|run (FSTestWrapper wrap, FSTestWrapper unprivilegedWrapper, FileSystem fs, FileContext fc)
name|void
name|run
parameter_list|(
name|FSTestWrapper
...
name|FSTestWrapperGlobTest
block|{
DECL|method|run (FSTestWrapper wrap, FSTestWrapper unprivilegedWrap, FileSystem fs, FileContext fc)
specifier|public
name|void
name|run
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// These inodes don't show up via listStatus.
name|Assert
operator|.
name|assertEquals
argument_list|(
