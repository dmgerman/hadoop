...
name|contains
argument_list|(
literal|"less than the minimum required number of racks (3) "
operator|+
literal|"for the erasure coding policies: RS-3-2-1024k"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"for the erasure coding policies: RS-10-4-1024k, RS-3-2-1024k"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
