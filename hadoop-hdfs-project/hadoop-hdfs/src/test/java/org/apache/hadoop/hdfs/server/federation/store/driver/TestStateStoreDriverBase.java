...
name|IOException
block|{
comment|// TODO add record
return|return
literal|null
return|;
block|}
comment|/**    * Validate if a record is the same.    *    * @param original    * @param committed    * @param assertEquals Assert if the records are equal or just return.    * @return    * @throws IllegalArgumentException    * @throws IllegalAccessException    */
...
name|IOException
block|{
comment|// TODO add records to remove
block|}
