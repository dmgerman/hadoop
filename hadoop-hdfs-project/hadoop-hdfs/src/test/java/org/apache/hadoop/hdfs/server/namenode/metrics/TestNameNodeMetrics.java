...
annotation|@
name|Test
DECL|method|testEditLogTailing ()
specifier|public
name|void
name|testEditLogTailing
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// We need to get the metrics for the SBN (excluding the NN from dfs
comment|// cluster created in setUp() and the ANN).
name|MetricsRecordBuilder
name|rb
init|=
name|getMetrics
...
name|assertQuantileGauges
argument_list|(
literal|"EditLogTailInterval60s"
argument_list|,
name|rb
argument_list|)
expr_stmt|;
...
name|assertCounterGt
argument_list|(
literal|"EditLogFetchTimeNumOps"
argument_list|,
literal|0L
argument_list|,
name|rb
...
name|assertCounterGt
argument_list|(
literal|"NumEditLogLoadedNumOps"
argument_list|,
literal|0L
argument_list|,
name|rb
...
name|assertCounterGt
argument_list|(
literal|"EditLogTailIntervalNumOps"
argument_list|,
literal|0L
argument_list|,
name|rb
