...
expr_stmt|;
block|}
comment|/**    * Assert exception of setting xattr when exceeding quota.    */
annotation|@
name|Test
DECL|method|testSetXAttrExceedsQuota ()
specifier|public
name|void
name|testSetXAttrExceedsQuota
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**    * Test that an exception is thrown when adding an XAttr Feature to    * a snapshotted path    */
annotation|@
name|Test
DECL|method|testSetXAttrAfterSnapshotExceedsQuota ()
specifier|public
name|void
name|testSetXAttrAfterSnapshotExceedsQuota
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// This adds an XAttr feature, which can throw an exception
name|exception
operator|.
name|expect
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Assert exception of removing xattr when exceeding quota.    */
annotation|@
name|Test
DECL|method|testRemoveXAttrExceedsQuota ()
specifier|public
name|void
name|testRemoveXAttrExceedsQuota
parameter_list|()
throws|throws
name|Exception
block|{
