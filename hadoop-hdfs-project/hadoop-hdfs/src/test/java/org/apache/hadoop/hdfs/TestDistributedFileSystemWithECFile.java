...
literal|60000
argument_list|)
DECL|method|testReplayEditLogsForReplicatedFile ()
specifier|public
name|void
name|testReplayEditLogsForReplicatedFile
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Test RS(6,3) as default policy
name|int
name|numDataNodes
init|=
name|rs63
...
argument_list|)
expr_stmt|;
comment|// Create an erasure coded file with the default policy.
name|Path
name|ecFile
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Create a replicated file.
name|Path
name|replicatedFile
init|=
operator|new
...
expr_stmt|;
block|}
comment|// Create an EC file with a different policy.
name|Path
name|ecFile2
init|=
operator|new
...
expr_stmt|;
block|}
comment|// verify stats are correct
name|Long
name|totalBytesRead
init|=
literal|0L
...
argument_list|)
expr_stmt|;
comment|// verify thread local stats are correct
name|Long
name|totalBytesReadThread
init|=
literal|0L
decl_stmt|;
name|Long
name|ecBytesReadThread
init|=
literal|0L
decl_stmt|;
for|for
