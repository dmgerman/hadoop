...
argument_list|)
expr_stmt|;
comment|// Verify again with the old listOpenFiles(EnumSet<>) API
comment|// Just to verify old API's validity
name|verifyOpenFilesOld
argument_list|(
name|closedFileSet
argument_list|,
name|openFileMap
...
block|}
block|}
DECL|method|verifyOpenFilesHelper ( RemoteIterator<OpenFileEntry> openFilesRemoteItr, HashSet<Path> closedFiles, HashSet<Path> openFiles)
specifier|private
name|void
name|verifyOpenFilesHelper
parameter_list|(
name|RemoteIterator
argument_list|<
name|OpenFileEntry
...
expr_stmt|;
block|}
comment|/**    * Using deprecated HdfsAdmin#listOpenFiles(EnumSet<>) to verify open files.    */
annotation|@
...
DECL|method|verifyOpenFilesOld (HashSet<Path> closedFiles, HashMap<Path, FSDataOutputStream> openFileMap)
specifier|private
name|void
name|verifyOpenFilesOld
parameter_list|(
