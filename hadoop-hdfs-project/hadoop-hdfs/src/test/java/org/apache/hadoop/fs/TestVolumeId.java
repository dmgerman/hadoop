...
expr_stmt|;
block|}
comment|/*    * Test the VolumeId.INVALID_VOLUME_ID singleton.    */
annotation|@
name|Test
DECL|method|testInvalidId ()
specifier|public
name|void
name|testInvalidId
parameter_list|()
...
parameter_list|()
block|{
comment|// The #toString() return value is only checked for != null.
comment|// We cannot assert more.
name|String
name|strInvalid
init|=
name|VolumeId
