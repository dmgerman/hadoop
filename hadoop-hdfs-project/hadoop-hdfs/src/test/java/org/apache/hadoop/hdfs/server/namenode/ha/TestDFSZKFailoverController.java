...
block|}
block|}
comment|/**    * Test that, when automatic failover is enabled, the manual    * failover script refuses to run.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|10000
argument_list|)
DECL|method|testManualFailoverIsDisabled ()
specifier|public
name|void
name|testManualFailoverIsDisabled
parameter_list|()
throws|throws
name|Exception
block|{
