...
return|;
block|}
comment|/**    * Create a new datanode ID.    *    * @return DatanodeID    */
...
expr_stmt|;
block|}
comment|/**    * Asserts that a single node moves from Healthy to stale node if it misses    * the heartbeat.    *    * @throws IOException    * @throws InterruptedException    * @throws TimeoutException    */
annotation|@
name|Test
DECL|method|testScmDetectStaleNode ()
specifier|public
name|void
name|testScmDetectStaleNode
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|)
expr_stmt|;
comment|// Wait for 2 more seconds, 3 seconds is the stale window for this test
name|Thread
operator|.
name|sleep
argument_list|(
...
block|}
block|}
comment|/**    * Asserts that a single node moves from Healthy to dead node if it misses    * enough heartbeats.    *    * @throws IOException    * @throws InterruptedException    * @throws TimeoutException    */
annotation|@
name|Test
DECL|method|testScmDetectDeadNode ()
specifier|public
name|void
name|testScmDetectDeadNode
parameter_list|()
throws|throws
name|IOException
throws|,
...
block|}
block|}
comment|/**    * Asserts that if we get duplicate registration calls for a datanode, we will    * ignore it and LOG the error.    *    * @throws IOException    * @throws InterruptedException    * @throws TimeoutException    */
annotation|@
name|Test
DECL|method|testScmDuplicateRegistrationLogsError ()
specifier|public
name|void
name|testScmDuplicateRegistrationLogsError
parameter_list|()
throws|throws
name|IOException
throws|,
...
DECL|method|heartbeatNodeSet (NodeManager manager, List<DatanodeID> list, int sleepDuration)
specifier|private
name|void
...
DECL|method|createNodeSet (int count, String prefix)
specifier|private
name|List
argument_list|<
name|DatanodeID
...
DECL|method|findNodes (NodeManager nodeManager, int count, NodeManager.NODESTATE state)
specifier|private
name|boolean
name|findNodes
parameter_list|(
...
operator|+
literal|"flooded by heartbeats. Not able to keep up with the heartbeat "
operator|+
literal|"counts."
argument_list|)
argument_list|)
