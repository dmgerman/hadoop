...
name|println
argument_list|(
literal|"TestHANameNodesWithFederation:\n"
operator|+
name|DFSUtil
operator|.
name|addressMapToString
...
argument_list|)
expr_stmt|;
comment|// No nameservice was given and we can't determine which to use
comment|// as two nameservices could share a namenode ID.
name|assertEquals
argument_list|(
literal|null
argument_list|,
