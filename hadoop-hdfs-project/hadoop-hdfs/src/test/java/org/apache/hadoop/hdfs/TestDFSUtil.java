...
specifier|final
name|String
name|NS1_NN1_SERVICE_HOST
init|=
literal|"ns1-nn1.example.com:9840"
decl_stmt|;
specifier|final
name|String
name|NS1_NN2_SERVICE_HOST
init|=
literal|"ns1-nn2.example.com:9840"
decl_stmt|;
specifier|final
name|String
name|NS2_NN1_SERVICE_HOST
init|=
literal|"ns2-nn1.example.com:9840"
decl_stmt|;
specifier|final
name|String
name|NS2_NN2_SERVICE_HOST
init|=
literal|"ns2-nn2.example.com:9840"
decl_stmt|;
name|conf
operator|.
name|set
...
init|=
literal|"ns1-nn1.example.com:9821"
decl_stmt|;
specifier|final
name|String
name|NS1_NN1_HOST_DEFAULT_SVC
init|=
literal|"ns1-nn1.example.com:9840"
decl_stmt|;
specifier|final
...
argument_list|)
expr_stmt|;
comment|// The default service rpc address is used if no service address is defined
name|assertEquals
argument_list|(
name|NS1_NN1_HOST_DEFAULT_SVC
argument_list|,
...
annotation|@
name|Test
DECL|method|testGetNNServiceRpcAddresses ()
specifier|public
name|void
name|testGetNNServiceRpcAddresses
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// Service RPC present
specifier|final
name|String
name|SERVICE_RPC_ADDRESS
init|=
name|NN_HOST
operator|+
literal|":9292"
...
annotation|@
name|Test
DECL|method|testGetNNServiceRpcAddressesForHA ()
specifier|public
name|void
name|testGetNNServiceRpcAddressesForHA
parameter_list|()
throws|throws
name|IOException
block|{
...
name|NN1_HOST
init|=
literal|"nn1.example.com"
decl_stmt|;
specifier|final
name|String
name|NN2_HOST
init|=
literal|"nn2.example.com"
decl_stmt|;
name|conf
operator|.
name|set
...
argument_list|)
expr_stmt|;
comment|// Without Service RPC keys
name|Map
argument_list|<
name|String
argument_list|,
