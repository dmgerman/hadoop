...
argument_list|)
expr_stmt|;
comment|// Make sure that SPS xattr has been removed.
name|int
name|retryTime
init|=
literal|0
...
block|}
block|}
comment|/**    * Check whether file contains SPS xattr.    * @param fileName file name.    * @return true if file contains SPS xattr.    * @throws IOException    */
DECL|method|fileContainsSPSXAttr (Path fileName)
specifier|private
name|boolean
name|fileContainsSPSXAttr
parameter_list|(
