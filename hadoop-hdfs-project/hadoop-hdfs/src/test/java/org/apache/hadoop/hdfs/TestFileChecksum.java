...
block|}
block|}
comment|/**    * Subclasses may customize the conf to run the full set of tests under    * different conditions.    */
DECL|method|customizeConf (Configuration preparedConf)
specifier|protected
name|void
name|customizeConf
parameter_list|(
...
parameter_list|)
block|{   }
comment|/**    * Subclasses may override this method to indicate whether equivalent files    * in striped and replicated formats are expected to have the same    * overall FileChecksum.    */
...
return|;
block|}
comment|/**    * Subclasses may override this method to indicate whether equivalent files    * in replicated formats with different block sizes are expected to have the    * same overall FileChecksum.    */
...
return|;
block|}
comment|/**    * Subclasses may override this method to indicate whether checksums are    * supported for files where different blocks have different bytesPerCRC.    */
...
literal|90000
argument_list|)
DECL|method|testDifferentBlockSizeReplicatedFileChecksum ()
specifier|public
name|void
name|testDifferentBlockSizeReplicatedFileChecksum
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
name|String
name|replicatedFile1
init|=
literal|"/replicatedFile1"
decl_stmt|;
name|String
name|replicatedFile2
init|=
literal|"/replicatedFile2"
decl_stmt|;
name|DFSTestUtil
operator|.
name|writeFile
...
literal|90000
argument_list|)
DECL|method|testMixedBytesPerChecksum ()
specifier|public
name|void
name|testMixedBytesPerChecksum
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"/replicatedFile1"
decl_stmt|;
comment|// Split file into two parts.
name|byte
index|[]
name|fileDataPart1
init|=
...
argument_list|)
expr_stmt|;
comment|// Modify bytesPerCRC for second part that we append as separate block.
name|conf
operator|.
name|setInt
argument_list|(
