...
expr_stmt|;
block|}
comment|/**    * Tests that a Namenode in Observer state rejects any state transition    * request from ZKFC, as a result of namenode's participation in the ZK    * election before getting transition to Observer state, since Observer    * Namenode isn't supposed to participate in ZKFC elections.    */
annotation|@
name|Test
DECL|method|testObserverRejectZkfcCall ()
specifier|public
name|void
name|testObserverRejectZkfcCall
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|30000
argument_list|)
DECL|method|testElectionOnObserver ()
specifier|public
name|void
name|testElectionOnObserver
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Transition nn2 to Observer
name|System
operator|.
name|setIn
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Call recheckElectability
name|thr2
operator|.
name|zkfc
operator|.
...
argument_list|)
expr_stmt|;
comment|// This namenode is in observer state, it shouldn't join election
name|assertEquals
argument_list|(
literal|false
argument_list|,
...
expr_stmt|;
block|}
DECL|method|waitForZKFCState (DFSZKFailoverController zkfc, final HAServiceState state)
specifier|private
name|void
name|waitForZKFCState
parameter_list|(
