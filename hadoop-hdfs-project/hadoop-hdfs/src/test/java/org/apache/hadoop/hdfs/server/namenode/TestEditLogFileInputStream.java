...
annotation|@
name|Test
DECL|method|testByteStringLog ()
specifier|public
name|void
name|testByteStringLog
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Read the edit log and verify that all of the data is present
name|EnumMap
argument_list|<
name|FSEditLogOpCodes
argument_list|,
...
expr_stmt|;
block|}
comment|/**    * Regression test for HDFS-14557 which verifies that an edit log filled    * with only "-1" bytes is moved aside and does not prevent the Journal    * node from starting.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|60000
argument_list|)
DECL|method|testScanEditThatFailedDuringPreAllocate ()
specifier|public
name|void
name|testScanEditThatFailedDuringPreAllocate
parameter_list|()
throws|throws
name|Exception
block|{
