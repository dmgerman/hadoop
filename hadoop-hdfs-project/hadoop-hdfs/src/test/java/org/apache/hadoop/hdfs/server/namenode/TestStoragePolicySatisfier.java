...
argument_list|)
expr_stmt|;
comment|// Check other element traversed in order and R,S should not be added in
comment|// queue which we already removed from expected list
for|for
control|(
name|String
name|path
...
name|assertTrue
argument_list|(
literal|"Status should be IN_PROGRESS"
argument_list|,
name|StoragePolicySatisfyPathStatus
operator|.
name|IN_PROGRESS
