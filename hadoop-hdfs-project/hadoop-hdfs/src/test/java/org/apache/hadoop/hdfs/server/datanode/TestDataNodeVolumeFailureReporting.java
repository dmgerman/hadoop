...
expr_stmt|;
block|}
comment|/**    * Verify DataNode NumFailedVolumes and FailedStorageLocations    * after hot swap out of failed volume.    */
annotation|@
name|Test
DECL|method|testHotSwapOutFailedVolumeAndReporting ()
specifier|public
name|void
name|testHotSwapOutFailedVolumeAndReporting
parameter_list|()
throws|throws
name|Exception
block|{
...
name|ObjectName
argument_list|(
literal|"Hadoop:service=DataNode,name=FSDatasetState-"
operator|+
name|dn0
operator|.
...
comment|// Verify NumFailedVolumes and FailedStorageLocations are empty.
name|DataNodeTestUtils
operator|.
name|injectDataDirFailure
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Reconfigure disks without fixing the failed disk.
comment|// Verify NumFailedVolumes and FailedStorageLocations haven't changed.
try|try
block|{
name|dn0
operator|.
...
name|fail
argument_list|(
literal|"Reconfigure with failed disk should throw exception."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertTrue
argument_list|(
literal|"Reconfigure exception doesn't have expected path!"
argument_list|,
name|e
operator|.
name|getCause
...
argument_list|)
expr_stmt|;
comment|// Hot swap out the failed volume.
comment|// Verify NumFailedVolumes and FailedStorageLocations are reset.
name|String
name|dataDirs
init|=
name|dn0Vol2
...
argument_list|)
expr_stmt|;
comment|// Fail dn0Vol2.
comment|// Verify NumFailedVolumes and FailedStorageLocations are updated.
name|DataNodeTestUtils
operator|.
name|injectDataDirFailure
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Verify DataNode tolerating one disk failure.
name|assertTrue
argument_list|(
name|dn0
operator|.
