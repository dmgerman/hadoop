...
argument_list|)
expr_stmt|;
comment|// 19: clrQuota on the root directory ("/") should pass.
name|runCommand
argument_list|(
name|admin
argument_list|,
...
literal|30000
argument_list|)
DECL|method|testSetAndClearSpaceQuotaDirectoryNotExist ()
specifier|public
name|void
name|testSetAndClearSpaceQuotaDirectoryNotExist
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
comment|/* set space quota */
name|testSetAndClearSpaceQuotaDirectoryNotExistInternal
argument_list|(
operator|new
name|String
index|[]
...
expr_stmt|;
block|}
DECL|method|testSetAndClearSpaceQuotaDirectoryNotExistInternal ( final String[] args, final Path dir, final int cmdRet, final String cmdName)
specifier|private
name|void
name|testSetAndClearSpaceQuotaDirectoryNotExistInternal
parameter_list|(
...
annotation|@
name|Test
DECL|method|testSpaceQuotaExceptionOnClose ()
specifier|public
name|void
name|testSpaceQuotaExceptionOnClose
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testSpaceQuotaExceptionOnFlush ()
specifier|public
name|void
name|testSpaceQuotaExceptionOnFlush
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// get the lease renewer now so we can verify it later without calling
comment|// getLeaseRenewer, which will automatically add the client into it.
specifier|final
name|LeaseRenewer
name|leaseRenewer
init|=
...
parameter_list|)
block|{     }
comment|// even if we close the stream in finially, it won't help.
try|try
block|{
name|stream
operator|.
...
annotation|@
name|Test
DECL|method|testClrQuotaOnRoot ()
specifier|public
name|void
name|testClrQuotaOnRoot
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Test quota check of rename. Expect a QuotaExceedException.
name|dfs
operator|.
name|setQuotaByStorageType
argument_list|(
...
parameter_list|)
block|{     }
comment|// Set enough quota, expect a successful rename.
name|dfs
operator|.
name|setQuotaByStorageType
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Verify the storage type usage is properly updated on source and dst.
name|checkQuotaAndCount
argument_list|(
name|dfs
argument_list|,
name|srcDir
...
annotation|@
name|Test
DECL|method|testSpaceQuotaExceptionOnAppend ()
specifier|public
name|void
name|testSpaceQuotaExceptionOnAppend
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"close after append should fail"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|// quota and count should match.
DECL|method|checkQuotaAndCount (DistributedFileSystem fs, Path path)
specifier|private
name|void
name|checkQuotaAndCount
parameter_list|(
...
control|)
block|{
comment|// it will fail here, because the quota and consume is not handled right.
name|assertEquals
argument_list|(
name|qu
operator|.
