...
decl_stmt|;
comment|/**      * Get data-node in the form       *<host name> :<port>      * where port is a 6 digit integer.      * This is necessary in order to provide lexocographic ordering.      * Host names are all the same, the ordering goes by port numbers.      */
DECL|method|getNodeName (int port)
specifier|private
specifier|static
name|String
name|getNodeName
...
return|;
block|}
DECL|method|compareTo (String name)
specifier|public
name|int
name|compareTo
parameter_list|(
