...
specifier|public
name|void
name|testLazyTokenFetchForSWebhdfs
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|/* create SIMPLE client connection */
name|SecurityUtil
operator|.
name|setAuthenticationMethod
argument_list|(
...
argument_list|)
decl_stmt|;
comment|/* create KERBEROS client connection */
name|SecurityUtil
operator|.
name|setAuthenticationMethod
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// 1. Get initial token through kerberos client connection
name|Token
argument_list|<
name|DelegationTokenIdentifier
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// 2. Get token with previous token which gets from kerberos connection
comment|//    through SIMPLE client connection.
name|simpleFs
operator|.
name|setDelegationToken
argument_list|(
