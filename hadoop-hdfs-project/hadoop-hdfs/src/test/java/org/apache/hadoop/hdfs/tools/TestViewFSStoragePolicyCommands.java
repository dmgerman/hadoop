...
annotation|@
name|Test
DECL|method|testStoragePolicyCommandPathWithSchema ()
specifier|public
name|void
name|testStoragePolicyCommandPathWithSchema
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
name|checkCommandsWithUriPath
argument_list|(
name|pathHdfsSchema
argument_list|)
expr_stmt|;
comment|// Test with webhdfs:// schema
name|InetSocketAddress
name|httpAddress
init|=
name|cluster
...
expr_stmt|;
block|}
DECL|method|checkCommandsWithUriPath (String pathWithSchema)
specifier|private
name|void
name|checkCommandsWithUriPath
parameter_list|(
