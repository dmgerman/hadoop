...
name|cellSize
decl_stmt|;
DECL|field|locatedStripedBlock
specifier|private
name|LocatedStripedBlock
name|locatedStripedBlock
decl_stmt|;
...
block|}
block|}
DECL|method|verifyInvalidationWorkCounts (int blockInvalidateLimit)
specifier|private
name|void
name|verifyInvalidationWorkCounts
parameter_list|(
name|int
...
block|}
block|}
comment|/**    * Test if {@link BlockManager#computeInvalidateWork(int)}    * can schedule invalidate work correctly for the replicas.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|120000
argument_list|)
DECL|method|testComputeInvalidateReplicas ()
specifier|public
name|void
name|testComputeInvalidateReplicas
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
comment|/**    * Test if {@link BlockManager#computeInvalidateWork(int)}    * can schedule invalidate work correctly for the striped block groups.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|120000
argument_list|)
DECL|method|testComputeInvalidateStripedBlockGroups ()
specifier|public
name|void
name|testComputeInvalidateStripedBlockGroups
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
comment|/**    * Test if {@link BlockManager#computeInvalidateWork(int)}    * can schedule invalidate work correctly for both replicas and striped    * block groups, combined.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|120000
argument_list|)
DECL|method|testComputeInvalidate ()
specifier|public
name|void
name|testComputeInvalidate
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Invalidate blocks should include both Replicas and "
operator|+
literal|"Striped BlockGroups!"
argument_list|,
operator|(
name|long
operator|)
...
name|assertEquals
argument_list|(
literal|"Unexpected invalidate count for replicas!"
argument_list|,
name|totalReplicas
argument_list|,
name|invalidateBlocks
...
name|assertEquals
argument_list|(
literal|"Unexpected invalidate count for striped block groups!"
argument_list|,
name|totalStripedDataBlocks
argument_list|,
name|invalidateBlocks
...
name|int
name|totalBlockGroupsPerDataNode
init|=
name|totalBlockGroups
decl_stmt|;
name|int
name|totalReplicasPerDataNode
init|=
name|totalReplicas
operator|/
name|NUM_OF_DATANODES
