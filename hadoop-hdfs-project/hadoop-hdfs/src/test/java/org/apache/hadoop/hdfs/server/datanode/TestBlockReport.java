...
expr_stmt|;
block|}
DECL|method|getBlockReports (DataNode dn, String bpid)
specifier|private
specifier|static
name|StorageBlockReport
index|[]
...
return|;
block|}
comment|// Get block reports but modify the GS of one of the blocks.
DECL|method|getBlockReportsCorruptSingleBlockGS ( DataNode dn, String bpid)
specifier|private
specifier|static
name|StorageBlockReport
index|[]
name|getBlockReportsCorruptSingleBlockGS
parameter_list|(
name|DataNode
name|dn
parameter_list|,
