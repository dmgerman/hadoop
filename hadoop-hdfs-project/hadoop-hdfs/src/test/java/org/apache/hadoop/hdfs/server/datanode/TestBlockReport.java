...
begin_comment
comment|/**  * This test simulates a variety of situations when blocks are being  * intentionally corrupted, unexpectedly modified, and so on before a block  * report is happening.  *  * For each test case it runs two variations:  *  #1 - For a given DN, the first variation sends block reports for all  *       storages in a single call to the NN.  *  #2 - For a given DN, the second variation sends block reports for each  *       storage in a separate call.  *  * The behavior should be the same in either variation.  */
end_comment
...
return|;
block|}
comment|/**    * Utility routine to send block reports to the NN, either in a single call    * or reporting one storage per call.    *    * @param dnR    * @param poolId    * @param reports    * @param needtoSplit    * @throws IOException    */
DECL|method|sendBlockReports (DatanodeRegistration dnR, String poolId, StorageBlockReport[] reports, boolean needtoSplit)
specifier|private
name|void
...
block|}
block|}
comment|/**    * Test variations blockReport_01 through blockReport_09 with combined    * and split block reports.    */
annotation|@
name|Test
DECL|method|blockReportCombined_01 ()
specifier|public
name|void
name|blockReportCombined_01
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|blockReportSplit_01 ()
specifier|public
name|void
name|blockReportSplit_01
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|blockReportCombined_02 ()
specifier|public
name|void
name|blockReportCombined_02
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|blockReportSplit_02 ()
specifier|public
name|void
name|blockReportSplit_02
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|blockReportCombined_03 ()
specifier|public
name|void
name|blockReportCombined_03
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|blockReportSplit_03 ()
specifier|public
name|void
name|blockReportSplit_03
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|blockReportCombined_04 ()
specifier|public
name|void
name|blockReportCombined_04
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|blockReportSplit_04 ()
specifier|public
name|void
name|blockReportSplit_04
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|blockReportCombined_06 ()
specifier|public
name|void
name|blockReportCombined_06
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|blockReportSplit_06 ()
specifier|public
name|void
name|blockReportSplit_06
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|blockReportCombined_07 ()
specifier|public
name|void
name|blockReportCombined_07
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|blockReportSplit_07 ()
specifier|public
name|void
name|blockReportSplit_07
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|blockReportCombined_08 ()
specifier|public
name|void
name|blockReportCombined_08
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|blockReportSplit_08 ()
specifier|public
name|void
name|blockReportSplit_08
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|blockReportCombined_09 ()
specifier|public
name|void
name|blockReportCombined_09
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|blockReportSplit_09 ()
specifier|public
name|void
name|blockReportSplit_09
parameter_list|()
throws|throws
name|Exception
block|{
...
DECL|method|blockReport_01 (boolean splitBlockReports)
specifier|private
name|void
name|blockReport_01
parameter_list|(
name|boolean
name|splitBlockReports
parameter_list|)
throws|throws
name|IOException
block|{
...
DECL|method|blockReport_02 (boolean splitBlockReports)
specifier|private
name|void
name|blockReport_02
parameter_list|(
...
DECL|method|blockReport_03 (boolean splitBlockReports)
specifier|private
name|void
name|blockReport_03
parameter_list|(
...
DECL|method|blockReport_04 (boolean splitBlockReports)
specifier|private
name|void
name|blockReport_04
parameter_list|(
...
DECL|method|blockReport_06 (boolean splitBlockReports)
specifier|private
name|void
name|blockReport_06
parameter_list|(
...
DECL|method|blockReport_07 (boolean splitBlockReports)
specifier|private
name|void
name|blockReport_07
parameter_list|(
...
DECL|method|blockReport_08 (boolean splitBlockReports)
specifier|private
name|void
name|blockReport_08
parameter_list|(
...
comment|// block
DECL|method|blockReport_09 (boolean splitBlockReports)
specifier|private
name|void
name|blockReport_09
parameter_list|(
