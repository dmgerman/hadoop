...
block|}
block|}
comment|/**    * Tests default configuration values and configuration setting    * of locate following block delays and number of retries.    *    * Configuration values tested:    * - dfs.client.block.write.locateFollowingBlock.initial.delay.ms    * - dfs.client.block.write.locateFollowingBlock.max.delay.ms    * - dfs.client.block.write.locateFollowingBlock.retries    */
annotation|@
name|Test
DECL|method|testDFSClientConfigurationLocateFollowingBlock ()
specifier|public
name|void
name|testDFSClientConfigurationLocateFollowingBlock
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|final
name|int
name|initialDelayTestValue
init|=
literal|1000
decl_stmt|;
specifier|final
name|int
name|maxDelayTestValue
init|=
literal|35000
decl_stmt|;
specifier|final
...
literal|120000
argument_list|)
DECL|method|testLeaseRenewAndDFSOutputStreamDeadLock ()
specifier|public
name|void
name|testLeaseRenewAndDFSOutputStreamDeadLock
parameter_list|()
throws|throws
name|Exception
block|{
...
try|try
block|{
comment|//1. trigger get LeaseRenewer lock
name|Mockito
operator|.
name|doThrow
argument_list|(
...
argument_list|()
expr_stmt|;
comment|//2. trigger get DFSOutputStream lock
name|out1
operator|.
name|close
argument_list|()
...
block|}
block|}
DECL|class|SleepFixedTimeAnswer
specifier|private
specifier|static
class|class
name|SleepFixedTimeAnswer
...
name|sleepTime
decl_stmt|;
DECL|field|testLatch
specifier|private
specifier|final
name|CountDownLatch
name|testLatch
decl_stmt|;
DECL|method|SleepFixedTimeAnswer (int sleepTime, CountDownLatch latch)
name|SleepFixedTimeAnswer
parameter_list|(
name|int
name|sleepTime
