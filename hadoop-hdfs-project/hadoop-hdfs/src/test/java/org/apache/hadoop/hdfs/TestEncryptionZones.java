...
argument_list|)
expr_stmt|;
comment|// Now delete the encryption zone, recreate the dir, and take another snapshot
name|fsWrapper
operator|.
name|delete
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Now delete the snapshots out of order and verify the zones are still correct
name|fs
operator|.
name|deleteSnapshot
argument_list|(
