...
expr_stmt|;
block|}
comment|/**    * Tests encrypted files with same original content placed in two different    * EZ are not same in encrypted form.    */
annotation|@
name|Test
DECL|method|testEncryptionZonesDictCp ()
specifier|public
name|void
name|testEncryptionZonesDictCp
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Path
argument_list|(
literal|"/.reserved/raw/zone1/file"
argument_list|)
decl_stmt|;
specifier|final
name|Path
...
name|zone2
argument_list|,
literal|"/.reserved/raw/zone2/file"
argument_list|)
decl_stmt|;
comment|// 1. Create two encrypted zones
name|fs
operator|.
name|mkdirs
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 2. Create a file in one of the zones
name|DFSTestUtil
operator|.
name|createFile
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 3. Copy it to the other zone through /.raw/reserved
name|FileUtil
operator|.
name|copy
argument_list|(
...
name|fail
argument_list|(
literal|"Exception should be thrown while setting: "
operator|+
name|xattrName
operator|+
literal|" on file:"
...
name|contains
argument_list|(
literal|"does not belong to the key"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|assertTrue
argument_list|(
literal|"/zone1 dir is encrypted"
argument_list|,
name|fs
operator|.
name|getFileStatus
...
name|assertTrue
argument_list|(
literal|"/zone2 dir is encrypted"
argument_list|,
name|fs
operator|.
name|getFileStatus
...
argument_list|)
expr_stmt|;
comment|// 4. Now the decrypted contents of the files should be different.
name|DFSTestUtil
operator|.
...
argument_list|)
expr_stmt|;
comment|// 5. Encrypted contents of the files should be same.
name|DFSTestUtil
operator|.
name|verifyFilesEqual
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Ignore the key provider from NN.
name|clusterConf
operator|.
name|setBoolean
argument_list|(
...
name|assertEquals
argument_list|(
literal|"Expecting Key Provider for client config"
argument_list|,
literal|"dummy://foo:bar@test_provider1"
argument_list|,
name|cluster
...
name|assertNotEquals
argument_list|(
literal|"Key Provider for client and namenode is different"
argument_list|,
name|namenodeKeyProviderUri
argument_list|,
name|cluster
