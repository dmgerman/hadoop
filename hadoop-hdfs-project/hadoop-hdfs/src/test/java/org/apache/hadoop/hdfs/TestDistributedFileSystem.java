...
argument_list|)
expr_stmt|;
comment|// Get locations of blocks of the file
name|BlockLocation
index|[]
name|blockLocs
init|=
...
name|assertEquals
argument_list|(
literal|"Expected one HdfsBlockLocation for one 1-block file"
argument_list|,
literal|1
argument_list|,
name|locs
...
name|assertTrue
argument_list|(
literal|"Expected one valid and one invalid replica"
argument_list|,
operator|(
name|l
operator|.
