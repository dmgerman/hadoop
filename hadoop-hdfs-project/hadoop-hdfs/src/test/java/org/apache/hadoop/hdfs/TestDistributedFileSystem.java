...
block|}
block|}
comment|/**    * Tests DFSClient.close throws no ConcurrentModificationException if     * multiple files are open.    * Also tests that any cached sockets are closed. (HDFS-3359)    * Also tests deprecated listOpenFiles(EnumSet<>). (HDFS-14595)    */
annotation|@
name|Test
annotation|@
...
literal|"deprecation"
argument_list|)
comment|// call to listOpenFiles(EnumSet<>)
...
argument_list|)
expr_stmt|;
comment|// Test listOpenFiles(EnumSet<>)
name|List
argument_list|<
name|OpenFilesIterator
operator|.
...
name|assertTrue
argument_list|(
literal|"Two files should be open"
argument_list|,
name|listOpenFiles
operator|.
name|hasNext
...
name|assertEquals
argument_list|(
literal|"Mismatch of open files count"
argument_list|,
literal|2
argument_list|,
name|countOpenFiles
...
block|}
block|{
comment|// Test PathIsNotEmptyDirectoryException while deleting non-empty dir
name|FileSystem
name|fs
init|=
name|cluster
...
name|Path
argument_list|(
literal|"/tmp/nonEmptyDir/emptyFile"
argument_list|)
argument_list|)
operator|.
name|close
...
name|fail
argument_list|(
literal|"Expecting PathIsNotEmptyDirectoryException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
annotation|@
name|Test
DECL|method|testStatistics2 ()
specifier|public
name|void
name|testStatistics2
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|)
expr_stmt|;
comment|// Satisfy Storage Policy.
name|opCount
operator|=
name|getOpStatistics
argument_list|(
...
annotation|@
name|Test
DECL|method|testECStatistics ()
specifier|public
name|void
name|testECStatistics
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testCreateWithStoragePolicy ()
specifier|public
name|void
name|testCreateWithStoragePolicy
parameter_list|()
throws|throws
name|Throwable
block|{
...
argument_list|)
expr_stmt|;
comment|// Check with storage policy not specified.
name|outputStream
operator|=
name|fs
operator|.
...
argument_list|)
expr_stmt|;
comment|// Check with default storage policy.
name|outputStream
operator|=
name|fs
operator|.
...
annotation|@
name|Test
DECL|method|testListStatusOfSnapshotDirs ()
specifier|public
name|void
name|testListStatusOfSnapshotDirs
parameter_list|()
throws|throws
name|IOException
block|{
...
name|Path
argument_list|(
literal|"/parent/test1/dfsclose/file-0"
argument_list|)
argument_list|)
expr_stmt|;
name|Path
...
annotation|@
name|Test
DECL|method|testSuperUserPrivilege ()
specifier|public
name|void
name|testSuperUserPrivilege
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Create a non-super user.
name|UserGroupInformation
name|user
init|=
name|UserGroupInformation
...
name|createUserForTesting
argument_list|(
literal|"Non_SuperUser"
argument_list|,
operator|new
name|String
index|[]
block|{
literal|"Non_SuperGroup"
block|}
argument_list|)
decl_stmt|;
name|DistributedFileSystem
...
annotation|@
name|Test
DECL|method|testListingStoragePolicyNonSuperUser ()
specifier|public
name|void
name|testListingStoragePolicyNonSuperUser
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// remove erasure coding policy as a user without privilege
name|UserGroupInformation
name|fakeUGI
init|=
name|UserGroupInformation
...
annotation|@
name|Test
DECL|method|testEnableAndDisableErasureCodingPolicy ()
specifier|public
name|void
name|testEnableAndDisableErasureCodingPolicy
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//test enable a policy that doesn't exist
try|try
block|{
name|fs
operator|.
...
name|fail
argument_list|(
literal|"enable the policy that doesn't exist should fail"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
comment|// pass
block|}
comment|//test disable a policy that doesn't exist
try|try
block|{
name|fs
operator|.
...
name|fail
argument_list|(
literal|"disable the policy that doesn't exist should fail"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
comment|// pass
block|}
comment|// disable and enable erasure coding policy as a user without privilege
name|UserGroupInformation
name|fakeUGI
init|=
name|UserGroupInformation
...
annotation|@
name|Test
DECL|method|testStorageFavouredNodes ()
specifier|public
name|void
name|testStorageFavouredNodes
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|assertEquals
argument_list|(
literal|"Number of SSD should be 1 but was : "
operator|+
name|numSSD
argument_list|,
literal|1
