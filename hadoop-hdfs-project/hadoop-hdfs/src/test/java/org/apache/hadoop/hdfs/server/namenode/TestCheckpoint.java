...
literal|300000
argument_list|)
DECL|method|testActiveRejectSmallerDeltaImage ()
specifier|public
name|void
name|testActiveRejectSmallerDeltaImage
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Set the delta txid threshold to 10
name|conf
operator|.
name|setInt
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Set the delta time threshold to some arbitrarily large value, so
comment|// it does not trigger a checkpoint during this test.
name|conf
operator|.
name|setInt
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// enable small delta rejection
name|NameNode
name|active
init|=
name|cluster
...
expr_stmt|;
block|}
comment|// Checkpoint 1st
name|secondary
operator|.
name|doCheckpoint
argument_list|()
expr_stmt|;
comment|// at this point, the txid delta is smaller than threshold 10.
comment|// active does not accept this image.
name|assertEquals
argument_list|(
literal|0
argument_list|,
...
expr_stmt|;
block|}
comment|// Checkpoint 2nd
name|secondary
operator|.
name|doCheckpoint
argument_list|()
expr_stmt|;
comment|// here the delta is large enough and active accepts this image.
name|assertEquals
argument_list|(
literal|21
argument_list|,
