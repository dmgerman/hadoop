...
annotation|@
name|Test
DECL|method|testChooseSrcDatanodesWithDupEC ()
specifier|public
name|void
name|testChooseSrcDatanodesWithDupEC
parameter_list|()
throws|throws
name|Exception
block|{
...
init|=
operator|-
literal|9223372036854775776L
decl_stmt|;
comment|// real ec block id
name|Block
name|aBlock
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// striped blockInfo
name|BlockInfoStriped
name|aBlockInfoStriped
init|=
operator|new
name|BlockInfoStriped
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// link block with storage
name|aBlockInfoStriped
operator|.
name|addStorage
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// simulate the node 2 arrive maxReplicationStreams
for|for
control|(
name|int
name|i
...
name|assertEquals
argument_list|(
literal|"Choose the source node for reconstruction with one node reach"
operator|+
literal|" the MAX maxReplicationStreams, the numReplicas still return the"
operator|+
literal|" correct live replicas."
argument_list|,
literal|4
argument_list|,
name|numReplicas
...
literal|"Choose the source node for reconstruction with one node reach"
operator|+
literal|" the MAX maxReplicationStreams, the numReplicas should return"
operator|+
literal|" the correct redundant Internal Blocks."
argument_list|,
literal|1
argument_list|,
name|numReplicas
...
annotation|@
name|Test
DECL|method|testChooseSrcDNWithDupECInDecommissioningNode ()
specifier|public
name|void
name|testChooseSrcDNWithDupECInDecommissioningNode
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// NOTE: duplicate block 0ï¼this DN will replace the decommission ds1 DN
name|aBlockInfoStriped
operator|.
name|addStorage
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// decommission datanode where store block 0
name|ds1
operator|.
name|getDatanodeDescriptor
argument_list|()
...
name|assertEquals
argument_list|(
literal|"There are 5 live replicas in "
operator|+
literal|"[ds2, ds3, ds4, ds5, ds6] datanodes "
argument_list|,
literal|5
argument_list|,
name|numReplicas
...
name|assertEquals
argument_list|(
literal|"The ds1 datanode is in decommissioning, "
operator|+
literal|"so there is no redundant replica"
argument_list|,
literal|0
argument_list|,
name|numReplicas
...
expr_stmt|;
block|}
DECL|method|addEcBlockToBM (long blkId, ErasureCodingPolicy ecPolicy)
specifier|private
name|BlockInfo
name|addEcBlockToBM
parameter_list|(
...
block|}
block|}
comment|/**    * Unit test to check the race condition for adding a Block to    * postponedMisreplicatedBlocks set which may not present in BlockManager    * thus avoiding NullPointerException.    **/
annotation|@
name|Test
DECL|method|testMetaSavePostponedMisreplicatedBlocks ()
specifier|public
name|void
name|testMetaSavePostponedMisreplicatedBlocks
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertTrue
argument_list|(
literal|"Metasave output should not have null block "
argument_list|,
name|output
operator|.
name|contains
argument_list|(
literal|"Block blk_0_0 is Null"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
return|;
block|}
DECL|method|makeBlockReplicasMaintenance (long blockId, List<DatanodeDescriptor> nodesList)
specifier|private
name|BlockInfo
name|makeBlockReplicasMaintenance
parameter_list|(
name|long
name|blockId
parameter_list|,
...
annotation|@
name|Test
DECL|method|testMetaSaveInMaintenanceReplicas ()
specifier|public
name|void
name|testMetaSaveInMaintenanceReplicas
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Metasave output should not have reported "
operator|+
...
name|assertTrue
argument_list|(
literal|"There should be 1 block waiting for reconstruction"
argument_list|,
name|output
operator|.
name|contains
argument_list|(
literal|"Metasave: Blocks waiting for reconstruction: 1"
argument_list|)
argument_list|)
expr_stmt|;
name|String
...
name|blockNameGS
operator|+
literal|" should be list as maintenance."
argument_list|,
name|output
operator|.
name|contains
...
name|blockNameGS
operator|+
literal|" (replicas: live: 1 decommissioning "
operator|+
literal|"and decommissioned: 0 corrupt: 0 in excess: "
operator|+
literal|"0 maintenance mode: 1)"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
block|}
block|}
DECL|method|makeBlockReplicasDecommission (long blockId, List<DatanodeDescriptor> nodesList)
specifier|private
name|BlockInfo
name|makeBlockReplicasDecommission
parameter_list|(
name|long
name|blockId
parameter_list|,
...
annotation|@
name|Test
DECL|method|testMetaSaveDecommissioningReplicas ()
specifier|public
name|void
name|testMetaSaveDecommissioningReplicas
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|" (replicas: live: 1 decommissioning "
operator|+
literal|"and decommissioned: 1 corrupt: 0 in excess: "
operator|+
literal|"0 maintenance mode: 0)"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|testLegacyBlockInInvalidateBlocks ()
specifier|public
name|void
name|testLegacyBlockInInvalidateBlocks
parameter_list|()
block|{
specifier|final
name|long
name|legancyGenerationStampLimit
init|=
literal|10000
decl_stmt|;
name|BlockIdManager
