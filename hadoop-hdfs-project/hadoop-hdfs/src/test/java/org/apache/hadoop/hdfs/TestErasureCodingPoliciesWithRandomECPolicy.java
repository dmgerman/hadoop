...
begin_comment
comment|/**  * This test extends TestErasureCodingPolicies to use a random (non-default) EC  * policy.  */
end_comment

begin_class
DECL|class|TestErasureCodingPoliciesWithRandomECPolicy
specifier|public
class|class
name|TestErasureCodingPoliciesWithRandomECPolicy
extends|extends
...
name|ecPolicy
decl_stmt|;
DECL|method|TestErasureCodingPoliciesWithRandomECPolicy ()
specifier|public
name|TestErasureCodingPoliciesWithRandomECPolicy
parameter_list|()
block|{
