...
name|fail
argument_list|(
literal|"Expect exception when providing invalid snapshot name "
operator|+
literal|"for diff report"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"Expect exception when providing null fromSnapshot "
argument_list|)
expr_stmt|;
block|}
catch|catch
...
literal|60000
argument_list|)
DECL|method|testSnapRootDescendantDiffReport ()
specifier|public
name|void
name|testSnapRootDescendantDiffReport
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Unexpected exception when getting snapshot diff report "
operator|+
name|subSub
operator|+
literal|": "
...
name|fail
argument_list|(
literal|"Snapshot diff report on a non snapshot directory '"
operator|+
name|nonSnapDir
operator|.
name|getName
...
name|assertExceptionContains
argument_list|(
literal|"Directory is neither snapshottable nor under a snap root!"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
name|verifyDescendantDiffReports
argument_list|(
name|sub1
argument_list|,
name|subSub
...
expr_stmt|;
block|}
DECL|method|verifyDescendantDiffReports (final Path snapDir, final Path snapSubDir, final Path snapSubSubDir)
specifier|private
name|void
name|verifyDescendantDiffReports
parameter_list|(
...
annotation|@
name|Test
DECL|method|testSnapRootDescendantDiffReportWithRename ()
specifier|public
name|void
name|testSnapRootDescendantDiffReportWithRename
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Case 1: Move a file away from a descendant dir, but within the snap root.
comment|// mv<snaproot>/<subsub>/<subsubsub>/file20<snaproot>/<subsub>/file20
name|hdfs
operator|.
name|rename
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// The snapshot diff for the snap root detects the change as file rename
comment|// as the file move happened within the snap root.
name|verifyDiffReport
argument_list|(
name|sub1
argument_list|,
...
name|string2Bytes
argument_list|(
literal|"subsub1/subsubsub1/file20"
argument_list|)
argument_list|,
name|DFSUtil
operator|.
name|string2Bytes
argument_list|(
literal|"subsub1/file20"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
comment|// The snapshot diff for the descendant dir<subsub> still detects the
comment|// change as file rename as the file move happened under the snap root
comment|// descendant dir.
name|verifyDiffReport
argument_list|(
name|subSub
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// The snapshot diff for the descendant dir<subsubsub> detects the
comment|// change as file delete as the file got moved from its scope.
name|verifyDiffReport
argument_list|(
name|subSubSub
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Case 2: Move the file from the snap root descendant dir to any
comment|// non snap root dir. mv<snaproot>/<subsub>/file20<nonsnaproot>/file20.
name|hdfs
operator|.
name|rename
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// The snapshot diff for the snap root detects the change as file delete
comment|// as the file got moved away from the snap root dir to some non snap
comment|// root dir.
name|verifyDiffReport
argument_list|(
name|sub1
...
argument_list|)
expr_stmt|;
comment|// The snapshot diff for the snap root descendant<subsub> detects the
comment|// change as file delete as the file was previously under its scope and
comment|// got moved away from its scope.
name|verifyDiffReport
argument_list|(
name|subSub
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// The file was already not under the descendant dir<subsubsub> scope.
comment|// So, the snapshot diff report for the descendant dir doesn't
comment|// show the file rename at all.
name|verifyDiffReport
argument_list|(
name|subSubSub
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Case 3: Move the file from the non-snap root dir to snap root dir
comment|// mv<nonsnaproot>/file20<snaproot>/file20
name|hdfs
operator|.
name|rename
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Snap root directory should show the file moved in as a new file.
name|verifyDiffReport
argument_list|(
name|sub1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Snap descendant directories don't have visibility to the moved in file.
name|verifyDiffReport
argument_list|(
name|subSub
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Snap root directory now shows the rename as both source and
comment|// destination paths are under the snap root.
name|verifyDiffReport
argument_list|(
name|sub1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// For the descendant directory under the snap root, the file
comment|// moved in shows up as a new file created.
name|verifyDiffReport
argument_list|(
name|subSub
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Case 4: Snapshot diff for the newly created descendant directory.
name|Path
name|subSubSub2
init|=
operator|new
...
annotation|@
name|Test
DECL|method|testSnapshotDiffInfo ()
specifier|public
name|void
name|testSnapshotDiffInfo
parameter_list|()
throws|throws
name|Exception
block|{
name|Path
name|snapshotRootDirPath
init|=
name|dir
decl_stmt|;
name|Path
name|snapshotDirDescendantPath
init|=
operator|new
name|Path
argument_list|(
...
decl_stmt|;
name|Path
name|snapshotDirNonDescendantPath
init|=
operator|new
name|Path
argument_list|(
literal|"/dummy/non/snap/desc"
argument_list|)
decl_stmt|;
name|hdfs
operator|.
...
decl_stmt|;
name|INodeDirectory
name|snapshotRootDescendantDir
init|=
name|cluster
operator|.
name|getNameNode
...
decl_stmt|;
name|INodeDirectory
name|snapshotRootNonDescendantDir
init|=
name|cluster
operator|.
name|getNameNode
...
name|fail
argument_list|(
literal|"Unexpected exception when constructing SnapshotDiffInfo: "
operator|+
name|iae
argument_list|)
expr_stmt|;
...
name|fail
argument_list|(
literal|"SnapshotDiffInfo construction should fail for non snapshot root "
operator|+
literal|"or non snapshot root descendant directories!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|/**    * Tests to verfy the diff report with maximum SnapsdiffReportEntries limit    * over an rpc being set to 3.    * @throws Exception    */
annotation|@
name|Test
DECL|method|testDiffReportWithRpcLimit ()
specifier|public
name|void
name|testDiffReportWithRpcLimit
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testDiffReportWithRpcLimit2 ()
specifier|public
name|void
name|testDiffReportWithRpcLimit2
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//moves files from dir1 to dir4
name|Path
name|path
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|//overwrite existing files in dir3 from files in dir1
name|path
operator|=
operator|new
name|Path
...
expr_stmt|;
block|}
DECL|method|verifyDiffReportForGivenReport (Path dirPath, String from, String to, SnapshotDiffReport report, DiffReportEntry... entries)
specifier|private
name|void
name|verifyDiffReportForGivenReport
parameter_list|(
name|Path
name|dirPath
parameter_list|,
...
annotation|@
name|Test
DECL|method|testSnapshotDiffReportRemoteIterator ()
specifier|public
name|void
name|testSnapshotDiffReportRemoteIterator
parameter_list|()
throws|throws
name|Exception
block|{
...
name|hdfs
operator|.
name|snapshotDiffReportListingRemoteIterator
argument_list|(
name|root
argument_list|,
literal|"s0"
...
name|contains
argument_list|(
literal|"No more entry in SnapshotDiffReport for /"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
argument_list|)
expr_stmt|;
comment|// generate the snapshotDiffReport and Verify
name|snapshotDiffReport
operator|=
operator|new
name|SnapshotDiffReportGenerator
...
annotation|@
name|Test
DECL|method|testSnapshotDiffReportRemoteIterator2 ()
specifier|public
name|void
name|testSnapshotDiffReportRemoteIterator2
parameter_list|()
throws|throws
name|Exception
block|{
