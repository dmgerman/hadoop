...
begin_class
DECL|class|TestRefreshTokenTimeBasedTokenRefresher
specifier|public
class|class
name|TestRefreshTokenTimeBasedTokenRefresher
block|{
...
argument_list|)
decl_stmt|;
DECL|method|buildConf (String refreshToken, String tokenExpires, String clientId, String refreshURL)
specifier|public
name|Configuration
name|buildConf
parameter_list|(
...
literal|"/refresh"
argument_list|)
comment|// Note, OkHttp does not sort the param values, so we need to
comment|// do it ourselves via the ordering provided to ParameterBody...
operator|.
name|withBody
argument_list|(
name|ParameterBody
