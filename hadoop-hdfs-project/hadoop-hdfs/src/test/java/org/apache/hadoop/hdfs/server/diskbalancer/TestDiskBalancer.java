...
annotation|@
name|Test
DECL|method|testDiskBalancerComputeDelay ()
specifier|public
name|void
name|testDiskBalancerComputeDelay
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Mocking bandwidth as 10mb/sec.
name|Mockito
operator|.
name|doReturn
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// bytesCopied - 20 * 1024 *1024 byteCopied.
comment|// timeUsed - 1200 in milliseconds
comment|// item - set DiskBalancerWorkItem bandwidth as 10
comment|// Expect return sleep delay in Milliseconds. sleep value = bytesCopied /
comment|// (1024*1024*bandwidth in MB/milli) - timeUsed;
name|long
name|val
init|=
name|diskBalancerMover
