...
literal|60000
argument_list|)
DECL|method|testSnapshotMtime ()
specifier|public
name|void
name|testSnapshotMtime
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|60000
argument_list|)
DECL|method|testRenameSnapshotMtime ()
specifier|public
name|void
name|testRenameSnapshotMtime
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
name|Path
name|snapshotRenamePath
init|=
operator|new
name|Path
argument_list|(
literal|"/dir/.snapshot/s2"
argument_list|)
decl_stmt|;
name|FileStatus
name|newSnapshotStatus
