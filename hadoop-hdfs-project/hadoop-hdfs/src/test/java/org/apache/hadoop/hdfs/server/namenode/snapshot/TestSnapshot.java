...
return|;
block|}
comment|/**    * Main test, where we will go in the following loop:    *     *    Create snapshot and check the creation<--+      * -> Change the current/live files/dir         |     * -> Check previous snapshots -----------------+    */
annotation|@
name|Test
...
argument_list|)
decl_stmt|;
comment|// make changes to the current directory
name|modifyCurrentDirAndCheckSnapshots
argument_list|(
name|mods
argument_list|)
