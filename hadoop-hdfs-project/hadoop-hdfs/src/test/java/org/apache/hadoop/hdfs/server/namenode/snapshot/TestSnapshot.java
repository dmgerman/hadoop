...
argument_list|()
expr_stmt|;
comment|// later check fsnMiddle to see if the edit log is recorded and applied
comment|// correctly
name|out
operator|=
operator|new
...
expr_stmt|;
block|}
comment|/** compare two file's content */
DECL|method|compareFile (File file1, File file2)
specifier|private
name|void
name|compareFile
parameter_list|(
