...
argument_list|()
expr_stmt|;
comment|// later check fsnStrMiddle to see if the edit log is recorded and applied
comment|// correctly
name|StringBuffer
name|fsnStrMiddle
init|=
...
name|println
argument_list|(
literal|"================== FSDir After Applying Edit Logs =================="
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"================ FSDir After FSImage Saving/Loading ================"
argument_list|)
expr_stmt|;
name|System
operator|.
...
argument_list|)
decl_stmt|;
comment|// TODO: temporarily disable file append testing before supporting
comment|// INodeFileUnderConstructionWithSnapshot in FSImage saving/loading
...
return|;
block|}
comment|/**    * Generate a random snapshot name.    * @return The snapshot name    */
DECL|method|genSnapshotName ()
specifier|static
name|String
name|genSnapshotName
parameter_list|()
