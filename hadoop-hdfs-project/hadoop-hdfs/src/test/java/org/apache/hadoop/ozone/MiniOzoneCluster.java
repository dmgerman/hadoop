...
argument_list|)
decl_stmt|;
comment|// TODO: use the i-th raft server as the i-th datanode address
comment|//       this only work for one Raft cluster
name|setConf
argument_list|(
name|i
argument_list|,
...
name|info
argument_list|(
literal|"Waiting for cluster to be ready. Got {} of {} DN Heartbeats."
argument_list|,
name|scm
operator|.
name|getNodeCount
