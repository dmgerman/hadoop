...
return|;
block|}
comment|/**    * Creates an RPC proxy connected to this cluster's KeySpaceManager    * for accessing Key Space Manager information. Callers take ownership of    * the proxy and must close it when done.    *    * @return RPC proxy for accessing Key Space Manager information    * @throws IOException if there is an I/O error    */
specifier|public
name|KeySpaceManagerProtocolClientSideTranslatorPB
DECL|method|createKeySpaceManagerClient ()
...
name|info
argument_list|(
literal|"Creating KeySpaceManager RPC client with address {}"
argument_list|,
name|ksmAddress
argument_list|)
expr_stmt|;
