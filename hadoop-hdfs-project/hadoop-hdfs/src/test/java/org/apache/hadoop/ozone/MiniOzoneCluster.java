...
name|IllegalStateException
argument_list|(
literal|"Timed out waiting for Ozone cluster to become ready."
argument_list|)
throw|;
block|}
name|LOG
...
name|info
argument_list|(
literal|"Waiting for Ozone cluster to become ready"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|IllegalStateException
argument_list|(
literal|"Interrupted while waiting for Ozone cluster to become ready."
argument_list|)
throw|;
block|}
block|}
