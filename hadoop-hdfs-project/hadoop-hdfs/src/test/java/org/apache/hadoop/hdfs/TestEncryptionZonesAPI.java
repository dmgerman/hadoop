...
literal|60000
argument_list|)
DECL|method|testCreateEncryptionZoneAsNonSuperUser ()
specifier|public
name|void
name|testCreateEncryptionZoneAsNonSuperUser
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|60000
argument_list|)
DECL|method|testCreateEncryptionZoneDownAFewLevels ()
specifier|public
name|void
name|testCreateEncryptionZoneDownAFewLevels
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
argument_list|,
literal|"EncryptionZone \\[path=/test/foo/baz, keyId="
argument_list|)
expr_stmt|;
block|}
comment|/** Test failure of creating an EZ using a non-empty directory. */
