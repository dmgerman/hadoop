...
argument_list|()
decl_stmt|;
comment|// add a striped block which been left NUM_DATA_BLOCKS internal blocks
name|BlockInfo
name|block1
init|=
name|genStripedBlockInfo
...
argument_list|)
expr_stmt|;
comment|// add a striped block which been left NUM_DATA_BLOCKS+1 internal blocks
name|BlockInfo
name|block2
init|=
name|genStripedBlockInfo
...
argument_list|)
expr_stmt|;
comment|// add a striped block which been left NUM_DATA_BLOCKS+2 internal blocks
name|BlockInfo
name|block3
init|=
name|genStripedBlockInfo
