...
argument_list|)
expr_stmt|;
comment|// Force DataNode to report missing blocks.
name|dn
operator|.
name|scheduleAllBlockReport
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// The 2nd block only has 1 replica due to the removed data volume.
name|waitReplication
argument_list|(
name|fs
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Wait NameNode to replica missing blocks.
name|DFSTestUtil
operator|.
name|waitReplication
argument_list|(
