...
expr_stmt|;
block|}
comment|/**    * Test rename where src has snapshottable descendant directories and    * dst is a descent of a snapshottable directory. Such case will cause    * nested snapshot which HDFS currently not fully supported.    */
annotation|@
name|Test
DECL|method|testRenameWithNestedSnapshottableDirs ()
specifier|public
name|void
name|testRenameWithNestedSnapshottableDirs
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Except exception since "
operator|+
...
argument_list|()
operator|+
literal|" is a descent of a snapshottable directory, "
operator|+
literal|"and HDFS does not support nested snapshottable directory."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
literal|60000
argument_list|)
DECL|method|testDoubleRenamesWithSnapshotDelete ()
specifier|public
name|void
name|testDoubleRenamesWithSnapshotDelete
parameter_list|()
throws|throws
name|Exception
block|{
