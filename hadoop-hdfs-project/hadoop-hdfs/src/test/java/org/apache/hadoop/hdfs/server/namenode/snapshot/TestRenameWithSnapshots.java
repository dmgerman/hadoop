...
expr_stmt|;
block|}
DECL|method|checkSpaceConsumed (String message, Path directory, long expectedSpace)
specifier|private
name|void
name|checkSpaceConsumed
parameter_list|(
name|String
name|message
parameter_list|,
...
expr_stmt|;
block|}
comment|/**    * Runs through various combinations of renames, deletes, appends and other    * operations in a snapshotted directory and ensures disk usage summaries    * (e.g. du -s) are computed correctly.    *    * @throws Exception    */
annotation|@
name|Test
argument_list|(
name|timeout
...
argument_list|)
decl_stmt|;
comment|/* We will test with a single block worth of data. If we don't at least use     a multiple of BLOCKSIZE, append operations will modify snapshotted blocks     and other factors will come into play here that we'll have to account for */
specifier|final
name|long
name|spaceIncrement
init|=
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong immediately"
argument_list|,
name|dfsRoot
argument_list|,
literal|0L
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after creating / copying file"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after snapshotting"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after 1 rename"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after 2 renames"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after deletion"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after replacing a renamed file"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after 1 snapshot + append"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after 2 snapshot + appends"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after snapshot, append,& rename"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
argument_list|)
expr_stmt|;
comment|// everything but the last append is snapshotted
name|expectedSpace
operator|-=
name|spaceIncrement
expr_stmt|;
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after snapshot, append, delete& rename"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong after deleting all files and snapshots"
argument_list|,
name|dfsRoot
argument_list|,
name|expectedSpace
...
literal|300000
argument_list|)
DECL|method|testDuMultipleDirs ()
specifier|public
name|void
name|testDuMultipleDirs
parameter_list|()
throws|throws
name|Exception
block|{
...
name|dfsRoot
argument_list|,
literal|"snapshottable2"
argument_list|)
decl_stmt|;
specifier|final
name|Path
name|nonsnapshottable
init|=
operator|new
name|Path
argument_list|(
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in original dir after 1st snapshot"
argument_list|,
name|snapshottable1
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in original dir after 1st rename"
argument_list|,
name|snapshottable1
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in non-snapshottable dir after 1st rename"
argument_list|,
name|nonsnapshottable
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in root dir after 1st rename"
argument_list|,
name|dfsRoot
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in original dir after 2nd rename"
argument_list|,
name|snapshottable1
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in non-snapshottable dir after 2nd rename"
argument_list|,
name|nonsnapshottable
argument_list|,
literal|0
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in snapshottable dir after 2nd rename"
argument_list|,
name|snapshottable2
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in root dir after 2nd rename"
argument_list|,
name|dfsRoot
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in original dir after 3rd rename"
argument_list|,
name|snapshottable1
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in snapshottable dir after 3rd rename"
argument_list|,
name|snapshottable2
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in original subdirectory after 3rd rename"
argument_list|,
name|subdirectory
argument_list|,
name|spaceConsumed
...
name|checkSpaceConsumed
argument_list|(
literal|"Du is wrong in root dir after 3rd rename"
argument_list|,
name|dfsRoot
argument_list|,
name|spaceConsumed
