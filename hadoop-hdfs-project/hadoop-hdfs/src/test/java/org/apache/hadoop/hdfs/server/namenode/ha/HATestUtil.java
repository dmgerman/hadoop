...
return|;
block|}
DECL|method|configureObserverReadFs ( MiniDFSCluster cluster, Configuration conf, boolean isObserverReadEnabled)
specifier|public
specifier|static
name|DistributedFileSystem
...
return|;
block|}
DECL|method|setUpObserverCluster ( Configuration conf, int numObservers)
specifier|public
specifier|static
name|MiniQJMHACluster
