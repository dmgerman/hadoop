...
return|;
block|}
DECL|method|setUpObserverCluster ( Configuration conf, int numObservers, int numDataNodes, boolean fastTailing, long[] simulatedCapacities, String[] racks)
specifier|public
specifier|static
name|MiniQJMHACluster
name|setUpObserverCluster
...
parameter_list|>
name|void
DECL|method|setFailoverConfigurations (MiniDFSCluster cluster, Configuration conf, String logicalName, int nsIndex, Class<P> classFPP)
name|setFailoverConfigurations
parameter_list|(
name|MiniDFSCluster
name|cluster
...
parameter_list|>
name|void
DECL|method|setFailoverConfigurations (Configuration conf, String logicalName, List<InetSocketAddress> nnAddresses, Class<P> classFPP)
name|setFailoverConfigurations
parameter_list|(
name|Configuration
name|conf
