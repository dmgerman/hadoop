...
annotation|@
name|Test
DECL|method|testRequestFromNonObserverProxyProvider ()
specifier|public
name|void
name|testRequestFromNonObserverProxyProvider
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Create another HDFS client using ConfiguredFailoverProvider
name|Configuration
name|conf2
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// Populate the above configuration with only a single observer in the
comment|// namenode list. Also reduce retries to make test finish faster.
name|HATestUtil
operator|.
...
try|try
block|{
comment|// Request should be rejected by observer and throw StandbyException
name|dfs2
operator|.
name|listStatus
argument_list|(
...
name|fail
argument_list|(
literal|"listStatus should have thrown exception"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertTrue
argument_list|(
literal|"should have thrown StandbyException but got "
operator|+
name|e
operator|.
name|getClass
