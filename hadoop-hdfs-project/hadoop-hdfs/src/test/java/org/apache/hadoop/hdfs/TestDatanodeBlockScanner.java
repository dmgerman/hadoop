...
block|}
block|}
comment|/**  * This test verifies whether block is added to the first location of   * BlockPoolSliceScanner#blockInfoSet  */
annotation|@
name|Test
DECL|method|testAddBlockInfoToFirstLocation ()
specifier|public
name|void
name|testAddBlockInfoToFirstLocation
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Creating a bunch of blocks
for|for
control|(
name|int
name|i
...
expr_stmt|;
block|}
comment|// Get block of the first file created (file1)
name|ExtendedBlock
name|block
init|=
name|DFSTestUtil
...
argument_list|)
expr_stmt|;
comment|// Let it sleep for more than 5 seconds so that BlockPoolSliceScanner can
comment|// scan the first set of blocks
name|Thread
operator|.
name|sleep
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// Create another set of blocks
for|for
control|(
name|int
name|i
...
argument_list|)
expr_stmt|;
comment|// Sleep so that BlockPoolSliceScanner can scan the second set of blocks
comment|// and one block which we scheduled to rescan
name|Thread
operator|.
name|sleep
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Get the lastScanTime of all of the second set of blocks
name|Set
argument_list|<
name|Long
argument_list|>
name|lastScanTimeSet
init|=
operator|new
name|HashSet
argument_list|<
...
name|assertTrue
argument_list|(
literal|"The second scanTime for test1 block should be greater than "
operator|+
literal|"first scanTime"
argument_list|,
name|scanTime2Fortest1Block
operator|>
name|scanTime1Fortest1Block
...
name|assertTrue
argument_list|(
literal|"The second scanTime for test1 block should be less than or"
operator|+
literal|" equal to minimum of the lastScanTime of second set of blocks"
argument_list|,
name|scanTime2Fortest1Block
operator|<=
name|minimumLastScanTime
