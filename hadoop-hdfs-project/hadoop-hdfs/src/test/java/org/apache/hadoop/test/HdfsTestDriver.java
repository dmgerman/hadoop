...
begin_comment
comment|/**  * Driver for HDFS tests. The tests should NOT depend on map-reduce APIs.  */
end_comment

begin_class
DECL|class|HdfsTestDriver
specifier|public
class|class
name|HdfsTestDriver
block|{
...
expr_stmt|;
block|}
DECL|method|HdfsTestDriver (ProgramDriver pgd)
specifier|public
name|HdfsTestDriver
parameter_list|(
name|ProgramDriver
