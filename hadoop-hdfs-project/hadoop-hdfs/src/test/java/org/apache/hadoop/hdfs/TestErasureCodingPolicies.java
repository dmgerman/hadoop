...
annotation|@
name|Test
DECL|method|testContentSummaryOfECSubdir ()
specifier|public
name|void
name|testContentSummaryOfECSubdir
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testErasureCodingPolicyOnReservedDir ()
specifier|public
name|void
name|testErasureCodingPolicyOnReservedDir
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// root EC policy before being set is null, verify the reserved raw dir
comment|// is treated as root
specifier|final
name|Path
name|root
init|=
...
argument_list|)
expr_stmt|;
comment|// verify the EC policy correctness under the reserved raw dir
specifier|final
name|Path
name|ecDir
init|=
