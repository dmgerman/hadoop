...
argument_list|,
literal|"org.apache.hadoop.hdfs.server.blockmanagement.BlockPlacementPolicyWithNodeGroup"
argument_list|)
expr_stmt|;
name|CONF
operator|.
...
argument_list|,
literal|"org.apache.hadoop.net.NetworkTopologyWithNodeGroup"
argument_list|)
expr_stmt|;
name|File
name|baseDir
...
name|Exception
block|{
comment|// Cleanup nodes in previous tests
for|for
control|(
name|int
name|i
