...
DECL|method|checkTargetsOnDifferentNodeGroup ( DatanodeDescriptor[] targets)
specifier|private
specifier|static
name|boolean
...
return|;
block|}
DECL|method|chooseTarget (int numOfReplicas, List<DatanodeDescriptor> chosenNodes)
specifier|private
name|DatanodeDescriptor
index|[]
name|chooseTarget
...
return|;
block|}
DECL|method|chooseTarget (int numOfReplicas, DatanodeDescriptor writer, List<DatanodeDescriptor> chosenNodes)
specifier|private
name|DatanodeDescriptor
index|[]
name|chooseTarget
...
return|;
block|}
DECL|method|chooseTarget ( int numOfReplicas, DatanodeDescriptor writer, List<DatanodeDescriptor> chosenNodes, Map<Node, Node> excludedNodes)
specifier|private
name|DatanodeDescriptor
index|[]
name|chooseTarget
...
expr_stmt|;
block|}
DECL|method|verifyNoTwoTargetsOnSameNodeGroup (DatanodeDescriptor[] targets)
specifier|private
name|void
name|verifyNoTwoTargetsOnSameNodeGroup
parameter_list|(
