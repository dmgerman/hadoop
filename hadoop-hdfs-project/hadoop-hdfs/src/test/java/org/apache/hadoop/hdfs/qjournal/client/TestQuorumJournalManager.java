...
name|equals
argument_list|(
literal|"testSelectThreadCounts"
argument_list|)
condition|)
block|{
...
expr_stmt|;
block|}
comment|// Turn off IPC client caching to handle daemon restarts.
name|conf
operator|.
name|setInt
argument_list|(
...
annotation|@
name|Test
DECL|method|testSelectViaRpcWithDurableTransactions ()
specifier|public
name|void
name|testSelectViaRpcWithDurableTransactions
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Two loggers will have up to ID 5, one will have up to ID 6
name|failLoggerAtTxn
argument_list|(
name|spies
operator|.
...
annotation|@
name|Test
DECL|method|testSelectViaRpcWithoutDurableTransactions ()
specifier|public
name|void
name|testSelectViaRpcWithoutDurableTransactions
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testSelectViaRpcOneDeadJN ()
specifier|public
name|void
name|testSelectViaRpcOneDeadJN
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testSelectViaRpcTwoDeadJNs ()
specifier|public
name|void
name|testSelectViaRpcTwoDeadJNs
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testSelectThreadCounts ()
specifier|public
name|void
name|testSelectThreadCounts
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// The number of threads for the stopped jn shouldn't be more than the
comment|// configured value.
name|assertTrue
argument_list|(
literal|"Number of threads are : "
operator|+
name|num
argument_list|,
name|num
...
annotation|@
name|Test
DECL|method|testSelectViaRpcTwoJNsError ()
specifier|public
name|void
name|testSelectViaRpcTwoJNsError
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// This should still succeed as the QJM should fall back to the streaming
comment|// mechanism for fetching edits
name|verifyEdits
argument_list|(
name|streams
argument_list|,
...
annotation|@
name|Test
DECL|method|testSelectViaRpcAfterJNRestart ()
specifier|public
name|void
name|testSelectViaRpcAfterJNRestart
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Close to avoid connections hanging around after the JNs are restarted
for|for
control|(
name|int
name|i
