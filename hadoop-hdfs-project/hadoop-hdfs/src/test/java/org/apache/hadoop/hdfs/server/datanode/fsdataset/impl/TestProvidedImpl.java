...
block|}
block|}
comment|/**    * Tests that a ProvidedReplica supports path handles.    *    * @throws Exception    */
annotation|@
name|Test
DECL|method|testProvidedReplicaWithPathHandle ()
specifier|public
name|void
name|testProvidedReplicaWithPathHandle
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// read should continue succeeding after the rename operation
name|IOUtils
operator|.
name|readFully
argument_list|(
...
try|try
block|{
comment|// expected to fail as URI of the provided replica is no longer valid.
name|replica
operator|.
name|getDataInputStream
argument_list|(
