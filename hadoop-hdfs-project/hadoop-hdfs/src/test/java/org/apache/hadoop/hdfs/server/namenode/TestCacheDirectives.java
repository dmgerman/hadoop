...
expr_stmt|;
block|}
DECL|method|waitForCachedStats (final DistributedFileSystem dfs, final long targetFilesAffected, final long targetBytesNeeded, final long targetBytesCached, final CacheDirectiveInfo filter, final String infoString)
specifier|private
specifier|static
name|void
name|waitForCachedStats
parameter_list|(
specifier|final
name|DistributedFileSystem
name|dfs
...
name|info
argument_list|(
literal|"Polling listDirectives{"
operator|+
operator|(
operator|(
name|filter
...
literal|120000
argument_list|)
DECL|method|testAddingCacheDirectiveInfosWhenCachingIsDisabled ()
specifier|public
name|void
name|testAddingCacheDirectiveInfosWhenCachingIsDisabled
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|0
argument_list|,
literal|"testAddingCacheDirectiveInfosWhenCachingIsDisabled:0"
argument_list|)
expr_stmt|;
comment|// Cache and check each path in sequence
name|int
...
literal|0
argument_list|,
literal|"testAddingCacheDirectiveInfosWhenCachingIsDisabled:1"
argument_list|)
expr_stmt|;
block|}
name|Thread
...
literal|0
argument_list|,
literal|"testAddingCacheDirectiveInfosWhenCachingIsDisabled:2"
argument_list|)
expr_stmt|;
block|}
finally|finally
...
literal|10
argument_list|,
literal|"testWaitForCachedReplicasInDirectory:3"
argument_list|)
expr_stmt|;
...
argument_list|()
argument_list|,
literal|"testWaitForCachedReplicasInDirectory:4"
argument_list|)
expr_stmt|;
...
argument_list|()
argument_list|,
literal|"testWaitForCachedReplicasInDirectory:5"
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"testWaitForCachedReplicasInDirectory:6"
argument_list|)
expr_stmt|;
block|}
finally|finally
