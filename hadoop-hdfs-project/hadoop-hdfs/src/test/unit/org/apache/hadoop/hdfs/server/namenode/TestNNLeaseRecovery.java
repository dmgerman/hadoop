...
expr_stmt|;
block|}
DECL|method|mockFileBlocks (int fileBlocksNumber, HdfsServerConstants.BlockUCState penUltState, HdfsServerConstants.BlockUCState lastState, Path file, DatanodeDescriptor dnd, PermissionStatus ps, boolean setStoredBlock)
specifier|private
name|void
name|mockFileBlocks
parameter_list|(
