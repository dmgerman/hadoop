...
name|warn
argument_list|(
literal|"Haven't noticed any partial overwrite for a sequential file"
operator|+
literal|" write requests. Treat it as a real random write, no support."
argument_list|)
expr_stmt|;
name|response
operator|=
...
name|offset
operator|+
literal|", update the memory count."
argument_list|)
expr_stmt|;
block|}
