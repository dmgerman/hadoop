...
return|;
block|}
DECL|method|getNamenodeId (Configuration conf, URI namenodeURI)
specifier|public
specifier|static
name|int
name|getNamenodeId
...
return|;
block|}
DECL|method|getResolvedURI (FileSystem fs, String exportPath)
specifier|public
specifier|static
name|URI
name|getResolvedURI
...
name|FileSystemException
argument_list|(
literal|"Only HDFS is supported as underlying"
operator|+
literal|"FileSystem, fs scheme:"
operator|+
name|scheme
operator|+
literal|" uri to be added"
operator|+
name|fsURI
argument_list|)
throw|;
