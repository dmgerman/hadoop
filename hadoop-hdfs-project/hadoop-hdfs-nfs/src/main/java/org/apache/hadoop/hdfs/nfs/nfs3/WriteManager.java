...
return|return;
block|}
DECL|method|handleCommit (FileHandle fileHandle, long commitOffset)
name|boolean
name|handleCommit
parameter_list|(
name|FileHandle
...
name|info
argument_list|(
literal|"Inactive stream, fileId="
operator|+
name|fileHandle
operator|.
name|getFileId
...
name|debug
argument_list|(
literal|"Not committed yet, wait., fileId="
operator|+
name|fileHandle
operator|.
name|getFileId
...
condition|)
block|{
comment|// Commit took too long, return error
return|return
literal|false
return|;
block|}
...
name|info
argument_list|(
literal|"Commit is interrupted, fileId="
operator|+
name|fileHandle
operator|.
name|getFileId
