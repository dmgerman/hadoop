...
expr_stmt|;
block|}
DECL|method|createTestFiles (FileSystem fileSys, String path, String destpath, int nfile, int nblock)
specifier|static
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|createTestFiles (FileSystem fileSys, String path, String destpath, int nfile, int nblock, short repl)
specifier|static
name|void
name|createTestFiles
parameter_list|(
...
name|Path
argument_list|(
literal|"/user/dhruba/raidtest/dir"
operator|+
name|i
operator|+
literal|"/file"
...
argument_list|)
expr_stmt|;
comment|// 4 test files: 2 jobs with 2 files each.
specifier|final
name|int
...
name|info
argument_list|(
literal|"Waiting for num jobs succeeded "
operator|+
name|dcnode
operator|.
name|jobMonitor
...
expr_stmt|;
block|}
comment|// Wait for any running jobs to finish.
name|start
operator|=
name|Time
operator|.
...
name|info
argument_list|(
literal|"Waiting for zero running jobs: "
operator|+
name|dcnode
operator|.
name|jobMonitor
