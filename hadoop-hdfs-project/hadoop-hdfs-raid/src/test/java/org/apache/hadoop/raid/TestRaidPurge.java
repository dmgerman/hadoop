...
argument_list|,
literal|"org.apache.hadoop.dfs.DFSClient"
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|mySetup (long targetReplication, long metaReplication, long stripeLength, int harDelay)
specifier|private
name|void
name|mySetup
parameter_list|(
...
name|info
argument_list|(
literal|"Test testPurge  started."
argument_list|)
expr_stmt|;
name|long
name|blockSizes
...
name|info
argument_list|(
literal|"Test testPurge completed."
argument_list|)
expr_stmt|;
block|}
comment|/**    * Create parity file, delete original file and then validate that    * parity file is automatically deleted.    */
DECL|method|doTestPurge (int iter, long targetReplication, long metaReplication, long stripeLength, long blockSize, int numBlock)
specifier|private
name|void
name|doTestPurge
parameter_list|(
...
name|info
argument_list|(
literal|"doTestPurge created test files for iteration "
operator|+
name|iter
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"doTestPurge found path "
operator|+
name|s
operator|.
name|getPath
...
name|info
argument_list|(
literal|"doTestPurge waiting for files to be raided. Found "
operator|+
operator|(
name|listPaths
operator|==
...
name|info
argument_list|(
literal|"doTestPurge all files found in Raid."
argument_list|)
expr_stmt|;
comment|// delete original file
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// wait till parity file and directory are automatically deleted
while|while
condition|(
name|fileSys
operator|.
...
name|info
argument_list|(
literal|"doTestPurge waiting for parity files to be removed."
argument_list|)
expr_stmt|;
name|Thread
operator|.
...
name|info
argument_list|(
literal|"doTestPurge delete file "
operator|+
name|file1
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Create a file, wait for parity file to get HARed. Then modify the file,    * wait for the HAR to get purged.    */
DECL|method|testPurgeHar ()
specifier|public
name|void
name|testPurgeHar
parameter_list|()
...
name|Path
argument_list|(
literal|"/raid/user/dhruba/raidtest"
argument_list|)
decl_stmt|;
name|Path
name|file1
...
name|info
argument_list|(
literal|"testPurgeHar created test files"
argument_list|)
expr_stmt|;
comment|// create an instance of the RaidNode
name|Configuration
...
argument_list|)
expr_stmt|;
comment|// Wait till har is created.
while|while
condition|(
literal|true
condition|)
...
name|info
argument_list|(
literal|"testPurgeHar found path "
operator|+
name|s
operator|.
name|getPath
...
name|info
argument_list|(
literal|"testPurgeHar waiting for parity file to be recreated"
operator|+
literal|" and har to be deleted found "
operator|+
name|s
operator|.
name|getPath
...
name|info
argument_list|(
literal|"testPurgeHar Exception "
operator|+
name|e
operator|+
name|StringUtils
...
block|}
block|}
comment|/**    * Create parity file, delete original file's directory and then validate that    * parity directory is automatically deleted.    */
DECL|method|testPurgeDirectory ()
specifier|public
name|void
name|testPurgeDirectory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// delete original directory.
name|assertTrue
argument_list|(
literal|"Unable to delete original directory "
operator|+
name|file1
argument_list|,
name|fileSys
...
name|info
argument_list|(
literal|"testPurgeDirectory waiting for parity files to be removed."
argument_list|)
expr_stmt|;
name|Thread
operator|.
...
name|info
argument_list|(
literal|"testPurgeDirectory Exception "
operator|+
name|e
operator|+
name|StringUtils
...
name|info
argument_list|(
literal|"testPurgeDirectory delete file "
operator|+
name|file1
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * Test that an XOR parity file is removed when a RS parity file is detected.    */
DECL|method|testPurgePreference ()
specifier|public
name|void
name|testPurgePreference
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Create the parity files.
name|RaidNode
operator|.
name|doRaid
argument_list|(
...
argument_list|,
literal|"user/test/raidtest/file1"
argument_list|)
decl_stmt|;
name|Path
name|rsParity
...
argument_list|)
expr_stmt|;
comment|// Check purge of a single parity file.
name|RaidNode
name|cnode
init|=
name|RaidNode
...
argument_list|)
expr_stmt|;
comment|// Calling purge under the RS path has no effect.
name|assertTrue
argument_list|(
name|fileSys
operator|.
...
argument_list|)
expr_stmt|;
comment|// XOR parity must have been purged by now.
name|assertFalse
argument_list|(
name|fileSys
operator|.
...
argument_list|)
expr_stmt|;
comment|// Now check the purge of a parity har.
comment|// Delete the RS parity for now.
name|fileSys
operator|.
name|delete
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Recreate the XOR parity.
name|Path
name|xorHar
init|=
operator|new
...
name|DEFAULT_RAID_LOCATION
argument_list|,
literal|"user/test/raidtest/raidtest"
operator|+
name|RaidNode
operator|.
name|HAR_SUFFIX
...
argument_list|)
expr_stmt|;
comment|// Call purge to get rid of the parity file. The har should remain.
name|cnode
operator|.
name|purgeMonitor
operator|.
...
argument_list|)
expr_stmt|;
comment|// XOR har should exist but xor parity file should have been purged.
name|assertFalse
argument_list|(
name|fileSys
operator|.
...
argument_list|)
expr_stmt|;
comment|// Now create the RS parity.
name|RaidNode
operator|.
name|doRaid
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// XOR har should get deleted.
name|assertTrue
argument_list|(
name|fileSys
operator|.
