...
decl_stmt|;
DECL|field|profilerSupport
specifier|private
name|boolean
name|profilerSupport
decl_stmt|;
...
name|warn
argument_list|(
literal|"/prof java profiling servlet is activated. Not safe for "
operator|+
literal|"production!"
argument_list|)
expr_stmt|;
...
block|}
comment|/**    * Add a servlet to BaseHttpServer.    *    * @param servletName The name of the servlet    * @param pathSpec    The path spec for the servlet    * @param clazz       The servlet class    */
DECL|method|addInternalServlet (String servletName, String pathSpec, Class<? extends HttpServlet> clazz, Map<String, String> initParams)
specifier|protected
name|void
