...
argument_list|)
expr_stmt|;
comment|// Not Replicated Exception will be thrown if watch For commit
...
DECL|method|getScmSecurityClient ( OzoneConfiguration conf, UserGroupInformation ugi)
specifier|public
specifier|static
name|SCMSecurityProtocol
...
return|;
block|}
DECL|method|checkForException (Exception e)
specifier|public
specifier|static
name|Throwable
