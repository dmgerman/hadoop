...
name|IOException
block|{
comment|// TODO: Add a heartbeat dispatcher.
name|DatanodeDetails
name|datanodeDetails
init|=
name|DatanodeDetails
...
annotation|@
name|Override
DECL|method|register ( HddsProtos.DatanodeDetailsProto datanodeDetailsProto, NodeReportProto nodeReport, ContainerReportsProto containerReportsProto)
specifier|public
name|SCMRegisteredResponseProto
name|register
parameter_list|(
