...
return|;
block|}
DECL|method|getDatanodeRpcServer ()
specifier|public
name|RPC
operator|.
name|Server
name|getDatanodeRpcServer
parameter_list|()
block|{
return|return
name|datanodeRpcServer
...
annotation|@
name|Override
DECL|method|register ( HddsProtos.DatanodeDetailsProto datanodeDetails, SCMNodeReport nodeReport, ContainerReportsRequestProto containerReportsRequestProto)
specifier|public
name|SCMRegisteredCmdResponseProto
name|register
parameter_list|(
...
operator|.
name|SCMCommandResponseProto
DECL|method|getCommandResponse ( SCMCommand cmd, final String datanodeID)
name|getCommandResponse
parameter_list|(
name|SCMCommand
name|cmd
