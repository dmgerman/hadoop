...
argument_list|)
expr_stmt|;
comment|// reset the datanodes in the pipeline
comment|// they will be reset on
name|pipeline
operator|.
name|resetPipeline
argument_list|()
...
block|}
block|}
DECL|method|handleStaleNode (DatanodeDetails dn)
specifier|public
name|void
...
block|}
block|}
DECL|method|processPipelineReport (DatanodeDetails dn, PipelineReportsProto pipelineReport)
name|void
...
argument_list|)
expr_stmt|;
comment|//TODO: handle missing pipelines and new pipelines later
block|}
DECL|method|processPipelineReport ( HddsProtos.PipelineID id, DatanodeDetails dn)
specifier|private
name|PipelineID
name|processPipelineReport
parameter_list|(
