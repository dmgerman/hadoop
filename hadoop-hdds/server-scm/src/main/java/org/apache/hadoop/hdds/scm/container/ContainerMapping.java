...
return|;
block|}
comment|/**    * Queues the close container command, to datanode and writes the new state    * to container DB.    *<p>    * TODO : Remove this 2 ContainerInfo definitions. It is brain dead to have    * one protobuf in one file and another definition in another file.    *    * @param newState - This is the state we maintain in SCM.    * @param pipeline    * @throws IOException    */
DECL|method|closeContainerIfNeeded (SCMContainerInfo newState, Pipeline pipeline)
specifier|private
name|boolean
name|closeContainerIfNeeded
parameter_list|(
