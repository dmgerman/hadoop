...
name|pipelineStore
decl_stmt|;
DECL|method|SCMPipelineManager (Configuration conf, NodeManager nodeManager)
specifier|public
name|SCMPipelineManager
parameter_list|(
name|Configuration
...
parameter_list|)
block|{
comment|// if db operation fails we need to revert the pipeline creation in
...
try|try
block|{
comment|//TODO: close all containers in this pipeline
name|Pipeline
name|pipeline
init|=
name|stateManager
