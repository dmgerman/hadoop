...
comment|// factors are handled by pipeline creator job.
name|pipeline
operator|=
name|pipelineManager
operator|.
...
name|pipeline
argument_list|,
literal|"Pipeline couldn't be found for the new container. "
operator|+
...
expr_stmt|;
block|}
comment|/**    * Return a container matching the attributes specified.    *    * @param size            - Space needed in the Container.    * @param owner           - Owner of the container - A specific nameservice.    * @param pipelineManager - Pipeline Manager    * @param pipeline        - Pipeline from which container needs to be matched    * @return ContainerInfo, null if there is no match found.    */
DECL|method|getMatchingContainer (final long size, String owner, PipelineManager pipelineManager, Pipeline pipeline)
name|ContainerInfo
...
name|error
argument_list|(
literal|"Container list is null for pipeline="
argument_list|,
name|pipeline
operator|.
name|getId
...
block|}
block|}
comment|// TODO: #CLUTIL cleanup entries in lastUsedMap
return|return
name|containerInfo
return|;
block|}
comment|/**    * Return a container matching the attributes specified.    *    * @param size         - Space needed in the Container.    * @param owner        - Owner of the container - A specific nameservice.    * @param pipelineID   - ID of the pipeline    * @param containerIDs - Set of containerIDs to choose from    * @return ContainerInfo, null if there is no match found.    */
DECL|method|getMatchingContainer (final long size, String owner, PipelineID pipelineID, NavigableSet<ContainerID> containerIDs)
name|ContainerInfo
name|getMatchingContainer
parameter_list|(
specifier|final
...
return|;
block|}
DECL|method|findContainerWithSpace (final long size, final NavigableSet<ContainerID> searchSet, final String owner, final PipelineID pipelineID)
specifier|private
name|ContainerInfo
name|findContainerWithSpace
parameter_list|(
...
return|;
block|}
DECL|method|getContainers ( NavigableSet<ContainerID> containerIDs, String owner)
specifier|private
name|NavigableSet
argument_list|<
name|ContainerID
...
name|error
argument_list|(
literal|"Could not find container info for container id={} {}"
argument_list|,
name|cid
argument_list|,
name|e
