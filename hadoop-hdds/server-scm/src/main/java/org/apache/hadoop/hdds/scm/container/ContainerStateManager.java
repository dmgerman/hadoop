...
name|containerCount
decl_stmt|;
DECL|field|containerStateCount
specifier|private
specifier|final
name|AtomicLongMap
argument_list|<
...
return|;
block|}
comment|/**    * Get count of containers in the current {@link LifeCycleState}.    *    * @param state {@link LifeCycleState}    * @return Count of containers    */
DECL|method|getContainerCountByState (final LifeCycleState state)
name|Integer
...
expr_stmt|;
block|}
comment|/**    * Update the lastUsedmap to update with ContainerState and containerID.    * @param pipelineID    * @param containerID    * @param owner    */
DECL|method|updateLastUsedMap (PipelineID pipelineID, ContainerID containerID, String owner)
specifier|public
specifier|synchronized
name|void
name|updateLastUsedMap
parameter_list|(
name|PipelineID
name|pipelineID
parameter_list|,
