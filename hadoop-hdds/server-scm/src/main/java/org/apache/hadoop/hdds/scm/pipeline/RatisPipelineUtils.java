...
parameter_list|()
lambda|->
name|fixedIntervalPipelineCreator
argument_list|(
name|pipelineManager
argument_list|,
name|conf
...
parameter_list|()
lambda|->
literal|"FixedIntervalPipelineCreatorJob failed."
argument_list|)
expr_stmt|;
block|}
DECL|method|fixedIntervalPipelineCreator ( PipelineManager pipelineManager, Configuration conf, TimeDuration timeDuration)
specifier|private
specifier|static
name|void
name|fixedIntervalPipelineCreator
...
parameter_list|()
lambda|->
literal|"PipelineCreation failed."
argument_list|)
expr_stmt|;
block|}
