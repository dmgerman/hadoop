...
block|}
block|}
comment|/**    * Removes the node from NodeStateMap.    *    * @param uuid node id    *    * @throws NodeNotFoundException if the node is not found    */
DECL|method|removeNode (UUID uuid)
specifier|public
name|void
name|removeNode
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Remove the current stats of the specify node.    *    * @param uuid node id    *    * @return SCMNodeStat the stat removed from the node.    *    * @throws NodeNotFoundException if the node is not found    */
