...
argument_list|)
decl_stmt|;
DECL|field|METRICS_SOURCE_NAME
specifier|public
specifier|static
specifier|final
name|String
...
name|METRICS_SOURCE_NAME
argument_list|,
literal|"SCM Replication manager (closed container replication) related "
operator|+
literal|"metrics"
argument_list|,
name|this
...
name|debug
argument_list|(
literal|"Handling underreplicated container: {}"
argument_list|,
name|container
operator|.
name|getContainerID
...
name|addGauge
argument_list|(
name|ReplicationManagerMetrics
operator|.
name|INFLIGHT_REPLICATION
argument_list|,
name|inflightReplication
operator|.
name|size
...
block|}
block|}
comment|/**    * Configuration used by the Replication Manager.    */
annotation|@
name|ConfigGroup
argument_list|(
name|prefix
operator|=
literal|"hdds.scm.replication"
argument_list|)
DECL|class|ReplicationManagerConfiguration
specifier|public
specifier|static
class|class
name|ReplicationManagerConfiguration
...
block|}
block|}
comment|/**    * Metric name definitions for Replication manager.    */
DECL|enum|ReplicationManagerMetrics
specifier|public
enum|enum
name|ReplicationManagerMetrics
implements|implements
name|MetricsInfo
block|{
DECL|enumConstant|INFLIGHT_REPLICATION
name|INFLIGHT_REPLICATION
argument_list|(
literal|"Tracked inflight container replication requests."
argument_list|)
block|,
DECL|enumConstant|INFLIGHT_DELETION
name|INFLIGHT_DELETION
argument_list|(
literal|"Tracked inflight container deletion requests."
argument_list|)
block|;
DECL|field|desc
specifier|private
...
name|desc
decl_stmt|;
DECL|method|ReplicationManagerMetrics (String desc)
name|ReplicationManagerMetrics
parameter_list|(
name|String
name|desc
