...
begin_function
DECL|method|getMatchingContainer (final long sizeRequired, String owner, Pipeline pipeline, List<ContainerID> excludedContainers)
specifier|public
name|ContainerInfo
name|getMatchingContainer
parameter_list|(
...
begin_comment
comment|/**    * Add newly allocated container to container DB.    * @param containerInfo    * @throws IOException    */
end_comment

begin_function
DECL|method|addContainerToDB (ContainerInfo containerInfo)
specifier|private
name|void
name|addContainerToDB
parameter_list|(
...
parameter_list|)
block|{
comment|// This should not happen, as we are removing after adding in to
comment|// container state cmap.
block|}
throw|throw
name|ex
throw|;
...
begin_comment
comment|/**    * Returns the container ID's matching with specified owner.    * @param containerIDs    * @param owner    * @return NavigableSet<ContainerID>    */
end_comment

begin_function
DECL|method|getContainersForOwner ( NavigableSet<ContainerID> containerIDs, String owner)
specifier|private
name|NavigableSet
argument_list|<
name|ContainerID
