...
name|size
decl_stmt|;
comment|/**    * Constructs a mapping class that creates mapping between container names    * and pipelines.    *    * @param nodeManager - NodeManager so that we can get the nodes that are    * healthy to place new    * containers.    * passed to LevelDB and this memory is allocated in Native code space.    * CacheSize is specified    * in MB.    * @throws IOException on Failure.    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
DECL|method|SCMContainerManager (final Configuration conf, final NodeManager nodeManager, final EventPublisher eventPublisher)
specifier|public
name|SCMContainerManager
parameter_list|(
specifier|final
