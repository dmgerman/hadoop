...
argument_list|)
decl_stmt|;
comment|/**    * Pipeline close event are triggered to close pipeline because of failure,    * stale node, decommissioning etc.    */
specifier|public
specifier|static
specifier|final
name|TypedEvent
