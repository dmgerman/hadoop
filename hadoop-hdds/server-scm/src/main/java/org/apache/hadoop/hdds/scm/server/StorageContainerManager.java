...
name|info
argument_list|(
literal|"Stopping Replication Activity Status tracker."
argument_list|)
expr_stmt|;
name|replicationStatus
operator|.
...
name|error
argument_list|(
literal|"Replication Activity Status tracker stop failed."
argument_list|,
name|ex
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Stopping SCM Common Scheduler."
argument_list|)
expr_stmt|;
name|commonScheduler
operator|.
...
name|error
argument_list|(
literal|"SCM Common Scheduler close failed {}"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
