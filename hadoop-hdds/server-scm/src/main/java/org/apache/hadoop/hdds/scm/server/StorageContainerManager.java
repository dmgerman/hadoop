...
return|;
block|}
comment|/**    * Create an SCM instance based on the supplied configuration.    *    * @param conf        HDDS configuration    * @return SCM instance    * @throws IOException, AuthenticationException    */
DECL|method|createSCM ( OzoneConfiguration conf)
specifier|public
specifier|static
name|StorageContainerManager
name|createSCM
...
DECL|method|scmInit (OzoneConfiguration conf, String clusterId)
specifier|public
specifier|static
name|boolean
name|scmInit
