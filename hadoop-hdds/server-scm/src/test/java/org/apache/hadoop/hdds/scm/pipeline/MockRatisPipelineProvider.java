...
begin_comment
comment|/**  * Mock Ratis Pipeline Provider for Mock Nodes.  */
end_comment

begin_class
DECL|class|MockRatisPipelineProvider
specifier|public
class|class
...
block|{
DECL|method|MockRatisPipelineProvider (NodeManager nodeManager, PipelineStateManager stateManager, Configuration conf)
specifier|public
name|MockRatisPipelineProvider
parameter_list|(
name|NodeManager
