...
expr_stmt|;
block|}
comment|/**    * Construct and returns StorageContainerManager instance using the given    * configuration. The ports used by this StorageContainerManager are    * randomly selected from free ports available.    *    * @param conf OzoneConfiguration    * @return StorageContainerManager instance    * @throws IOException    * @throws AuthenticationException    */
...
return|;
block|}
comment|/**    * Construct and returns StorageContainerManager instance using the given    * configuration and the configurator. The ports used by this    * StorageContainerManager are randomly selected from free ports available.    *    * @param conf OzoneConfiguration    * @param configurator SCMConfigurator    * @return StorageContainerManager instance    * @throws IOException    * @throws AuthenticationException    */
...
return|;
block|}
DECL|method|getContainer ( final HddsProtos.LifeCycleState state)
specifier|public
specifier|static
name|ContainerInfo
name|getContainer
...
return|;
block|}
DECL|method|getReplicas ( final ContainerID containerId, final ContainerReplicaProto.State state, final long sequenceId, final UUID originNodeId, final DatanodeDetails datanodeDetails)
specifier|public
specifier|static
name|ContainerReplica
name|getReplicas
