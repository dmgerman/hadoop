...
annotation|@
name|Test
DECL|method|testGetStaleNodeInterval ()
specifier|public
name|void
name|testGetStaleNodeInterval
parameter_list|()
block|{
specifier|final
name|Configuration
...
argument_list|()
decl_stmt|;
comment|// Reset OZONE_SCM_STALENODE_INTERVAL to 300s that
comment|// larger than max limit value.
name|conf
operator|.
...
argument_list|)
expr_stmt|;
comment|// the max limit value will be returned
name|assertEquals
argument_list|(
literal|100000
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Reset OZONE_SCM_STALENODE_INTERVAL to 10ms that
comment|// smaller than min limit value.
name|conf
operator|.
name|setTimeDuration
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// the min limit value will be returned
name|assertEquals
argument_list|(
literal|90000
argument_list|,
