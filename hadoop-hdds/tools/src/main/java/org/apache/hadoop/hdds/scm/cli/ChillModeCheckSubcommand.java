...
begin_comment
comment|/**  * This is the handler that process chill mode check command.  */
end_comment
...
name|description
operator|=
literal|"Check if SCM is in chill mode"
argument_list|,
...
name|class
argument_list|)
DECL|class|ChillModeCheckSubcommand
specifier|public
class|class
...
name|info
argument_list|(
literal|"SCM is out of chill mode."
argument_list|)
expr_stmt|;
block|}
return|return
