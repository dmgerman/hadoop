...
begin_comment
comment|/**  * This is the handler that process safe mode exit command.  */
end_comment
...
name|description
operator|=
literal|"Force SCM out of safe mode"
argument_list|,
...
name|class
argument_list|)
DECL|class|SafeModeExitSubcommand
specifier|public
class|class
...
name|info
argument_list|(
literal|"SCM exit safe mode successfully."
argument_list|)
expr_stmt|;
block|}
return|return
