...
name|description
operator|=
literal|"Check if ReplicationManager is running or not"
argument_list|,
...
name|class
argument_list|)
DECL|class|ReplicationManagerStatusSubcommand
specifier|public
class|class
name|ReplicationManagerStatusSubcommand
...
name|info
argument_list|(
literal|"ReplicationManager is Running."
argument_list|)
expr_stmt|;
block|}
else|else
...
name|info
argument_list|(
literal|"ReplicationManager is Not Running."
argument_list|)
expr_stmt|;
block|}
return|return
