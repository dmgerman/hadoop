...
argument_list|)
decl_stmt|;
DECL|field|WRITE_SUCCESS_MSG
specifier|private
specifier|static
specifier|final
name|AuditMessage
name|WRITE_SUCCESS_MSG
init|=
operator|new
name|AuditMessage
argument_list|(
...
argument_list|)
decl_stmt|;
DECL|field|READ_SUCCESS_MSG
specifier|private
specifier|static
specifier|final
name|AuditMessage
name|READ_SUCCESS_MSG
init|=
operator|new
name|AuditMessage
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Test to verify default log level is INFO when logging success events.    */
annotation|@
name|Test
DECL|method|verifyDefaultLogLevelForSuccess ()
specifier|public
name|void
name|verifyDefaultLogLevelForSuccess
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**    * Test to verify default log level is ERROR when logging failure events.    */
annotation|@
name|Test
DECL|method|verifyDefaultLogLevelForFailure ()
specifier|public
name|void
name|verifyDefaultLogLevelForFailure
parameter_list|()
throws|throws
name|IOException
block|{
