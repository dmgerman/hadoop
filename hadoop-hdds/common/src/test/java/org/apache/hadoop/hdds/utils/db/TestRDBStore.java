...
block|}
block|}
DECL|method|insertRandomData (RDBStore dbStore, int familyIndex)
specifier|private
name|void
...
annotation|@
name|Test
DECL|method|testRocksDBCheckpoint ()
specifier|public
name|void
name|testRocksDBCheckpoint
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
name|RDBStore
name|restoredStoreFromCheckPoint
init|=
operator|new
name|RDBStore
argument_list|(
...
annotation|@
name|Test
DECL|method|testRocksDBCheckpointCleanup ()
specifier|public
name|void
name|testRocksDBCheckpointCleanup
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
comment|/**    * Not strictly a unit test. Just a confirmation of the expected behavior    * of RocksDB keyMayExist API.    * Expected behavior - On average, keyMayExist latency< key.get() latency    * for invalid keys.    * @throws Exception if unable to read from RocksDB.    */
annotation|@
name|Test
DECL|method|testRocksDBKeyMayExistApi ()
specifier|public
name|void
name|testRocksDBKeyMayExistApi
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|//Test with 50 invalid keys.
name|long
name|start
init|=
name|System
...
annotation|@
name|Test
DECL|method|testGetDBUpdatesSince ()
specifier|public
name|void
name|testGetDBUpdatesSince
parameter_list|()
throws|throws
name|Exception
block|{
