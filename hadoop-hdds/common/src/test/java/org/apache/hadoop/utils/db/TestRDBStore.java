...
annotation|@
name|Test
DECL|method|testReadOnlyRocksDB ()
specifier|public
name|void
name|testReadOnlyRocksDB
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|//Create Rdb and write some data into it.
name|RDBStore
name|newStore
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|//Create Read Only DB from snapshot of first DB.
name|RDBStore
name|snapshotStore
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|//Verify read is allowed.
name|firstTable
operator|=
name|snapshotStore
operator|.
...
argument_list|)
expr_stmt|;
comment|//Verify write is not allowed.
name|byte
index|[]
name|key2
init|=
