...
expr_stmt|;
block|}
comment|/**    * Tests that we are able    * to create a Test CA, creates it own self-Signed CA and then issue a    * certificate based on a CSR when scmId and clusterId are not set in    * csr subject.    * @throws SCMSecurityException - on ERROR.    * @throws ExecutionException - on ERROR.    * @throws InterruptedException - on ERROR.    * @throws NoSuchProviderException - on ERROR.    * @throws NoSuchAlgorithmException - on ERROR.    */
annotation|@
name|Test
DECL|method|testRequestCertificateWithInvalidSubject ()
specifier|public
name|void
name|testRequestCertificateWithInvalidSubject
parameter_list|()
throws|throws
name|IOException
throws|,
...
annotation|@
name|Test
DECL|method|testRequestCertificateWithInvalidSubjectFailure ()
specifier|public
name|void
name|testRequestCertificateWithInvalidSubjectFailure
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"ScmId and "
operator|+
literal|"ClusterId in CSR subject are incorrect"
argument_list|,
parameter_list|()
lambda|->
block|{
