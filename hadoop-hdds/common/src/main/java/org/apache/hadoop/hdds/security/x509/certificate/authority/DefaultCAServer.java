...
name|store
decl_stmt|;
comment|/**    * Create an Instance of DefaultCAServer.    *  @param subject - String Subject    * @param clusterID - String ClusterID    * @param scmID - String SCMID.    * @param certificateStore - A store used to persist Certificates.    */
DECL|method|DefaultCAServer (String subject, String clusterID, String scmID, CertificateStore certificateStore)
specifier|public
name|DefaultCAServer
parameter_list|(
name|String
...
parameter_list|)
block|{
comment|// Certificate with conflicting serial id, retry again may resolve
comment|// this issue.
name|LOG
operator|.
name|error
argument_list|(
literal|"Certificate storage failed, retrying one more time."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Unable to issue a certificate. {}"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|signAndStoreCertificate (LocalDate beginDate, LocalDate endDate, PKCS10CertificationRequest csr)
specifier|private
name|X509CertificateHolder
name|signAndStoreCertificate
parameter_list|(
...
name|SCMSecurityException
argument_list|(
literal|"Certificate cannot be null"
argument_list|)
argument_list|)
expr_stmt|;
return|return
...
name|error
argument_list|(
literal|"Revoking the certificate failed. {}"
argument_list|,
name|ex
operator|.
name|getCause
