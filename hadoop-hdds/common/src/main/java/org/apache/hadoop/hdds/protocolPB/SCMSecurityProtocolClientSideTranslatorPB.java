...
DECL|method|submitRequest ( SCMSecurityProtocolProtos.Type type, Consumer<Builder> builderConsumer)
specifier|private
name|SCMSecurityResponse
name|submitRequest
parameter_list|(
...
block|}
comment|/**    * Get SCM signed certificate for OM.    *    * @param omDetails   - OzoneManager Details.    * @param certSignReq - Certificate signing request.    * @return byte[]         - SCM signed certificate.    */
DECL|method|getOMCertChain ( OzoneManagerDetailsProto omDetails, String certSignReq)
specifier|public
name|SCMGetCertResponseProto
name|getOMCertChain
parameter_list|(
...
name|builder
operator|.
name|setGetOMCertRequest
argument_list|(
name|request
argument_list|)
argument_list|)
operator|.
name|getGetCertResponseProto
argument_list|()
return|;
block|}
comment|/**    * Get SCM signed certificate with given serial id. Throws exception if    * certificate is not found.    *    * @param certSerialId - Certificate serial id.    * @return string         - pem encoded certificate.    */
annotation|@
name|Override
...
DECL|method|getDataNodeCertificateChain ( DatanodeDetailsProto dnDetails, String certSignReq)
specifier|public
name|SCMGetCertResponseProto
name|getDataNodeCertificateChain
parameter_list|(
...
name|builder
operator|.
name|setGetDataNodeCertRequest
argument_list|(
name|request
argument_list|)
argument_list|)
...
return|;
block|}
comment|/**    * Get CA certificate.    *    * @return serial   - Root certificate.    */
annotation|@
name|Override
...
name|builder
operator|.
name|setGetCACertificateRequest
argument_list|(
name|protoIns
argument_list|)
argument_list|)
