...
expr_stmt|;
block|}
DECL|method|of (Configuration conf)
specifier|public
specifier|static
name|OzoneConfiguration
name|of
...
try|try
block|{
comment|//there could be multiple ozone-default-generated.xml files on the
comment|// classpath, which are generated by the annotation processor.
comment|// Here we add all of them to the list of the available configuration.
name|Enumeration
argument_list|<
name|URL
argument_list|>
name|generatedDefaults
init|=
name|OzoneConfiguration
operator|.
name|class
