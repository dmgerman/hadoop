...
block|}
block|}
comment|/**    * Get<i>leafIndex</i> leaf of this subtree.    *    * @param leafIndex node's index, start from 0, skip the nodes in    *                 excludedScope and excludedNodes with ancestorGen    * @param excludedScope the exclude scope    * @param excludedNodes nodes to be excluded from. If ancestorGen is not 0,    *                      the chosen node will not share same ancestor with    *                      those in excluded nodes at the specified generation    * @param ancestorGen  apply to excludeNodes, when value is 0, then no same    *                    ancestor enforcement on excludedNodes    * @return the leaf node corresponding to the given index.    * Example:    *    *                                /  --- root    *                              /  \    *                             /    \    *                            /      \    *                           /        \    *                         dc1         dc2    *                        / \         / \    *                       /   \       /   \    *                      /     \     /     \    *                    rack1 rack2  rack1  rack2    *                   / \     / \  / \     / \    *                 n1  n2  n3 n4 n5  n6  n7 n8    *    *   Input:    *   leafIndex = 2    *   excludedScope = /dc2    *   excludedNodes = {/dc1/rack1/n1}    *   ancestorGen = 1    *    *   Output:    *   node /dc1/rack2/n5    *    *   Explanation:    *   Since excludedNodes is n1 and ancestorGen is 1, it means nodes under    *   /root/dc1/rack1 are excluded. Given leafIndex start from 0, LeafIndex 2    *   means picking the 3th available node, which is n5.    *    */
...
argument_list|()
decl_stmt|;
comment|// skip nodes covered by excluded scope
if|if
condition|(
name|excludedScope
operator|!=
...
DECL|method|getLeafOnLeafParent (int leafIndex, String excludedScope, Collection<Node> excludedNodes)
specifier|private
name|Node
name|getLeafOnLeafParent
parameter_list|(
...
return|;
block|}
comment|/** Get how many leaf nodes are covered by the excludedScope. */
DECL|method|getExcludedScopeNodeCount (String excludedScope)
specifier|private
name|int
name|getExcludedScopeNodeCount
parameter_list|(
