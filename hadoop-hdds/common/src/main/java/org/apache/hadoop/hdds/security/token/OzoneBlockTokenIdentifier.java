...
name|maxLength
decl_stmt|;
DECL|method|OzoneBlockTokenIdentifier ()
specifier|public
name|OzoneBlockTokenIdentifier
parameter_list|()
block|{   }
DECL|method|OzoneBlockTokenIdentifier (String ownerId, String blockId, EnumSet<AccessModeProto> modes, long expiryDate, String omCertSerialId, long maxLength)
specifier|public
name|OzoneBlockTokenIdentifier
parameter_list|(
name|String
