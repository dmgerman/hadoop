...
begin_comment
comment|/**  * Exceptions thrown when a block is yet to be committed on the datanode.  */
end_comment

begin_class
DECL|class|BlockNotCommittedException
specifier|public
class|class
...
DECL|method|BlockNotCommittedException (String message)
specifier|public
name|BlockNotCommittedException
parameter_list|(
name|String
