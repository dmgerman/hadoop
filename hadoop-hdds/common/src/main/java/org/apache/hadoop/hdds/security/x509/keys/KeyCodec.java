...
expr_stmt|;
block|}
comment|/**    * Writes a given private key using the default config options.    *    * @param key - Key to write to file.    * @throws IOException - On I/O failure.    */
DECL|method|writePrivateKey (PrivateKey key)
specifier|public
name|void
...
name|IOException
argument_list|(
literal|"Private key already exist."
argument_list|)
throw|;
block|}
try|try
...
expr_stmt|;
block|}
comment|/**    * Writes a given public key using the default config options.    *    * @param key - Key to write to file.    * @throws IOException - On I/O failure.    */
DECL|method|writePublicKey (PublicKey key)
specifier|public
name|void
name|writePublicKey
parameter_list|(
