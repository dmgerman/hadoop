...
throw|;
block|}
comment|/**    * Creates digital signature over the data stream using the components    * private key.    *    * @param stream - Data stream to sign.    * @throws CertificateException - on Error.    */
annotation|@
name|Override
...
block|}
block|}
comment|/**    * Creates digital signature over the data stream using the components    * private key.    *    * @param data        - Data to sign.    * @throws CertificateException - on Error.    */
annotation|@
name|Override
...
throw|;
block|}
comment|/**    * Stores the Certificate  for this client. Don't use this api to add    * trusted certificates of other components.    *    * @param certificate - X509 Certificate    * @throws CertificateException - on Error.    */
annotation|@
name|Override
...
block|}
block|}
comment|/**    * Stores the trusted chain of certificates for a specific component.    *    * @param ks                    - Key Store.    * @throws CertificateException - on Error.    */
annotation|@
name|Override
...
throw|;
block|}
comment|/**    * Stores the trusted chain of certificates for a specific component.    *    * @param certificates - List of Certificates.    * @throws CertificateException - on Error.    */
annotation|@
name|Override
