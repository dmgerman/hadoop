...
argument_list|)
decl_stmt|;
DECL|field|ROCKSDB_CONTEXT_PREFIX
specifier|public
specifier|final
specifier|static
name|String
...
literal|"Rocksdb_"
decl_stmt|;
DECL|method|RocksDBStoreMBean (Statistics statistics, String dbName)
specifier|public
name|RocksDBStoreMBean
parameter_list|(
name|Statistics
...
expr_stmt|;
block|}
DECL|method|create (Statistics statistics, String contextName)
specifier|public
specifier|static
name|RocksDBStoreMBean
name|create
...
annotation|@
name|Override
DECL|method|getMetrics (MetricsCollector metricsCollector, boolean b)
specifier|public
name|void
name|getMetrics
parameter_list|(
...
argument_list|)
expr_stmt|;
name|getTickerTypeData
argument_list|(
name|rb
argument_list|)
expr_stmt|;
block|}
comment|/**    * Collect all histogram metrics from RocksDB statistics.    * @param rb Metrics Record Builder.    */
DECL|method|getHistogramData (MetricsRecordBuilder rb)
specifier|private
name|void
name|getHistogramData
parameter_list|(
...
name|error
argument_list|(
literal|"Error reading histogram data {} "
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * Collect all Counter metrics from RocksDB statistics.    * @param rb Metrics Record Builder.    */
DECL|method|getTickerTypeData (MetricsRecordBuilder rb)
specifier|private
name|void
name|getTickerTypeData
parameter_list|(
