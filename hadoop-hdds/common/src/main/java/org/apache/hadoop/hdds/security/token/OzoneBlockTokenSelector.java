...
begin_comment
comment|/**  * A block token selector for Ozone.  */
end_comment
...
operator|.
name|Private
DECL|class|OzoneBlockTokenSelector
specifier|public
class|class
...
return|;
block|}
comment|/**    * Static method to avoid instantiation.    * */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
DECL|method|selectBlockToken (Text service, Collection<Token<? extends TokenIdentifier>> tokens)
specifier|public
specifier|static
name|Token
argument_list|<
