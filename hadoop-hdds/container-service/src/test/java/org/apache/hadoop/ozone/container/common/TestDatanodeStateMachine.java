...
argument_list|)
expr_stmt|;
comment|// Wait for GetVersion call (called by task.execute) to finish. After
comment|// Earlier task.execute called into GetVersion. Wait for the execution
comment|// to finish and the endPointState to move to REGISTER state.
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
