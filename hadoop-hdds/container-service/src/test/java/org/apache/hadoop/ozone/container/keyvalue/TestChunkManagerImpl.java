...
annotation|@
name|Test
DECL|method|testWriteChunkChecksumMismatch ()
specifier|public
name|void
name|testWriteChunkChecksumMismatch
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//Setting checksum to some value.
name|chunkInfo
operator|.
name|setChecksum
argument_list|(
literal|"some garbage"
argument_list|)
expr_stmt|;
name|chunkManager
operator|.
...
name|fail
argument_list|(
literal|"testWriteChunkChecksumMismatch failed"
argument_list|)
expr_stmt|;
block|}
catch|catch
