...
expr_stmt|;
block|}
comment|/**    * Sanity test, when there are corruptions induced.    * @throws Exception    */
annotation|@
name|Test
...
DECL|method|createContainerWithBlocks (long containerId, int normalBlocks, int deletedBlocks, int chunkLen, int chunksPerBlock)
specifier|private
name|void
name|createContainerWithBlocks
parameter_list|(
