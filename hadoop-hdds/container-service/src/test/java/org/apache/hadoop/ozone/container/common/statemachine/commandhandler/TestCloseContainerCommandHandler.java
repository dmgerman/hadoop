...
argument_list|()
expr_stmt|;
comment|// Give some time for ratis for leader election.
specifier|final
name|PipelineID
name|pipelineID
init|=
...
argument_list|)
expr_stmt|;
comment|// We have created a container via ratis. Now close the container on ratis.
specifier|final
...
argument_list|()
decl_stmt|;
comment|// Specify a pipeline which doesn't exist in the datanode.
specifier|final
name|CloseContainerCommand
name|command
init|=
