...
name|StorageContainerException
function_decl|;
comment|/**    * Determine if the container has suitable type for this policy.    * @param type  type of the container    * @return whether the container type suitable for this policy.    */
DECL|method|isValidContainerType (ContainerProtos.ContainerType type)
specifier|default
name|boolean
