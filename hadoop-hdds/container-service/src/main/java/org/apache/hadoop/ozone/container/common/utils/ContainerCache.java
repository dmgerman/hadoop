...
condition|)
block|{
comment|// marking it as evicted will close the db as well.
name|db
operator|.
name|setEvicted
argument_list|(
...
block|}
block|}
comment|/**    * Class to implement reference counting over instances handed by Container    * Cache.    */
...
operator|)
argument_list|,
literal|"checkNoReferences:%b, referencount:%d"
argument_list|,
name|checkNoReferences
argument_list|,
name|referenceCount
