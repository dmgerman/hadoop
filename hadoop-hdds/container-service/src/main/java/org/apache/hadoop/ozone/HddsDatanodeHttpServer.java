...
begin_comment
comment|/**  * Simple http server to provide basic monitoring for hdds datanode.  *<p>  * This server is used to access default /conf /prom /prof endpoints.  */
end_comment

begin_class
DECL|class|HddsDatanodeHttpServer
specifier|public
class|class
...
name|BaseHttpServer
block|{
DECL|method|HddsDatanodeHttpServer (Configuration conf)
specifier|public
name|HddsDatanodeHttpServer
parameter_list|(
name|Configuration
