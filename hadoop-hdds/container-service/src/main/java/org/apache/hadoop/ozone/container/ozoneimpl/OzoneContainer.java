...
return|;
block|}
comment|/**    * Submit ContainerRequest.    * @param request    * @param replicationType    * @param pipelineID    */
DECL|method|submitContainerRequest ( ContainerProtos.ContainerCommandRequestProto request, ReplicationType replicationType, PipelineID pipelineID)
specifier|public
name|void
...
comment|// In such cases of the retry attempt, if the container is already closed
comment|// via Ratis, we should just return.
block|}
name|LOG
operator|.
name|info
argument_list|(
literal|"submitting {} request over {} server for container {}"
argument_list|,
name|request
operator|.
name|getCmdType
...
expr_stmt|;
block|}
DECL|method|getPortByType (ReplicationType replicationType)
specifier|private
name|int
name|getPortByType
parameter_list|(
...
return|;
block|}
comment|/**    * Returns the container servers IPC port.    *    * @return Container servers IPC port.    */
