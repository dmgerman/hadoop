...
return|;
block|}
DECL|method|getContainerFile (String metadataPath, long containerId)
specifier|static
name|File
name|getContainerFile
parameter_list|(
...
name|info
argument_list|(
literal|"Doing Fast integrity checks for Container ID : {},"
operator|+
literal|" because it is OPEN"
argument_list|,
name|containerId
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Doing Full integrity checks for Container ID : {},"
operator|+
...
name|ContainerCheckLevel
block|{
DECL|enumConstant|NO_CHECK
DECL|enumConstant|FAST_CHECK
DECL|enumConstant|FULL_CHECK
name|NO_CHECK
block|,
name|FAST_CHECK
block|,
