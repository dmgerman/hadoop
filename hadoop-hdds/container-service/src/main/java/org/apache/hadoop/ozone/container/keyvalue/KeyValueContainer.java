...
block|}
block|}
comment|/**    * Compute checksum of the .container file.    * @param containerFile    * @throws StorageContainerException    */
DECL|method|computeCheckSum (File containerFile)
specifier|private
name|String
name|computeCheckSum
parameter_list|(
...
name|StorageContainerException
argument_list|(
literal|"Error during update of "
operator|+
literal|"check sum file. Container Name: "
operator|+
name|containerData
operator|.
name|getContainerId
