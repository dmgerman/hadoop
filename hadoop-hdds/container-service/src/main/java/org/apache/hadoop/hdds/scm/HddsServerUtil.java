...
begin_comment
comment|/**  * Hdds stateless helper functions for server side components.  */
end_comment
...
return|;
block|}
comment|/**    * Retrieve the socket address that should be used by scm security server to    * service clients.    *    * @param conf    * @return Target InetSocketAddress for the SCM security service.    */
DECL|method|getScmSecurityInetAddress ( Configuration conf)
specifier|public
specifier|static
name|InetSocketAddress
...
return|;
block|}
DECL|method|getOzoneDatanodeRatisDirectory (Configuration conf)
specifier|public
specifier|static
name|String
...
expr_stmt|;
block|}
comment|// Use default datanode id file name for file path
return|return
operator|new
name|File
argument_list|(
