...
return|;
block|}
comment|/**    * Returns LifeCycle State of the container.    * @param containerData - ContainerData    * @return LifeCycle State of the container    * @throws StorageContainerException    */
DECL|method|getState (ContainerData containerData)
specifier|private
name|HddsProtos
operator|.
name|LifeCycleState
