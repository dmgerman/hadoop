...
name|debug
argument_list|(
literal|"Sending heartbeat message :: {}"
argument_list|,
name|request
operator|.
name|toString
...
name|requestBuilder
operator|.
name|getIncrementalContainerReportCount
argument_list|()
operator|!=
literal|0
condition|)
...
name|commandResponseProto
operator|.
name|getDeleteContainerCommandProto
argument_list|()
argument_list|)
decl_stmt|;
if|if
...
name|debug
argument_list|(
literal|"Received SCM delete container request for container {}"
argument_list|,
name|deleteContainerCommand
operator|.
name|getContainerID
