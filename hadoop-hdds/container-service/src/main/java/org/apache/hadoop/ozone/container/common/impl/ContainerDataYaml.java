...
block|}
block|}
comment|/**    * Read the yaml file, and return containerData.    *    * @throws IOException    */
...
block|}
block|}
comment|/**    * Read the yaml file content, and return containerData.    *    * @throws IOException    */
DECL|method|readContainer (byte[] containerFileContent)
specifier|public
specifier|static
name|ContainerData
name|readContainer
...
return|;
block|}
comment|/**    * Read the yaml content, and return containerData.    *    * @throws IOException    */
DECL|method|readContainer (InputStream input)
specifier|public
specifier|static
name|ContainerData
name|readContainer
