...
comment|// the container2BCSIDMap here.
comment|// container2BCSIDMap will further grow as and when containers get created
name|container2BCSIDMap
operator|.
name|putAll
argument_list|(
...
name|proto
init|=
name|message2ContainerCommandRequestProto
argument_list|(
name|request
operator|.
name|getMessage
...
return|;
block|}
DECL|method|message2ContainerCommandRequestProto ( Message message)
specifier|private
name|ContainerCommandRequestProto
name|message2ContainerCommandRequestProto
parameter_list|(
...
name|error
argument_list|(
literal|"gid {} : ApplyTransaction failed. cmd {} logIndex "
operator|+
literal|"{} exception {}"
argument_list|,
name|gid
