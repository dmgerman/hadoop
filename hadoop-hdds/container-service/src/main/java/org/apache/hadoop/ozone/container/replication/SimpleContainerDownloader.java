...
name|setNameFormat
argument_list|(
literal|"Container downloader thread - %d"
argument_list|)
operator|.
name|build
argument_list|()
...
name|info
argument_list|(
literal|"Starting container downloader service to copy "
operator|+
literal|"containers to replicate."
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|error
argument_list|(
literal|"Can't stop container downloader gracefully"
argument_list|,
name|e
argument_list|)
expr_stmt|;
