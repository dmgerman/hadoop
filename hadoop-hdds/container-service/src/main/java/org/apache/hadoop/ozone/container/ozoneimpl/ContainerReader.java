...
name|config
decl_stmt|;
DECL|method|ContainerReader (File volumeRoot, ContainerSet cset, OzoneConfiguration conf)
name|ContainerReader
parameter_list|(
name|File
name|volumeRoot
...
block|}
block|}
DECL|method|verifyContainerFile (File containerFile, File checksumFile, File dbFile)
specifier|private
name|void
name|verifyContainerFile
parameter_list|(
