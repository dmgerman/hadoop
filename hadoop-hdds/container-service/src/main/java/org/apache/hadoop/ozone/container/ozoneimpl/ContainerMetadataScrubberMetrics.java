...
begin_comment
comment|/**  * This class captures the container meta-data scrubber metrics on the  * data-node.  **/
end_comment
...
literal|"dfs"
argument_list|)
DECL|class|ContainerMetadataScrubberMetrics
specifier|public
specifier|final
class|class
...
expr_stmt|;
block|}
DECL|method|ContainerMetadataScrubberMetrics (String name, MetricsSystem ms)
specifier|private
name|ContainerMetadataScrubberMetrics
parameter_list|(
name|String
