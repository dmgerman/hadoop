...
argument_list|)
decl_stmt|;
comment|// Populate UGI context via ServerCredentialInterceptor
name|SecurityConfig
name|secConfig
init|=
operator|new
...
condition|)
block|{
comment|// Only needed for mutual TLS
name|sslClientContextBuilder
operator|.
name|clientAuth
argument_list|(
...
name|error
argument_list|(
literal|"Unable to setup TLS for secure datanode GRPC endpoint."
argument_list|,
name|ex
argument_list|)
expr_stmt|;
