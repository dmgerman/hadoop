...
DECL|method|reportFatalError (TaskAttemptID id, Throwable throwable, String logMsg)
specifier|protected
name|void
...
expr_stmt|;
block|}
comment|/**    * Return current state of the task.     * needs to be synchronized as communication thread     * sends the state every second    * @return    */
...
function_decl|;
comment|/** Return an approprate thread runner for this task.     * @param tip TODO*/
...
argument_list|()
expr_stmt|;
comment|// Updating resources specified in ResourceCalculatorPlugin
if|if
condition|(
name|resourceCalculator
operator|==
...
literal|null
decl_stmt|;
DECL|field|counterNames
specifier|private
name|String
index|[]
name|counterNames
decl_stmt|;
DECL|method|FileSystemStatisticUpdater (String uriScheme, FileSystem.Statistics stats)
name|FileSystemStatisticUpdater
parameter_list|(
name|String
name|uriScheme
