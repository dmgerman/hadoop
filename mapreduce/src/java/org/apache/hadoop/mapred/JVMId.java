...
expr_stmt|;
block|}
DECL|method|JVMId (JobID jobId, boolean isMap, int id)
specifier|public
name|JVMId
parameter_list|(
name|JobID
...
expr_stmt|;
block|}
DECL|method|JVMId (String jtIdentifier, int jobId, boolean isMap, int id)
specifier|public
name|JVMId
parameter_list|(
name|String
...
annotation|@
name|Override
DECL|method|compareTo (org.apache.hadoop.mapreduce.ID o)
specifier|public
name|int
name|compareTo
parameter_list|(
