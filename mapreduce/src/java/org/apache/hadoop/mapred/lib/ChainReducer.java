...
DECL|method|setReducer (JobConf job, Class<? extends Reducer<K1, V1, K2, V2>> klass, Class<? extends K1> inputKeyClass, Class<? extends V1> inputValueClass, Class<? extends K2> outputKeyClass, Class<? extends V2> outputValueClass, boolean byValue, JobConf reducerConf)
specifier|public
specifier|static
parameter_list|<
name|K1
...
expr_stmt|;
block|}
comment|/**    * Configures the ChainReducer, the Reducer and all the Mappers in the chain.    *<p/>    * If this method is overriden<code>super.configure(...)</code> should be    * invoked at the beginning of the overwriter method.    */
...
expr_stmt|;
block|}
comment|/**    * Chains the<code>reduce(...)</code> method of the Reducer with the    *<code>map(...)</code> methods of the Mappers in the chain.    */
annotation|@
...
block|}
block|}
comment|/**    * Closes  the ChainReducer, the Reducer and all the Mappers in the chain.    *<p/>    * If this method is overriden<code>super.close()</code> should be    * invoked at the end of the overwriter method.    */
DECL|method|close ()
specifier|public
name|void
name|close
