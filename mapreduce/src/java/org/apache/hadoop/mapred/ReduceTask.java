...
annotation|@
name|Override
DECL|method|createRunner (TaskTracker tracker, TaskInProgress tip)
specifier|public
name|TaskRunner
name|createRunner
parameter_list|(
...
decl_stmt|;
DECL|method|NewTrackingRecordWriter (org.apache.hadoop.mapreduce.RecordWriter<K,V> real, org.apache.hadoop.mapreduce.Counter recordCounter)
name|NewTrackingRecordWriter
parameter_list|(
name|org
operator|.
