...
argument_list|()
decl_stmt|;
comment|/**    * Create an event to record the successful completion of a task    * @param id Task ID    * @param finishTime Finish time of the task    * @param taskType Type of the task    * @param status Status string    * @param counters Counters for the task    */
DECL|method|TaskFinishedEvent (TaskID id, long finishTime, TaskType taskType, String status, Counters counters)
specifier|public
name|TaskFinishedEvent
parameter_list|(
name|TaskID
