...
decl_stmt|;
DECL|method|MapOutput (TaskAttemptID mapId, MergeManager<K,V> merger, long size, JobConf conf, LocalDirAllocator localDirAllocator, int fetcher, boolean primaryMapOutput)
name|MapOutput
parameter_list|(
name|TaskAttemptID
name|mapId
