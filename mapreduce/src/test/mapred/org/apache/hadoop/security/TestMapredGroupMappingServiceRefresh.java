...
begin_class
DECL|class|TestMapredGroupMappingServiceRefresh
specifier|public
class|class
name|TestMapredGroupMappingServiceRefresh
block|{
DECL|field|cluster
specifier|private
name|MiniDFSCluster
...
name|info
argument_list|(
literal|"GROUP MAPPING class name="
operator|+
name|config
operator|.
name|getClass
...
name|rsrc
init|=
literal|"testRefreshSuperUserGroupsConfiguration_rsrc.xml"
decl_stmt|;
