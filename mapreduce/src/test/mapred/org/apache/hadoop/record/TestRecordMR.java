...
parameter_list|)
block|{     }
DECL|method|map (RecInt key, RecInt val, OutputCollector<RecInt, RecString> out, Reporter reporter)
specifier|public
name|void
name|map
parameter_list|(
...
parameter_list|)
block|{     }
DECL|method|reduce (RecInt key, Iterator<RecString> it, OutputCollector<RecInt, RecString> out, Reporter reporter)
specifier|public
name|void
name|reduce
parameter_list|(
...
parameter_list|)
block|{     }
DECL|method|map (RecInt key, RecString val, OutputCollector<RecInt, RecString> out, Reporter reporter)
specifier|public
name|void
name|map
parameter_list|(
...
parameter_list|)
block|{     }
DECL|method|map (RecInt key, RecString val, OutputCollector<RecInt, RecInt> out, Reporter reporter)
specifier|public
name|void
name|map
parameter_list|(
...
parameter_list|)
block|{     }
DECL|method|reduce (RecInt key, Iterator<RecInt> it, OutputCollector<RecInt, RecInt> out, Reporter reporter)
specifier|public
name|void
name|reduce
parameter_list|(
...
name|println
argument_list|(
literal|"Usage: TestRecordMR<range><counts>"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"Note: a good test will have a<counts> value that is substantially larger than the<range>"
argument_list|)
expr_stmt|;
return|return;
block|}
