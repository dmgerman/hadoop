...
comment|// This only happens for real for non-local jobtrackers.
comment|// (The symlinks exist in "localRunner/" for local Jobtrackers,
comment|// but the user has no way to get at them.
if|if
condition|(
operator|!
literal|"local"
...
argument_list|)
expr_stmt|;
comment|// don't create symlink for LocalJobRunner
if|if
condition|(
operator|!
literal|"local"
...
expr_stmt|;
block|}
comment|/** Tests using a full MiniMRCluster. */
DECL|method|testMiniMRJobRunner ()
specifier|public
name|void
name|testMiniMRJobRunner
parameter_list|()
throws|throws
name|Exception
block|{
