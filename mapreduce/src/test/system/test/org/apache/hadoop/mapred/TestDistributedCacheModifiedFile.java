...
begin_class
DECL|class|TestDistributedCacheModifiedFile
specifier|public
class|class
name|TestDistributedCacheModifiedFile
block|{
DECL|field|cluster
specifier|private
specifier|static
...
argument_list|)
decl_stmt|;
DECL|method|TestDistributedCacheModifiedFile ()
specifier|public
name|TestDistributedCacheModifiedFile
parameter_list|()
throws|throws
...
annotation|@
name|Test
comment|/**    * This tests Distributed Cache for modified file    * @param none    * @return void    */
...
literal|0
decl_stmt|;
comment|// This counter increases with all the tasktrackers in which tasks ran
name|int
...
argument_list|()
decl_stmt|;
comment|// This boolean tells if two tasks ran onteh same tasktracker or not
name|boolean
name|taskTrackerFound
init|=
literal|false
decl_stmt|;
do|do
...
argument_list|)
decl_stmt|;
comment|// Before starting, Modify the file
name|String
name|input
init|=
...
argument_list|)
expr_stmt|;
comment|// The tasktrackerFound variable is initialized
name|taskTrackerFound
operator|=
literal|false
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// we have loopped through two times to look for task
...
name|debug
argument_list|(
literal|"The distributed FileCount is :"
operator|+
name|distributedFileCount
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"The taskTrackerFound is :"
operator|+
name|taskTrackerFound
argument_list|)
expr_stmt|;
comment|// If distributed cache is modified in dfs
comment|// between two job runs, it can be present more than once
...
name|fail
argument_list|(
literal|"The distributed cache file has to be two. "
operator|+
literal|"But found was "
operator|+
name|distributedFileCount
argument_list|)
expr_stmt|;
...
name|fail
argument_list|(
literal|"The distributed cache file cannot more than one."
operator|+
literal|" But found was "
operator|+
name|distributedFileCount
...
argument_list|()
expr_stmt|;
comment|// Waiting for 3 seconds for cleanup to start
name|Thread
operator|.
name|sleep
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Getting the last cleanup task's tasktracker also, as
comment|// distributed cache gets uploaded even during cleanup.
name|TaskInfo
index|[]
name|myTaskInfos
init|=
