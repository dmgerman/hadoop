...
return|;
block|}
comment|/**    * @param fileName    * @return the jobID String, parsed out of the file name. We return a valid    *         String for either a history log file or a config file. Otherwise,    *         [especially for .crc files] we return null.    */
...
condition|)
block|{
comment|// check if its a pre21 jobhistory file
name|jobId
operator|=
name|applyParser
argument_list|(
...
return|;
block|}
DECL|method|isJobConfXml (String fileName, InputStream input)
specifier|static
name|boolean
name|isJobConfXml
parameter_list|(
...
condition|)
block|{
comment|// check if its a pre21 jobhistory conf file
name|jobId
operator|=
name|applyParser
argument_list|(
