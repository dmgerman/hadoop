...
name|getLog
argument_list|(
literal|"org.apache.hadoop.mapred.FairSchedulerEventLog"
argument_list|)
decl_stmt|;
...
name|logDir
decl_stmt|;
comment|/**     * Active log file, which is {LOG_DIR}/hadoop-{user}-fairscheduler.{host}.log.    * Older files are also stored as {LOG_FILE}.date (date format YYYY-MM-DD).    */
DECL|field|logFile
specifier|private
name|String
name|logFile
...
name|appender
decl_stmt|;
DECL|method|init (Configuration conf, String jobtrackerHostname)
name|boolean
name|init
parameter_list|(
name|Configuration
...
name|get
argument_list|(
literal|"mapred.fairscheduler.eventlog.location"
argument_list|,
operator|new
name|File
argument_list|(
...
name|format
argument_list|(
literal|"%s%shadoop-%s-fairscheduler-%s.log"
argument_list|,
name|logDir
argument_list|,
name|File
