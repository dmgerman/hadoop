...
expr_stmt|;
block|}
comment|/**    * Test that shares are computed accurately even when there are many more    * frameworks than available slots.    */
DECL|method|testSmallShares ()
specifier|public
name|void
name|testSmallShares
parameter_list|()
block|{
name|scheds
operator|.
