...
begin_comment
comment|/**  * An interface implemented by client-side protocol translators to get the  * underlying proxy object the translator is operating on.  */
end_comment
...
operator|.
name|Private
DECL|interface|ProtocolTranslator
specifier|public
interface|interface
