...
return|;
block|}
DECL|method|getHealthMonitorProxy (Configuration conf, int timeoutMs, int retries)
specifier|public
name|HAServiceProtocol
name|getHealthMonitorProxy
parameter_list|(
...
name|IOException
block|{
comment|// Lower the timeout by setting retries to 1, so we quickly fail to connect
return|return
name|getProxyForAddress
argument_list|(
name|conf
...
return|;
block|}
DECL|method|getProxyForAddress (Configuration conf, int timeoutMs, int retries, InetSocketAddress addr)
specifier|private
name|HAServiceProtocol
name|getProxyForAddress
parameter_list|(
