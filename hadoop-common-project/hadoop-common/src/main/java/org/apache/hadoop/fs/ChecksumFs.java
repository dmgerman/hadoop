...
block|}
decl_stmt|;
DECL|field|defaultBytesPerChecksum
specifier|private
name|int
...
return|;
block|}
DECL|method|ChecksumFs (AbstractFileSystem theFs)
specifier|public
name|ChecksumFs
parameter_list|(
...
literal|1L
decl_stmt|;
DECL|method|ChecksumFSInputChecker (ChecksumFs fs, Path file)
specifier|public
name|ChecksumFSInputChecker
parameter_list|(
name|ChecksumFs
...
expr_stmt|;
block|}
DECL|method|ChecksumFSInputChecker (ChecksumFs fs, Path file, int bufferSize)
specifier|public
name|ChecksumFSInputChecker
parameter_list|(
name|ChecksumFs
...
argument_list|)
expr_stmt|;
comment|// Now create the chekcsumfile; adjust the buffsize
name|int
name|bytesPerSum
init|=
name|fs
