...
DECL|method|processPaths (PathData parent, RemoteIterator<PathData> itemsIterator)
specifier|protected
name|void
name|processPaths
parameter_list|(
...
condition|)
block|{
comment|// No grouping of contents required.
while|while
condition|(
name|itemsIterator
operator|.
...
block|}
block|}
DECL|method|processPathInternal (PathData item)
specifier|private
name|void
name|processPathInternal
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Whether the directory listing for a path should be sorted.?    * @return true/false.    */
...
return|;
block|}
comment|/**    * While using iterator method for listing for a path, whether to group items    * and process as array? If so what is the size of array?    * @return size of the grouping array.    */
...
comment|// required. Iterators not guaranteed to return sorted elements
name|processPaths
argument_list|(
name|item
argument_list|,
