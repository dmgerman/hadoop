...
return|;
block|}
comment|/**    * Create a mutable float gauge    * @param name  of the metric    * @param desc  metric description    * @param iVal  initial value    * @return a new gauge object    */
DECL|method|newGauge (String name, String desc, float iVal)
specifier|public
...
return|;
block|}
comment|/**    * Create a mutable float gauge    * @param info  metadata of the metric    * @param iVal  initial value    * @return a new gauge object    */
DECL|method|newGauge (MetricsInfo info, float iVal)
specifier|public
specifier|synchronized
name|MutableGaugeFloat
name|newGauge
...
return|;
block|}
DECL|method|newMutableRollingAverages ( String name, String valueName)
specifier|public
specifier|synchronized
