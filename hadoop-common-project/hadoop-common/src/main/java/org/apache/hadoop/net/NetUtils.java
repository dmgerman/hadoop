...
static|static
block|{
comment|// SecurityUtils requires a more secure host resolver if tokens are
comment|// using hostnames
...
expr_stmt|;
block|}
comment|/**    * This method is intended for use only by SecurityUtils!    * @param flag where the qualified or standard host resolver is used    *             to create socket addresses    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
DECL|method|setUseQualifiedHostResolver (boolean flag)
specifier|public
specifier|static
name|void
name|setUseQualifiedHostResolver
...
annotation|@
name|VisibleForTesting
DECL|method|setHostResolver (HostResolver newResolver)
specifier|static
name|void
