...
return|;
block|}
comment|/**    * Trims all the strings in a Collection<String> and returns a Set<String>.    * @param strings    * @return    */
DECL|method|getTrimmedStrings (Collection<String> strings)
specifier|public
specifier|static
name|Set
argument_list|<
