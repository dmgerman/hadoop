...
DECL|method|call (String protocol, BufferListWritable request)
...
name|protocol
decl_stmt|;
DECL|method|ClientTransceiver (InetSocketAddress addr, UserGroupInformation ticket, Configuration conf, SocketFactory factory, int rpcTimeout, String protocol)
specifier|public
name|ClientTransceiver
parameter_list|(
name|InetSocketAddress
...
argument_list|()
decl_stmt|;
DECL|method|addProtocol (Class<?> iface, Object impl)
specifier|public
name|void
name|addProtocol
parameter_list|(
...
argument_list|()
decl_stmt|;
DECL|method|Server (Class<?> iface, Object impl, String bindAddress, int port, int numHandlers, int numReaders, int queueSizePerHandler, boolean verbose, Configuration conf, SecretManager<? extends TokenIdentifier> secretManager )
specifier|public
name|Server
parameter_list|(
name|Class
...
argument_list|)
expr_stmt|;
comment|// RpcKind is WRITABLE since Avro is tunneled through WRITABLE
name|super
operator|.
name|addProtocol
argument_list|(
