...
expr_stmt|;
block|}
comment|/**    * Construct by the given {@link FsAction} and special bits.    * @param u user action    * @param g group action    * @param o other action    * @param sb sticky bit    * @param ab ACL bit    */
DECL|method|FsPermission (FsAction u, FsAction g, FsAction o, boolean sb, boolean ab)
specifier|public
name|FsPermission
parameter_list|(
name|FsAction
...
return|;
block|}
DECL|method|set (FsAction u, FsAction g, FsAction o, boolean sb, boolean ab)
specifier|private
name|void
name|set
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"invalid length(unixSymbolicPermission="
operator|+
name|unixSymbolicPermission
operator|+
literal|")"
...
literal|01000
expr_stmt|;
comment|// Add ACL bit value if set
if|if
condition|(
name|unixSymbolicPermission
operator|.
