...
name|OPTION_SPOLICY
operator|+
literal|"  Display the storage policy of files and directories.\n"
decl_stmt|;
...
return|;
block|}
comment|/**    * Should storage policies be displayed.    * @return true display storage policies, false doesn't display storage    *         policies    */
annotation|@
name|VisibleForTesting
DECL|method|isDisplaySPolicy ()
name|boolean
name|isDisplaySPolicy
parameter_list|()
block|{
return|return
name|this
