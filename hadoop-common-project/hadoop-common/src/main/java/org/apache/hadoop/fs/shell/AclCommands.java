...
expr_stmt|;
block|}
comment|// Print mask entry implied by group permission bits, or print group entry
comment|// if there is no access ACL (only default ACL).
name|out
operator|.
name|println
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// ACL sort order guarantees default mask is the second-to-last entry.
name|FsAction
name|maskPerm
init|=
name|entries
