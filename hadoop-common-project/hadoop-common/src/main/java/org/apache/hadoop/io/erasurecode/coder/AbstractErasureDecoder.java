...
return|;
block|}
comment|/**    * Which blocks were erased ? We only care data blocks here. Sub-classes can    * override this behavior.    * @param blockGroup    * @return output blocks to recover    */
