...
operator|.
name|Evolving
DECL|class|MutableRollingAverages
specifier|public
class|class
...
name|setNameFormat
argument_list|(
literal|"MutableRollingAverages-%d"
argument_list|)
operator|.
name|build
argument_list|()
...
argument_list|()
decl_stmt|;
DECL|field|WINDOW_SIZE_MS_DEFAULT
specifier|private
specifier|static
specifier|final
name|long
name|WINDOW_SIZE_MS_DEFAULT
init|=
literal|300_000
decl_stmt|;
DECL|field|NUM_WINDOWS_DEFAULT
specifier|private
specifier|static
specifier|final
name|int
name|NUM_WINDOWS_DEFAULT
init|=
literal|36
decl_stmt|;
comment|/**    * Constructor for {@link MutableRollingAverages}.    * @param metricValueName    */
DECL|method|MutableRollingAverages (String metricValueName)
specifier|public
name|MutableRollingAverages
parameter_list|(
name|String
...
expr_stmt|;
block|}
comment|/**    * This method is for testing only to replace the scheduledTask.    */
annotation|@
name|VisibleForTesting
DECL|method|replaceScheduledTask (int windows, long interval, TimeUnit timeUnit)
...
name|parent
decl_stmt|;
DECL|method|RatesRoller (final MutableRollingAverages parent)
name|RatesRoller
parameter_list|(
specifier|final
name|MutableRollingAverages
...
block|}
block|}
comment|/**    * Iterates over snapshot to capture all Avg metrics into rolling structure    * {@link MutableRollingAverages#averages}.    */
