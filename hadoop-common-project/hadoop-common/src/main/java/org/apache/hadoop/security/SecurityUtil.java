...
name|NetUtils
operator|.
name|setUseQualifiedHostResolver
argument_list|(
operator|!
name|flag
argument_list|)
expr_stmt|;
block|}
comment|/**    * Intended only for temporary use by NetUtils.  Do not use.    * @return whether tokens use an IP address    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
DECL|method|getTokenServiceUseIp ()
specifier|public
specifier|static
name|boolean
