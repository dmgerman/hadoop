...
name|forName
argument_list|(
literal|"com.ibm.security.krb5.Credentials"
argument_list|)
expr_stmt|;
name|krb5utilClass
operator|=
...
name|forName
argument_list|(
literal|"com.ibm.security.jgss.mech.krb5"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|forName
argument_list|(
literal|"sun.security.krb5.Credentials"
argument_list|)
expr_stmt|;
name|krb5utilClass
operator|=
...
decl_stmt|;
name|Method
name|acquireServiceCredsMeth
init|=
name|credentialsClass
operator|.
name|getDeclaredMethod
argument_list|(
literal|"acquireServiceCreds"
argument_list|,
name|String
operator|.
name|class
...
decl_stmt|;
name|Method
name|ticketToCredsMeth
init|=
name|krb5utilClass
operator|.
name|getDeclaredMethod
argument_list|(
literal|"ticketToCreds"
argument_list|,
name|KerberosTicket
operator|.
name|class
...
block|}
block|}
DECL|method|initKrb5CipherSuites ()
specifier|public
specifier|static
name|void
