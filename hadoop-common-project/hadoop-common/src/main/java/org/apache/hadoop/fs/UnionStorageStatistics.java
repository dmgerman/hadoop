...
literal|null
argument_list|,
literal|"The name of union storage statistics can not be null!"
argument_list|)
expr_stmt|;
name|Preconditions
operator|.
...
literal|null
argument_list|,
literal|"The stats of union storage statistics can not be null!"
argument_list|)
expr_stmt|;
for|for
control|(
...
literal|null
argument_list|,
literal|"The stats of union storage statistics can not have null element!"
argument_list|)
expr_stmt|;
block|}
name|this
