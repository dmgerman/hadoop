...
expr_stmt|;
block|}
DECL|method|match (String osStr)
specifier|public
name|boolean
name|match
parameter_list|(
...
argument_list|)
decl_stmt|;
DECL|method|getOSType (String osName)
specifier|protected
specifier|static
name|OSType
name|getOSType
...
argument_list|()
expr_stmt|;
comment|// Skip parsing if df was not successful
if|if
condition|(
name|getExitCode
argument_list|()
