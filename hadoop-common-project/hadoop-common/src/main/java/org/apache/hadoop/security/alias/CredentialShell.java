...
name|USAGE
init|=
literal|"check<alias> [-value alias-value] "
operator|+
...
name|DESC
init|=
literal|"The check subcommand check a password for the name\n"
operator|+
...
literal|null
decl_stmt|;
DECL|method|CheckCommand (String alias)
name|CheckCommand
parameter_list|(
name|String
name|alias
...
name|println
argument_list|(
literal|"Checking aliases for CredentialProvider: "
operator|+
name|provider
operator|.
name|toString
...
name|IOException
argument_list|(
literal|"No console available for checking user."
argument_list|)
throw|;
block|}
name|char
...
name|println
argument_list|(
literal|"Cannot check aliases for CredentialProvider: "
operator|+
name|provider
operator|.
name|toString
