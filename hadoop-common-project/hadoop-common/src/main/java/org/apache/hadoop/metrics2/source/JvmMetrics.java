...
parameter_list|()
block|{
comment|// during tests impl might exist, but is not registered
name|MetricsSystem
name|ms
init|=
name|DefaultMetricsSystem
...
literal|1024
decl_stmt|;
DECL|field|MEMORY_MAX_UNLIMITED_MB
specifier|static
specifier|public
specifier|final
name|float
name|MEMORY_MAX_UNLIMITED_MB
init|=
operator|-
literal|1
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|setPauseMonitor (final JvmPauseMonitor pauseMonitor)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|setGcTimeMonitor (GcTimeMonitor gcTimeMonitor)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|calculateMaxMemoryUsage (MemoryUsage memHeap)
specifier|private
name|float
name|calculateMaxMemoryUsage
parameter_list|(
