...
begin_comment
comment|/**  * No such protocol (i.e. interface) for and Rpc Call  *  */
end_comment

begin_class
DECL|class|RpcNoSuchProtocolException
specifier|public
class|class
...
literal|1L
decl_stmt|;
DECL|method|RpcNoSuchProtocolException (final String message)
specifier|public
name|RpcNoSuchProtocolException
parameter_list|(
specifier|final
