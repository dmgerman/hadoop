...
begin_comment
comment|/**  * Specifies the scope or intended usage of an ACL entry.  */
end_comment
...
operator|.
name|Evolving
DECL|enum|AclEntryScope
specifier|public
enum|enum
name|AclEntryScope
block|{
comment|/**    * An ACL entry that is inspected during permission checks to enforce    * permissions.    */
