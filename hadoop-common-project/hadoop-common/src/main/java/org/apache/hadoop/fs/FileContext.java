...
expr_stmt|;
block|}
comment|/**    * Removes ACL entries from files and directories.  Other ACL entries are    * retained.    *    * @param path Path to modify    * @param aclSpec List{@literal<}AclEntry{@literal>} describing entries    * to remove    * @throws IOException if an ACL could not be modified    */
...
expr_stmt|;
block|}
comment|/**    * Fully replaces ACL of files and directories, discarding all existing    * entries.    *    * @param path Path to modify    * @param aclSpec List{@literal<}AclEntry{@literal>} describing    * modifications, must include entries for user, group, and others for    * compatibility with permission bits.    * @throws IOException if an ACL could not be modified    */
...
expr_stmt|;
block|}
comment|/**    * Gets the ACLs of files and directories.    *    * @param path Path to get    * @return RemoteIterator{@literal<}AclStatus{@literal>} which returns    *         each AclStatus    * @throws IOException if an ACL could not be read    */
...
return|;
block|}
comment|/**    * Builder returned for {@link #openFile(Path)}.    */
...
name|FutureDataInputStreamBuilderImpl
block|{
comment|/**      * Path Constructor.      * @param path path to open.      */
DECL|method|FSDataInputStreamBuilder ( @onnull final Path path)
specifier|protected
name|FSDataInputStreamBuilder
parameter_list|(
annotation|@
...
expr_stmt|;
block|}
comment|/**      * Perform the open operation.      *      * @return a future to the input stream.      * @throws IOException early failure to open      * @throws UnsupportedOperationException if the specific operation      * is not supported.      * @throws IllegalArgumentException if the parameters are not valid.      */
annotation|@
name|Override
DECL|method|build ()
specifier|public
