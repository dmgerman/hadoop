...
begin_comment
comment|/**  * A container class for javax.servlet.Filter.   */
end_comment

begin_interface
DECL|interface|FilterContainer
specifier|public
interface|interface
...
parameter_list|)
function_decl|;
comment|/**    * Add a global filter to the container.    * @param name filter name    * @param classname filter class name    * @param parameters a map from parameter names to initial values    */
