...
block|{     }
block|}
comment|/**    * Write a ByteBuffer to a WritableByteChannel, handling short writes.    *     * @param bc               The WritableByteChannel to write to.    * @param buf              The input buffer    * @param offset           The offset in the file to start writing at.    * @throws IOException     On I/O error.    */
