...
expr_stmt|;
block|}
DECL|method|lazyRefresh (String includesFile, String excludesFile)
specifier|public
name|void
name|lazyRefresh
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|refreshInternal (String includesFile, String excludesFile, boolean lazy)
specifier|private
name|void
name|refreshInternal
parameter_list|(
...
name|info
argument_list|(
literal|"Refreshing hosts (include/exclude) list (lazy refresh = {})"
argument_list|,
name|lazy
argument_list|)
expr_stmt|;
...
argument_list|(
literal|"Cannot finish refresh - call lazyRefresh() first"
argument_list|)
throw|;
block|}
name|current
...
return|;
block|}
DECL|method|getLazyLoadedHostDetails ()
specifier|public
name|HostDetails
