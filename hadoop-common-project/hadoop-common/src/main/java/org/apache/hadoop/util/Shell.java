...
name|revision
decl_stmt|;
DECL|method|LinuxKernelVersion (short major, short minor, short revision)
specifier|public
name|LinuxKernelVersion
parameter_list|(
name|short
...
expr_stmt|;
block|}
comment|/**      * Parse Linux kernel version string from output of POSIX command 'uname -r'      * @param version version string from POSIX command 'uname -r'      * @return LinuxKernelVersion      * @throws IllegalArgumentException      *      * Note:      * On CentOS 5.8: '2.6.18-308.24.1.el5'      * On Ubuntu 14:  '3.13.0-32-generic'      */
DECL|method|parseLinuxKernelVersion (String version)
specifier|public
specifier|static
name|LinuxKernelVersion
...
annotation|@
name|Override
DECL|method|compareTo (LinuxKernelVersion o)
specifier|public
name|int
name|compareTo
parameter_list|(
...
block|}
block|}
comment|/*    * sendfile() API between two file descriptors    * is only supported on Linux Kernel version 2.6.33+    * according to http://man7.org/linux/man-pages/man2/sendfile.2.html    */
DECL|field|isLinuxSendfileAvailable
specifier|public
specifier|static
specifier|final
name|boolean
...
init|=
name|isLinuxSendfileSupported
argument_list|()
decl_stmt|;
DECL|field|minLkvSupportSendfile
specifier|private
specifier|static
name|LinuxKernelVersion
name|minLkvSupportSendfile
init|=
operator|new
name|LinuxKernelVersion
argument_list|(
...
argument_list|)
decl_stmt|;
DECL|method|isLinuxSendfileSupported ()
specifier|private
specifier|static
name|boolean
name|isLinuxSendfileSupported
...
name|warn
argument_list|(
literal|"isLinuxSendfileSupported() failed unexpected: "
operator|+
name|e
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"uname exited with exit code "
operator|+
operator|(
name|shexec
operator|!=
