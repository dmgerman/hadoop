...
block|}
block|}
comment|/**    * Static method to destroy all running<code>Shell</code> processes    * Iterates through a list of all currently running<code>Shell</code>    * processes and destroys them one by one. This method is thread safe and    * is intended to be used in a shutdown hook.    */
DECL|method|destroyAllProcesses ()
specifier|public
specifier|static
name|void
