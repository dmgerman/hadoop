...
literal|"User-Agent"
decl_stmt|;
DECL|field|BROWSER_USER_AGENT_PARAM
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|BROWSER_USER_AGENTS_DEFAULT
specifier|static
specifier|final
name|String
...
expr_stmt|;
block|}
DECL|method|parseBrowserUserAgents (String userAgents)
name|void
name|parseBrowserUserAgents
parameter_list|(
name|String
...
DECL|method|handleHttpInteraction (HttpInteraction httpInteraction)
specifier|public
name|void
...
annotation|@
name|Override
DECL|method|doFilter (ServletRequest request, ServletResponse response, final FilterChain chain)
specifier|public
name|void
name|doFilter
parameter_list|(
