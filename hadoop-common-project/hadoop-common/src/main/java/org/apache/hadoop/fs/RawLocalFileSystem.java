...
block|}
block|}
comment|/**    * Returns the target of the given symlink. Returns the empty string if    * the given path does not refer to a symlink or there is an error    * accessing the symlink.    */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**    * Deprecated. Remains for windows support. Should be removed in favor of    * {@link #getFileLinkStatusInternal(Path, boolean)} when {@link Stat} gains    * support for windows.    */
annotation|@
name|Deprecated
DECL|method|getFileLinkStatusInternal (final Path f)
specifier|private
name|FileStatus
name|getFileLinkStatusInternal
parameter_list|(
