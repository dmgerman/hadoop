...
return|;
block|}
comment|/**    * Strip out the root from the path.    * @param p - fully qualified path p    * @return -  the remaining path  without the beginning /    * @throws IOException if the p is not prefixed with root    */
...
annotation|@
name|Override
DECL|method|getFileChecksum (final Path f, final long length)
specifier|public
name|FileChecksum
name|getFileChecksum
parameter_list|(
...
annotation|@
name|Override
DECL|method|createFile (final Path path)
specifier|public
name|FSDataOutputStreamBuilder
name|createFile
parameter_list|(
...
annotation|@
name|Override
DECL|method|openFile (final Path path)
specifier|public
name|FutureDataInputStreamBuilder
name|openFile
parameter_list|(
