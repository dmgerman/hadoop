...
name|nextBlock
expr_stmt|;
comment|// current block position
name|nextBlock
operator|=
name|curPos
expr_stmt|;
block|}
block|}
comment|// Follow the same logic as in
comment|// {@link MapFile.Writer#append(WritableComparable, Writable)}
if|if
condition|(
name|cnt
operator|>=
