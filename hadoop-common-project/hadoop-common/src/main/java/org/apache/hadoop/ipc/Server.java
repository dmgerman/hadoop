...
block|}
block|}
DECL|method|updateMetrics (Call call, long startTime, boolean connDropped)
name|void
name|updateMetrics
parameter_list|(
name|Call
...
parameter_list|)
block|{
comment|// delta = handler + processing + response
name|long
name|deltaNanos
init|=
name|Time
...
argument_list|()
decl_stmt|;
comment|// queue time is the delta between when the call first arrived and when it
comment|// began being serviced, minus the time it took to be put into the queue
name|details
operator|.
name|set
argument_list|(
...
condition|)
block|{
comment|// call was skipped; don't include it in processing metrics
return|return;
block|}
name|long
name|processingTime
...
argument_list|)
expr_stmt|;
comment|// don't include lock wait for detailed metrics.
name|processingTime
operator|-=
name|waitTime
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// the method name to use in metrics
DECL|field|detailedMetricsName
specifier|private
specifier|volatile
name|String
...
DECL|field|clientStateId
specifier|private
name|long
name|clientStateId
decl_stmt|;
DECL|field|isCallCoordinated
specifier|private
name|boolean
name|isCallCoordinated
decl_stmt|;
DECL|method|Call ()
name|Call
parameter_list|()
...
expr_stmt|;
block|}
comment|/**      * Indicates whether the call has been processed. Always true unless      * overridden.      *      * @return true      */
DECL|method|isOpen ()
name|boolean
name|isOpen
parameter_list|()
...
return|;
block|}
DECL|method|setDetailedMetricsName (String name)
name|void
name|setDetailedMetricsName
parameter_list|(
name|String
name|name
parameter_list|)
...
expr_stmt|;
block|}
DECL|method|getProcessingDetails ()
specifier|public
name|ProcessingDetails
name|getProcessingDetails
parameter_list|()
...
return|;
block|}
DECL|method|setClientStateId (long stateId)
specifier|public
name|void
name|setClientStateId
parameter_list|(
name|long
name|stateId
parameter_list|)
...
expr_stmt|;
block|}
DECL|method|markCallCoordinated (boolean flag)
specifier|public
name|void
name|markCallCoordinated
parameter_list|(
name|boolean
name|flag
parameter_list|)
...
DECL|field|responseParams
specifier|private
name|ResponseParams
name|responseParams
decl_stmt|;
comment|// the response params
DECL|field|rv
specifier|private
name|Writable
name|rv
...
return|;
block|}
DECL|method|setResponseFields (Writable returnValue, ResponseParams responseParams)
name|void
name|setResponseFields
parameter_list|(
name|Writable
name|returnValue
parameter_list|,
...
block|}
block|}
DECL|field|PURGE_INTERVAL_NANOS
specifier|private
specifier|final
specifier|static
name|long
...
condition|)
block|{
comment|// if call.rpcRequest is not RpcProtobufRequest, will skip the following
comment|// step and treat the call as uncoordinated. As currently only certain
comment|// ClientProtocol methods request made through RPC protobuf needs to be
comment|// coordinated.
name|String
name|methodName
decl_stmt|;
...
name|RpcServerException
argument_list|(
literal|"Processing RPC request caught "
argument_list|,
name|ioe
argument_list|)
throw|;
...
literal|0
decl_stmt|;
comment|// True iff the connection for this call has been dropped.
comment|// Set to true by default and update to false later if the connection
comment|// can be succesfully read.
name|boolean
name|connDropped
init|=
literal|true
...
name|debug
argument_list|(
literal|"Served: [{}]{} name={} user={} details={}"
argument_list|,
name|call
argument_list|,
operator|(
