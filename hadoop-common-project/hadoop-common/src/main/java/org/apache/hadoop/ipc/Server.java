...
parameter_list|)
block|{
comment|// log stack trace for "interesting" exceptions not sent to client
name|LOG
operator|.
name|info
argument_list|(
...
block|}
block|}
DECL|method|saslReadAndProcess (DataInputStream dis)
specifier|private
name|RpcSaslProto
...
return|;
block|}
DECL|method|processSaslMessage (DataInputStream dis)
specifier|private
name|RpcSaslProto
name|processSaslMessage
parameter_list|(
...
DECL|method|processConnectionContext (DataInputStream dis)
specifier|private
name|void
...
expr_stmt|;
block|}
comment|/**      * Process a RPC Request - if SASL wrapping is enabled, unwrap the      * requests and process each one, else directly process the request       * @param buf - single request or SASL wrapped requests      * @throws IOException - connection failed to authenticate or authorize,      *   or the request could not be decoded into a Call      * @throws InterruptedException      */
DECL|method|processRpcRequestPacket (byte[] buf)
specifier|private
name|void
name|processRpcRequestPacket
parameter_list|(
...
literal|"unchecked"
argument_list|)
DECL|method|decodeProtobufFromStream (Builder builder, DataInputStream dis)
specifier|private
parameter_list|<
name|T
extends|extends
