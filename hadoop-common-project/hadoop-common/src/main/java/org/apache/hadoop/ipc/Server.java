...
case|:
block|{
comment|// always allow tokens if there's a secret manager
name|useSaslServer
operator||=
operator|(
name|secretManager
...
block|}
block|}
DECL|method|createSaslServerInternal (AuthMethod authMethod)
specifier|private
name|SaslServer
name|createSaslServerInternal
parameter_list|(
