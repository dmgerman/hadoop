...
block|}
block|}
DECL|method|sendResponse (Call call)
specifier|private
name|void
name|sendResponse
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|abortResponse (Call call, Throwable t)
specifier|private
name|void
name|abortResponse
parameter_list|(
...
name|IOException
block|{
comment|// clone the call to prevent a race with the other thread stomping
...
DECL|method|setupResponse ( Call call, RpcStatusProto status, RpcErrorCodeProto erCode, Writable rv, String errorClass, String error)
specifier|private
name|void
name|setupResponse
parameter_list|(
...
block|}
block|}
DECL|method|setupResponse (Call call, RpcResponseHeaderProto header, Writable rv)
specifier|private
name|void
name|setupResponse
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// adjust capacity on estimated length to reduce resizing copies
name|int
name|estimatedLen
init|=
name|header
...
argument_list|)
expr_stmt|;
comment|// if it's not a wrapped protobuf, just let it grow on its own
if|if
condition|(
name|rv
operator|instanceof
...
expr_stmt|;
block|}
DECL|method|wrapWithSasl (Call call)
specifier|private
name|void
name|wrapWithSasl
parameter_list|(
