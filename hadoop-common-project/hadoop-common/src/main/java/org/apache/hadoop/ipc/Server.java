...
return|;
block|}
DECL|method|setResponse (Throwable t)
specifier|public
name|void
name|setResponse
parameter_list|(
...
condition|)
block|{
comment|// needed by postponed operations to indicate an exception has
comment|// occurred.  it's too late to re-encode the response so just
