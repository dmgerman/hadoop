...
DECL|method|getFingerprint (Method method)
specifier|static
name|int
name|getFingerprint
parameter_list|(
...
DECL|method|getFingerprints (Method[] methods)
specifier|private
specifier|static
name|int
index|[]
...
DECL|method|getFingerprint (Method[] methods)
specifier|static
name|int
name|getFingerprint
parameter_list|(
...
DECL|method|getFingerprint (int[] hashcodes)
specifier|static
name|int
name|getFingerprint
parameter_list|(
...
return|;
block|}
DECL|class|ProtocolSigFingerprint
specifier|private
specifier|static
class|class
...
name|fingerprint
decl_stmt|;
DECL|method|ProtocolSigFingerprint (ProtocolSignature sig, int fingerprint)
name|ProtocolSigFingerprint
parameter_list|(
name|ProtocolSignature
name|sig
...
name|ProtocolSigFingerprint
argument_list|>
DECL|field|PROTOCOL_FINGERPRINT_CACHE
