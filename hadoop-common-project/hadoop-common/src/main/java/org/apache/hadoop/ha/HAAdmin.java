...
literal|"<serviceId>"
argument_list|,
literal|"Transitions the service into Observer state"
argument_list|)
argument_list|)
decl|.
name|put
...
return|;
block|}
DECL|method|transitionToObserver (final CommandLine cmd)
specifier|private
name|int
...
name|println
argument_list|(
literal|"transitionToObserver: incorrect number of arguments"
argument_list|)
expr_stmt|;
name|printUsage
argument_list|(
...
return|;
block|}
comment|/**    * Check if the target supports the Observer state.    * @param target the target to check    * @return true if the target support Observer state, false otherwise.    */
DECL|method|checkSupportObserver (HAServiceTarget target)
specifier|private
name|boolean
name|checkSupportObserver
parameter_list|(
...
name|target
operator|+
literal|" doesn't support Observer state."
argument_list|)
expr_stmt|;
return|return
literal|false
