...
begin_comment
comment|/**  * Implementation of {@link FileSystem#globStatus(Path, PathFilter)}.  * This has historically been package-private; it has been opened  * up for object stores within the {@code hadoop-*} codebase ONLY.  * It could be expanded for external store implementations in future.  */
end_comment
...
expr_stmt|;
block|}
comment|/**    * Filesystem constructor for use by {@link GlobBuilder}.    * @param fs filesystem    * @param pathPattern path pattern    * @param filter optional filter    * @param resolveSymlinks should symlinks be resolved.    */
DECL|method|Globber (FileSystem fs, Path pathPattern, PathFilter filter, boolean resolveSymlinks)
specifier|private
name|Globber
parameter_list|(
name|FileSystem
...
name|debug
argument_list|(
literal|"Created Globber for path={}, symlinks={}"
argument_list|,
name|pathPattern
argument_list|,
name|resolveSymlinks
...
expr_stmt|;
block|}
comment|/**    * File Context constructor for use by {@link GlobBuilder}.    * @param fc file context    * @param pathPattern path pattern    * @param filter optional filter    * @param resolveSymlinks should symlinks be resolved.    */
DECL|method|Globber (FileContext fc, Path pathPattern, PathFilter filter, boolean resolveSymlinks)
specifier|private
name|Globber
parameter_list|(
name|FileContext
...
name|debug
argument_list|(
literal|"Created Globber path={}, symlinks={}"
argument_list|,
name|pathPattern
argument_list|,
name|resolveSymlinks
...
name|debug
argument_list|(
literal|"getFileStatus({}) failed; returning null"
argument_list|,
name|path
argument_list|,
name|e
...
name|debug
argument_list|(
literal|"listStatus({}) failed; returning empty array"
argument_list|,
name|path
argument_list|,
name|e
...
name|debug
argument_list|(
literal|"listStatus found one entry; disambiguating {}"
argument_list|,
name|children
index|[
literal|0
...
name|debug
argument_list|(
literal|"Resolved entry is a file; skipping: {}"
argument_list|,
name|status
argument_list|)
expr_stmt|;
...
block|{
comment|// there's no symlinks in this store, so no need to issue
comment|// another call, just see if the result is a directory or a file
if|if
condition|(
name|children
index|[
...
condition|)
block|{
comment|// the listing status is of a file
continue|continue;
block|}
block|}
block|}
...
name|debug
argument_list|(
literal|"No matches found and there was no wildcard in the path {}"
argument_list|,
name|pathPattern
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * Create a builder for a Globber, bonded to the specific filesystem.    * @param filesystem filesystem    * @return the builder to finish configuring.    */
DECL|method|createGlobber (FileSystem filesystem)
specifier|public
specifier|static
name|GlobBuilder
name|createGlobber
...
return|;
block|}
comment|/**    * Create a builder for a Globber, bonded to the specific file    * context.    * @param fileContext file context.    * @return the builder to finish configuring.    */
DECL|method|createGlobber (FileContext fileContext)
specifier|public
specifier|static
name|GlobBuilder
name|createGlobber
...
return|;
block|}
comment|/**    * Builder for Globber instances.    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
DECL|class|GlobBuilder
specifier|public
specifier|static
class|class
name|GlobBuilder
...
literal|true
decl_stmt|;
comment|/**      * Construct bonded to a file context.      * @param fc file context.      */
DECL|method|GlobBuilder (final FileContext fc)
specifier|public
name|GlobBuilder
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**      * Construct bonded to a filesystem.      * @param fs file system.      */
DECL|method|GlobBuilder (final FileSystem fs)
specifier|public
name|GlobBuilder
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**      * Set the path pattern.      * @param pattern pattern to use.      * @return the builder      */
DECL|method|withPathPattern (Path pattern)
specifier|public
name|GlobBuilder
...
return|;
block|}
comment|/**      * Set the path filter.      * @param pathFilter filter      * @return the builder      */
DECL|method|withPathFiltern (PathFilter pathFilter)
specifier|public
name|GlobBuilder
...
return|;
block|}
comment|/**      * Set the symlink resolution policy.      * @param resolve resolution flag.      * @return the builder      */
DECL|method|withResolveSymlinks (boolean resolve)
specifier|public
name|GlobBuilder
...
return|;
block|}
comment|/**      * Build the Globber.      * @return a new instance.      */
DECL|method|build ()
specifier|public
name|Globber
name|build
