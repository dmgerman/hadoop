...
operator|.
name|Evolving
DECL|interface|SSLHostnameVerifier
specifier|public
interface|interface
...
name|SSLException
function_decl|;
DECL|method|check (String[] hosts, SSLSocket ssl)
name|void
name|check
parameter_list|(
name|String
...
name|IOException
function_decl|;
DECL|method|check (String[] hosts, X509Certificate cert)
name|void
name|check
parameter_list|(
name|String
...
DECL|method|check (String[] hosts, String[] cns, String[] subjectAlts)
name|void
name|check
parameter_list|(
name|String
...
DECL|field|DEFAULT_AND_LOCALHOST
specifier|public
specifier|final
specifier|static
name|SSLHostnameVerifier
...
block|}
block|}
DECL|method|isIP4Address (final String cn)
specifier|public
specifier|static
name|boolean
name|isIP4Address
...
return|;
block|}
DECL|method|acceptableCountryWildcard (final String cn)
specifier|public
specifier|static
name|boolean
name|acceptableCountryWildcard
...
return|;
block|}
DECL|method|isLocalhost (String host)
specifier|public
specifier|static
name|boolean
name|isLocalhost
...
DECL|method|countDots (final String s)
specifier|public
specifier|static
name|int
name|countDots
...
name|Certificates
block|{
DECL|method|getCNs (X509Certificate cert)
specifier|public
specifier|static
name|String
index|[]
