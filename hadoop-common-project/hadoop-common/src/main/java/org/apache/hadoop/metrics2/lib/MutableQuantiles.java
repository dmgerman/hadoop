...
DECL|method|MutableQuantiles (String name, String description, String sampleName, String valueName, int interval)
specifier|public
name|MutableQuantiles
parameter_list|(
name|String
...
name|parent
decl_stmt|;
DECL|method|RolloverSample (MutableQuantiles parent)
specifier|public
name|RolloverSample
parameter_list|(
name|MutableQuantiles
