...
expr_stmt|;
block|}
comment|/**    * Constructor which allows assigning the /proc/ directories. This will be    * used only in unit tests.    * @param procfsMemFile fake file for /proc/meminfo    * @param procfsCpuFile fake file for /proc/cpuinfo    * @param procfsStatFile fake file for /proc/stat    * @param procfsNetFile fake file for /proc/net/dev    * @param jiffyLengthInMillis fake jiffy length value    */
annotation|@
name|VisibleForTesting
DECL|method|SysInfoLinux (String procfsMemFile, String procfsCpuFile, String procfsStatFile, String procfsNetFile, long jiffyLengthInMillis)
specifier|public
name|SysInfoLinux
parameter_list|(
name|String
