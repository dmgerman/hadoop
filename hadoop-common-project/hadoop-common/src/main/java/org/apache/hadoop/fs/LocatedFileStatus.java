...
DECL|method|LocatedFileStatus (long length, boolean isdir, int block_replication, long blocksize, long modification_time, long access_time, FsPermission permission, String owner, String group, Path symlink, Path path, Set<AttrFlags> attr, BlockLocation[] locations)
specifier|public
name|LocatedFileStatus
parameter_list|(
name|long
