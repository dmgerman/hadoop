...
name|CMD_EXE
operator|+
literal|" /q /c for %f in ( ) do "
operator|+
name|Shell
operator|.
name|WINUTILS
operator|+
literal|" hardlink create \\%f %f"
operator|)
operator|.
name|length
argument_list|()
