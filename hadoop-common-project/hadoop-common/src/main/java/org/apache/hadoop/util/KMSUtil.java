...
name|info
argument_list|(
literal|"KeyProvider is created with uri: {}. This should happen only "
operator|+
literal|"in tests."
argument_list|,
name|providerUriStr
...
return|;
block|}
comment|/**    * Creates a key provider from token service field, which must be URI format.    *    * @param conf    * @param tokenServiceValue    * @return new KeyProvider or null    * @throws IOException    */
DECL|method|createKeyProviderFromTokenService ( final Configuration conf, final String tokenServiceValue)
specifier|public
specifier|static
name|KeyProvider
...
name|debug
argument_list|(
literal|"Creating key provider from token service value {}. "
argument_list|,
name|tokenServiceValue
argument_list|)
expr_stmt|;
