...
argument_list|)
decl_stmt|;
comment|/**    * Suffix added by maven for nightly builds and other snapshot releases.    * These releases are considered to precede the non-SNAPSHOT version    * with the same version number.    */
...
return|;
block|}
DECL|method|stripSnapshotSuffix (String version)
specifier|private
specifier|static
name|String
name|stripSnapshotSuffix
