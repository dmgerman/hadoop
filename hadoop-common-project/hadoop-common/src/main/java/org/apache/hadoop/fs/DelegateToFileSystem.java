...
return|;
block|}
comment|/**    * Open a file by delegating to    * {@link FileSystem#openFileWithOptions(Path, Set, Configuration, int)}.    * @param path path to the file    * @param mandatoryKeys set of options declared as mandatory.    * @param options options set during the build sequence.    * @param bufferSize buffer size    * @return a future which will evaluate to the opened file.    * @throws IOException failure to resolve the link.    * @throws IllegalArgumentException unknown mandatory key    */
