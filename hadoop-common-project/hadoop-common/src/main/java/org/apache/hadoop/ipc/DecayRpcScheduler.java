...
decl_stmt|;
DECL|field|decayRpcSchedulerInfoBeanName
specifier|private
name|ObjectName
...
return|;
block|}
DECL|method|removeInstance (String namespace)
specifier|public
specifier|static
specifier|synchronized
name|void
...
expr_stmt|;
block|}
DECL|method|unregisterSource (String namespace)
name|void
