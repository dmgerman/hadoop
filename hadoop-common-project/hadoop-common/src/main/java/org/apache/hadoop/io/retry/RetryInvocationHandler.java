...
name|retryInvocationHandler
decl_stmt|;
DECL|method|Call (Method method, Object[] args, boolean isRpc, int callId, Counters counters, RetryInvocationHandler<?> retryInvocationHandler)
name|Call
parameter_list|(
name|Method
name|method
...
return|;
block|}
DECL|method|failover (long expectedFailoverCount, Method method)
specifier|synchronized
name|void
name|failover
parameter_list|(
...
name|warn
argument_list|(
literal|"A failover has occurred since the start of "
operator|+
name|proxyInfo
operator|.
name|getString
...
name|fail
decl_stmt|;
DECL|method|RetryInfo (long delay, RetryAction failover, RetryAction fail)
name|RetryInfo
parameter_list|(
name|long
name|delay
...
expr_stmt|;
block|}
DECL|method|newRetryInfo (RetryPolicy policy, Exception e, Counters counters, boolean idempotentOrAtMostOnce)
specifier|static
name|RetryInfo
name|newRetryInfo
parameter_list|(
...
return|;
block|}
DECL|method|newCall (Method method, Object[] args, boolean isRpc, int callId, Counters counters)
specifier|private
name|Call
name|newCall
parameter_list|(
...
block|}
block|}
DECL|method|handleException (final Method method, final RetryPolicy policy, final long expectedFailoverCount, final Counters counters, final Exception ex)
specifier|private
name|void
name|handleException
parameter_list|(
