...
block|}
block|}
comment|/**    * Adds the deprecated key to the deprecation map.    * It does not override any existing entries in the deprecation map.    * This is to be used only by the developers in order to add deprecation of    * keys, and attempts to call this method after loading resources once,    * would lead to<tt>UnsupportedOperationException</tt>    *     * @param key    * @param newKey    * @param customMessage    */
...
expr_stmt|;
block|}
comment|/**    * Adds the deprecated key to the deprecation map when no custom message    * is provided.    * It does not override any existing entries in the deprecation map.    * This is to be used only by the developers in order to add deprecation of    * keys, and attempts to call this method after loading resources once,    * would lead to<tt>UnsupportedOperationException</tt>    *     * @param key Key that is to be deprecated    * @param newKey key that takes up the value of deprecated key    */
...
return|;
block|}
comment|/**    * Returns the alternate name for a key if the property name is deprecated    * or if deprecates a property name.    *    * @param name property name.    * @return alternate name.    */
DECL|method|getAlternateNames (String name)
specifier|private
name|String
index|[]
...
condition|)
block|{
comment|//To help look for other new configs for this deprecated config
name|keyInfo
operator|=
name|deprecatedKeyMap
operator|.
...
condition|)
block|{
comment|// Cyclic resolution pattern detected. Return current expression.
return|return
name|eval
return|;
block|}
...
expr_stmt|;
block|}
DECL|method|warnOnceIfDeprecated (String name)
specifier|private
name|void
name|warnOnceIfDeprecated
parameter_list|(
...
return|;
block|}
DECL|method|parse (DocumentBuilder builder, URL url)
specifier|private
name|Document
name|parse
parameter_list|(
...
return|;
block|}
DECL|method|parse (DocumentBuilder builder, InputStream is, String systemId)
specifier|private
name|Document
name|parse
parameter_list|(
