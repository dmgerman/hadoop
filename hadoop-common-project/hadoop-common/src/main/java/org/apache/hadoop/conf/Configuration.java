...
argument_list|()
decl_stmt|;
comment|/**    * Map to register all classes holding property tag enums.    */
specifier|private
specifier|static
specifier|final
name|Map
...
name|Class
argument_list|>
DECL|field|REGISTERED_TAG_CLASS
name|REGISTERED_TAG_CLASS
init|=
operator|new
name|HashMap
argument_list|<>
...
argument_list|()
expr_stmt|;
comment|// Register all classes holding property tags with
name|REGISTERED_TAG_CLASS
operator|.
name|put
argument_list|(
...
return|;
block|}
DECL|method|parse (InputStream is, String systemIdStr)
specifier|private
name|XMLStreamReader
name|parse
parameter_list|(
...
return|;
block|}
comment|/**    * Get all properties belonging to tag.    * @return Properties with matching properties    */
DECL|method|getAllPropertiesByTag (final PropertyTag tag)
specifier|public
name|Properties
...
return|;
block|}
comment|/**    * Get all properties belonging to list of input tags. Calls    * getAllPropertiesByTag internally.    *    * @return Properties with all matching properties    */
DECL|method|getAllPropertiesByTags (final List<PropertyTag> tagList)
specifier|public
name|Properties
...
return|;
block|}
comment|/**    * Get Property tag Enum corresponding to given source.    *    * @param tagStr String representation of Enum    * @param group Group to which enum belongs.Ex hdfs,yarn    * @return Properties with all matching properties    */
DECL|method|getPropertyTag (String tagStr, String group)
specifier|private
name|PropertyTag
name|getPropertyTag
parameter_list|(
