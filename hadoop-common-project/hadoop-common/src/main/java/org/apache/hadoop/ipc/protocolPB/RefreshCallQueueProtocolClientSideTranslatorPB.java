...
begin_class
DECL|class|RefreshCallQueueProtocolClientSideTranslatorPB
specifier|public
class|class
...
specifier|static
name|RefreshCallQueueRequestProto
DECL|field|VOID_REFRESH_CALL_QUEUE_REQUEST
name|VOID_REFRESH_CALL_QUEUE_REQUEST
init|=
name|RefreshCallQueueRequestProto
operator|.
name|newBuilder
...
argument_list|()
decl_stmt|;
DECL|method|RefreshCallQueueProtocolClientSideTranslatorPB ( RefreshCallQueueProtocolPB rpcProxy)
specifier|public
name|RefreshCallQueueProtocolClientSideTranslatorPB
parameter_list|(
name|RefreshCallQueueProtocolPB
