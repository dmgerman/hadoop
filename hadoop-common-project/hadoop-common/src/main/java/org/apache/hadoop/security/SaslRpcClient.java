...
comment|// try to get the configured principal for the remote server
...
throw|;
block|}
comment|// construct the expected principal from the config
name|String
name|confPrincipal
init|=
name|SecurityUtil
...
throw|;
block|}
comment|// ensure it looks like a host-based service principal
name|KerberosName
name|name
init|=
operator|new
