...
annotation|@
name|Override
DECL|method|create (final Path f, final FsPermission permission, final EnumSet<CreateFlag> flags, final int bufferSize, final short replication, final long blockSize, final Progressable progress, final Options.ChecksumOpt checksumOpt)
specifier|public
name|FSDataOutputStream
name|create
parameter_list|(
...
return|;
block|}
comment|/**    * This is overridden to ensure that this class's    * {@link #openFileWithOptions}() method is called, and so ultimately    * its {@link #open(Path, int)}.    *    * {@inheritDoc}    */
annotation|@
name|Override
...
return|;
block|}
comment|/**    * Open the file as a blocking call to {@link #open(Path, int)}.    *    * {@inheritDoc}    */
annotation|@
name|Override
...
return|;
block|}
comment|/**    * This is overridden to ensure that this class's create() method is    * ultimately called.    *    * {@inheritDoc}    */
...
return|;
block|}
comment|/**    * Disable those operations which the checksummed FS blocks.    * {@inheritDoc}    */
annotation|@
name|Override
