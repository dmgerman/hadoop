...
annotation|@
name|VisibleForTesting
comment|/**    * Spawn a thread to do periodic renewals of kerberos credentials from    * a ticket cache.  NEVER directly call this method.    * @param force - used by tests to forcibly spawn thread    */
...
literal|true
decl_stmt|;
DECL|method|AutoRenewalForUserCredsRunnable (KerberosTicket tgt, String kinitCmd, long nextRefresh)
name|AutoRenewalForUserCredsRunnable
parameter_list|(
name|KerberosTicket
name|tgt
