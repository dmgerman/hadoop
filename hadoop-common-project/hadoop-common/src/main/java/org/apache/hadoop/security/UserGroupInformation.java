...
return|;
block|}
comment|// wrapper to retain the creds key for the token
DECL|class|NamedToken
specifier|private
class|class
name|NamedToken
block|{
...
name|token
decl_stmt|;
DECL|method|NamedToken (Text alias, Token<? extends TokenIdentifier> token)
name|NamedToken
parameter_list|(
name|Text
name|alias
...
argument_list|)
expr_stmt|;
comment|// allow token to be replaced
return|return
name|ugiCreds
operator|.
name|add
