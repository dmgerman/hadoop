...
begin_comment
comment|/**  * The LocalFs implementation of ChecksumFs.  */
end_comment
...
name|ChecksumFs
block|{
DECL|method|LocalFs (final Configuration conf)
name|LocalFs
parameter_list|(
specifier|final
name|Configuration
...
DECL|method|LocalFs (final URI theUri, final Configuration conf)
name|LocalFs
parameter_list|(
specifier|final
name|URI
