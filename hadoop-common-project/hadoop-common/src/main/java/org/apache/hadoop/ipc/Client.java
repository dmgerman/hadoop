...
argument_list|()
decl_stmt|;
comment|/** Set call id for the next call. */
DECL|method|setCallId (int cid)
specifier|public
specifier|static
name|void
name|setCallId
...
block|{
comment|// this only happens in lazy tests
name|authentication
operator|=
name|AuthenticationMethod
operator|.
...
return|;
block|}
comment|/** Make a call, passing<code>param</code>, to the IPC server running at    *<code>address</code>, returning the value.  Throws exceptions if there are    * network problems or if the remote code threw an exception.    * @deprecated Use {@link #call(RPC.RpcKind, Writable,    *  ConnectionId)} instead     */
annotation|@
name|Deprecated
DECL|method|call (RPC.RpcKind rpcKind, Writable param, InetSocketAddress address)
specifier|public
name|Writable
name|call
parameter_list|(
...
annotation|@
name|Deprecated
DECL|method|call (RPC.RpcKind rpcKind, Writable param, InetSocketAddress addr, UserGroupInformation ticket)
specifier|public
name|Writable
name|call
parameter_list|(
...
annotation|@
name|Deprecated
DECL|method|call (RPC.RpcKind rpcKind, Writable param, InetSocketAddress addr, Class<?> protocol, UserGroupInformation ticket, int rpcTimeout)
specifier|public
name|Writable
name|call
parameter_list|(
...
return|;
block|}
comment|/**    * Same as {@link #call(RPC.RpcKind, Writable, InetSocketAddress,    * Class, UserGroupInformation, int, Configuration)}    * except that rpcKind is writable.    */
...
return|;
block|}
comment|/**    * Same as {@link #call(Writable, InetSocketAddress,    * Class, UserGroupInformation, int, Configuration)}    * except that specifying serviceClass.    */
DECL|method|call (Writable param, InetSocketAddress addr, Class<?> protocol, UserGroupInformation ticket, int rpcTimeout, int serviceClass, Configuration conf)
specifier|public
name|Writable
name|call
parameter_list|(
...
DECL|method|call (RPC.RpcKind rpcKind, Writable param, InetSocketAddress addr, Class<?> protocol, UserGroupInformation ticket, int rpcTimeout, Configuration conf)
specifier|public
name|Writable
name|call
parameter_list|(
...
return|;
block|}
comment|/**    * Same as {link {@link #call(RPC.RpcKind, Writable, ConnectionId)}    * except the rpcKind is RPC_BUILTIN    */
...
DECL|method|call (RPC.RpcKind rpcKind, Writable rpcRequest, ConnectionId remoteId)
specifier|public
name|Writable
name|call
parameter_list|(
...
decl_stmt|;
comment|// how often sends ping to the server in msecs
DECL|method|ConnectionId (InetSocketAddress address, Class<?> protocol, UserGroupInformation ticket, int rpcTimeout, String serverPrincipal, int maxIdleTime, RetryPolicy connectionRetryPolicy, int maxRetriesOnSocketTimeouts, boolean tcpNoDelay, boolean doPing, int pingInterval)
name|ConnectionId
parameter_list|(
name|InetSocketAddress
name|address
