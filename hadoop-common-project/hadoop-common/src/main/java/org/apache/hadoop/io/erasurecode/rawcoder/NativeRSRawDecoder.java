...
begin_comment
comment|/**  * A Reed-Solomon raw decoder using Intel ISA-L library.  */
end_comment
...
expr_stmt|;
block|}
DECL|method|NativeRSRawDecoder (ErasureCoderOptions coderOptions)
specifier|public
name|NativeRSRawDecoder
parameter_list|(
name|ErasureCoderOptions
