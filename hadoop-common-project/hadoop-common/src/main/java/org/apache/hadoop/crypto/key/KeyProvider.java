...
name|versions
decl_stmt|;
DECL|method|Metadata (String cipher, int bitLength, String description, Date created, int versions)
specifier|protected
name|Metadata
parameter_list|(
name|String
...
name|IOException
function_decl|;
comment|/**    * Get the key metadata for all keys.    *    * @return a Map with all the keys and their metadata    * @throws IOException    */
DECL|method|getKeysMetadata ()
specifier|public
name|Map
argument_list|<
name|String
