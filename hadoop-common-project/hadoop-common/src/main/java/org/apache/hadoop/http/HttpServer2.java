...
name|X_FRAME_VALUE
init|=
literal|"xFrameOption"
decl_stmt|;
DECL|field|X_FRAME_ENABLED
specifier|private
specifier|static
specifier|final
name|String
...
return|;
block|}
comment|/**    * check whether user is static and unauthenticated, if the    * answer is TRUE, that means http sever is in non-security    * environment.    * @param servletContext the servlet context.    * @param request the servlet request.    * @return TRUE/FALSE based on the logic described above.    */
DECL|method|isStaticUserAndNoneAuthType ( ServletContext servletContext, HttpServletRequest request)
specifier|public
specifier|static
name|boolean
