...
argument_list|)
decl_stmt|;
DECL|field|prometheusSupport
specifier|private
name|boolean
name|prometheusSupport
decl_stmt|;
DECL|field|PROMETHEUS_SINK
specifier|protected
specifier|static
specifier|final
name|String
...
init|=
literal|"PROMETHEUS_SINK"
decl_stmt|;
DECL|field|prometheusMetricsSink
specifier|private
name|PrometheusMetricsSink
name|prometheusMetricsSink
decl_stmt|;
...
return|;
block|}
DECL|method|setEnabledProtocols (SslContextFactory sslContextFactory)
specifier|private
name|void
name|setEnabledProtocols
parameter_list|(
...
condition|)
block|{
comment|// Jetty 9.2.4.v20141103 and above excludes certain protocols by
comment|// default. Remove the user enabled protocols from the exclude list,
comment|// and add them into the include list.
name|String
index|[]
name|jettyExcludedProtocols
init|=
name|sslContextFactory
operator|.
...
name|debug
argument_list|(
literal|"Removed {} from exclude protocol list"
argument_list|,
name|jettyExcludedProtocol
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Reset exclude protocol list: {}"
argument_list|,
name|resetExcludedProtocols
argument_list|)
expr_stmt|;
...
argument_list|()
expr_stmt|;
name|addPrometheusServlet
argument_list|(
name|conf
argument_list|)
expr_stmt|;
block|}
DECL|method|addPrometheusServlet (Configuration conf)
specifier|private
name|void
name|addPrometheusServlet
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Add a Jersey resource package.    * @param packageName The Java package name containing the Jersey resource.    * @param pathSpec The path spec for the servlet    * @param params properties and features for ResourceConfig    */
DECL|method|addJerseyResourcePackage (final String packageName, final String pathSpec, Map<String, String> params)
specifier|public
name|void
name|addJerseyResourcePackage
parameter_list|(
...
literal|"prometheus"
argument_list|,
literal|"Hadoop metrics prometheus exporter"
argument_list|,
name|prometheusMetricsSink
argument_list|)
expr_stmt|;
