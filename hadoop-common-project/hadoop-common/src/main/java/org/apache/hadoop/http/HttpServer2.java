...
return|;
block|}
comment|/**      * A wrapper of {@link Configuration#getPassword(String)}. It returns      *<code>String</code> instead of<code>char[]</code> and throws      * {@link IOException} when the password not found.      *      * @param conf the configuration      * @param name the property name      * @return the password string      */
DECL|method|getPassword (Configuration conf, String name)
specifier|private
specifier|static
name|String
name|getPassword
