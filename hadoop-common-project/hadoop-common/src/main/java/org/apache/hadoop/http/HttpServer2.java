...
return|;
block|}
DECL|method|createHttpsChannelConnector ()
specifier|private
name|Connector
name|createHttpsChannelConnector
parameter_list|()
...
block|}
block|}
DECL|method|addListener (Connector connector)
specifier|private
name|void
name|addListener
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|configureChannelConnector (SelectChannelConnector c)
specifier|private
specifier|static
name|void
name|configureChannelConnector
...
name|put
argument_list|(
literal|"org.mortbay.jetty.servlet.Default.dirAllowed"
argument_list|,
literal|"false"
argument_list|)
expr_stmt|;
...
block|}
comment|/**    * Define a filter for a context and set up default url mappings.    */
DECL|method|defineFilter (Context ctx, FilterHolder holder, FilterMapping fmap)
specifier|private
specifier|static
name|void
name|defineFilter
