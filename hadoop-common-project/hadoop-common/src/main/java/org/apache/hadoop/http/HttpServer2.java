...
return|;
block|}
DECL|method|createHttpsChannelConnector (Server server)
specifier|private
name|ServerConnector
name|createHttpsChannelConnector
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|createWebAppContext (String name, Configuration conf, AccessControlList adminsAcl, final String appDir)
specifier|private
specifier|static
name|WebAppContext
name|createWebAppContext
...
operator|.
name|Private
DECL|method|createDefaultChannelConnector (Server server)
specifier|public
specifier|static
name|ServerConnector
name|createDefaultChannelConnector
