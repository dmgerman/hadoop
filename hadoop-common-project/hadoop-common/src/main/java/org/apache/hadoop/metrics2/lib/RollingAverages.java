...
argument_list|()
decl_stmt|;
comment|/**    * Constructor of {@link RollingAverages}.    * @param windowSizeMs    *          The number of milliseconds of each window for which subset    *          of samples are gathered to compute the rolling average, A.K.A.    *          roll over interval.    * @param numWindows    *          The number of windows maintained to compute the rolling average.    * @param valueName    *          of the metric (e.g. "Time", "Latency")    */
DECL|method|RollingAverages ( final long windowSizeMs, final int numWindows, final String valueName)
specifier|public
name|RollingAverages
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**    * Constructor of {@link RollingAverages}.    * @param windowSizeMs    *          The number of seconds of each window for which sub set of samples    *          are gathered to compute rolling average, also A.K.A roll over    *          interval.    * @param numWindows    *          The number of windows maintained in the same time to compute the    *          average of the rolling averages.    */
DECL|method|RollingAverages ( final long windowSizeMs, final int numWindows)
specifier|public
name|RollingAverages
parameter_list|(
specifier|final
