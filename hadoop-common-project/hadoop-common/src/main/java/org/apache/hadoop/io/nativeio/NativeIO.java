...
expr_stmt|;
block|}
comment|/**      * Resource limit types copied from<sys/resource.h>      */
DECL|class|ResourceLimit
specifier|private
specifier|static
class|class
name|ResourceLimit
block|{
DECL|field|RLIMIT_CPU
specifier|public
specifier|static
specifier|final
name|int
...
decl_stmt|;
block|}
DECL|method|getrlimit (int limit)
specifier|static
specifier|native
name|String
name|getrlimit
...
name|NativeIOException
function_decl|;
comment|/**      * Returns the soft limit on the number of bytes that may be locked by the      * process in bytes (RLIMIT_MEMLOCK).      *       * See the getrlimit(2) man page for more information      *        * @return maximum amount of locked memory in bytes      */
...
literal|false
decl_stmt|;
comment|/**    * The Windows logon name has two part, NetBIOS domain name and    * user account name, of the format DOMAIN\UserName. This method    * will remove the domain part of the full logon name.    *    * @param the full principal name containing the domain    * @return name with domain removed    */
