...
literal|4
decl_stmt|;
comment|/**      * Keeps the support state of PMDK.      */
DECL|enum|SupportState
specifier|public
enum|enum
name|SupportState
block|{
...
argument_list|)
block|,
DECL|enumConstant|PMDK_LIB_NOT_FOUND
...
name|stateCode
decl_stmt|;
DECL|method|SupportState (int stateCode)
name|SupportState
parameter_list|(
name|int
name|stateCode
...
block|}
block|}
comment|// Denotes the state of supporting PMDK. The value is set by JNI.
DECL|field|pmdkSupportState
specifier|private
specifier|static
name|SupportState
...
expr_stmt|;
block|}
comment|// This method is invoked by JNI.
DECL|method|setPmdkSupportState (int stateCode)
specifier|public
specifier|static
name|void
name|setPmdkSupportState
parameter_list|(
name|int
name|stateCode
parameter_list|)
...
return|;
block|}
comment|/**      * Denote memory region for a file mapped.      */
DECL|class|PmemMappedRegion
specifier|public
specifier|static
class|class
...
name|isPmem
decl_stmt|;
DECL|method|PmemMappedRegion (long address, long length, boolean isPmem)
specifier|public
name|PmemMappedRegion
parameter_list|(
name|long
...
block|}
block|}
comment|/**      * JNI wrapper of persist memory operations.      */
DECL|class|Pmem
specifier|public
specifier|static
class|class
name|Pmem
block|{
comment|// check whether the address is a Pmem address or DIMM address
DECL|method|isPmem (long address, long length)
specifier|public
specifier|static
name|boolean
name|isPmem
...
return|;
block|}
comment|// create a pmem file and memory map it
DECL|method|mapBlock (String path, long length)
specifier|public
specifier|static
name|PmemMappedRegion
name|mapBlock
...
return|;
block|}
comment|// unmap a pmem file
DECL|method|unmapBlock (long address, long length)
specifier|public
specifier|static
name|boolean
name|unmapBlock
...
return|;
block|}
comment|// copy data from disk file(src) to pmem file(dest), without flush
DECL|method|memCopy (byte[] src, long dest, boolean isPmem, long length)
specifier|public
specifier|static
name|void
name|memCopy
...
expr_stmt|;
block|}
comment|// flush the memory content to persistent storage
DECL|method|memSync (PmemMappedRegion region)
specifier|public
specifier|static
name|void
name|memSync
...
parameter_list|)
function_decl|;
DECL|method|pmemCreateMapFile (String path, long length)
specifier|private
specifier|static
specifier|native
name|PmemMappedRegion
...
parameter_list|)
function_decl|;
DECL|method|pmemUnMap (long address, long length)
specifier|private
specifier|static
specifier|native
name|boolean
...
parameter_list|)
function_decl|;
DECL|method|pmemCopy (byte[] src, long dest, boolean isPmem, long length)
specifier|private
specifier|static
specifier|native
name|void
...
parameter_list|()
function_decl|;
DECL|method|pmemSync (long address, long length)
specifier|private
specifier|static
specifier|native
name|void
...
literal|false
decl_stmt|;
comment|/**    * The Windows logon name has two part, NetBIOS domain name and    * user account name, of the format DOMAIN\UserName. This method    * will remove the domain part of the full logon name.    *    * @param name the full principal name containing the domain    * @return name with domain removed    */
...
name|dst
argument_list|)
init|;              FileChannel output = fos.getChannel()
block|)
block|{
name|long
name|remaining
