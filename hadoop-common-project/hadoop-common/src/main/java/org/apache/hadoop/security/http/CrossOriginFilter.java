...
literal|"*"
decl_stmt|;
DECL|field|ALLOWED_ORIGINS_REGEX_PREFIX
specifier|public
specifier|static
specifier|final
name|String
...
name|String
argument_list|>
name|discouragedAllowedOrigins
init|=
name|allowedOrigins
operator|.
name|stream
...
name|warn
argument_list|(
literal|"Allowed Origin pattern '"
operator|+
name|discouragedAllowedOrigin
operator|+
literal|"' is discouraged, use the 'regex:' prefix and use a Java regular expression instead."
argument_list|)
expr_stmt|;
block|}
block|}
