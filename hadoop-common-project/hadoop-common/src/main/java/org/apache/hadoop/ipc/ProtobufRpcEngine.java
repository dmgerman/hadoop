...
expr_stmt|;
block|}
comment|// Wrap the received message
name|ResponseStatus
name|status
init|=
name|response
...
parameter_list|()
block|{     }
DECL|method|RpcResponseWritable (HadoopRpcResponseProto message)
specifier|public
name|RpcResponseWritable
parameter_list|(
name|HadoopRpcResponseProto
...
return|;
block|}
DECL|method|getRemoteException (Exception e)
specifier|private
specifier|static
name|RemoteException
name|getRemoteException
