...
argument_list|>
argument_list|>
DECL|field|RETURN_MESSAGE_CALLBACK
name|RETURN_MESSAGE_CALLBACK
init|=
operator|new
name|ThreadLocal
argument_list|<>
...
annotation|@
name|Unstable
DECL|method|getReturnMessageCallback ()
specifier|public
specifier|static
parameter_list|<
name|T
...
block|}
block|}
DECL|method|getReturnMessage (final Method method, final RpcResponseWrapper rrw)
specifier|private
name|Message
name|getReturnMessage
parameter_list|(
