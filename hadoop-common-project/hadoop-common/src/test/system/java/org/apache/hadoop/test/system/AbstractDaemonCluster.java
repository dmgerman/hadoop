...
block|}
block|}
comment|/**    * Get the proxy user definitions from cluster from configuration.    * @return ProxyUserDefinitions - proxy users data like groups and hosts.    * @throws Exception - if no proxy users found in config.    */
DECL|method|getHadoopProxyUsers ()
specifier|public
name|ProxyUserDefinitions
name|getHadoopProxyUsers
parameter_list|()
throws|throws
name|Exception
block|{
