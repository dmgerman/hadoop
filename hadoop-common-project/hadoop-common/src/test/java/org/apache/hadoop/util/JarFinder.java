...
begin_class
DECL|class|JarFinder
specifier|public
class|class
name|JarFinder
block|{
DECL|method|copyToZipStream (File file, ZipEntry entry, ZipOutputStream zos)
specifier|private
specifier|static
name|void
...
block|}
block|}
DECL|method|jarDir (File dir, String relativePath, ZipOutputStream zos)
specifier|public
specifier|static
name|void
name|jarDir
...
expr_stmt|;
block|}
DECL|method|zipDir (File dir, String relativePath, ZipOutputStream zos, boolean start)
specifier|private
specifier|static
name|void
name|zipDir
...
block|}
block|}
DECL|method|createJar (File dir, File jarFile)
specifier|private
specifier|static
name|void
name|createJar
...
DECL|method|getJar (Class klass)
specifier|public
specifier|static
name|String
name|getJar
...
return|;
block|}
DECL|method|makeClassLoaderTestJar (Class<?> target, File rootDir, String jarName, int buffSize, String... clsNames)
specifier|public
specifier|static
name|File
