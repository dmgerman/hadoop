...
name|assertEquals
argument_list|(
literal|"Expunge should return zero"
argument_list|,
literal|0
argument_list|,
name|val
...
name|assertEquals
argument_list|(
literal|"Remove should return zero"
argument_list|,
literal|0
argument_list|,
name|val
...
name|assertEquals
argument_list|(
literal|"Recursive Remove should return zero"
argument_list|,
literal|0
argument_list|,
name|val
...
name|assertEquals
argument_list|(
literal|"Recursive Remove should return exit code 1"
argument_list|,
literal|1
argument_list|,
name|val
...
name|assertEquals
argument_list|(
literal|"Remove with skipTrash should return zero"
argument_list|,
literal|0
argument_list|,
name|val
...
name|assertEquals
argument_list|(
literal|"Count should have returned 10"
argument_list|,
name|num_runs
argument_list|,
name|count
...
name|indexOf
argument_list|(
literal|"Failed to determine server "
operator|+
literal|"trash configuration"
argument_list|)
operator|!=
operator|-
literal|1
...
expr_stmt|;
block|}
comment|// Verify expunge -immediate removes all checkpoints and current folder
block|{
comment|// Setup a recent and old checkpoint and a current folder
comment|// to be deleted on the next expunge and one that isn't.
name|long
name|trashInterval
init|=
...
name|assertEquals
argument_list|(
literal|"Expunge immediate should return zero"
argument_list|,
literal|0
argument_list|,
name|rc
...
name|assertFalse
argument_list|(
literal|"Old checkpoint should be removed"
argument_list|,
name|trashRootFs
operator|.
name|exists
...
name|assertFalse
argument_list|(
literal|"Recent checkpoint should be removed"
argument_list|,
name|trashRootFs
operator|.
name|exists
...
name|assertFalse
argument_list|(
literal|"Current folder should be removed"
argument_list|,
name|trashRootFs
operator|.
name|exists
...
name|assertEquals
argument_list|(
literal|"Ensure trash folder is empty"
argument_list|,
literal|0
argument_list|,
name|trashRootFs
...
annotation|@
name|Test
DECL|method|testExpungeWithFileSystem ()
specifier|public
name|void
name|testExpungeWithFileSystem
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Expunge immediate with filesystem should return zero"
argument_list|,
literal|0
argument_list|,
name|val
...
argument_list|)
expr_stmt|;
comment|// Incorrect FileSystem scheme
name|String
name|incorrectFS
init|=
literal|"incorrectfs:/"
...
name|assertEquals
argument_list|(
literal|"Expunge immediate should return exit code 1 when "
operator|+
literal|"incorrect Filesystem is passed"
argument_list|,
literal|1
argument_list|,
name|val
argument_list|)
expr_stmt|;
comment|// Empty FileSystem scheme
name|args
operator|=
operator|new
name|String
...
name|assertNotEquals
argument_list|(
literal|"Expunge immediate should fail when filesystem is NULL"
argument_list|,
literal|0
argument_list|,
name|val
...
annotation|@
name|Test
DECL|method|testExistingFileTrash ()
specifier|public
name|void
name|testExistingFileTrash
parameter_list|()
throws|throws
name|IOException
block|{
...
name|TEST_DIR
argument_list|,
literal|"test/mkdirs/myExistingFile"
argument_list|)
decl_stmt|;
name|writeFile
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Second  rm a file which parent path is the same as above
name|mkdir
argument_list|(
name|fs
argument_list|,
...
name|info
argument_list|(
literal|"Create a checkpoint, current number of checkpoints {}"
argument_list|,
name|numOfCheckpoint
operator|.
name|get
...
name|info
argument_list|(
literal|"Delete a checkpoint, current number of checkpoints {}"
argument_list|,
name|numOfCheckpoint
operator|.
name|get
...
name|info
argument_list|(
literal|"Delete all checkpoints, current number of checkpoints {}"
argument_list|,
name|numOfCheckpoint
operator|.
name|get
