...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of    * {@link FileUtil#symLink(String, String)} in case of null pointer inputs.    *    * @throws IOException    */
annotation|@
name|Test
DECL|method|testSymlinkWithNullInput ()
specifier|public
name|void
name|testSymlinkWithNullInput
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// Create the same symbolic link
comment|// The operation should fail and returns 1
name|int
name|result
init|=
name|FileUtil
...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of    * {@link FileUtil#symLink(String, String)} in case the file already exists.    *    * @throws IOException    */
annotation|@
name|Test
DECL|method|testSymlinkFileAlreadyExists ()
specifier|public
name|void
name|testSymlinkFileAlreadyExists
parameter_list|()
throws|throws
name|IOException
block|{
...
comment|// The operation should succeed
name|int
name|result1
init|=
name|FileUtil
...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of    * {@link FileUtil#symLink(String, String)} in case the file and the link are    * the same file.    *    * @throws IOException    */
annotation|@
name|Test
DECL|method|testSymlinkSameFile ()
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of    * {@link FileUtil#symLink(String, String)} in case we want to use a link for    * 2 different files.    *    * @throws IOException    */
annotation|@
name|Test
DECL|method|testSymlink2DifferentFile ()
specifier|public
name|void
name|testSymlink2DifferentFile
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of    * {@link FileUtil#symLink(String, String)} in case we want to use a 2    * different links for the same file.    *    * @throws IOException    */
annotation|@
name|Test
DECL|method|testSymlink2DifferentLinks ()
specifier|public
name|void
name|testSymlink2DifferentLinks
parameter_list|()
throws|throws
name|IOException
block|{
...
block|}
block|}
comment|/**    * This test validates the correctness of {@link FileUtil#readLink(File)} in    * case of null pointer inputs.    */
annotation|@
name|Test
DECL|method|testReadSymlinkWithNullInput ()
specifier|public
name|void
name|testReadSymlinkWithNullInput
parameter_list|()
block|{
name|String
name|result
...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of {@link FileUtil#readLink(File)}.    *    * @throws IOException    */
annotation|@
name|Test
DECL|method|testReadSymlink ()
specifier|public
name|void
name|testReadSymlink
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**    * This test validates the correctness of {@link FileUtil#readLink(File)} when    * it gets a file in input.    *    * @throws IOException    */
annotation|@
name|Test
DECL|method|testReadSymlinkWithAFileAsInput ()
specifier|public
name|void
name|testReadSymlinkWithAFileAsInput
parameter_list|()
throws|throws
name|IOException
block|{
