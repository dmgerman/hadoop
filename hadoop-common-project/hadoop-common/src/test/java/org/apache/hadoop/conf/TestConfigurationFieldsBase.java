...
argument_list|()
operator|+
literal|" properties that do not match the default Config value"
argument_list|)
expr_stmt|;
if|if
condition|(
...
argument_list|()
operator|+
literal|" properties with empty values"
argument_list|)
expr_stmt|;
if|if
condition|(
...
argument_list|()
operator|+
literal|" properties which match a corresponding Config variable"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|valuesChecked
operator|+
literal|" default values for collision."
argument_list|)
expr_stmt|;
block|}
block|}
