...
annotation|@
name|Test
DECL|method|testAclHashCode ()
specifier|public
name|void
name|testAclHashCode
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|testAclEntriesImmutable ()
specifier|public
name|void
name|testAclEntriesImmutable
parameter_list|()
block|{
name|AclEntry
name|entry
...
name|fail
argument_list|(
literal|"expected adding ACL entry to fail"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertEquals
argument_list|(
literal|"entries: [user:user1:rwx, group:group2:rw-, default:other::---], stickyBit: false"
argument_list|,
name|ACL1
operator|.
name|toString
...
name|assertEquals
argument_list|(
literal|"entries: [], stickyBit: true"
argument_list|,
name|ACL3
operator|.
name|toString
...
name|assertEquals
argument_list|(
literal|"file: file1, owner: owner1, group: group1, acl: {entries: [user:user1:rwx, group:group2:rw-, default:other::---], stickyBit: false}"
argument_list|,
name|STATUS1
operator|.
name|toString
...
name|assertEquals
argument_list|(
literal|"file: file2, owner: owner2, group: group2, acl: {entries: [], stickyBit: true}"
argument_list|,
name|STATUS3
operator|.
name|toString
