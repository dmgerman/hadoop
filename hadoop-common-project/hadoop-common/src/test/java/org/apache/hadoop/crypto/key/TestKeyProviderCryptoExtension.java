...
annotation|@
name|Test
DECL|method|testReencryptEncryptedKeys ()
specifier|public
name|void
name|testReencryptEncryptedKeys
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Generate 2 new EEKs @v0 and add to the list
name|ekvs
operator|.
name|add
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Generate 1 new EEK @v1 add to the list.
name|ekvs
operator|.
name|add
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Generate 1 new EEK @v2 add to the list.
name|ekvs
operator|.
name|add
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// leave a deep copy of the original, for verification purpose.
name|List
argument_list|<
name|EncryptedKeyVersion
argument_list|>
...
name|assertEquals
argument_list|(
literal|"Version name should be EEK"
argument_list|,
name|KeyProviderCryptoExtension
operator|.
name|EEK
...
name|assertEquals
argument_list|(
literal|"Encryption key name should be "
operator|+
name|ENCRYPTION_KEY_NAME
argument_list|,
name|ENCRYPTION_KEY_NAME
...
name|assertTrue
argument_list|(
literal|"Re-encrypted EEK should have same material"
argument_list|,
name|Arrays
operator|.
name|equals
...
argument_list|)
expr_stmt|;
comment|// Verify decrypting the new EEK and orig EEK gives the same material.
specifier|final
name|KeyVersion
name|origKv
init|=
...
name|assertTrue
argument_list|(
literal|"Returned EEK and original EEK should both decrypt to the "
operator|+
literal|"same kv."
argument_list|,
name|Arrays
