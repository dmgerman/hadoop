...
expr_stmt|;
block|}
comment|/**    * Test that if one thread is blocking in accept(), another thread    * can close the socket and stop the accept.    *    * @throws IOException    */
annotation|@
name|Test
argument_list|(
name|timeout
...
DECL|method|testClientServer1 (final Class<? extends WriteStrategy> writeStrategyClass, final Class<? extends ReadStrategy> readStrategyClass)
name|void
