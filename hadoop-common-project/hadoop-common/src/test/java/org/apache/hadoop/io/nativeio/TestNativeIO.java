...
name|info
argument_list|(
literal|"testStat() is successful."
argument_list|)
expr_stmt|;
block|}
finally|finally
...
block|}
block|}
DECL|method|doStatTest (String testFilePath)
specifier|private
name|boolean
name|doStatTest
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// direct check with System
name|String
name|expectedOwner
init|=
name|System
...
argument_list|)
expr_stmt|;
comment|// cross check with ProcessBuilder
name|StatUtils
operator|.
name|Permission
name|expected
...
name|info
argument_list|(
literal|"Load permission test is successful for path: {}, stat: {}"
argument_list|,
name|testFilePath
argument_list|,
name|stat
...
name|info
argument_list|(
literal|"On mask, stat is owner: {}, group: {}, permission: {}"
argument_list|,
name|owner
argument_list|,
name|group
...
annotation|@
name|Test
DECL|method|testStatOnError ()
specifier|public
name|void
name|testStatOnError
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|30000
argument_list|)
DECL|method|testMultiThreadedStat ()
specifier|public
name|void
name|testMultiThreadedStat
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"testMultiThreadedStat() is successful."
argument_list|)
expr_stmt|;
block|}
finally|finally
...
annotation|@
name|Test
DECL|method|testMultiThreadedStatOnError ()
specifier|public
name|void
name|testMultiThreadedStatOnError
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|10000
argument_list|)
DECL|method|testPmemCheckParameters ()
specifier|public
name|void
name|testPmemCheckParameters
parameter_list|()
block|{
name|assumeNotWindows
argument_list|(
literal|"Native PMDK not supported on Windows"
argument_list|)
expr_stmt|;
comment|// Skip testing while the build or environment does not support PMDK
name|assumeTrue
argument_list|(
name|NativeIO
operator|.
...
argument_list|)
expr_stmt|;
comment|// Please make sure /mnt/pmem0 is a persistent memory device with total
comment|// volume size 'volumeSize'
name|String
name|filePath
init|=
literal|"/$:"
...
name|fail
argument_list|(
literal|"Illegal length parameter should be detected"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|filePath
operator|=
literal|"/mnt/pmem0/test_native_io"
expr_stmt|;
name|length
operator|=
operator|-
...
literal|10000
argument_list|)
DECL|method|testPmemMapMultipleFiles ()
specifier|public
name|void
name|testPmemMapMultipleFiles
parameter_list|()
block|{
name|assumeNotWindows
argument_list|(
...
literal|1024L
decl_stmt|;
comment|// Multiple files, each with 128MB size, aggregated size exceeds volume
comment|// limit 16GB
name|length
operator|=
literal|128
...
name|fail
argument_list|(
literal|"Request map extra file when persistent memory is all occupied"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
literal|10000
argument_list|)
DECL|method|testPmemMapBigFile ()
specifier|public
name|void
name|testPmemMapBigFile
parameter_list|()
block|{
name|assumeNotWindows
argument_list|(
...
name|filePath
init|=
literal|"/mnt/pmem0/test_native_io_big"
decl_stmt|;
name|long
name|length
init|=
...
literal|1024L
decl_stmt|;
comment|// One file length exceeds persistent memory volume 16GB.
name|length
operator|=
name|volumeSize
operator|+
...
name|fail
argument_list|(
literal|"File length exceeds persistent memory total volume size"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
expr_stmt|;
comment|// Create and map a block file. Please make sure /mnt/pmem0 is a persistent
comment|// memory device.
name|String
name|filePath
init|=
literal|"/mnt/pmem0/copy"
decl_stmt|;
name|long
name|length
init|=
...
argument_list|)
expr_stmt|;
comment|// Copy content to mapped file
name|byte
index|[]
name|data
init|=
...
argument_list|)
expr_stmt|;
comment|// Read content before pmemSync
name|byte
index|[]
name|readBuf1
init|=
...
index|]
decl_stmt|;
comment|// Sync content to persistent memory twice
name|NativeIO
operator|.
name|POSIX
operator|.
...
argument_list|)
expr_stmt|;
comment|// Read content after pmemSync twice
name|IOUtils
operator|.
name|readFully
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//Read content after unmap twice
name|NativeIO
operator|.
name|POSIX
operator|.
...
return|;
block|}
DECL|method|deletePmemMappedFile (String filePath)
specifier|private
specifier|static
name|void
name|deletePmemMappedFile
