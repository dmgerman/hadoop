...
begin_comment
comment|/**  * A class that generates random numbers that follow some distribution.  */
end_comment

begin_class
DECL|class|RandomDistribution
specifier|public
class|class
name|RandomDistribution
block|{
comment|/**    * Interface for discrete (integer) random distributions.    */
DECL|interface|DiscreteRNG
specifier|public
specifier|static
interface|interface
name|DiscreteRNG
...
DECL|method|Flat (Random random, int min, int max)
specifier|public
name|Flat
parameter_list|(
name|Random
...
DECL|method|Zipf (Random r, int min, int max, double sigma)
specifier|public
name|Zipf
parameter_list|(
name|Random
...
DECL|method|Zipf (Random r, int min, int max, double sigma, double epsilon)
specifier|public
name|Zipf
parameter_list|(
name|Random
...
name|v
decl_stmt|;
DECL|method|select (int n, int k)
specifier|private
specifier|static
name|double
name|select
...
return|;
block|}
DECL|method|power (double p, int k)
specifier|private
specifier|static
name|double
name|power
...
DECL|method|Binomial (Random random, int min, int max, double p)
specifier|public
name|Binomial
parameter_list|(
name|Random
