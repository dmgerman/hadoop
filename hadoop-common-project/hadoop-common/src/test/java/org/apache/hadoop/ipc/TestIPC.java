...
expr_stmt|;
block|}
DECL|method|TestServer (int port, int handlerCount, boolean sleep)
specifier|public
name|TestServer
parameter_list|(
name|int
...
expr_stmt|;
block|}
DECL|method|TestServer (int port, int handlerCount, boolean sleep, Class<? extends Writable> paramClass, Class<? extends Writable> responseClass)
specifier|public
name|TestServer
parameter_list|(
name|int
...
expr_stmt|;
block|}
DECL|method|TestServer (int port, int handlerCount, boolean sleep, Class<? extends Writable> paramClass, Class<? extends Writable> responseClass, Configuration conf)
specifier|public
name|TestServer
parameter_list|(
name|int
...
annotation|@
name|Test
DECL|method|testAuxiliaryPorts ()
specifier|public
name|void
name|testAuxiliaryPorts
parameter_list|()
throws|throws
name|IOException
throws|,
...
block|}
block|}
comment|/**    * Mock socket class to help inject an exception for HADOOP-7428.    */
...
literal|60000
argument_list|)
DECL|method|testSetupConnectionShouldNotBlockShutdown ()
specifier|public
name|void
name|testSetupConnectionShouldNotBlockShutdown
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Track how many times we retried to set up the connection
specifier|final
name|AtomicInteger
name|createSocketCalled
init|=
operator|new
name|AtomicInteger
argument_list|()
...
argument_list|)
decl_stmt|;
comment|// Call a random function asynchronously so that we can call stop()
operator|new
name|Thread
argument_list|(
operator|new
...
argument_list|)
expr_stmt|;
comment|// stop() should stop the client immediately without any more retries
name|client
operator|.
name|stop
argument_list|()
