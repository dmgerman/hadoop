...
expr_stmt|;
block|}
comment|/**    * A helper used in log4j2 migration to accept legacy    * org.apache.commons.logging apis.    *<p>    * And will be removed after migration.    *    * @param log   a log    * @param level level to be set    */
annotation|@
name|Deprecated
DECL|method|setLogLevel (Log log, org.slf4j.event.Level level)
specifier|public
specifier|static
name|void
name|setLogLevel
...
expr_stmt|;
block|}
DECL|method|setRootLogLevel (org.slf4j.event.Level level)
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
DECL|method|setCurrentLoggersLogLevel (org.slf4j.event.Level level)
specifier|public
specifier|static
name|void
name|setCurrentLoggersLogLevel
parameter_list|(
name|org
operator|.
name|slf4j
...
block|}
block|}
DECL|method|toLevel (String level)
specifier|public
specifier|static
name|org
operator|.
...
return|;
block|}
DECL|method|toLevel ( String level, org.slf4j.event.Level defaultLevel)
specifier|public
specifier|static
name|org
operator|.
...
expr_stmt|;
block|}
DECL|method|SleepAnswer (int minSleepTime, int maxSleepTime)
specifier|public
name|SleepAnswer
parameter_list|(
name|int
...
block|}
block|}
comment|/**    * Retreive the max number of parallel test threads when running under maven.    * @return int number of threads    */
