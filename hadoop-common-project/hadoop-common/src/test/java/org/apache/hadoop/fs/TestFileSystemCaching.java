...
name|fail
argument_list|(
literal|"got fs with auth but no scheme"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
annotation|@
name|Test
DECL|method|testDeleteOnExitChecksExists ()
specifier|public
name|void
name|testDeleteOnExitChecksExists
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// path has to exist for deleteOnExit to register it
name|when
argument_list|(
name|mockFs
operator|.
...
argument_list|)
expr_stmt|;
comment|// make sure it doesn't try to delete a file that doesn't exist
name|when
argument_list|(
name|mockFs
operator|.
