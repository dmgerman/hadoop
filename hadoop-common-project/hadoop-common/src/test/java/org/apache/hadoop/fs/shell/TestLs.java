...
expr_stmt|;
block|}
comment|// check the -e option is recognised
annotation|@
name|Test
...
expr_stmt|;
block|}
comment|// check the -sp option is recognised
annotation|@
name|Test
DECL|method|processOptionsDisplaySPolicy ()
specifier|public
name|void
name|processOptionsDisplaySPolicy
parameter_list|()
throws|throws
name|IOException
block|{
