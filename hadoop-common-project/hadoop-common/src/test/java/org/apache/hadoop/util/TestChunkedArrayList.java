...
expr_stmt|;
block|}
comment|// Iterate through all list elements.
name|Iterator
argument_list|<
name|Integer
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Iterate through all odd list elements.
name|iter
operator|=
name|list
operator|.
...
argument_list|)
expr_stmt|;
comment|// Check that list is now empty.
name|Assert
operator|.
name|assertEquals
argument_list|(
