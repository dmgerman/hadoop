...
begin_class
DECL|class|TestHHXORErasureCoder
specifier|public
class|class
name|TestHHXORErasureCoder
extends|extends
...
annotation|@
name|Test
DECL|method|testCodingDirectBuffer_10x4_erasing_d4 ()
specifier|public
name|void
name|testCodingDirectBuffer_10x4_erasing_d4
parameter_list|()
block|{
name|prepare
argument_list|(
...
block|}
comment|//  @Test
comment|//  public void testCodingNoDirectBuffer_3x3_erasing_d0_p0() {
comment|//    prepare(null, 3, 3, new int[] {0}, new int[] {0});
comment|//    testCoding(false);
comment|//  }
annotation|@
name|Test
