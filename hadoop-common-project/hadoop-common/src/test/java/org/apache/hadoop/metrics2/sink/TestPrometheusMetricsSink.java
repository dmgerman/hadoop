...
annotation|@
name|Test
DECL|method|testNamingPeriods ()
specifier|public
name|void
name|testNamingPeriods
parameter_list|()
block|{
name|PrometheusMetricsSink
name|sink
...
name|assertEquals
argument_list|(
literal|"org_apache_hadoop_hdfs_server_datanode_fsdataset_impl_fs_dataset_impl_dfs_used"
argument_list|,
name|sink
operator|.
name|prometheusName
...
annotation|@
name|Test
DECL|method|testNamingWhitespaces ()
specifier|public
name|void
name|testNamingWhitespaces
parameter_list|()
block|{
name|PrometheusMetricsSink
name|sink
...
name|assertEquals
argument_list|(
literal|"jvm_metrics_gc_count_g1_old_generation"
argument_list|,
name|sink
operator|.
name|prometheusName
