...
block|}
block|}
DECL|method|compressDecompressLoop (int rawDataSize, int inSize, int outSize)
specifier|private
name|void
...
condition|)
block|{
comment|// flush when the buffer is full
name|outBuf
operator|.
name|flip
argument_list|()
...
argument_list|()
expr_stmt|;
comment|// zlib always has header
if|if
condition|(
name|compressed
operator|.
...
try|try
block|{
comment|// 0-2 bytes results in sizeof(outBuf)> sizeof(inBuf)
name|compressDecompressLoop
argument_list|(
literal|0
argument_list|,
