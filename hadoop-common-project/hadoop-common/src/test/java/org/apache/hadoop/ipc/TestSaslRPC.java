...
argument_list|)
decl_stmt|;
DECL|method|Denied (AuthenticationMethod method)
specifier|private
specifier|static
name|Pattern
name|Denied
...
annotation|@
name|Test
DECL|method|testSimpleServerWithTokensWithNoClientFallbackToSimple ()
specifier|public
name|void
name|testSimpleServerWithTokensWithNoClientFallbackToSimple
parameter_list|()
throws|throws
name|Exception
block|{
...
try|try
block|{
comment|// Client has a token even though its configs says simple auth. Server
comment|// is configured for simple auth, but as client sends the token, and
comment|// server asks to switch to simple, this should fail.
name|getAuthMethod
argument_list|(
name|SIMPLE
argument_list|,
...
literal|"Failed on local exception: "
operator|+
literal|"java.io.IOException: java.io.IOException: "
operator|+
