...
name|IOException
function_decl|;
DECL|method|echoPostponed (String value)
specifier|public
name|String
name|echoPostponed
parameter_list|(
...
begin_function
DECL|method|getConnectionId (Configuration conf)
specifier|static
name|ConnectionId
...
literal|1
argument_list|)
comment|// prevents ordering issues when unblocking calls.
operator|.
name|setVerbose
argument_list|(
literal|true
