...
name|UnreliableInterface
argument_list|>
DECL|method|newFlipFlopProxyProvider ()
name|newFlipFlopProxyProvider
parameter_list|()
block|{
return|return
operator|new
...
name|UnreliableInterface
argument_list|>
DECL|method|newFlipFlopProxyProvider (TypeOfExceptionToFailWith t1, TypeOfExceptionToFailWith t2)
name|newFlipFlopProxyProvider
parameter_list|(
name|TypeOfExceptionToFailWith
name|t1
