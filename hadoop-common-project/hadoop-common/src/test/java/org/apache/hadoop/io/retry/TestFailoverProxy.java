...
literal|0
decl_stmt|;
DECL|method|FlipFlopProxyProvider (Class<?> iface, Object activeImpl, Object standbyImpl, int getProxyCountDown)
specifier|public
name|FlipFlopProxyProvider
parameter_list|(
name|Class
...
block|}
DECL|method|setLatchEnabled (boolean latchEnabled)
specifier|public
name|void
name|setLatchEnabled
parameter_list|(
name|boolean
name|latchEnabled
parameter_list|)
...
argument_list|)
decl_stmt|;
comment|// Getting a proxy will now wait on a latch.
name|proxyProvider
operator|.
name|setLatchEnabled
argument_list|(
