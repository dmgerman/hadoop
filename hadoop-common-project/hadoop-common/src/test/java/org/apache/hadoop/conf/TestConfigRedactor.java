...
argument_list|,
literal|"fs.azure.account.key.abcdefg.dfs.core.windows.net"
argument_list|,
literal|"fs.azure.account.oauth2.client.secret"
argument_list|,
literal|"fs.azure.account.oauth2.client.secret.account.dfs.core.windows.net"
argument_list|,
literal|"fs.azure.account.oauth2.user.password"
argument_list|,
literal|"fs.azure.account.oauth2.user.password.account.dfs.core.windows.net"
argument_list|,
literal|"fs.azure.account.oauth2.refresh.token"
argument_list|,
literal|"fs.azure.account.oauth2.refresh.token.account.dfs.core.windows.net"
argument_list|,
