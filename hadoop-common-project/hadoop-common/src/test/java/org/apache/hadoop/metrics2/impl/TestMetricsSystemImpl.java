...
annotation|@
name|Test
DECL|method|testRegisterSinksMultiplePeriods ()
specifier|public
name|void
name|testRegisterSinksMultiplePeriods
parameter_list|()
throws|throws
name|Exception
block|{
...
name|add
argument_list|(
literal|"test.sink.test1.period"
argument_list|,
literal|100000
argument_list|)
operator|.
...
name|add
argument_list|(
literal|"test.sink.test2.period"
argument_list|,
literal|200000
argument_list|)
operator|.
...
argument_list|()
expr_stmt|;
comment|// Give some time for the publish event to go through
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
