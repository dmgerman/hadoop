...
expr_stmt|;
block|}
comment|// hadoop.security.authorization is set as true while
comment|// hadoop.http.authentication.type's value is `simple`(default value)
comment|// in this case, static user has administrator access
specifier|final
name|String
name|staticUser
init|=
