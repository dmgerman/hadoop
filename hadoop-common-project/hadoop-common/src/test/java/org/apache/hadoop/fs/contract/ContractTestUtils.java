...
expr_stmt|;
block|}
comment|/**    * Write a file.    * Optional flags control    * whether file overwrite operations should be enabled    * Optional using {@link org.apache.hadoop.fs.FSDataOutputStreamBuilder}    *    * @param fs filesystem    * @param path path to write to    * @param len length of data    * @param overwrite should the create option allow overwrites?    * @param useBuilder should use builder API to create file?    * @throws IOException IO problems    */
DECL|method|writeDataset (FileSystem fs, Path path, byte[] src, int len, int buffersize, boolean overwrite, boolean useBuilder)
specifier|public
specifier|static
name|void
name|writeDataset
...
return|;
block|}
comment|/**    * Rename operation. Safety check for attempts to rename the root directory.    * Verifies that src no longer exists after rename.    * @param fileSystem filesystem to work with    * @param src source path    * @param dst destination path    * @throws IOException If rename fails or src is the root directory.    */
DECL|method|rename (FileSystem fileSystem, Path src, Path dst)
specifier|public
specifier|static
name|void
name|rename
...
block|}
block|}
comment|/**    * Append to an existing file.    * @param fs filesystem    * @param path path to file    * @param data data to append. Can be null    * @throws IOException On any error    */
DECL|method|appendFile (FileSystem fs, Path path, byte[] data)
specifier|public
specifier|static
name|void
name|appendFile
...
block|}
block|}
comment|/**    * Read in "length" bytes, convert to an ascii string.    * This uses {@link #toChar(byte)} to escape bytes, so cannot be used    * for round trip operations.    * @param fs filesystem    * @param path path to read    * @param length #of bytes to read.    * @return the bytes read and converted to a string    * @throws IOException IO problems    */
...
block|}
block|}
comment|/**    * Read in "length" bytes, convert to UTF8 string.    * @param fs filesystem    * @param path path to read    * @param length #of bytes to read. If -1: use file length.    * @return the bytes read and converted to a string    * @throws IOException IO problems    */
DECL|method|readUTF8 (FileSystem fs, Path path, int length)
specifier|public
specifier|static
name|String
name|readUTF8
...
expr_stmt|;
block|}
comment|/**    * Verify that a path exists, returning the file status of the path.    *    * @param fileSystem filesystem to examine    * @param message message to include in the assertion failure message    * @param path path in the filesystem    * @throws FileNotFoundException raised if the path is missing    * @throws IOException IO problems    */
DECL|method|verifyPathExists (FileSystem fileSystem, String message, Path path)
specifier|public
specifier|static
name|FileStatus
name|verifyPathExists
...
name|error
argument_list|(
literal|"{}: not found {}; parent listing is:\n{}"
argument_list|,
name|message
argument_list|,
name|path
...
return|;
block|}
comment|/**    * Custom assert to test {@link StreamCapabilities}.    *    * @param stream The stream to test for StreamCapabilities    * @param shouldHaveCapabilities The array of expected capabilities    * @param shouldNotHaveCapabilities The array of unexpected capabilities    */
DECL|method|assertCapabilities ( Object stream, String[] shouldHaveCapabilities, String[] shouldNotHaveCapabilities)
specifier|public
specifier|static
name|void
...
name|String
index|[]
name|shouldHaveCapabilities
parameter_list|,
name|String
index|[]
name|shouldNotHaveCapabilities
parameter_list|)
block|{
name|assertTrue
argument_list|(
literal|"Stream should be instanceof StreamCapabilities"
argument_list|,
name|stream
operator|instanceof
name|StreamCapabilities
...
name|assertTrue
argument_list|(
literal|"Should have capability: "
operator|+
name|shouldHaveCapability
argument_list|,
name|source
...
name|assertFalse
argument_list|(
literal|"Should not have capability: "
operator|+
name|shouldNotHaveCapability
argument_list|,
name|source
...
block|}
block|}
comment|/**    * Custom assert to test {@link PathCapabilities}.    *    * @param source source (FS, FC, etc)    * @param path path to check    * @param capabilities The array of unexpected capabilities    */
DECL|method|assertHasPathCapabilities ( final PathCapabilities source, final Path path, final String...capabilities)
specifier|public
specifier|static
name|void
...
block|}
block|}
comment|/**    * Custom assert to test that the named {@link PathCapabilities}    * are not supported.    *    * @param source source (FS, FC, etc)    * @param path path to check    * @param capabilities The array of unexpected capabilities    */
DECL|method|assertLacksPathCapabilities ( final PathCapabilities source, final Path path, final String...capabilities)
specifier|public
specifier|static
name|void
...
name|assertFalse
argument_list|(
literal|"Path  must not support capability: "
operator|+
name|shouldHaveCapability
operator|+
literal|" under "
...
block|}
block|}
comment|/**    * Function which calls {@code InputStream.read()} and    * downgrades an IOE to a runtime exception.    * @param in input    * @return the read value    * @throws AssertionError on any IOException    */
...
block|}
block|}
comment|/**    * Read a whole stream; downgrades an IOE to a runtime exception.    * @param in input    * @return the number of bytes read.    * @throws AssertionError on any IOException    */
DECL|method|readStream (InputStream in)
specifier|public
specifier|static
name|long
name|readStream
...
return|;
block|}
comment|/**      * Dump the files and directories to a multi-line string for error      * messages and assertions.      * @return a dump of the internal state      */
DECL|method|dump ()
specifier|private
name|String
name|dump
