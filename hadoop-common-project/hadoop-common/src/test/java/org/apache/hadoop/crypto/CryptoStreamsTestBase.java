...
return|;
block|}
DECL|method|preadAll (PositionedReadable in, byte[] b, int off, int len)
specifier|private
name|int
name|preadAll
parameter_list|(
...
return|;
block|}
DECL|method|preadCheck (PositionedReadable in)
specifier|private
name|void
name|preadCheck
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|byteBufferPreadAll (ByteBufferPositionedReadable in, ByteBuffer buf)
specifier|private
name|int
name|byteBufferPreadAll
parameter_list|(
name|ByteBufferPositionedReadable
name|in
parameter_list|,
...
return|;
block|}
DECL|method|byteBufferPreadCheck (ByteBufferPositionedReadable in)
specifier|private
name|void
name|byteBufferPreadCheck
parameter_list|(
name|ByteBufferPositionedReadable
name|in
parameter_list|)
...
return|;
block|}
DECL|method|readAll (InputStream in, long pos, ByteBuffer buf)
specifier|private
name|int
name|readAll
parameter_list|(
...
expr_stmt|;
block|}
comment|/** Test positioned read with ByteBuffers. */
annotation|@
name|Test
argument_list|(
name|timeout
...
block|{
comment|// Pos: 1/3 dataLen
name|positionedReadCheckWithByteBuffer
argument_list|(
name|in
argument_list|,
name|dataLen
...
block|}
block|}
DECL|method|positionedReadCheckWithByteBuffer (InputStream in, int pos)
specifier|private
name|void
name|positionedReadCheckWithByteBuffer
parameter_list|(
...
block|{     }
block|}
comment|/** Test byte byffer read fully. */
annotation|@
name|Test
argument_list|(
name|timeout
...
block|}
block|}
DECL|method|byteBufferReadFullyCheck (InputStream in, int pos)
specifier|private
name|void
name|byteBufferReadFullyCheck
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|byteBufferPreadCheck (InputStream in, ByteBuffer buf, int bufPos)
specifier|private
name|void
name|byteBufferPreadCheck
parameter_list|(
...
name|Exception
block|{
comment|// Test reading from position 0
name|buf
operator|.
name|position
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Test reading from half way through the data
name|buf
operator|.
name|position
argument_list|(
...
expr_stmt|;
block|}
comment|/** Test byte buffer pread with different buffer size. */
annotation|@
name|Test
argument_list|(
name|timeout
...
argument_list|)
expr_stmt|;
comment|// Test with direct ByteBuffer
name|buf
operator|=
name|ByteBuffer
operator|.
...
init|)
block|{
comment|// Test unbuffer after buffered read
name|readCheck
argument_list|(
name|in
argument_list|)
...
condition|)
block|{
comment|// Test buffered read again after unbuffer
comment|// Must seek to the beginning first
operator|(
operator|(
name|Seekable
operator|)
...
expr_stmt|;
block|}
comment|// Test close after unbuffer
operator|(
operator|(
name|CanUnbuffer
operator|)
...
argument_list|()
expr_stmt|;
comment|// The close will be called when exiting this try-with-resource block
block|}
comment|// Test pread
try|try
init|(
...
name|in
decl_stmt|;
comment|// Test unbuffer after pread
name|preadCheck
argument_list|(
name|pin
argument_list|)
...
argument_list|()
expr_stmt|;
comment|// Test pread again after unbuffer
name|preadCheck
argument_list|(
name|pin
argument_list|)
