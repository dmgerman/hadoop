...
comment|// to rename across mount points where the mount link targets are different
...
name|class
argument_list|)
DECL|method|testInternalSatisfyStoragePolicy ()
specifier|public
name|void
name|testInternalSatisfyStoragePolicy
parameter_list|()
throws|throws
name|IOException
block|{
...
name|fail
argument_list|(
literal|"ViewFileSystem getUsed() should fail for slash root path when the"
operator|+
literal|" slash root mount point is not configured."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
decl_stmt|;
name|long
name|usedSpaceByPathViaTargetFs
init|=
name|fsTarget
operator|.
name|getUsed
...
name|assertEquals
argument_list|(
literal|"Space used not matching between ViewFileSystem and "
operator|+
literal|"the mounted FileSystem!"
argument_list|,
name|usedSpaceByPathViaTargetFs
argument_list|,
name|usedSpaceByPathViaViewFs
...
name|assertEquals
argument_list|(
literal|"Resolved link target path not matching!"
argument_list|,
name|expectedMountLinkTarget
argument_list|,
name|actualMountLinkTarget
argument_list|)
expr_stmt|;
comment|// Relative symbolic link
specifier|final
name|String
...
specifier|final
name|Path
name|mountTargetRelativeSymLinkPath
init|=
operator|new
name|Path
argument_list|(
...
specifier|final
name|Path
name|expectedMountRelLinkTarget
init|=
name|fsTarget
operator|.
name|makeQualified
...
name|assertEquals
argument_list|(
literal|"Resolved relative link target path not matching!"
argument_list|,
name|expectedMountRelLinkTarget
argument_list|,
name|actualMountRelLinkTarget
...
name|fail
argument_list|(
literal|"Resolving link target for a ViewFs mount link should fail!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"Resolving link target for a non sym link should fail!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|Path
argument_list|(
literal|"/targetRoot/non-existing-file"
argument_list|)
argument_list|)
expr_stmt|;
name|fail
argument_list|(
literal|"Resolving link target for a non existing link should fail!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
annotation|@
name|Test
DECL|method|testViewFileSystemInnerCache ()
specifier|public
name|void
name|testViewFileSystemInnerCache
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// InnerCache caches filesystem.
name|assertSame
argument_list|(
name|fs
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// InnerCache and FileSystem.CACHE are independent.
name|assertNotSame
argument_list|(
name|fs
argument_list|,
...
condition|)
block|{
comment|// Ignore LocalFileSystem because it can still be used after close.
name|fail
argument_list|(
literal|"Expect Filesystem closed exception"
argument_list|)
expr_stmt|;
block|}
block|}
...
annotation|@
name|Test
DECL|method|testCloseChildrenFileSystem ()
specifier|public
name|void
name|testCloseChildrenFileSystem
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"viewfs should have at least one child fs."
argument_list|,
name|viewFs
operator|.
name|getChildFileSystems
...
argument_list|)
expr_stmt|;
comment|// viewFs is cached in FileSystem.CACHE
name|assertSame
argument_list|(
name|viewFs
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// child fs is not cached in FileSystem.CACHE
name|FileSystem
name|child
init|=
name|viewFs
...
annotation|@
name|Test
DECL|method|testChildrenFileSystemLeak ()
specifier|public
name|void
name|testChildrenFileSystemLeak
parameter_list|()
throws|throws
name|Exception
block|{
