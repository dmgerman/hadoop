...
begin_comment
comment|/**  * Performance tests to compare performance of Crc32 implementations  * This can be run from the command line with:  *  *   java -cp path/to/test/classes:path/to/common/classes \  *      'org.apache.hadoop.util.Crc32PerformanceTest'  *  *      or  *  *  hadoop org.apache.hadoop.util.Crc32PerformanceTest  *  * The output is in JIRA table format.  */
end_comment
...
return|;
block|}
DECL|method|computeCrc (ByteBuffer dataBufs, int bytePerCrc)
specifier|private
name|ByteBuffer
name|computeCrc
parameter_list|(
...
return|;
block|}
DECL|method|doBench (final List<Class<? extends Crc32>> crcs)
specifier|private
name|void
name|doBench
parameter_list|(
...
block|}
block|}
DECL|method|doBench (final List<Class<? extends Crc32>> crcs, final ByteBuffer[] dataBufs, final int bytePerCrc, final PrintStream out)
specifier|private
name|void
name|doBench
parameter_list|(
