...
begin_class
DECL|class|TestScriptBasedMappingWithDependency
specifier|public
class|class
name|TestScriptBasedMappingWithDependency
block|{
DECL|method|TestScriptBasedMappingWithDependency ()
specifier|public
name|TestScriptBasedMappingWithDependency
parameter_list|()
block|{    }
...
name|assertNull
argument_list|(
literal|"Expected an empty list for resolve"
argument_list|,
name|result
argument_list|)
expr_stmt|;
...
name|assertNull
argument_list|(
literal|"Expected an empty list for getDependency"
argument_list|,
name|result
argument_list|)
expr_stmt|;
