...
block|}
block|}
DECL|method|testInvalidSubstitutation ()
specifier|public
name|void
name|testInvalidSubstitutation
parameter_list|()
block|{
specifier|final
name|Configuration
...
argument_list|)
expr_stmt|;
comment|// 3-variable loop with non-empty value prefix/suffix
comment|//
specifier|final
name|String
name|expVal2
init|=
literal|"foo2${test.var2}bar2"
decl_stmt|;
name|configuration
operator|.
name|set
