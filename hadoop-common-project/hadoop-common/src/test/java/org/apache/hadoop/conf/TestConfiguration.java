...
expr_stmt|;
block|}
comment|// When a resource is parsed as an input stream the first time, included
comment|// properties are saved within the config. However, the included properties
comment|// are not cached in the resource object. So, if an additional resource is
comment|// added after the config is parsed the first time, the config loses the
comment|// prperties that were included from the first resource.
annotation|@
name|Test
DECL|method|testIncludesFromInputStreamWhenResourceAdded ()
specifier|public
name|void
name|testIncludesFromInputStreamWhenResourceAdded
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// CONFIG includes CONFIG2. CONFIG2 includes CONFIG_FOR_ENUM
name|out
operator|=
operator|new
name|BufferedWriter
...
argument_list|()
expr_stmt|;
comment|// Add CONFIG as an InputStream resource.
name|File
name|file
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// The first time the conf is parsed, verify that all properties were read
comment|// from all levels of includes.
name|assertEquals
argument_list|(
literal|"1"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Add another resource to the conf.
name|out
operator|=
operator|new
name|BufferedWriter
...
argument_list|)
expr_stmt|;
comment|// Verify that all properties were read from all levels of includes the
comment|// second time the conf is parsed.
name|assertEquals
argument_list|(
literal|"1"
argument_list|,
...
annotation|@
name|Test
DECL|method|testOrderOfDuplicatePropertiesWithInclude ()
specifier|public
name|void
name|testOrderOfDuplicatePropertiesWithInclude
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Property "a" is set to different values inside and outside of includes.
name|out
operator|=
operator|new
name|BufferedWriter
...
argument_list|)
expr_stmt|;
comment|// This call returns the value specified in the Key as a double in MBs.
name|assertThat
argument_list|(
name|conf
operator|.
...
argument_list|)
expr_stmt|;
comment|// Since this key is missing, This call converts the default value of  1GB
comment|// to MBs are returns that value.
name|assertThat
argument_list|(
name|conf
operator|.
...
argument_list|)
expr_stmt|;
comment|// We try out different kind of String formats to see if they work and
comment|// during read, we also try to read using a different Storage Units.
name|conf
operator|.
name|setStrings
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Match the parsing patterns of getLongBytes, which takes single char
comment|// suffix.
name|conf
operator|.
name|setStrings
...
argument_list|)
expr_stmt|;
comment|// Missing format specification, this should throw.
name|conf
operator|.
name|setStrings
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// illegal format specification, this should throw.
name|conf
operator|.
name|setStrings
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Illegal number  specification, this should throw.
name|conf
operator|.
name|setStrings
argument_list|(
...
annotation|@
name|Test
DECL|method|testGettingPropertiesWithPrefix ()
specifier|public
name|void
name|testGettingPropertiesWithPrefix
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// Repeat test with variable substitution
name|conf
operator|.
name|set
argument_list|(
...
expr_stmt|;
block|}
comment|// test call with no properties for a given prefix
name|prefixedProps
operator|=
name|conf
operator|.
