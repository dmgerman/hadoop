...
expr_stmt|;
block|}
comment|// Verify that the proxy created to try to make it go to standby
comment|// gracefully used the right rpc timeout
name|Mockito
operator|.
name|verify
argument_list|(
...
annotation|@
name|Test
DECL|method|testSelfFailoverFails ()
specifier|public
name|void
name|testSelfFailoverFails
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Can't failover to yourself"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
DECL|method|doFailover (HAServiceTarget tgt1, HAServiceTarget tgt2, boolean forceFence, boolean forceActive)
specifier|private
name|void
name|doFailover
parameter_list|(
