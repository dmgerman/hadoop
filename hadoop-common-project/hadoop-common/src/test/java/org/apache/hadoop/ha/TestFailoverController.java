...
annotation|@
name|Test
DECL|method|testFailoverToUnhealthyServiceFails ()
specifier|public
name|void
name|testFailoverToUnhealthyServiceFails
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// svc1 still thinks they're active, that's OK, we'll fence them
name|assertEquals
argument_list|(
name|HAServiceState
operator|.
...
annotation|@
name|Test
DECL|method|testFailoverFromNonExistantServiceSucceeds ()
specifier|public
name|void
name|testFailoverFromNonExistantServiceSucceeds
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// Don't check svc1 (we can't reach it, but that's OK, we'll fence)
name|assertEquals
argument_list|(
name|HAServiceState
operator|.
