...
argument_list|)
expr_stmt|;
comment|// assert empty ls on the empty dir
name|assertEquals
argument_list|(
literal|"ls on an empty directory not of length 0"
argument_list|,
literal|0
argument_list|,
name|fs
...
argument_list|)
expr_stmt|;
comment|// assert non-empty ls on parent dir
name|assertTrue
argument_list|(
literal|"ls on a non-empty directory of length 0"
argument_list|,
name|fs
operator|.
name|listStatus
