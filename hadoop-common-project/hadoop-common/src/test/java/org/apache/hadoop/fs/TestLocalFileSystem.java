...
argument_list|()
decl_stmt|;
comment|/**    * Get the statistics for the file schema. Contains assertions    * @return the statistics on all file:// IO.    */
DECL|method|getFileStatistics ()
specifier|protected
name|Statistics
...
name|assertEquals
argument_list|(
literal|"Number of statistics counters for file://"
argument_list|,
literal|1
argument_list|,
name|fileStats
...
argument_list|)
expr_stmt|;
comment|// this should be used for local and rawLocal, as they share the
comment|// same schema (although their class is different)
return|return
name|fileStats
operator|.
name|get
...
return|;
block|}
comment|/**    * Write the byte array {@link #DATA} to the given output stream.    * @param s stream to write to.    * @throws IOException failure to write/close the file    */
DECL|method|writeData (FSDataOutputStream s)
specifier|private
name|void
name|writeData
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Evaluate the closure while counting bytes written during    * its execution, and verify that the count included the CRC    * write as well as the data.    * After the operation, the file is deleted.    * @param operation operation for assertion method.    * @param path path to write    * @param callable expression evaluated    * @param delete should the file be deleted after?    */
DECL|method|assertWritesCRC (String operation, Path path, LambdaTestUtils.VoidCallable callable, boolean delete)
specifier|private
name|void
name|assertWritesCRC
parameter_list|(
name|String
name|operation
parameter_list|,
...
parameter_list|)
block|{
comment|// ignore this cleanup failure
block|}
block|}
block|}
block|}
comment|/**    * Verify that File IO through the classic non-builder APIs generate    * statistics which imply that CRCs were read and written.    */
annotation|@
name|Test
DECL|method|testCRCwithClassicAPIs ()
specifier|public
name|void
name|testCRCwithClassicAPIs
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|TEST_ROOT_DIR
argument_list|,
literal|"testByteCountersClassicAPIs"
argument_list|)
decl_stmt|;
name|assertWritesCRC
argument_list|(
...
name|assertEquals
argument_list|(
literal|"Bytes read in open() call with stats "
operator|+
name|stats
argument_list|,
name|CRC_SIZE
...
expr_stmt|;
block|}
comment|/**    * create/7 to use write the CRC.    */
annotation|@
name|Test
DECL|method|testCRCwithCreate7 ()
specifier|public
name|void
name|testCRCwithCreate7
parameter_list|()
throws|throws
name|Throwable
block|{
...
expr_stmt|;
block|}
comment|/**    * Create with ChecksumOpt to create checksums.    * If the LocalFS ever interpreted the flag, this test may fail.    */
annotation|@
name|Test
DECL|method|testCRCwithCreateChecksumOpt ()
specifier|public
name|void
name|testCRCwithCreateChecksumOpt
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|TEST_ROOT_DIR
argument_list|,
literal|"testCRCwithCreateChecksumOpt"
argument_list|)
decl_stmt|;
name|assertWritesCRC
argument_list|(
literal|"create with checksum opt"
argument_list|,
name|file
argument_list|,
parameter_list|()
...
expr_stmt|;
block|}
comment|/**    * Create createNonRecursive/6.    */
annotation|@
name|Test
DECL|method|testCRCwithCreateNonRecursive6 ()
specifier|public
name|void
name|testCRCwithCreateNonRecursive6
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|TEST_ROOT_DIR
argument_list|,
literal|"testCRCwithCreateNonRecursive6"
argument_list|)
decl_stmt|;
name|assertWritesCRC
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Create createNonRecursive with CreateFlags.    */
annotation|@
name|Test
DECL|method|testCRCwithCreateNonRecursiveCreateFlags ()
specifier|public
name|void
name|testCRCwithCreateNonRecursiveCreateFlags
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|TEST_ROOT_DIR
argument_list|,
literal|"testCRCwithCreateNonRecursiveCreateFlags"
argument_list|)
decl_stmt|;
name|assertWritesCRC
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * This relates to MAPREDUCE-7184, where the openFile() call's    * CRC count wasn't making into the statistics for the current thread.    * If the evaluation was in a separate thread you'd expect that,    * but if the completable future is in fact being synchronously completed    * it should not happen.    */
annotation|@
name|Test
DECL|method|testReadIncludesCRCwithBuilders ()
specifier|public
name|void
name|testReadIncludesCRCwithBuilders
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|TEST_ROOT_DIR
argument_list|,
literal|"testReadIncludesCRCwithBuilders"
argument_list|)
decl_stmt|;
name|Statistics
name|stats
...
argument_list|()
decl_stmt|;
comment|// write the file using the builder API
name|assertWritesCRC
argument_list|(
literal|"createFile()"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// now read back the data, again with the builder API
specifier|final
name|long
name|bytesRead0
init|=
...
name|assertEquals
argument_list|(
literal|"Bytes read in openFile() call with stats "
operator|+
name|stats
argument_list|,
name|CRC_SIZE
...
argument_list|)
expr_stmt|;
comment|// now write with overwrite = true
name|assertWritesCRC
argument_list|(
literal|"createFileNonRecursive()"
argument_list|,
name|file
argument_list|,
parameter_list|()
...
expr_stmt|;
block|}
comment|/**    * Write with the builder, using the normal recursive create    * with create flags containing the overwrite option.    */
annotation|@
name|Test
DECL|method|testWriteWithBuildersRecursive ()
specifier|public
name|void
name|testWriteWithBuildersRecursive
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|TEST_ROOT_DIR
argument_list|,
literal|"testWriteWithBuildersRecursive"
argument_list|)
decl_stmt|;
name|Statistics
name|stats
