...
annotation|@
name|Test
DECL|method|testConfGetPasswordUsingAlias ()
specifier|public
name|void
name|testConfGetPasswordUsingAlias
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Empty for an invalid alias
name|Assert
operator|.
name|assertEquals
argument_list|(
