...
begin_class
DECL|class|TestAuthenticationSessionCookie
specifier|public
class|class
name|TestAuthenticationSessionCookie
block|{
DECL|field|BASEDIR
specifier|private
specifier|static
...
block|}
block|}
DECL|class|Dummy2AuthenticationFilter
specifier|public
specifier|static
class|class
name|Dummy2AuthenticationFilter
extends|extends
name|DummyAuthenticationFilter
block|{
annotation|@
...
block|{     }
block|}
DECL|class|Dummy2FilterInitializer
specifier|public
specifier|static
class|class
name|Dummy2FilterInitializer
extends|extends
name|FilterInitializer
block|{
annotation|@
...
block|}
block|}
DECL|method|startServer (boolean isTestSessionCookie)
specifier|public
name|void
name|startServer
parameter_list|(
name|boolean
name|isTestSessionCookie
parameter_list|)
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testPersistentCookie ()
specifier|public
name|void
name|testPersistentCookie
parameter_list|()
throws|throws
name|IOException
block|{
