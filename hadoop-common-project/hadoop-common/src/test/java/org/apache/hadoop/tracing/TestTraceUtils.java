...
expr_stmt|;
block|}
comment|/**    * Test tracing the globber.  This is a regression test for HDFS-9187.    */
annotation|@
name|Test
DECL|method|testTracingGlobber ()
specifier|public
name|void
name|testTracingGlobber
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Bypass the normal FileSystem object creation path by just creating an
comment|// instance of a subclass.
name|FileSystem
name|fs
init|=
operator|new
