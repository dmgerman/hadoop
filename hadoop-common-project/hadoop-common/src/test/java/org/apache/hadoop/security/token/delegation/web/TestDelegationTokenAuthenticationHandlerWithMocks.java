...
argument_list|)
expr_stmt|;
comment|// Management operations against token requested with service parameter
name|Token
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testGetToken (String renewer, String service, Text expectedTokenKind)
specifier|private
name|Token
argument_list|<
name|DelegationTokenIdentifier
...
literal|"unchecked"
argument_list|)
DECL|method|testCancelToken (Token<DelegationTokenIdentifier> token)
specifier|private
name|void
name|testCancelToken
parameter_list|(
...
literal|"unchecked"
argument_list|)
DECL|method|testRenewToken (String testRenewer)
specifier|private
name|void
name|testRenewToken
parameter_list|(
...
literal|"unchecked"
argument_list|)
DECL|method|testRenewToken (Token<DelegationTokenIdentifier> dToken, String testRenewer)
specifier|private
name|void
name|testRenewToken
parameter_list|(
