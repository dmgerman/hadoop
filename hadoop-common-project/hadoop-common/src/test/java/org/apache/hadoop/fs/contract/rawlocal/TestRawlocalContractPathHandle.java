...
begin_class
DECL|class|TestRawlocalContractPathHandle
specifier|public
class|class
name|TestRawlocalContractPathHandle
extends|extends
name|AbstractContractPathHandleTest
block|{
DECL|method|TestRawlocalContractPathHandle (String testname, Options.HandleOpt[] opts, boolean serialized)
specifier|public
name|TestRawlocalContractPathHandle
parameter_list|(
name|String
