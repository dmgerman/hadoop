...
expr_stmt|;
block|}
comment|//here principals use \ instead of /
comment|//because org.apache.directory.server.kerberos.shared.keytab.KeytabDecoder
comment|// .getPrincipalName(IoBuffer buffer) use \\ when generates principal
name|Assert
operator|.
name|assertEquals
argument_list|(
