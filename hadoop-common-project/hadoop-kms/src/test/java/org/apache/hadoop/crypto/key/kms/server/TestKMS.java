...
argument_list|)
expr_stmt|;
comment|/**          * due to the cache on the server side, client may get old keys.          * @see EagerKeyGeneratorKeyProviderCryptoExtension#rollNewVersion(String)          */
name|boolean
name|rollSucceeded
init|=
literal|false
...
name|fail
argument_list|(
literal|"User [GENERATE_EEK] should be allowed to generate_eek on k1"
argument_list|)
expr_stmt|;
block|}
block|}
...
annotation|@
name|Test
DECL|method|testDelegationTokensOpsSimple ()
specifier|public
name|void
name|testDelegationTokensOpsSimple
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testDelegationTokensOpsKerberized ()
specifier|public
name|void
name|testDelegationTokensOpsKerberized
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testDelegationTokensOps (Configuration conf, final Authenticator mockAuthenticator)
specifier|private
name|void
name|testDelegationTokensOps
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// After this point, we're supposed to use the delegation token to auth.
name|doThrow
argument_list|(
operator|new
name|IOException
argument_list|(
literal|"Authenticator should not fall back"
argument_list|)
argument_list|)
operator|.
name|when
...
argument_list|)
expr_stmt|;
comment|// test delegation token renewal
name|boolean
name|renewed
init|=
literal|false
...
name|info
argument_list|(
literal|"Expected exception when trying to renew token"
argument_list|,
name|e
argument_list|)
expr_stmt|;
