...
name|Exception
block|{
comment|// Make sure bogus errors don't get emitted.
name|GenericTestUtils
operator|.
name|LogCapturer
name|logs
...
name|getLogger
argument_list|(
literal|"com.sun.jersey.server.wadl.generators.AbstractWadlGeneratorGrammarGenerator"
argument_list|)
argument_list|)
decl_stmt|;
try|try
...
name|contains
argument_list|(
literal|"Couldn't find grammar element for class"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|testGetDelegationTokenByProxyUser ()
specifier|public
name|void
name|testGetDelegationTokenByProxyUser
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// current user client using token credentials for proxy user
name|UserGroupInformation
name|nonKerberosUgi
init|=
name|UserGroupInformation
