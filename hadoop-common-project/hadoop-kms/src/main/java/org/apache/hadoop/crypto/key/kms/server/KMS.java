...
DECL|enumConstant|REENCRYPT_EEK_BATCH
name|GENERATE_EEK
block|,
name|DECRYPT_EEK
block|,
...
argument_list|)
decl_stmt|;
DECL|field|MAX_NUM_PER_BATCH
specifier|private
specifier|static
specifier|final
name|int
name|MAX_NUM_PER_BATCH
init|=
literal|10000
decl_stmt|;
DECL|method|KMS ()
...
name|UTF_8
argument_list|)
DECL|method|reencryptEncryptedKeys ( @athParamR) final String name, final List<Map> jsonPayload)
specifier|public
name|Response
...
name|trace
argument_list|(
literal|"Entering reencryptEncryptedKeys method."
argument_list|)
expr_stmt|;
try|try
block|{
...
name|warn
argument_list|(
literal|"Payload size {} too big for reencryptEncryptedKeys from"
operator|+
literal|" user {}."
argument_list|,
name|jsonPayload
...
name|debug
argument_list|(
literal|"Batch reencrypting {} Encrypted Keys for key name {}"
argument_list|,
name|jsonPayload
operator|.
name|size
...
argument_list|()
argument_list|,
literal|"EncryptedKey size mismatch after parsing from json"
argument_list|)
expr_stmt|;
for|for
control|(
...
argument_list|)
argument_list|,
literal|"All EncryptedKeys must be under the given key name "
operator|+
name|name
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"reencryptEncryptedKeys {} keys for key {} took {}"
argument_list|,
name|jsonPayload
operator|.
name|size
...
name|trace
argument_list|(
literal|"Exiting reencryptEncryptedKeys method."
argument_list|)
expr_stmt|;
return|return
name|Response
...
name|debug
argument_list|(
literal|"Exception in reencryptEncryptedKeys."
argument_list|,
name|e
argument_list|)
expr_stmt|;
