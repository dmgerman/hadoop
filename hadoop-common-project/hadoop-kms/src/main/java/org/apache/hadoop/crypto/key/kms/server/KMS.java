...
name|APPLICATION_JSON
argument_list|)
DECL|method|generateEncryptedKeys ( @ontext SecurityContext securityContext, @PathParam(R) String name, @QueryParam(KMSRESTConstants.EEK_OP) String edekOp, @DefaultValue(R) @QueryParam(KMSRESTConstants.EEK_NUM_KEYS) int numKeys)
specifier|public
name|Response
...
name|APPLICATION_JSON
argument_list|)
DECL|method|decryptEncryptedKey (@ontext SecurityContext securityContext, @PathParam(R) String versionName, @QueryParam(KMSRESTConstants.EEK_OP) String eekOp, Map jsonPayload)
specifier|public
name|Response
