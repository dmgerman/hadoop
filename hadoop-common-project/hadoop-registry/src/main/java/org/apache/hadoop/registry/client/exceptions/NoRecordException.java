...
block|{
DECL|method|NoRecordException (String path, String error)
specifier|public
name|NoRecordException
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|NoRecordException (String path, String error, Throwable cause)
specifier|public
name|NoRecordException
parameter_list|(
name|String
