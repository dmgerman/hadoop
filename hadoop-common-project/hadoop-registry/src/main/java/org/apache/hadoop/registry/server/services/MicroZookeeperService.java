...
return|;
block|}
comment|/**    * Returns with a random open port can be used to set as server port for ZooKeeper.    * @return a random open port or 0 (in case of error)    */
DECL|method|getRandomAvailablePort ()
specifier|private
name|int
name|getRandomAvailablePort
parameter_list|()
...
name|warn
argument_list|(
literal|"ERROR during selecting random port for ZooKeeper server to bind."
argument_list|,
name|e
argument_list|)
expr_stmt|;
