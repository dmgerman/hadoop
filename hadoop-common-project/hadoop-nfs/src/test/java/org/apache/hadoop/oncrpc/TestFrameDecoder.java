...
literal|12345
decl_stmt|;
comment|// some random server port
DECL|field|result
specifier|private
specifier|static
name|XDR
...
name|RpcProgram
block|{
DECL|method|TestRpcProgram (String program, String host, int port, int progNumber, int lowProgVersion, int highProgVersion, int cacheSize)
specifier|protected
name|TestRpcProgram
parameter_list|(
name|String
...
parameter_list|)
block|{
comment|// Get the final complete request and return a void response.
name|result
operator|=
name|in
expr_stmt|;
