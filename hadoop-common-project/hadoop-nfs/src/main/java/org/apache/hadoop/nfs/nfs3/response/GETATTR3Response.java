...
begin_comment
comment|/**  * GETATTR3 Response  */
end_comment

begin_class
DECL|class|GETATTR3Response
specifier|public
class|class
...
name|postOpAttr
decl_stmt|;
DECL|method|GETATTR3Response (int status)
specifier|public
name|GETATTR3Response
parameter_list|(
name|int
...
expr_stmt|;
block|}
DECL|method|GETATTR3Response (int status, Nfs3FileAttributes attrs)
specifier|public
name|GETATTR3Response
parameter_list|(
name|int
