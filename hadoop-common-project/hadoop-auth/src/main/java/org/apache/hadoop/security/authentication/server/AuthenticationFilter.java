...
literal|"cookie.path"
decl_stmt|;
comment|/**    * Constant for the configuration property that indicates the name of the    * SignerSecretProvider class to use.  If not specified, SIGNATURE_SECRET    * will be used or a random secret.    */
DECL|field|SIGNER_SECRET_PROVIDER_CLASS
specifier|public
specifier|static
specifier|final
name|String
name|SIGNER_SECRET_PROVIDER_CLASS
init|=
literal|"signer.secret.provider"
decl_stmt|;
comment|/**    * Constant for the attribute that can be used for providing a custom    * object that subclasses the SignerSecretProvider.  Note that this should be    * set in the ServletContext and the class should already be initialized.      * If not specified, SIGNER_SECRET_PROVIDER_CLASS will be used.    */
DECL|field|SIGNATURE_PROVIDER_ATTRIBUTE
specifier|public
specifier|static
specifier|final
name|String
name|SIGNATURE_PROVIDER_ATTRIBUTE
init|=
...
name|authHandler
decl_stmt|;
DECL|field|randomSecret
specifier|private
name|boolean
name|randomSecret
decl_stmt|;
DECL|field|customSecretProvider
specifier|private
name|boolean
name|customSecretProvider
decl_stmt|;
DECL|field|validity
specifier|private
name|long
...
name|cookiePath
decl_stmt|;
comment|/**    * Initializes the authentication filter.    *<p/>    * It instantiates and initializes the specified {@link AuthenticationHandler}.    *<p/>    *    * @param filterConfig filter configuration.    *    * @throws ServletException thrown if the filter or the authentication handler could not be initialized properly.    */
annotation|@
name|Override
...
block|{
name|String
name|signerSecretProviderClassName
init|=
name|config
operator|.
name|getProperty
