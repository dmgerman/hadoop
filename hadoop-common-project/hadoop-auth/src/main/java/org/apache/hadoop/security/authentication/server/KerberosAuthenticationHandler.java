...
condition|)
block|{
comment|// IBM JDK needs non-null credentials to be passed to createContext here, with
comment|// SPNEGO mechanism specified, otherwise JGSS will use its default mechanism
comment|// only, which is Kerberos V5.
name|gssCreds
operator|=
name|gssManager
operator|.
