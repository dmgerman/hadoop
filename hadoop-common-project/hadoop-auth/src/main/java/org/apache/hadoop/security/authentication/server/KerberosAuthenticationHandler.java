...
decl_stmt|;
comment|/**    * Constant for the list of endpoints that skips Kerberos authentication.    */
annotation|@
name|VisibleForTesting
DECL|field|ENDPOINT_WHITELIST
specifier|static
specifier|final
name|String
name|ENDPOINT_WHITELIST
init|=
name|TYPE
operator|+
literal|".endpoint.whitelist"
decl_stmt|;
DECL|field|ENDPOINT_PATTERN
specifier|private
specifier|static
specifier|final
name|Pattern
...
name|ServletException
argument_list|(
literal|"The element of the whitelist: "
operator|+
name|s
operator|+
literal|" must start with '/'"
operator|+
literal|" and must not contain special characters afterwards"
argument_list|)
throw|;
block|}
block|}
...
name|AuthenticationException
block|{
comment|// If the request servlet path is in the whitelist,
comment|// skip Kerberos authentication and return anonymous token.
specifier|final
name|String
name|path
init|=
