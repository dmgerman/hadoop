...
begin_comment
comment|/**  * This unit test verifies the functionality of LDAP authentication handler.  */
end_comment
...
block|}
argument_list|)
DECL|class|TestLdapAuthenticationHandler
specifier|public
class|class
name|TestLdapAuthenticationHandler
extends|extends
name|AbstractLdapTestUnit
block|{
DECL|field|handler
...
literal|60000
argument_list|)
DECL|method|testRequestWithWrongCredentials ()
specifier|public
name|void
name|testRequestWithWrongCredentials
parameter_list|()
throws|throws
name|Exception
block|{
