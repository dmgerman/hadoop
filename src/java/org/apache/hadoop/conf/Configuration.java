...
argument_list|()
decl_stmt|;
comment|/**    * Flag to indicate if the storage of resource which updates a key needs     * to be stored for each key    */
DECL|field|storeResource
specifier|private
name|boolean
name|storeResource
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**    * A new configuration with the same settings and additional facility for    * storage of resource to each key which loads or updates     * the key most recently    * @param other the configuration from which to clone settings    * @param storeResource flag to indicate if the storage of resource to     * each key is to be stored    */
DECL|method|Configuration (Configuration other, boolean storeResource)
specifier|private
name|Configuration
parameter_list|(
name|Configuration
...
throw|;
block|}
comment|/**    * Get the value of the<code>name</code> property,<code>null</code> if    * no such property exists.    *     * Values are processed for<a href="#VariableExpansion">variable expansion</a>     * before being returned.     *     * @param name the property name.    * @return the value of the<code>name</code> property,     *         or null if no such property exists.    */
...
return|;
block|}
comment|/**    * Get the value of the<code>name</code> property, without doing    *<a href="#VariableExpansion">variable expansion</a>.    *     * @param name the property name.    * @return the value of the<code>name</code> property,     *         or null if no such property exists.    */
...
return|;
block|}
comment|/**     * Set the<code>value</code> of the<code>name</code> property.    *     * @param name property name.    * @param value property value.    */
...
return|;
block|}
comment|/**     * Get the value of the<code>name</code> property. If no such property     * exists, then<code>defaultValue</code> is returned.    *     * @param name property name.    * @param defaultValue default value.    * @return property value, or<code>defaultValue</code> if the property     *         doesn't exist.                        */
...
block|}
block|}
comment|/**     * Write out the non-default properties in this configuration to the give    * {@link OutputStream}.    *     * @param out the output stream to write to.    */
...
DECL|method|dumpConfiguration (Configuration conf, Writer out)
specifier|public
specifier|static
name|void
