...
expr_stmt|;
block|}
DECL|method|DeprecatedKeyInfo (String[] newKeys)
name|DeprecatedKeyInfo
parameter_list|(
name|String
index|[]
...
expr_stmt|;
block|}
comment|/**    * Instantiates a map view over a subset of the entries in    * the Configuration. This is instantiated by getMap(), which    * binds a prefix of the namespace to the ConfigItemMap. This    * mapping reflects changes to the underlying Configuration.    *    * This map does not support iteration.    */
DECL|class|ConfigItemMap
specifier|protected
class|class
name|ConfigItemMap
extends|extends
...
name|prefix
decl_stmt|;
DECL|method|ConfigItemMap (String prefix)
specifier|public
name|ConfigItemMap
parameter_list|(
name|String
...
annotation|@
name|Override
DECL|method|put (String key, String val)
specifier|public
name|String
name|put
parameter_list|(
...
block|}
block|}
DECL|method|lookup (String subKey)
specifier|private
name|String
name|lookup
parameter_list|(
...
parameter_list|)
block|{
comment|// Store all elements of the map proper.
for|for
control|(
name|Map
operator|.
...
block|}
block|}
comment|/**    * Sets the deprecated key's value to the associated mapped keys    * @param attr the deprecated key    * @param value the value corresponding to the deprecated key    * @param finalParameter flag to indicate if<code>attr</code> is    *        marked as final    */
DECL|method|setDeprecatedValue (String attr, String value, boolean finalParameter)
specifier|private
name|void
name|setDeprecatedValue
parameter_list|(
...
control|)
block|{
comment|// update replacing keys with deprecated key's value in all cases,
comment|// except when the replacing key is already set to final
comment|// and finalParameter is false
if|if
condition|(
name|finalParameters
operator|.
...
name|name
operator|+
literal|":a attempt to override final parameter: "
operator|+
name|attr
operator|+
literal|";  Ignoring."
