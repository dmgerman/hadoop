...
literal|null
expr_stmt|;
comment|// Authorize the connection
try|try
block|{
name|authorize
argument_list|(
...
DECL|method|Server (String bindAddress, int port, Class<? extends Writable> paramClass, int handlerCount, Configuration conf, String serverName)
specifier|protected
name|Server
parameter_list|(
name|String
...
DECL|method|setupResponse (ByteArrayOutputStream response, Call call, Status status, Writable rv, String errorClass, String error)
specifier|private
name|void
name|setupResponse
parameter_list|(
