...
block|{
DECL|method|Invoker (Protocol protocol, Transceiver transceiver)
specifier|public
name|Invoker
parameter_list|(
name|Protocol
...
return|;
block|}
comment|/** An Avro RPC Transceiver that provides a request passed through Hadoop RPC    * to the Avro RPC Responder for processing. */
DECL|class|ServerTransceiver
specifier|private
specifier|static
class|class
...
name|request
decl_stmt|;
DECL|method|ServerTransceiver (List<ByteBuffer> request)
specifier|public
name|ServerTransceiver
parameter_list|(
name|List
