...
decl_stmt|;
DECL|field|DEFAULT_PING_INTERVAL
specifier|final
specifier|static
name|int
...
name|index
decl_stmt|;
DECL|method|ParallelCall (Writable param, ParallelResults results, int index)
specifier|public
name|ParallelCall
parameter_list|(
name|Writable
...
name|count
decl_stmt|;
DECL|method|ParallelResults (int size)
specifier|public
name|ParallelResults
parameter_list|(
name|int
...
DECL|method|callComplete (ParallelCall call)
specifier|public
specifier|synchronized
name|void
name|callComplete
...
block|}
block|}
comment|/**     * @deprecated Use {@link #call(Writable[], InetSocketAddress[],     * Class, UserGroupInformation, Configuration)} instead     */
annotation|@
name|Deprecated
...
DECL|method|call (Writable[] params, InetSocketAddress[] addresses, Class<?> protocol, UserGroupInformation ticket, Configuration conf)
specifier|public
name|Writable
index|[]
name|call
...
DECL|method|getConnection (ConnectionId remoteId, Call call)
specifier|private
name|Connection
name|getConnection
parameter_list|(
...
return|;
block|}
DECL|method|getRemotePrincipal (Configuration conf, InetSocketAddress address, Class<?> protocol)
specifier|private
specifier|static
name|String
name|getRemotePrincipal
