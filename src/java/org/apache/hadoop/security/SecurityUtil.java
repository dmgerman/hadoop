...
expr_stmt|;
block|}
comment|/**    * Convert Kerberos principal name conf values to valid Kerberos principal    * names. It replaces $host in the conf values with hostname, which should be    * fully-qualified domain name. If hostname is null or "0.0.0.0", it uses    * dynamically looked-up fqdn of the current host instead.    *     * @param principalConfig    *          the Kerberos principal name conf value to convert    * @param hostname    *          the fully-qualified domain name used for substitution    * @return converted Kerberos principal name    * @throws IOException    */
...
name|IOException
argument_list|(
literal|"Kerberos service principal name isn't configured properly "
operator|+
