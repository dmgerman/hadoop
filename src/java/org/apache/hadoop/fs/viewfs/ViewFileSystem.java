...
condition|)
block|{
comment|// We deal with whether or not home dir should be /user (hdfs) or /Users (if run on local file system on mac
try|try
block|{
if|if
condition|(
...
parameter_list|)
block|{
comment|// ignore - - the default of /user is good enough
block|}
name|homeDir
operator|=
name|this
