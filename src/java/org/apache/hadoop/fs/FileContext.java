...
return|;
block|}
comment|/**    * Make the given file and all non-existent parents into    * directories. Has the semantics of Unix 'mkdir -p'.    * Existence of the directory hierarchy is not an error.    *     * @param dir - the dir to make    * @param permission - permissions is set permission&~umask    * @return true if the operation succeeds; false if dir already exists     * @throws IOException when operation fails (e.g. permissions) etc.    */
...
return|;
block|}
comment|/**   * Renames Path src to Path dst.    *     * @param src   * @param dst   * @throws IOException if a rename is attempted across URI filessystem or   * across volumes within a file system.   */
...
name|IOException
argument_list|(
literal|"bug in underlying filesystem"
argument_list|)
throw|;
block|}
