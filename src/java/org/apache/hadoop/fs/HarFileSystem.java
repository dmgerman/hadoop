...
name|IOException
block|{
comment|// just fake block locations
comment|// its fast and simpler
comment|// doing various block location manipulation
comment|// with part files adds a lot of overhead because
comment|// of the look ups of filestatus in index files
return|return
operator|new
name|BlockLocation
index|[]
...
DECL|method|fileStatusesInIndex (HarStatus parent, List<FileStatus> statuses, List<String> children, FileStatus archiveIndexStat)
specifier|private
name|void
