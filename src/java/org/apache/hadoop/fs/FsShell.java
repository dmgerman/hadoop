...
condition|)
block|{
comment|// TODO: it's backwards compat, but why is this throwing an exception?
comment|// it's not like the shell test cmd
throw|throw
operator|new
name|PathNotFoundException
argument_list|(
...
operator|+
literal|"[-dus<path>] [-mv<src><dst>] [-cp<src><dst>]\n\t"
operator|+
