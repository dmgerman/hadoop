...
block|}
block|}
comment|/**    * Get a listing of all files in that match the file pattern<i>srcf</i>.    * @param srcf a file pattern specifying source files    * @param recursive if need to list files in subdirs    * @throws IOException      * @see org.apache.hadoop.fs.FileSystem#globStatus(Path)    */
DECL|method|ls (String srcf, boolean recursive)
specifier|private
name|int
name|ls
parameter_list|(
...
return|;
block|}
comment|/* list all files under the directory<i>src</i>    * ideally we should provide "-l" option, that lists like "ls -l".    */
DECL|method|ls (FileStatus src, FileSystem srcFs, boolean recursive, boolean printHeader)
specifier|private
name|int
name|ls
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Show the size of all files that match the file pattern<i>src</i>    * @param src a file pattern specifying source files    * @throws IOException      * @see org.apache.hadoop.fs.FileSystem#globStatus(Path)    */
DECL|method|du (String src)
name|void
name|du
parameter_list|(
name|String
...
block|}
block|}
comment|/**    * Show the summary disk usage of each dir/file     * that matches the file pattern<i>src</i>    * @param src a file pattern specifying source files    * @throws IOException      * @see org.apache.hadoop.fs.FileSystem#globStatus(Path)    */
DECL|method|dus (String src)
name|void
name|dus
parameter_list|(
name|String
...
name|ls
init|=
literal|"-ls<path>: \tList the contents that match the specified file pattern. If\n"
operator|+
...
name|lsr
init|=
literal|"-lsr<path>: \tRecursively list the contents that match the specified\n"
operator|+
