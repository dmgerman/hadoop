...
condition|)
block|{
comment|//kill the whole process group
name|pid_pgrpid
operator|=
literal|"-"
operator|+
...
block|}
block|}
comment|/**    * Is the process with PID pid still alive?    * This method assumes that isAlive is called on a pid that was alive not    * too long ago, and hence assumes no chance of pid-wrapping-around.    */
