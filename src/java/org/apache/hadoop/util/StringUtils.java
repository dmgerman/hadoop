...
DECL|method|formatPercent (double done, int digits)
specifier|public
specifier|static
name|String
name|formatPercent
...
DECL|method|getFormattedTimeWithDiff (DateFormat dateFormat, long finishTime, long startTime)
specifier|public
specifier|static
name|String
...
name|symbol
decl_stmt|;
DECL|method|TraditionalBinaryPrefix (long value)
name|TraditionalBinaryPrefix
parameter_list|(
name|long
name|value
...
DECL|method|join (CharSequence separator, Iterable<String> strings)
specifier|public
specifier|static
name|String
name|join
