...
argument_list|()
expr_stmt|;
comment|// Workaround for HADOOP-6386
name|port
operator|=
name|listener
operator|.
...
name|i
operator|+
literal|"attempts to restart webserver"
argument_list|)
expr_stmt|;
name|port
operator|=
...
throw|;
block|}
comment|// End of HADOOP-6386 workaround
break|break;
block|}
catch|catch
parameter_list|(
...
operator|+
literal|"Only superusers/supergroup \""
operator|+
name|adminsAclString
operator|+
