...
DECL|method|needsQuoting (String str)
specifier|public
specifier|static
name|boolean
name|needsQuoting
...
DECL|method|quoteHtmlChars (OutputStream output, byte[] buffer, int off, int len)
specifier|public
specifier|static
name|void
name|quoteHtmlChars
...
DECL|method|quoteHtmlChars (String item)
specifier|public
specifier|static
name|String
name|quoteHtmlChars
...
DECL|method|quoteOutputStream (final OutputStream out )
specifier|public
specifier|static
name|OutputStream
...
DECL|method|unquoteHtmlChars (String item)
specifier|public
specifier|static
name|String
