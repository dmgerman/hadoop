...
block|}
block|}
DECL|class|CompressionTypeOption
specifier|private
specifier|static
class|class
name|CompressionTypeOption
...
name|value
decl_stmt|;
DECL|method|CompressionTypeOption (CompressionType value)
name|CompressionTypeOption
parameter_list|(
name|CompressionType
name|value
...
block|}
block|}
DECL|class|CompressionCodecOption
specifier|private
specifier|static
class|class
name|CompressionCodecOption
implements|implements
name|Option
block|{
DECL|field|value
...
name|value
decl_stmt|;
DECL|method|CompressionCodecOption (CompressionCodec value)
name|CompressionCodecOption
parameter_list|(
name|CompressionCodec
name|value
...
return|;
block|}
comment|/**      * Construct a uncompressed writer from a set of options.      * @param conf the configuration to use      * @param compressionType the compression type being used      * @param options the options used when creating the writer      * @throws IOException if it fails      */
DECL|method|Writer (Configuration conf, CompressionType compressionType, Option... opts)
name|Writer
parameter_list|(
name|Configuration
name|conf
...
name|Writer
block|{
DECL|method|RecordCompressWriter (Configuration conf, CompressionType compressionType, Option... options)
name|RecordCompressWriter
parameter_list|(
name|Configuration
name|conf
...
decl_stmt|;
DECL|method|BlockCompressWriter (Configuration conf, CompressionType compressionType, Option... options)
name|BlockCompressWriter
parameter_list|(
name|Configuration
name|conf
