...
specifier|static
name|Writer
DECL|method|createWriter (Configuration conf, FSDataOutputStream out, Class keyClass, Class valClass, boolean compress, boolean blockCompress, CompressionCodec codec, Metadata metadata)
name|createWriter
parameter_list|(
name|Configuration
name|conf
...
specifier|static
name|Writer
DECL|method|createWriter (FileSystem fs, Configuration conf, Path file, Class keyClass, Class valClass, boolean compress, boolean blockCompress, CompressionCodec codec, Progressable progress, Metadata metadata)
name|createWriter
parameter_list|(
name|FileSystem
name|fs
...
return|;
block|}
DECL|method|getMetadataAsStringMap ()
specifier|public
name|Map
argument_list|<
name|String
...
DECL|method|Writer (Configuration conf, FSDataOutputStream out, Class keyClass, Class valClass, Metadata metadata)
specifier|private
name|Writer
parameter_list|(
name|Configuration
...
DECL|method|initializeFileHeader ()
name|void
name|initializeFileHeader
parameter_list|()
throws|throws
...
DECL|method|finalizeFileHeader ()
name|void
name|finalizeFileHeader
parameter_list|()
throws|throws
...
literal|"unchecked"
argument_list|)
DECL|method|init (Path name, Configuration conf, FSDataOutputStream out, Class keyClass, Class valClass, boolean compress, CompressionCodec codec, Metadata metadata)
name|void
name|init
parameter_list|(
name|Path
...
literal|"unchecked"
argument_list|)
DECL|method|getSerializer (SerializationFactory sf, Class c, Metadata metadata)
specifier|private
name|SerializerBase
name|getSerializer
parameter_list|(
...
block|{
comment|/** Create the named file. */
DECL|method|RecordCompressWriter (FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, CompressionCodec codec)
specifier|public
name|RecordCompressWriter
parameter_list|(
name|FileSystem
...
block|}
comment|/** Create the named file with write-progress reporter. */
DECL|method|RecordCompressWriter (FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, CompressionCodec codec, Progressable progress, Metadata metadata)
specifier|public
name|RecordCompressWriter
parameter_list|(
name|FileSystem
...
block|}
comment|/** Create the named file with write-progress reporter. */
DECL|method|RecordCompressWriter (FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, int bufferSize, short replication, long blockSize, CompressionCodec codec, Progressable progress, Metadata metadata)
specifier|public
name|RecordCompressWriter
parameter_list|(
name|FileSystem
...
block|}
comment|/** Create the named file with write-progress reporter. */
DECL|method|RecordCompressWriter (FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, CompressionCodec codec, Progressable progress)
specifier|public
name|RecordCompressWriter
parameter_list|(
name|FileSystem
...
block|}
comment|/** Write to an arbitrary stream using a specified buffer size. */
DECL|method|RecordCompressWriter (Configuration conf, FSDataOutputStream out, Class keyClass, Class valClass, CompressionCodec codec, Metadata metadata)
specifier|private
name|RecordCompressWriter
parameter_list|(
name|Configuration
...
decl_stmt|;
comment|/** Create the named file. */
DECL|method|BlockCompressWriter (FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, CompressionCodec codec)
specifier|public
name|BlockCompressWriter
parameter_list|(
name|FileSystem
...
block|}
comment|/** Create the named file with write-progress reporter. */
DECL|method|BlockCompressWriter (FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, CompressionCodec codec, Progressable progress, Metadata metadata)
specifier|public
name|BlockCompressWriter
parameter_list|(
name|FileSystem
...
block|}
comment|/** Create the named file with write-progress reporter. */
DECL|method|BlockCompressWriter (FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, int bufferSize, short replication, long blockSize, CompressionCodec codec, Progressable progress, Metadata metadata)
specifier|public
name|BlockCompressWriter
parameter_list|(
name|FileSystem
...
block|}
comment|/** Create the named file with write-progress reporter. */
DECL|method|BlockCompressWriter (FileSystem fs, Configuration conf, Path name, Class keyClass, Class valClass, CompressionCodec codec, Progressable progress)
specifier|public
name|BlockCompressWriter
parameter_list|(
name|FileSystem
...
block|}
comment|/** Write to an arbitrary stream using a specified buffer size. */
DECL|method|BlockCompressWriter (Configuration conf, FSDataOutputStream out, Class keyClass, Class valClass, CompressionCodec codec, Metadata metadata)
specifier|private
name|BlockCompressWriter
parameter_list|(
name|Configuration
...
block|}
comment|/** Initialize */
DECL|method|init (int compressionBlockSize)
name|void
name|init
parameter_list|(
name|int
...
literal|"unchecked"
argument_list|)
DECL|method|getDeserializer (SerializationFactory sf, Class c, Metadata metadata)
specifier|private
name|DeserializerBase
name|getDeserializer
parameter_list|(
...
return|;
block|}
DECL|method|flush (int count, int bytesProcessed, boolean isCompressed, boolean isBlockCompressed, CompressionCodec codec, boolean done)
specifier|private
name|void
name|flush
parameter_list|(
