...
block|}
block|}
DECL|method|open (FileSystem fs, String dirName, WritableComparator comparator, Configuration conf)
specifier|protected
specifier|synchronized
name|void
name|open
...
DECL|method|createDataFileReader (FileSystem fs, Path dataFile, Configuration conf)
specifier|protected
name|SequenceFile
operator|.
name|Reader
