...
expr_stmt|;
block|}
DECL|method|collectStats (OutputCollector<Text, Text> output, String name, long execTime, Object objSize)
name|void
name|collectStats
parameter_list|(
...
name|className
operator|+
literal|" -read | -write | -clean [-nrFiles N] [-fileSize MB] [-resFile resultFileName] [-bufferSize Bytes] "
decl_stmt|;
name|System
operator|.
name|out
