...
expr_stmt|;
block|}
comment|/**    * check for arguments and fail if the values are not specified    */
...
block|}
block|}
comment|/**    * Parse input arguments    *     * @params args Command line inputs    */
...
block|}
block|}
comment|/**   * Main method for running the NNBench benchmarks   *   * @throws IOException indicates a problem with test startup   */
...
expr_stmt|;
block|}
comment|/**      * Create and Write operation.      */
DECL|method|doCreateWriteOp (String name, OutputCollector<Text, Text> output, Reporter reporter)
specifier|private
name|void
name|doCreateWriteOp
parameter_list|(
...
name|info
argument_list|(
literal|"Exception recorded in op: "
operator|+
literal|"Create/Write/Close"
argument_list|)
expr_stmt|;
name|numOfExceptions
operator|++
...
block|}
block|}
comment|/**      * Open operation      */
DECL|method|doOpenReadOp (String name, OutputCollector<Text, Text> output, Reporter reporter)
specifier|private
name|void
name|doOpenReadOp
parameter_list|(
...
DECL|method|doRenameOp (String name, OutputCollector<Text, Text> output, Reporter reporter)
specifier|private
name|void
name|doRenameOp
parameter_list|(
...
DECL|method|doDeleteOp (String name, OutputCollector<Text, Text> output, Reporter reporter)
specifier|private
name|void
name|doDeleteOp
parameter_list|(
...
name|info
argument_list|(
literal|"Exception in recorded op: Delete"
argument_list|)
expr_stmt|;
name|numOfExceptions
operator|++
