...
argument_list|()
decl_stmt|;
comment|// manually create a map in the config; extract
comment|// its values as a map object.
name|conf
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Assert that we can extract individual entries in
comment|// the nested map ok.
name|assertEquals
argument_list|(
literal|"123"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Assert that we can get the whole map back out again.
name|out
operator|=
name|conf
operator|.
...
argument_list|)
expr_stmt|;
comment|// Test that substitution is handled by getMap().
name|conf
operator|.
name|set
argument_list|(
...
name|set
argument_list|(
literal|"mymap.someprop"
argument_list|,
literal|"AAA${subparam}BBB"
argument_list|)
expr_stmt|;
name|out
operator|=
...
argument_list|)
expr_stmt|;
comment|// Test deprecation of maps.
name|Configuration
operator|.
name|addDeprecation
argument_list|(
