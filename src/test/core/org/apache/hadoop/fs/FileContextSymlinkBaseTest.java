...
argument_list|)
expr_stmt|;
comment|// Create, write, read, append, rename, get block locations and
comment|// checksums, and delete a file using a path that contains a
comment|// symlink as an intermediate path component. Rename is covered
comment|// in more depth below.
name|createAndWriteFile
argument_list|(
name|fileViaLink
argument_list|)
