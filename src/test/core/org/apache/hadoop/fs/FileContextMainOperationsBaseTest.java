...
name|getTestRootPath
argument_list|(
literal|"test/hadoop/NonExistingPath"
argument_list|)
decl_stmt|;
name|Path
name|dst
...
name|assertTrue
argument_list|(
literal|"rename of non existing path should have Assert.failed"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|getTestRootPath
argument_list|(
literal|"test/existing/existingFile"
argument_list|)
decl_stmt|;
name|createFile
argument_list|(
...
name|getTestRootPath
argument_list|(
literal|"test/existing/existingDir"
argument_list|)
decl_stmt|;
name|fc
operator|.
...
name|getTestRootPath
argument_list|(
literal|"test/existing/existingDir/file"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
name|getTestRootPath
argument_list|(
literal|"test/nonExisting/newdir"
argument_list|)
decl_stmt|;
name|rename
argument_list|(
...
expr_stmt|;
block|}
DECL|method|rename (Path src, Path dst, boolean renameShouldSucceed, boolean srcExists, boolean dstExists)
specifier|private
name|void
name|rename
parameter_list|(
...
name|fail
argument_list|(
literal|"rename should have suceeded, but threw exception"
argument_list|)
expr_stmt|;
block|}
name|Assert
