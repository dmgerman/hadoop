...
block|}
block|}
comment|//should return 2 paths ("/test/hadoop/axa2" and "/test/hadoop/axx2")
name|FileStatus
index|[]
name|filteredPaths
init|=
...
annotation|@
name|Test
DECL|method|testListStatusFilterWithAnArrayOrPaths ()
specifier|public
name|void
name|testListStatusFilterWithAnArrayOrPaths
parameter_list|()
throws|throws
name|Exception
block|{
