...
argument_list|)
expr_stmt|;
comment|// Asking for a decompressor directly from GzipCodec should return null;
...
name|fail
argument_list|(
literal|"Got non-null codecDecompressor: "
operator|+
name|codecDecompressor
argument_list|)
expr_stmt|;
...
comment|// should return null as well.
name|Decompressor
...
name|fail
argument_list|(
literal|"Got non-null poolDecompressor: "
operator|+
name|poolDecompressor
argument_list|)
expr_stmt|;
block|}
comment|// If we then ensure that the pool is populated...
name|CodecPool
operator|.
name|returnDecompressor
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Asking the pool another time should still not bind this to GzipCodec.
name|poolDecompressor
operator|=
name|CodecPool
operator|.
...
name|fail
argument_list|(
literal|"Second time, got non-null poolDecompressor: "
operator|+
name|poolDecompressor
argument_list|)
expr_stmt|;
