...
begin_comment
comment|/**  * Indicates that the RPC server encountered an undeclared exception from the  * service   */
end_comment

begin_class
DECL|class|UnexpectedServerException
specifier|public
class|class
...
DECL|method|UnexpectedServerException (final String message)
name|UnexpectedServerException
parameter_list|(
specifier|final
name|String
...
DECL|method|UnexpectedServerException (final String message, final Throwable cause)
name|UnexpectedServerException
parameter_list|(
specifier|final
name|String
