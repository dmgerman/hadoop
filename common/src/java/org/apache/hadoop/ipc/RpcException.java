...
begin_comment
comment|/**  * Indicates an exception during the execution of remote procedure call.  */
end_comment
...
DECL|method|RpcException (final String message)
name|RpcException
parameter_list|(
specifier|final
name|String
...
DECL|method|RpcException (final String message, final Throwable cause)
name|RpcException
parameter_list|(
specifier|final
name|String
