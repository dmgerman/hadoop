...
DECL|field|DFS_CBLOCK_CACHE_KEEP_ALIVE
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"dfs.cblock.cache.keep.alive"
decl_stmt|;
DECL|field|DFS_CBLOCK_CACHE_KEEP_ALIVE_DEFAULT
specifier|public
specifier|static
specifier|final
name|String
...
literal|512
decl_stmt|;
DECL|field|DFS_CBLOCK_BLOCK_BUFFER_FLUSH_INTERVAL
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"dfs.cblock.block.buffer.flush.interval"
decl_stmt|;
DECL|field|DFS_CBLOCK_BLOCK_BUFFER_FLUSH_INTERVAL_DEFAULT
specifier|public
specifier|static
specifier|final
name|String
...
DECL|field|DFS_CBLOCK_RPC_TIMEOUT
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"dfs.cblock.rpc.timeout"
decl_stmt|;
DECL|field|DFS_CBLOCK_RPC_TIMEOUT_DEFAULT
specifier|public
specifier|static
specifier|final
name|String
...
literal|"300s"
decl_stmt|;
DECL|field|DFS_CBLOCK_ISCSI_ADVERTISED_IP
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"dfs.cblock.iscsi.advertised.ip"
decl_stmt|;
DECL|field|DFS_CBLOCK_ISCSI_ADVERTISED_PORT
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"dfs.cblock.iscsi.advertised.port"
decl_stmt|;
DECL|field|DFS_CBLOCK_ISCSI_ADVERTISED_PORT_DEFAULT
specifier|public
specifier|static
specifier|final
name|int
...
specifier|final
name|String
DECL|field|DFS_CBLOCK_KUBERNETES_DYNAMIC_PROVISIONER_ENABLED
name|DFS_CBLOCK_KUBERNETES_DYNAMIC_PROVISIONER_ENABLED
init|=
literal|"dfs.cblock.kubernetes.dynamic-provisioner.enabled"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|boolean
DECL|field|DFS_CBLOCK_KUBERNETES_DYNAMIC_PROVISIONER_ENABLED_DEFAULT
name|DFS_CBLOCK_KUBERNETES_DYNAMIC_PROVISIONER_ENABLED_DEFAULT
init|=
literal|false
decl_stmt|;
specifier|public
...
specifier|final
name|String
DECL|field|DFS_CBLOCK_KUBERNETES_CBLOCK_USER
name|DFS_CBLOCK_KUBERNETES_CBLOCK_USER
init|=
literal|"dfs.cblock.kubernetes.cblock-user"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
DECL|field|DFS_CBLOCK_KUBERNETES_CBLOCK_USER_DEFAULT
name|DFS_CBLOCK_KUBERNETES_CBLOCK_USER_DEFAULT
init|=
literal|"iqn.2001-04.org.apache.hadoop"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
DECL|field|DFS_CBLOCK_KUBERNETES_CONFIG_FILE_KEY
name|DFS_CBLOCK_KUBERNETES_CONFIG_FILE_KEY
init|=
literal|"dfs.cblock.kubernetes.configfile"
decl_stmt|;
