...
argument_list|()
decl_stmt|;
comment|// if the starting block id was specified, iterate over keys until
comment|// we find the matching block. If we find a matching block, break
comment|// to leave the iterator on the next block after the specified block.
if|if
condition|(
name|startingBlockId
operator|!=
