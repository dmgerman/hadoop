...
decl_stmt|;
comment|//
comment|// Keeps a Collection for every named machine containing
comment|// blocks that have recently been invalidated and are thought to live
comment|// on the machine in question.
comment|// Mapping: StorageID -> ArrayList<Block>
comment|//
DECL|field|recentInvalidateSets
specifier|private
specifier|final
name|Map
argument_list|<
...
block|}
block|}
DECL|method|belongsToInvalidates (String storageID, Block block)
name|boolean
name|belongsToInvalidates
parameter_list|(
name|String
...
block|}
block|}
comment|/**    * dumps the contents of recentInvalidateSets    */
DECL|method|dumpRecentInvalidateSets (PrintWriter out)
specifier|private
name|void
name|dumpRecentInvalidateSets
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|// get an array of the keys
name|keyArray
operator|=
operator|new
name|ArrayList
...
argument_list|)
expr_stmt|;
comment|// randomly pick up<i>nodesToProcess</i> nodes
comment|// and put them at [0, nodesToProcess)
name|int
name|remainingNodes
init|=
name|numOfNodes
...
name|int
name|scheduledReplicationCount
init|=
literal|0
decl_stmt|;
for|for
