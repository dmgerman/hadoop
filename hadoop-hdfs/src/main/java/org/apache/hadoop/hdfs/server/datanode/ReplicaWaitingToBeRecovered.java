...
DECL|method|ReplicaWaitingToBeRecovered (long blockId, long len, long genStamp, FSVolume vol, File dir)
name|ReplicaWaitingToBeRecovered
parameter_list|(
name|long
name|blockId
...
DECL|method|ReplicaWaitingToBeRecovered (Block block, FSVolume vol, File dir)
name|ReplicaWaitingToBeRecovered
parameter_list|(
name|Block
name|block
