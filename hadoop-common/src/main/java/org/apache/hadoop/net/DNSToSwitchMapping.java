...
begin_comment
comment|/**  * An interface that should be implemented to allow pluggable   * DNS-name/IP-address to RackID resolvers.  *  */
end_comment
