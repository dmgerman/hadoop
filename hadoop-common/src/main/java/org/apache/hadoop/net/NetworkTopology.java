...
block|{
comment|//local node
comment|//swap the local node and the node at position 0
if|if
condition|(
name|i
operator|!=
...
block|}
block|}
comment|// swap the local rack node and the node at position tempIndex
if|if
condition|(
name|localRackNode
operator|!=
...
block|}
block|}
comment|// put a random node at position 0 if it is not a local/local-rack node
if|if
condition|(
name|tempIndex
operator|==
