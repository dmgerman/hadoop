...
DECL|method|getTaskCompletionEvents (int startFrom, int numEvents)
specifier|public
name|TaskCompletionEvent
index|[]
name|getTaskCompletionEvents
...
block|}
block|}
comment|// Displaying the task logs
name|displayTaskLogs
argument_list|(
name|event
operator|.
...
block|}
block|}
DECL|method|downloadProfile (TaskCompletionEvent e)
specifier|private
name|void
name|downloadProfile
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|displayTaskLogs (TaskAttemptID taskId, String baseUrl)
specifier|private
name|void
name|displayTaskLogs
parameter_list|(
...
name|IOException
block|{
comment|// The tasktracker for a 'failed/killed' job might not be around...
if|if
condition|(
name|baseUrl
operator|!=
...
condition|)
block|{
comment|// Construct the url for the tasklogs
name|String
name|taskLogUrl
init|=
name|getTaskLogURL
...
argument_list|)
decl_stmt|;
comment|// Copy tasks's stdout of the JobClient
name|getTaskLogs
argument_list|(
name|taskId
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Copy task's stderr to stderr of the JobClient
name|getTaskLogs
argument_list|(
name|taskId
argument_list|,
...
block|}
block|}
DECL|method|getTaskLogs (TaskAttemptID taskId, URL taskLogUrl, OutputStream out)
specifier|private
name|void
name|getTaskLogs
parameter_list|(
...
name|warn
argument_list|(
literal|"Error reading task output "
operator|+
name|ioe
operator|.
name|getMessage
