...
DECL|field|MAX_SINGLE_SHUFFLE_SEGMENT_FRACTION
specifier|private
specifier|static
specifier|final
name|float
name|MAX_SINGLE_SHUFFLE_SEGMENT_FRACTION
init|=
literal|0.25f
decl_stmt|;
DECL|field|reduceId
...
return|;
block|}
DECL|method|waitForInMemoryMerge ()
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|closeInMemoryFile (MapOutput<K,V> mapOutput)
specifier|public
specifier|synchronized
name|void
...
block|}
block|}
DECL|method|closeInMemoryMergedFile (MapOutput<K,V> mapOutput)
specifier|public
specifier|synchronized
name|void
...
expr_stmt|;
block|}
DECL|method|closeOnDiskFile (Path file)
specifier|public
specifier|synchronized
name|void
...
argument_list|>
block|{
DECL|method|IntermediateMemoryToMemoryMerger (MergeManager<K, V> manager, int mergeFactor)
specifier|public
name|IntermediateMemoryToMemoryMerger
parameter_list|(
name|MergeManager
...
annotation|@
name|Override
DECL|method|merge (List<MapOutput<K, V>> inputs)
specifier|public
name|void
name|merge
parameter_list|(
...
argument_list|>
block|{
DECL|method|InMemoryMerger (MergeManager<K, V> manager)
specifier|public
name|InMemoryMerger
parameter_list|(
name|MergeManager
...
argument_list|>
block|{
DECL|method|OnDiskMerger (MergeManager<K, V> manager)
specifier|public
name|OnDiskMerger
parameter_list|(
name|MergeManager
...
annotation|@
name|Override
DECL|method|merge (List<Path> inputs)
specifier|public
name|void
name|merge
parameter_list|(
...
block|}
block|}
DECL|method|createInMemorySegments (List<MapOutput<K,V>> inMemoryMapOutputs, List<Segment<K, V>> inMemorySegments, long leaveBytes )
specifier|private
name|long
name|createInMemorySegments
parameter_list|(
...
block|}
block|}
DECL|method|finalMerge (JobConf job, FileSystem fs, List<MapOutput<K,V>> inMemoryMapOutputs, List<Path> onDiskMapOutputs )
specifier|private
name|RawKeyValueIterator
name|finalMerge
parameter_list|(
