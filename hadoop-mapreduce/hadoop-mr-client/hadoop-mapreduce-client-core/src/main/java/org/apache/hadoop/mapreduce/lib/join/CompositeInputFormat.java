...
init|=
literal|"mapreduce.join.keycomparator"
decl_stmt|;
...
DECL|method|addUserIdentifiers (Configuration conf)
specifier|private
name|void
name|addUserIdentifiers
parameter_list|(
...
name|compile
argument_list|(
literal|"^mapreduce\\.join\\.define\\.(\\w+)$"
argument_list|)
decl_stmt|;
for|for
control|(
