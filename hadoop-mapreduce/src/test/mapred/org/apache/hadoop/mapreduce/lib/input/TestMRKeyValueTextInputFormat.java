...
begin_class
DECL|class|TestMRKeyValueTextInputFormat
specifier|public
class|class
name|TestMRKeyValueTextInputFormat
block|{
DECL|field|LOG
specifier|private
specifier|static
...
name|assertTrue
argument_list|(
literal|"KVTIF claims not splittable"
argument_list|,
name|format
operator|.
name|isSplitable
...
name|v
operator|+
literal|" in multiple partitions."
argument_list|,
name|bits
operator|.
name|get
...
expr_stmt|;
block|}
DECL|method|readSplit (KeyValueTextInputFormat format, InputSplit split, Job job)
specifier|private
specifier|static
name|List
argument_list|<
