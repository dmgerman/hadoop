...
DECL|method|TypedBytesOutput (DataOutput out)
specifier|public
name|TypedBytesOutput
parameter_list|(
name|DataOutput
...
DECL|method|writeRaw (byte[] bytes)
specifier|public
name|void
name|writeRaw
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Writes a bytes array as a typed bytes sequence, using a given typecode     * and length.    *     * @param bytes the bytes array to be written    * @param code the typecode to use    * @param length the number of bytes to write, starting from position 0    * @throws IOException    */
DECL|method|writeBytes (byte[] bytes, int code, int length)
specifier|public
name|void
name|writeBytes
parameter_list|(
...
DECL|method|writeBytes (byte[] bytes, int code)
specifier|public
name|void
name|writeBytes
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Writes a bytes buffer as a typed bytes sequence.    *     * @param buffer the bytes buffer to be written    * @throws IOException    */
DECL|method|writeBytes (Buffer buffer)
specifier|public
name|void
name|writeBytes
parameter_list|(
...
DECL|method|writeBool (boolean b)
specifier|public
name|void
name|writeBool
parameter_list|(
...
DECL|method|writeFloat (float f)
specifier|public
name|void
name|writeFloat
parameter_list|(
...
DECL|method|writeDouble (double d)
specifier|public
name|void
name|writeDouble
parameter_list|(
...
DECL|method|writeVector (ArrayList vector)
specifier|public
name|void
name|writeVector
parameter_list|(
...
DECL|method|writeVectorHeader (int length)
specifier|public
name|void
name|writeVectorHeader
parameter_list|(
...
DECL|method|writeList (List list)
specifier|public
name|void
name|writeList
parameter_list|(
...
DECL|method|writeMapHeader (int length)
specifier|public
name|void
name|writeMapHeader
parameter_list|(
