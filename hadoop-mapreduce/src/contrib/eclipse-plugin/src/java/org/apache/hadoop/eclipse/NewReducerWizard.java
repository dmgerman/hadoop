...
begin_comment
comment|/**  * Wizard for creating a new Reducer class (a class that runs the Reduce  * portion of a MapReduce job). The class is pre-filled with a template.  *   */
end_comment

begin_class
DECL|class|NewReducerWizard
specifier|public
class|class
...
name|setDescription
argument_list|(
literal|"Create a new Reducer implementation."
argument_list|)
expr_stmt|;
...
name|createMethod
argument_list|(
literal|"public void reduce(WritableComparable _key, Iterator values, OutputCollector output, Reporter reporter) throws IOException \n{\n"
operator|+
literal|"\t// replace KeyType with the real type of your key\n"
operator|+
literal|"\tKeyType key = (KeyType) _key;\n\n"
operator|+
literal|"\twhile (values.hasNext()) {\n"
operator|+
literal|"\t\t// replace ValueType with the real type of your value\n"
operator|+
literal|"\t\tValueType value = (ValueType) values.next();\n\n"
operator|+
literal|"\t\t// process value\n"
operator|+
literal|"\t}\n"
operator|+
literal|"}\n"
