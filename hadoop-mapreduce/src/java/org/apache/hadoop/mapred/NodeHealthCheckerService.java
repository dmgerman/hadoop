...
DECL|field|HEALTH_CHECK_SCRIPT_PROPERTY
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|HEALTH_CHECK_INTERVAL_PROPERTY
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|HEALTH_CHECK_FAILURE_INTERVAL_PROPERTY
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|HEALTH_CHECK_SCRIPT_ARGUMENTS_PROPERTY
specifier|static
specifier|final
name|String
name|HEALTH_CHECK_SCRIPT_ARGUMENTS_PROPERTY
init|=
name|TTConfig
operator|.
name|TT_HEALTH_CHECKER_SCRIPT_ARGS
decl_stmt|;
comment|/* end of configuration keys */
...
decl_stmt|;
comment|/** Default frequency of running node health script */
DECL|field|DEFAULT_HEALTH_CHECK_INTERVAL
specifier|private
specifier|static
specifier|final
name|long
name|DEFAULT_HEALTH_CHECK_INTERVAL
init|=
literal|10
operator|*
literal|60
...
literal|1000
decl_stmt|;
comment|/** Default script time out period */
DECL|field|DEFAULT_HEALTH_SCRIPT_FAILURE_INTERVAL
specifier|private
specifier|static
specifier|final
name|long
name|DEFAULT_HEALTH_SCRIPT_FAILURE_INTERVAL
init|=
literal|2
operator|*
name|DEFAULT_HEALTH_CHECK_INTERVAL
...
expr_stmt|;
block|}
comment|/**    * Method to populate the fields for the {@link TaskTrackerHealthStatus}    *     * @param healthStatus    */
DECL|method|setHealthStatus (TaskTrackerHealthStatus healthStatus)
specifier|synchronized
name|void
name|setHealthStatus
parameter_list|(
