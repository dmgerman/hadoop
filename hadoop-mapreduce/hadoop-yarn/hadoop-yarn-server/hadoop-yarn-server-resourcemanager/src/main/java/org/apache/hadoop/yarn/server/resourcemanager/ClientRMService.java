...
decl_stmt|;
DECL|method|ClientRMService (RMContext rmContext, ClientToAMSecretManager clientToAMSecretManager, YarnScheduler scheduler, ApplicationMasterService masterService)
specifier|public
name|ClientRMService
parameter_list|(
name|RMContext
