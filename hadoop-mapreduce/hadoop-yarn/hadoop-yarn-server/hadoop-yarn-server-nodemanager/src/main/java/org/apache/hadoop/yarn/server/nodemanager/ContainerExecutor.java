...
condition|)
block|{
comment|// This happens if the command is not yet started
return|return
name|pid
return|;
block|}
...
parameter_list|)
block|{
comment|// SecurityManager not expected with yarn. Ignore.
block|}
catch|catch
parameter_list|(
...
parameter_list|)
block|{
comment|// Yarn only on UNIX for now. Ignore.
block|}
catch|catch
parameter_list|(
...
name|containerExecutor
decl_stmt|;
DECL|method|DelayedProcessKiller (String user, String pid, long delay, Signal signal, ContainerExecutor containerExecutor)
specifier|public
name|DelayedProcessKiller
parameter_list|(
name|String
...
name|warn
argument_list|(
literal|"Exception when killing task "
operator|+
name|pid
argument_list|,
name|e
