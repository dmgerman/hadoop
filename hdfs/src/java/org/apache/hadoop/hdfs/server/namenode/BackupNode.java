...
name|Override
comment|// NamenodeProtocol
DECL|method|journal (NamenodeRegistration nnReg, int jAction, int length, byte[] args)
specifier|public
name|void
name|journal
parameter_list|(
...
name|IOException
argument_list|(
literal|"Unexpected journal action: "
operator|+
name|jAction
argument_list|)
throw|;
...
operator|+
literal|": active node namespaceID = "
operator|+
name|nsInfo
operator|.
name|getNamespaceID
argument_list|()
operator|+
literal|"; backup node namespaceID = "
operator|+
name|bnImage
operator|.
name|getStorage
...
expr_stmt|;
block|}
comment|/**    * Reset node namespace state in memory and in storage directories.    * @throws IOException    */
DECL|method|resetNamespace ()
name|void
name|resetNamespace
parameter_list|()
throws|throws
...
expr_stmt|;
block|}
comment|/**    * Get size of the local journal (edit log).    * @return size of the current journal    * @throws IOException    */
DECL|method|journalSize ()
name|long
name|journalSize
parameter_list|()
throws|throws
