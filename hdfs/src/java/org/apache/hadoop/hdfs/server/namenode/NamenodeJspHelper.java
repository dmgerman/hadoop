...
argument_list|)
expr_stmt|;
comment|// If a data node has been first included in the include list,
comment|// then decommissioned, then removed from both include and exclude list.
comment|// We make the web console to "forget" this node by not displaying it.
name|fsn
operator|.
...
DECL|method|getNetworkTopology (final NameNode namenode)
specifier|static
name|NetworkTopology
...
return|;
block|}
DECL|method|generateNodeDataHeader (JspWriter out, DatanodeDescriptor d, String suffix, boolean alive, int nnHttpPort, String nnaddr)
specifier|private
name|void
...
expr_stmt|;
block|}
DECL|method|generateDecommissioningNodeData (JspWriter out, DatanodeDescriptor d, String suffix, boolean alive, int nnHttpPort, String nnaddr)
name|void
...
expr_stmt|;
block|}
DECL|method|generateNodeData (JspWriter out, DatanodeDescriptor d, String suffix, boolean alive, int nnHttpPort, String nnaddr)
name|void
