...
name|BlockManager
block|{
comment|// Default initial capacity and load factor of map
DECL|field|DEFAULT_INITIAL_MAP_CAPACITY
specifier|public
specifier|static
specifier|final
name|int
name|DEFAULT_INITIAL_MAP_CAPACITY
init|=
literal|16
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|BlockManager (FSNamesystem fsn, Configuration conf, int capacity)
name|BlockManager
parameter_list|(
name|FSNamesystem
name|fsn
...
argument_list|)
expr_stmt|;
comment|// TODO should using recentInvalidateSets be synchronized?
