...
name|debug
argument_list|(
literal|"Removing pending replication for block"
operator|+
name|block
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"PendingReplicationMonitor thread received exception. "
operator|+
name|ie
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"PendingReplicationMonitor timed out block "
operator|+
name|block
argument_list|)
expr_stmt|;
