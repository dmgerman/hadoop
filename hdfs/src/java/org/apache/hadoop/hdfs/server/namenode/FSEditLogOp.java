...
name|timestamp
argument_list|)
comment|// atime, unused at this time
block|}
decl_stmt|;
operator|new
name|ArrayWritable
...
expr_stmt|;
block|}
DECL|method|setCheckpointTime (long time)
name|CheckpointTimeOp
...
name|out
decl_stmt|;
DECL|method|Writer (DataOutputStream out)
specifier|public
name|Writer
parameter_list|(
name|DataOutputStream
