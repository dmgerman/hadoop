...
argument_list|)
operator|+
literal|" following http server start."
argument_list|)
expr_stmt|;
name|SecurityUtil
operator|.
...
name|Override
comment|// NamenodeProtocol
DECL|method|journal (NamenodeRegistration registration, int jAction, int length, byte[] args)
specifier|public
name|void
name|journal
parameter_list|(
...
throw|;
block|}
comment|/**    * Returns the name of the fsImage file    */
...
return|;
block|}
comment|/**    * Returns the name of the fsImage file uploaded by periodic    * checkpointing    */
