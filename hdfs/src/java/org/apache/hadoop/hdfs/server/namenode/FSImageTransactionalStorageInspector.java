...
expr_stmt|;
block|}
DECL|method|addEditLog (EditLogFile foundEditLog)
specifier|private
name|void
name|addEditLog
parameter_list|(
...
return|;
block|}
DECL|method|getEditLogFiles ()
specifier|public
name|List
argument_list|<
name|EditLogFile
argument_list|>
name|getEditLogFiles
parameter_list|()
block|{
return|return
name|ImmutableList
...
throw|;
block|}
DECL|method|add (EditLogFile log)
name|void
name|add
parameter_list|(
name|EditLogFile
...
name|logPlan
decl_stmt|;
DECL|method|TransactionalLoadPlan (FSImageFile image, LogLoadPlan logPlan)
specifier|public
name|TransactionalLoadPlan
parameter_list|(
name|FSImageFile
...
decl_stmt|;
DECL|method|LogLoadPlan (List<EditLogFile> editLogs, List<LogGroup> logGroupsToRecover)
name|LogLoadPlan
parameter_list|(
name|List
argument_list|<
