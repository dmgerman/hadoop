...
return|;
block|}
comment|/**      * Read version file.      *       * @throws IOException if file cannot be read or contains inconsistent data      */
DECL|method|read ()
specifier|public
name|void
name|read
...
return|;
block|}
comment|/**      * Write version file.      *       * @throws IOException      */
DECL|method|write ()
specifier|public
name|void
name|write
...
DECL|method|analyzeStorage (StartupOption startOpt)
specifier|public
name|StorageState
name|analyzeStorage
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Set common storage fields.    * Should be overloaded if additional fields need to be set.    *     * @param props    * @throws IOException    */
...
DECL|method|isLockSupported (int idx)
specifier|public
name|boolean
