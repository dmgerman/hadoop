...
expr_stmt|;
block|}
comment|/**    * Remove a datanode descriptor.    * @param nodeID datanode ID.    * @throws UnregisteredNodeException     */
DECL|method|removeDatanode (final DatanodeID nodeID )
specifier|public
name|void
name|removeDatanode
parameter_list|(
...
return|;
block|}
DECL|method|removeDecomNodeFromList (List<DatanodeDescriptor> nodeList)
name|void
name|removeDecomNodeFromList
parameter_list|(
name|List
