...
begin_comment
comment|/**    * ugi parameter for http connection    *     * @return user_shortname,group1,group2...    */
end_comment

begin_function
DECL|method|getUgiParameter ()
specifier|private
name|String
name|getUgiParameter
parameter_list|()
...
begin_function
DECL|method|updateQuery (String query)
specifier|protected
name|String
name|updateQuery
parameter_list|(
