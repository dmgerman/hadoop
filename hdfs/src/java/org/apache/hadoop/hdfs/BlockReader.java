...
return|;
block|}
DECL|method|BlockReader (String file, String bpid, long blockId, DataInputStream in, DataChecksum checksum, boolean verifyChecksum, long startOffset, long firstChunkOffset, long bytesToRead, Socket dnSock)
specifier|private
name|BlockReader
parameter_list|(
name|String
...
return|;
block|}
comment|/** Java Doc required */
DECL|method|newBlockReader ( Socket sock, String file, ExtendedBlock block, Token<BlockTokenIdentifier> blockToken, long startOffset, long len, int bufferSize, boolean verifyChecksum)
specifier|public
specifier|static
name|BlockReader
name|newBlockReader
