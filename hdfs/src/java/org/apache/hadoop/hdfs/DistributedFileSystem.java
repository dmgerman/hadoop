...
expr_stmt|;
block|}
comment|/** Permit paths which explicitly specify the default port. */
annotation|@
name|Override
...
expr_stmt|;
block|}
comment|/** Normalize paths that explicitly specify the default port. */
annotation|@
name|Override
...
return|;
block|}
comment|/** @deprecated Use {@link org.apache.hadoop.fs.FsStatus} instead */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
name|FsStatus
block|{
DECL|method|DiskStatus (FsStatus stats)
specifier|public
name|DiskStatus
parameter_list|(
name|FsStatus
...
expr_stmt|;
block|}
DECL|method|DiskStatus (long capacity, long dfsUsed, long remaining)
specifier|public
name|DiskStatus
parameter_list|(
name|long
...
return|;
block|}
comment|/** Return the disk usage of the filesystem, including total capacity,    * used space, and remaining space     * @deprecated Use {@link org.apache.hadoop.fs.FileSystem#getStatus()}     * instead */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/** Return the total raw capacity of the filesystem, disregarding    * replication.    * @deprecated Use {@link org.apache.hadoop.fs.FileSystem#getStatus()}     * instead */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/** Return the total raw used space in the filesystem, disregarding    * replication.    * @deprecated Use {@link org.apache.hadoop.fs.FileSystem#getStatus()}     * instead */
annotation|@
name|Deprecated
DECL|method|getRawUsed ()
specifier|public
name|long
name|getRawUsed
parameter_list|()
