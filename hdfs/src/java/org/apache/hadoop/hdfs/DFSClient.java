...
expr_stmt|;
block|}
comment|/**    * Same as this(nameNodeAddr, conf, null);    * @see #DFSClient(InetSocketAddress, Configuration, org.apache.hadoop.fs.FileSystem.Statistics)    */
DECL|method|DFSClient (InetSocketAddress nameNodeAddr, Configuration conf )
specifier|public
name|DFSClient
parameter_list|(
name|InetSocketAddress
...
expr_stmt|;
block|}
comment|/**    * Same as this(nameNodeAddr, null, conf, stats);    * @see #DFSClient(InetSocketAddress, ClientProtocol, Configuration, org.apache.hadoop.fs.FileSystem.Statistics)     */
DECL|method|DFSClient (InetSocketAddress nameNodeAddr, Configuration conf, FileSystem.Statistics stats)
specifier|public
name|DFSClient
parameter_list|(
name|InetSocketAddress
...
expr_stmt|;
block|}
comment|/**     * Create a new DFSClient connected to the given nameNodeAddr or rpcNamenode.    * Exactly one of nameNodeAddr or rpcNamenode must be null.    */
DECL|method|DFSClient (InetSocketAddress nameNodeAddr, ClientProtocol rpcNamenode, Configuration conf, FileSystem.Statistics stats)
name|DFSClient
parameter_list|(
name|InetSocketAddress
name|nameNodeAddr
...
argument_list|(
literal|"Expecting exactly one of nameNodeAddr and rpcNamenode being null: "
operator|+
...
return|;
block|}
comment|/**    *  A test method for printing out tokens     *  @param token    *  @return Stringify version of the token    */
DECL|method|stringifyToken (Token<DelegationTokenIdentifier> token)
specifier|public
specifier|static
name|String
name|stringifyToken
...
return|;
block|}
comment|/**    * @see ClientProtocol#renewDelegationToken(Token)    */
...
block|}
block|}
comment|/**    * @see ClientProtocol#cancelDelegationToken(Token)    */
...
DECL|method|getFileChecksum (String src, ClientProtocol namenode, SocketFactory socketFactory, int socketTimeout )
specifier|public
specifier|static
name|MD5MD5CRC32FileChecksum
name|getFileChecksum
