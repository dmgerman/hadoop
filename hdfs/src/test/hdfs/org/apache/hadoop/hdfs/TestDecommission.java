...
expr_stmt|;
block|}
comment|/**    * For blocks that reside on the nodes that are down, verify that their    * replication factor is 1 more than the specified one.    */
...
block|{
comment|//
comment|// sleep an additional 10 seconds for the blockreports from the datanodes
comment|// to arrive.
comment|//
...
name|assertEquals
argument_list|(
literal|"Decom node is not at the end"
argument_list|,
name|firstDecomNodeIndex
argument_list|,
operator|-
...
name|assertEquals
argument_list|(
literal|"Number of replicas for block "
operator|+
name|blk
operator|.
name|getBlock
