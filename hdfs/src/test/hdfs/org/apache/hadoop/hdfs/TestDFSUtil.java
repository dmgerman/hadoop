...
expr_stmt|;
block|}
comment|/**     * Test for    * {@link DFSUtil#getNameServiceIds(Configuration)}    * {@link DFSUtil#getNameServiceId(Configuration)}    * {@link DFSUtil#getNNServiceRpcAddresses(Configuration)}    */
annotation|@
name|Test
...
argument_list|)
expr_stmt|;
comment|// Test - The configured nameserviceIds are returned
name|Collection
argument_list|<
name|String
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Tests default nameserviceId is returned
name|conf
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// If DFSConfigKeys.DFS_FEDERATION_NAMESERVICES is not set, verify that
