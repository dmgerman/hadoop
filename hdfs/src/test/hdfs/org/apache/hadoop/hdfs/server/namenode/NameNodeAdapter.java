...
return|;
block|}
comment|/**    * Return a tuple of the replica state (number racks, number live    * replicas, and number needed replicas) for the given block.    * @param namenode to proxy the invocation to.    */
DECL|method|getReplicaInfo (NameNode namenode, Block b)
specifier|public
specifier|static
name|int
index|[]
