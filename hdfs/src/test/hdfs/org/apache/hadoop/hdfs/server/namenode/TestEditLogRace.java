...
block|}
block|}
DECL|method|verifyEditLogs (FSNamesystem namesystem, FSImage fsimage)
specifier|private
name|void
name|verifyEditLogs
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Verify that edit logs post save are also not corrupt
name|verifyEditLogs
argument_list|(
name|namesystem
argument_list|,
