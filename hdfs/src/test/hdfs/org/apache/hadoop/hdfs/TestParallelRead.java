...
begin_comment
comment|/**  * Test the use of DFSInputStream by multiple concurrent readers.  */
end_comment
...
name|error
decl_stmt|;
DECL|method|ReadWorker (TestFileInfo testInfo, int id)
name|ReadWorker
parameter_list|(
name|TestFileInfo
name|testInfo
...
DECL|method|runParallelRead (int nFiles, int nWorkerEach)
name|boolean
name|runParallelRead
parameter_list|(
name|int
