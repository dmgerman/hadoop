...
return|;
block|}
comment|/**    * Returns Iterator to iterate over all buckets for a specific user.    * The result can be restricted using bucket prefix, will return all    * buckets if bucket prefix is null.    *    * @param userName    * @param prefix    * @return {@code Iterator<OzoneBucket>}    */
DECL|method|listS3Buckets (String userName, String prefix)
specifier|public
name|Iterator
argument_list|<
name|?
...
return|;
block|}
DECL|method|getAuthenticationHeaderParser ()
specifier|public
name|AuthenticationHeaderParser
