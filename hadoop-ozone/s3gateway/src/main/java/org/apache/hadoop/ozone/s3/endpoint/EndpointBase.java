...
return|;
block|}
comment|/**    * Retrieve the username based on the authorization header.    *    * @param httpHeaders    * @return Identified username    * @throws OS3Exception    */
DECL|method|parseUsername ( @ontext HttpHeaders httpHeaders)
specifier|public
name|String
name|parseUsername
parameter_list|(
