...
annotation|@
name|GET
DECL|method|list ( @athParamR) String bucketName, @QueryParam(R) String delimiter, @QueryParam(R) String encodingType, @QueryParam(R) String marker, @DefaultValue(R) @QueryParam(R) int maxKeys, @QueryParam(R) String prefix, @QueryParam(R) String browser, @Context HttpHeaders hh)
specifier|public
name|Response
name|list
parameter_list|(
