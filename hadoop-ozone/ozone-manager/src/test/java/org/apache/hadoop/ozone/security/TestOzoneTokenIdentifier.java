...
begin_comment
comment|/**  * Test class for {@link OzoneTokenIdentifier}.  */
end_comment

begin_class
DECL|class|TestOzoneTokenIdentifier
specifier|public
class|class
name|TestOzoneTokenIdentifier
block|{
DECL|field|LOG
specifier|private
specifier|static
...
name|sslConfsDir
decl_stmt|;
DECL|field|EXCLUDE_CIPHERS
specifier|private
specifier|static
specifier|final
name|String
name|EXCLUDE_CIPHERS
init|=
...
expr_stmt|;
block|}
DECL|method|signTokenAsymmetric (OzoneTokenIdentifier tokenId, PrivateKey privateKey)
specifier|public
name|byte
index|[]
name|signTokenAsymmetric
...
return|;
block|}
DECL|method|verifyTokenAsymmetric (OzoneTokenIdentifier tokenId, byte[] signature, Certificate certificate)
specifier|public
name|boolean
name|verifyTokenAsymmetric
parameter_list|(
...
return|;
block|}
DECL|method|signTokenSymmetric (OzoneTokenIdentifier identifier, Mac mac, SecretKey key)
specifier|private
name|byte
index|[]
...
expr_stmt|;
block|}
comment|/*    * Test serialization/deserialization of OzoneTokenIdentifier.    */
annotation|@
name|Test
DECL|method|testReadWriteInProtobuf ()
specifier|public
name|void
name|testReadWriteInProtobuf
parameter_list|()
throws|throws
name|IOException
block|{
