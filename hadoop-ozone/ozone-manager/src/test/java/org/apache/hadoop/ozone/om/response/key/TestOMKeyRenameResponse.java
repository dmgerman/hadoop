...
begin_comment
comment|/**  * Tests OMKeyRenameResponse.  */
end_comment

begin_class
DECL|class|TestOMKeyRenameResponse
specifier|public
class|class
name|TestOMKeyRenameResponse
extends|extends
...
argument_list|)
expr_stmt|;
comment|// As omResponse has error, it is a no-op. So, no changes should happen.
name|Assert
operator|.
name|assertTrue
argument_list|(
...
annotation|@
name|Test
DECL|method|testAddToDBBatchWithSameKeyName ()
specifier|public
name|void
name|testAddToDBBatchWithSameKeyName
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Passing toKeyName also same as KeyName.
name|OMKeyRenameResponse
name|omKeyRenameResponse
init|=
operator|new
