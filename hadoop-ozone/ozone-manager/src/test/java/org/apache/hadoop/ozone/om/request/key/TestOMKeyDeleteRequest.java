...
begin_comment
comment|/**  * Tests OmKeyDelete request.  */
end_comment

begin_class
DECL|class|TestOMKeyDeleteRequest
specifier|public
class|class
name|TestOMKeyDeleteRequest
extends|extends
...
argument_list|)
decl_stmt|;
comment|// As we added manually to key table.
name|Assert
operator|.
name|assertNotNull
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Now after calling validateAndUpdateCache, it should be deleted.
name|omKeyInfo
operator|=
name|omMetadataManager
operator|.
...
DECL|method|createDeleteKeyRequest ()
specifier|private
name|OMRequest
name|createDeleteKeyRequest
parameter_list|()
