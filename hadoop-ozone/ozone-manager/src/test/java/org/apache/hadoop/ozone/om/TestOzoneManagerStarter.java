...
begin_comment
comment|/**  * This class is used to test the CLI provided by OzoneManagerStarter, which is  * used to start and init the OzoneManager. The calls to the Ozone Manager are  * mocked so the tests only validate the CLI calls the correct methods are  * invoked.  */
end_comment

begin_class
DECL|class|TestOzoneManagerStarter
specifier|public
class|class
name|TestOzoneManagerStarter
block|{
...
annotation|@
name|Test
DECL|method|testInitThatReturnsFalseThrowsException ()
specifier|public
name|void
name|testInitThatReturnsFalseThrowsException
parameter_list|()
block|{
name|mock
operator|.
