...
argument_list|()
decl_stmt|;
comment|// As we have not flushed/added any transactions, all metrics should have
comment|// value zero.
name|Assert
operator|.
name|assertTrue
...
name|omBucketInfo
decl_stmt|;
DECL|method|OMDummyCreateBucketResponse (OmBucketInfo omBucketInfo, OMResponse omResponse)
specifier|public
name|OMDummyCreateBucketResponse
parameter_list|(
name|OmBucketInfo
