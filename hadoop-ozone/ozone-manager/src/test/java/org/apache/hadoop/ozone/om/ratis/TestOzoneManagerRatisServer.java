...
annotation|@
name|Test
DECL|method|testLoadSnapshotInfoOnStart ()
specifier|public
name|void
name|testLoadSnapshotInfoOnStart
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Stop the Ratis server and manually update the snapshotInfo.
name|long
name|oldSnaphsotIndex
init|=
name|ozoneManager
operator|.
...
argument_list|)
expr_stmt|;
comment|// Start new Ratis server. It should pick up and load the new SnapshotInfo
name|omRatisServer
operator|=
name|OzoneManagerRatisServer
operator|.
