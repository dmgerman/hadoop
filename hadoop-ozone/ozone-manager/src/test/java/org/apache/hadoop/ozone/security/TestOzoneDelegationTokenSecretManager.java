...
expr_stmt|;
block|}
DECL|method|restartSecretManager ()
specifier|private
name|void
name|restartSecretManager
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testRenewTokenSuccessHelper (boolean restartSecretManager)
specifier|private
name|void
name|testRenewTokenSuccessHelper
parameter_list|(
name|boolean
name|restartSecretManager
parameter_list|)
...
annotation|@
name|Test
DECL|method|testReloadAndRenewToken ()
specifier|public
name|void
name|testReloadAndRenewToken
parameter_list|()
throws|throws
name|Exception
block|{
