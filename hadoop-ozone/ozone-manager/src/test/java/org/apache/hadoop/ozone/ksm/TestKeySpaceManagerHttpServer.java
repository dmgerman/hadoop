...
begin_comment
comment|/**  * Test http server os KSM with various HTTP option.  */
end_comment
...
name|class
argument_list|)
DECL|class|TestKeySpaceManagerHttpServer
specifier|public
class|class
name|TestKeySpaceManagerHttpServer
block|{
DECL|field|BASEDIR
specifier|private
specifier|static
...
name|policy
decl_stmt|;
DECL|method|TestKeySpaceManagerHttpServer (Policy policy)
specifier|public
name|TestKeySpaceManagerHttpServer
parameter_list|(
name|Policy
