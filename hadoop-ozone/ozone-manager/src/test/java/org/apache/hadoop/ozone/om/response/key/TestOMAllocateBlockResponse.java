...
begin_comment
comment|/**  * Tests OMAllocateBlockResponse.  */
end_comment

begin_class
DECL|class|TestOMAllocateBlockResponse
specifier|public
class|class
name|TestOMAllocateBlockResponse
extends|extends
...
argument_list|)
decl_stmt|;
comment|// Not adding key entry before to test whether commit is successful or not.
name|Assert
operator|.
name|assertFalse
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// Before calling addToDBBatch
name|String
name|openKey
init|=
name|omMetadataManager
...
argument_list|)
expr_stmt|;
comment|// As omResponse is error it is a no-op.
name|Assert
operator|.
name|assertFalse
argument_list|(
