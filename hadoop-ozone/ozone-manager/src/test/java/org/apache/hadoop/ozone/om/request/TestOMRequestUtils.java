...
block|}
block|}
comment|/**    * Add key entry to key table cache.    * @param volumeName    * @param bucketName    * @param keyName    * @param replicationType    * @param replicationFactor    * @param omMetadataManager    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"parameterNumber"
argument_list|)
DECL|method|addKeyToTableCache (String volumeName, String bucketName, String keyName, HddsProtos.ReplicationType replicationType, HddsProtos.ReplicationFactor replicationFactor, OMMetadataManager omMetadataManager)
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
DECL|method|createKeyInfo (String volumeName, String bucketName, String keyName, HddsProtos.ReplicationType replicationType, HddsProtos.ReplicationFactor replicationFactor)
specifier|private
name|OmKeyInfo
name|createKeyInfo
parameter_list|(
