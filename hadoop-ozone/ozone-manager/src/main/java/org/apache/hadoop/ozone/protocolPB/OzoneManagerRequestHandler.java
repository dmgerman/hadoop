...
case|:
name|CreateKeyResponse
name|applyKeyResponse
init|=
name|applyCreateKey
argument_list|(
name|request
operator|.
name|getApplyCreateKeyRequest
argument_list|()
argument_list|)
decl_stmt|;
name|responseBuilder
...
name|request
operator|.
name|getInitiateMultiPartUploadApplyRequest
argument_list|()
argument_list|)
decl_stmt|;
name|responseBuilder
...
name|request
operator|.
name|getGetFileStatusRequest
argument_list|()
argument_list|)
decl_stmt|;
name|responseBuilder
operator|.
name|setGetFileStatusResponse
argument_list|(
name|getFileStatusResponse
argument_list|)
expr_stmt|;
...
name|request
operator|.
name|getLookupFileRequest
argument_list|()
argument_list|)
decl_stmt|;
name|responseBuilder
operator|.
name|setLookupFileResponse
argument_list|(
name|lookupFileResponse
argument_list|)
expr_stmt|;
...
name|request
operator|.
name|getListStatusRequest
argument_list|()
argument_list|)
decl_stmt|;
name|responseBuilder
operator|.
name|setListStatusResponse
argument_list|(
name|listStatusResponse
argument_list|)
expr_stmt|;
...
name|request
operator|.
name|getGetAclRequest
argument_list|()
argument_list|)
decl_stmt|;
name|responseBuilder
operator|.
name|setGetAclResponse
argument_list|(
name|getAclResponse
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|getAcl (GetAclRequest req)
specifier|private
name|GetAclResponse
name|getAcl
parameter_list|(
...
return|;
block|}
DECL|method|removeAcl (RemoveAclRequest req)
specifier|private
name|RemoveAclResponse
name|removeAcl
parameter_list|(
...
return|;
block|}
DECL|method|setAcl (SetAclRequest req)
specifier|private
name|SetAclResponse
name|setAcl
parameter_list|(
...
return|;
block|}
DECL|method|addAcl (AddAclRequest req)
specifier|private
name|AddAclResponse
name|addAcl
parameter_list|(
...
return|;
block|}
DECL|method|applyCreateKey (ApplyCreateKeyRequest request)
specifier|private
name|CreateKeyResponse
name|applyCreateKey
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// If applying to om DB successful just return createKeyResponse.
return|return
name|createKeyResponse
return|;
block|}
...
return|;
block|}
DECL|method|applyInitiateMultiPartUpload ( MultipartInfoApplyInitiateRequest request)
specifier|private
name|MultipartInfoInitiateResponse
name|applyInitiateMultiPartUpload
parameter_list|(
...
return|;
block|}
DECL|method|getS3Secret ( GetS3SecretRequest request)
specifier|private
name|GetS3SecretResponse
name|getS3Secret
parameter_list|(
...
return|;
block|}
DECL|method|getOzoneFileStatus ( GetFileStatusRequest request)
specifier|private
name|GetFileStatusResponse
name|getOzoneFileStatus
parameter_list|(
...
return|;
block|}
DECL|method|createDirectory (CreateDirectoryRequest request)
specifier|private
name|void
name|createDirectory
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|createFile ( CreateFileRequest request)
specifier|private
name|CreateFileResponse
name|createFile
parameter_list|(
...
return|;
block|}
DECL|method|lookupFile ( LookupFileRequest request)
specifier|private
name|LookupFileResponse
name|lookupFile
parameter_list|(
...
operator|.
name|Builder
name|listStatusResponseBuilder
init|=
name|ListStatusResponse
operator|.
name|newBuilder
