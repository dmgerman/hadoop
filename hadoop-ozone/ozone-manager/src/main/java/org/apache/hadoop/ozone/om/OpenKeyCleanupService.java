...
begin_comment
comment|/**  * This is the background service to delete hanging open keys.  * Scan the metadata of om periodically to get  * the keys with prefix "#open#" and ask scm to  * delete metadata accordingly, if scm returns  * success for keys, then clean up those keys.  */
end_comment
...
name|debug
argument_list|(
literal|"Found {} to-delete open keys in OM"
argument_list|,
name|toDeleteSize
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"No hanging open key found in OM"
argument_list|)
expr_stmt|;
block|}
block|}
