...
begin_comment
comment|/**  * This is the background service to delete keys.  * Scan the metadata of om periodically to get  * the keys with prefix "#deleting" and ask scm to  * delete metadata accordingly, if scm returns  * success for keys, then clean up those keys.  */
end_comment
...
name|info
argument_list|(
literal|"Found {} to-delete keys in OM"
argument_list|,
name|keyBlocksList
operator|.
name|size
...
name|info
argument_list|(
literal|"Number of key deleted from OM DB: {},"
operator|+
...
name|debug
argument_list|(
literal|"No pending deletion key found in OM"
argument_list|)
expr_stmt|;
block|}
block|}
