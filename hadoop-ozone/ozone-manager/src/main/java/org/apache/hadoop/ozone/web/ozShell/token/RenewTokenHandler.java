...
begin_comment
comment|/**  * Executes renewDelegationToken api.  */
end_comment
...
name|description
operator|=
literal|"renew a delegation token."
argument_list|)
DECL|class|RenewTokenHandler
specifier|public
class|class
...
name|println
argument_list|(
literal|"Error:Renew token operation failed as token file: "
operator|+
name|tokenFile
operator|+
...
name|printf
argument_list|(
literal|"Token renewed successfully, expiry time: %s"
argument_list|,
name|expiryTime
argument_list|)
expr_stmt|;
