...
name|error
argument_list|(
literal|"Open failed for Key: {} in volume/bucket:{}/{}"
argument_list|,
name|keyName
argument_list|,
name|bucketName
...
block|}
block|}
DECL|method|prepareKeyInfo (OMMetadataManager omMetadataManager, KeyArgs keyArgs, String dbKeyName, long size, List<OmKeyLocationInfo> locations, FileEncryptionInfo encInfo)
specifier|private
name|OmKeyInfo
name|prepareKeyInfo
parameter_list|(
...
return|;
block|}
DECL|method|prepareMultipartKeyInfo (OMMetadataManager omMetadataManager, KeyArgs args, long size, List<OmKeyLocationInfo> locations, FileEncryptionInfo encInfo)
specifier|private
name|OmKeyInfo
name|prepareMultipartKeyInfo
parameter_list|(
...
return|;
block|}
comment|/**    * Create OmKeyInfo object.    * @param keyArgs    * @param locations    * @param factor    * @param type    * @param size    * @param encInfo    * @return    */
DECL|method|createKeyInfo (KeyArgs keyArgs, List<OmKeyLocationInfo> locations, HddsProtos.ReplicationFactor factor, HddsProtos.ReplicationType type, long size, FileEncryptionInfo encInfo)
specifier|private
name|OmKeyInfo
name|createKeyInfo
parameter_list|(
