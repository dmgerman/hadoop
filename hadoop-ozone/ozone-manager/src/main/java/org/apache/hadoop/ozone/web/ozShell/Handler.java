...
block|}
block|}
comment|/**    *    * @param uri    * @return volumeName    * @throws Exception    * @throws OzoneClientException when uri is null or invalid volume name    */
DECL|method|parseVolumeName (String uri)
specifier|protected
name|String
...
name|errorMessage
operator|=
literal|"Volume name is required to perform volume "
operator|+
literal|"operations like info, update, create and delete. "
expr_stmt|;
block|}
else|else
block|{
