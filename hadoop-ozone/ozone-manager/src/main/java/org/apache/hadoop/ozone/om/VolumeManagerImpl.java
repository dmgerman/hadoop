...
return|;
block|}
comment|/**    * Creates a volume.    * @param omVolumeArgs - OmVolumeArgs.    * @return VolumeList    */
annotation|@
name|Override
...
name|IOException
block|{
comment|// Do we need to hold lock in apply Transactions requests?
name|String
name|dbVolumeKey
init|=
name|metadataManager
...
block|}
block|}
comment|/**    * Changes the Quota on a volume.    *    * @param volume - Name of the volume.    * @param quota - Quota in bytes.    *    * @return OmVolumeArgs    * @throws IOException    */
annotation|@
name|Override
...
block|}
block|}
comment|/**    * Deletes an existing empty volume.    *    * @param volume - Name of the volume.    *    * @return OmDeleteVolumeResponse    * @throws IOException    */
annotation|@
name|Override
