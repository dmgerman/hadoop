...
block|}
block|}
comment|//Check if key with same keyName exists in deletedTable and then
comment|// insert/update accordingly.
name|RepeatedOmKeyInfo
name|repeatedOmKeyInfo
init|=
name|metadataManager
...
name|warn
argument_list|(
literal|"Open key entry for multipart upload record can be read  {}"
argument_list|,
name|dbKey
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"List Multipart Uploads Failed: volume: "
operator|+
name|volumeName
operator|+
literal|"bucket: "
...
name|replicationFactor
argument_list|,
literal|"Replication factor can't be identified"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|error
argument_list|(
literal|"List Multipart Upload Parts Failed: volume: {}, bucket: {}, ,key: "
operator|+
literal|"{} "
argument_list|,
name|volumeName
