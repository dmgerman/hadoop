...
block|}
block|}
DECL|method|getAclsForKey (OmKeyArgs keyArgs, OmVolumeArgs volArgs, OmBucketInfo bucketInfo)
specifier|private
name|List
argument_list|<
name|OzoneAclInfo
...
block|{
comment|// Acl to be removed might be a subset of existing acls.
for|for
control|(
name|OzoneAclInfo
name|a
