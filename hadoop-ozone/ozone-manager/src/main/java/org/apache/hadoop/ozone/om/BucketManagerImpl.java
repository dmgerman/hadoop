...
condition|)
block|{
name|commitCreateBucketInfoToDB
argument_list|(
name|omBucketInfo
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Apply CreateBucket Failed for bucket: {}, volume: {}"
argument_list|,
name|omBucketInfo
operator|.
name|getBucketName
...
block|}
block|}
DECL|method|commitCreateBucketInfoToDB (OmBucketInfo omBucketInfo)
specifier|private
name|void
name|commitCreateBucketInfoToDB
parameter_list|(
...
condition|)
block|{
name|commitSetBucketPropertyInfoToDB
argument_list|(
name|omBucketInfo
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Apply SetBucket property failed for bucket:{} in "
operator|+
literal|"volume:{}"
argument_list|,
name|omBucketInfo
...
block|}
block|}
DECL|method|commitSetBucketPropertyInfoToDB (OmBucketInfo omBucketInfo)
specifier|private
name|void
name|commitSetBucketPropertyInfoToDB
parameter_list|(
...
name|error
argument_list|(
literal|"Apply DeleteBucket Failed for bucket: {}, volume: {}"
argument_list|,
name|bucketName
argument_list|,
name|volumeName
