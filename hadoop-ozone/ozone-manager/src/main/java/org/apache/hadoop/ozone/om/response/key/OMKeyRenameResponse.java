...
begin_class
DECL|class|OMKeyRenameResponse
specifier|public
class|class
...
name|OMClientResponse
block|{
DECL|field|renameKeyInfo
specifier|private
specifier|final
name|OmKeyInfo
name|renameKeyInfo
decl_stmt|;
DECL|field|toKeyName
specifier|private
specifier|final
name|String
name|toKeyName
decl_stmt|;
DECL|field|fromKeyName
specifier|private
specifier|final
name|String
name|fromKeyName
...
condition|)
block|{
comment|// If both from and toKeyName are equal do nothing
if|if
condition|(
operator|!
name|toKeyName
