...
begin_comment
comment|/**  * Set acl handler for bucket.  */
end_comment
...
literal|"Set acls."
argument_list|)
DECL|class|SetAclBucketHandler
specifier|public
class|class
name|SetAclBucketHandler
extends|extends
name|Handler
block|{
annotation|@
...
name|acls
argument_list|,
literal|"Acls to be set not specified."
argument_list|)
expr_stmt|;
name|OzoneAddress
name|address
