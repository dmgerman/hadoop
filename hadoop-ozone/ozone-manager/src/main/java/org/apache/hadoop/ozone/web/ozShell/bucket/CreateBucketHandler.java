...
name|rootName
decl_stmt|;
comment|/**    * Executes create bucket.    *    * @param cmd - CommandLine    *    * @throws IOException    * @throws OzoneException    * @throws URISyntaxException    */
annotation|@
name|Override
...
name|OzoneRestClientException
argument_list|(
literal|"Incorrect call : createBucket is missing"
argument_list|)
throw|;
block|}
name|String
