...
begin_class
DECL|class|OMVolumeSetQuotaRequest
specifier|public
class|class
...
argument_list|)
decl_stmt|;
DECL|method|OMVolumeSetQuotaRequest (OMRequest omRequest)
specifier|public
name|OMVolumeSetQuotaRequest
parameter_list|(
name|OMRequest
...
comment|// when we have quota in bytes is set in setVolumePropertyRequest.
if|if
condition|(
operator|!
name|setVolumePropertyRequest
...
name|debug
argument_list|(
literal|"Changing volume quota is successfully completed for volume: "
operator|+
literal|"{} quota:{}"
argument_list|,
name|volume
