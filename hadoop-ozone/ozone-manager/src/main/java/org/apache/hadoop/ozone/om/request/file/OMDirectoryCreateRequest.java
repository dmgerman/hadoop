...
DECL|method|verifyFilesInPath ( OMMetadataManager omMetadataManager, String volumeName, String bucketName, String directoryName, Path keyPath)
specifier|private
name|OMDirectoryResult
name|verifyFilesInPath
parameter_list|(
...
name|OMDirectoryResult
block|{
DECL|enumConstant|DIRECTORY_ALREADY_EXISTS
name|DIRECTORY_ALREADY_EXISTS
block|,
DECL|enumConstant|FILE_ALREADY_EXISTS
name|FILE_ALREADY_EXISTS
block|,
DECL|enumConstant|SUB_DIRECTORY_EXISTS
name|SUB_DIRECTORY_EXISTS
block|,
