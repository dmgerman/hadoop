...
block|{
comment|// If token is null, do not set GetDelegationTokenResponse with response.
name|omRequest
operator|=
name|OMRequest
operator|.
...
literal|null
decl_stmt|;
comment|// If security is not enabled and token request is received, leader
comment|// returns token null. So, check here if updatedGetDelegationTokenResponse
comment|// has response set or not. If it is not set, then token is null.
if|if
condition|(
operator|!
name|updateGetDelegationTokenRequest
