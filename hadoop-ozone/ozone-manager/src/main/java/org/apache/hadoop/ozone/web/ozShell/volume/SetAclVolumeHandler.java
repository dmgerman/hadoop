...
begin_comment
comment|/**  * Set acl handler for volume.  */
end_comment
...
literal|"Set acls."
argument_list|)
DECL|class|SetAclVolumeHandler
specifier|public
class|class
name|SetAclVolumeHandler
extends|extends
name|Handler
block|{
annotation|@
...
literal|"y = WRITE_AC"
operator|+
literal|"Ex user:user1:rw,user:user2:a,group:hadoop:a"
argument_list|)
DECL|field|acls
specifier|private
name|String
...
name|acls
argument_list|,
literal|"New acls to be added not specified."
argument_list|)
expr_stmt|;
name|OzoneAddress
name|address
