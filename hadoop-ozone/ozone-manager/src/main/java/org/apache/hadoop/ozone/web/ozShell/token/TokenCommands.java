...
begin_comment
comment|/**  * Sub-command to group token related operations.  */
end_comment
...
name|description
operator|=
literal|"Token specific operations"
argument_list|,
name|subcommands
operator|=
block|{
...
name|class
block|,
name|RenewTokenHandler
operator|.
name|class
block|,
name|PrintTokenHandler
operator|.
name|class
block|}
argument_list|,
