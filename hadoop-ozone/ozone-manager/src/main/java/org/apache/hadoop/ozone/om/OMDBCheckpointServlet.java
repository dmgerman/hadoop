...
block|}
name|boolean
name|takeRatisSnapshot
init|=
literal|false
decl_stmt|;
name|String
name|snapshotBeforeCheckpointParam
init|=
name|request
operator|.
name|getParameter
...
condition|)
block|{
comment|// If OM follower is downloading the checkpoint, we should save a
comment|// ratis snapshot first. This step also included flushing the OM DB.
comment|// Hence, we can set flush to false.
name|flush
operator|=
literal|false
expr_stmt|;
...
name|debug
argument_list|(
literal|"Time taken to archive the checkpoint : "
operator|+
name|duration
operator|+
...
name|info
argument_list|(
literal|"Checkpoint Tar location = "
operator|+
name|checkPointTarFile
operator|.
...
argument_list|)
expr_stmt|;
comment|// Ratis snapshot index used when downloading DB checkpoint to OM follower
name|response
operator|.
name|setHeader
argument_list|(
...
name|debug
argument_list|(
literal|"Time taken to write the checkpoint to response output "
operator|+
literal|"stream: "
operator|+
name|duration
