...
name|secretManager
decl_stmt|;
comment|// TO DO: For testing purpose only, remove before commiting
DECL|field|keyPair
specifier|private
name|KeyPair
name|keyPair
...
comment|// should go through Ratis - either standalone (for non-HA) or replicated
comment|// (for HA).
name|boolean
name|omRatisEnabled
init|=
...
return|;
block|}
DECL|method|createSecretManager ( OzoneConfiguration conf)
specifier|private
name|OzoneSecretManager
name|createSecretManager
parameter_list|(
...
name|info
argument_list|(
literal|"Stopping OM secret manager"
argument_list|)
expr_stmt|;
name|secretManager
operator|.
...
name|info
argument_list|(
literal|"Starting OM secret manager"
argument_list|)
expr_stmt|;
name|secretManager
operator|.
...
name|error
argument_list|(
literal|"Error starting secret manager."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// TODO: Initialize it in contructor with implementation for certClient.
name|this
operator|.
name|certClient
operator|=
...
name|OzoneSecurityException
argument_list|(
literal|"Error reading private file for "
operator|+
...
name|println
argument_list|(
literal|"OM cannot be started in secure mode or when "
operator|+
name|OZONE_ENABLED
operator|+
...
name|error
argument_list|(
literal|"Delegation token renewal failed for dt: {}, cause: {}"
argument_list|,
name|id
operator|.
name|toString
...
name|trace
argument_list|(
literal|"Delegation token renewed for dt: {}"
argument_list|,
name|id
argument_list|)
expr_stmt|;
