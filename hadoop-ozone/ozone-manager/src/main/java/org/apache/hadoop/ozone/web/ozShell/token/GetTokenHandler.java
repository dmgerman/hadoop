...
begin_comment
comment|/**  * Executes getDelegationToken api.  */
end_comment
...
name|description
operator|=
literal|"get a delegation token."
argument_list|)
DECL|class|GetTokenHandler
specifier|public
class|class
...
name|println
argument_list|(
literal|"Error: Get delegation token operation failed. Check"
operator|+
literal|" OzoneManager logs for more details."
argument_list|)
expr_stmt|;
return|return
literal|null
