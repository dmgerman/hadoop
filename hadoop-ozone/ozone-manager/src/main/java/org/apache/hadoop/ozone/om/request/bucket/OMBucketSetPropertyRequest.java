...
begin_comment
comment|/**  * Handle SetBucketProperty Request.  */
end_comment

begin_class
DECL|class|OMBucketSetPropertyRequest
specifier|public
class|class
...
argument_list|)
decl_stmt|;
DECL|method|OMBucketSetPropertyRequest (OMRequest omRequest)
specifier|public
name|OMBucketSetPropertyRequest
parameter_list|(
name|OMRequest
...
argument_list|()
decl_stmt|;
comment|// This will never be null, on a real Ozone cluster. For tests this might
comment|// be null. using mockito, to set omMetrics object, but still getting
comment|// null. For now added this not null check.
comment|//TODO: Removed not null check from here, once tests got fixed.
if|if
condition|(
name|omMetrics
operator|!=
...
name|debug
argument_list|(
literal|"Setting bucket property for bucket:{} in volume:{}"
argument_list|,
name|bucketName
argument_list|,
name|volumeName
