...
literal|"parameternumber"
argument_list|)
DECL|method|prepareCreateKeyResponse (@onnull KeyArgs keyArgs, OmKeyInfo omKeyInfo, @Nonnull List<OmKeyLocationInfo> locations, FileEncryptionInfo encryptionInfo, @Nullable IOException exception, long clientID, long transactionLogIndex, @Nonnull String volumeName, @Nonnull String bucketName, @Nonnull String keyName, @Nonnull OzoneManager ozoneManager, @Nonnull OMAction omAction, @Nonnull PrefixManager prefixManager, @Nullable OmBucketInfo omBucketInfo)
specifier|protected
name|OMClientResponse
...
literal|"parameterNumber"
argument_list|)
DECL|method|createKeyInfo (@onnull KeyArgs keyArgs, @Nonnull List<OmKeyLocationInfo> locations, @Nonnull HddsProtos.ReplicationFactor factor, @Nonnull HddsProtos.ReplicationType type, long size, @Nullable FileEncryptionInfo encInfo, @Nonnull PrefixManager prefixManager, @Nullable OmBucketInfo omBucketInfo)
specifier|protected
name|OmKeyInfo
name|createKeyInfo
parameter_list|(
...
return|;
block|}
DECL|method|getAclsForKey (KeyArgs keyArgs, OmBucketInfo bucketInfo, PrefixManager prefixManager)
specifier|private
name|List
argument_list|<
name|OzoneAcl
...
literal|"parameternumber"
argument_list|)
DECL|method|prepareKeyInfo ( @onnull OMMetadataManager omMetadataManager, @Nonnull KeyArgs keyArgs, @Nonnull String dbKeyName, long size, @Nonnull List<OmKeyLocationInfo> locations, @Nullable FileEncryptionInfo encInfo, @Nonnull PrefixManager prefixManager, @Nullable OmBucketInfo omBucketInfo)
specifier|protected
name|OmKeyInfo
name|prepareKeyInfo
parameter_list|(
...
DECL|method|prepareMultipartKeyInfo ( @onnull OMMetadataManager omMetadataManager, @Nonnull KeyArgs args, long size, @Nonnull List<OmKeyLocationInfo> locations, FileEncryptionInfo encInfo, @Nonnull PrefixManager prefixManager, @Nullable OmBucketInfo omBucketInfo)
specifier|private
name|OmKeyInfo
name|prepareMultipartKeyInfo
parameter_list|(
...
block|}
block|}
comment|/**    * Check Acls for the ozone bucket.    * @param ozoneManager    * @param volume    * @param bucket    * @param key    * @throws IOException    */
DECL|method|checkBucketAcls (OzoneManager ozoneManager, String volume, String bucket, String key)
specifier|protected
name|void
name|checkBucketAcls
parameter_list|(
name|OzoneManager
name|ozoneManager
parameter_list|,
...
block|}
block|}
comment|/**    * Check Acls for the ozone key.    * @param ozoneManager    * @param volume    * @param bucket    * @param key    * @throws IOException    */
DECL|method|checkKeyAcls (OzoneManager ozoneManager, String volume, String bucket, String key)
specifier|protected
name|void
name|checkKeyAcls
parameter_list|(
