...
return|;
block|}
comment|/**    * Gets the Key detail information if it exists.    */
DECL|method|getKeyInfoDetail (KeyArgs args)
specifier|private
name|Response
name|getKeyInfoDetail
parameter_list|(
...
return|;
block|}
comment|/**    * Renames an existing key within a bucket.    *    * @param volume      Storage Volume Name    * @param bucket      Name of the bucket    * @param key         Name of the Object    * @param toKeyName   New name of the Object    * @param req         http Request    * @param info        UriInfo    * @param headers     HttpHeaders    * @return Response    * @throws OzoneException    */
annotation|@
name|Override
DECL|method|renameKey (String volume, String bucket, String key, String toKeyName, Request req, UriInfo info, HttpHeaders headers)
specifier|public
name|Response
name|renameKey
parameter_list|(
