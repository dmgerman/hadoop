...
begin_comment
comment|/**  * The minimal Ozone Filesystem implementation.  *<p>  * This is a basic version which doesn't extend  * KeyProviderTokenIssuer and doesn't include statistics. It can be used  * from older hadoop version. For newer hadoop version use the full featured  * OzoneFileSystem.  */
end_comment
...
operator|.
name|Evolving
DECL|class|BasicOzoneFileSystem
specifier|public
class|class
...
parameter_list|)
block|{
comment|//don't do anyting in this default implementation.
block|}
annotation|@
name|Override
...
return|;
block|}
DECL|method|createOutputStream (String key, boolean overwrite, boolean recursive)
specifier|private
name|FSDataOutputStream
name|createOutputStream
parameter_list|(
...
expr_stmt|;
block|}
comment|// listStatus returns entries numEntries in size if available.
comment|// Any lesser number of entries indicate that the required entries have
comment|// exhausted.
block|}
do|while
condition|(
...
return|;
block|}
comment|/**    * Creates a directory. Directory is represented using a key with no value.    *    * @param path directory path to be created    * @return true if directory exists or created successfully.    * @throws IOException    */
...
return|;
block|}
DECL|method|isEmpty (CharSequence cs)
specifier|public
name|boolean
name|isEmpty
parameter_list|(
...
return|;
block|}
DECL|method|isNumber (String number)
specifier|public
name|boolean
name|isNumber
parameter_list|(
...
return|;
block|}
DECL|method|convertFileStatus ( FileStatusAdapter fileStatusAdapter)
specifier|private
name|FileStatus
name|convertFileStatus
parameter_list|(
...
parameter_list|)
block|{
comment|//NOOP: If not symlink symlink remains null.
block|}
return|return
operator|new
name|FileStatus
