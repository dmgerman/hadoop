...
expr_stmt|;
block|}
comment|/**    * Interface to create OzoneClientAdapter implementation with reflection.    */
annotation|@
name|FunctionalInterface
DECL|interface|OzoneClientAdapterCreator
interface|interface
name|OzoneClientAdapterCreator
block|{
DECL|method|createOzoneClientAdapter (Class<?> clientAdapter)
name|OzoneClientAdapter
name|createOzoneClientAdapter
parameter_list|(
name|Class
