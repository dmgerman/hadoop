...
begin_comment
comment|/**  * A DT fetcher for OzoneFileSystem.  * It is only needed for the `hadoop dtutil` command.  */
end_comment

begin_class
DECL|class|O3fsDtFetcher
specifier|public
class|class
name|O3fsDtFetcher
...
name|FETCH_FAILED
init|=
literal|"Fetch ozone delegation token failed"
decl_stmt|;
comment|/**    * Returns the service name for O3fs, which is also a valid URL prefix.    */
...
name|debug
argument_list|(
literal|"addDelegationTokens from {} renewer {}."
argument_list|,
name|url
argument_list|,
name|renewer
