...
block|}
block|}
DECL|method|generateResourceLockName (OzoneManagerLock.Resource resource)
specifier|private
name|String
name|generateResourceLockName
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Since the new thread is trying to get lock on same volume,
...
argument_list|)
expr_stmt|;
comment|// Since the new thread is trying to get lock on same volume, it will wait.
name|Assert
operator|.
name|assertFalse
argument_list|(
