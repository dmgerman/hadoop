...
name|IOException
function_decl|;
comment|/**    * Gets s3Secret for given kerberos user.    * @param kerberosID    * @return S3SecretValue    * @throws IOException    */
...
DECL|method|getDBUpdates ( OzoneManagerProtocolProtos.DBUpdatesRequest dbUpdatesRequest)
name|DBUpdatesWrapper
name|getDBUpdates
parameter_list|(
name|OzoneManagerProtocolProtos
