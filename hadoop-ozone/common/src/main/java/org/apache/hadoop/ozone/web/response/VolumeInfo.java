...
begin_comment
comment|/**  * VolumeInfo Class is the Java class that represents  * Json when VolumeInfo Call is made.  */
end_comment
...
argument_list|>
block|{
DECL|field|VOLUME_INFO
specifier|static
specifier|final
name|String
name|VOLUME_INFO
init|=
literal|"VOLUME_INFO_FILTER"
decl_stmt|;
DECL|field|READER
specifier|private
specifier|static
...
expr_stmt|;
block|}
comment|/**    * Custom Json Filter Class.    */
annotation|@
name|JsonFilter
argument_list|(
name|VOLUME_INFO
...
expr_stmt|;
block|}
comment|/**    * Returns a JSON string of this object.    * After stripping out bytesUsed and bucketCount    *    * @return String - json string    * @throws IOException    */
...
return|;
block|}
comment|/**    * Gets the number of bytesUsed by this volume.    *    * @return long - Bytes used    */
...
return|;
block|}
comment|/**    * Sets number of bytesUsed by this volume.    *    * @param bytesUsed - Number of bytesUsed    */
...
return|;
block|}
comment|/**    * Total number of buckets under this volume.    *    * @return - bucketCount    */
...
return|;
block|}
comment|/**    * Sets the buckets count.    *    * @param bucketCount - Bucket Count    */
DECL|method|setBucketCount (long bucketCount)
specifier|public
name|void
name|setBucketCount
parameter_list|(
