...
begin_class
DECL|class|OmMultipartUploadCompleteList
specifier|public
class|class
...
name|multipartMap
decl_stmt|;
comment|/**    * Construct OmMultipartUploadCompleteList which holds multipart map which    * contains part number and part name.    * @param partMap    */
DECL|method|OmMultipartUploadCompleteList (Map<Integer, String> partMap)
specifier|public
name|OmMultipartUploadCompleteList
parameter_list|(
name|Map
