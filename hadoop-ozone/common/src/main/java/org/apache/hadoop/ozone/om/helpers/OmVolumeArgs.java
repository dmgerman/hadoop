...
name|updateID
decl_stmt|;
comment|/**    * Set the Object ID. If this value is already set then this function throws.    * There is a reason why we cannot use the final here. The OmVolumeArgs is    * deserialized from the protobuf in many places in code. We need to set    * this object ID, after it is deserialized.    *    * @param obId - long    */
DECL|method|setObjectID (long obId)
specifier|public
name|void
name|setObjectID
parameter_list|(
...
argument_list|(
literal|"Attempt to modify object ID "
operator|+
literal|"which is not zero. Current Object ID is "
operator|+
name|this
operator|.
name|objectID
...
expr_stmt|;
block|}
comment|/**    * Returns a monotonically increasing ID, that denotes the last update.    * Each time an update happens, this ID is incremented.    * @return long    */
...
return|;
block|}
comment|/**    * Sets the update ID. For each modification of this object, we will set    * this to a value greater than the current value.    * @param updateID  long    */
...
expr_stmt|;
block|}
comment|/**    * A immutable identity field for this object.    * @return  long.    */
...
block|,
literal|"This is invoked from a "
operator|+
literal|"builder."
block|}
argument_list|)
DECL|method|OmVolumeArgs (String adminName, String ownerName, String volume, long quotaInBytes, Map<String, String> metadata, OmOzoneAclMap aclMap, long creationTime, long objectID, long updateID)
specifier|private
name|OmVolumeArgs
parameter_list|(
name|String
...
name|updateID
decl_stmt|;
comment|/**      * Sets the Object ID for this Object.      * Object ID are unique and immutable identifier for each object in the      * System.      * @param objectID - long      */
DECL|method|setObjectID (long objectID)
specifier|public
name|void
name|setObjectID
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Sets the update ID for this Object. Update IDs are monotonically      * increasing values which are updated each time there is an update.      * @param updateID - long      */
DECL|method|setUpdateID (long updateID)
specifier|public
name|void
name|setUpdateID
