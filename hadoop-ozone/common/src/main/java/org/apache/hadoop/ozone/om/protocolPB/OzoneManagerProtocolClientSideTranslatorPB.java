...
name|IOException
argument_list|(
literal|"List Multipart upload parts failed, error: "
operator|+
name|response
operator|.
name|getStatus
...
name|OMException
argument_list|(
literal|"Get delegation token failed with response:"
operator|+
name|resp
operator|.
name|getStatus
...
name|OMException
argument_list|(
literal|"Renew delegation token failed with response:"
operator|+
name|resp
operator|.
name|getStatus
...
name|OMException
argument_list|(
literal|"Cancel delegation token failed with response:"
operator|+
name|resp
operator|.
name|getStatus
...
block|}
block|}
comment|/**    * Converts proto status to OMException result code.    *    * @param status Proto status received from rpc call.    */
DECL|method|toResultStatus (Status status)
specifier|public
name|ResultCodes
name|toResultStatus
parameter_list|(
