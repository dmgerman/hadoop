...
DECL|method|generateResourceName (Resource resource, String... resources)
specifier|private
name|String
name|generateResourceName
parameter_list|(
...
argument_list|(
literal|"acquire lock is supported on single"
operator|+
literal|" resource for all locks except for resource bucket"
argument_list|)
throw|;
block|}
block|}
