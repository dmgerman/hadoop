...
return|;
block|}
comment|/**    * Default implementation for Ozone. Verifies if hash in token is legit.    * */
annotation|@
name|Override
...
argument_list|)
decl_stmt|;
comment|// TODO: Revisit this when key/certificate rotation is implemented.
comment|// i.e Try all valid keys instead of current key only.
if|if
condition|(
operator|!
...
DECL|method|verifySignature (T identifier, byte[] password)
specifier|public
name|boolean
name|verifySignature
parameter_list|(
...
return|;
block|}
comment|/**    * Should be called before this object is used.    *    * @param keyPair    * @throws IOException    */
