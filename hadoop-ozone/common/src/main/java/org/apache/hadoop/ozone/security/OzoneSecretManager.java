...
DECL|field|DEFAULT_SIGNATURE_ALGORITHM
specifier|private
specifier|static
specifier|final
name|String
...
DECL|method|OzoneSecretManager (OzoneConfiguration conf, long tokenMaxLifetime, long tokenRenewInterval, long dtRemoverScanInterval, Text service)
specifier|public
name|OzoneSecretManager
parameter_list|(
name|OzoneConfiguration
...
return|;
block|}
comment|/**    * Validates if given token is valid.    *    * @param identifier    * @param password    */
DECL|method|validateToken (T identifier, byte[] password)
specifier|private
name|boolean
name|validateToken
parameter_list|(
...
DECL|method|checkToken (T identifier)
specifier|public
name|TokenInfo
name|checkToken
parameter_list|(
...
DECL|method|startThreads (KeyPair keyPair)
specifier|public
name|void
name|startThreads
parameter_list|(
...
block|}
block|}
comment|/**    * Stops the OzoneSecretManager.    *    * @throws IOException    */
DECL|method|stop ()
specifier|public
name|void
name|stop
...
block|}
block|}
comment|/**    * Update the current master key. This is called once by startThreads before    * tokenRemoverThread is created,    */
...
DECL|method|getTokenExpiryTime (T dtId)
specifier|public
name|long
