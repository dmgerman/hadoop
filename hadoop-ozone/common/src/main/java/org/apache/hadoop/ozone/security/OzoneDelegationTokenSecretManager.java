...
return|;
block|}
comment|/**    * Add delegation token in to in-memory map of tokens.    * @param token    * @param ozoneTokenIdentifier    * @return renewTime - If updated successfully, return renewTime.    */
DECL|method|updateToken (Token<OzoneTokenIdentifier> token, OzoneTokenIdentifier ozoneTokenIdentifier)
specifier|public
name|long
name|updateToken
parameter_list|(
...
DECL|method|addToTokenStore (OzoneTokenIdentifier identifier, byte[] password, long renewTime)
specifier|private
name|void
name|addToTokenStore
parameter_list|(
