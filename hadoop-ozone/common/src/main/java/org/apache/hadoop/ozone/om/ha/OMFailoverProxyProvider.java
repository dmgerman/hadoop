...
name|ugi
decl_stmt|;
DECL|field|delegationTokenService
specifier|private
specifier|final
name|Text
...
name|delegationTokenService
operator|=
name|computeDelegationTokenService
argument_list|()
expr_stmt|;
name|currentProxyIndex
operator|=
...
return|;
block|}
DECL|method|computeDelegationTokenService ()
specifier|private
name|Text
name|computeDelegationTokenService
parameter_list|()
block|{
comment|// For HA, this will return "," separated address of all OM's.
name|StringBuilder
name|rpcAddress
init|=
operator|new
