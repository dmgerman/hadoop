...
name|factor
decl_stmt|;
DECL|method|KsmKeyInfo (String volumeName, String bucketName, String keyName, List<KsmKeyLocationInfoGroup> versions, long dataSize, long creationTime, long modificationTime, HddsProtos.ReplicationType type, HddsProtos.ReplicationFactor factor)
specifier|private
name|KsmKeyInfo
parameter_list|(
name|String
