...
annotation|@
name|Inject
DECL|method|ReconOmMetadataManagerImpl (OzoneConfiguration configuration, ReconUtils reconUtils)
specifier|public
name|ReconOmMetadataManagerImpl
parameter_list|(
name|OzoneConfiguration
...
name|info
argument_list|(
literal|"Last known snapshot for OM : {}"
argument_list|,
name|lastKnownOMSnapshot
operator|.
...
name|info
argument_list|(
literal|"Created OM DB snapshot at {}."
argument_list|,
name|dbFile
operator|.
name|getAbsolutePath
