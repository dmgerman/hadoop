...
annotation|@
name|Inject
DECL|method|ReconTaskControllerImpl (OzoneConfiguration configuration, Configuration sqlConfiguration, Set<ReconDBUpdateTask> tasks)
specifier|public
name|ReconTaskControllerImpl
parameter_list|(
name|OzoneConfiguration
...
expr_stmt|;
block|}
comment|// Reprocess the failed tasks.
...
block|}
block|}
comment|/**    * Store the last completed event sequence number and timestamp to the DB    * for that task.    * @param taskName taskname to be updated.    * @param lastSequenceNumber contains the new sequence number.    */
DECL|method|storeLastCompletedTransaction ( String taskName, long lastSequenceNumber)
specifier|private
name|void
