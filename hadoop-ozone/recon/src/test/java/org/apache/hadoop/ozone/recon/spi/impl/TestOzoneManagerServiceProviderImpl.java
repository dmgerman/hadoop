...
begin_comment
comment|/**  * Mock OzoneManagerServiceProviderImpl which overrides  * updateReconOmDBWithNewSnapshot.  */
end_comment

begin_class
DECL|class|MockOzoneServiceProvider
class|class
name|MockOzoneServiceProvider
extends|extends
name|OzoneManagerServiceProviderImpl
block|{
DECL|method|MockOzoneServiceProvider (OzoneConfiguration configuration, ReconOMMetadataManager omMetadataManager, ReconTaskController reconTaskController, ReconUtils reconUtils, OzoneManagerProtocol ozoneManagerClient)
name|MockOzoneServiceProvider
parameter_list|(
name|OzoneConfiguration
name|configuration
