...
expr_stmt|;
block|}
comment|/**    * Append another ChunkInputStreamEntry to the end of the list.    * The stream will be constructed from the input information when it needs    * to be accessed.    */
DECL|method|addStream (OmKeyLocationInfo omKeyLocationInfo, XceiverClientManager xceiverClientMngr, String clientRequestId, boolean verifyChecksum)
specifier|private
specifier|synchronized
name|void
name|addStream
...
expr_stmt|;
block|}
DECL|method|getStreamEntry (int index)
specifier|private
specifier|synchronized
name|ChunkInputStreamEntry
name|getStreamEntry
...
name|verifyChecksum
decl_stmt|;
comment|// the position of the blockInputStream is maintained by this variable
comment|// till the stream is initialized
DECL|field|position
specifier|private
name|long
name|position
decl_stmt|;
DECL|method|ChunkInputStreamEntry (OmKeyLocationInfo omKeyLocationInfo, XceiverClientManager xceiverClientMngr, String clientRequestId, boolean verifyChecksum)
specifier|public
name|ChunkInputStreamEntry
parameter_list|(
name|OmKeyLocationInfo
...
condition|)
block|{
name|initializeBlockInputStream
argument_list|()
expr_stmt|;
block|}
return|return
...
return|;
block|}
DECL|method|initializeBlockInputStream ()
specifier|private
name|void
name|initializeBlockInputStream
parameter_list|()
...
name|debug
argument_list|(
literal|"Initializing stream for get key to access {} {}"
argument_list|,
name|containerID
argument_list|,
name|containerKey
