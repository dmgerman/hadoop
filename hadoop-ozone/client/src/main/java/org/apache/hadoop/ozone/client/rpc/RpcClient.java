...
argument_list|()
expr_stmt|;
comment|// Get default acl rights for user and group.
name|OzoneAclConfig
name|aclConfig
init|=
name|this
...
name|IOException
block|{
comment|// Set acls of current user.
name|createBucket
argument_list|(
name|volumeName
argument_list|,
...
operator|+
literal|"Storage Type set to {} and Encryption set to {} "
argument_list|,
name|volumeName
argument_list|,
name|bucketName
...
expr_stmt|;
block|}
comment|/**    * Helper function to get default acl list for current user.    *    * @return listOfAcls    * */
...
name|debug
argument_list|(
literal|"Created token {} for dtService {}"
argument_list|,
name|token
argument_list|,
name|dtService
...
expr_stmt|;
block|}
comment|/**    * Returns s3 secret given a kerberos user.    * @param kerberosID    * @return S3SecretValue    * @throws IOException    */
annotation|@
name|Override
...
name|contains
argument_list|(
literal|"Illegal key size or default parameters"
argument_list|)
condition|)
block|{
name|LOG
...
name|error
argument_list|(
literal|"Missing Unlimited Strength Policy jars. Please install "
operator|+
literal|"Java Cryptography Extension (JCE) Unlimited Strength "
operator|+
literal|"Jurisdiction Policy Files"
argument_list|)
expr_stmt|;
block|}
throw|throw
...
return|;
block|}
DECL|method|getDEK (FileEncryptionInfo feInfo)
specifier|private
name|KeyProvider
operator|.
name|KeyVersion
...
name|IOException
block|{
comment|// check crypto protocol version
name|OzoneKMSUtil
operator|.
...
literal|"Part "
operator|+
literal|"number should be greater than zero and less than or equal to 10000"
argument_list|)
expr_stmt|;
name|Preconditions
operator|.
...
operator|+
literal|"Should be greater than or equal to zero, as part numbers starts from"
operator|+
literal|" 1 and ranges till 10000"
argument_list|)
expr_stmt|;
name|OmMultipartUploadListParts
name|omMultipartUploadListParts
...
return|;
block|}
DECL|method|createOutputStream (OpenKeySession openKey, String requestId, ReplicationType type, ReplicationFactor factor)
specifier|private
name|OzoneOutputStream
name|createOutputStream
parameter_list|(
