...
block|}
block|}
comment|/**    * Get a valid Delegation Token. Not supported for RestClient.    *    * @param renewer the designated renewer for the token    * @return Token<OzoneDelegationTokenSelector>    * @throws IOException    */
annotation|@
name|Override
...
throw|;
block|}
comment|/**    * Renew an existing delegation token. Not supported for RestClient.    *    * @param token delegation token obtained earlier    * @return the new expiration time    * @throws IOException    */
annotation|@
name|Override
...
throw|;
block|}
comment|/**    * Cancel an existing delegation token. Not supported for RestClient.    *    * @param token delegation token    * @throws IOException    */
annotation|@
name|Override
