...
name|listCacheSize
decl_stmt|;
comment|/**    * Constructs OzoneVolume instance.    * @param conf Configuration object.    * @param proxy ClientProtocol proxy.    * @param name Name of the volume.    * @param admin Volume admin.    * @param owner Volume owner.    * @param quotaInBytes Volume quota in bytes.    * @param creationTime creation time of the volume    * @param acls ACLs associated with the volume.    * @param metadata custom key value metadata.    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"parameternumber"
argument_list|)
DECL|method|OzoneVolume (Configuration conf, ClientProtocol proxy, String name, String admin, String owner, long quotaInBytes, long creationTime, List<OzoneAcl> acls, Map<String, String> metadata)
specifier|public
name|OzoneVolume
parameter_list|(
name|Configuration
...
annotation|@
name|VisibleForTesting
DECL|method|OzoneVolume (String name, String admin, String owner, long quotaInBytes, long creationTime, List<OzoneAcl> acls)
specifier|protected
name|OzoneVolume
parameter_list|(
name|String
