...
name|creationTime
decl_stmt|;
comment|/**    * Bucket Encryption key name if bucket encryption is enabled.    */
...
name|ozoneObj
decl_stmt|;
DECL|method|OzoneBucket (Configuration conf, String volumeName, String bucketName, ReplicationFactor defaultReplication, ReplicationType defaultReplicationType, ClientProtocol proxy)
specifier|private
name|OzoneBucket
parameter_list|(
name|Configuration
...
argument_list|)
DECL|method|OzoneBucket (Configuration conf, ClientProtocol proxy, String volumeName, String bucketName, StorageType storageType, Boolean versioning, long creationTime, Map<String, String> metadata, String encryptionKeyName)
specifier|public
name|OzoneBucket
parameter_list|(
name|Configuration
...
expr_stmt|;
block|}
comment|/**    * Constructs OzoneBucket instance.    * @param conf Configuration object.    * @param proxy ClientProtocol proxy.    * @param volumeName Name of the volume the bucket belongs to.    * @param bucketName Name of the bucket.    * @param storageType StorageType of the bucket.    * @param versioning versioning status of the bucket.    * @param creationTime creation time of the bucket.    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"parameternumber"
argument_list|)
DECL|method|OzoneBucket (Configuration conf, ClientProtocol proxy, String volumeName, String bucketName, StorageType storageType, Boolean versioning, long creationTime, Map<String, String> metadata)
specifier|public
name|OzoneBucket
parameter_list|(
name|Configuration
...
literal|"parameternumber"
argument_list|)
DECL|method|OzoneBucket (String volumeName, String name, ReplicationFactor defaultReplication, ReplicationType defaultReplicationType, StorageType storageType, Boolean versioning, long creationTime)
name|OzoneBucket
parameter_list|(
name|String
name|volumeName
...
return|;
block|}
comment|/**    * Return the bucket encryption key name.    * @return the bucket encryption key name    */
...
return|;
block|}
comment|/**    * Adds ACLs to the Bucket.    * @param addAcl ACL to be added    * @return true - if acl is successfully added, false if acl already exists    * for the bucket.    * @throws IOException    */
DECL|method|addAcls (OzoneAcl addAcl)
specifier|public
name|boolean
name|addAcls
parameter_list|(
...
return|;
block|}
comment|/**    * Removes ACLs from the bucket.    * @return true - if acl is successfully removed, false if acl to be    * removed does not exist for the bucket.    * @throws IOException    */
DECL|method|removeAcls (OzoneAcl removeAcl)
specifier|public
name|boolean
name|removeAcls
parameter_list|(
...
return|;
block|}
comment|/**    * OzoneFS api to get file status for an entry.    *    * @param keyName Key name    * @throws OMException if file does not exist    *                     if bucket does not exist    * @throws IOException if there is error in the db    *                     invalid arguments    */
DECL|method|getFileStatus (String keyName)
specifier|public
name|OzoneFileStatus
name|getFileStatus
parameter_list|(
...
return|;
block|}
comment|/**    * Ozone FS api to create a directory. Parent directories if do not exist    * are created for the input directory.    *    * @param keyName Key name    * @throws OMException if any entry in the path exists as a file    *                     if bucket does not exist    * @throws IOException if there is error in the db    *                     invalid arguments    */
...
expr_stmt|;
block|}
comment|/**    * OzoneFS api to creates an input stream for a file.    *    * @param keyName Key name    * @throws OMException if given key is not found or it is not a file    *                     if bucket does not exist    * @throws IOException if there is error in the db    *                     invalid arguments    */
DECL|method|readFile (String keyName)
specifier|public
name|OzoneInputStream
name|readFile
parameter_list|(
...
return|;
block|}
comment|/**    * OzoneFS api to creates an output stream for a file.    *    * @param keyName   Key name    * @param overWrite if true existing file at the location will be overwritten    * @param recursive if true file would be created even if parent directories    *                    do not exist    * @throws OMException if given key is a directory    *                     if file exists and isOverwrite flag is false    *                     if an ancestor exists as a file    *                     if bucket does not exist    * @throws IOException if there is error in the db    *                     invalid arguments    */
DECL|method|createFile (String keyName, long size, ReplicationType type, ReplicationFactor factor, boolean overWrite, boolean recursive)
specifier|public
name|OzoneOutputStream
name|createFile
parameter_list|(
...
return|;
block|}
comment|/**    * List the status for a file or a directory and its contents.    *    * @param keyName    Absolute path of the entry to be listed    * @param recursive  For a directory if true all the descendants of a    *                   particular directory are listed    * @param startKey   Key from which listing needs to start. If startKey exists    *                   its status is included in the final list.    * @param numEntries Number of entries to list from the start key    * @return list of file status    */
