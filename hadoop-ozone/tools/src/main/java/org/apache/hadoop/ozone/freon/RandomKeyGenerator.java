...
name|digest
decl_stmt|;
comment|/**      * Constructs a new ozone keyValidate.      *      * @param bucket    bucket part      * @param keyName   key part      * @param keyName   digest of this key's full value      */
...
name|volumeName
decl_stmt|;
DECL|method|VolumeProcessor (String volumeName)
name|VolumeProcessor
parameter_list|(
name|String
name|volumeName
...
name|bucketName
decl_stmt|;
DECL|method|BucketProcessor (OzoneVolume volume, String bucketName)
name|BucketProcessor
parameter_list|(
name|OzoneVolume
name|volume
...
name|keyName
decl_stmt|;
DECL|method|KeyProcessor (OzoneBucket bucket, String keyName)
name|KeyProcessor
parameter_list|(
name|OzoneBucket
name|bucket
