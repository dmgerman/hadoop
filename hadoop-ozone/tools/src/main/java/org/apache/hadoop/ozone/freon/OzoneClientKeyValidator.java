...
name|aliases
operator|=
literal|"ozone-client-key-validator"
argument_list|,
name|description
operator|=
literal|"Validate keys with the help of the ozone clients."
argument_list|,
...
literal|true
argument_list|)
DECL|class|OzoneClientKeyValidator
specifier|public
class|class
name|OzoneClientKeyValidator
extends|extends
...
name|description
operator|=
literal|"Name of the bucket which contains the test data."
argument_list|,
name|defaultValue
operator|=
literal|"bucket1"
