...
expr_stmt|;
block|}
comment|/**    * Test that if no OM address is specified, then the OM rpc server    * is started on localhost.    */
annotation|@
name|Test
DECL|method|testNoConfiguredOMAddress ()
specifier|public
name|void
name|testNoConfiguredOMAddress
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**    * Test that if only the hostname is specified for om address, then the    * default port is used.    */
annotation|@
name|Test
DECL|method|testDefaultPortIfNotSpecified ()
specifier|public
name|void
name|testDefaultPortIfNotSpecified
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Set omNode1 as the current node. omNode1 address does not have a port
comment|// number specified. So the default port should be taken.
name|conf
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Verify that the 2nd OMs address stored in the current OM also has the
comment|// default port as the port is not specified
name|InetSocketAddress
name|omNode2Addr
init|=
name|om
