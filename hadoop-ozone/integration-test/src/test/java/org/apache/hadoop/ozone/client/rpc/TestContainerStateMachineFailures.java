...
argument_list|)
decl_stmt|;
comment|/**      * Ensure length of data stored in key is equal to number of bytes written.      */
name|Assert
operator|.
name|assertTrue
argument_list|(
literal|"Number of bytes stored in the key is not equal "
operator|+
literal|"to number of bytes written."
argument_list|,
name|keyDetails
operator|.
name|getDataSize
...
argument_list|)
expr_stmt|;
comment|/**      * Pending data from the second write should get written to a new container      * during key.close() because the first container is UNHEALTHY by that time      */
name|Assert
operator|.
name|assertTrue
argument_list|(
literal|"Expect Key to be stored in 2 separate containers"
argument_list|,
name|keyDetails
operator|.
