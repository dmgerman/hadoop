...
expr_stmt|;
block|}
comment|/**    * Test datanode heartbeat well processed with a 4-layer network topology.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
literal|60000
argument_list|)
DECL|method|testScmProcessDatanodeHeartbeat ()
specifier|public
name|void
name|testScmProcessDatanodeHeartbeat
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// verify datanode heartbeats are well processed
name|long
...
literal|"unchecked"
argument_list|)
DECL|method|testCloseContainerCommandOnRestart ()
specifier|public
name|void
name|testCloseContainerCommandOnRestart
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
operator|new
name|CloseContainerCommandMatcher
argument_list|(
name|dnUuid
argument_list|,
name|commandForDatanode
...
argument_list|)
DECL|class|CloseContainerCommandMatcher
specifier|static
class|class
name|CloseContainerCommandMatcher
extends|extends
...
name|uuid
decl_stmt|;
DECL|method|CloseContainerCommandMatcher (UUID uuid, CommandForDatanode cmd)
name|CloseContainerCommandMatcher
parameter_list|(
name|UUID
name|uuid
