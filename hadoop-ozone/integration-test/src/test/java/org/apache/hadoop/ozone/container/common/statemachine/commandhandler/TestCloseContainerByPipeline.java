...
name|keyName
init|=
literal|"testIfCloseContainerCommandHandlerIsInvoked"
decl_stmt|;
name|OzoneOutputStream
name|key
init|=
...
argument_list|)
expr_stmt|;
comment|// Send the order to close the container, give random pipeline id so that
comment|// the container will not be closed via RATIS
name|cluster
operator|.
name|getStorageContainerManager
argument_list|()
...
comment|// TODO: change the below line after implementing QUASI_CLOSED to CLOSED
comment|// logic. The container will be QUASI closed as of now
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Pipeline close should not affect a container in CLOSED state
name|Assert
operator|.
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Make sure that it is CLOSED
for|for
control|(
name|DatanodeDetails
name|datanodeDetails
...
annotation|@
name|Test
DECL|method|testQuasiCloseTransitionViaRatis ()
specifier|public
name|void
name|testQuasiCloseTransitionViaRatis
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|keyName
init|=
literal|"testQuasiCloseTransitionViaRatis"
decl_stmt|;
name|OzoneOutputStream
name|key
init|=
...
argument_list|)
expr_stmt|;
comment|// All the containers in OPEN or CLOSING state should transition to
comment|// QUASI-CLOSED after pipeline close
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Send close container command from SCM to datanode with forced flag as
comment|// true
name|cluster
operator|.
name|getStorageContainerManager
...
return|;
block|}
DECL|method|isContainerQuasiClosed (MiniOzoneCluster miniCluster, long containerID, DatanodeDetails datanode)
specifier|private
name|Boolean
name|isContainerQuasiClosed
parameter_list|(
