...
annotation|@
name|Test
DECL|method|testCloseContainerViaStandaAlone ()
specifier|public
name|void
name|testCloseContainerViaStandaAlone
parameter_list|()
throws|throws
name|IOException
throws|,
...
condition|)
block|{
comment|// make sure the closeContainerHandler on the Datanode is invoked
name|Assert
operator|.
name|assertTrue
argument_list|(
