...
literal|60000
argument_list|)
DECL|method|testDeleteContainerRequestHandlerOnClosedContainer ()
specifier|public
name|void
name|testDeleteContainerRequestHandlerOnClosedContainer
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// get containerID of the key
name|ContainerID
name|containerId
init|=
name|getContainerID
...
comment|// on closed containers with force flag set to false.
name|HddsDatanodeService
name|hddsDatanodeService
init|=
name|cluster
...
argument_list|)
expr_stmt|;
comment|// send delete container to the datanode
name|nodeManager
operator|.
name|addDatanodeCommand
argument_list|(
...
annotation|@
name|Test
DECL|method|testDeleteContainerRequestHandlerOnOpenContainer ()
specifier|public
name|void
name|testDeleteContainerRequestHandlerOnOpenContainer
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Send delete container command with force flag set to false.
name|nodeManager
operator|.
name|addDatanodeCommand
argument_list|(
...
literal|1
decl_stmt|;
comment|// Checking for 5 seconds, whether it is containerSet, as after command
...
argument_list|)
expr_stmt|;
comment|// Now delete container with force flag set to true. now it should delete
comment|// container
name|nodeManager
operator|.
name|addDatanodeCommand
...
expr_stmt|;
block|}
comment|/**    * create a key with specified name.    * @param keyName    * @throws IOException    */
...
expr_stmt|;
block|}
comment|/**    * Return containerID of the key.    * @param keyName    * @return ContainerID    * @throws IOException    */
DECL|method|getContainerID (String keyName)
specifier|private
name|ContainerID
name|getContainerID
parameter_list|(
