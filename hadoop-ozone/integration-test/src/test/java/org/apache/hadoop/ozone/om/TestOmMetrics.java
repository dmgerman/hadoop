...
argument_list|)
expr_stmt|;
comment|// As last call for volumesOps does not increment numVolumes as those are
comment|// failed.
name|assertCounter
argument_list|(
literal|"NumVolumes"
...
name|Ignore
argument_list|(
literal|"Test failing because of table cache. Revisit later."
argument_list|)
...
argument_list|)
expr_stmt|;
comment|//Taking already existing value, as the same metrics is used over all the
comment|// test cases.
name|long
name|numVolumesOps
init|=
...
name|assertCounter
argument_list|(
literal|"NumInitiateMultipartUploads"
argument_list|,
literal|1L
argument_list|,
name|omMetrics
...
name|assertCounter
argument_list|(
literal|"NumInitiateMultipartUploadFails"
argument_list|,
literal|1L
argument_list|,
name|omMetrics
