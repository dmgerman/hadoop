...
annotation|@
name|Test
DECL|method|testOzoneContainerStart ()
specifier|public
name|void
name|testOzoneContainerStart
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Container cannot be deleted because force flag is set to false and
comment|// the container is still open
name|request
operator|=
name|ContainerTestHelper
operator|.
...
argument_list|)
expr_stmt|;
comment|// Container can be deleted, by setting force flag, even with out closing
name|request
operator|=
name|ContainerTestHelper
operator|.
