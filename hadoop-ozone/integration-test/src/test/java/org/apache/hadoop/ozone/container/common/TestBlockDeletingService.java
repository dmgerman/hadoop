...
DECL|method|createToDeleteBlocks (ContainerSet containerSet, Configuration conf, int numOfContainers, int numOfBlocksPerContainer, int numOfChunksPerBlock, File chunkDir)
specifier|private
name|void
...
comment|// TODO : Implement deleteTransactionID in ContainerData.
comment|//    Assert.assertEquals(0, transactionId);
