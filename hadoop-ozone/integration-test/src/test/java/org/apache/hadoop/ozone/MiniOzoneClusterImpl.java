...
name|error
argument_list|(
literal|"Exception while trying to shutdown datanodes:"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|stopDatanodes ( Collection<HddsDatanodeService> hddsDatanodes)
specifier|private
specifier|static
name|void
name|stopDatanodes
...
name|info
argument_list|(
literal|"Stopping the HddsDatanodes"
argument_list|)
expr_stmt|;
name|hddsDatanodes
operator|.
...
block|}
block|}
DECL|method|stopDatanode (HddsDatanodeService dn)
specifier|private
specifier|static
name|void
name|stopDatanode
...
block|}
block|}
DECL|method|stopSCM (StorageContainerManager scm)
specifier|private
specifier|static
name|void
name|stopSCM
...
block|}
block|}
DECL|method|stopOM (OzoneManager om)
specifier|private
specifier|static
name|void
name|stopOM
...
expr_stmt|;
block|}
DECL|method|removeConfiguration ()
name|void
name|removeConfiguration
parameter_list|()
block|{
