...
expr_stmt|;
block|}
comment|/**      * Return an available TCP port if available.      *<p>      * As we have a static counter the port should be unique inside the JVM..      */
DECL|method|findPort ()
specifier|private
name|int
name|findPort
parameter_list|()
...
parameter_list|)
block|{
comment|//port is not available, let's try the next one.
continue|continue;
block|}
block|}
throw|throw
...
argument_list|(
literal|"No available port"
argument_list|)
throw|;
block|}
DECL|method|configureHddsDatanodes (OzoneConfiguration dnConf)
specifier|private
name|void
name|configureHddsDatanodes
parameter_list|(
