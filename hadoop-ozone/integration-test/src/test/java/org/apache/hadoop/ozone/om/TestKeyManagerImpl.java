...
argument_list|()
decl_stmt|;
comment|// As now openKey will allocate at least one block, even if the size
comment|// passed is 0. So adding an entry to openKeyTable manually to test
comment|// allocateBlock failure.
name|OmKeyInfo
name|omKeyInfo
init|=
operator|new
...
annotation|@
name|Test
DECL|method|testCheckAccessForFileKey ()
specifier|public
name|void
name|testCheckAccessForFileKey
parameter_list|()
throws|throws
name|Exception
block|{
...
name|setKeyName
argument_list|(
literal|"testdir/deep/NOTICE.txt"
argument_list|)
operator|.
name|build
argument_list|()
...
annotation|@
name|Test
DECL|method|testCheckAccessForNonExistentKey ()
specifier|public
name|void
name|testCheckAccessForNonExistentKey
parameter_list|()
throws|throws
name|Exception
block|{
...
name|setKeyName
argument_list|(
literal|"testdir/deep/NO_SUCH_FILE.txt"
argument_list|)
operator|.
name|build
argument_list|()
...
annotation|@
name|Test
DECL|method|testCheckAccessForDirectoryKey ()
specifier|public
name|void
name|testCheckAccessForDirectoryKey
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testLookupKeyWithLocation ()
specifier|public
name|void
name|testLookupKeyWithLocation
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
decl_stmt|;
comment|// lookup for a non-existent key
try|try
block|{
name|keyManager
operator|.
...
name|fail
argument_list|(
literal|"Lookup key should fail for non existent key"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
decl_stmt|;
comment|// randomly select 3 datanodes
name|List
argument_list|<
name|DatanodeDetails
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// create a pipeline using 3 datanodes
name|Pipeline
name|pipeline
init|=
name|scm
...
argument_list|)
expr_stmt|;
comment|// lookup key, leader as client
name|OmKeyInfo
name|key1
init|=
name|keyManager
...
argument_list|)
expr_stmt|;
comment|// lookup key, follower1 as client
name|OmKeyInfo
name|key2
init|=
name|keyManager
...
argument_list|)
expr_stmt|;
comment|// lookup key, follower2 as client
name|OmKeyInfo
name|key3
init|=
name|keyManager
...
argument_list|)
expr_stmt|;
comment|// lookup key, random node as client
name|OmKeyInfo
name|key4
init|=
name|keyManager
...
name|keyArgs
argument_list|,
literal|"/d=default-drack/127.0.0.1"
argument_list|)
decl_stmt|;
name|Assert
operator|.
