...
annotation|@
name|Test
DECL|method|testFileOperationsWithRecursive ()
specifier|public
name|void
name|testFileOperationsWithRecursive
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// multi level key name
name|keyName
operator|=
literal|"dir1/dir2/dir3/file1"
expr_stmt|;
name|testCreateFile
argument_list|(
name|ozoneBucket
...
name|data
operator|=
literal|"random data random data"
expr_stmt|;
comment|// multi level key name with over write set.
name|testCreateFile
argument_list|(
name|ozoneBucket
argument_list|,
...
name|fail
argument_list|(
literal|"testFileOperationsWithRecursive"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|// Try now with a file name which is same as a directory.
try|try
block|{
name|keyName
operator|=
literal|"folder/folder2"
expr_stmt|;
name|ozoneBucket
operator|.
...
name|fail
argument_list|(
literal|"testFileOperationsWithNonRecursive"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
annotation|@
name|Test
DECL|method|testFileOperationsWithNonRecursive ()
specifier|public
name|void
name|testFileOperationsWithNonRecursive
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"dir1/dir2/dir3/file1"
expr_stmt|;
comment|// Should fail, as this is non-recursive and no parent directories exist
try|try
block|{
name|testCreateFile
argument_list|(
...
expr_stmt|;
block|}
comment|// create directory, now this should pass.
name|ozoneBucket
operator|.
name|createDirectory
argument_list|(
...
expr_stmt|;
block|}
comment|// Try now with a file which already exists under the path
name|ozoneBucket
operator|.
name|createDirectory
argument_list|(
literal|"folder1/folder2/folder3/folder4"
argument_list|)
expr_stmt|;
name|keyName
operator|=
literal|"folder1/folder2/folder3/folder4/file1"
expr_stmt|;
name|testCreateFile
argument_list|(
name|ozoneBucket
...
name|keyName
operator|=
literal|"folder1/folder2/folder3/file1"
expr_stmt|;
name|testCreateFile
argument_list|(
name|ozoneBucket
...
argument_list|)
expr_stmt|;
comment|// Try now with a file under path already. This should fail.
try|try
block|{
name|keyName
operator|=
...
block|}
block|}
comment|/**    * This method createFile and verifies the file is successfully created or    * not.    * @param ozoneBucket    * @param keyName    * @param data    * @param recursive    * @param overwrite    * @throws Exception    */
DECL|method|testCreateFile (OzoneBucket ozoneBucket, String keyName, String data, boolean recursive, boolean overwrite)
specifier|public
name|void
name|testCreateFile
parameter_list|(
...
annotation|@
name|Test
DECL|method|testSetBucketAcl ()
specifier|public
name|void
name|testSetBucketAcl
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|containsAcl (OzoneAcl ozoneAcl, List<OzoneAcl> ozoneAcls)
specifier|private
name|boolean
name|containsAcl
parameter_list|(
...
condition|)
block|{
comment|// We found a match, return.
return|return
name|result
return|;
block|}
...
return|;
block|}
DECL|method|compareAcls (OzoneAcl givenAcl, OzoneAcl existingAcl)
specifier|private
name|boolean
name|compareAcls
parameter_list|(
...
annotation|@
name|Test
DECL|method|testRemoveKeyAcl ()
specifier|public
name|void
name|testRemoveKeyAcl
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testAddPrefixAcl ()
specifier|public
name|void
name|testAddPrefixAcl
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testRemovePrefixAcl ()
specifier|public
name|void
name|testRemovePrefixAcl
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// try removing already removed acl.
name|result
operator|=
name|objectStore
operator|.
...
annotation|@
name|Test
DECL|method|testSetPrefixAcl ()
specifier|public
name|void
name|testSetPrefixAcl
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSetAcl (String remoteUserName, OzoneObj ozoneObj, OzoneAcl userAcl)
specifier|private
name|void
name|testSetAcl
parameter_list|(
...
name|Exception
block|{
comment|// As by default create will add some default acls in RpcClient.
if|if
condition|(
operator|!
name|ozoneObj
...
argument_list|)
expr_stmt|;
comment|// Get acls and check whether they are reset or not.
name|List
argument_list|<
name|OzoneAcl
argument_list|>
...
block|}
block|}
DECL|method|testAddAcl (String remoteUserName, OzoneObj ozoneObj, OzoneAcl userAcl)
specifier|private
name|void
name|testAddAcl
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Add an already existing acl.
name|addAcl
operator|=
name|objectStore
operator|.
...
argument_list|)
expr_stmt|;
comment|// Add an acl by changing acl type with same type, name and scope.
name|userAcl
operator|=
operator|new
name|OzoneAcl
...
expr_stmt|;
block|}
DECL|method|testRemoveAcl (String remoteUserName, OzoneObj ozoneObj, OzoneAcl userAcl)
specifier|private
name|void
name|testRemoveAcl
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Remove an existing acl.
name|boolean
name|removeAcl
init|=
name|objectStore
...
argument_list|)
expr_stmt|;
comment|// Trying to remove an already removed acl.
name|removeAcl
operator|=
name|objectStore
operator|.
...
argument_list|)
expr_stmt|;
comment|// Just changed acl type here to write, rest all is same as defaultUserAcl.
name|OzoneAcl
name|modifiedUserAcl
init|=
operator|new
...
block|}
name|long
name|lastAppliedTxOnFollowerOM
init|=
name|followerOM1
operator|.
name|getOmRatisServer
...
argument_list|()
decl_stmt|;
comment|// Stop one follower OM
name|followerOM1
operator|.
name|stop
argument_list|()
expr_stmt|;
comment|// Do more transactions. Stopped OM should miss these transactions and
comment|// the logs corresponding to atleast some of the missed transactions
comment|// should be purged. This will force the OM to install snapshot when
comment|// restarted.
name|long
name|minNewTxIndex
init|=
...
expr_stmt|;
block|}
comment|// Restart the stopped OM.
name|followerOM1
operator|.
name|restart
argument_list|()
expr_stmt|;
comment|// Get the latest snapshotIndex from the leader OM.
name|long
...
argument_list|)
expr_stmt|;
comment|// Wait for the follower OM to catch up
name|GenericTestUtils
operator|.
name|waitFor
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Do more transactions. The restarted OM should receive the
comment|// new transactions. It's last applied tx index should increase from the
comment|// last snapshot index after more transactions are applied.
for|for
control|(
name|int
name|i
...
block|}
name|long
name|followerOM1lastAppliedIndex
init|=
name|followerOM1
operator|.
name|getOmRatisServer
...
argument_list|)
expr_stmt|;
comment|// The follower OMs should be in sync. There can be a small lag between
comment|// leader OM and follower OMs as txns are applied first on leader OM.
name|long
name|followerOM2lastAppliedIndex
init|=
name|followerOM1
operator|.
name|getOmRatisServer
