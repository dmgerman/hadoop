...
control|)
block|{
comment|// Try removing an acl which doesn't exist, it should return false.
name|assertFalse
argument_list|(
name|finalVolume
operator|.
...
argument_list|)
expr_stmt|;
comment|// Call addAcl again, this time operation will fail as
comment|// acl is already added.
name|assertFalse
argument_list|(
name|store
operator|.
...
argument_list|)
expr_stmt|;
comment|// Add acl should succeed.
name|assertTrue
argument_list|(
name|store
operator|.
...
argument_list|)
expr_stmt|;
comment|// Call addAcl again, this time operation will return false as
comment|// acl is already added.
name|assertFalse
argument_list|(
name|store
