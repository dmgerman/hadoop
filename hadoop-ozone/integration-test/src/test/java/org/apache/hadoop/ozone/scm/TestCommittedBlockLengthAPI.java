...
begin_class
DECL|class|TestCommittedBlockLengthAPI
specifier|public
class|class
name|TestCommittedBlockLengthAPI
block|{
DECL|field|cluster
specifier|private
specifier|static
...
annotation|@
name|Test
DECL|method|tesGetCommittedBlockLengthWithClosedContainer ()
specifier|public
name|void
name|tesGetCommittedBlockLengthWithClosedContainer
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testGetCommittedBlockLengthForOpenBlock ()
specifier|public
name|void
name|testGetCommittedBlockLengthForOpenBlock
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// now close the container, it should auto commit pending open blocks
name|ContainerProtocolCalls
operator|.
name|closeContainer
argument_list|(
