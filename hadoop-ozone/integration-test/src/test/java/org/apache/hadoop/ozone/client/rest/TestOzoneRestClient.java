...
argument_list|()
expr_stmt|;
comment|// Get the containerID and localID.
...
argument_list|)
expr_stmt|;
comment|// Sum the data size from chunks in Container via containerID
comment|// and localID, make sure the size equals to the actually value size.
name|Pipeline
name|pipeline
init|=
name|cluster
