...
name|assertCounter
argument_list|(
literal|"NumStartTransactionVerifyFailures"
argument_list|,
literal|0L
argument_list|,
name|metric
...
name|assertCounter
argument_list|(
literal|"NumContainerNotOpenVerifyFailures"
argument_list|,
literal|0L
argument_list|,
name|metric
...
expr_stmt|;
name|double
name|applyTransactionLatency
init|=
name|getDoubleGauge
argument_list|(
literal|"ApplyTransactionAvgTime"
argument_list|,
name|metric
argument_list|)
decl_stmt|;
...
expr_stmt|;
name|double
name|writeStateMachineLatency
init|=
name|getDoubleGauge
argument_list|(
literal|"WriteStateMachineDataAvgTime"
argument_list|,
name|metric
argument_list|)
decl_stmt|;
