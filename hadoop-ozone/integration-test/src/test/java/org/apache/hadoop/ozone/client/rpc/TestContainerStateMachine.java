...
argument_list|)
expr_stmt|;
comment|//  conf.setBoolean(OZONE_SECURITY_ENABLED_KEY, true);
name|conf
operator|.
...
argument_list|)
expr_stmt|;
comment|//  conf.set(HADOOP_SECURITY_AUTHENTICATION, KERBEROS.toString());
name|cluster
operator|=
name|MiniOzoneCluster
operator|.
...
annotation|@
name|Test
DECL|method|testRatisSnapshotRetention ()
specifier|public
name|void
name|testRatisSnapshotRetention
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Write 10 keys. Num snapshots should be equal to config value.
for|for
control|(
name|int
name|i
...
argument_list|)
expr_stmt|;
comment|// Write 10 more keys. Num Snapshots should remain the same.
for|for
control|(
name|int
name|i
