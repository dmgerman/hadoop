...
expr_stmt|;
block|}
comment|/**    * Test if OM RocksDB keyMayExist API works for keys that are present.    * Test added in this module since we need access to custom codec dependent    * objects like OMKeyInfo.    * @throws Exception if OM or RocksDB operations fail.    */
annotation|@
name|Test
DECL|method|testDBKeyMayExist ()
specifier|public
name|void
name|testDBKeyMayExist
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testGetOMDBUpdates ()
specifier|public
name|void
name|testGetOMDBUpdates
parameter_list|()
throws|throws
name|IOException
block|{
