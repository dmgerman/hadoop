...
expr_stmt|;
block|}
DECL|method|writeChunkHelper (BlockID blockID, Pipeline pipeline)
specifier|private
name|ChunkInfo
...
comment|// Delete container file then try to update without force update flag.
name|FileUtil
operator|.
name|fullyDelete
argument_list|(
...
name|assertEquals
argument_list|(
literal|"Container file not exists or "
operator|+
literal|"corrupted. ID: "
operator|+
name|testContainerID
argument_list|,
name|ex
...
expr_stmt|;
block|}
DECL|method|writeKeyHelper (Pipeline pipeline, BlockID blockID)
specifier|private
name|KeyData
name|writeKeyHelper
parameter_list|(
