...
return|;
block|}
DECL|method|getDispatcherContext ()
specifier|private
name|DispatcherContext
name|getDispatcherContext
parameter_list|()
block|{
return|return
operator|new
...
block|{
name|long
name|commitBytesBefore
init|=
literal|0
decl_stmt|;
name|long
name|commitBytesAfter
init|=
literal|0
decl_stmt|;
name|long
name|commitIncrement
init|=
literal|0
decl_stmt|;
name|KeyValueContainerData
...
name|commitBytesBefore
expr_stmt|;
comment|// did we commit space for the new container?
name|Assert
operator|.
name|assertTrue
argument_list|(
...
name|commitBytesAfter
expr_stmt|;
comment|// did we decrement commit bytes by the amount of data we wrote?
name|Assert
operator|.
name|assertTrue
argument_list|(
