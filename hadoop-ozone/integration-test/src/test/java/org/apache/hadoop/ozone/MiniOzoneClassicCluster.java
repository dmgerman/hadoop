...
operator|.
name|Private
DECL|class|MiniOzoneClassicCluster
specifier|public
specifier|final
class|class
...
DECL|method|MiniOzoneClassicCluster (Builder builder, StorageContainerManager scm, KeySpaceManager ksm)
specifier|private
name|MiniOzoneClassicCluster
parameter_list|(
name|Builder
...
return|;
block|}
comment|/*    * Restart a particular datanode, wait for it to become active    */
annotation|@
name|Override
...
block|}
comment|/**    * Waits for a particular Datanode to be ready for processing ozone requests.    */
annotation|@
name|Override
...
return|;
block|}
DECL|method|setScmId (String sId)
specifier|public
name|Builder
name|setScmId
parameter_list|(
...
return|;
block|}
DECL|method|setKsmId (String kId)
specifier|public
name|Builder
name|setKsmId
parameter_list|(
...
name|DFS_DATANODE_PLUGINS_KEY
argument_list|,
literal|"org.apache.hadoop.ozone.HdslServerPlugin,"
operator|+
