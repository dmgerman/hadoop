...
parameter_list|)
block|{
comment|// add container possible only in container with open state
name|Assert
operator|.
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// removeContainerFromPipeline in open pipeline does not lead to removal of pipeline
name|Assert
operator|.
name|assertNotNull
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// removal of second last container in closing or closed pipeline should
comment|// not lead to removal of pipeline
name|Assert
operator|.
name|assertNotNull
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// removal of last container in closing or closed pipeline should lead to
comment|// removal of pipeline
try|try
block|{
name|stateManager
operator|.
...
name|fail
argument_list|(
literal|"getPipeline should have failed."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
annotation|@
name|Test
DECL|method|testUpdatePipelineState ()
specifier|public
name|void
name|testUpdatePipelineState
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|updateEvents (PipelineID pipelineID, HddsProtos.LifeCycleEvent... events)
specifier|private
name|void
name|updateEvents
parameter_list|(
