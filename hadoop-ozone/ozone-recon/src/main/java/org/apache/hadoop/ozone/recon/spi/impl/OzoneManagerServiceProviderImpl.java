...
name|IOException
block|{
comment|//Schedule a task to periodically obtain the DB snapshot from OM and
...
name|info
argument_list|(
literal|"Starting thread to get OM DB Snapshot."
argument_list|)
expr_stmt|;
name|executorService
operator|.
...
name|error
argument_list|(
literal|"Null snapshot got from OM, {}"
argument_list|,
name|dbSnapshot
operator|.
name|getCheckpointLocation
