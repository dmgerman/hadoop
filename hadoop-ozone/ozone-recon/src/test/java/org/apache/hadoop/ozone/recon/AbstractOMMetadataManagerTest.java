...
block|}
comment|/**    * Write a key to OM instance.    * @throws IOException while writing.    */
DECL|method|writeDataToOm (OMMetadataManager omMetadataManager, String key, String bucket, String volume, Long dataSize, List<OmKeyLocationInfoGroup> omKeyLocationInfoGroupList)
specifier|protected
name|void
name|writeDataToOm
parameter_list|(
