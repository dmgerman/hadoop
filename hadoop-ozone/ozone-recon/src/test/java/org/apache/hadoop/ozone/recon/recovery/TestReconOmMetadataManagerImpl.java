...
argument_list|)
expr_stmt|;
comment|//Verify that we cannot write data to Recon OM DB (Read Only)
try|try
block|{
name|reconOMMetadataManager
operator|.
...
name|put
argument_list|(
literal|"/sampleVol/bucketOne/fail_key"
argument_list|,
operator|new
name|OmKeyInfo
operator|.
...
name|contains
argument_list|(
literal|"Not supported operation in read only mode"
argument_list|)
argument_list|)
expr_stmt|;
block|}
