...
argument_list|)
decl_stmt|;
DECL|method|SignerManager ()
specifier|public
name|SignerManager
parameter_list|()
block|{   }
comment|/**    * Initialize custom signers and register them with the AWS SDK.    *    * @param conf Hadoop configuration    */
DECL|method|initCustomSigners (Configuration conf)
specifier|public
name|void
...
name|message
init|=
literal|"Invalid format (Expected name:SignerClass) for CustomSigner: ["
operator|+
name|customSigner
operator|+
literal|"]"
