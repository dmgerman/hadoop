...
begin_comment
comment|/**  * Factory for creation of S3 client instances to be used by {@link S3Store}.  */
end_comment
...
DECL|method|createAmazonS3Client (Configuration conf, AWSCredentialsProvider credentials, ClientConfiguration awsConf)
specifier|private
specifier|static
name|AmazonS3
name|createAmazonS3Client
