...
return|;
block|}
DECL|method|getAuthoritativePaths (S3AFileSystem fs)
specifier|public
specifier|static
name|Collection
argument_list|<
...
init|=
literal|"S3Guard is disabled on this bucket: {}"
decl_stmt|;
DECL|field|UNKNOWN_WARN_LEVEL
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"Unknown S3Guard disabled warn level: "
decl_stmt|;
DECL|enum|DisabledWarnLevel
specifier|public
enum|enum
...
name|FAIL
block|}
DECL|method|logS3GuardDisabled (Logger logger, String warnLevelStr, String bucket)
specifier|public
specifier|static
name|void
