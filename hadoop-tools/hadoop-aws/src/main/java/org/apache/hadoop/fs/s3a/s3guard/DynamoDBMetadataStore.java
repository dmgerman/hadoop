...
DECL|method|completeAncestry ( Collection<DDBPathMetadata> pathsToCreate)
name|Collection
argument_list|<
name|DDBPathMetadata
argument_list|>
...
operator|.
name|OnceRaw
DECL|method|innerPut (Collection<DDBPathMetadata> metas)
specifier|private
name|void
name|innerPut
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// add parent path of what we remove
name|Path
name|parentPath
init|=
name|path
...
expr_stmt|;
block|}
DECL|method|removeAuthoritativeDirFlag (Set<Path> pathSet)
specifier|private
name|void
name|removeAuthoritativeDirFlag
parameter_list|(
...
block|}
block|}
comment|/**    *  Add tags from configuration to the existing DynamoDB table.    */
annotation|@
name|Retries
operator|.
name|OnceRaw
DECL|method|tagTable ()
specifier|public
name|void
name|tagTable
parameter_list|()
...
expr_stmt|;
block|}
comment|/**    * Create a table, wait for it to become active, then add the version    * marker.    * Creating an setting up the table isn't wrapped by any retry operations;    * the wait for a table to become available is RetryTranslated.    * @param capacity capacity to provision. If null: create a per-request    * table.    * @throws IOException on any failure.    * @throws InterruptedIOException if the wait was interrupted    */
annotation|@
name|Retries
operator|.
name|OnceRaw
