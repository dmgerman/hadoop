...
literal|"open"
decl_stmt|;
DECL|field|OPERATION_REOPEN
specifier|public
specifier|static
specifier|final
name|String
name|OPERATION_REOPEN
init|=
literal|"re-open"
decl_stmt|;
...
decl_stmt|;
comment|/** change tracker. */
DECL|field|changeTracker
specifier|private
specifier|final
name|ChangeTracker
name|changeTracker
...
return|;
block|}
comment|/**    * Return the number of bytes available.    * If the inner stream is closed, the value is 1 for consistency    * with S3ObjectStream -and so address the GZip bug    * http://bugs.java.com/bugdatabase/view_bug.do?bug_id=7036144 .    * If the stream is open, then it is the amount returned by the    * wrapped stream.    * @return a value greater than or equal to zero.    * @throws IOException IO failure.    */
annotation|@
name|Override
...
annotation|@
name|VisibleForTesting
DECL|method|isObjectStreamOpen ()
name|boolean
name|isObjectStreamOpen
parameter_list|()
block|{
