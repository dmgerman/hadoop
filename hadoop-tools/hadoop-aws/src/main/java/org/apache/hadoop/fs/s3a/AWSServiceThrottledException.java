...
begin_comment
comment|/**  * Exception raised when a service was throttled.  */
end_comment

begin_class
DECL|class|AWSServiceThrottledException
specifier|public
class|class
...
DECL|method|AWSServiceThrottledException (String operation, AmazonServiceException cause)
specifier|public
name|AWSServiceThrottledException
parameter_list|(
name|String
