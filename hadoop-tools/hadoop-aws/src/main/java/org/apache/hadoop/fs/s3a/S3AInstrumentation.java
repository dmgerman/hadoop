...
name|ignoredErrors
decl_stmt|;
DECL|field|putLatencyQuantile
specifier|private
specifier|final
name|MutableQuantiles
name|putLatencyQuantile
decl_stmt|;
DECL|field|throttleRateQuantile
specifier|private
specifier|final
name|MutableQuantiles
name|throttleRateQuantile
decl_stmt|;
...
return|;
block|}
comment|/**      * Merge the statistics into the filesystem's instrumentation instance.      * Takes a diff between the current version of the stats and the      * version of the stats when merge was last called, and merges the diff      * into the instrumentation instance. Used to periodically merge the      * stats into the fs-wide stats.<b>Behavior is undefined if called on a      * closed instance.</b>      */
DECL|method|merge (boolean isClosed)
name|void
name|merge
parameter_list|(
name|boolean
...
expr_stmt|;
block|}
comment|// If stats are closed, no need to create another copy
if|if
condition|(
operator|!
name|isClosed
...
block|}
block|}
comment|/**      * Returns a diff between this {@link InputStreamStatistics} instance and      * the given {@link InputStreamStatistics} instance.      */
DECL|method|diff (InputStreamStatistics inputStats)
specifier|private
name|InputStreamStatistics
name|diff
parameter_list|(
...
return|;
block|}
comment|/**      * Returns a new {@link InputStreamStatistics} instance with all the same      * values as this {@link InputStreamStatistics}.      */
DECL|method|copy ()
specifier|private
name|InputStreamStatistics
name|copy
