...
begin_comment
comment|/**    * Get the probability of the request being throttled.    * @return a value 0 - 1.0f.    */
end_comment
...
begin_comment
comment|/**    * Conditionally fail the operation.    * @throws AmazonClientException if the client chooses to fail    * the request.    */
end_comment
