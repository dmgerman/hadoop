...
return|;
block|}
comment|/**    * Translate a DynamoDB exception into an IOException.    * @param message preformatted message for the exception    * @param ex exception    * @return an exception to throw.    */
DECL|method|translateDynamoDBException (String message, AmazonDynamoDBException ex)
specifier|public
specifier|static
name|IOException
name|translateDynamoDBException
