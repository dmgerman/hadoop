...
block|}
block|}
comment|/**    * Create a new AWS {@code ClientConfiguration}.    * All clients to AWS services<i>MUST</i> use this for consistent setup    * of connectivity, UA, proxy settings.    * @param conf The Hadoop configuration    * @param bucket Optional bucket to use to look up per-bucket proxy secrets    * @return new AWS client configuration    * @throws IOException problem creating AWS client configuration    *    * @deprecated use {@link #createAwsConf(Configuration, String, String)}    */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**    * Create a new AWS {@code ClientConfiguration}. All clients to AWS services    *<i>MUST</i> use this or the equivalents for the specific service for    * consistent setup of connectivity, UA, proxy settings.    *    * @param conf The Hadoop configuration    * @param bucket Optional bucket to use to look up per-bucket proxy secrets    * @param awsServiceIdentifier a string representing the AWS service (S3,    * DDB, etc) for which the ClientConfiguration is being created.    * @return new AWS client configuration    * @throws IOException problem creating AWS client configuration    */
DECL|method|createAwsConf (Configuration conf, String bucket, String awsServiceIdentifier)
specifier|public
specifier|static
name|ClientConfiguration
name|createAwsConf
...
name|configKey
operator|=
name|SIGNING_ALGORITHM_STS
expr_stmt|;
break|break;
default|default:
comment|// Nothing to do. The original signer override is already setup
block|}
if|if
condition|(
name|configKey
