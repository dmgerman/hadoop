...
argument_list|)
decl_stmt|;
comment|/** We only want the HEAD or dir marker. */
DECL|field|HEAD_OR_DIR_MARKER
specifier|public
specifier|static
specifier|final
name|Set
...
argument_list|)
decl_stmt|;
comment|/** We only want the HEAD. */
DECL|field|HEAD_ONLY
specifier|public
specifier|static
specifier|final
name|Set
...
argument_list|)
decl_stmt|;
comment|/** We only want the dir marker. */
DECL|field|DIR_MARKER_ONLY
specifier|public
specifier|static
specifier|final
name|Set
