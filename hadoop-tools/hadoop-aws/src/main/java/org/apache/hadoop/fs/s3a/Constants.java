...
name|CUSTOM_SIGNERS
init|=
literal|"fs.s3a.custom.signers"
decl_stmt|;
comment|/**    * There's 3 parameters that can be used to specify a non-default signing    * algorithm.<br>    * fs.s3a.signing-algorithm - This property has existed for the longest time.    * If specified, without either of the other 2 properties being specified,    * this signing algorithm will be used for S3 and DDB (S3Guard).<br>    * The other 2 properties override this value for S3 or DDB.<br>    * fs.s3a.s3.signing-algorithm - Allows overriding the S3 Signing algorithm.    * This does not affect DDB. Specifying this property without specifying    * fs.s3a.signing-algorithm will only update the signing algorithm for S3    * requests, and the default will be used for DDB.<br>    * fs.s3a.ddb.signing-algorithm - Allows overriding the DDB Signing algorithm.    * This does not affect S3. Specifying this property without specifying    * fs.s3a.signing-algorithm will only update the signing algorithm for    * DDB requests, and the default will be used for S3.    */
...
decl_stmt|;
DECL|field|SIGNING_ALGORITHM_S3
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|SIGNING_ALGORITHM_DDB
specifier|public
specifier|static
specifier|final
name|String
...
literal|"signing-algorithm"
decl_stmt|;
DECL|field|SIGNING_ALGORITHM_STS
specifier|public
specifier|static
specifier|final
name|String
...
literal|"2s"
decl_stmt|;
DECL|field|AWS_SERVICE_IDENTIFIER_S3
specifier|public
specifier|static
specifier|final
name|String
...
literal|"S3"
decl_stmt|;
DECL|field|AWS_SERVICE_IDENTIFIER_DDB
specifier|public
specifier|static
specifier|final
name|String
...
literal|"DDB"
decl_stmt|;
DECL|field|AWS_SERVICE_IDENTIFIER_STS
specifier|public
specifier|static
specifier|final
name|String
