...
return|;
block|}
comment|/**    * Create the attributes of an object for a get/select request.    * @param f path path of the request.    * @param eTag the eTag of the S3 object    * @param versionId S3 object version ID    * @return attributes to use when building the query.    */
DECL|method|createObjectAttributes ( final Path f, final String eTag, final String versionId)
specifier|private
...
annotation|@
name|VisibleForTesting
DECL|method|setTtlTimeProvider (S3Guard.ITtlTimeProvider ttlTimeProvider)
specifier|protected
name|void
