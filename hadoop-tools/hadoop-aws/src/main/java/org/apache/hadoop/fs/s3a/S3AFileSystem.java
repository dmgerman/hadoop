...
block|}
block|}
comment|/**    * Create the AWS SDK structure used to configure SSE, based on the    * configuration.    * @return an instance of the class, which main contain the encryption key    */
annotation|@
name|Retries
operator|.
...
return|;
block|}
comment|/**    * Create the SSE-C structure for the AWS SDK.    * This will contain a secret extracted from the bucket/configuration.    * @return the customer key.    */
annotation|@
name|Retries
operator|.
name|OnceExceptionsSwallowed
