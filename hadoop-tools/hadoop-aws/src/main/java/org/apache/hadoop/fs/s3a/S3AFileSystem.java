...
return|;
block|}
comment|/**    * Create the attributes of an object for a get/select request.    * @param f path path of the request.    * @return attributes to use when building the query.    */
DECL|method|createObjectAttributes (final Path f)
specifier|private
