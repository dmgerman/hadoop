...
argument_list|,
operator|new
name|RenameOperationCallbacksImpl
argument_list|()
argument_list|)
decl_stmt|;
return|return
...
return|;
block|}
comment|/**    * All the callbacks made by the rename operation of the filesystem.    * This separation allows the operation to be factored out and    * still avoid knowledge of the S3AFilesystem implementation.    */
DECL|class|RenameOperationCallbacksImpl
specifier|private
class|class
name|RenameOperationCallbacksImpl
implements|implements
...
operator|.
name|RetryTranslated
DECL|method|listFilesAndEmptyDirectories ( final Path path)
specifier|public
name|RemoteIterator
argument_list|<
...
annotation|@
name|Override
DECL|method|removeKeys (final List<DeleteObjectsRequest.KeyVersion> keysToDelete, final boolean deleteFakeDir, final List<Path> undeletedObjectsOnFailure)
specifier|public
name|void
name|removeKeys
parameter_list|(
...
operator|.
name|RetryRaw
DECL|method|removeKeysS3 (List<DeleteObjectsRequest.KeyVersion> keysToDelete, boolean deleteFakeDir)
specifier|private
name|void
name|removeKeysS3
parameter_list|(
...
operator|.
name|RetryMixed
DECL|method|removeKeys ( final List<DeleteObjectsRequest.KeyVersion> keysToDelete, final boolean deleteFakeDir)
name|void
name|removeKeys
parameter_list|(
specifier|final
...
condition|)
block|{
comment|// delete a single page of keys
name|removeKeys
argument_list|(
name|keys
argument_list|,
...
block|{
comment|// there is no more data: delete the final set of entries.
name|removeKeys
argument_list|(
name|keys
argument_list|,
