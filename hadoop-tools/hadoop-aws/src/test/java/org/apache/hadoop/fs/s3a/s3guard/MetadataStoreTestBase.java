...
literal|5000
decl_stmt|;
comment|// attributes not supported by S3AFileStatus
...
annotation|@
name|Test
DECL|method|testPrunePreservesAuthoritative ()
specifier|public
name|void
name|testPrunePreservesAuthoritative
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// get the directory listings
name|DirListingMetadata
name|rootDirMd
init|=
name|ms
...
argument_list|)
expr_stmt|;
comment|// assert that parent dir is still authoritative (no removed elements
comment|// during prune)
name|assertFalse
argument_list|(
name|rootDirMd
operator|.
...
annotation|@
name|Test
DECL|method|testPutDirListingMetadataPutsFileMetadata ()
specifier|public
name|void
name|testPutDirListingMetadataPutsFileMetadata
parameter_list|()
throws|throws
name|IOException
block|{
...
name|format
argument_list|(
literal|"PathMetadata for file %s should not be null."
argument_list|,
name|fileName
argument_list|)
argument_list|,
...
annotation|@
name|Test
DECL|method|testPutRetainsIsDeletedInParentListing ()
specifier|public
name|void
name|testPutRetainsIsDeletedInParentListing
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"isDeleted should be true on the parent listing"
argument_list|,
name|pathMetadata
operator|.
name|isDeleted
...
annotation|@
name|Test
DECL|method|testPruneExpiredTombstones ()
specifier|public
name|void
name|testPruneExpiredTombstones
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// tombstones are the deleted files!
name|pathMetadata
operator|.
name|setIsDeleted
argument_list|(
...
name|assertNotNull
argument_list|(
literal|"Kept files should be in the metastore after prune"
argument_list|,
name|pathMetadata
argument_list|)
expr_stmt|;
...
name|assertNull
argument_list|(
literal|"Expired tombstones should be removed from metastore after "
operator|+
literal|"the prune."
argument_list|,
name|pathMetadata
...
annotation|@
name|Test
DECL|method|testPruneExpiredTombstonesSpecifiedPath ()
specifier|public
name|void
name|testPruneExpiredTombstonesSpecifiedPath
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|9001
decl_stmt|;
comment|// Both are expired. Difference is it will only delete the specified one.
for|for
control|(
name|String
name|fN
...
return|;
block|}
comment|/**    * The prune operation needs the path with the bucket name as a string in    * {@link DynamoDBMetadataStore}, but not for {@link LocalMetadataStore}.    * This is an implementation detail of the ms, so this should be    * implemented in the subclasses.    */
...
block|}
block|}
DECL|method|basicFileStatus (Path path, int size, boolean isDir, long newModTime)
specifier|public
specifier|static
name|S3AFileStatus
name|basicFileStatus
