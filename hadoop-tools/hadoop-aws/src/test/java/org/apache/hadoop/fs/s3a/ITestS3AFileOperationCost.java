...
argument_list|)
expr_stmt|;
comment|/*  TODO: uncomment once HADOOP-13222 is in     deleteRequests.assertDiffEquals(state,1);     directoriesDeleted.assertDiffEquals(state,0);     fakeDirectoriesDeleted.assertDiffEquals(state,destDirDepth); */
name|reset
argument_list|(
name|deleteRequests
argument_list|,
