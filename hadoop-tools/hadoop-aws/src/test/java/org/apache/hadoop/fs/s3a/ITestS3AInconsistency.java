...
literal|10
decl_stmt|;
DECL|field|INCONSISTENCY_MSEC
specifier|public
specifier|static
specifier|final
name|int
name|INCONSISTENCY_MSEC
init|=
literal|800
decl_stmt|;
DECL|field|INITIAL_RETRY
specifier|private
specifier|static
specifier|final
name|int
...
literal|4
decl_stmt|;
comment|/** By using a power of 2 for the initial time, the total is a shift left. */
DECL|field|TOTAL_RETRY_DELAY
specifier|private
specifier|static
specifier|final
name|int
name|TOTAL_RETRY_DELAY
init|=
name|INITIAL_RETRY
operator|<<
name|RETRIES
...
argument_list|)
expr_stmt|;
comment|// the reads are always inconsistent
name|conf
operator|.
name|setFloat
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// but the inconsistent time is less than exponential growth of the
comment|// retry interval (128 -> 256 -> 512 -> 1024
name|conf
operator|.
name|setLong
argument_list|(
