...
block|}
block|}
DECL|method|parallelRenames (int concurrentRenames, final S3AFileSystem fs, String sourceNameBase, String targetNameBase)
specifier|private
name|void
name|parallelRenames
parameter_list|(
name|int
name|concurrentRenames
parameter_list|,
...
name|tinyThreadPoolFs
argument_list|,
literal|"testParallelRename-source"
argument_list|,
literal|"testParallelRename-target"
argument_list|)
expr_stmt|;
block|}
block|}
annotation|@
name|Test
DECL|method|testThreadPoolCoolDown ()
specifier|public
name|void
name|testThreadPoolCoolDown
parameter_list|()
throws|throws
name|InterruptedException
throws|,
...
name|auxFs
argument_list|,
literal|"testThreadPoolCoolDown-source"
argument_list|,
literal|"testThreadPoolCoolDown-target"
argument_list|)
expr_stmt|;
for|for
control|(
...
argument_list|(
literal|"Failed to find threads in active FS - test is flawed"
argument_list|,
name|hotThreads
argument_list|,
literal|0
...
name|assertTrue
argument_list|(
literal|"s3a-transfer threads went from "
operator|+
name|hotThreads
operator|+
literal|" to "
