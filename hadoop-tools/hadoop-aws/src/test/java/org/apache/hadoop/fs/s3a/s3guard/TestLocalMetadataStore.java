...
expr_stmt|;
block|}
DECL|method|populateMap (Cache<Path, PathMetadata> cache, String prefix)
specifier|private
specifier|static
name|void
name|populateMap
...
expr_stmt|;
block|}
DECL|method|populateEntry (Cache<Path, PathMetadata> cache, Path path)
specifier|private
specifier|static
name|void
name|populateEntry
...
expr_stmt|;
block|}
DECL|method|sizeOfMap (Cache<Path, PathMetadata> cache)
specifier|private
specifier|static
name|int
name|sizeOfMap
...
return|;
block|}
DECL|method|assertClearResult (Cache<Path, PathMetadata> cache, String prefixStr, String pathStr, int leftoverSize)
specifier|private
specifier|static
name|void
name|assertClearResult
