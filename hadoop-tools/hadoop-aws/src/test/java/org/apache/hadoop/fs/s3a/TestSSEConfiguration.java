...
begin_comment
comment|/**  * Test SSE setup operations and errors raised.  */
end_comment
...
name|Throwable
block|{
name|assertExceptionTextEquals
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Set the SSE Key via the provision API, not the config itself.    * @param conf config    * @param option option name    * @param key key to set    * @throws Exception failure    */
DECL|method|provisionSSEKey (final Configuration conf, String option, String key)
name|void
name|provisionSSEKey
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**    * Assert that the exception text from a config contains the expected string    * @param expected expected substring    * @param alg algorithm to ask for    * @param key optional key value    * @throws Exception anything else which gets raised    */
DECL|method|assertExceptionTextEquals (String expected, final String alg, final String key)
specifier|public
name|void
name|assertExceptionTextEquals
parameter_list|(
