...
expr_stmt|;
block|}
comment|/**    * Tests doing a rename() on a file which is eventually visible.    */
annotation|@
name|Test
DECL|method|testRenameEventuallyVisibleFile ()
specifier|public
name|void
name|testRenameEventuallyVisibleFile
parameter_list|()
throws|throws
name|Throwable
block|{
...
expr_stmt|;
block|}
comment|/**    * Tests doing a rename() on a file which never quite appears will    * fail with a RemoteFileChangedException rather than have the exception    * downgraded to a failure.    */
annotation|@
name|Test
...
name|debug
argument_list|(
literal|"File {} will be inconsistent for {} HEAD and {} GET requests"
argument_list|,
name|testpath
argument_list|,
name|getMetadataInconsistencyCount
...
name|debug
argument_list|(
literal|"File {} will be inconsistent for {} COPY operations"
argument_list|,
name|testpath
argument_list|,
name|copyInconsistencyCount
...
return|;
block|}
comment|/**    * Match any getObjectMetadata request against a given path.    * @param path path to to match.    * @return the matching request.    */
DECL|method|matchingMetadataRequest (Path path)
specifier|private
name|GetObjectMetadataRequest
name|matchingMetadataRequest
parameter_list|(
...
name|Throwable
block|{
comment|// simulates delayed visibility.
name|callCount
operator|++
expr_stmt|;
if|if
...
block|}
decl_stmt|;
comment|// HEAD requests will fail
name|doAnswer
argument_list|(
name|notFound
argument_list|)
