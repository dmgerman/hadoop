...
name|path
argument_list|(
literal|"testRenameDirectoryAsExisting/dir/file1"
argument_list|)
argument_list|)
expr_stmt|;
name|createFile
...
name|path
argument_list|(
literal|"testRenameDirectoryAsExisting/dir/subdir/file2"
argument_list|)
argument_list|)
expr_stmt|;
name|Path
...
name|path
argument_list|(
literal|"testRenameDirectoryAsExisting/newdir"
argument_list|)
decl_stmt|;
name|fs
operator|.
...
name|path
argument_list|(
literal|"testRenameDirectoryAsExisting/newdir/file1"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
name|path
argument_list|(
literal|"testRenameDirectoryAsExisting/newdir/subdir/file2"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
