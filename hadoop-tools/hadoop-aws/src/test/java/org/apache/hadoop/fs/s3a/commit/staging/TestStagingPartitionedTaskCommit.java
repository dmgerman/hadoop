...
expr_stmt|;
block|}
comment|/**    * Verify that the files created matches that expected.    * @param committer committer    */
DECL|method|verifyFilesCreated ( final PartitionedStagingCommitter committer)
specifier|protected
name|void
name|verifyFilesCreated
parameter_list|(
