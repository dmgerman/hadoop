...
begin_comment
comment|/**  * S3N basic contract tests through mock in-memory S3 implementation.  */
end_comment

begin_class
DECL|class|ITestInMemoryNativeS3FileSystemContract
specifier|public
class|class
name|ITestInMemoryNativeS3FileSystemContract
extends|extends
