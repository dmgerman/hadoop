...
name|write
decl_stmt|;
DECL|method|Capacities (long read, long write)
name|Capacities
parameter_list|(
name|long
name|read
...
return|;
block|}
DECL|method|checkEquals (String text, Capacities that)
name|void
name|checkEquals
parameter_list|(
name|String
...
return|;
block|}
DECL|method|getCapacities (Map<String, String> diagnostics)
specifier|private
name|Capacities
name|getCapacities
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// to avoid race conditions, spin for the state change
name|AtomicInteger
name|c
init|=
operator|new
