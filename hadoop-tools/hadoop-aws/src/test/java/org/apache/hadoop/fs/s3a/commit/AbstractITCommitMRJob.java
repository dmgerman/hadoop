...
name|fs
argument_list|,
literal|"MR job Output directory not found,"
operator|+
literal|" even though the job did not report a failure"
argument_list|,
name|outputPath
argument_list|)
expr_stmt|;
...
name|describedAs
argument_list|(
literal|"Committed files in the job output directory"
argument_list|)
operator|.
...
name|describedAs
argument_list|(
literal|"List of committed files in %s"
argument_list|,
name|commitData
argument_list|)
operator|.
