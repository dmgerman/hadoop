...
return|;
block|}
comment|/**    * This is here because somehow test runs were failing with    * the confict mode being fail. Unsetting per-bucket options    * in setup made this go away; its retained for regression    * testing    */
annotation|@
name|Test
...
name|describe
argument_list|(
literal|"Checking default conflict mode adoption"
argument_list|)
expr_stmt|;
name|Configuration
name|baseConf
...
name|assertEquals
argument_list|(
literal|"conflict mode in filesystem"
argument_list|,
name|CONFLICT_MODE_APPEND
argument_list|,
name|conflictModeDefVal
