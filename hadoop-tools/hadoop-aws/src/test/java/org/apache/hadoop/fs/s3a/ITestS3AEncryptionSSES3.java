...
begin_comment
comment|/**  * Concrete class that extends {@link AbstractTestS3AEncryption}  * and tests SSE-S3 encryption.  */
end_comment

begin_class
DECL|class|ITestS3AEncryptionSSES3
specifier|public
class|class
name|ITestS3AEncryptionSSES3
extends|extends
