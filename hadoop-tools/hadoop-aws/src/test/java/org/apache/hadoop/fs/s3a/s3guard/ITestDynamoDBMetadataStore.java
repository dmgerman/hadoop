...
parameter_list|)
block|{
comment|// prune failed. warn and then fall back to forget.
name|LOG
operator|.
name|warn
argument_list|(
literal|"Failed to prune {}"
argument_list|,
name|path
argument_list|,
name|ioe
...
block|}
block|}
comment|// and after the pruning, make sure all other metadata is gone
name|int
name|forgotten
init|=
literal|0
...
name|base
init|=
literal|"/testPruneAgainstInvalidTable"
decl_stmt|;
name|String
name|subdir
init|=
...
name|describedAs
argument_list|(
literal|"Subdirectory entry %s is now file"
argument_list|,
name|subDirMetadataOrig
argument_list|)
operator|.
...
name|describe
argument_list|(
literal|"Put a file under a tombstone"
argument_list|)
expr_stmt|;
name|String
name|base
init|=
literal|"/testPutFileDirectlyUnderTombstone"
decl_stmt|;
name|long
name|now
init|=
...
name|base
init|=
literal|"/testPutFileDeepUnderTombstone"
decl_stmt|;
name|String
name|subdir
init|=
...
argument_list|()
expr_stmt|;
comment|// this is the same ordering as S3FileSystem.finishedWrite()
name|AncestorState
name|ancestorState
init|=
name|getDynamoMetadataStore
