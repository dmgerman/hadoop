...
argument_list|)
expr_stmt|;
comment|// check version compatibility
name|checkVerifyVersionMarkerCompatibility
argument_list|(
name|localTableHandler
argument_list|,
name|table
...
block|}
block|}
DECL|method|checkVerifyVersionMarkerCompatibility ( DynamoDBMetadataStoreTableManager localTableHandler, Table table)
specifier|private
name|void
name|checkVerifyVersionMarkerCompatibility
parameter_list|(
...
name|info
argument_list|(
literal|"1/6: remove version marker and tags from table "
operator|+
literal|"the table is empty, so it should be initialized after the call"
argument_list|)
expr_stmt|;
name|deleteVersionMarkerItem
argument_list|(
name|table
argument_list|)
expr_stmt|;
name|removeVersionMarkerTag
argument_list|(
name|table
argument_list|,
name|addb
...
name|assertEquals
argument_list|(
literal|"Table should be tagged with the right version."
argument_list|,
name|VERSION
argument_list|,
name|versionFromTag
...
name|assertEquals
argument_list|(
literal|"Table should have the right version marker."
argument_list|,
name|VERSION
argument_list|,
name|versionFromItem
...
name|info
argument_list|(
literal|"2/6: if the table is not empty and there's no version marker "
operator|+
literal|"it should fail"
argument_list|)
expr_stmt|;
name|deleteVersionMarkerItem
argument_list|(
...
name|info
argument_list|(
literal|"3/6: table has only version marker item then it will be tagged"
argument_list|)
expr_stmt|;
name|table
operator|.
...
name|assertEquals
argument_list|(
literal|"Table should have the right version marker tag "
operator|+
literal|"if there was a version item."
argument_list|,
name|VERSION
argument_list|,
name|versionFromTag2
...
name|info
argument_list|(
literal|"4/6: table has only version marker tag then the version marker "
operator|+
literal|"item will be created."
argument_list|)
expr_stmt|;
name|deleteVersionMarkerItem
argument_list|(
...
name|assertEquals
argument_list|(
literal|"Table should have the right version marker item "
operator|+
literal|"if there was a version tag."
argument_list|,
name|VERSION
argument_list|,
name|versionFromItem2
...
name|info
argument_list|(
literal|"5/6: add a different marker tag to the table: init should fail"
argument_list|)
expr_stmt|;
name|deleteVersionMarkerItem
argument_list|(
...
name|info
argument_list|(
literal|"6/6: add a different marker item to the table: init should fail"
argument_list|)
expr_stmt|;
name|deleteVersionMarkerItem
argument_list|(
...
literal|3
decl_stmt|;
name|tagTableWithCustomVersion
argument_list|(
name|table
argument_list|,
name|addb
...
expr_stmt|;
block|}
DECL|method|tagTableWithCustomVersion (Table table, AmazonDynamoDB addb, int wrongVersion)
specifier|private
name|void
name|tagTableWithCustomVersion
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|removeVersionMarkerTag (Table table, AmazonDynamoDB addb)
specifier|private
name|void
name|removeVersionMarkerTag
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|deleteVersionMarkerItem (Table table)
specifier|private
name|void
name|deleteVersionMarkerItem
parameter_list|(
...
name|assertNull
argument_list|(
literal|"Version marker should be null after deleting it "
operator|+
literal|"from the table."
argument_list|,
name|table
operator|.
name|getItem
...
argument_list|)
operator|.
name|containsAllEntriesOf
argument_list|(
name|tagMap
argument_list|)
expr_stmt|;
comment|// The version marker is always there in the tags.
comment|// We have a plus one in tags we expect.
name|assertEquals
argument_list|(
name|tagMap
operator|.
