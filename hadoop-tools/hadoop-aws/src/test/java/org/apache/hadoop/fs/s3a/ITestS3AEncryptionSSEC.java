...
name|Exception
block|{
name|requireUnguardedFilesystem
argument_list|()
expr_stmt|;
name|intercept
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Skip the test case if S3Guard is enabled; generally this is because    * list and GetFileStatus calls can succeed even with different keys.    */
DECL|method|requireUnguardedFilesystem ()
specifier|protected
name|void
name|requireUnguardedFilesystem
parameter_list|()
...
name|assume
argument_list|(
literal|"Filesystem has a metastore"
argument_list|,
operator|!
name|getFileSystem
argument_list|()
