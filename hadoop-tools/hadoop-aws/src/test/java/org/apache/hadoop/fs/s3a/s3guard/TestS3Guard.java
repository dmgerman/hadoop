...
annotation|@
name|Test
DECL|method|testLogS3GuardDisabled ()
specifier|public
name|void
name|testLogS3GuardDisabled
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Test that lowercase setting is accepted
name|S3Guard
operator|.
name|logS3GuardDisabled
argument_list|(
