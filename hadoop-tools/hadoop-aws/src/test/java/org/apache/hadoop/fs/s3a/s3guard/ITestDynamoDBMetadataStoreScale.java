...
parameter_list|)
block|{
comment|// if the service was throttled, we expect the exception text
name|GenericTestUtils
operator|.
...
block|}
block|}
comment|/**    * Try many deletes in parallel; this will create tombstones.    */
annotation|@
name|Test
DECL|method|test_090_delete ()
specifier|public
name|void
name|test_090_delete
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|Path
argument_list|(
literal|"s3a://example.org/delete"
argument_list|)
decl_stmt|;
name|S3AFileStatus
name|status
...
block|}
block|}
comment|/**    * Forget Metadata: delete entries without tombstones.    */
annotation|@
name|Test
DECL|method|test_100_forgetMetadata ()
specifier|public
name|void
name|test_100_forgetMetadata
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|assumeTrue
argument_list|(
literal|"No throttling expected"
argument_list|,
name|expectThrottling
argument_list|()
argument_list|)
...
DECL|method|cleanupMetadata (DynamoDBMetadataStore ms, PathMetadata pm)
specifier|private
name|void
name|cleanupMetadata
parameter_list|(
...
block|}
block|}
DECL|method|pathOfDepth (long n, String name, @Nullable String fileSuffix)
specifier|private
name|Path
name|pathOfDepth
parameter_list|(
