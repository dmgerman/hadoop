...
begin_comment
comment|/**  * An exception raised when an authentication request was rejected  */
end_comment

begin_class
DECL|class|SwiftAuthenticationFailedException
specifier|public
class|class
...
block|{
DECL|method|SwiftAuthenticationFailedException (String message, int statusCode, String operation, URI uri)
specifier|public
name|SwiftAuthenticationFailedException
parameter_list|(
name|String
