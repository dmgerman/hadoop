...
annotation|@
name|Test
DECL|method|testAuditWorkloadDirectParserWithOutput ()
specifier|public
name|void
name|testAuditWorkloadDirectParserWithOutput
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
name|testAuditWorkloadWithOutput
argument_list|(
name|auditOutputPath
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testAuditWorkloadHiveParserWithOutput ()
specifier|public
name|void
name|testAuditWorkloadHiveParserWithOutput
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testAuditWorkloadWithOutput (String auditOutputPath)
specifier|private
name|void
name|testAuditWorkloadWithOutput
parameter_list|(
...
name|matches
argument_list|(
literal|".*(hdfs,WRITE,[A-Z]+,[13]+,[0-9]+\\n){3}.*"
argument_list|)
argument_list|)
expr_stmt|;
comment|// Matches three lines of the format "hdfs,WRITE,name,count,time"
comment|// Using [13] for the count group because each operation is run either
comment|// 1 or 3 times but the output order isn't guaranteed
block|}
block|}
block|}
end_class
