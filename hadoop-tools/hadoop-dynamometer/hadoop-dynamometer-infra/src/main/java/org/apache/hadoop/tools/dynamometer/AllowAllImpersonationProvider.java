...
begin_comment
comment|/**  * An {@link ImpersonationProvider} that indiscriminately allows all users to  * proxy as any other user.  */
end_comment

begin_class
DECL|class|AllowAllImpersonationProvider
specifier|public
class|class
name|AllowAllImpersonationProvider
extends|extends
name|Configured
