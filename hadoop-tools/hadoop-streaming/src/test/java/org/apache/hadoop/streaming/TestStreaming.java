...
argument_list|)
decl_stmt|;
comment|//    PrintWriter writer = new PrintWriter(new OutputStreamWriter(new FileOutputStream(new File("/tmp/tucu.txt"), true)), true);
comment|//    writer.println("** Expected: " + expectedOutput);
comment|//    writer.println("** Output  : " + output);
name|assertTrue
argument_list|(
name|returnedWords
operator|.
