...
begin_comment
comment|/**  * This class tests hadoopStreaming in MapReduce local mode.  * It tests the case where number of reducers is set to 0.    In this case, the mappers are expected to write out outputs directly.    No reducer/combiner will be activated.  */
end_comment

begin_class
DECL|class|TestStreamReduceNone
specifier|public
class|class
name|TestStreamReduceNone
block|{
...
name|File
argument_list|(
literal|"stream_reduce_none_input.txt"
argument_list|)
decl_stmt|;
...
name|File
argument_list|(
literal|"stream_reduce_none_out"
argument_list|)
decl_stmt|;
DECL|field|input
specifier|protected
...
name|job
decl_stmt|;
DECL|method|TestStreamReduceNone ()
specifier|public
name|TestStreamReduceNone
parameter_list|()
throws|throws
