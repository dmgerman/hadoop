...
return|;
block|}
comment|/**    * A helper method to parse chunk size in number of blocks.    * Used when breaking large file into chunks to copy in parallel.    *    * @param command command line arguments    */
DECL|method|parseBlocksPerChunk (CommandLine command, DistCpOptions option)
specifier|private
specifier|static
name|void
name|parseBlocksPerChunk
