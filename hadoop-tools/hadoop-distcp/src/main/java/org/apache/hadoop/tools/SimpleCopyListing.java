...
block|}
block|}
DECL|method|writeToFileListingRoot (SequenceFile.Writer fileListWriter, FileStatus fileStatus, Path sourcePathRoot, boolean localFile, DistCpOptions options)
specifier|private
name|void
name|writeToFileListingRoot
parameter_list|(
