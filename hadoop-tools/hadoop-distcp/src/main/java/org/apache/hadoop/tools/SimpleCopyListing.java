...
block|}
block|}
DECL|method|traverseDirectory (SequenceFile.Writer fileListWriter, FileSystem sourceFS, ArrayList<FileStatus> sourceDirs, Path sourcePathRoot, DistCpOptions options, HashSet<String> excludeList)
specifier|private
name|void
name|traverseDirectory
parameter_list|(
