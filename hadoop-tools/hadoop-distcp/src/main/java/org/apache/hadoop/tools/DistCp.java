...
expr_stmt|;
block|}
comment|/**    * Check if concat is supported by fs.    * Throws UnsupportedOperationException if not.    */
DECL|method|checkConcatSupport (FileSystem fs)
specifier|private
name|void
name|checkConcatSupport
parameter_list|(
name|FileSystem
name|fs
parameter_list|)
...
block|}
block|}
comment|/**    * Set up needed options for splitting large files.    */
