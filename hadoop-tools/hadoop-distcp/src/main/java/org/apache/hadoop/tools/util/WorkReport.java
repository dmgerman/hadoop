...
begin_comment
comment|/**  *  WorkReport{@literal<T>} is a simple container for items of class T and its  *  corresponding retry counter that indicates how many times this item  *  was previously attempted to be processed.  */
end_comment
