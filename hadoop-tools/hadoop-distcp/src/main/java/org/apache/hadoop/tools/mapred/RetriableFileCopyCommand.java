...
block|}
block|}
DECL|method|copyToTmpFile (Path tmpTargetPath, FileSystem targetFS, FileStatus sourceFileStatus, Mapper.Context context, EnumSet<FileAttribute> fileAttributes)
specifier|private
name|long
name|copyToTmpFile
parameter_list|(
...
return|;
block|}
DECL|method|compareFileLengths (FileStatus sourceFileStatus, Path target, Configuration configuration, long bytesRead)
specifier|private
name|void
name|compareFileLengths
parameter_list|(
...
throw|;
block|}
DECL|method|compareCheckSums (FileSystem sourceFS, Path source, FileSystem targetFS, Path target)
specifier|private
name|void
name|compareCheckSums
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|readBytes (InputStream inStream, byte buf[])
specifier|private
specifier|static
name|int
name|readBytes
