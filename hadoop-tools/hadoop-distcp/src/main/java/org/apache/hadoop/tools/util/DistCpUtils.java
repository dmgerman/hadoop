...
return|;
block|}
comment|/**    * Un packs preservation attribute string containing the first character of    * each preservation attribute back to a set of attributes to preserve    * @param attributes - Attribute string    * @return - Attribute set    */
...
DECL|method|preserve (FileSystem targetFS, Path path, CopyListingFileStatus srcFileStatus, EnumSet<FileAttribute> attributes)
specifier|public
specifier|static
name|void
name|preserve
...
expr_stmt|;
block|}
comment|// setAcl can't preserve sticky bit, so also call setPermission if needed.
if|if
condition|(
name|srcFileStatus
operator|.
...
return|;
block|}
comment|/**    * Converts a FileStatus to a CopyListingFileStatus.  If preserving ACLs,    * populates the CopyListingFileStatus with the ACLs. If preserving XAttrs,    * populates the CopyListingFileStatus with the XAttrs.    *    * @param fileSystem FileSystem containing the file    * @param fileStatus FileStatus of file    * @param preserveAcls boolean true if preserving ACLs    * @param preserveXAttrs boolean true if preserving XAttrs    * @throws IOException if there is an I/O error    */
DECL|method|toCopyListingFileStatus ( FileSystem fileSystem, FileStatus fileStatus, boolean preserveAcls, boolean preserveXAttrs)
specifier|public
specifier|static
name|CopyListingFileStatus
