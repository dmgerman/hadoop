...
parameter_list|()
function_decl|;
comment|/**    * Validate the final resulting path listing to see if there are any duplicate entries    *    * @param pathToListFile - path listing build by doBuildListing    * @throws IOException - Any issues while checking for duplicates and throws    * @throws DuplicateFileException - if there are duplicates    */
DECL|method|checkForDuplicates (Path pathToListFile)
specifier|private
name|void
name|checkForDuplicates
parameter_list|(
