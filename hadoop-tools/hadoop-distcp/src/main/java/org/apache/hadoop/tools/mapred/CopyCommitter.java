...
name|info
argument_list|(
literal|"delete({}) returned false ({}). Consider using "
operator|+
literal|"-useTrash option if trash is enabled."
argument_list|,
name|targetEntry
argument_list|,
name|trgtFileStatus
...
expr_stmt|;
block|}
DECL|method|deletePath (FileSystem targetFS, Path targetEntry, Configuration conf)
specifier|private
name|boolean
name|deletePath
parameter_list|(
...
DECL|method|concatFileChunks (Configuration conf, Path targetFile, LinkedList<Path> allChunkPaths)
specifier|private
name|void
name|concatFileChunks
parameter_list|(
