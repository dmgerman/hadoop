...
block|{     }
block|}
comment|/**    * Asserts the XAttrs returned by getXAttrs for a specific path.    *     * @param path String path to check    * @param xAttrs XAttr[] expected xAttrs    * @throws Exception if there is any error    */
DECL|method|assertXAttrs (Path path, Map<String, byte[]> expectedXAttrs)
specifier|private
specifier|static
name|void
name|assertXAttrs
...
block|}
block|}
comment|/**    * Runs distcp from /src to specified destination, preserving XAttrs. Asserts    * expected exit code.    *     * @param int exitCode expected exit code    * @param dst String distcp destination    * @throws Exception if there is any error    */
