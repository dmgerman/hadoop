...
annotation|@
name|Test
DECL|method|testDeleteMissingUseTrash ()
specifier|public
name|void
name|testDeleteMissingUseTrash
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertFalse
argument_list|(
literal|"Delete does not use trash by default."
argument_list|,
name|builder
operator|.
name|build
...
operator|+
literal|"deleteMissing=false, deleteUseTrash=false, ignoreFailures=false, "
operator|+
literal|"overwrite=false, append=false, useDiff=false, useRdiff=false, "
operator|+
