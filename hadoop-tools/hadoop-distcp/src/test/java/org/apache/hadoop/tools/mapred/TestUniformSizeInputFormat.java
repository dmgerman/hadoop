...
block|}
comment|// From
comment|// http://svn.apache.org/repos/asf/hadoop/mapreduce/trunk/src/tools/org/apache/hadoop/tools/DistCp.java
DECL|method|legacyGetSplits (Path listFile, int numSplits)
specifier|private
name|List
argument_list|<
name|InputSplit
...
block|}
block|}
DECL|method|checkAgainstLegacy (List<InputSplit> splits, List<InputSplit> legacySplits)
specifier|private
name|void
name|checkAgainstLegacy
parameter_list|(
