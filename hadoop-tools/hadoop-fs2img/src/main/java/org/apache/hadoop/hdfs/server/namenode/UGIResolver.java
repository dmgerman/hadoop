...
return|;
block|}
DECL|method|resolve (AclStatus aclStatus)
specifier|private
name|long
name|resolve
parameter_list|(
...
return|;
block|}
DECL|method|permission (FsPermission s)
specifier|public
name|FsPermission
name|permission
parameter_list|(
...
return|;
block|}
comment|/**    * Get the serialized, local permissions for the external    * {@link FileStatus} or {@link AclStatus}. {@code remoteAcl} is used when it    * is not null, otherwise {@code remoteStatus} is used.    *    * @param remoteStatus FileStatus on remote store.    * @param remoteAcl AclStatus on external store.    * @return serialized, local permissions the FileStatus or AclStatus map to.    */
DECL|method|getPermissionsProto (FileStatus remoteStatus, AclStatus remoteAcl)
specifier|public
name|long
...
block|}
block|}
comment|/**    * Add the users and groups specified by the given {@link FileStatus} and    * {@link AclStatus}.    *    * @param remoteStatus    * @param remoteAcl    */
DECL|method|addUGI (FileStatus remoteStatus, AclStatus remoteAcl)
specifier|private
name|void
name|addUGI
parameter_list|(
...
control|)
block|{
comment|// add the users and groups in this acl entry to ugi
name|String
name|name
init|=
name|entry
