...
block|{
comment|// Check write-permissions on sub-tree including current folder
comment|// NOTE: Ideally the subtree needs read-write-execute access check.
comment|// But we will simplify it to write-access check.
if|if
condition|(
name|metaFile
operator|.
