...
operator|.
name|Evolving
DECL|class|IntegerConfigurationBasicValidator
specifier|public
class|class
...
name|max
decl_stmt|;
DECL|method|IntegerConfigurationBasicValidator (final int min, final int max, final int defaultVal, final String configKey, final boolean throwIfInvalid)
specifier|public
name|IntegerConfigurationBasicValidator
parameter_list|(
specifier|final
