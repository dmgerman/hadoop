...
name|msg
init|=
literal|"Error in fetching the WASB delegation token"
decl_stmt|;
name|LOG
operator|.
name|error
...
name|IOException
argument_list|(
literal|"Authentication failed in check authorization"
argument_list|,
name|e
argument_list|)
throw|;
...
name|error
argument_list|(
literal|"Error in check authorization"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|WasbAuthorizationException
argument_list|(
literal|"Error in check authorize"
argument_list|,
name|e
argument_list|)
throw|;
