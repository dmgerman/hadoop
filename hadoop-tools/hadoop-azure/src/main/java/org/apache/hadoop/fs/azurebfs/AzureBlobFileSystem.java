...
name|debug
argument_list|(
literal|"AzureBlobFileSystem.access path : {}, mode : {}"
argument_list|,
name|path
argument_list|,
name|mode
...
parameter_list|)
block|{
name|checkCheckAccessException
argument_list|(
name|path
argument_list|,
name|ex
...
block|}
block|}
DECL|method|checkCheckAccessException (final Path path, final AzureBlobFileSystemException exception)
specifier|private
name|void
name|checkCheckAccessException
parameter_list|(
