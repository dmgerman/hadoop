...
return|;
block|}
DECL|method|createPath (final String path, final boolean isFile, final boolean overwrite)
specifier|public
name|AbfsRestOperation
name|createPath
parameter_list|(
...
return|;
block|}
DECL|method|getPathProperties (final String path)
specifier|public
name|AbfsRestOperation
