...
begin_comment
comment|/**  * A DT fetcher for Abfs.  * This is a copy-and-paste of  * {@code org.apache.hadoop.hdfs.HdfsDtFetcher}.  *  * It is needed for the `hadoop dtutil` command.  */
end_comment

begin_class
DECL|class|AbfsDtFetcher
specifier|public
class|class
name|AbfsDtFetcher
...
decl_stmt|;
comment|/**    * Returns the service name for the scheme..    */
