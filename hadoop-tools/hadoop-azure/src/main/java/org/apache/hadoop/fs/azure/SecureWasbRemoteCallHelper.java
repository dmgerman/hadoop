...
decl_stmt|;
comment|/**    * Enable caching of Spnego token.    */
DECL|field|isSpnegoTokenCachingEnabled
specifier|private
name|boolean
name|isSpnegoTokenCachingEnabled
decl_stmt|;
comment|/**    * Cached SPNEGO token.    */
DECL|field|spnegoToken
specifier|private
name|SpnegoToken
name|spnegoToken
decl_stmt|;
DECL|method|SecureWasbRemoteCallHelper (RetryPolicy retryPolicy, boolean alwaysRequiresKerberosAuth, boolean isSpnegoTokenCachingEnabled)
specifier|public
name|SecureWasbRemoteCallHelper
parameter_list|(
name|RetryPolicy
