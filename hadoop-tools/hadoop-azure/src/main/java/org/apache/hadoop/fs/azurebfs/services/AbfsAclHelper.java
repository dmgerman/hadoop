...
name|InvalidAclOperationException
argument_list|(
literal|"Duplicate acl entries are not allowed."
argument_list|)
throw|;
block|}
name|aclEntries
...
name|InvalidAclOperationException
argument_list|(
literal|"Access mask is required when a named access acl is present."
argument_list|)
throw|;
block|}
if|if
...
name|InvalidAclOperationException
argument_list|(
literal|"Default mask is required when a named default acl is present."
argument_list|)
throw|;
block|}
if|if
...
block|}
block|}
DECL|method|modifyAclEntriesInternal (Map<String, String> aclEntries, Map<String, String> toModifyEntries)
specifier|public
specifier|static
name|void
...
name|String
argument_list|>
name|toModifyEntries
parameter_list|)
throws|throws
name|AzureBlobFileSystemException
block|{
name|boolean
name|namedAccessAclTouched
init|=
literal|false
decl_stmt|;
name|boolean
name|namedDefaultAclTouched
init|=
literal|false
decl_stmt|;
for|for
...
block|}
block|}
DECL|method|setAclEntriesInternal (Map<String, String> aclEntries, Map<String, String> getAclEntries)
specifier|public
specifier|static
name|void
...
block|}
block|}
DECL|method|isUpnFormatAclEntries (Map<String, String> aclEntries)
specifier|public
specifier|static
name|boolean
...
return|;
block|}
DECL|method|containsNamedAce (Map<String, String> aclEntries, boolean checkDefault)
specifier|private
specifier|static
name|boolean
name|containsNamedAce
