...
decl_stmt|;
DECL|method|AzureBlobFileSystemStore (URI uri, boolean isSecure, Configuration configuration, UserGroupInformation userGroupInformation)
specifier|public
name|AzureBlobFileSystemStore
parameter_list|(
name|URI
...
expr_stmt|;
block|}
DECL|method|createFile (final Path path, final boolean overwrite)
specifier|public
name|OutputStream
name|createFile
parameter_list|(
...
return|;
block|}
DECL|method|createDirectory (final Path path)
specifier|public
name|void
...
name|debug
argument_list|(
literal|"createDirectory filesystem: {} path: {}"
argument_list|,
name|client
operator|.
name|getFileSystem
...
return|;
block|}
DECL|method|initializeClient (URI uri, boolean isSeure)
specifier|private
name|void
name|initializeClient
parameter_list|(
...
name|error
argument_list|(
literal|"Failed to parse the date {0}"
argument_list|,
name|lastModifiedTime
argument_list|)
expr_stmt|;
