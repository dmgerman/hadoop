...
name|authType
decl_stmt|;
DECL|method|AzureBlobFileSystemStore (URI uri, boolean isSecureScheme, Configuration configuration, UserGroupInformation userGroupInformation)
specifier|public
name|AzureBlobFileSystemStore
parameter_list|(
name|URI
...
return|;
block|}
DECL|method|isSuperUserOrEmpty (final String name)
specifier|private
name|boolean
name|isSuperUserOrEmpty
parameter_list|(
