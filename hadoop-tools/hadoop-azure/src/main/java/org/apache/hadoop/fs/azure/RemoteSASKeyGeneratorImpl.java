...
name|msg
init|=
literal|"Invalid CredService Url, configure it correctly"
decl_stmt|;
name|LOG
operator|.
name|error
...
name|msg
init|=
literal|"CredService Url not found in configuration to "
operator|+
literal|"initialize RemoteSASKeyGenerator"
decl_stmt|;
name|LOG
operator|.
name|error
...
name|SASKeyGenerationException
argument_list|(
literal|"Encountered IOException"
operator|+
...
block|}
block|}
DECL|method|getSASKey (final URI uri, UserGroupInformation connectUgi)
specifier|private
name|URI
name|getSASKey
parameter_list|(
...
argument_list|()
argument_list|,
literal|"Authenticated Token is NOT present. "
operator|+
literal|"The request cannot proceed."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|msg
init|=
literal|"Error fetching SAS Key from Remote Service: "
operator|+
name|uri
decl_stmt|;
name|LOG
...
block|}
block|}
comment|/**    * Helper method to make a remote request.    * @param uri - Uri to use for the remote request    * @param token - hadoop.auth token for the remote request    * @return RemoteSASKeyGenerationResponse    */
DECL|method|makeRemoteRequest (URI uri, String token)
specifier|private
name|RemoteSASKeyGenerationResponse
name|makeRemoteRequest
parameter_list|(
