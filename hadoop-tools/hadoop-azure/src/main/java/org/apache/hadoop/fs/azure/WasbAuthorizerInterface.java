...
block|{
comment|/**    * Initializer method    * @param conf - Configuration object    */
...
name|IOException
function_decl|;
comment|/**    * Authorizer API to authorize access in WASB.    * @param wasbAbsolutePath : Absolute WASB Path used for access.    * @param accessType : Type of access    * @return : true - If access allowed false - If access is not allowed.    */
