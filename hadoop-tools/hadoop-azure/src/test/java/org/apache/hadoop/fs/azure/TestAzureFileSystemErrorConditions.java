...
block|}
block|}
comment|// Tests an error during stream creation (in this case in the seek() implementation
comment|// to verify the close-stream-on-error logic.
annotation|@
name|Test
argument_list|(
name|expected
...
name|class
argument_list|)
DECL|method|testErrorDuringRetrieve ()
specifier|public
name|void
name|testErrorDuringRetrieve
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Path
argument_list|(
literal|"/testErrorDuringRetrieve"
argument_list|)
decl_stmt|;
name|writeAllThreeFile
argument_list|(
