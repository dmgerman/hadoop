...
begin_class
DECL|class|TestAzureFileSystemInstrumentation
specifier|public
class|class
name|TestAzureFileSystemInstrumentation
block|{
DECL|field|fs
specifier|private
name|FileSystem
...
name|directoryName
init|=
literal|"metricsTestDirectory_ClientError"
decl_stmt|;
name|Path
name|directoryPath
init|=
...
operator|)
operator|+
literal|" web responses to complete."
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Override
DECL|method|matches (Object toMatch)
specifier|public
name|boolean
name|matches
parameter_list|(
...
block|}
block|}
comment|/**    * A matcher class for asserting that a long value is in a    * given range.    */
DECL|class|InRange
specifier|private
specifier|static
class|class
...
argument_list|>
block|{
DECL|field|inclusiveLowerLimit
specifier|private
specifier|final
name|long
name|inclusiveLowerLimit
decl_stmt|;
DECL|field|inclusiveUpperLimit
specifier|private
specifier|final
name|long
name|inclusiveUpperLimit
...
name|obtained
decl_stmt|;
DECL|method|InRange (long inclusiveLowerLimit, long inclusiveUpperLimit)
specifier|public
name|InRange
parameter_list|(
name|long
...
annotation|@
name|Override
DECL|method|matches (Object number)
specifier|public
name|boolean
name|matches
parameter_list|(
