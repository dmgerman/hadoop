...
begin_comment
comment|/**  * Contract test for concat operation.  */
end_comment
...
name|class
argument_list|)
DECL|class|ITestAbfsFileSystemContractConcat
specifier|public
class|class
name|ITestAbfsFileSystemContractConcat
extends|extends
name|AbstractContractConcatTest
block|{
annotation|@
...
name|binding
decl_stmt|;
DECL|method|ITestAbfsFileSystemContractConcat (final boolean secure)
specifier|public
name|ITestAbfsFileSystemContractConcat
parameter_list|(
specifier|final
