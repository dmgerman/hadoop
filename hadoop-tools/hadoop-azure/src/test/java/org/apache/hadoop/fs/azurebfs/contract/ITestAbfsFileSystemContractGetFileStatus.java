...
begin_comment
comment|/**  * Contract test for getFileStatus operation.  */
end_comment
...
name|class
argument_list|)
DECL|class|ITestAbfsFileSystemContractGetFileStatus
specifier|public
class|class
name|ITestAbfsFileSystemContractGetFileStatus
extends|extends
name|AbstractContractGetFileStatusTest
block|{
annotation|@
...
name|dependencyInjectedContractTest
decl_stmt|;
DECL|method|ITestAbfsFileSystemContractGetFileStatus (final boolean secure)
specifier|public
name|ITestAbfsFileSystemContractGetFileStatus
parameter_list|(
specifier|final
