...
begin_class
DECL|class|ITestWasbUriAndConfiguration
specifier|public
class|class
name|ITestWasbUriAndConfiguration
extends|extends
...
expr_stmt|;
block|}
comment|/**    * Use secure mode, which will automatically switch to SAS,    */
annotation|@
name|Test
DECL|method|testConnectUsingSecureSAS ()
specifier|public
name|void
name|testConnectUsingSecureSAS
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Path
argument_list|(
literal|"/testConnectUsingSecureSAS"
argument_list|)
argument_list|,
literal|"testConnectUsingSecureSAS"
argument_list|,
...
argument_list|(
literal|"The specified container does not exist"
argument_list|,
name|cause
argument_list|)
expr_stmt|;
block|}
comment|/**    * Get an inner cause of an exception; require it to be of the given    * type.    * If there is a problem, an AssertionError is thrown, containing the    * outer or inner exception.    * @param clazz required class    * @param t exception    * @param<E> type of required exception    * @return the retrieved exception    * @throws AssertionError if there is no cause or it is of the wrong type.    */
DECL|method|getCause ( Class<E> clazz, Throwable t)
specifier|private
parameter_list|<
name|E
extends|extends
...
annotation|@
name|Test
DECL|method|testUserAgentConfig ()
specifier|public
name|void
name|testUserAgentConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testCanonicalServiceName ()
specifier|public
name|void
name|testCanonicalServiceName
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Default getCanonicalServiceName() will try to resolve the host to IP,
comment|// because the mock container does not exist, this call is expected to fail.
name|intercept
argument_list|(
name|IllegalArgumentException
operator|.
name|class
argument_list|,
literal|"java.net.UnknownHostException"
argument_list|,
parameter_list|()
lambda|->
block|{
...
name|assertEquals
argument_list|(
literal|"getCanonicalServiceName() should return URI"
argument_list|,
name|fs1
operator|.
name|getUri
