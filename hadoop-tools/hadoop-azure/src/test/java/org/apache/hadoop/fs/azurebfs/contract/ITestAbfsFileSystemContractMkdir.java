...
begin_comment
comment|/**  * Contract test for mkdir operation.  */
end_comment
...
name|class
argument_list|)
DECL|class|ITestAbfsFileSystemContractMkdir
specifier|public
class|class
name|ITestAbfsFileSystemContractMkdir
extends|extends
name|AbstractContractMkdirTest
block|{
annotation|@
...
name|binding
decl_stmt|;
DECL|method|ITestAbfsFileSystemContractMkdir (final boolean secure)
specifier|public
name|ITestAbfsFileSystemContractMkdir
parameter_list|(
specifier|final
