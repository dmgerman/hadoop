...
begin_class
DECL|class|ITestReadAndSeekPageBlobAfterWrite
specifier|public
class|class
name|ITestReadAndSeekPageBlobAfterWrite
extends|extends
name|AbstractAzureScaleTest
block|{
DECL|field|LOG
...
name|blobPath
argument_list|(
literal|"ITestReadAndSeekPageBlobAfterWrite"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|assertEquals
argument_list|(
literal|"File size hasn't changed "
operator|+
name|status
argument_list|,
name|numWrites
