...
DECL|method|allowRecursiveDelete (NativeAzureFileSystem fs, MockWasbAuthorizerImpl authorizer, String path)
specifier|private
name|void
...
name|expectMessage
argument_list|(
literal|"create operation for Path : /test.dat not allowed"
argument_list|)
expr_stmt|;
name|AzureBlobStorageTestAccount
name|testAccount
...
name|expectMessage
argument_list|(
literal|"liststatus operation for Path : /testListAccessCheckNegative/test.dat not allowed"
argument_list|)
expr_stmt|;
name|AzureBlobStorageTestAccount
name|testAccount
...
name|expectMessage
argument_list|(
literal|"rename operation for Path : /testRenameAccessCheckNegative/test1.dat not allowed"
argument_list|)
expr_stmt|;
name|AzureBlobStorageTestAccount
name|testAccount
...
name|expectMessage
argument_list|(
literal|"rename operation for Path : /testRenameAccessCheckNegativeDst/test2.dat not allowed"
argument_list|)
expr_stmt|;
name|AzureBlobStorageTestAccount
name|testAccount
...
name|expectMessage
argument_list|(
literal|"delete operation for Path : /test.dat not allowed"
argument_list|)
expr_stmt|;
name|AzureBlobStorageTestAccount
name|testAccount
...
name|expectMessage
argument_list|(
literal|"getFileStatus operation for Path : / not allowed"
argument_list|)
expr_stmt|;
name|AzureBlobStorageTestAccount
name|testAccount
...
name|expectMessage
argument_list|(
literal|"mkdirs operation for Path : /testMkdirsAccessCheckNegative/1/2/3 not allowed"
argument_list|)
expr_stmt|;
name|AzureBlobStorageTestAccount
name|testAccount
