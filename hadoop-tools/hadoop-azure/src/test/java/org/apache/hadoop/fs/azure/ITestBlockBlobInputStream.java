...
name|NAME_ASCENDING
argument_list|)
DECL|class|ITestBlockBlobInputStream
specifier|public
class|class
name|ITestBlockBlobInputStream
extends|extends
name|AbstractAzureScaleTest
block|{
DECL|field|LOG
...
index|]
decl_stmt|;
comment|// v1 forward seek and read a kilobyte into first kilobyte of bufferV1
name|inputStreamV1
operator|.
name|seek
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// v2 forward seek and read a kilobyte into first kilobyte of bufferV2
name|inputStreamV2
operator|.
name|seek
argument_list|(
...
name|len
decl_stmt|;
comment|// v1 reverse seek and read a megabyte into last megabyte of bufferV1
name|inputStreamV1
operator|.
name|seek
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// v2 reverse seek and read a megabyte into last megabyte of bufferV2
name|inputStreamV2
operator|.
name|seek
argument_list|(
...
name|assertEquals
argument_list|(
literal|"Bytes read from V1 stream"
argument_list|,
name|size
argument_list|,
name|numBytesReadV1
...
name|assertEquals
argument_list|(
literal|"Bytes read from V2 stream"
argument_list|,
name|size
argument_list|,
name|numBytesReadV2
...
block|{
comment|// clean up the test account
name|AzureTestUtils
operator|.
