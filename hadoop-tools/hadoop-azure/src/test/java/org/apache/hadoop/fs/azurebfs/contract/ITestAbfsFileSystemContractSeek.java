...
begin_comment
comment|/**  * Contract test for seek operation.  */
end_comment
...
name|class
argument_list|)
DECL|class|ITestAbfsFileSystemContractSeek
specifier|public
class|class
name|ITestAbfsFileSystemContractSeek
extends|extends
name|AbstractContractSeekTest
block|{
annotation|@
...
name|binding
decl_stmt|;
DECL|method|ITestAbfsFileSystemContractSeek (final boolean secure)
specifier|public
name|ITestAbfsFileSystemContractSeek
parameter_list|(
specifier|final
