...
name|contentLength
decl_stmt|;
DECL|method|ListBlobEntry (String key, HashMap<String, String> metadata, int contentLength)
name|ListBlobEntry
parameter_list|(
name|String
name|key
...
literal|"unchecked"
argument_list|)
DECL|method|setContent (String key, byte[] value, HashMap<String, String> metadata)
specifier|public
specifier|synchronized
name|void
name|setContent
...
expr_stmt|;
block|}
DECL|method|upload (final String key, final HashMap<String, String> metadata)
specifier|public
name|OutputStream
name|upload
parameter_list|(
...
name|metadata
decl_stmt|;
DECL|method|Entry (byte[] content, HashMap<String, String> metadata)
specifier|public
name|Entry
parameter_list|(
name|byte
