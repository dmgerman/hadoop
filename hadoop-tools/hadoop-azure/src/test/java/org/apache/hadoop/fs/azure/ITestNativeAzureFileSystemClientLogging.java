...
begin_comment
comment|/**  * Test to validate Azure storage client side logging. Tests works only when  * testing with Live Azure storage because Emulator does not have support for  * client-side logging.  *  *<I>Important:</I> Do not attempt to move off commons-logging.  * The tests will fail.  */
end_comment

begin_class
DECL|class|ITestNativeAzureFileSystemClientLogging
specifier|public
class|class
name|ITestNativeAzureFileSystemClientLogging
extends|extends
