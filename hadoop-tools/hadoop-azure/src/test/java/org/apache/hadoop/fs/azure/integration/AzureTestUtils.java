...
return|;
block|}
comment|/**    * Write string into a file.    */
DECL|method|writeStringToFile (FileSystem fs, Path path, String value)
specifier|public
specifier|static
name|void
...
block|}
comment|/**    * Write string into a file.    */
DECL|method|writeStringToStream (FSDataOutputStream outputStream, String value)
specifier|public
specifier|static
name|void
name|writeStringToStream
...
expr_stmt|;
block|}
comment|/**    * Read string from a file.    */
DECL|method|readStringFromFile (FileSystem fs, Path testFile)
specifier|public
specifier|static
name|String
...
return|;
block|}
comment|/**    * Read string from stream.    */
DECL|method|readStringFromStream (FSDataInputStream inputStream)
specifier|public
specifier|static
name|String
name|readStringFromStream
