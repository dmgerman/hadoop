...
argument_list|)
expr_stmt|;
comment|// Prepare working directory
if|if
condition|(
name|fs
operator|.
...
annotation|@
name|VisibleForTesting
DECL|method|findAggregatedApps ()
name|void
name|findAggregatedApps
parameter_list|()
throws|throws
...
annotation|@
name|VisibleForTesting
DECL|method|checkFiles (FileSystem fs, Path remoteRootLogDir, String suffix)
name|void
name|checkFiles
parameter_list|(
name|FileSystem
...
parameter_list|)
block|{
comment|// If the user doesn't have permission or it doesn't exist, then skip it
name|reportIt
operator|.
name|remove
argument_list|()
