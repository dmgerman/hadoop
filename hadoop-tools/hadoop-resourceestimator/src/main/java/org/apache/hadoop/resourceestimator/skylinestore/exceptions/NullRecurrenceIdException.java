...
begin_comment
comment|/**  * Exception thrown the {@code RecurrenceId} to be added is<em>null</em>.  */
end_comment

begin_class
DECL|class|NullRecurrenceIdException
specifier|public
class|class
...
decl_stmt|;
DECL|method|NullRecurrenceIdException (final String message)
specifier|public
name|NullRecurrenceIdException
parameter_list|(
specifier|final
