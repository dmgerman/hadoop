...
begin_comment
comment|/**  * Exception thrown when pipelineId to be added is<em>null</em>.  */
end_comment

begin_class
DECL|class|NullPipelineIdException
specifier|public
class|class
...
decl_stmt|;
DECL|method|NullPipelineIdException (final String message)
specifier|public
name|NullPipelineIdException
parameter_list|(
specifier|final
