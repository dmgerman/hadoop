...
annotation|@
name|Override
DECL|method|allocate (ApplicationAttemptId attemptId, List<ResourceRequest> resourceRequests, List<ContainerId> containerIds, List<String> blacklistAdditions, List<String> blacklistRemovals, ContainerUpdates updateRequests)
specifier|public
name|Allocation
name|allocate
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|initQueueMetrics (FSQueue queue)
specifier|private
name|void
