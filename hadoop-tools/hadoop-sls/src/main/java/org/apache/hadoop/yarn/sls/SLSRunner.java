...
name|SYNTH
block|}
DECL|field|NETWORK_CACHE_TTL
specifier|public
specifier|static
specifier|final
name|String
name|NETWORK_CACHE_TTL
init|=
literal|"networkaddress.cache.ttl"
decl_stmt|;
DECL|field|NETWORK_NEGATIVE_CACHE_TTL
specifier|public
specifier|static
specifier|final
name|String
name|NETWORK_NEGATIVE_CACHE_TTL
init|=
literal|"networkaddress.cache.negative.ttl"
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Enables DNS Caching based on config. If DNS caching is enabled, then set    * the DNS cache to infinite time. Since in SLS random nodes are added, DNS    * resolution can take significant time which can cause erroneous results.    * For more details, check<a href=    * "https://docs.oracle.com/javase/8/docs/technotes/guides/net/properties.html">    * Java Networking Properties</a>    * @param conf Configuration object.    */
DECL|method|enableDNSCaching (Configuration conf)
specifier|static
name|void
name|enableDNSCaching
parameter_list|(
