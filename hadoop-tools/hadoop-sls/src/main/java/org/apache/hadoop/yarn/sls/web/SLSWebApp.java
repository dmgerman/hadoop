...
decl_stmt|;
DECL|field|commitSuccessTimecostHistogram
specifier|private
specifier|transient
name|Histogram
name|commitSuccessTimecostHistogram
decl_stmt|;
DECL|field|commitFailureTimecostHistogram
specifier|private
specifier|transient
name|Histogram
name|commitFailureTimecostHistogram
decl_stmt|;
...
decl_stmt|;
DECL|field|lastTrackingTime
specifier|private
name|Long
name|lastTrackingTime
decl_stmt|;
DECL|field|lastSchedulerCommitSuccessCount
specifier|private
name|Long
name|lastSchedulerCommitSuccessCount
decl_stmt|;
DECL|field|lastSchedulerCommitFailureCount
specifier|private
name|Long
name|lastSchedulerCommitFailureCount
decl_stmt|;
block|{
...
decl_stmt|,
name|commitSuccessTimecost
decl_stmt|,
name|commitFailureTimecost
decl_stmt|,
name|handleTimecost
decl_stmt|;
if|if
...
expr_stmt|;
block|}
comment|// calculate commit throughput, unit is number/second
if|if
condition|(
name|schedulerCommitSuccessCounter
operator|==
...
block|}
name|long
name|schedulerCommitSuccessThroughput
init|=
literal|0
decl_stmt|;
name|long
name|schedulerCommitFailureThroughput
init|=
literal|0
decl_stmt|;
if|if
...
decl_stmt|;
name|long
name|currentSchedulerCommitSucessCount
init|=
name|schedulerCommitSuccessCounter
operator|.
name|getCount
...
decl_stmt|;
name|long
name|currentSchedulerCommitFailureCount
init|=
name|schedulerCommitFailureCounter
operator|.
name|getCount
...
name|append
argument_list|(
literal|",\"scheduler.commit.success.timecost\":"
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|",\"scheduler.commit.failure.timecost\":"
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|",\"scheduler.commit.success.throughput\":"
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|",\"scheduler.commit.failure.throughput\":"
argument_list|)
operator|.
name|append
argument_list|(
