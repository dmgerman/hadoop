...
argument_list|)
DECL|method|init (int id, int heartbeatInterval, List<ContainerSimulator> containerList, ResourceManager resourceManager, SLSRunner slsRunnner, long startTime, long finishTime, String simUser, String simQueue, boolean tracked, String oldApp, ReservationSubmissionRequest rr, long baseTimeMS)
specifier|public
name|void
name|init
parameter_list|(
