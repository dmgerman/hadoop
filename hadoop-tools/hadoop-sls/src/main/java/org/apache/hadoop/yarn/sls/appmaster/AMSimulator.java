...
argument_list|)
expr_stmt|;
comment|// waiting until application ACCEPTED
name|RMApp
name|app
init|=
name|rm
...
expr_stmt|;
block|}
comment|// Waiting until application attempt reach LAUNCHED
comment|// "Unmanaged AM must register after AM attempt reaches LAUNCHED state"
name|this
operator|.
name|appAttemptId
operator|=
