...
annotation|@
name|Test
DECL|method|testSequentialAndRandomRead ()
specifier|public
name|void
name|testSequentialAndRandomRead
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testOSSFileReaderTask ()
specifier|public
name|void
name|testOSSFileReaderTask
parameter_list|()
throws|throws
name|Exception
block|{
...
name|setPath
argument_list|(
literal|"/test/smallSeekFileOSSFileReader.txt"
argument_list|)
decl_stmt|;
name|long
name|size
...
name|info
argument_list|(
literal|"5MB file created: smallSeekFileOSSFileReader.txt"
argument_list|)
expr_stmt|;
name|ReadBuffer
name|readBuffer
...
argument_list|)
decl_stmt|;
comment|//NullPointerException, fail
name|task
operator|.
name|run
argument_list|()
...
name|AliyunOSSFileReaderTask
argument_list|(
literal|"test/test/smallSeekFileOSSFileReader.txt"
argument_list|,
operator|(
operator|(
name|AliyunOSSFileSystem
