...
annotation|@
name|Test
comment|/**    * This test is used to verify HADOOP-16306.    * Test small file uploading so that oss fs will upload file directly    * instead of multi part upload.    */
...
expr_stmt|;
block|}
DECL|method|bufferDirShouldEmpty ()
specifier|private
name|void
name|bufferDirShouldEmpty
parameter_list|()
...
argument_list|)
decl_stmt|;
comment|// Temporary file should be deleted
name|assertEquals
argument_list|(
literal|0
argument_list|,
