...
block|}
block|}
comment|/**    * list objects.    *    * @param prefix prefix.    * @param maxListingLength max no. of entries    * @param delimiter delimiter.    * @param marker last key in any previous search.    * @return a list of matches.    */
DECL|method|listObjects (String prefix, int maxListingLength, String delimiter, String marker)
specifier|public
name|ObjectListing
name|listObjects
parameter_list|(
