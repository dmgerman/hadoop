...
name|error
argument_list|(
literal|"Exception thrown when get object meta: "
operator|+
name|key
operator|+
literal|", exception: "
...
block|}
block|}
comment|/**    * Copy an object from source key to destination key.    *    * @param srcKey source key.    * @param srcLen source file length.    * @param dstKey destination key.    * @return true if file is successfully copied.    */
DECL|method|copyFile (String srcKey, long srcLen, String dstKey)
specifier|public
name|boolean
name|copyFile
parameter_list|(
...
try|try
block|{
comment|//1, try single copy first
return|return
name|singleCopy
argument_list|(
name|srcKey
...
parameter_list|)
block|{
comment|//2, if failed(shallow copy not supported), then multi part copy
name|LOG
operator|.
name|debug
argument_list|(
literal|"Exception thrown when copy file: "
operator|+
name|srcKey
operator|+
literal|", exception: "
...
name|e
operator|+
literal|", use multipartCopy instead"
argument_list|)
expr_stmt|;
return|return
name|multipartCopy
...
return|;
block|}
DECL|method|uploadPart (File file, String key, String uploadId, int idx)
specifier|public
name|PartETag
name|uploadPart
parameter_list|(
...
return|;
block|}
comment|/**    * Complete the specific multipart upload.    */
DECL|method|completeMultipartUpload (String key, String uploadId, List<PartETag> partETags)
specifier|public
name|CompleteMultipartUploadResult
name|completeMultipartUpload
parameter_list|(
...
argument_list|,
operator|new
name|PartNumberAscendComparator
argument_list|()
argument_list|)
expr_stmt|;
name|CompleteMultipartUploadRequest
...
return|;
block|}
comment|/**    * Abort the specific multipart upload.    */
...
expr_stmt|;
block|}
DECL|class|PartNumberAscendComparator
specifier|private
specifier|static
class|class
name|PartNumberAscendComparator
...
annotation|@
name|Override
DECL|method|compare (PartETag o1, PartETag o2)
specifier|public
name|int
name|compare
parameter_list|(
