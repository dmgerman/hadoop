...
begin_comment
comment|/**  * Extended Webhdfs GetOpParam to avoid redirect operation for azure data  * lake storage.  */
end_comment

begin_class
DECL|class|ADLGetOpParam
specifier|public
class|class
name|ADLGetOpParam
extends|extends
...
DECL|method|ADLGetOpParam (final String str)
specifier|public
name|ADLGetOpParam
parameter_list|(
specifier|final
...
name|requireAuth
decl_stmt|;
DECL|method|Op (final boolean doRedirect, final int expectHttpResponseCode)
name|Op
parameter_list|(
specifier|final
name|boolean
...
expr_stmt|;
block|}
DECL|method|Op (final boolean doRedirect, final int expectHttpResponseCode, final boolean doRequireAuth)
name|Op
parameter_list|(
specifier|final
name|boolean
