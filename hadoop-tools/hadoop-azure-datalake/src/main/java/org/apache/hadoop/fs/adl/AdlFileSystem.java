...
name|tokenProvider
operator|=
name|getDeviceCodeTokenProvider
argument_list|(
name|conf
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|getMsiBasedTokenProvider ( Configuration conf)
specifier|private
name|AccessTokenProvider
name|getMsiBasedTokenProvider
parameter_list|(
...
return|;
block|}
DECL|method|getDeviceCodeTokenProvider ( Configuration conf)
specifier|private
name|AccessTokenProvider
name|getDeviceCodeTokenProvider
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Gets ADL account name from ADL FQDN.    * @param accountFQDN ADL account fqdn    * @return ADL account name    */
DECL|method|getAccountNameFromFQDN (String accountFQDN)
specifier|public
specifier|static
name|String
name|getAccountNameFromFQDN
...
continue|continue;
block|}
comment|// there's a account prefix, so strip it
specifier|final
name|String
name|stripped
init|=
