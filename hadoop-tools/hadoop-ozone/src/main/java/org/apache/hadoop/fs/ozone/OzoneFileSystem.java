...
return|;
block|}
comment|// TODO: currently rename work by copying the streams, with changes in KSM,
comment|// this operation can be improved by renaming the keys in KSM directly.
