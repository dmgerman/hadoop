...
index|]
decl_stmt|;
DECL|field|mapMetrics
specifier|private
name|ResourceUsageMetrics
name|mapMetrics
decl_stmt|;
DECL|field|reduceMetrics
specifier|private
name|ResourceUsageMetrics
index|[]
name|reduceMetrics
decl_stmt|;
DECL|method|LoadSplit ()
name|LoadSplit
parameter_list|()
block|{
name|super
...
expr_stmt|;
block|}
DECL|method|LoadSplit (CombineFileSplit cfsplit, int maps, int id, long inputBytes, long inputRecords, long outputBytes, long outputRecords, double[] reduceBytes, double[] reduceRecords, long[] reduceOutputBytes, long[] reduceOutputRecords, ResourceUsageMetrics metrics, ResourceUsageMetrics[] rMetrics)
specifier|public
name|LoadSplit
parameter_list|(
name|CombineFileSplit
...
return|;
block|}
DECL|method|getMapResourceUsageMetrics ()
specifier|public
name|ResourceUsageMetrics
...
return|;
block|}
DECL|method|getReduceResourceUsageMetrics (int i)
specifier|public
name|ResourceUsageMetrics
