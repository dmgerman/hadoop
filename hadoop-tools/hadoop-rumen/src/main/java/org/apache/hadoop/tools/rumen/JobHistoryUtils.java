...
return|;
block|}
comment|/**    * Extract/Add counters into the Map from the given JhCounters object.    * @param counters the counters to be extracted from    * @return the map of counters    */
DECL|method|extractCounters (JhCounters counters)
specifier|static
name|Map
argument_list|<
name|String
