...
name|reduceTime
decl_stmt|;
DECL|method|ReduceTaskAttemptInfo (State state, TaskInfo taskInfo, long shuffleTime, long mergeTime, long reduceTime, List<List<Integer>> allSplits)
specifier|public
name|ReduceTaskAttemptInfo
parameter_list|(
name|State
...
expr_stmt|;
block|}
comment|/**    *    * @deprecated please use the constructor with     *               {@code (state, taskInfo, shuffleTime, mergeTime, reduceTime    *                  List<List<Integer>> allSplits)}    *             instead.      *    * see {@link LoggedTaskAttempt} for an explanation of    *        {@code allSplits}.    *    * If there are no known splits, use {@code null}.    */
annotation|@
name|Deprecated
